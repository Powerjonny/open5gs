...
OpenAPI_cag_info_t *OpenAPI_cag_info_create(
	...
	int
	cag_only_indicator) {
	OpenAPI_cag_info_t *cag_info_local_var =
		ogs_malloc(sizeof(OpenAPI_cag_info_t));
...
cJSON *OpenAPI_cag_info_convertToJSON(OpenAPI_cag_info_t *cag_info) {
	...
	if(cag_info->is_cag_only_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_cag_info_convertToJSON() failed [cag_only_indicator]");
			goto end;
		}
	}
...
OpenAPI_cag_info_t *OpenAPI_cag_info_parseFromJSON(cJSON *cag_infoJSON) {
	...
	if(cag_only_indicator) {
		if(!cJSON_IsBool(cag_only_indicator)) {
			ogs_error(
				"OpenAPI_cag_info_parseFromJSON() failed [cag_only_indicator]");
			goto end;
		}
	}
...
OpenAPI_cag_info_t *OpenAPI_cag_info_copy(OpenAPI_cag_info_t	*dst,
                                          OpenAPI_cag_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
