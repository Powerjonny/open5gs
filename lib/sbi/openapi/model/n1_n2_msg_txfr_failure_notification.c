...
OpenAPI_n1_n2_msg_txfr_failure_notification_create(
	...
	OpenAPI_n1_n2_msg_txfr_failure_notification_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_n1_n2_msg_txfr_failure_notification_t));
...
void OpenAPI_n1_n2_msg_txfr_failure_notification_free(
	...
	if(n1_n2_msg_txfr_failure_notification->n1n2_msg_data_uri) {
		ogs_free(
			n1_n2_msg_txfr_failure_notification->n1n2_msg_data_uri);
...
cJSON *OpenAPI_n1_n2_msg_txfr_failure_notification_convertToJSON(
	...
	if(n1_n2_msg_txfr_failure_notification == NULL) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_failure_notification_convertToJSON() failed [N1N2MsgTxfrFailureNotification]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(n1_n2_msg_txfr_failure_notification->cause ==
	   OpenAPI_n1_n2_message_transfer_cause_NULL)
	{
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_failure_notification_convertToJSON() failed [cause]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "cause",
	                           OpenAPI_n1_n2_message_transfer_cause_ToString
	                                   (n1_n2_msg_txfr_failure_notification
	                                   ->cause)) == NULL)
	{
		ogs_error(
	...
	if(!n1_n2_msg_txfr_failure_notification->n1n2_msg_data_uri) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_failure_notification_convertToJSON() failed [n1n2_msg_data_uri]");
		return NULL;
	}
...
OpenAPI_n1_n2_msg_txfr_failure_notification_parseFromJSON(
	...
	if(!cause) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_failure_notification_parseFromJSON() failed [cause]");
		goto end;
	}
	...
	causeVariable =
		OpenAPI_n1_n2_message_transfer_cause_FromString(
			cause->valuestring);
	...
	if(!n1n2_msg_data_uri) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_failure_notification_parseFromJSON() failed [n1n2_msg_data_uri]");
		goto end;
	}
...
OpenAPI_n1_n2_msg_txfr_failure_notification_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_failure_notification_convertToJSON() failed");
		return NULL;
	}
