...
OpenAPI_network_perf_type_t *OpenAPI_network_perf_type_create() {
	OpenAPI_network_perf_type_t *network_perf_type_local_var =
		ogs_malloc(sizeof(OpenAPI_network_perf_type_t));
...
void OpenAPI_network_perf_type_free(
	OpenAPI_network_perf_type_t *network_perf_type) {
...
cJSON *OpenAPI_network_perf_type_convertToJSON(
	OpenAPI_network_perf_type_t *network_perf_type) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(network_perf_type == NULL) {
		ogs_error(
			"OpenAPI_network_perf_type_convertToJSON() failed [NetworkPerfType]");
		return NULL;
	}
...
OpenAPI_network_perf_type_t *OpenAPI_network_perf_type_parseFromJSON(
...
OpenAPI_network_perf_type_t *OpenAPI_network_perf_type_copy(
	OpenAPI_network_perf_type_t *dst, OpenAPI_network_perf_type_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
