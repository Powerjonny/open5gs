...
char * OpenAPI_ma_pdu_indication_ToString(
	...
	const char *ma_pdu_indicationArray[] = { "NULL", "MA_PDU_REQUEST",
		                                 "MA_PDU_NETWORK_UPGRADE_ALLOWED" };
	size_t sizeofArray = sizeof(ma_pdu_indicationArray) /
	                     sizeof(ma_pdu_indicationArray[0]);
...
OpenAPI_ma_pdu_indication_e OpenAPI_ma_pdu_indication_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(ma_pdu_indication,
		          ma_pdu_indicationArray[stringToReturn]) == 0) {
