...
OpenAPI_reachability_for_data_report_config_create() {
	OpenAPI_reachability_for_data_report_config_t *
	        reachability_for_data_report_config_local_var =
		ogs_malloc(
			sizeof(OpenAPI_reachability_for_data_report_config_t));
...
void OpenAPI_reachability_for_data_report_config_free(
	OpenAPI_reachability_for_data_report_config_t *
	reachability_for_data_report_config) {
...
cJSON *OpenAPI_reachability_for_data_report_config_convertToJSON(
	OpenAPI_reachability_for_data_report_config_t *
	reachability_for_data_report_config) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(reachability_for_data_report_config == NULL) {
		ogs_error(
			"OpenAPI_reachability_for_data_report_config_convertToJSON() failed [ReachabilityForDataReportConfig]");
		return NULL;
	}
...
OpenAPI_reachability_for_data_report_config_parseFromJSON(
	cJSON *reachability_for_data_report_configJSON) {
	OpenAPI_reachability_for_data_report_config_t *
	        reachability_for_data_report_config_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	reachability_for_data_report_config_local_var =
		OpenAPI_reachability_for_data_report_config_create(
			);
...
OpenAPI_reachability_for_data_report_config_copy(
	OpenAPI_reachability_for_data_report_config_t	*dst,
	OpenAPI_reachability_for_data_report_config_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_reachability_for_data_report_config_convertToJSON() failed");
		return NULL;
	}
