...
char * OpenAPI_reflective_qo_s_attribute_ToString(
	...
	const char *reflective_qo_s_attributeArray[] = { "NULL", "RQOS",
		                                         "NO_RQOS" };
	size_t sizeofArray = sizeof(reflective_qo_s_attributeArray) /
	                     sizeof(reflective_qo_s_attributeArray[0]);
...
OpenAPI_reflective_qo_s_attribute_e OpenAPI_reflective_qo_s_attribute_FromString
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(reflective_qo_s_attribute,
		          reflective_qo_s_attributeArray[stringToReturn]) ==
		   0) {
