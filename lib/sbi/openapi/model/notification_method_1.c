...
OpenAPI_notification_method_1_t *OpenAPI_notification_method_1_create() {
	OpenAPI_notification_method_1_t *notification_method_1_local_var =
		ogs_malloc(sizeof(OpenAPI_notification_method_1_t));
...
cJSON *OpenAPI_notification_method_1_convertToJSON(
	...
	if(notification_method_1 == NULL) {
		ogs_error(
			"OpenAPI_notification_method_1_convertToJSON() failed [NotificationMethod_1]");
		return NULL;
	}
...
OpenAPI_notification_method_1_t *OpenAPI_notification_method_1_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_notification_method_1_convertToJSON() failed");
		return NULL;
	}
