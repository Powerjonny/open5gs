...
char * OpenAPI_service_info_status_ToString(
	...
	const char *service_info_statusArray[] = { "NULL", "FINAL",
		                                   "PRELIMINARY" };
	size_t sizeofArray = sizeof(service_info_statusArray) /
	                     sizeof(service_info_statusArray[0]);
...
OpenAPI_service_info_status_e OpenAPI_service_info_status_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(service_info_status,
		          service_info_statusArray[stringToReturn]) == 0) {
