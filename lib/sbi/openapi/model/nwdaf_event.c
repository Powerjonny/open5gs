...
OpenAPI_nwdaf_event_t *OpenAPI_nwdaf_event_create() {
	OpenAPI_nwdaf_event_t *nwdaf_event_local_var =
		ogs_malloc(sizeof(OpenAPI_nwdaf_event_t));
...
cJSON *OpenAPI_nwdaf_event_convertToJSON(OpenAPI_nwdaf_event_t *nwdaf_event) {
	...
	if(nwdaf_event == NULL) {
		ogs_error(
			"OpenAPI_nwdaf_event_convertToJSON() failed [NwdafEvent]");
		return NULL;
	}
...
OpenAPI_nwdaf_event_t *OpenAPI_nwdaf_event_parseFromJSON(
	cJSON *nwdaf_eventJSON) {
...
OpenAPI_nwdaf_event_t *OpenAPI_nwdaf_event_copy(OpenAPI_nwdaf_event_t	*dst,
                                                OpenAPI_nwdaf_event_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
