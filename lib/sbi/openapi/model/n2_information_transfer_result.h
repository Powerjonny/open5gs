...
typedef enum { OpenAPI_n2_information_transfer_result_NULL = 0,
	       OpenAPI_n2_information_transfer_result_N2_INFO_TRANSFER_INITIATED }
OpenAPI_n2_information_transfer_result_e;

char * OpenAPI_n2_information_transfer_result_ToString(
	OpenAPI_n2_information_transfer_result_e n2_information_transfer_result);
