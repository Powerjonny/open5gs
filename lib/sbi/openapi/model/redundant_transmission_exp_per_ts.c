...
OpenAPI_redundant_transmission_exp_per_ts_create(char *ts_start,
                                                 int ts_duration,
                                                 OpenAPI_observed_redundant_trans_exp_t
                                                 *obsv_red_trans_exp,
                                                 bool is_red_trans_status,
                                                 int red_trans_status,
                                                 bool is_ue_ratio, int ue_ratio,
                                                 bool is_confidence,
                                                 int confidence) {
	OpenAPI_redundant_transmission_exp_per_ts_t *
	        redundant_transmission_exp_per_ts_local_var =
		ogs_malloc(sizeof(OpenAPI_redundant_transmission_exp_per_ts_t));
...
void OpenAPI_redundant_transmission_exp_per_ts_free(
	OpenAPI_redundant_transmission_exp_per_ts_t *
	...
	if(redundant_transmission_exp_per_ts->obsv_red_trans_exp) {
		OpenAPI_observed_redundant_trans_exp_free(
...
cJSON *OpenAPI_redundant_transmission_exp_per_ts_convertToJSON(
	OpenAPI_redundant_transmission_exp_per_ts_t *
	redundant_transmission_exp_per_ts) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(redundant_transmission_exp_per_ts == NULL) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [RedundantTransmissionExpPerTS]");
		return NULL;
	}
	...
	if(!redundant_transmission_exp_per_ts->ts_start) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [ts_start]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [ts_duration]");
		goto end;
	}

	if(!redundant_transmission_exp_per_ts->obsv_red_trans_exp) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [obsv_red_trans_exp]");
		return NULL;
	}
	...
	if(redundant_transmission_exp_per_ts->is_red_trans_status) {
		...
		{
			ogs_error(
				"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [red_trans_status]");
			goto end;
		}
	}
	...
	if(redundant_transmission_exp_per_ts->is_ue_ratio) {
		...
		{
			ogs_error(
				"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [ue_ratio]");
			goto end;
		}
	}
	...
	if(redundant_transmission_exp_per_ts->is_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_redundant_transmission_exp_per_ts_t *
OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON(
	...
	OpenAPI_observed_redundant_trans_exp_t *obsv_red_trans_exp_local_nonprim
	        = NULL;
	...
	if(!ts_start) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON() failed [ts_start]");
		goto end;
	}
	...
	if(!ts_duration) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON() failed [ts_duration]");
		goto end;
	}
	...
	obsv_red_trans_exp =
		cJSON_GetObjectItemCaseSensitive(
			redundant_transmission_exp_per_tsJSON,
			"obsvRedTransExp");
	if(!obsv_red_trans_exp) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON() failed [obsv_red_trans_exp]");
		goto end;
	}
	...
	if(!obsv_red_trans_exp_local_nonprim) {
		ogs_error(
			"OpenAPI_observed_redundant_trans_exp_parseFromJSON failed [obsv_red_trans_exp]");
		goto end;
	}
	...
	if(red_trans_status) {
		if(!cJSON_IsBool(red_trans_status)) {
			ogs_error(
				"OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON() failed [red_trans_status]");
			goto end;
		}
	}
	...
	if(ue_ratio) {
		if(!cJSON_IsNumber(ue_ratio)) {
			ogs_error(
				"OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON() failed [ue_ratio]");
			goto end;
		}
	}
	...
	if(confidence) {
		if(!cJSON_IsNumber(confidence)) {
			ogs_error(
				"OpenAPI_redundant_transmission_exp_per_ts_parseFromJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_redundant_transmission_exp_per_ts_copy(
	OpenAPI_redundant_transmission_exp_per_ts_t	*dst,
	OpenAPI_redundant_transmission_exp_per_ts_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_redundant_transmission_exp_per_ts_convertToJSON() failed");
		return NULL;
	}
