...
OpenAPI_vsmf_update_error_t *OpenAPI_vsmf_update_error_create(
	OpenAPI_ext_problem_details_t *error, bool is_pti, int pti,
	char *n1sm_cause, OpenAPI_ref_to_binary_data_t *n1_sm_info_from_ue,
	...
	int _5g_mm_cause_value, char *recovery_time,
	...
	OpenAPI_vsmf_update_error_t *vsmf_update_error_local_var =
		ogs_malloc(sizeof(OpenAPI_vsmf_update_error_t));
	...
	vsmf_update_error_local_var->failed_to_assign_ebi_list =
		failed_to_assign_ebi_list;
	vsmf_update_error_local_var->ng_ap_cause = ng_ap_cause;
	vsmf_update_error_local_var->is__5g_mm_cause_value =
...
void OpenAPI_vsmf_update_error_free(
	OpenAPI_vsmf_update_error_t *vsmf_update_error) {
...
cJSON *OpenAPI_vsmf_update_error_convertToJSON(
	OpenAPI_vsmf_update_error_t *vsmf_update_error) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(vsmf_update_error == NULL) {
		ogs_error(
			"OpenAPI_vsmf_update_error_convertToJSON() failed [VsmfUpdateError]");
		return NULL;
	}
	...
	if(!vsmf_update_error->error) {
		ogs_error(
			"OpenAPI_vsmf_update_error_convertToJSON() failed [error]");
		return NULL;
	}
	cJSON *error_local_JSON =
		OpenAPI_ext_problem_details_convertToJSON(
			vsmf_update_error->error);
	...
	if(vsmf_update_error->is_pti) {
		if(cJSON_AddNumberToObject(item, "pti",
		                           vsmf_update_error->pti) == NULL)
		{
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [pti]");
			goto end;
		}
	}
	...
	if(vsmf_update_error->n1sm_cause) {
		if(cJSON_AddStringToObject(item, "n1smCause",
		                           vsmf_update_error->n1sm_cause) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [n1sm_cause]");
			goto end;
		}
	}
	...
	if(vsmf_update_error->n1_sm_info_from_ue) {
		...
		if(n1_sm_info_from_ue_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [n1_sm_info_from_ue]");
			goto end;
		}
	...
	if(vsmf_update_error->unknown_n1_sm_info) {
		...
		if(unknown_n1_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [unknown_n1_sm_info]");
			goto end;
		}
	...
	if(vsmf_update_error->failed_to_assign_ebi_list) {
		...
		if(failed_to_assign_ebi_listList == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [failed_to_assign_ebi_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			vsmf_update_error->failed_to_assign_ebi_list, node) {
	...
	if(vsmf_update_error->ng_ap_cause) {
		cJSON *ng_ap_cause_local_JSON =
			OpenAPI_ng_ap_cause_convertToJSON(
				vsmf_update_error->ng_ap_cause);
		if(ng_ap_cause_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [ng_ap_cause]");
			goto end;
		}
	...
	if(vsmf_update_error->is__5g_mm_cause_value) {
		if(cJSON_AddNumberToObject(item, "5gMmCauseValue",
		                           vsmf_update_error->_5g_mm_cause_value)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [_5g_mm_cause_value]");
			goto end;
		}
	}
	...
	if(vsmf_update_error->recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(vsmf_update_error->n4_info) {
		cJSON *n4_info_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				vsmf_update_error->n4_info);
		if(n4_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [n4_info]");
			goto end;
		}
	...
	if(vsmf_update_error->n4_info_ext1) {
		cJSON *n4_info_ext1_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				vsmf_update_error->n4_info_ext1);
		if(n4_info_ext1_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [n4_info_ext1]");
			goto end;
		}
	...
	if(vsmf_update_error->n4_info_ext2) {
		cJSON *n4_info_ext2_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				vsmf_update_error->n4_info_ext2);
		if(n4_info_ext2_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [n4_info_ext2]");
			goto end;
		}
	...
	if(vsmf_update_error->n4_info_ext3) {
		cJSON *n4_info_ext3_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				vsmf_update_error->n4_info_ext3);
		if(n4_info_ext3_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vsmf_update_error_convertToJSON() failed [n4_info_ext3]");
			goto end;
		}
...
OpenAPI_vsmf_update_error_t *OpenAPI_vsmf_update_error_parseFromJSON(
	cJSON *vsmf_update_errorJSON) {
	...
	error = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                         "error");
	if(!error) {
		ogs_error(
			"OpenAPI_vsmf_update_error_parseFromJSON() failed [error]");
		goto end;
	}
	error_local_nonprim = OpenAPI_ext_problem_details_parseFromJSON(error);
	if(!error_local_nonprim) {
		ogs_error(
			"OpenAPI_ext_problem_details_parseFromJSON failed [error]");
		goto end;
	}
	...
	if(pti) {
		if(!cJSON_IsNumber(pti)) {
			ogs_error(
				"OpenAPI_vsmf_update_error_parseFromJSON() failed [pti]");
			goto end;
		}
	}

	n1sm_cause = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                              "n1smCause");
	if(n1sm_cause) {
		...
		{
			ogs_error(
				"OpenAPI_vsmf_update_error_parseFromJSON() failed [n1sm_cause]");
			goto end;
		}
	}

	n1_sm_info_from_ue =
		cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
		                                 "n1SmInfoFromUe");
	...
	if(failed_to_assign_ebi_list) {
		...
		if(!cJSON_IsArray(failed_to_assign_ebi_list)) {
			ogs_error(
				"OpenAPI_vsmf_update_error_parseFromJSON() failed [failed_to_assign_ebi_list]");
			goto end;
		}
	...
	ng_ap_cause = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                               "ngApCause");
	if(ng_ap_cause) {
	...
	if(_5g_mm_cause_value) {
		if(!cJSON_IsNumber(_5g_mm_cause_value)) {
			ogs_error(
				"OpenAPI_vsmf_update_error_parseFromJSON() failed [_5g_mm_cause_value]");
			goto end;
		}
	}

	recovery_time = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                                 "recoveryTime");
	if(recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_vsmf_update_error_parseFromJSON() failed [recovery_time]");
			goto end;
		}
	}

	n4_info = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                           "n4Info");
	if(n4_info) {
	...
	n4_info_ext1 = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                                "n4InfoExt1");
	if(n4_info_ext1) {
	...
	n4_info_ext2 = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                                "n4InfoExt2");
	if(n4_info_ext2) {
	...
	n4_info_ext3 = cJSON_GetObjectItemCaseSensitive(vsmf_update_errorJSON,
	                                                "n4InfoExt3");
	if(n4_info_ext3) {
...
OpenAPI_vsmf_update_error_t *OpenAPI_vsmf_update_error_copy(
	OpenAPI_vsmf_update_error_t *dst, OpenAPI_vsmf_update_error_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
