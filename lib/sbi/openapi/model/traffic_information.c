...
OpenAPI_traffic_information_t *OpenAPI_traffic_information_create(
	...
	bool is_total_volume, long total_volume) {
	OpenAPI_traffic_information_t *traffic_information_local_var =
		ogs_malloc(sizeof(OpenAPI_traffic_information_t));
...
void OpenAPI_traffic_information_free(
	OpenAPI_traffic_information_t *traffic_information) {
...
cJSON *OpenAPI_traffic_information_convertToJSON(
	OpenAPI_traffic_information_t *traffic_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(traffic_information == NULL) {
		ogs_error(
			"OpenAPI_traffic_information_convertToJSON() failed [TrafficInformation]");
		return NULL;
	}
	...
	if(traffic_information->uplink_rate) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_convertToJSON() failed [uplink_rate]");
			goto end;
		}
	}
	...
	if(traffic_information->downlink_rate) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_convertToJSON() failed [downlink_rate]");
			goto end;
		}
	}
	...
	if(traffic_information->is_uplink_volume) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_convertToJSON() failed [uplink_volume]");
			goto end;
		}
	}
	...
	if(traffic_information->is_downlink_volume) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_convertToJSON() failed [downlink_volume]");
			goto end;
		}
	}
	...
	if(traffic_information->is_total_volume) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_convertToJSON() failed [total_volume]");
			goto end;
		}
	}
...
OpenAPI_traffic_information_t *OpenAPI_traffic_information_parseFromJSON(
	...
	if(uplink_rate) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_parseFromJSON() failed [uplink_rate]");
			goto end;
		}
	}

	downlink_rate =
		cJSON_GetObjectItemCaseSensitive(traffic_informationJSON,
		                                 "downlinkRate");
	if(downlink_rate) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_information_parseFromJSON() failed [downlink_rate]");
			goto end;
		}
	}
	...
	if(uplink_volume) {
		if(!cJSON_IsNumber(uplink_volume)) {
			ogs_error(
				"OpenAPI_traffic_information_parseFromJSON() failed [uplink_volume]");
			goto end;
		}
	}
	...
	if(downlink_volume) {
		if(!cJSON_IsNumber(downlink_volume)) {
			ogs_error(
				"OpenAPI_traffic_information_parseFromJSON() failed [downlink_volume]");
			goto end;
		}
	}
	...
	if(total_volume) {
		if(!cJSON_IsNumber(total_volume)) {
			ogs_error(
				"OpenAPI_traffic_information_parseFromJSON() failed [total_volume]");
			goto end;
		}
	}
	...
	traffic_information_local_var = OpenAPI_traffic_information_create(
		uplink_rate &&
		!cJSON_IsNull(uplink_rate) ?
		ogs_strdup(uplink_rate->valuestring) : NULL,
		downlink_rate &&
		!cJSON_IsNull(downlink_rate) ?
		ogs_strdup(downlink_rate->valuestring) : NULL,
...
OpenAPI_traffic_information_t *OpenAPI_traffic_information_copy(
	OpenAPI_traffic_information_t	*dst,
	OpenAPI_traffic_information_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
