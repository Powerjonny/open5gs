...
OpenAPI_mdt_configuration_t *OpenAPI_mdt_configuration_create(
	...
	OpenAPI_mdt_configuration_t *mdt_configuration_local_var =
		ogs_malloc(sizeof(OpenAPI_mdt_configuration_t));
	...
	mdt_configuration_local_var->measurement_lte_list =
		measurement_lte_list;
	mdt_configuration_local_var->measurement_nr_list = measurement_nr_list;
	mdt_configuration_local_var->sensor_measurement_list =
		sensor_measurement_list;
	mdt_configuration_local_var->reporting_trigger_list =
	...
	mdt_configuration_local_var->is_event_threshold_rsrp =
		is_event_threshold_rsrp;
	mdt_configuration_local_var->event_threshold_rsrp =
		event_threshold_rsrp;
	mdt_configuration_local_var->is_event_threshold_rsrp_nr =
		is_event_threshold_rsrp_nr;
	mdt_configuration_local_var->event_threshold_rsrp_nr =
		event_threshold_rsrp_nr;
	mdt_configuration_local_var->is_event_threshold_rsrq =
		is_event_threshold_rsrq;
	mdt_configuration_local_var->event_threshold_rsrq =
		event_threshold_rsrq;
	mdt_configuration_local_var->is_event_threshold_rsrq_nr =
		is_event_threshold_rsrq_nr;
	mdt_configuration_local_var->event_threshold_rsrq_nr =
	...
	mdt_configuration_local_var->add_positioning_method_list =
		add_positioning_method_list;
	mdt_configuration_local_var->collection_period_rmm_lte =
		collection_period_rmm_lte;
	mdt_configuration_local_var->collection_period_rmm_nr =
		collection_period_rmm_nr;
	mdt_configuration_local_var->measurement_period_lte =
		measurement_period_lte;
	mdt_configuration_local_var->mdt_allowed_plmn_id_list =
		mdt_allowed_plmn_id_list;
	mdt_configuration_local_var->mbsfn_area_list = mbsfn_area_list;
	mdt_configuration_local_var->inter_freq_target_list =
		inter_freq_target_list;

	return mdt_configuration_local_var;
}

void OpenAPI_mdt_configuration_free(
	...
	if(mdt_configuration->mbsfn_area_list) {
		OpenAPI_list_for_each(mdt_configuration->mbsfn_area_list,
		                      node) {
	...
	if(mdt_configuration->inter_freq_target_list) {
		OpenAPI_list_for_each(mdt_configuration->inter_freq_target_list,
		                      node) {
...
cJSON *OpenAPI_mdt_configuration_convertToJSON(
	OpenAPI_mdt_configuration_t *mdt_configuration) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(mdt_configuration == NULL) {
		ogs_error(
			"OpenAPI_mdt_configuration_convertToJSON() failed [MdtConfiguration]");
		return NULL;
	}
	...
	if(mdt_configuration->job_type == OpenAPI_job_type_NULL) {
		ogs_error(
			"OpenAPI_mdt_configuration_convertToJSON() failed [job_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "jobType",
	                           OpenAPI_job_type_ToString(
					   mdt_configuration->job_type)) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_mdt_configuration_convertToJSON() failed [job_type]");
	...
	if(mdt_configuration->report_type != OpenAPI_report_type_mdt_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [report_type]");
			goto end;
		}
	}
	...
	if(mdt_configuration->area_scope) {
		cJSON *area_scope_local_JSON =
			OpenAPI_area_scope_convertToJSON(
				mdt_configuration->area_scope);
		if(area_scope_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [area_scope]");
			goto end;
		}
	   ...
	   OpenAPI_measurement_lte_for_mdt_NULL)
	{
		...
		if(measurement_lte_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [measurement_lte_list]");
			goto end;
		}
		OpenAPI_list_for_each(mdt_configuration->measurement_lte_list,
		                      node) {
	   ...
	   OpenAPI_measurement_nr_for_mdt_NULL)
	{
		...
		if(measurement_nr_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [measurement_nr_list]");
			goto end;
		}
		OpenAPI_list_for_each(mdt_configuration->measurement_nr_list,
		                      node) {
	   ...
	   OpenAPI_sensor_measurement_NULL)
	{
		...
		if(sensor_measurement_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [sensor_measurement_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			mdt_configuration->sensor_measurement_list, node) {
	   ...
	   OpenAPI_reporting_trigger_NULL)
	{
		...
		if(reporting_trigger_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [reporting_trigger_list]");
			goto end;
		}
		OpenAPI_list_for_each(mdt_configuration->reporting_trigger_list,
		                      node) {
	   ...
	   OpenAPI_report_interval_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [report_interval]");
			goto end;
		}
	}
	   ...
	   OpenAPI_report_interval_nr_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [report_interval_nr]");
			goto end;
		}
	}
	...
	if(mdt_configuration->report_amount != OpenAPI_report_amount_mdt_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [report_amount]");
			goto end;
		}
	}
	...
	if(mdt_configuration->is_event_threshold_rsrp) {
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrp]");
			goto end;
		}
	}
	...
	if(mdt_configuration->is_event_threshold_rsrp_nr) {
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrp_nr]");
			goto end;
		}
	}
	...
	if(mdt_configuration->is_event_threshold_rsrq) {
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrq]");
			goto end;
		}
	}
	...
	if(mdt_configuration->is_event_threshold_rsrq_nr) {
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [event_threshold_rsrq_nr]");
			goto end;
		}
	}
	...
	if(mdt_configuration->event_list != OpenAPI_event_for_mdt_NULL) {
		...
		if(event_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [event_list]");
			goto end;
		}
	   ...
	   OpenAPI_logging_interval_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [logging_interval]");
			goto end;
		}
	}
	   ...
	   OpenAPI_logging_interval_nr_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [logging_interval_nr]");
			goto end;
		}
	}
	   ...
	   OpenAPI_logging_duration_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [logging_duration]");
			goto end;
		}
	}
	   ...
	   OpenAPI_logging_duration_nr_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [logging_duration_nr]");
			goto end;
		}
	}
	   ...
	   OpenAPI_positioning_method_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [positioning_method]");
			goto end;
		}
	}
	   ...
	   OpenAPI_positioning_method_mdt_NULL)
	{
		...
		if(add_positioning_method_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [add_positioning_method_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			mdt_configuration->add_positioning_method_list, node) {
	   ...
	   OpenAPI_collection_period_rmm_lte_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [collection_period_rmm_lte]");
			goto end;
		}
	}
	   ...
	   OpenAPI_collection_period_rmm_nr_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [collection_period_rmm_nr]");
			goto end;
		}
	}
	   ...
	   OpenAPI_measurement_period_lte_mdt_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [measurement_period_lte]");
			goto end;
		}
	}
	...
	if(mdt_configuration->mdt_allowed_plmn_id_list) {
		...
		if(mdt_allowed_plmn_id_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [mdt_allowed_plmn_id_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			mdt_configuration->mdt_allowed_plmn_id_list, node) {
	...
	if(mdt_configuration->mbsfn_area_list) {
		...
		if(mbsfn_area_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [mbsfn_area_list]");
			goto end;
		}
		OpenAPI_list_for_each(mdt_configuration->mbsfn_area_list,
		                      node) {
	...
	if(mdt_configuration->inter_freq_target_list) {
		...
		if(inter_freq_target_listList == NULL) {
			ogs_error(
				"OpenAPI_mdt_configuration_convertToJSON() failed [inter_freq_target_list]");
			goto end;
		}
		OpenAPI_list_for_each(mdt_configuration->inter_freq_target_list,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_inter_freq_target_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_mdt_configuration_convertToJSON() failed [inter_freq_target_list]");
...
OpenAPI_mdt_configuration_t *OpenAPI_mdt_configuration_parseFromJSON(
	cJSON *mdt_configurationJSON) {
	...
	job_type = cJSON_GetObjectItemCaseSensitive(mdt_configurationJSON,
	                                            "jobType");
	if(!job_type) {
		ogs_error(
			"OpenAPI_mdt_configuration_parseFromJSON() failed [job_type]");
		goto end;
	}
	...
	report_type = cJSON_GetObjectItemCaseSensitive(mdt_configurationJSON,
	                                               "reportType");
	if(report_type) {
		if(!cJSON_IsString(report_type)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [report_type]");
			goto end;
		}
		report_typeVariable =
	...
	area_scope = cJSON_GetObjectItemCaseSensitive(mdt_configurationJSON,
	                                              "areaScope");
	if(area_scope) {
	...
	measurement_lte_list =
		cJSON_GetObjectItemCaseSensitive(mdt_configurationJSON,
		                                 "measurementLteList");
	if(measurement_lte_list) {
		cJSON *measurement_lte_list_local = NULL;
		if(!cJSON_IsArray(measurement_lte_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [measurement_lte_list]");
			goto end;
		}
		...
		if(measurement_lte_listList->count == 0) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed: Expected measurement_lte_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(measurement_nr_list) {
		...
		if(!cJSON_IsArray(measurement_nr_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [measurement_nr_list]");
			goto end;
		}
		...
		if(measurement_nr_listList->count == 0) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed: Expected measurement_nr_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(sensor_measurement_list) {
		...
		if(!cJSON_IsArray(sensor_measurement_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [sensor_measurement_list]");
			goto end;
		}
		...
		if(sensor_measurement_listList->count == 0) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed: Expected sensor_measurement_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(reporting_trigger_list) {
		...
		if(!cJSON_IsArray(reporting_trigger_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [reporting_trigger_list]");
			goto end;
		}
		...
		if(reporting_trigger_listList->count == 0) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed: Expected reporting_trigger_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(report_interval) {
		if(!cJSON_IsString(report_interval)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [report_interval]");
			goto end;
		}
	...
	if(report_interval_nr) {
		if(!cJSON_IsString(report_interval_nr)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [report_interval_nr]");
			goto end;
		}
	...
	report_amount = cJSON_GetObjectItemCaseSensitive(mdt_configurationJSON,
	                                                 "reportAmount");
	if(report_amount) {
		if(!cJSON_IsString(report_amount)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [report_amount]");
			goto end;
		}
	...
	if(event_threshold_rsrp) {
		if(!cJSON_IsNumber(event_threshold_rsrp)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrp]");
			goto end;
		}
	}
	...
	if(event_threshold_rsrp_nr) {
		if(!cJSON_IsNumber(event_threshold_rsrp_nr)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrp_nr]");
			goto end;
		}
	}
	...
	if(event_threshold_rsrq) {
		if(!cJSON_IsNumber(event_threshold_rsrq)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrq]");
			goto end;
		}
	}
	...
	if(event_threshold_rsrq_nr) {
		if(!cJSON_IsNumber(event_threshold_rsrq_nr)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [event_threshold_rsrq_nr]");
			goto end;
		}
	}

	event_list = cJSON_GetObjectItemCaseSensitive(mdt_configurationJSON,
	                                              "eventList");
	if(event_list) {
		cJSON *event_list_local = NULL;
		if(!cJSON_IsArray(event_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [event_list]");
			goto end;
		}
		...
		if(event_listList->count == 0) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed: Expected event_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(logging_interval) {
		if(!cJSON_IsString(logging_interval)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [logging_interval]");
			goto end;
		}
	...
	if(logging_interval_nr) {
		if(!cJSON_IsString(logging_interval_nr)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [logging_interval_nr]");
			goto end;
		}
	...
	if(logging_duration) {
		if(!cJSON_IsString(logging_duration)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [logging_duration]");
			goto end;
		}
	...
	if(logging_duration_nr) {
		if(!cJSON_IsString(logging_duration_nr)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [logging_duration_nr]");
			goto end;
		}
	...
	if(positioning_method) {
		if(!cJSON_IsString(positioning_method)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [positioning_method]");
			goto end;
		}
	...
	if(add_positioning_method_list) {
		...
		if(!cJSON_IsArray(add_positioning_method_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [add_positioning_method_list]");
			goto end;
		}
		...
		if(add_positioning_method_listList->count == 0) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed: Expected add_positioning_method_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(collection_period_rmm_lte) {
		if(!cJSON_IsString(collection_period_rmm_lte)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [collection_period_rmm_lte]");
			goto end;
		}
	...
	if(collection_period_rmm_nr) {
		if(!cJSON_IsString(collection_period_rmm_nr)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [collection_period_rmm_nr]");
			goto end;
		}
	...
	if(measurement_period_lte) {
		if(!cJSON_IsString(measurement_period_lte)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [measurement_period_lte]");
			goto end;
		}
	...
	if(mdt_allowed_plmn_id_list) {
		...
		if(!cJSON_IsArray(mdt_allowed_plmn_id_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [mdt_allowed_plmn_id_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(mdt_allowed_plmn_id_list_local,
			...
			OpenAPI_plmn_id_t *mdt_allowed_plmn_id_listItem =
	...
	if(mbsfn_area_list) {
		...
		if(!cJSON_IsArray(mbsfn_area_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [mbsfn_area_list]");
			goto end;
		}
	...
	if(inter_freq_target_list) {
		...
		if(!cJSON_IsArray(inter_freq_target_list)) {
			ogs_error(
				"OpenAPI_mdt_configuration_parseFromJSON() failed [inter_freq_target_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(inter_freq_target_list_local,
			...
			OpenAPI_inter_freq_target_info_t *
				...
				OpenAPI_inter_freq_target_info_parseFromJSON(
...
OpenAPI_mdt_configuration_t *OpenAPI_mdt_configuration_copy(
	OpenAPI_mdt_configuration_t *dst, OpenAPI_mdt_configuration_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
