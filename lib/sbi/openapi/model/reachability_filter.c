...
OpenAPI_reachability_filter_t *OpenAPI_reachability_filter_create() {
	OpenAPI_reachability_filter_t *reachability_filter_local_var =
		ogs_malloc(sizeof(OpenAPI_reachability_filter_t));
...
cJSON *OpenAPI_reachability_filter_convertToJSON(
	...
	if(reachability_filter == NULL) {
		ogs_error(
			"OpenAPI_reachability_filter_convertToJSON() failed [ReachabilityFilter]");
		return NULL;
	}
...
OpenAPI_reachability_filter_t *OpenAPI_reachability_filter_copy(
	OpenAPI_reachability_filter_t	*dst,
	OpenAPI_reachability_filter_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
