...
OpenAPI_nidd_information_1_t *OpenAPI_nidd_information_1_create(char	*af_id,
                                                                ...
                                                                char	*
                                                                ext_group_id) {
	OpenAPI_nidd_information_1_t *nidd_information_1_local_var =
		ogs_malloc(sizeof(OpenAPI_nidd_information_1_t));
...
cJSON *OpenAPI_nidd_information_1_convertToJSON(
	...
	if(nidd_information_1 == NULL) {
		ogs_error(
			"OpenAPI_nidd_information_1_convertToJSON() failed [NiddInformation_1]");
		return NULL;
	}
	...
	if(!nidd_information_1->af_id) {
		ogs_error(
			"OpenAPI_nidd_information_1_convertToJSON() failed [af_id]");
		return NULL;
	}
	...
	if(nidd_information_1->gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_nidd_information_1_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(nidd_information_1->ext_group_id) {
		if(cJSON_AddStringToObject(item, "extGroupId",
		                           nidd_information_1->ext_group_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nidd_information_1_convertToJSON() failed [ext_group_id]");
			goto end;
		}
	}
...
OpenAPI_nidd_information_1_t *OpenAPI_nidd_information_1_parseFromJSON(
	...
	af_id = cJSON_GetObjectItemCaseSensitive(nidd_information_1JSON,
	                                         "afId");
	if(!af_id) {
		ogs_error(
			"OpenAPI_nidd_information_1_parseFromJSON() failed [af_id]");
		goto end;
	}
	...
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_nidd_information_1_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}

	ext_group_id = cJSON_GetObjectItemCaseSensitive(nidd_information_1JSON,
	                                                "extGroupId");
	if(ext_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_nidd_information_1_parseFromJSON() failed [ext_group_id]");
			goto end;
		}
	}
