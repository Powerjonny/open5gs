...
typedef enum { OpenAPI_privacy_check_related_action_NULL = 0,
	       OpenAPI_privacy_check_related_action_LOCATION_NOT_ALLOWED,
	       ...
	       OpenAPI_privacy_check_related_action_LOCATION_ALLOWED_WITHOUT_RESPONSE,
	       OpenAPI_privacy_check_related_action_LOCATION_RESTRICTED_WITHOUT_RESPONSE }
