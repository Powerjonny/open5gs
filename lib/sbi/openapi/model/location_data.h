...
typedef enum { OpenAPI_location_data_REMOTEUEIND_NULL = 0,
	       OpenAPI_location_data_REMOTEUEIND__true }
OpenAPI_location_data_remote_ue_ind_e;

char * OpenAPI_location_data_remote_ue_ind_ToString(
	OpenAPI_location_data_remote_ue_ind_e remote_ue_ind);

OpenAPI_location_data_remote_ue_ind_e
OpenAPI_location_data_remote_ue_ind_FromString(char *remote_ue_ind);
typedef enum { OpenAPI_location_data_NRPPAPERIODICIND_NULL = 0,
	       OpenAPI_location_data_NRPPAPERIODICIND__true }
OpenAPI_location_data_nrppa_periodic_ind_e;

char * OpenAPI_location_data_nrppa_periodic_ind_ToString(
	OpenAPI_location_data_nrppa_periodic_ind_e nrppa_periodic_ind);

OpenAPI_location_data_nrppa_periodic_ind_e
OpenAPI_location_data_nrppa_periodic_ind_FromString(char *nrppa_periodic_ind);
