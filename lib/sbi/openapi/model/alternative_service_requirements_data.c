...
OpenAPI_alternative_service_requirements_data_create(
	...
	int pdb) {
	OpenAPI_alternative_service_requirements_data_t *
	        alternative_service_requirements_data_local_var =
		ogs_malloc(
			sizeof(OpenAPI_alternative_service_requirements_data_t));
	ogs_assert(alternative_service_requirements_data_local_var);

	alternative_service_requirements_data_local_var->alt_qos_param_set_ref =
...
void OpenAPI_alternative_service_requirements_data_free(
	...
	if(alternative_service_requirements_data->alt_qos_param_set_ref) {
		ogs_free(
			alternative_service_requirements_data->
			alt_qos_param_set_ref);
		alternative_service_requirements_data->alt_qos_param_set_ref =
			NULL;
	}
...
cJSON *OpenAPI_alternative_service_requirements_data_convertToJSON(
	...
	if(alternative_service_requirements_data == NULL) {
		ogs_error(
			"OpenAPI_alternative_service_requirements_data_convertToJSON() failed [AlternativeServiceRequirementsData]");
		return NULL;
	}
	...
	if(!alternative_service_requirements_data->alt_qos_param_set_ref) {
		ogs_error(
			"OpenAPI_alternative_service_requirements_data_convertToJSON() failed [alt_qos_param_set_ref]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "altQosParamSetRef",
	                           alternative_service_requirements_data->
	                           alt_qos_param_set_ref) == NULL)
	{
		ogs_error(
			"OpenAPI_alternative_service_requirements_data_convertToJSON() failed [alt_qos_param_set_ref]");
		goto end;
	...
	if(alternative_service_requirements_data->gbr_ul) {
		...
		{
			ogs_error(
				"OpenAPI_alternative_service_requirements_data_convertToJSON() failed [gbr_ul]");
			goto end;
		}
	}
	...
	if(alternative_service_requirements_data->gbr_dl) {
		...
		{
			ogs_error(
				"OpenAPI_alternative_service_requirements_data_convertToJSON() failed [gbr_dl]");
			goto end;
		}
	}
	...
	if(alternative_service_requirements_data->is_pdb) {
		...
		{
			ogs_error(
				"OpenAPI_alternative_service_requirements_data_convertToJSON() failed [pdb]");
			goto end;
		}
	}
...
OpenAPI_alternative_service_requirements_data_parseFromJSON(
	...
	OpenAPI_alternative_service_requirements_data_t *
	        alternative_service_requirements_data_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	alt_qos_param_set_ref =
		cJSON_GetObjectItemCaseSensitive(
			alternative_service_requirements_dataJSON,
			"altQosParamSetRef");
	if(!alt_qos_param_set_ref) {
		ogs_error(
			"OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [alt_qos_param_set_ref]");
		goto end;
	}
	...
	gbr_ul =
		cJSON_GetObjectItemCaseSensitive(
			alternative_service_requirements_dataJSON, "gbrUl");
	if(gbr_ul) {
		if(!cJSON_IsString(gbr_ul) &&
		   !cJSON_IsNull(gbr_ul))
		{
			ogs_error(
				"OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [gbr_ul]");
			goto end;
		}
	}
	...
	gbr_dl =
		cJSON_GetObjectItemCaseSensitive(
			alternative_service_requirements_dataJSON, "gbrDl");
	if(gbr_dl) {
		if(!cJSON_IsString(gbr_dl) &&
		   !cJSON_IsNull(gbr_dl))
		{
			ogs_error(
				"OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [gbr_dl]");
			goto end;
		}
	}
	...
	pdb =
		cJSON_GetObjectItemCaseSensitive(
			alternative_service_requirements_dataJSON, "pdb");
	if(pdb) {
		if(!cJSON_IsNumber(pdb)) {
			ogs_error(
				"OpenAPI_alternative_service_requirements_data_parseFromJSON() failed [pdb]");
			goto end;
		}
	}
...
OpenAPI_alternative_service_requirements_data_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_alternative_service_requirements_data_convertToJSON() failed");
		return NULL;
	}
