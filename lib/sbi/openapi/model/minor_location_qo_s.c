...
OpenAPI_minor_location_qo_s_t *OpenAPI_minor_location_qo_s_create(
	bool is_h_accuracy, float h_accuracy, bool is_v_accuracy,
	float v_accuracy) {
	OpenAPI_minor_location_qo_s_t *minor_location_qo_s_local_var =
		ogs_malloc(sizeof(OpenAPI_minor_location_qo_s_t));
...
void OpenAPI_minor_location_qo_s_free(
	OpenAPI_minor_location_qo_s_t *minor_location_qo_s) {
...
cJSON *OpenAPI_minor_location_qo_s_convertToJSON(
	OpenAPI_minor_location_qo_s_t *minor_location_qo_s) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(minor_location_qo_s == NULL) {
		ogs_error(
			"OpenAPI_minor_location_qo_s_convertToJSON() failed [MinorLocationQoS]");
		return NULL;
	}
	...
	if(minor_location_qo_s->is_h_accuracy) {
		...
		{
			ogs_error(
				"OpenAPI_minor_location_qo_s_convertToJSON() failed [h_accuracy]");
			goto end;
		}
	}
	...
	if(minor_location_qo_s->is_v_accuracy) {
		...
		{
			ogs_error(
				"OpenAPI_minor_location_qo_s_convertToJSON() failed [v_accuracy]");
			goto end;
		}
	}
...
OpenAPI_minor_location_qo_s_t *OpenAPI_minor_location_qo_s_parseFromJSON(
	...
	if(h_accuracy) {
		if(!cJSON_IsNumber(h_accuracy)) {
			ogs_error(
				"OpenAPI_minor_location_qo_s_parseFromJSON() failed [h_accuracy]");
			goto end;
		}
	}
	...
	if(v_accuracy) {
		if(!cJSON_IsNumber(v_accuracy)) {
			ogs_error(
				"OpenAPI_minor_location_qo_s_parseFromJSON() failed [v_accuracy]");
			goto end;
		}
	}
...
OpenAPI_minor_location_qo_s_t *OpenAPI_minor_location_qo_s_copy(
	OpenAPI_minor_location_qo_s_t	*dst,
	OpenAPI_minor_location_qo_s_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
