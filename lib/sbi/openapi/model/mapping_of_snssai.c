...
OpenAPI_mapping_of_snssai_t *OpenAPI_mapping_of_snssai_create(
	OpenAPI_snssai_t *serving_snssai, OpenAPI_snssai_t *home_snssai) {
	OpenAPI_mapping_of_snssai_t *mapping_of_snssai_local_var =
		ogs_malloc(sizeof(OpenAPI_mapping_of_snssai_t));
...
void OpenAPI_mapping_of_snssai_free(
	OpenAPI_mapping_of_snssai_t *mapping_of_snssai) {
...
cJSON *OpenAPI_mapping_of_snssai_convertToJSON(
	OpenAPI_mapping_of_snssai_t *mapping_of_snssai) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(mapping_of_snssai == NULL) {
		ogs_error(
			"OpenAPI_mapping_of_snssai_convertToJSON() failed [MappingOfSnssai]");
		return NULL;
	}
	...
	if(!mapping_of_snssai->serving_snssai) {
		ogs_error(
			"OpenAPI_mapping_of_snssai_convertToJSON() failed [serving_snssai]");
		return NULL;
	}
	cJSON *serving_snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(mapping_of_snssai->serving_snssai);
	...
	if(!mapping_of_snssai->home_snssai) {
		ogs_error(
			"OpenAPI_mapping_of_snssai_convertToJSON() failed [home_snssai]");
		return NULL;
	}
	cJSON *home_snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(mapping_of_snssai->home_snssai);
...
OpenAPI_mapping_of_snssai_t *OpenAPI_mapping_of_snssai_parseFromJSON(
	...
	serving_snssai = cJSON_GetObjectItemCaseSensitive(mapping_of_snssaiJSON,
	                                                  "servingSnssai");
	if(!serving_snssai) {
		ogs_error(
			"OpenAPI_mapping_of_snssai_parseFromJSON() failed [serving_snssai]");
		goto end;
	}
	...
	home_snssai = cJSON_GetObjectItemCaseSensitive(mapping_of_snssaiJSON,
	                                               "homeSnssai");
	if(!home_snssai) {
		ogs_error(
			"OpenAPI_mapping_of_snssai_parseFromJSON() failed [home_snssai]");
		goto end;
	}
...
OpenAPI_mapping_of_snssai_t *OpenAPI_mapping_of_snssai_copy(
	OpenAPI_mapping_of_snssai_t *dst, OpenAPI_mapping_of_snssai_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
