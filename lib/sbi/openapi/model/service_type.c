...
OpenAPI_service_type_t *OpenAPI_service_type_create() {
	OpenAPI_service_type_t *service_type_local_var =
...
cJSON *OpenAPI_service_type_convertToJSON(
	OpenAPI_service_type_t *service_type) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(service_type == NULL) {
		ogs_error(
			"OpenAPI_service_type_convertToJSON() failed [ServiceType]");
		return NULL;
	}
