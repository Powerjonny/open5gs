...
OpenAPI_lte_m_ind_t *OpenAPI_lte_m_ind_create(int lte_cat_m_ind) {
	OpenAPI_lte_m_ind_t *lte_m_ind_local_var =
		ogs_malloc(sizeof(OpenAPI_lte_m_ind_t));
...
cJSON *OpenAPI_lte_m_ind_convertToJSON(OpenAPI_lte_m_ind_t *lte_m_ind) {
	...
	{
		ogs_error(
			"OpenAPI_lte_m_ind_convertToJSON() failed [lte_cat_m_ind]");
		goto end;
	}
...
OpenAPI_lte_m_ind_t *OpenAPI_lte_m_ind_parseFromJSON(cJSON *lte_m_indJSON) {
	...
	if(!lte_cat_m_ind) {
		ogs_error(
			"OpenAPI_lte_m_ind_parseFromJSON() failed [lte_cat_m_ind]");
		goto end;
	}
