...
OpenAPI_additional_ee_subs_info_t *OpenAPI_additional_ee_subs_info_create(
	...
	OpenAPI_additional_ee_subs_info_t *additional_ee_subs_info_local_var =
		ogs_malloc(sizeof(OpenAPI_additional_ee_subs_info_t));
	...
	additional_ee_subs_info_local_var->smf_subscription_info =
		smf_subscription_info;
	additional_ee_subs_info_local_var->hss_subscription_info =
...
void OpenAPI_additional_ee_subs_info_free(
	...
	if(additional_ee_subs_info->smf_subscription_info) {
		OpenAPI_smf_subscription_info_free(
			additional_ee_subs_info->smf_subscription_info);
	...
	if(additional_ee_subs_info->hss_subscription_info) {
		OpenAPI_hss_subscription_info_free(
			additional_ee_subs_info->hss_subscription_info);
...
cJSON *OpenAPI_additional_ee_subs_info_convertToJSON(
	...
	if(additional_ee_subs_info == NULL) {
		ogs_error(
			"OpenAPI_additional_ee_subs_info_convertToJSON() failed [AdditionalEeSubsInfo]");
		return NULL;
	}
	...
	if(additional_ee_subs_info->amf_subscription_info_list) {
		...
		if(amf_subscription_info_listList == NULL) {
			ogs_error(
				"OpenAPI_additional_ee_subs_info_convertToJSON() failed [amf_subscription_info_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			additional_ee_subs_info->amf_subscription_info_list,
	...
	if(additional_ee_subs_info->smf_subscription_info) {
		...
		if(smf_subscription_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_additional_ee_subs_info_convertToJSON() failed [smf_subscription_info]");
			goto end;
		}
	...
	if(additional_ee_subs_info->hss_subscription_info) {
		...
		if(hss_subscription_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_additional_ee_subs_info_convertToJSON() failed [hss_subscription_info]");
			goto end;
		}
...
OpenAPI_additional_ee_subs_info_t *OpenAPI_additional_ee_subs_info_parseFromJSON
	...
	if(amf_subscription_info_list) {
		...
		if(!cJSON_IsArray(amf_subscription_info_list)) {
			ogs_error(
				"OpenAPI_additional_ee_subs_info_parseFromJSON() failed [amf_subscription_info_list]");
			goto end;
		}
	...
	additional_ee_subs_info_local_var =
		OpenAPI_additional_ee_subs_info_create(
			amf_subscription_info_list ?
			amf_subscription_info_listList :
			NULL,
			smf_subscription_info ?
			smf_subscription_info_local_nonprim :
			NULL,
...
OpenAPI_additional_ee_subs_info_t *OpenAPI_additional_ee_subs_info_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_additional_ee_subs_info_convertToJSON() failed");
		return NULL;
	}
