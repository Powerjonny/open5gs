...
OpenAPI_motion_event_info_t *OpenAPI_motion_event_info_create(
	int linear_distance, OpenAPI_occurrence_info_e occurrence_info,
	bool is_minimum_interval, int minimum_interval,
	bool is_maximum_interval, int maximum_interval,
	...
	OpenAPI_motion_event_info_t *motion_event_info_local_var =
		ogs_malloc(sizeof(OpenAPI_motion_event_info_t));
...
void OpenAPI_motion_event_info_free(
...
cJSON *OpenAPI_motion_event_info_convertToJSON(
	OpenAPI_motion_event_info_t *motion_event_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(motion_event_info == NULL) {
		ogs_error(
			"OpenAPI_motion_event_info_convertToJSON() failed [MotionEventInfo]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_motion_event_info_convertToJSON() failed [linear_distance]");
		goto end;
	}
	...
	if(motion_event_info->occurrence_info != OpenAPI_occurrence_info_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_motion_event_info_convertToJSON() failed [occurrence_info]");
			goto end;
		}
	}
	...
	if(motion_event_info->is_minimum_interval) {
		...
		{
			ogs_error(
				"OpenAPI_motion_event_info_convertToJSON() failed [minimum_interval]");
			goto end;
		}
	}
	...
	if(motion_event_info->is_maximum_interval) {
		...
		{
			ogs_error(
				"OpenAPI_motion_event_info_convertToJSON() failed [maximum_interval]");
			goto end;
		}
	}
	...
	if(motion_event_info->is_sampling_interval) {
		...
		{
			ogs_error(
				"OpenAPI_motion_event_info_convertToJSON() failed [sampling_interval]");
			goto end;
		}
	}
	...
	if(motion_event_info->is_reporting_duration) {
		...
		{
			ogs_error(
				"OpenAPI_motion_event_info_convertToJSON() failed [reporting_duration]");
			goto end;
		}
	}
	...
	if(motion_event_info->is_reporting_location_req) {
		...
		{
			ogs_error(
				"OpenAPI_motion_event_info_convertToJSON() failed [reporting_location_req]");
			goto end;
		}
	}
...
OpenAPI_motion_event_info_t *OpenAPI_motion_event_info_parseFromJSON(
	...
	linear_distance =
		cJSON_GetObjectItemCaseSensitive(motion_event_infoJSON,
		                                 "linearDistance");
	if(!linear_distance) {
		ogs_error(
			"OpenAPI_motion_event_info_parseFromJSON() failed [linear_distance]");
		goto end;
	}
	...
	if(occurrence_info) {
		if(!cJSON_IsString(occurrence_info)) {
			ogs_error(
				"OpenAPI_motion_event_info_parseFromJSON() failed [occurrence_info]");
			goto end;
		}
	...
	if(minimum_interval) {
		if(!cJSON_IsNumber(minimum_interval)) {
			ogs_error(
				"OpenAPI_motion_event_info_parseFromJSON() failed [minimum_interval]");
			goto end;
		}
	}
	...
	if(maximum_interval) {
		if(!cJSON_IsNumber(maximum_interval)) {
			ogs_error(
				"OpenAPI_motion_event_info_parseFromJSON() failed [maximum_interval]");
			goto end;
		}
	}
	...
	if(sampling_interval) {
		if(!cJSON_IsNumber(sampling_interval)) {
			ogs_error(
				"OpenAPI_motion_event_info_parseFromJSON() failed [sampling_interval]");
			goto end;
		}
	}
	...
	if(reporting_duration) {
		if(!cJSON_IsNumber(reporting_duration)) {
			ogs_error(
				"OpenAPI_motion_event_info_parseFromJSON() failed [reporting_duration]");
			goto end;
		}
	}
	...
	if(reporting_location_req) {
		if(!cJSON_IsBool(reporting_location_req)) {
			ogs_error(
				"OpenAPI_motion_event_info_parseFromJSON() failed [reporting_location_req]");
			goto end;
		}
	}
...
OpenAPI_motion_event_info_t *OpenAPI_motion_event_info_copy(
	OpenAPI_motion_event_info_t *dst, OpenAPI_motion_event_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
