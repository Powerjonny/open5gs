...
OpenAPI_sor_update_info_t *OpenAPI_sor_update_info_create(
	OpenAPI_plmn_id_t *vplmn_id, char *supported_features) {
	OpenAPI_sor_update_info_t *sor_update_info_local_var =
		ogs_malloc(sizeof(OpenAPI_sor_update_info_t));
...
cJSON *OpenAPI_sor_update_info_convertToJSON(
	OpenAPI_sor_update_info_t *sor_update_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(sor_update_info == NULL) {
		ogs_error(
			"OpenAPI_sor_update_info_convertToJSON() failed [SorUpdateInfo]");
		return NULL;
	}
	...
	if(!sor_update_info->vplmn_id) {
		ogs_error(
			"OpenAPI_sor_update_info_convertToJSON() failed [vplmn_id]");
		return NULL;
	}
	cJSON *vplmn_id_local_JSON =
		OpenAPI_plmn_id_convertToJSON(sor_update_info->vplmn_id);
	...
	if(sor_update_info->supported_features) {
		if(cJSON_AddStringToObject(item, "supportedFeatures",
		                           sor_update_info->supported_features)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sor_update_info_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_sor_update_info_t *OpenAPI_sor_update_info_parseFromJSON(
	cJSON *sor_update_infoJSON) {
	OpenAPI_sor_update_info_t *sor_update_info_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *vplmn_id = NULL;
	OpenAPI_plmn_id_t *vplmn_id_local_nonprim = NULL;
	cJSON *supported_features = NULL;
	vplmn_id = cJSON_GetObjectItemCaseSensitive(sor_update_infoJSON,
	                                            "vplmnId");
	if(!vplmn_id) {
		ogs_error(
			"OpenAPI_sor_update_info_parseFromJSON() failed [vplmn_id]");
		goto end;
	}
	...
	supported_features =
		cJSON_GetObjectItemCaseSensitive(sor_update_infoJSON,
		                                 "supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sor_update_info_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_sor_update_info_t *OpenAPI_sor_update_info_copy(
	OpenAPI_sor_update_info_t *dst, OpenAPI_sor_update_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
