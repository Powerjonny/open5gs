...
OpenAPI_assign_ebi_failed_t *OpenAPI_assign_ebi_failed_create(
	...
	OpenAPI_assign_ebi_failed_t *assign_ebi_failed_local_var =
		ogs_malloc(sizeof(OpenAPI_assign_ebi_failed_t));
...
void OpenAPI_assign_ebi_failed_free(
	OpenAPI_assign_ebi_failed_t *assign_ebi_failed) {
	...
	if(assign_ebi_failed->failed_arp_list) {
		OpenAPI_list_for_each(assign_ebi_failed->failed_arp_list,
		                      node) {
...
cJSON *OpenAPI_assign_ebi_failed_convertToJSON(
	OpenAPI_assign_ebi_failed_t *assign_ebi_failed) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(assign_ebi_failed == NULL) {
		ogs_error(
			"OpenAPI_assign_ebi_failed_convertToJSON() failed [AssignEbiFailed]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_assign_ebi_failed_convertToJSON() failed [pdu_session_id]");
		goto end;
	}
	...
	if(assign_ebi_failed->failed_arp_list) {
		...
		if(failed_arp_listList == NULL) {
			ogs_error(
				"OpenAPI_assign_ebi_failed_convertToJSON() failed [failed_arp_list]");
			goto end;
		}
		OpenAPI_list_for_each(assign_ebi_failed->failed_arp_list,
		                      node) {
...
OpenAPI_assign_ebi_failed_t *OpenAPI_assign_ebi_failed_parseFromJSON(
	...
	if(!pdu_session_id) {
		ogs_error(
			"OpenAPI_assign_ebi_failed_parseFromJSON() failed [pdu_session_id]");
		goto end;
	}
	...
	failed_arp_list =
		cJSON_GetObjectItemCaseSensitive(assign_ebi_failedJSON,
		                                 "failedArpList");
	if(failed_arp_list) {
		cJSON *failed_arp_list_local = NULL;
		if(!cJSON_IsArray(failed_arp_list)) {
			ogs_error(
				"OpenAPI_assign_ebi_failed_parseFromJSON() failed [failed_arp_list]");
			goto end;
		}
...
OpenAPI_assign_ebi_failed_t *OpenAPI_assign_ebi_failed_copy(
	OpenAPI_assign_ebi_failed_t *dst, OpenAPI_assign_ebi_failed_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
