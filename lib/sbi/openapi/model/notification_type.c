...
char * OpenAPI_notification_type_ToString(
	...
	const char *notification_typeArray[] = { "NULL", "N1_MESSAGES",
		                                 "N2_INFORMATION",
	...
	size_t sizeofArray = sizeof(notification_typeArray) /
	                     sizeof(notification_typeArray[0]);
...
OpenAPI_notification_type_e OpenAPI_notification_type_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(notification_type,
		          notification_typeArray[stringToReturn]) == 0) {
