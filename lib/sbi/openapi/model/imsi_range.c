...
OpenAPI_imsi_range_t *OpenAPI_imsi_range_create(char *start, char *end,
                                                char *pattern) {
	OpenAPI_imsi_range_t *imsi_range_local_var =
		ogs_malloc(sizeof(OpenAPI_imsi_range_t));
...
cJSON *OpenAPI_imsi_range_convertToJSON(OpenAPI_imsi_range_t *imsi_range) {
	...
	if(imsi_range == NULL) {
		ogs_error(
			"OpenAPI_imsi_range_convertToJSON() failed [ImsiRange]");
		return NULL;
	}
	...
	if(imsi_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_imsi_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(imsi_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_imsi_range_convertToJSON() failed [end]");
			goto end;
		}
	}
	...
	if(imsi_range->pattern) {
		...
		{
			ogs_error(
				"OpenAPI_imsi_range_convertToJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_imsi_range_t *OpenAPI_imsi_range_parseFromJSON(cJSON *imsi_rangeJSON) {
	...
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_imsi_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_imsi_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
	...
	if(pattern) {
		...
		{
			ogs_error(
				"OpenAPI_imsi_range_parseFromJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_imsi_range_t *OpenAPI_imsi_range_copy(OpenAPI_imsi_range_t	*dst,
                                              OpenAPI_imsi_range_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
