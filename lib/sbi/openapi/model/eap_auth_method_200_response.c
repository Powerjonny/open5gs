...
OpenAPI_eap_auth_method_200_response_create(
	bool		is_eap_payload_null,
	char		*eap_payload,
	OpenAPI_list_t	*_links) {
	OpenAPI_eap_auth_method_200_response_t *
	        eap_auth_method_200_response_local_var =
		ogs_malloc(sizeof(OpenAPI_eap_auth_method_200_response_t));
	ogs_assert(eap_auth_method_200_response_local_var);

	eap_auth_method_200_response_local_var->is_eap_payload_null =
		is_eap_payload_null;
...
void OpenAPI_eap_auth_method_200_response_free(
	OpenAPI_eap_auth_method_200_response_t *eap_auth_method_200_response) {
	...
	if(eap_auth_method_200_response->_links) {
		OpenAPI_list_for_each(eap_auth_method_200_response->_links,
		                      node) {
...
cJSON *OpenAPI_eap_auth_method_200_response_convertToJSON(
	OpenAPI_eap_auth_method_200_response_t *eap_auth_method_200_response) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(eap_auth_method_200_response == NULL) {
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_convertToJSON() failed [EapAuthMethod_200_response]");
		return NULL;
	}
	...
	if(!eap_auth_method_200_response->eap_payload) {
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_convertToJSON() failed [eap_payload]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "eapPayload",
	                           eap_auth_method_200_response->eap_payload) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_convertToJSON() failed [eap_payload]");
	...
	if(!eap_auth_method_200_response->_links) {
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_convertToJSON() failed [_links]");
		return NULL;
	}
	...
	if(eap_auth_method_200_response->_links) {
		OpenAPI_list_for_each(eap_auth_method_200_response->_links,
			...
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_eap_auth_method_200_response_convertToJSON() failed [inner]");
				goto end;
			}
...
OpenAPI_eap_auth_method_200_response_t *
OpenAPI_eap_auth_method_200_response_parseFromJSON(
	cJSON *eap_auth_method_200_responseJSON) {
	OpenAPI_eap_auth_method_200_response_t *
	        eap_auth_method_200_response_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	eap_payload =
		cJSON_GetObjectItemCaseSensitive(
			eap_auth_method_200_responseJSON, "eapPayload");
	if(!eap_payload) {
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_parseFromJSON() failed [eap_payload]");
		goto end;
	}
	...
	_links =
		cJSON_GetObjectItemCaseSensitive(
			eap_auth_method_200_responseJSON, "_links");
	if(!_links) {
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_parseFromJSON() failed [_links]");
		goto end;
	}
	...
	if(cJSON_IsObject(_links)) {
		...
		cJSON_ArrayForEach(_links_local_map, _links) {
			...
			if(cJSON_IsObject(localMapObject)) {
				...
				ogs_error(
					"OpenAPI_eap_auth_method_200_response_parseFromJSON() failed [inner]");
				goto end;
			}
...
OpenAPI_eap_auth_method_200_response_t *
OpenAPI_eap_auth_method_200_response_copy(
	OpenAPI_eap_auth_method_200_response_t	*dst,
	OpenAPI_eap_auth_method_200_response_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_eap_auth_method_200_response_convertToJSON() failed");
		return NULL;
	}
