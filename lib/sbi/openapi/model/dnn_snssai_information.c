...
OpenAPI_dnn_snssai_information_t *OpenAPI_dnn_snssai_information_create(
	char *dnn, OpenAPI_snssai_t *snssai) {
	OpenAPI_dnn_snssai_information_t *dnn_snssai_information_local_var =
		ogs_malloc(sizeof(OpenAPI_dnn_snssai_information_t));
...
void OpenAPI_dnn_snssai_information_free(
	OpenAPI_dnn_snssai_information_t *dnn_snssai_information) {
...
cJSON *OpenAPI_dnn_snssai_information_convertToJSON(
	OpenAPI_dnn_snssai_information_t *dnn_snssai_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(dnn_snssai_information == NULL) {
		ogs_error(
			"OpenAPI_dnn_snssai_information_convertToJSON() failed [DnnSnssaiInformation]");
		return NULL;
	}
	...
	if(dnn_snssai_information->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_dnn_snssai_information_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(dnn_snssai_information->snssai) {
		...
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_dnn_snssai_information_convertToJSON() failed [snssai]");
			goto end;
		}
...
OpenAPI_dnn_snssai_information_t *OpenAPI_dnn_snssai_information_parseFromJSON(
	cJSON *dnn_snssai_informationJSON) {
	OpenAPI_dnn_snssai_information_t *dnn_snssai_information_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *dnn = NULL;
	...
	dnn = cJSON_GetObjectItemCaseSensitive(dnn_snssai_informationJSON,
	                                       "dnn");
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_dnn_snssai_information_parseFromJSON() failed [dnn]");
			goto end;
		}
	}

	snssai = cJSON_GetObjectItemCaseSensitive(dnn_snssai_informationJSON,
	                                          "snssai");
	if(snssai) {
...
OpenAPI_dnn_snssai_information_t *OpenAPI_dnn_snssai_information_copy(
	OpenAPI_dnn_snssai_information_t	*dst,
	OpenAPI_dnn_snssai_information_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_dnn_snssai_information_convertToJSON() failed");
		return NULL;
	}
