...
OpenAPI_qos_monitoring_information_rm_create(bool	is_rep_thresh_dl,
                                             int	rep_thresh_dl,
	...
	OpenAPI_qos_monitoring_information_rm_t *
		...
		ogs_malloc(sizeof(OpenAPI_qos_monitoring_information_rm_t));
	ogs_assert(qos_monitoring_information_rm_local_var);

	qos_monitoring_information_rm_local_var->is_rep_thresh_dl =
		is_rep_thresh_dl;
	qos_monitoring_information_rm_local_var->rep_thresh_dl = rep_thresh_dl;
	qos_monitoring_information_rm_local_var->is_rep_thresh_ul =
		is_rep_thresh_ul;
	qos_monitoring_information_rm_local_var->rep_thresh_ul = rep_thresh_ul;
	qos_monitoring_information_rm_local_var->is_rep_thresh_rp =
		is_rep_thresh_rp;
...
void OpenAPI_qos_monitoring_information_rm_free(
	...
	OpenAPI_qos_monitoring_information_rm_t *qos_monitoring_information_rm)
{
	...
	if(qos_monitoring_information_rm == NULL) {
		ogs_error(
			"OpenAPI_qos_monitoring_information_rm_convertToJSON() failed [QosMonitoringInformationRm]");
		return NULL;
	}
	...
	if(qos_monitoring_information_rm->is_rep_thresh_dl) {
		if(cJSON_AddNumberToObject(item, "repThreshDl",
		                           qos_monitoring_information_rm->
		                           rep_thresh_dl) == NULL)
		{
			ogs_error(
				"OpenAPI_qos_monitoring_information_rm_convertToJSON() failed [rep_thresh_dl]");
			goto end;
		}
	}
	...
	if(qos_monitoring_information_rm->is_rep_thresh_ul) {
		...
		{
			ogs_error(
				"OpenAPI_qos_monitoring_information_rm_convertToJSON() failed [rep_thresh_ul]");
			goto end;
		}
	}
	...
	if(qos_monitoring_information_rm->is_rep_thresh_rp) {
		...
		{
			ogs_error(
				"OpenAPI_qos_monitoring_information_rm_convertToJSON() failed [rep_thresh_rp]");
			goto end;
		}
	}
...
OpenAPI_qos_monitoring_information_rm_parseFromJSON(
	cJSON *qos_monitoring_information_rmJSON) {
	OpenAPI_qos_monitoring_information_rm_t *
	        qos_monitoring_information_rm_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	rep_thresh_dl =
		cJSON_GetObjectItemCaseSensitive(
			qos_monitoring_information_rmJSON, "repThreshDl");
	if(rep_thresh_dl) {
		if(!cJSON_IsNumber(rep_thresh_dl)) {
			ogs_error(
				"OpenAPI_qos_monitoring_information_rm_parseFromJSON() failed [rep_thresh_dl]");
			goto end;
		}
	}
	...
	rep_thresh_ul =
		cJSON_GetObjectItemCaseSensitive(
			qos_monitoring_information_rmJSON, "repThreshUl");
	if(rep_thresh_ul) {
		if(!cJSON_IsNumber(rep_thresh_ul)) {
			ogs_error(
				"OpenAPI_qos_monitoring_information_rm_parseFromJSON() failed [rep_thresh_ul]");
			goto end;
		}
	}
	...
	rep_thresh_rp =
		cJSON_GetObjectItemCaseSensitive(
			qos_monitoring_information_rmJSON, "repThreshRp");
	if(rep_thresh_rp) {
...
OpenAPI_qos_monitoring_information_rm_t *
OpenAPI_qos_monitoring_information_rm_copy(
	OpenAPI_qos_monitoring_information_rm_t *dst,
	OpenAPI_qos_monitoring_information_rm_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_qos_monitoring_information_rm_convertToJSON() failed");
		return NULL;
	}
