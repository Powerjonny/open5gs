...
char * OpenAPI_restriction_type_ToString(
	...
	const char *restriction_typeArray[] = { "NULL", "ALLOWED_AREAS",
		                                "NOT_ALLOWED_AREAS" };
	size_t sizeofArray = sizeof(restriction_typeArray) /
	                     sizeof(restriction_typeArray[0]);
...
OpenAPI_restriction_type_e OpenAPI_restriction_type_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(restriction_type,
		          restriction_typeArray[stringToReturn]) == 0) {
