...
OpenAPI_pro_se_authentication_ctx_t *OpenAPI_pro_se_authentication_ctx_create(
	OpenAPI_auth_type_e auth_type, OpenAPI_list_t *_links,
	OpenAPI_pro_se_auth_data_t *pro_se_auth_data,
	char *supported_features) {
	OpenAPI_pro_se_authentication_ctx_t *pro_se_authentication_ctx_local_var
	        = ogs_malloc(sizeof(OpenAPI_pro_se_authentication_ctx_t));
	...
	pro_se_authentication_ctx_local_var->pro_se_auth_data =
		pro_se_auth_data;
	pro_se_authentication_ctx_local_var->supported_features =
		supported_features;

	return pro_se_authentication_ctx_local_var;
}

void OpenAPI_pro_se_authentication_ctx_free(
	OpenAPI_pro_se_authentication_ctx_t *pro_se_authentication_ctx) {
	...
	if(pro_se_authentication_ctx->pro_se_auth_data) {
		OpenAPI_pro_se_auth_data_free(
			pro_se_authentication_ctx->pro_se_auth_data);
...
cJSON *OpenAPI_pro_se_authentication_ctx_convertToJSON(
	OpenAPI_pro_se_authentication_ctx_t *pro_se_authentication_ctx) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pro_se_authentication_ctx == NULL) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [ProSeAuthenticationCtx]");
		return NULL;
	}
	...
	if(pro_se_authentication_ctx->auth_type == OpenAPI_auth_type_NULL) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [auth_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "authType",
	                           OpenAPI_auth_type_ToString(
					   pro_se_authentication_ctx->auth_type))
	   == NULL)
	{
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [auth_type]");
	...
	if(!pro_se_authentication_ctx->_links) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [_links]");
		return NULL;
	}
	...
	if(pro_se_authentication_ctx->_links) {
		OpenAPI_list_for_each(pro_se_authentication_ctx->_links, node) {
			...
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [inner]");
				goto end;
			}
	...
	if(!pro_se_authentication_ctx->pro_se_auth_data) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [pro_se_auth_data]");
		return NULL;
	}
	cJSON *pro_se_auth_data_local_JSON =
		OpenAPI_pro_se_auth_data_convertToJSON(
			pro_se_authentication_ctx->pro_se_auth_data);
	...
	cJSON_AddItemToObject(item, "proSeAuthData",
	                      pro_se_auth_data_local_JSON);
	if(item->child == NULL) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [pro_se_auth_data]");
		goto end;
	...
	if(pro_se_authentication_ctx->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_pro_se_authentication_ctx_parseFromJSON(
	cJSON *pro_se_authentication_ctxJSON) {
	OpenAPI_pro_se_authentication_ctx_t *pro_se_authentication_ctx_local_var
	        = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	auth_type =
		cJSON_GetObjectItemCaseSensitive(pro_se_authentication_ctxJSON,
		                                 "authType");
	if(!auth_type) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [auth_type]");
		goto end;
	}
	...
	_links = cJSON_GetObjectItemCaseSensitive(pro_se_authentication_ctxJSON,
	                                          "_links");
	if(!_links) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [_links]");
		goto end;
	}
	...
	if(cJSON_IsObject(_links)) {
		...
		cJSON_ArrayForEach(_links_local_map, _links) {
			...
			if(cJSON_IsObject(localMapObject)) {
				...
				ogs_error(
					"OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [inner]");
				goto end;
			}
	...
	if(!pro_se_auth_data) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [pro_se_auth_data]");
		goto end;
	}
	...
	if(!pro_se_auth_data_local_nonprim) {
		ogs_error(
			"OpenAPI_pro_se_auth_data_parseFromJSON failed [pro_se_auth_data]");
		goto end;
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pro_se_authentication_ctx_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	pro_se_authentication_ctx_local_var =
		OpenAPI_pro_se_authentication_ctx_create(
			auth_typeVariable,
			_linksList,
			pro_se_auth_data_local_nonprim,
			supported_features &&
...
OpenAPI_pro_se_authentication_ctx_t *OpenAPI_pro_se_authentication_ctx_copy(
	OpenAPI_pro_se_authentication_ctx_t	*dst,
	OpenAPI_pro_se_authentication_ctx_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pro_se_authentication_ctx_convertToJSON() failed");
		return NULL;
	}
