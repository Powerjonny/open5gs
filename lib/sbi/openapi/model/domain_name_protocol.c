...
OpenAPI_domain_name_protocol_t *OpenAPI_domain_name_protocol_create() {
	OpenAPI_domain_name_protocol_t *domain_name_protocol_local_var =
		ogs_malloc(sizeof(OpenAPI_domain_name_protocol_t));
...
void OpenAPI_domain_name_protocol_free(
	OpenAPI_domain_name_protocol_t *domain_name_protocol) {
...
cJSON *OpenAPI_domain_name_protocol_convertToJSON(
	OpenAPI_domain_name_protocol_t *domain_name_protocol) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(domain_name_protocol == NULL) {
		ogs_error(
			"OpenAPI_domain_name_protocol_convertToJSON() failed [DomainNameProtocol]");
		return NULL;
	}
...
OpenAPI_domain_name_protocol_t *OpenAPI_domain_name_protocol_copy(
	OpenAPI_domain_name_protocol_t	*dst,
	OpenAPI_domain_name_protocol_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_domain_name_protocol_convertToJSON() failed");
		return NULL;
	}
