...
typedef enum { OpenAPI_nef_cond_CONDITIONTYPE_NULL = 0,
	       OpenAPI_nef_cond_CONDITIONTYPE_NEF_COND }
OpenAPI_nef_cond_condition_type_e;

char * OpenAPI_nef_cond_condition_type_ToString(
	OpenAPI_nef_cond_condition_type_e condition_type);

OpenAPI_nef_cond_condition_type_e OpenAPI_nef_cond_condition_type_FromString(
	char *condition_type);
