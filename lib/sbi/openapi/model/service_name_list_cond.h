...
typedef enum { OpenAPI_service_name_list_cond_CONDITIONTYPE_NULL = 0,
	       OpenAPI_service_name_list_cond_CONDITIONTYPE_SERVICE_NAME_LIST_COND }
...
OpenAPI_service_name_list_cond_condition_type_e
OpenAPI_service_name_list_cond_condition_type_FromString(char *condition_type);
