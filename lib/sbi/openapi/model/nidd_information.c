...
OpenAPI_nidd_information_t *OpenAPI_nidd_information_create(char	*af_id,
                                                            char	*gpsi,
                                                            char	*
                                                            ext_group_id) {
	OpenAPI_nidd_information_t *nidd_information_local_var =
		ogs_malloc(sizeof(OpenAPI_nidd_information_t));
...
void OpenAPI_nidd_information_free(
	OpenAPI_nidd_information_t *nidd_information) {
...
cJSON *OpenAPI_nidd_information_convertToJSON(
	OpenAPI_nidd_information_t *nidd_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nidd_information == NULL) {
		ogs_error(
			"OpenAPI_nidd_information_convertToJSON() failed [NiddInformation]");
		return NULL;
	}
	...
	if(!nidd_information->af_id) {
		ogs_error(
			"OpenAPI_nidd_information_convertToJSON() failed [af_id]");
		return NULL;
	}
	...
	if(nidd_information->gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_nidd_information_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(nidd_information->ext_group_id) {
		if(cJSON_AddStringToObject(item, "extGroupId",
		                           nidd_information->ext_group_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nidd_information_convertToJSON() failed [ext_group_id]");
			goto end;
		}
	}
...
OpenAPI_nidd_information_t *OpenAPI_nidd_information_parseFromJSON(
	cJSON *nidd_informationJSON) {
	...
	if(!af_id) {
		ogs_error(
			"OpenAPI_nidd_information_parseFromJSON() failed [af_id]");
		goto end;
	}
	...
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_nidd_information_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}

	ext_group_id = cJSON_GetObjectItemCaseSensitive(nidd_informationJSON,
	                                                "extGroupId");
	if(ext_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_nidd_information_parseFromJSON() failed [ext_group_id]");
			goto end;
		}
	}
...
OpenAPI_nidd_information_t *OpenAPI_nidd_information_copy(
	OpenAPI_nidd_information_t *dst, OpenAPI_nidd_information_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
