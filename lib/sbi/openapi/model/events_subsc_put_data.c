...
OpenAPI_events_subsc_put_data_t *OpenAPI_events_subsc_put_data_create(
	OpenAPI_list_t *events, char *notif_uri,
	OpenAPI_list_t *req_qos_mon_params,
	OpenAPI_qos_monitoring_information_t *qos_mon, OpenAPI_list_t *req_anis,
	OpenAPI_usage_threshold_t *usg_thres, char *notif_corre_id,
	OpenAPI_list_t *af_app_ids, bool is_direct_notif_ind,
	int direct_notif_ind, OpenAPI_list_t *ad_reports,
	...
	OpenAPI_list_t *an_charg_ids, OpenAPI_an_gw_address_t *an_gw_addr,
	char *ev_subs_uri, OpenAPI_list_t *ev_notifs,
	...
	OpenAPI_list_t *out_of_cred_reports, OpenAPI_plmn_id_nid_t *plmn_id,
	OpenAPI_list_t *qnc_reports, OpenAPI_list_t *qos_mon_reports,
	OpenAPI_list_t *ran_nas_rel_causes, OpenAPI_rat_type_e rat_type,
	OpenAPI_satellite_backhaul_category_e sat_backhaul_category,
	OpenAPI_user_location_t *ue_loc, char *ue_loc_time, char *ue_time_zone,
	...
	OpenAPI_events_subsc_put_data_t *events_subsc_put_data_local_var =
		ogs_malloc(sizeof(OpenAPI_events_subsc_put_data_t));
	...
	events_subsc_put_data_local_var->req_qos_mon_params =
		req_qos_mon_params;
	...
	events_subsc_put_data_local_var->is_direct_notif_ind =
		is_direct_notif_ind;
	...
	events_subsc_put_data_local_var->failed_resourc_alloc_reports =
		failed_resourc_alloc_reports;
	events_subsc_put_data_local_var->succ_resourc_alloc_reports =
		succ_resourc_alloc_reports;
	events_subsc_put_data_local_var->no_net_loc_supp = no_net_loc_supp;
	events_subsc_put_data_local_var->out_of_cred_reports =
		out_of_cred_reports;
	...
	events_subsc_put_data_local_var->ran_nas_rel_causes =
		ran_nas_rel_causes;
	events_subsc_put_data_local_var->rat_type = rat_type;
	events_subsc_put_data_local_var->sat_backhaul_category =
	...
	events_subsc_put_data_local_var->tsn_bridge_man_cont =
		tsn_bridge_man_cont;
	events_subsc_put_data_local_var->tsn_port_man_cont_dstt =
		tsn_port_man_cont_dstt;
	events_subsc_put_data_local_var->tsn_port_man_cont_nwtts =
		tsn_port_man_cont_nwtts;

	return events_subsc_put_data_local_var;
}

void OpenAPI_events_subsc_put_data_free(
	...
	if(events_subsc_put_data->qos_mon) {
		OpenAPI_qos_monitoring_information_free(
			events_subsc_put_data->qos_mon);
	...
	if(events_subsc_put_data->failed_resourc_alloc_reports) {
		OpenAPI_list_for_each(
			events_subsc_put_data->failed_resourc_alloc_reports,
			node) {
	...
	if(events_subsc_put_data->qnc_reports) {
		OpenAPI_list_for_each(events_subsc_put_data->qnc_reports,
		                      node) {
	...
	if(events_subsc_put_data->qos_mon_reports) {
		OpenAPI_list_for_each(events_subsc_put_data->qos_mon_reports,
		                      node) {
	...
	if(events_subsc_put_data->ran_nas_rel_causes) {
		OpenAPI_list_for_each(events_subsc_put_data->ran_nas_rel_causes,
		                      node) {
	...
	if(events_subsc_put_data->tsn_bridge_man_cont) {
		OpenAPI_bridge_management_container_free(
			events_subsc_put_data->tsn_bridge_man_cont);
...
cJSON *OpenAPI_events_subsc_put_data_convertToJSON(
	...
	if(events_subsc_put_data == NULL) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_convertToJSON() failed [EventsSubscPutData]");
		return NULL;
	}
	...
	if(!events_subsc_put_data->events) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_convertToJSON() failed [events]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(events_subsc_put_data->events, node) {
		cJSON *itemLocal =
			OpenAPI_af_event_subscription_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [events]");
			goto end;
	...
	if(events_subsc_put_data->notif_uri) {
		if(cJSON_AddStringToObject(item, "notifUri",
		                           events_subsc_put_data->notif_uri) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [notif_uri]");
			goto end;
		}
	}

	if(events_subsc_put_data->req_qos_mon_params !=
	   OpenAPI_requested_qos_monitoring_parameter_NULL)
	{
		cJSON *req_qos_mon_paramsList = cJSON_AddArrayToObject(item,
		                                                       "reqQosMonParams");
		if(req_qos_mon_paramsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [req_qos_mon_params]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->req_qos_mon_params,
		                      node) {
			if(cJSON_AddStringToObject(req_qos_mon_paramsList, "",
	...
	if(events_subsc_put_data->qos_mon) {
		cJSON *qos_mon_local_JSON =
			OpenAPI_qos_monitoring_information_convertToJSON(
				events_subsc_put_data->qos_mon);
		if(qos_mon_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [qos_mon]");
			goto end;
		}
	...
	if(events_subsc_put_data->req_anis !=
	   OpenAPI_required_access_info_NULL)
	{
		cJSON *req_anisList = cJSON_AddArrayToObject(item, "reqAnis");
		if(req_anisList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [req_anis]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->req_anis, node) {
			if(cJSON_AddStringToObject(req_anisList, "",
			                           OpenAPI_required_access_info_ToString
			                                   ((intptr_t) node->
			                                   data)) == NULL)
			{
				ogs_error(
	...
	if(events_subsc_put_data->usg_thres) {
		cJSON *usg_thres_local_JSON =
			OpenAPI_usage_threshold_convertToJSON(
				events_subsc_put_data->usg_thres);
		if(usg_thres_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [usg_thres]");
			goto end;
		}
	...
	if(events_subsc_put_data->notif_corre_id) {
		if(cJSON_AddStringToObject(item, "notifCorreId",
		                           events_subsc_put_data->notif_corre_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [notif_corre_id]");
			goto end;
		}
	}

	if(events_subsc_put_data->af_app_ids) {
		cJSON *af_app_idsList = cJSON_AddArrayToObject(item,
		                                               "afAppIds");
		if(af_app_idsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [af_app_ids]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->af_app_ids, node) {
			if(cJSON_AddStringToObject(af_app_idsList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_events_subsc_put_data_convertToJSON() failed [af_app_ids]");
	...
	if(events_subsc_put_data->is_direct_notif_ind) {
		if(cJSON_AddBoolToObject(item, "directNotifInd",
		                         events_subsc_put_data->direct_notif_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [direct_notif_ind]");
			goto end;
		}
	}

	if(events_subsc_put_data->ad_reports) {
		cJSON *ad_reportsList = cJSON_AddArrayToObject(item,
		                                               "adReports");
		if(ad_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [ad_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->ad_reports, node) {
			cJSON *itemLocal =
				OpenAPI_app_detection_report_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_events_subsc_put_data_convertToJSON() failed [ad_reports]");
	...
	if(events_subsc_put_data->access_type != OpenAPI_access_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [access_type]");
			goto end;
		}
	}
	...
	if(events_subsc_put_data->add_access_info) {
		...
		if(add_access_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [add_access_info]");
			goto end;
		}
	...
	if(events_subsc_put_data->rel_access_info) {
		...
		if(rel_access_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [rel_access_info]");
			goto end;
		}
	...
	if(events_subsc_put_data->an_charg_addr) {
		cJSON *an_charg_addr_local_JSON =
			OpenAPI_acc_net_charging_address_convertToJSON(
				events_subsc_put_data->an_charg_addr);
		if(an_charg_addr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [an_charg_addr]");
			goto end;
		}
		cJSON_AddItemToObject(item, "anChargAddr",
		                      an_charg_addr_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [an_charg_addr]");
			goto end;
	...
	if(events_subsc_put_data->an_charg_ids) {
		cJSON *an_charg_idsList = cJSON_AddArrayToObject(item,
		                                                 "anChargIds");
		if(an_charg_idsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [an_charg_ids]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->an_charg_ids,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_access_net_charging_identifier_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_events_subsc_put_data_convertToJSON() failed [an_charg_ids]");
	...
	if(events_subsc_put_data->an_gw_addr) {
		cJSON *an_gw_addr_local_JSON =
			OpenAPI_an_gw_address_convertToJSON(
				events_subsc_put_data->an_gw_addr);
		if(an_gw_addr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [an_gw_addr]");
			goto end;
		}
	...
	if(!events_subsc_put_data->ev_subs_uri) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_convertToJSON() failed [ev_subs_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "evSubsUri",
	                           events_subsc_put_data->ev_subs_uri) == NULL)
	{
		ogs_error(
			"OpenAPI_events_subsc_put_data_convertToJSON() failed [ev_subs_uri]");
	...
	if(!events_subsc_put_data->ev_notifs) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_convertToJSON() failed [ev_notifs]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(events_subsc_put_data->ev_notifs, node) {
		cJSON *itemLocal =
			OpenAPI_af_event_notification_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [ev_notifs]");
			goto end;
	...
	if(events_subsc_put_data->failed_resourc_alloc_reports) {
		cJSON *failed_resourc_alloc_reportsList =
			cJSON_AddArrayToObject(item,
			                       "failedResourcAllocReports");
		if(failed_resourc_alloc_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [failed_resourc_alloc_reports]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_subsc_put_data->failed_resourc_alloc_reports,
			node) {
			cJSON *itemLocal =
				OpenAPI_resources_allocation_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_events_subsc_put_data_convertToJSON() failed [failed_resourc_alloc_reports]");
			...
			cJSON_AddItemToArray(failed_resourc_alloc_reportsList,
			                     itemLocal);
		}
	}

	if(events_subsc_put_data->succ_resourc_alloc_reports) {
		cJSON *succ_resourc_alloc_reportsList =
			cJSON_AddArrayToObject(item, "succResourcAllocReports");
		if(succ_resourc_alloc_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [succ_resourc_alloc_reports]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_subsc_put_data->succ_resourc_alloc_reports,
			...
			cJSON_AddItemToArray(succ_resourc_alloc_reportsList,
			                     itemLocal);
		}
	}

	if(events_subsc_put_data->no_net_loc_supp !=
	   OpenAPI_net_loc_access_support_NULL)
	{
		if(cJSON_AddStringToObject(item, "noNetLocSupp",
		                           OpenAPI_net_loc_access_support_ToString
		                                   (events_subsc_put_data->
		                                   no_net_loc_supp)) == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [no_net_loc_supp]");
			goto end;
		}
	}

	if(events_subsc_put_data->out_of_cred_reports) {
		cJSON *out_of_cred_reportsList = cJSON_AddArrayToObject(item,
		                                                        "outOfCredReports");
		if(out_of_cred_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [out_of_cred_reports]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_subsc_put_data->out_of_cred_reports, node) {
			cJSON *itemLocal =
				OpenAPI_out_of_credit_information_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_events_subsc_put_data_convertToJSON() failed [out_of_cred_reports]");
			...
			cJSON_AddItemToArray(out_of_cred_reportsList,
			                     itemLocal);
		}
	}
	...
	if(events_subsc_put_data->plmn_id) {
		cJSON *plmn_id_local_JSON =
			OpenAPI_plmn_id_nid_convertToJSON(
				events_subsc_put_data->plmn_id);
		if(plmn_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [plmn_id]");
			goto end;
		}
	...
	if(events_subsc_put_data->qnc_reports) {
		...
		if(qnc_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [qnc_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->qnc_reports,
		                      node) {
	...
	if(events_subsc_put_data->qos_mon_reports) {
		...
		if(qos_mon_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [qos_mon_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->qos_mon_reports,
		                      node) {
	...
	if(events_subsc_put_data->ran_nas_rel_causes) {
		cJSON *ran_nas_rel_causesList = cJSON_AddArrayToObject(item,
		                                                       "ranNasRelCauses");
		if(ran_nas_rel_causesList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [ran_nas_rel_causes]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_put_data->ran_nas_rel_causes,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_ran_nas_rel_cause_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_events_subsc_put_data_convertToJSON() failed [ran_nas_rel_causes]");
	...
	if(events_subsc_put_data->rat_type != OpenAPI_rat_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [rat_type]");
			goto end;
		}
	}

	if(events_subsc_put_data->sat_backhaul_category !=
	   OpenAPI_satellite_backhaul_category_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [sat_backhaul_category]");
			goto end;
		}
	}

	if(events_subsc_put_data->ue_loc) {
		cJSON *ue_loc_local_JSON =
			OpenAPI_user_location_convertToJSON(
				events_subsc_put_data->ue_loc);
		if(ue_loc_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [ue_loc]");
			goto end;
		}
	...
	if(events_subsc_put_data->ue_loc_time) {
		if(cJSON_AddStringToObject(item, "ueLocTime",
		                           events_subsc_put_data->ue_loc_time)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [ue_loc_time]");
			goto end;
		}
	}
	...
	if(events_subsc_put_data->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           events_subsc_put_data->ue_time_zone)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}

	if(events_subsc_put_data->usg_rep) {
		cJSON *usg_rep_local_JSON =
			OpenAPI_accumulated_usage_convertToJSON(
				events_subsc_put_data->usg_rep);
		if(usg_rep_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [usg_rep]");
			goto end;
		}
	...
	if(events_subsc_put_data->tsn_bridge_man_cont) {
		...
		if(tsn_bridge_man_cont_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [tsn_bridge_man_cont]");
			goto end;
		}
	...
	if(events_subsc_put_data->tsn_port_man_cont_dstt) {
		...
		if(tsn_port_man_cont_dstt_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [tsn_port_man_cont_dstt]");
			goto end;
		}
	...
	if(events_subsc_put_data->tsn_port_man_cont_nwtts) {
		...
		if(tsn_port_man_cont_nwttsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_convertToJSON() failed [tsn_port_man_cont_nwtts]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_subsc_put_data->tsn_port_man_cont_nwtts, node) {
...
OpenAPI_events_subsc_put_data_t *OpenAPI_events_subsc_put_data_parseFromJSON(
	cJSON *events_subsc_put_dataJSON) {
	...
	events = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                          "events");
	if(!events) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_parseFromJSON() failed [events]");
		goto end;
	}
	...
	cJSON_ArrayForEach(events_local, events) {
		...
		OpenAPI_af_event_subscription_t *eventsItem =
	...
	notif_uri = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                             "notifUri");
	if(notif_uri) {
		if(!cJSON_IsString(notif_uri) &&
		   !cJSON_IsNull(notif_uri))
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [notif_uri]");
			goto end;
		}
	}

	req_qos_mon_params =
		cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
		                                 "reqQosMonParams");
	if(req_qos_mon_params) {
		cJSON *req_qos_mon_params_local = NULL;
		if(!cJSON_IsArray(req_qos_mon_params)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [req_qos_mon_params]");
			goto end;
		}

		req_qos_mon_paramsList = OpenAPI_list_create();

		cJSON_ArrayForEach(req_qos_mon_params_local,
		                   req_qos_mon_params) {
			OpenAPI_requested_qos_monitoring_parameter_e localEnum =
				OpenAPI_requested_qos_monitoring_parameter_NULL;
			...
			localEnum =
				OpenAPI_requested_qos_monitoring_parameter_FromString
				        (req_qos_mon_params_local->valuestring);
			if(!localEnum) {
				ogs_info(
					"Enum value \"%s\" for field \"req_qos_mon_params\" is not supported. Ignoring it ...",
					req_qos_mon_params_local->valuestring);
			} else {
				OpenAPI_list_add(req_qos_mon_paramsList,
				                 (void *) localEnum);
			}
		}
		if(req_qos_mon_paramsList->count == 0) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed: Expected req_qos_mon_paramsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	qos_mon = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                           "qosMon");
	if(qos_mon) {
		qos_mon_local_nonprim =
			OpenAPI_qos_monitoring_information_parseFromJSON(
				qos_mon);
		if(!qos_mon_local_nonprim) {
			ogs_error(
				"OpenAPI_qos_monitoring_information_parseFromJSON failed [qos_mon]");
			goto end;
		}
	}

	req_anis = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                            "reqAnis");
	if(req_anis) {
		cJSON *req_anis_local = NULL;
		if(!cJSON_IsArray(req_anis)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [req_anis]");
			goto end;
		}
		...
		cJSON_ArrayForEach(req_anis_local, req_anis) {
			OpenAPI_required_access_info_e localEnum =
				OpenAPI_required_access_info_NULL;
			...
			if(!localEnum) {
				ogs_info(
					"Enum value \"%s\" for field \"req_anis\" is not supported. Ignoring it ...",
					req_anis_local->valuestring);
			} else {
				OpenAPI_list_add(req_anisList,
				                 (void *) localEnum);
			}
		}
		if(req_anisList->count == 0) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed: Expected req_anisList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	usg_thres = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                             "usgThres");
	if(usg_thres) {
		usg_thres_local_nonprim =
			OpenAPI_usage_threshold_parseFromJSON(usg_thres);
		if(!usg_thres_local_nonprim) {
			ogs_error(
				"OpenAPI_usage_threshold_parseFromJSON failed [usg_thres]");
			goto end;
		}
	}
	...
	if(notif_corre_id) {
		if(!cJSON_IsString(notif_corre_id) &&
		   !cJSON_IsNull(notif_corre_id))
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [notif_corre_id]");
			goto end;
		}
	}

	af_app_ids = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                              "afAppIds");
	if(af_app_ids) {
		cJSON *af_app_ids_local = NULL;
		if(!cJSON_IsArray(af_app_ids)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [af_app_ids]");
			goto end;
		}
		...
		cJSON_ArrayForEach(af_app_ids_local, af_app_ids) {
			...
			OpenAPI_list_add(af_app_idsList,
			                 ogs_strdup(
						 af_app_ids_local->valuestring));
		}
	}
	...
	if(direct_notif_ind) {
		if(!cJSON_IsBool(direct_notif_ind)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [direct_notif_ind]");
			goto end;
		}
	}

	ad_reports = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                              "adReports");
	if(ad_reports) {
		cJSON *ad_reports_local = NULL;
		if(!cJSON_IsArray(ad_reports)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [ad_reports]");
			goto end;
		}
		...
		cJSON_ArrayForEach(ad_reports_local, ad_reports) {
			...
			OpenAPI_app_detection_report_t *ad_reportsItem =
	...
	if(access_type) {
		if(!cJSON_IsString(access_type)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [access_type]");
			goto end;
		}
		access_typeVariable =
	...
	an_charg_addr =
		cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
		                                 "anChargAddr");
	if(an_charg_addr) {
		an_charg_addr_local_nonprim =
			OpenAPI_acc_net_charging_address_parseFromJSON(
				an_charg_addr);
		if(!an_charg_addr_local_nonprim) {
			ogs_error(
				"OpenAPI_acc_net_charging_address_parseFromJSON failed [an_charg_addr]");
			goto end;
		}
	}
	...
	if(an_charg_ids) {
		...
		if(!cJSON_IsArray(an_charg_ids)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [an_charg_ids]");
			goto end;
		}
	...
	an_gw_addr = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                              "anGwAddr");
	if(an_gw_addr) {
	...
	if(!ev_subs_uri) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_parseFromJSON() failed [ev_subs_uri]");
		goto end;
	}
	...
	ev_notifs = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                             "evNotifs");
	if(!ev_notifs) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_parseFromJSON() failed [ev_notifs]");
		goto end;
	}
	...
	cJSON_ArrayForEach(ev_notifs_local, ev_notifs) {
		...
		OpenAPI_af_event_notification_t *ev_notifsItem =
			OpenAPI_af_event_notification_parseFromJSON(
				ev_notifs_local);
		if(!ev_notifsItem) {
	...
	if(failed_resourc_alloc_reports) {
		...
		if(!cJSON_IsArray(failed_resourc_alloc_reports)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [failed_resourc_alloc_reports]");
			goto end;
		}

		failed_resourc_alloc_reportsList = OpenAPI_list_create();

		cJSON_ArrayForEach(failed_resourc_alloc_reports_local,
		                   failed_resourc_alloc_reports) {
			if(!cJSON_IsObject(
				   failed_resourc_alloc_reports_local))
			{
				ogs_error(
					"OpenAPI_events_subsc_put_data_parseFromJSON() failed [failed_resourc_alloc_reports]");
				goto end;
			...
			OpenAPI_resources_allocation_info_t *
			        failed_resourc_alloc_reportsItem =
				OpenAPI_resources_allocation_info_parseFromJSON(
					failed_resourc_alloc_reports_local);
			if(!failed_resourc_alloc_reportsItem) {
				ogs_error(
					"No failed_resourc_alloc_reportsItem");
				goto end;
			}
			OpenAPI_list_add(failed_resourc_alloc_reportsList,
			                 failed_resourc_alloc_reportsItem);
		}
	}
	...
	if(succ_resourc_alloc_reports) {
		...
		if(!cJSON_IsArray(succ_resourc_alloc_reports)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [succ_resourc_alloc_reports]");
			goto end;
		}

		succ_resourc_alloc_reportsList = OpenAPI_list_create();

		cJSON_ArrayForEach(succ_resourc_alloc_reports_local,
		                   succ_resourc_alloc_reports) {
			...
			OpenAPI_resources_allocation_info_t *
			        succ_resourc_alloc_reportsItem =
				OpenAPI_resources_allocation_info_parseFromJSON(
					succ_resourc_alloc_reports_local);
			if(!succ_resourc_alloc_reportsItem) {
				ogs_error("No succ_resourc_alloc_reportsItem");
				goto end;
			}
			OpenAPI_list_add(succ_resourc_alloc_reportsList,
			                 succ_resourc_alloc_reportsItem);
		}
	}
	...
	if(no_net_loc_supp) {
		if(!cJSON_IsString(no_net_loc_supp)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [no_net_loc_supp]");
			goto end;
		}
		no_net_loc_suppVariable =
			OpenAPI_net_loc_access_support_FromString(
				no_net_loc_supp->valuestring);
	}
	...
	if(out_of_cred_reports) {
		...
		if(!cJSON_IsArray(out_of_cred_reports)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [out_of_cred_reports]");
			goto end;
		}

		out_of_cred_reportsList = OpenAPI_list_create();

		cJSON_ArrayForEach(out_of_cred_reports_local,
		                   out_of_cred_reports) {
			...
			OpenAPI_out_of_credit_information_t *
			        out_of_cred_reportsItem =
				OpenAPI_out_of_credit_information_parseFromJSON(
					out_of_cred_reports_local);
			if(!out_of_cred_reportsItem) {
				ogs_error("No out_of_cred_reportsItem");
				goto end;
			}
			OpenAPI_list_add(out_of_cred_reportsList,
			                 out_of_cred_reportsItem);
		}
	}

	plmn_id = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                           "plmnId");
	if(plmn_id) {
	...
	if(qnc_reports) {
		...
		if(!cJSON_IsArray(qnc_reports)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [qnc_reports]");
			goto end;
		}
	...
	if(qos_mon_reports) {
		...
		if(!cJSON_IsArray(qos_mon_reports)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [qos_mon_reports]");
			goto end;
		}
	...
	if(ran_nas_rel_causes) {
		...
		if(!cJSON_IsArray(ran_nas_rel_causes)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [ran_nas_rel_causes]");
			goto end;
		}

		ran_nas_rel_causesList = OpenAPI_list_create();

		cJSON_ArrayForEach(ran_nas_rel_causes_local,
		                   ran_nas_rel_causes) {
			...
			OpenAPI_ran_nas_rel_cause_t *ran_nas_rel_causesItem =
				OpenAPI_ran_nas_rel_cause_parseFromJSON(
					ran_nas_rel_causes_local);
			if(!ran_nas_rel_causesItem) {
				ogs_error("No ran_nas_rel_causesItem");
				goto end;
			}
			OpenAPI_list_add(ran_nas_rel_causesList,
			                 ran_nas_rel_causesItem);
		}
	}

	rat_type = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                            "ratType");
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	if(sat_backhaul_category) {
		if(!cJSON_IsString(sat_backhaul_category)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [sat_backhaul_category]");
			goto end;
		}
	...
	ue_loc = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                          "ueLoc");
	if(ue_loc) {
		ue_loc_local_nonprim =
			OpenAPI_user_location_parseFromJSON(ue_loc);
		if(!ue_loc_local_nonprim) {
			ogs_error(
				"OpenAPI_user_location_parseFromJSON failed [ue_loc]");
			goto end;
		}
	}
	...
	ue_loc_time =
		cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
		                                 "ueLocTime");
	if(ue_loc_time) {
		if(!cJSON_IsString(ue_loc_time) &&
		   !cJSON_IsNull(ue_loc_time))
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [ue_loc_time]");
			goto end;
		}
	}
	...
	if(ue_time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}

	usg_rep = cJSON_GetObjectItemCaseSensitive(events_subsc_put_dataJSON,
	                                           "usgRep");
	if(usg_rep) {
		usg_rep_local_nonprim =
			OpenAPI_accumulated_usage_parseFromJSON(usg_rep);
		if(!usg_rep_local_nonprim) {
			ogs_error(
				"OpenAPI_accumulated_usage_parseFromJSON failed [usg_rep]");
			goto end;
		}
	}
	...
	if(tsn_port_man_cont_nwtts) {
		...
		if(!cJSON_IsArray(tsn_port_man_cont_nwtts)) {
			ogs_error(
				"OpenAPI_events_subsc_put_data_parseFromJSON() failed [tsn_port_man_cont_nwtts]");
			goto end;
		}
	...
	events_subsc_put_data_local_var = OpenAPI_events_subsc_put_data_create(
		eventsList,
		notif_uri &&
		!cJSON_IsNull(notif_uri) ? ogs_strdup(notif_uri->valuestring) :
		NULL,
		...
		notif_corre_id &&
		!cJSON_IsNull(notif_corre_id) ?
		ogs_strdup(notif_corre_id->valuestring) : NULL,
		...
		succ_resourc_alloc_reports ? succ_resourc_alloc_reportsList :
		NULL,
		...
		ue_loc_time &&
		!cJSON_IsNull(ue_loc_time) ?
		ogs_strdup(ue_loc_time->valuestring) : NULL,
		ue_time_zone &&
		!cJSON_IsNull(ue_time_zone) ?
		...
		tsn_port_man_cont_dstt ? tsn_port_man_cont_dstt_local_nonprim :
		NULL,
...
OpenAPI_events_subsc_put_data_t *OpenAPI_events_subsc_put_data_copy(
	OpenAPI_events_subsc_put_data_t *dst,
	OpenAPI_events_subsc_put_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_events_subsc_put_data_convertToJSON() failed");
		return NULL;
	}
