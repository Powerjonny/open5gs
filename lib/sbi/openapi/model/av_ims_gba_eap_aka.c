...
OpenAPI_av_ims_gba_eap_aka_t *OpenAPI_av_ims_gba_eap_aka_create(
	OpenAPI_hss_av_type_e av_type, char *rand, char *xres, char *autn,
	char *ck, char *ik) {
	OpenAPI_av_ims_gba_eap_aka_t *av_ims_gba_eap_aka_local_var =
...
void OpenAPI_av_ims_gba_eap_aka_free(
	OpenAPI_av_ims_gba_eap_aka_t *av_ims_gba_eap_aka) {
...
cJSON *OpenAPI_av_ims_gba_eap_aka_convertToJSON(
	OpenAPI_av_ims_gba_eap_aka_t *av_ims_gba_eap_aka) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(av_ims_gba_eap_aka == NULL) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [AvImsGbaEapAka]");
		return NULL;
	}
	...
	if(av_ims_gba_eap_aka->av_type == OpenAPI_hss_av_type_NULL) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [av_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "avType",
	                           OpenAPI_hss_av_type_ToString(
					   av_ims_gba_eap_aka->av_type)) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [av_type]");
	...
	if(!av_ims_gba_eap_aka->rand) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [rand]");
		return NULL;
	}
	...
	if(!av_ims_gba_eap_aka->xres) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [xres]");
		return NULL;
	}
	...
	if(!av_ims_gba_eap_aka->autn) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [autn]");
		return NULL;
	}
	...
	if(!av_ims_gba_eap_aka->ck) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [ck]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "ck",
	                           av_ims_gba_eap_aka->ck) == NULL)
	{
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [ck]");
	...
	if(!av_ims_gba_eap_aka->ik) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [ik]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "ik",
	                           av_ims_gba_eap_aka->ik) == NULL)
	{
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_convertToJSON() failed [ik]");
...
OpenAPI_av_ims_gba_eap_aka_t *OpenAPI_av_ims_gba_eap_aka_parseFromJSON(
	cJSON *av_ims_gba_eap_akaJSON) {
	...
	cJSON *ck = NULL;
	cJSON *ik = NULL;
	av_type = cJSON_GetObjectItemCaseSensitive(av_ims_gba_eap_akaJSON,
	                                           "avType");
	if(!av_type) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [av_type]");
		goto end;
	}
	...
	if(!rand) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [rand]");
		goto end;
	}
	...
	if(!xres) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [xres]");
		goto end;
	}
	...
	if(!autn) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [autn]");
		goto end;
	}
	...
	if(!ck) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [ck]");
		goto end;
	}
	...
	if(!ik) {
		ogs_error(
			"OpenAPI_av_ims_gba_eap_aka_parseFromJSON() failed [ik]");
		goto end;
	}
...
OpenAPI_av_ims_gba_eap_aka_t *OpenAPI_av_ims_gba_eap_aka_copy(
	OpenAPI_av_ims_gba_eap_aka_t *dst, OpenAPI_av_ims_gba_eap_aka_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
