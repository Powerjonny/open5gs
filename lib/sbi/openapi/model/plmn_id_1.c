...
OpenAPI_plmn_id_1_t *OpenAPI_plmn_id_1_create(char *mcc, char *mnc) {
	OpenAPI_plmn_id_1_t *plmn_id_1_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_id_1_t));
...
cJSON *OpenAPI_plmn_id_1_convertToJSON(OpenAPI_plmn_id_1_t *plmn_id_1) {
	...
	if(plmn_id_1 == NULL) {
		ogs_error(
			"OpenAPI_plmn_id_1_convertToJSON() failed [PlmnId_1]");
		return NULL;
	}
...
OpenAPI_plmn_id_1_t *OpenAPI_plmn_id_1_copy(OpenAPI_plmn_id_1_t *dst,
                                            OpenAPI_plmn_id_1_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
