...
OpenAPI_af_routing_requirement_rm_t *OpenAPI_af_routing_requirement_rm_create(
	bool is_app_reloc, int app_reloc, bool is_route_to_locs_null,
	OpenAPI_list_t *route_to_locs, bool is_sp_val_null,
	OpenAPI_spatial_validity_rm_t *sp_val, bool is_temp_vals_null,
	OpenAPI_list_t *temp_vals, bool is_up_path_chg_sub_null,
	OpenAPI_up_path_chg_event_t *up_path_chg_sub,
	bool is_addr_preser_ind_null, bool is_addr_preser_ind,
	int addr_preser_ind, bool is_sim_conn_ind_null, bool is_sim_conn_ind,
	int sim_conn_ind, bool is_sim_conn_term_null, bool is_sim_conn_term,
	int sim_conn_term, bool is_eas_ip_replace_infos_null,
	OpenAPI_list_t *eas_ip_replace_infos, bool is_eas_redis_ind,
	int eas_redis_ind, bool is_max_allowed_up_lat_null,
	bool is_max_allowed_up_lat, int max_allowed_up_lat) {
	OpenAPI_af_routing_requirement_rm_t *af_routing_requirement_rm_local_var
	        = ogs_malloc(sizeof(OpenAPI_af_routing_requirement_rm_t));
	...
	af_routing_requirement_rm_local_var->is_route_to_locs_null =
	...
	af_routing_requirement_rm_local_var->is_temp_vals_null =
		is_temp_vals_null;
	af_routing_requirement_rm_local_var->temp_vals = temp_vals;
	af_routing_requirement_rm_local_var->is_up_path_chg_sub_null =
		is_up_path_chg_sub_null;
	af_routing_requirement_rm_local_var->up_path_chg_sub = up_path_chg_sub;
	af_routing_requirement_rm_local_var->is_addr_preser_ind_null =
		is_addr_preser_ind_null;
	af_routing_requirement_rm_local_var->is_addr_preser_ind =
		is_addr_preser_ind;
	af_routing_requirement_rm_local_var->addr_preser_ind = addr_preser_ind;
	af_routing_requirement_rm_local_var->is_sim_conn_ind_null =
		is_sim_conn_ind_null;
	...
	af_routing_requirement_rm_local_var->is_sim_conn_term_null =
	...
	af_routing_requirement_rm_local_var->is_eas_ip_replace_infos_null =
		is_eas_ip_replace_infos_null;
	af_routing_requirement_rm_local_var->eas_ip_replace_infos =
		eas_ip_replace_infos;
	af_routing_requirement_rm_local_var->is_eas_redis_ind =
		is_eas_redis_ind;
	af_routing_requirement_rm_local_var->eas_redis_ind = eas_redis_ind;
	af_routing_requirement_rm_local_var->is_max_allowed_up_lat_null =
		is_max_allowed_up_lat_null;
	af_routing_requirement_rm_local_var->is_max_allowed_up_lat =
		is_max_allowed_up_lat;
	af_routing_requirement_rm_local_var->max_allowed_up_lat =
		max_allowed_up_lat;

	return af_routing_requirement_rm_local_var;
}

void OpenAPI_af_routing_requirement_rm_free(
	OpenAPI_af_routing_requirement_rm_t *af_routing_requirement_rm) {
	...
	if(af_routing_requirement_rm->route_to_locs) {
		OpenAPI_list_for_each(af_routing_requirement_rm->route_to_locs,
		                      node) {
	...
	if(af_routing_requirement_rm->sp_val) {
		OpenAPI_spatial_validity_rm_free(
			af_routing_requirement_rm->sp_val);
		af_routing_requirement_rm->sp_val = NULL;
	}
	if(af_routing_requirement_rm->temp_vals) {
		OpenAPI_list_for_each(af_routing_requirement_rm->temp_vals,
		                      node) {
...
cJSON *OpenAPI_af_routing_requirement_rm_convertToJSON(
	...
	if(af_routing_requirement_rm == NULL) {
		ogs_error(
			"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [AfRoutingRequirementRm]");
		return NULL;
	}
	...
	if(af_routing_requirement_rm->is_app_reloc) {
		if(cJSON_AddBoolToObject(item, "appReloc",
		                         af_routing_requirement_rm->app_reloc)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [app_reloc]");
			goto end;
		}
	}
	...
	if(af_routing_requirement_rm->route_to_locs) {
		...
		if(route_to_locsList == NULL) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [route_to_locs]");
			goto end;
		}
		OpenAPI_list_for_each(af_routing_requirement_rm->route_to_locs,
		                      node) {
	...
	if(af_routing_requirement_rm->sp_val) {
		cJSON *sp_val_local_JSON =
			OpenAPI_spatial_validity_rm_convertToJSON(
				af_routing_requirement_rm->sp_val);
		if(sp_val_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [sp_val]");
			goto end;
		}
	...
	if(af_routing_requirement_rm->temp_vals) {
		...
		if(temp_valsList == NULL) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [temp_vals]");
			goto end;
		}
		OpenAPI_list_for_each(af_routing_requirement_rm->temp_vals,
		                      node) {
	...
	if(af_routing_requirement_rm->up_path_chg_sub) {
		cJSON *up_path_chg_sub_local_JSON =
			OpenAPI_up_path_chg_event_convertToJSON(
				af_routing_requirement_rm->up_path_chg_sub);
		if(up_path_chg_sub_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [up_path_chg_sub]");
			goto end;
		}
		cJSON_AddItemToObject(item, "upPathChgSub",
		                      up_path_chg_sub_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [up_path_chg_sub]");
			goto end;
	...
	if(af_routing_requirement_rm->is_addr_preser_ind) {
		...
		{
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [addr_preser_ind]");
			goto end;
		}
	...
	if(af_routing_requirement_rm->is_sim_conn_ind) {
		if(cJSON_AddBoolToObject(item, "simConnInd",
		                         af_routing_requirement_rm->sim_conn_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [sim_conn_ind]");
			goto end;
		}
	...
	if(af_routing_requirement_rm->is_sim_conn_term) {
		...
		{
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [sim_conn_term]");
			goto end;
		}
	...
	if(af_routing_requirement_rm->eas_ip_replace_infos) {
		...
		if(eas_ip_replace_infosList == NULL) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [eas_ip_replace_infos]");
			goto end;
		}
		OpenAPI_list_for_each(
			af_routing_requirement_rm->eas_ip_replace_infos, node) {
	...
	if(af_routing_requirement_rm->is_eas_redis_ind) {
		...
		{
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [eas_redis_ind]");
			goto end;
		}
	}
	...
	if(af_routing_requirement_rm->is_max_allowed_up_lat) {
		...
		{
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_convertToJSON() failed [max_allowed_up_lat]");
			goto end;
		}
...
OpenAPI_af_routing_requirement_rm_parseFromJSON(
	cJSON *af_routing_requirement_rmJSON) {
	OpenAPI_af_routing_requirement_rm_t *af_routing_requirement_rm_local_var
	        = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	app_reloc =
		cJSON_GetObjectItemCaseSensitive(af_routing_requirement_rmJSON,
		                                 "appReloc");
	if(app_reloc) {
		if(!cJSON_IsBool(app_reloc)) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [app_reloc]");
			goto end;
		}
	}
	...
	if(route_to_locs) {
		if(!cJSON_IsNull(route_to_locs)) {
			...
			if(!cJSON_IsArray(route_to_locs)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [route_to_locs]");
				goto end;
			}
	...
	sp_val = cJSON_GetObjectItemCaseSensitive(af_routing_requirement_rmJSON,
	                                          "spVal");
	if(sp_val) {
		if(!cJSON_IsNull(sp_val)) {
			sp_val_local_nonprim =
				OpenAPI_spatial_validity_rm_parseFromJSON(
					sp_val);
			if(!sp_val_local_nonprim) {
				ogs_error(
					"OpenAPI_spatial_validity_rm_parseFromJSON failed [sp_val]");
				goto end;
			}
		}
	}
	...
	if(temp_vals) {
		if(!cJSON_IsNull(temp_vals)) {
			...
			if(!cJSON_IsArray(temp_vals)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [temp_vals]");
				goto end;
			}
			...
			cJSON_ArrayForEach(temp_vals_local, temp_vals) {
				...
				OpenAPI_temporal_validity_t *temp_valsItem =
	...
	if(up_path_chg_sub) {
		if(!cJSON_IsNull(up_path_chg_sub)) {
			up_path_chg_sub_local_nonprim =
				OpenAPI_up_path_chg_event_parseFromJSON(
					up_path_chg_sub);
			if(!up_path_chg_sub_local_nonprim) {
				ogs_error(
					"OpenAPI_up_path_chg_event_parseFromJSON failed [up_path_chg_sub]");
				goto end;
			}
		}
	}
	...
	if(addr_preser_ind) {
		if(!cJSON_IsNull(addr_preser_ind)) {
			if(!cJSON_IsBool(addr_preser_ind)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [addr_preser_ind]");
				goto end;
			}
		}
	}
	...
	if(sim_conn_ind) {
		if(!cJSON_IsNull(sim_conn_ind)) {
			if(!cJSON_IsBool(sim_conn_ind)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [sim_conn_ind]");
				goto end;
			}
		}
	}
	...
	if(sim_conn_term) {
		if(!cJSON_IsNull(sim_conn_term)) {
			if(!cJSON_IsNumber(sim_conn_term)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [sim_conn_term]");
				goto end;
			}
		}
	}
	...
	if(eas_ip_replace_infos) {
		if(!cJSON_IsNull(eas_ip_replace_infos)) {
			...
			if(!cJSON_IsArray(eas_ip_replace_infos)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [eas_ip_replace_infos]");
				goto end;
			}
	...
	if(eas_redis_ind) {
		if(!cJSON_IsBool(eas_redis_ind)) {
			ogs_error(
				"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [eas_redis_ind]");
			goto end;
		}
	}
	...
	if(max_allowed_up_lat) {
		if(!cJSON_IsNull(max_allowed_up_lat)) {
			if(!cJSON_IsNumber(max_allowed_up_lat)) {
				ogs_error(
					"OpenAPI_af_routing_requirement_rm_parseFromJSON() failed [max_allowed_up_lat]");
				goto end;
			}
		}
	}
	...
	af_routing_requirement_rm_local_var =
		OpenAPI_af_routing_requirement_rm_create(
			...
			sp_val &&
			cJSON_IsNull(sp_val) ? true : false,
			sp_val ? sp_val_local_nonprim : NULL,
			temp_vals &&
			cJSON_IsNull(temp_vals) ? true : false,
			temp_vals ? temp_valsList : NULL,
			up_path_chg_sub &&
			cJSON_IsNull(up_path_chg_sub) ? true : false,
			...
			sim_conn_ind &&
			cJSON_IsNull(sim_conn_ind) ? true : false,
...
OpenAPI_af_routing_requirement_rm_t *OpenAPI_af_routing_requirement_rm_copy(
	OpenAPI_af_routing_requirement_rm_t	*dst,
	OpenAPI_af_routing_requirement_rm_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_af_routing_requirement_rm_convertToJSON() failed");
		return NULL;
	}
