...
OpenAPI_events_subsc_req_data_t *OpenAPI_events_subsc_req_data_create(
	...
	OpenAPI_events_subsc_req_data_t *events_subsc_req_data_local_var =
		ogs_malloc(sizeof(OpenAPI_events_subsc_req_data_t));
	...
	events_subsc_req_data_local_var->req_qos_mon_params =
		req_qos_mon_params;
	...
	events_subsc_req_data_local_var->is_direct_notif_ind =
		is_direct_notif_ind;
...
void OpenAPI_events_subsc_req_data_free(
	OpenAPI_events_subsc_req_data_t *events_subsc_req_data) {
...
cJSON *OpenAPI_events_subsc_req_data_convertToJSON(
	OpenAPI_events_subsc_req_data_t *events_subsc_req_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(events_subsc_req_data == NULL) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_convertToJSON() failed [EventsSubscReqData]");
		return NULL;
	}
	...
	if(!events_subsc_req_data->events) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_convertToJSON() failed [events]");
		return NULL;
	}
	...
	if(events_subsc_req_data->notif_uri) {
		if(cJSON_AddStringToObject(item, "notifUri",
		                           events_subsc_req_data->notif_uri) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [notif_uri]");
			goto end;
		}
	}
	   ...
	   OpenAPI_requested_qos_monitoring_parameter_NULL)
	{
		...
		if(req_qos_mon_paramsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [req_qos_mon_params]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_req_data->req_qos_mon_params,
		                      node) {
	...
	if(events_subsc_req_data->qos_mon) {
		...
		if(qos_mon_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [qos_mon]");
			goto end;
		}
	   ...
	   OpenAPI_required_access_info_NULL)
	{
		...
		if(req_anisList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [req_anis]");
			goto end;
		}
	...
	if(events_subsc_req_data->usg_thres) {
		cJSON *usg_thres_local_JSON =
			OpenAPI_usage_threshold_convertToJSON(
				events_subsc_req_data->usg_thres);
		if(usg_thres_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [usg_thres]");
			goto end;
		}
	...
	if(events_subsc_req_data->notif_corre_id) {
		if(cJSON_AddStringToObject(item, "notifCorreId",
		                           events_subsc_req_data->notif_corre_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [notif_corre_id]");
			goto end;
		}
	}
	...
	if(events_subsc_req_data->af_app_ids) {
		...
		if(af_app_idsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [af_app_ids]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_req_data->af_app_ids, node) {
	...
	if(events_subsc_req_data->is_direct_notif_ind) {
		if(cJSON_AddBoolToObject(item, "directNotifInd",
		                         events_subsc_req_data->direct_notif_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_convertToJSON() failed [direct_notif_ind]");
			goto end;
		}
	}
...
OpenAPI_events_subsc_req_data_t *OpenAPI_events_subsc_req_data_parseFromJSON(
	...
	if(!events) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_parseFromJSON() failed [events]");
		goto end;
	}
	...
	notif_uri = cJSON_GetObjectItemCaseSensitive(events_subsc_req_dataJSON,
	                                             "notifUri");
	if(notif_uri) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed [notif_uri]");
			goto end;
		}
	}
	...
	if(req_qos_mon_params) {
		...
		if(!cJSON_IsArray(req_qos_mon_params)) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed [req_qos_mon_params]");
			goto end;
		}
		...
		if(req_qos_mon_paramsList->count == 0) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed: Expected req_qos_mon_paramsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	qos_mon = cJSON_GetObjectItemCaseSensitive(events_subsc_req_dataJSON,
	                                           "qosMon");
	if(qos_mon) {
	...
	req_anis = cJSON_GetObjectItemCaseSensitive(events_subsc_req_dataJSON,
	                                            "reqAnis");
	if(req_anis) {
		cJSON *req_anis_local = NULL;
		if(!cJSON_IsArray(req_anis)) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed [req_anis]");
			goto end;
		}
		...
		if(req_anisList->count == 0) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed: Expected req_anisList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	usg_thres = cJSON_GetObjectItemCaseSensitive(events_subsc_req_dataJSON,
	                                             "usgThres");
	if(usg_thres) {
	...
	if(notif_corre_id) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed [notif_corre_id]");
			goto end;
		}
	}

	af_app_ids = cJSON_GetObjectItemCaseSensitive(events_subsc_req_dataJSON,
	                                              "afAppIds");
	if(af_app_ids) {
		cJSON *af_app_ids_local = NULL;
		if(!cJSON_IsArray(af_app_ids)) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed [af_app_ids]");
			goto end;
		}
	...
	if(direct_notif_ind) {
		if(!cJSON_IsBool(direct_notif_ind)) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_parseFromJSON() failed [direct_notif_ind]");
			goto end;
		}
	}
...
OpenAPI_events_subsc_req_data_t *OpenAPI_events_subsc_req_data_copy(
	OpenAPI_events_subsc_req_data_t *dst,
	OpenAPI_events_subsc_req_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_convertToJSON() failed");
		return NULL;
	}
