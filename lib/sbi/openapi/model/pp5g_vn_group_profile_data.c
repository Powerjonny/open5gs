...
OpenAPI_pp5g_vn_group_profile_data_t *OpenAPI_pp5g_vn_group_profile_data_create(
	...
	OpenAPI_pp5g_vn_group_profile_data_t *
	        pp5g_vn_group_profile_data_local_var =
		ogs_malloc(sizeof(OpenAPI_pp5g_vn_group_profile_data_t));
	ogs_assert(pp5g_vn_group_profile_data_local_var);

	pp5g_vn_group_profile_data_local_var->allowed_mtc_providers =
		allowed_mtc_providers;
	pp5g_vn_group_profile_data_local_var->supported_features =
		supported_features;
...
void OpenAPI_pp5g_vn_group_profile_data_free(
	...
	if(pp5g_vn_group_profile_data->allowed_mtc_providers) {
		OpenAPI_list_for_each(
			pp5g_vn_group_profile_data->allowed_mtc_providers,
			node) {
...
cJSON *OpenAPI_pp5g_vn_group_profile_data_convertToJSON(
	...
	if(pp5g_vn_group_profile_data == NULL) {
		ogs_error(
			"OpenAPI_pp5g_vn_group_profile_data_convertToJSON() failed [Pp5gVnGroupProfileData]");
		return NULL;
	}
	...
	if(pp5g_vn_group_profile_data->allowed_mtc_providers) {
		...
		if(allowed_mtc_providers == NULL) {
			ogs_error(
				"OpenAPI_pp5g_vn_group_profile_data_convertToJSON() failed [allowed_mtc_providers]");
			goto end;
		}
		...
		if(pp5g_vn_group_profile_data->allowed_mtc_providers) {
			OpenAPI_list_for_each(
				...
				if(itemLocal == NULL) {
					ogs_error(
						"OpenAPI_pp5g_vn_group_profile_data_convertToJSON() failed [inner]");
					goto end;
				}
	...
	if(pp5g_vn_group_profile_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pp5g_vn_group_profile_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_pp5g_vn_group_profile_data_parseFromJSON(
	...
	OpenAPI_pp5g_vn_group_profile_data_t *
	        pp5g_vn_group_profile_data_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *allowed_mtc_providers = NULL;
	OpenAPI_list_t *allowed_mtc_providersList = NULL;
	cJSON *supported_features = NULL;
	allowed_mtc_providers =
		cJSON_GetObjectItemCaseSensitive(pp5g_vn_group_profile_dataJSON,
		                                 "allowedMtcProviders");
	if(allowed_mtc_providers) {
		...
		{
			ogs_error(
				"OpenAPI_pp5g_vn_group_profile_data_parseFromJSON() failed [allowed_mtc_providers]");
			goto end;
		}
		if(cJSON_IsObject(allowed_mtc_providers)) {
			...
			cJSON_ArrayForEach(allowed_mtc_providers_local_map,
				...
				if(cJSON_IsObject(localMapObject)) {
					...
					ogs_error(
						"OpenAPI_pp5g_vn_group_profile_data_parseFromJSON() failed [inner]");
					goto end;
				}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pp5g_vn_group_profile_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	pp5g_vn_group_profile_data_local_var =
		OpenAPI_pp5g_vn_group_profile_data_create(
...
OpenAPI_pp5g_vn_group_profile_data_t *OpenAPI_pp5g_vn_group_profile_data_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pp5g_vn_group_profile_data_convertToJSON() failed");
		return NULL;
	}
