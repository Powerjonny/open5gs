...
OpenAPI_pdu_session_create_data_t *OpenAPI_pdu_session_create_data_create(
	...
	char *pei, bool is_pdu_session_id, int pdu_session_id, char *dnn,
	char *selected_dnn, OpenAPI_snssai_t *s_nssai,
	OpenAPI_snssai_t *hplmn_snssai, char *vsmf_id, char *ismf_id,
	OpenAPI_plmn_id_nid_t *serving_network,
	OpenAPI_request_type_e request_type, OpenAPI_list_t *eps_bearer_id,
	char *pgw_s8c_fteid, char *vsmf_pdu_session_uri,
	char *ismf_pdu_session_uri, OpenAPI_tunnel_info_t *vcn_tunnel_info,
	...
	OpenAPI_access_type_e an_type, OpenAPI_access_type_e additional_an_type,
	OpenAPI_rat_type_e rat_type, OpenAPI_user_location_t *ue_location,
	char *ue_time_zone, OpenAPI_user_location_t *add_ue_location,
	char *gpsi, OpenAPI_ref_to_binary_data_t *n1_sm_info_from_ue,
	OpenAPI_ref_to_binary_data_t *unknown_n1_sm_info,
	char *supported_features, char *h_pcf_id, char *pcf_id,
	char *pcf_group_id, char *pcf_set_id, bool is_ho_preparation_indication,
	int ho_preparation_indication, OpenAPI_dnn_selection_mode_e sel_mode,
	bool is_always_on_requested, int always_on_requested,
	...
	char *v_smf_service_instance_id, char *i_smf_service_instance_id,
	char *recovery_time,
	OpenAPI_roaming_charging_profile_t *roaming_charging_profile,
	char *charging_id, bool is_old_pdu_session_id, int old_pdu_session_id,
	char *eps_bearer_ctx_status, char *amf_nf_id, OpenAPI_guami_t *guami,
	OpenAPI_max_integrity_protected_data_rate_e
	max_integrity_protected_data_rate_ul,
	OpenAPI_max_integrity_protected_data_rate_e
	max_integrity_protected_data_rate_dl, bool is_cp_ciot_enabled,
	int cp_ciot_enabled, bool is_cp_only_ind, int cp_only_ind,
	bool is_invoke_nef, int invoke_nef, bool is_ma_request_ind,
	int ma_request_ind, bool is_ma_nw_upgrade_ind, int ma_nw_upgrade_ind,
	OpenAPI_list_t *dnai_list, OpenAPI_presence_state_e presence_in_ladn,
	OpenAPI_list_t *secondary_rat_usage_info,
	OpenAPI_small_data_rate_status_t *small_data_rate_status,
	OpenAPI_apn_rate_status_t *apn_rate_status,
	bool is_dl_serving_plmn_rate_ctl, int dl_serving_plmn_rate_ctl,
	OpenAPI_up_security_info_t *up_security_info,
	OpenAPI_vplmn_qos_t *vplmn_qos, char *old_sm_context_ref,
	...
	bool is_upip_supported, int upip_supported,
	OpenAPI_up_cnx_state_e up_cnx_state, bool is_disaster_roaming_ind,
	int disaster_roaming_ind) {
	OpenAPI_pdu_session_create_data_t *pdu_session_create_data_local_var =
		ogs_malloc(sizeof(OpenAPI_pdu_session_create_data_t));
	ogs_assert(pdu_session_create_data_local_var);

	pdu_session_create_data_local_var->supi = supi;
	pdu_session_create_data_local_var->is_unauthenticated_supi =
		is_unauthenticated_supi;
	pdu_session_create_data_local_var->unauthenticated_supi =
		unauthenticated_supi;
	pdu_session_create_data_local_var->pei = pei;
	pdu_session_create_data_local_var->is_pdu_session_id =
		is_pdu_session_id;
	...
	pdu_session_create_data_local_var->vsmf_pdu_session_uri =
		vsmf_pdu_session_uri;
	pdu_session_create_data_local_var->ismf_pdu_session_uri =
		ismf_pdu_session_uri;
	...
	pdu_session_create_data_local_var->n9_forwarding_tunnel_info =
		n9_forwarding_tunnel_info;
	pdu_session_create_data_local_var->additional_cn_tunnel_info =
		additional_cn_tunnel_info;
	pdu_session_create_data_local_var->an_type = an_type;
	pdu_session_create_data_local_var->additional_an_type =
		additional_an_type;
	...
	pdu_session_create_data_local_var->n1_sm_info_from_ue =
		n1_sm_info_from_ue;
	pdu_session_create_data_local_var->unknown_n1_sm_info =
		unknown_n1_sm_info;
	pdu_session_create_data_local_var->supported_features =
		supported_features;
	...
	pdu_session_create_data_local_var->is_ho_preparation_indication =
		is_ho_preparation_indication;
	pdu_session_create_data_local_var->ho_preparation_indication =
		ho_preparation_indication;
	pdu_session_create_data_local_var->sel_mode = sel_mode;
	pdu_session_create_data_local_var->is_always_on_requested =
		is_always_on_requested;
	pdu_session_create_data_local_var->always_on_requested =
		always_on_requested;
	pdu_session_create_data_local_var->udm_group_id = udm_group_id;
	pdu_session_create_data_local_var->routing_indicator =
		routing_indicator;
	pdu_session_create_data_local_var->is_h_nw_pub_key_id =
		is_h_nw_pub_key_id;
	pdu_session_create_data_local_var->h_nw_pub_key_id = h_nw_pub_key_id;
	pdu_session_create_data_local_var->eps_interworking_ind =
		eps_interworking_ind;
	pdu_session_create_data_local_var->v_smf_service_instance_id =
		v_smf_service_instance_id;
	pdu_session_create_data_local_var->i_smf_service_instance_id =
		i_smf_service_instance_id;
	pdu_session_create_data_local_var->recovery_time = recovery_time;
	pdu_session_create_data_local_var->roaming_charging_profile =
		roaming_charging_profile;
	pdu_session_create_data_local_var->charging_id = charging_id;
	pdu_session_create_data_local_var->is_old_pdu_session_id =
		is_old_pdu_session_id;
	pdu_session_create_data_local_var->old_pdu_session_id =
		old_pdu_session_id;
	pdu_session_create_data_local_var->eps_bearer_ctx_status =
		eps_bearer_ctx_status;
	pdu_session_create_data_local_var->amf_nf_id = amf_nf_id;
	pdu_session_create_data_local_var->guami = guami;
	pdu_session_create_data_local_var->max_integrity_protected_data_rate_ul
	        = max_integrity_protected_data_rate_ul;
	pdu_session_create_data_local_var->max_integrity_protected_data_rate_dl
	        = max_integrity_protected_data_rate_dl;
	pdu_session_create_data_local_var->is_cp_ciot_enabled =
		is_cp_ciot_enabled;
	...
	pdu_session_create_data_local_var->is_ma_request_ind =
		is_ma_request_ind;
	pdu_session_create_data_local_var->ma_request_ind = ma_request_ind;
	pdu_session_create_data_local_var->is_ma_nw_upgrade_ind =
		is_ma_nw_upgrade_ind;
	pdu_session_create_data_local_var->ma_nw_upgrade_ind =
		ma_nw_upgrade_ind;
	pdu_session_create_data_local_var->dnai_list = dnai_list;
	pdu_session_create_data_local_var->presence_in_ladn = presence_in_ladn;
	pdu_session_create_data_local_var->secondary_rat_usage_info =
		secondary_rat_usage_info;
	pdu_session_create_data_local_var->small_data_rate_status =
		small_data_rate_status;
	pdu_session_create_data_local_var->apn_rate_status = apn_rate_status;
	pdu_session_create_data_local_var->is_dl_serving_plmn_rate_ctl =
		is_dl_serving_plmn_rate_ctl;
	pdu_session_create_data_local_var->dl_serving_plmn_rate_ctl =
	...
	pdu_session_create_data_local_var->old_sm_context_ref =
		old_sm_context_ref;
	pdu_session_create_data_local_var->redundant_pdu_session_info =
		redundant_pdu_session_info;
	pdu_session_create_data_local_var->old_pdu_session_ref =
		old_pdu_session_ref;
	pdu_session_create_data_local_var->is_sm_policy_notify_ind =
		is_sm_policy_notify_ind;
	pdu_session_create_data_local_var->sm_policy_notify_ind =
		sm_policy_notify_ind;
	pdu_session_create_data_local_var->is_pcf_ue_callback_info_null =
		is_pcf_ue_callback_info_null;
	pdu_session_create_data_local_var->pcf_ue_callback_info =
		pcf_ue_callback_info;
	pdu_session_create_data_local_var->satellite_backhaul_cat =
		satellite_backhaul_cat;
	pdu_session_create_data_local_var->is_upip_supported =
		is_upip_supported;
	...
	pdu_session_create_data_local_var->is_disaster_roaming_ind =
		is_disaster_roaming_ind;
	pdu_session_create_data_local_var->disaster_roaming_ind =
		disaster_roaming_ind;

	return pdu_session_create_data_local_var;
}

void OpenAPI_pdu_session_create_data_free(
	OpenAPI_pdu_session_create_data_t *pdu_session_create_data) {
	...
	if(pdu_session_create_data->serving_network) {
		OpenAPI_plmn_id_nid_free(
			pdu_session_create_data->serving_network);
	...
	if(pdu_session_create_data->add_ue_location) {
		OpenAPI_user_location_free(
			pdu_session_create_data->add_ue_location);
	...
	if(pdu_session_create_data->roaming_charging_profile) {
		OpenAPI_roaming_charging_profile_free(
			pdu_session_create_data->roaming_charging_profile);
	...
	if(pdu_session_create_data->dnai_list) {
		OpenAPI_list_for_each(pdu_session_create_data->dnai_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(pdu_session_create_data->secondary_rat_usage_info) {
		OpenAPI_list_for_each(
			pdu_session_create_data->secondary_rat_usage_info,
			node) {
	...
	if(pdu_session_create_data->small_data_rate_status) {
		OpenAPI_small_data_rate_status_free(
			pdu_session_create_data->small_data_rate_status);
	...
	if(pdu_session_create_data->redundant_pdu_session_info) {
		OpenAPI_redundant_pdu_session_information_free(
			pdu_session_create_data->redundant_pdu_session_info);
...
cJSON *OpenAPI_pdu_session_create_data_convertToJSON(
	OpenAPI_pdu_session_create_data_t *pdu_session_create_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pdu_session_create_data == NULL) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_convertToJSON() failed [PduSessionCreateData]");
		return NULL;
	}
	...
	if(pdu_session_create_data->supi) {
		if(cJSON_AddStringToObject(item, "supi",
		                           pdu_session_create_data->supi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_unauthenticated_supi) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [unauthenticated_supi]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->pei) {
		if(cJSON_AddStringToObject(item, "pei",
		                           pdu_session_create_data->pei) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_pdu_session_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pdu_session_id]");
			goto end;
		}
	}
	...
	if(!pdu_session_create_data->dnn) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_convertToJSON() failed [dnn]");
		return NULL;
	}
	...
	if(pdu_session_create_data->selected_dnn) {
		if(cJSON_AddStringToObject(item, "selectedDnn",
		                           pdu_session_create_data->selected_dnn)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [selected_dnn]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->s_nssai) {
		cJSON *s_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				pdu_session_create_data->s_nssai);
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(pdu_session_create_data->hplmn_snssai) {
		cJSON *hplmn_snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				pdu_session_create_data->hplmn_snssai);
		if(hplmn_snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [hplmn_snssai]");
			goto end;
		}
	...
	if(pdu_session_create_data->vsmf_id) {
		if(cJSON_AddStringToObject(item, "vsmfId",
		                           pdu_session_create_data->vsmf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [vsmf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->ismf_id) {
		if(cJSON_AddStringToObject(item, "ismfId",
		                           pdu_session_create_data->ismf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ismf_id]");
			goto end;
		}
	}
	...
	if(!pdu_session_create_data->serving_network) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_convertToJSON() failed [serving_network]");
		return NULL;
	}
	...
	if(pdu_session_create_data->request_type != OpenAPI_request_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [request_type]");
			goto end;
		}
	}

	if(pdu_session_create_data->eps_bearer_id) {
		cJSON *eps_bearer_idList = cJSON_AddArrayToObject(item,
		                                                  "epsBearerId");
		if(eps_bearer_idList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [eps_bearer_id]");
			goto end;
		}
		OpenAPI_list_for_each(pdu_session_create_data->eps_bearer_id,
		                      node) {
			...
			if(cJSON_AddNumberToObject(eps_bearer_idList, "",
			                           *(double *) node->data) ==
			   NULL)
			{
				ogs_error(
	...
	if(pdu_session_create_data->pgw_s8c_fteid) {
		if(cJSON_AddStringToObject(item, "pgwS8cFteid",
		                           pdu_session_create_data->
		                           pgw_s8c_fteid) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pgw_s8c_fteid]");
			goto end;
		}
	}

	if(pdu_session_create_data->vsmf_pdu_session_uri) {
		if(cJSON_AddStringToObject(item, "vsmfPduSessionUri",
		                           pdu_session_create_data->
		                           vsmf_pdu_session_uri) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [vsmf_pdu_session_uri]");
			goto end;
		}
	}

	if(pdu_session_create_data->ismf_pdu_session_uri) {
		if(cJSON_AddStringToObject(item, "ismfPduSessionUri",
		                           pdu_session_create_data->
		                           ismf_pdu_session_uri) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ismf_pdu_session_uri]");
			goto end;
		}
	}

	if(pdu_session_create_data->vcn_tunnel_info) {
		cJSON *vcn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				pdu_session_create_data->vcn_tunnel_info);
		if(vcn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [vcn_tunnel_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "vcnTunnelInfo",
		                      vcn_tunnel_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [vcn_tunnel_info]");
			goto end;
	...
	if(pdu_session_create_data->icn_tunnel_info) {
		cJSON *icn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				pdu_session_create_data->icn_tunnel_info);
		if(icn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [icn_tunnel_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "icnTunnelInfo",
		                      icn_tunnel_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [icn_tunnel_info]");
			goto end;
	...
	if(pdu_session_create_data->n9_forwarding_tunnel_info) {
		cJSON *n9_forwarding_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				pdu_session_create_data->
				n9_forwarding_tunnel_info);
		if(n9_forwarding_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [n9_forwarding_tunnel_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n9ForwardingTunnelInfo",
		                      n9_forwarding_tunnel_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [n9_forwarding_tunnel_info]");
			goto end;
	...
	if(pdu_session_create_data->additional_cn_tunnel_info) {
		cJSON *additional_cn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				pdu_session_create_data->
				additional_cn_tunnel_info);
		if(additional_cn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [additional_cn_tunnel_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "additionalCnTunnelInfo",
		                      additional_cn_tunnel_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [additional_cn_tunnel_info]");
			goto end;
	...
	if(pdu_session_create_data->an_type == OpenAPI_access_type_NULL) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_convertToJSON() failed [an_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "anType",
	                           OpenAPI_access_type_ToString(
					   pdu_session_create_data->an_type)) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_pdu_session_create_data_convertToJSON() failed [an_type]");
	   ...
	   OpenAPI_access_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [additional_an_type]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->rat_type != OpenAPI_rat_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [rat_type]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->ue_location) {
		...
		if(ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ue_location]");
			goto end;
		}
	...
	if(pdu_session_create_data->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           pdu_session_create_data->ue_time_zone)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->add_ue_location) {
		...
		if(add_ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [add_ue_location]");
			goto end;
		}
	...
	if(pdu_session_create_data->gpsi) {
		if(cJSON_AddStringToObject(item, "gpsi",
		                           pdu_session_create_data->gpsi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->n1_sm_info_from_ue) {
		...
		if(n1_sm_info_from_ue_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [n1_sm_info_from_ue]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n1SmInfoFromUe",
		                      n1_sm_info_from_ue_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [n1_sm_info_from_ue]");
			goto end;
	...
	if(pdu_session_create_data->unknown_n1_sm_info) {
		cJSON *unknown_n1_sm_info_local_JSON =
			OpenAPI_ref_to_binary_data_convertToJSON(
				pdu_session_create_data->unknown_n1_sm_info);
		if(unknown_n1_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [unknown_n1_sm_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "unknownN1SmInfo",
		                      unknown_n1_sm_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [unknown_n1_sm_info]");
			goto end;
	...
	if(pdu_session_create_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->h_pcf_id) {
		if(cJSON_AddStringToObject(item, "hPcfId",
		                           pdu_session_create_data->h_pcf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [h_pcf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->pcf_id) {
		if(cJSON_AddStringToObject(item, "pcfId",
		                           pdu_session_create_data->pcf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->pcf_group_id) {
		if(cJSON_AddStringToObject(item, "pcfGroupId",
		                           pdu_session_create_data->pcf_group_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_group_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->pcf_set_id) {
		if(cJSON_AddStringToObject(item, "pcfSetId",
		                           pdu_session_create_data->pcf_set_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_set_id]");
			goto end;
		}
	}

	if(pdu_session_create_data->is_ho_preparation_indication) {
		if(cJSON_AddBoolToObject(item, "hoPreparationIndication",
		                         pdu_session_create_data->
		                         ho_preparation_indication) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ho_preparation_indication]");
			goto end;
		}
	}
	   ...
	   OpenAPI_dnn_selection_mode_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [sel_mode]");
			goto end;
		}
	}

	if(pdu_session_create_data->is_always_on_requested) {
		if(cJSON_AddBoolToObject(item, "alwaysOnRequested",
		                         pdu_session_create_data->
		                         always_on_requested) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [always_on_requested]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->udm_group_id) {
		if(cJSON_AddStringToObject(item, "udmGroupId",
		                           pdu_session_create_data->udm_group_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [udm_group_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->routing_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [routing_indicator]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_h_nw_pub_key_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [h_nw_pub_key_id]");
			goto end;
		}
	}
	   ...
	   OpenAPI_eps_interworking_indication_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [eps_interworking_ind]");
			goto end;
		}
	}

	if(pdu_session_create_data->v_smf_service_instance_id) {
		if(cJSON_AddStringToObject(item, "vSmfServiceInstanceId",
		                           pdu_session_create_data->
		                           v_smf_service_instance_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [v_smf_service_instance_id]");
			goto end;
		}
	}

	if(pdu_session_create_data->i_smf_service_instance_id) {
		if(cJSON_AddStringToObject(item, "iSmfServiceInstanceId",
		                           pdu_session_create_data->
		                           i_smf_service_instance_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [i_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [recovery_time]");
			goto end;
		}
	}

	if(pdu_session_create_data->roaming_charging_profile) {
		cJSON *roaming_charging_profile_local_JSON =
			OpenAPI_roaming_charging_profile_convertToJSON(
				pdu_session_create_data->
				roaming_charging_profile);
		if(roaming_charging_profile_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [roaming_charging_profile]");
			goto end;
		}
		cJSON_AddItemToObject(item, "roamingChargingProfile",
		                      roaming_charging_profile_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [roaming_charging_profile]");
			goto end;
	...
	if(pdu_session_create_data->charging_id) {
		if(cJSON_AddStringToObject(item, "chargingId",
		                           pdu_session_create_data->charging_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [charging_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_old_pdu_session_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [old_pdu_session_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->eps_bearer_ctx_status) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [eps_bearer_ctx_status]");
			goto end;
		}
	}

	if(pdu_session_create_data->amf_nf_id) {
		if(cJSON_AddStringToObject(item, "amfNfId",
		                           pdu_session_create_data->amf_nf_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [amf_nf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->guami) {
		cJSON *guami_local_JSON =
			OpenAPI_guami_convertToJSON(
				pdu_session_create_data->guami);
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [guami]");
			goto end;
		}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_cp_ciot_enabled) {
		if(cJSON_AddBoolToObject(item, "cpCiotEnabled",
		                         pdu_session_create_data->
		                         cp_ciot_enabled) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [cp_ciot_enabled]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_cp_only_ind) {
		if(cJSON_AddBoolToObject(item, "cpOnlyInd",
		                         pdu_session_create_data->cp_only_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [cp_only_ind]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_invoke_nef) {
		if(cJSON_AddBoolToObject(item, "invokeNef",
		                         pdu_session_create_data->invoke_nef) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [invoke_nef]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_ma_request_ind) {
		if(cJSON_AddBoolToObject(item, "maRequestInd",
		                         pdu_session_create_data->ma_request_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ma_request_ind]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_ma_nw_upgrade_ind) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->dnai_list) {
		...
		if(dnai_listList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [dnai_list]");
			goto end;
		}
		OpenAPI_list_for_each(pdu_session_create_data->dnai_list,
		                      node) {
			if(cJSON_AddStringToObject(dnai_listList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_pdu_session_create_data_convertToJSON() failed [dnai_list]");
	   ...
	   OpenAPI_presence_state_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [presence_in_ladn]");
			goto end;
		}
	}

	if(pdu_session_create_data->secondary_rat_usage_info) {
		cJSON *secondary_rat_usage_infoList =
			cJSON_AddArrayToObject(item, "secondaryRatUsageInfo");
		if(secondary_rat_usage_infoList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [secondary_rat_usage_info]");
			goto end;
		}
		OpenAPI_list_for_each(
			pdu_session_create_data->secondary_rat_usage_info,
			node) {
			cJSON *itemLocal =
				OpenAPI_secondary_rat_usage_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_pdu_session_create_data_convertToJSON() failed [secondary_rat_usage_info]");
			...
			cJSON_AddItemToArray(secondary_rat_usage_infoList,
			                     itemLocal);
		}
	}
	...
	if(pdu_session_create_data->small_data_rate_status) {
		...
		if(small_data_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [small_data_rate_status]");
			goto end;
		}
	...
	if(pdu_session_create_data->apn_rate_status) {
		...
		if(apn_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [apn_rate_status]");
			goto end;
		}
	...
	if(pdu_session_create_data->is_dl_serving_plmn_rate_ctl) {
		if(cJSON_AddNumberToObject(item, "dlServingPlmnRateCtl",
		                           pdu_session_create_data->
		                           dl_serving_plmn_rate_ctl) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [dl_serving_plmn_rate_ctl]");
			goto end;
		}
	}

	if(pdu_session_create_data->up_security_info) {
		cJSON *up_security_info_local_JSON =
			OpenAPI_up_security_info_convertToJSON(
				pdu_session_create_data->up_security_info);
		if(up_security_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [up_security_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "upSecurityInfo",
		                      up_security_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [up_security_info]");
			goto end;
	...
	if(pdu_session_create_data->vplmn_qos) {
		cJSON *vplmn_qos_local_JSON =
			OpenAPI_vplmn_qos_convertToJSON(
				pdu_session_create_data->vplmn_qos);
		if(vplmn_qos_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [vplmn_qos]");
			goto end;
		}
	...
	if(pdu_session_create_data->old_sm_context_ref) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [old_sm_context_ref]");
			goto end;
		}
	}

	if(pdu_session_create_data->redundant_pdu_session_info) {
		cJSON *redundant_pdu_session_info_local_JSON =
			OpenAPI_redundant_pdu_session_information_convertToJSON(
				pdu_session_create_data->
				redundant_pdu_session_info);
		if(redundant_pdu_session_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [redundant_pdu_session_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "redundantPduSessionInfo",
		                      redundant_pdu_session_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [redundant_pdu_session_info]");
			goto end;
	...
	if(pdu_session_create_data->old_pdu_session_ref) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [old_pdu_session_ref]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_sm_policy_notify_ind) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->pcf_ue_callback_info) {
		...
		if(pcf_ue_callback_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [pcf_ue_callback_info]");
			goto end;
		}
	...
	if(pdu_session_create_data->satellite_backhaul_cat !=
	   OpenAPI_satellite_backhaul_category_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_upip_supported) {
		if(cJSON_AddBoolToObject(item, "upipSupported",
		                         pdu_session_create_data->upip_supported)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [upip_supported]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->up_cnx_state != OpenAPI_up_cnx_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [up_cnx_state]");
			goto end;
		}
	}
	...
	if(pdu_session_create_data->is_disaster_roaming_ind) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_convertToJSON() failed [disaster_roaming_ind]");
			goto end;
		}
	}
...
OpenAPI_pdu_session_create_data_t *OpenAPI_pdu_session_create_data_parseFromJSON
        (cJSON *pdu_session_create_dataJSON) {
	OpenAPI_pdu_session_create_data_t *pdu_session_create_data_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *supi = NULL;
	...
	OpenAPI_max_integrity_protected_data_rate_e
	        max_integrity_protected_data_rate_ulVariable = 0;
	cJSON *max_integrity_protected_data_rate_dl = NULL;
	OpenAPI_max_integrity_protected_data_rate_e
	        max_integrity_protected_data_rate_dlVariable = 0;
	...
	supi = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                        "supi");
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(unauthenticated_supi) {
		if(!cJSON_IsBool(unauthenticated_supi)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [unauthenticated_supi]");
			goto end;
		}
	}

	pei = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                       "pei");
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(pdu_session_id) {
		if(!cJSON_IsNumber(pdu_session_id)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [pdu_session_id]");
			goto end;
		}
	}

	dnn = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                       "dnn");
	if(!dnn) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	if(selected_dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [selected_dnn]");
			goto end;
		}
	}

	s_nssai = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                           "sNssai");
	if(s_nssai) {
	...
	vsmf_id = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                           "vsmfId");
	if(vsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [vsmf_id]");
			goto end;
		}
	}

	ismf_id = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                           "ismfId");
	if(ismf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [ismf_id]");
			goto end;
		}
	}
	...
	if(!serving_network) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_parseFromJSON() failed [serving_network]");
		goto end;
	}
	...
	if(request_type) {
		if(!cJSON_IsString(request_type)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [request_type]");
			goto end;
		}
	...
	if(eps_bearer_id) {
		...
		if(!cJSON_IsArray(eps_bearer_id)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [eps_bearer_id]");
			goto end;
		}
	...
	if(pgw_s8c_fteid) {
		if(!cJSON_IsString(pgw_s8c_fteid) &&
		   !cJSON_IsNull(pgw_s8c_fteid))
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [pgw_s8c_fteid]");
			goto end;
		}
	}
	...
	if(vsmf_pdu_session_uri) {
		if(!cJSON_IsString(vsmf_pdu_session_uri) &&
		   !cJSON_IsNull(vsmf_pdu_session_uri))
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [vsmf_pdu_session_uri]");
			goto end;
		}
	}
	...
	if(ismf_pdu_session_uri) {
		if(!cJSON_IsString(ismf_pdu_session_uri) &&
		   !cJSON_IsNull(ismf_pdu_session_uri))
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [ismf_pdu_session_uri]");
			goto end;
		}
	}
	...
	vcn_tunnel_info =
		cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
		                                 "vcnTunnelInfo");
	if(vcn_tunnel_info) {
		vcn_tunnel_info_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(vcn_tunnel_info);
		if(!vcn_tunnel_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [vcn_tunnel_info]");
			goto end;
		}
	}
	...
	if(icn_tunnel_info) {
		icn_tunnel_info_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(icn_tunnel_info);
		if(!icn_tunnel_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [icn_tunnel_info]");
			goto end;
		}
	}
	...
	if(n9_forwarding_tunnel_info) {
		...
		if(!n9_forwarding_tunnel_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [n9_forwarding_tunnel_info]");
			goto end;
		}
	}
	...
	if(additional_cn_tunnel_info) {
		additional_cn_tunnel_info_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(
				additional_cn_tunnel_info);
		if(!additional_cn_tunnel_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [additional_cn_tunnel_info]");
			goto end;
		}
	}

	an_type = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                           "anType");
	if(!an_type) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_parseFromJSON() failed [an_type]");
		goto end;
	}
	...
	if(additional_an_type) {
		if(!cJSON_IsString(additional_an_type)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [additional_an_type]");
			goto end;
		}
	...
	rat_type = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                            "ratType");
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	if(ue_time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	gpsi = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                        "gpsi");
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(n1_sm_info_from_ue) {
		n1_sm_info_from_ue_local_nonprim =
			OpenAPI_ref_to_binary_data_parseFromJSON(
				n1_sm_info_from_ue);
		if(!n1_sm_info_from_ue_local_nonprim) {
			ogs_error(
				"OpenAPI_ref_to_binary_data_parseFromJSON failed [n1_sm_info_from_ue]");
			goto end;
		}
	}
	...
	if(unknown_n1_sm_info) {
		unknown_n1_sm_info_local_nonprim =
			OpenAPI_ref_to_binary_data_parseFromJSON(
				unknown_n1_sm_info);
		if(!unknown_n1_sm_info_local_nonprim) {
			ogs_error(
				"OpenAPI_ref_to_binary_data_parseFromJSON failed [unknown_n1_sm_info]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	h_pcf_id = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                            "hPcfId");
	if(h_pcf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [h_pcf_id]");
			goto end;
		}
	}

	pcf_id = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                          "pcfId");
	if(pcf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [pcf_id]");
			goto end;
		}
	}
	...
	if(pcf_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [pcf_group_id]");
			goto end;
		}
	}
	...
	if(pcf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [pcf_set_id]");
			goto end;
		}
	}
	...
	if(ho_preparation_indication) {
		if(!cJSON_IsBool(ho_preparation_indication)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [ho_preparation_indication]");
			goto end;
		}
	}

	sel_mode = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                            "selMode");
	if(sel_mode) {
		if(!cJSON_IsString(sel_mode)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [sel_mode]");
			goto end;
		}
		sel_modeVariable =
	...
	if(always_on_requested) {
		if(!cJSON_IsBool(always_on_requested)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [always_on_requested]");
			goto end;
		}
	}
	...
	if(udm_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [udm_group_id]");
			goto end;
		}
	}
	...
	if(routing_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [routing_indicator]");
			goto end;
		}
	}
	...
	if(h_nw_pub_key_id) {
		if(!cJSON_IsNumber(h_nw_pub_key_id)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [h_nw_pub_key_id]");
			goto end;
		}
	}
	...
	if(eps_interworking_ind) {
		if(!cJSON_IsString(eps_interworking_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [eps_interworking_ind]");
			goto end;
		}
	...
	if(v_smf_service_instance_id) {
		if(!cJSON_IsString(v_smf_service_instance_id) &&
		   !cJSON_IsNull(v_smf_service_instance_id))
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [v_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(i_smf_service_instance_id) {
		if(!cJSON_IsString(i_smf_service_instance_id) &&
		   !cJSON_IsNull(i_smf_service_instance_id))
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [i_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(roaming_charging_profile) {
		roaming_charging_profile_local_nonprim =
			OpenAPI_roaming_charging_profile_parseFromJSON(
				roaming_charging_profile);
		if(!roaming_charging_profile_local_nonprim) {
			ogs_error(
				"OpenAPI_roaming_charging_profile_parseFromJSON failed [roaming_charging_profile]");
			goto end;
		}
	}
	...
	if(charging_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [charging_id]");
			goto end;
		}
	}
	...
	if(old_pdu_session_id) {
		if(!cJSON_IsNumber(old_pdu_session_id)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [old_pdu_session_id]");
			goto end;
		}
	}
	...
	if(eps_bearer_ctx_status) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [eps_bearer_ctx_status]");
			goto end;
		}
	}
	...
	if(amf_nf_id) {
		if(!cJSON_IsString(amf_nf_id) &&
		   !cJSON_IsNull(amf_nf_id))
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [amf_nf_id]");
			goto end;
		}
	}

	guami = cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
	                                         "guami");
	if(guami) {
	...
	if(max_integrity_protected_data_rate_ul) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_ul)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	...
	if(max_integrity_protected_data_rate_dl) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	...
	if(cp_ciot_enabled) {
		if(!cJSON_IsBool(cp_ciot_enabled)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [cp_ciot_enabled]");
			goto end;
		}
	}
	...
	if(cp_only_ind) {
		if(!cJSON_IsBool(cp_only_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [cp_only_ind]");
			goto end;
		}
	}
	...
	if(invoke_nef) {
		if(!cJSON_IsBool(invoke_nef)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [invoke_nef]");
			goto end;
		}
	}
	...
	if(ma_request_ind) {
		if(!cJSON_IsBool(ma_request_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [ma_request_ind]");
			goto end;
		}
	}
	...
	if(ma_nw_upgrade_ind) {
		if(!cJSON_IsBool(ma_nw_upgrade_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}
	...
	if(dnai_list) {
		...
		if(!cJSON_IsArray(dnai_list)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [dnai_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(dnai_list_local, dnai_list) {
			...
			OpenAPI_list_add(dnai_listList,
			                 ogs_strdup(
						 dnai_list_local->valuestring));
		}
	}
	...
	if(presence_in_ladn) {
		if(!cJSON_IsString(presence_in_ladn)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [presence_in_ladn]");
			goto end;
		}
	...
	if(secondary_rat_usage_info) {
		...
		if(!cJSON_IsArray(secondary_rat_usage_info)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [secondary_rat_usage_info]");
			goto end;
		}

		secondary_rat_usage_infoList = OpenAPI_list_create();

		cJSON_ArrayForEach(secondary_rat_usage_info_local,
		                   secondary_rat_usage_info) {
			...
			OpenAPI_secondary_rat_usage_info_t *
				...
				OpenAPI_secondary_rat_usage_info_parseFromJSON(
					secondary_rat_usage_info_local);
			if(!secondary_rat_usage_infoItem) {
				ogs_error("No secondary_rat_usage_infoItem");
				goto end;
			}
			OpenAPI_list_add(secondary_rat_usage_infoList,
			                 secondary_rat_usage_infoItem);
		}
	}
	...
	if(dl_serving_plmn_rate_ctl) {
		if(!cJSON_IsNumber(dl_serving_plmn_rate_ctl)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [dl_serving_plmn_rate_ctl]");
			goto end;
		}
	}
	...
	up_security_info =
		cJSON_GetObjectItemCaseSensitive(pdu_session_create_dataJSON,
		                                 "upSecurityInfo");
	if(up_security_info) {
		up_security_info_local_nonprim =
			OpenAPI_up_security_info_parseFromJSON(
				up_security_info);
		if(!up_security_info_local_nonprim) {
			ogs_error(
				"OpenAPI_up_security_info_parseFromJSON failed [up_security_info]");
			goto end;
		}
	}
	...
	if(old_sm_context_ref) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [old_sm_context_ref]");
			goto end;
		}
	}
	...
	if(redundant_pdu_session_info) {
		...
		if(!redundant_pdu_session_info_local_nonprim) {
			ogs_error(
				"OpenAPI_redundant_pdu_session_information_parseFromJSON failed [redundant_pdu_session_info]");
			goto end;
		}
	}
	...
	if(old_pdu_session_ref) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [old_pdu_session_ref]");
			goto end;
		}
	}
	...
	if(sm_policy_notify_ind) {
		if(!cJSON_IsBool(sm_policy_notify_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	}
	...
	if(satellite_backhaul_cat) {
		if(!cJSON_IsString(satellite_backhaul_cat)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	...
	if(upip_supported) {
		if(!cJSON_IsBool(upip_supported)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [upip_supported]");
			goto end;
		}
	}
	...
	if(up_cnx_state) {
		if(!cJSON_IsString(up_cnx_state)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [up_cnx_state]");
			goto end;
		}
	...
	if(disaster_roaming_ind) {
		if(!cJSON_IsBool(disaster_roaming_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_create_data_parseFromJSON() failed [disaster_roaming_ind]");
			goto end;
		}
	}
	...
	pdu_session_create_data_local_var =
		OpenAPI_pdu_session_create_data_create(
			...
			vsmf_id &&
			!cJSON_IsNull(vsmf_id) ?
			ogs_strdup(vsmf_id->valuestring) :
			NULL,
			ismf_id &&
			!cJSON_IsNull(ismf_id) ?
			ogs_strdup(ismf_id->valuestring) :
			NULL,
			serving_network_local_nonprim,
			...
			pgw_s8c_fteid &&
			!cJSON_IsNull(pgw_s8c_fteid) ?
			ogs_strdup(pgw_s8c_fteid->valuestring) : NULL,
			vsmf_pdu_session_uri &&
			!cJSON_IsNull(vsmf_pdu_session_uri) ?
			ogs_strdup(vsmf_pdu_session_uri->valuestring) : NULL,
			ismf_pdu_session_uri &&
			!cJSON_IsNull(ismf_pdu_session_uri) ?
			ogs_strdup(ismf_pdu_session_uri->valuestring) : NULL,
			...
			NULL,
			n1_sm_info_from_ue ? n1_sm_info_from_ue_local_nonprim :
			NULL,
			unknown_n1_sm_info ? unknown_n1_sm_info_local_nonprim :
			NULL,
			supported_features &&
			!cJSON_IsNull(supported_features) ?
			...
			ho_preparation_indication ?
			ho_preparation_indication->valueint : 0,
			...
			v_smf_service_instance_id &&
			!cJSON_IsNull(v_smf_service_instance_id) ?
			ogs_strdup(v_smf_service_instance_id->valuestring) :
			NULL,
			i_smf_service_instance_id &&
			!cJSON_IsNull(i_smf_service_instance_id) ?
			ogs_strdup(i_smf_service_instance_id->valuestring) :
			NULL,
			recovery_time &&
			!cJSON_IsNull(recovery_time) ?
			...
			charging_id &&
			!cJSON_IsNull(charging_id) ?
			ogs_strdup(charging_id->valuestring) : NULL,
			...
			amf_nf_id &&
			!cJSON_IsNull(amf_nf_id) ?
			ogs_strdup(amf_nf_id->valuestring) :
			NULL,
			...
			dl_serving_plmn_rate_ctl ?
			dl_serving_plmn_rate_ctl->valuedouble : 0,
			up_security_info ? up_security_info_local_nonprim :
			NULL,
...
OpenAPI_pdu_session_create_data_t *OpenAPI_pdu_session_create_data_copy(
	OpenAPI_pdu_session_create_data_t	*dst,
	OpenAPI_pdu_session_create_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pdu_session_create_data_convertToJSON() failed");
		return NULL;
	}
