...
OpenAPI_class_criterion_t *OpenAPI_class_criterion_create(
	OpenAPI_dispersion_class_t *disper_class, int class_threshold,
	OpenAPI_matching_direction_t *thres_match) {
	OpenAPI_class_criterion_t *class_criterion_local_var =
		ogs_malloc(sizeof(OpenAPI_class_criterion_t));
...
cJSON *OpenAPI_class_criterion_convertToJSON(
	OpenAPI_class_criterion_t *class_criterion) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(class_criterion == NULL) {
		ogs_error(
			"OpenAPI_class_criterion_convertToJSON() failed [ClassCriterion]");
		return NULL;
	}
	...
	if(!class_criterion->disper_class) {
		ogs_error(
			"OpenAPI_class_criterion_convertToJSON() failed [disper_class]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_class_criterion_convertToJSON() failed [class_threshold]");
		goto end;
	}

	if(!class_criterion->thres_match) {
		ogs_error(
			"OpenAPI_class_criterion_convertToJSON() failed [thres_match]");
		return NULL;
	}
	cJSON *thres_match_local_JSON =
...
OpenAPI_class_criterion_t *OpenAPI_class_criterion_parseFromJSON(
	...
	if(!disper_class) {
		ogs_error(
			"OpenAPI_class_criterion_parseFromJSON() failed [disper_class]");
		goto end;
	}
	...
	if(!class_threshold) {
		ogs_error(
			"OpenAPI_class_criterion_parseFromJSON() failed [class_threshold]");
		goto end;
	}
	...
	if(!thres_match) {
		ogs_error(
			"OpenAPI_class_criterion_parseFromJSON() failed [thres_match]");
		goto end;
	}
	thres_match_local_nonprim =
		OpenAPI_matching_direction_parseFromJSON(thres_match);
	if(!thres_match_local_nonprim) {
		ogs_error(
			"OpenAPI_matching_direction_parseFromJSON failed [thres_match]");
		goto end;
	}
...
OpenAPI_class_criterion_t *OpenAPI_class_criterion_copy(
	OpenAPI_class_criterion_t *dst, OpenAPI_class_criterion_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
