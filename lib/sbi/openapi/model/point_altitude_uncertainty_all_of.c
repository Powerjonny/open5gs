...
OpenAPI_point_altitude_uncertainty_all_of_create(
	...
	OpenAPI_point_altitude_uncertainty_all_of_t *
		...
		ogs_malloc(sizeof(OpenAPI_point_altitude_uncertainty_all_of_t));
...
void OpenAPI_point_altitude_uncertainty_all_of_free(
	OpenAPI_point_altitude_uncertainty_all_of_t *
...
cJSON *OpenAPI_point_altitude_uncertainty_all_of_convertToJSON(
	...
	if(point_altitude_uncertainty_all_of == NULL) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [PointAltitudeUncertainty_allOf]");
		return NULL;
	}
	...
	if(!point_altitude_uncertainty_all_of->point) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [altitude]");
		goto end;
	}

	if(!point_altitude_uncertainty_all_of->uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [confidence]");
		goto end;
	}
	...
	if(point_altitude_uncertainty_all_of->is_v_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed [v_confidence]");
			goto end;
		}
	}
...
OpenAPI_point_altitude_uncertainty_all_of_t *
OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON(
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	if(!altitude) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON() failed [altitude]");
		goto end;
	}
	...
	uncertainty_ellipse =
		cJSON_GetObjectItemCaseSensitive(
			point_altitude_uncertainty_all_ofJSON,
			"uncertaintyEllipse");
	if(!uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	...
	if(!uncertainty_altitude) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON() failed [confidence]");
		goto end;
	}
	...
	if(v_confidence) {
		if(!cJSON_IsNumber(v_confidence)) {
			ogs_error(
				"OpenAPI_point_altitude_uncertainty_all_of_parseFromJSON() failed [v_confidence]");
			goto end;
		}
	}
...
OpenAPI_point_altitude_uncertainty_all_of_t *
OpenAPI_point_altitude_uncertainty_all_of_copy(
	OpenAPI_point_altitude_uncertainty_all_of_t	*dst,
	OpenAPI_point_altitude_uncertainty_all_of_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_all_of_convertToJSON() failed");
		return NULL;
	}
