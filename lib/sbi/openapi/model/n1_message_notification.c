...
OpenAPI_n1_message_notification_t *OpenAPI_n1_message_notification_create(
	...
	char *new_lmf_identification, OpenAPI_guami_t *guami,
	bool is_c_io_t5_gs_optimisation, int c_io_t5_gs_optimisation,
	OpenAPI_ecgi_t *ecgi, OpenAPI_ncgi_t *ncgi, OpenAPI_tai_t *tai,
	char *supi) {
	OpenAPI_n1_message_notification_t *n1_message_notification_local_var =
		ogs_malloc(sizeof(OpenAPI_n1_message_notification_t));
...
void OpenAPI_n1_message_notification_free(
	OpenAPI_n1_message_notification_t *n1_message_notification) {
...
cJSON *OpenAPI_n1_message_notification_convertToJSON(
	OpenAPI_n1_message_notification_t *n1_message_notification) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n1_message_notification == NULL) {
		ogs_error(
			"OpenAPI_n1_message_notification_convertToJSON() failed [N1MessageNotification]");
		return NULL;
	}
	...
	if(n1_message_notification->n1_notify_subscription_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [n1_notify_subscription_id]");
			goto end;
		}
	}
	...
	if(!n1_message_notification->n1_message_container) {
		ogs_error(
			"OpenAPI_n1_message_notification_convertToJSON() failed [n1_message_container]");
		return NULL;
	}
	...
	if(n1_message_notification->lcs_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [lcs_correlation_id]");
			goto end;
		}
	}
	...
	if(n1_message_notification->registration_ctxt_container) {
		cJSON *registration_ctxt_container_local_JSON =
			OpenAPI_registration_context_container_convertToJSON(
				n1_message_notification->
				registration_ctxt_container);
		if(registration_ctxt_container_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [registration_ctxt_container]");
			goto end;
		}
	...
	if(n1_message_notification->new_lmf_identification) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [new_lmf_identification]");
			goto end;
		}
	}
	...
	if(n1_message_notification->guami) {
		...
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [guami]");
			goto end;
		}
	...
	if(n1_message_notification->is_c_io_t5_gs_optimisation) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [c_io_t5_gs_optimisation]");
			goto end;
		}
	}
	...
	if(n1_message_notification->ecgi) {
		...
		if(ecgi_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [ecgi]");
			goto end;
		}
	...
	if(n1_message_notification->ncgi) {
		...
		if(ncgi_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [ncgi]");
			goto end;
		}
	...
	if(n1_message_notification->tai) {
		cJSON *tai_local_JSON =
			OpenAPI_tai_convertToJSON(n1_message_notification->tai);
		if(tai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [tai]");
			goto end;
		}
	...
	if(n1_message_notification->supi) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_convertToJSON() failed [supi]");
			goto end;
		}
	}
...
OpenAPI_n1_message_notification_t *OpenAPI_n1_message_notification_parseFromJSON
	...
	cJSON *supi = NULL;
	n1_notify_subscription_id =
		cJSON_GetObjectItemCaseSensitive(n1_message_notificationJSON,
	...
	if(n1_notify_subscription_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_parseFromJSON() failed [n1_notify_subscription_id]");
			goto end;
		}
	}
	...
	if(!n1_message_container) {
		ogs_error(
			"OpenAPI_n1_message_notification_parseFromJSON() failed [n1_message_container]");
		goto end;
	}
	...
	if(lcs_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_parseFromJSON() failed [lcs_correlation_id]");
			goto end;
		}
	}
	...
	if(registration_ctxt_container) {
		...
		if(!registration_ctxt_container_local_nonprim) {
			ogs_error(
				"OpenAPI_registration_context_container_parseFromJSON failed [registration_ctxt_container]");
			goto end;
		}
	}
	...
	if(new_lmf_identification) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_parseFromJSON() failed [new_lmf_identification]");
			goto end;
		}
	}
	...
	if(c_io_t5_gs_optimisation) {
		if(!cJSON_IsBool(c_io_t5_gs_optimisation)) {
			ogs_error(
				"OpenAPI_n1_message_notification_parseFromJSON() failed [c_io_t5_gs_optimisation]");
			goto end;
		}
	}
	...
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_notification_parseFromJSON() failed [supi]");
			goto end;
		}
	}
	...
	n1_message_notification_local_var =
		OpenAPI_n1_message_notification_create(
			n1_notify_subscription_id &&
			!cJSON_IsNull(n1_notify_subscription_id) ?
			ogs_strdup(n1_notify_subscription_id->valuestring) :
			NULL,
			n1_message_container_local_nonprim,
			lcs_correlation_id &&
			!cJSON_IsNull(lcs_correlation_id) ?
			...
			new_lmf_identification &&
			!cJSON_IsNull(new_lmf_identification) ?
			ogs_strdup(new_lmf_identification->valuestring) : NULL,
			guami ? guami_local_nonprim : NULL,
			c_io_t5_gs_optimisation ? true : false,
			c_io_t5_gs_optimisation ?
			c_io_t5_gs_optimisation->valueint : 0,
...
OpenAPI_n1_message_notification_t *OpenAPI_n1_message_notification_copy(
	OpenAPI_n1_message_notification_t	*dst,
	OpenAPI_n1_message_notification_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n1_message_notification_convertToJSON() failed");
		return NULL;
	}
