...
OpenAPI_location_area_id_t *OpenAPI_location_area_id_create(
	OpenAPI_plmn_id_t *plmn_id, char *lac) {
	OpenAPI_location_area_id_t *location_area_id_local_var =
		ogs_malloc(sizeof(OpenAPI_location_area_id_t));
...
void OpenAPI_location_area_id_free(
	OpenAPI_location_area_id_t *location_area_id) {
...
cJSON *OpenAPI_location_area_id_convertToJSON(
	OpenAPI_location_area_id_t *location_area_id) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(location_area_id == NULL) {
		ogs_error(
			"OpenAPI_location_area_id_convertToJSON() failed [LocationAreaId]");
		return NULL;
	}
	...
	if(!location_area_id->plmn_id) {
		ogs_error(
			"OpenAPI_location_area_id_convertToJSON() failed [plmn_id]");
		return NULL;
	}
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_convertToJSON(location_area_id->plmn_id);
	...
	if(!location_area_id->lac) {
		ogs_error(
			"OpenAPI_location_area_id_convertToJSON() failed [lac]");
		return NULL;
	}
...
OpenAPI_location_area_id_t *OpenAPI_location_area_id_parseFromJSON(
	cJSON *location_area_idJSON) {
	...
	if(!plmn_id) {
		ogs_error(
			"OpenAPI_location_area_id_parseFromJSON() failed [plmn_id]");
		goto end;
	}
	...
	if(!lac) {
		ogs_error(
			"OpenAPI_location_area_id_parseFromJSON() failed [lac]");
		goto end;
	}
...
OpenAPI_location_area_id_t *OpenAPI_location_area_id_copy(
	OpenAPI_location_area_id_t *dst, OpenAPI_location_area_id_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
