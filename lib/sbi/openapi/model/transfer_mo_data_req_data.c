...
OpenAPI_transfer_mo_data_req_data_t *OpenAPI_transfer_mo_data_req_data_create(
	...
	OpenAPI_transfer_mo_data_req_data_t *transfer_mo_data_req_data_local_var
	        = ogs_malloc(sizeof(OpenAPI_transfer_mo_data_req_data_t));
	ogs_assert(transfer_mo_data_req_data_local_var);

	transfer_mo_data_req_data_local_var->mo_data = mo_data;
	transfer_mo_data_req_data_local_var->mo_exp_data_counter =
		mo_exp_data_counter;
...
cJSON *OpenAPI_transfer_mo_data_req_data_convertToJSON(
	...
	if(transfer_mo_data_req_data == NULL) {
		ogs_error(
			"OpenAPI_transfer_mo_data_req_data_convertToJSON() failed [TransferMoDataReqData]");
		return NULL;
	}
	...
	if(!transfer_mo_data_req_data->mo_data) {
		ogs_error(
			"OpenAPI_transfer_mo_data_req_data_convertToJSON() failed [mo_data]");
		return NULL;
	}
	...
	if(transfer_mo_data_req_data->mo_exp_data_counter) {
		...
		if(mo_exp_data_counter_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_transfer_mo_data_req_data_convertToJSON() failed [mo_exp_data_counter]");
			goto end;
		}
	...
	if(transfer_mo_data_req_data->ue_location) {
		...
		if(ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_transfer_mo_data_req_data_convertToJSON() failed [ue_location]");
			goto end;
		}
...
OpenAPI_transfer_mo_data_req_data_parseFromJSON(
	...
	mo_data =
		cJSON_GetObjectItemCaseSensitive(transfer_mo_data_req_dataJSON,
		                                 "moData");
	if(!mo_data) {
		ogs_error(
			"OpenAPI_transfer_mo_data_req_data_parseFromJSON() failed [mo_data]");
		goto end;
	}
	...
	transfer_mo_data_req_data_local_var =
...
OpenAPI_transfer_mo_data_req_data_t *OpenAPI_transfer_mo_data_req_data_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_transfer_mo_data_req_data_convertToJSON() failed");
		return NULL;
	}
