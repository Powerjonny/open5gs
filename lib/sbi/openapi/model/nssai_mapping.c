...
OpenAPI_nssai_mapping_t *OpenAPI_nssai_mapping_create(
	OpenAPI_snssai_t *mapped_snssai, OpenAPI_snssai_t *h_snssai) {
	OpenAPI_nssai_mapping_t *nssai_mapping_local_var =
		ogs_malloc(sizeof(OpenAPI_nssai_mapping_t));
...
cJSON *OpenAPI_nssai_mapping_convertToJSON(
	...
	if(nssai_mapping == NULL) {
		ogs_error(
			"OpenAPI_nssai_mapping_convertToJSON() failed [NssaiMapping]");
		return NULL;
	}
	...
	if(!nssai_mapping->mapped_snssai) {
		ogs_error(
			"OpenAPI_nssai_mapping_convertToJSON() failed [mapped_snssai]");
		return NULL;
	}
	cJSON *mapped_snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(nssai_mapping->mapped_snssai);
	...
	if(!nssai_mapping->h_snssai) {
		ogs_error(
			"OpenAPI_nssai_mapping_convertToJSON() failed [h_snssai]");
		return NULL;
	}
	cJSON *h_snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(nssai_mapping->h_snssai);
...
OpenAPI_nssai_mapping_t *OpenAPI_nssai_mapping_parseFromJSON(
	cJSON *nssai_mappingJSON) {
	...
	if(!mapped_snssai) {
		ogs_error(
			"OpenAPI_nssai_mapping_parseFromJSON() failed [mapped_snssai]");
		goto end;
	}
	mapped_snssai_local_nonprim =
		OpenAPI_snssai_parseFromJSON(mapped_snssai);
	if(!mapped_snssai_local_nonprim) {
		ogs_error(
			"OpenAPI_snssai_parseFromJSON failed [mapped_snssai]");
		goto end;
	}

	h_snssai = cJSON_GetObjectItemCaseSensitive(nssai_mappingJSON,
	                                            "hSnssai");
	if(!h_snssai) {
		ogs_error(
			"OpenAPI_nssai_mapping_parseFromJSON() failed [h_snssai]");
		goto end;
	}
...
OpenAPI_nssai_mapping_t *OpenAPI_nssai_mapping_copy(
	OpenAPI_nssai_mapping_t *dst, OpenAPI_nssai_mapping_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
