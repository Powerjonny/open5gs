...
OpenAPI_nf_service_version_t *OpenAPI_nf_service_version_create(
	char *api_version_in_uri, char *api_full_version, char *expiry) {
	OpenAPI_nf_service_version_t *nf_service_version_local_var =
		ogs_malloc(sizeof(OpenAPI_nf_service_version_t));
...
void OpenAPI_nf_service_version_free(
	OpenAPI_nf_service_version_t *nf_service_version) {
...
cJSON *OpenAPI_nf_service_version_convertToJSON(
	OpenAPI_nf_service_version_t *nf_service_version) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nf_service_version == NULL) {
		ogs_error(
			"OpenAPI_nf_service_version_convertToJSON() failed [NFServiceVersion]");
		return NULL;
	}
	...
	if(!nf_service_version->api_version_in_uri) {
		ogs_error(
			"OpenAPI_nf_service_version_convertToJSON() failed [api_version_in_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "apiVersionInUri",
	...
	if(!nf_service_version->api_full_version) {
		ogs_error(
			"OpenAPI_nf_service_version_convertToJSON() failed [api_full_version]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "apiFullVersion",
	...
	if(nf_service_version->expiry) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_version_convertToJSON() failed [expiry]");
			goto end;
		}
	}
...
OpenAPI_nf_service_version_t *OpenAPI_nf_service_version_parseFromJSON(
	cJSON *nf_service_versionJSON) {
	...
	cJSON *expiry = NULL;
	api_version_in_uri =
		cJSON_GetObjectItemCaseSensitive(nf_service_versionJSON,
		                                 "apiVersionInUri");
	if(!api_version_in_uri) {
		ogs_error(
			"OpenAPI_nf_service_version_parseFromJSON() failed [api_version_in_uri]");
		goto end;
	}
	...
	if(!api_full_version) {
		ogs_error(
			"OpenAPI_nf_service_version_parseFromJSON() failed [api_full_version]");
		goto end;
	}
	...
	expiry = cJSON_GetObjectItemCaseSensitive(nf_service_versionJSON,
	                                          "expiry");
	if(expiry) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_version_parseFromJSON() failed [expiry]");
			goto end;
		}
	}
...
OpenAPI_nf_service_version_t *OpenAPI_nf_service_version_copy(
	OpenAPI_nf_service_version_t *dst, OpenAPI_nf_service_version_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
