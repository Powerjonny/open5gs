...
OpenAPI_pc5_qos_flow_item_t *OpenAPI_pc5_qos_flow_item_create(int pqi,
                                                              OpenAPI_pc5_flow_bit_rates_t
                                                              *
                                                              pc5_flow_bit_rates,
                                                              bool	is_range,
                                                              int	range) {
	OpenAPI_pc5_qos_flow_item_t *pc5_qos_flow_item_local_var =
		ogs_malloc(sizeof(OpenAPI_pc5_qos_flow_item_t));
...
void OpenAPI_pc5_qos_flow_item_free(
	OpenAPI_pc5_qos_flow_item_t *pc5_qos_flow_item) {
	...
	if(pc5_qos_flow_item->pc5_flow_bit_rates) {
		OpenAPI_pc5_flow_bit_rates_free(
...
cJSON *OpenAPI_pc5_qos_flow_item_convertToJSON(
	OpenAPI_pc5_qos_flow_item_t *pc5_qos_flow_item) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pc5_qos_flow_item == NULL) {
		ogs_error(
			"OpenAPI_pc5_qos_flow_item_convertToJSON() failed [Pc5QosFlowItem]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_pc5_qos_flow_item_convertToJSON() failed [pqi]");
		goto end;
	}

	if(pc5_qos_flow_item->pc5_flow_bit_rates) {
		cJSON *pc5_flow_bit_rates_local_JSON =
			OpenAPI_pc5_flow_bit_rates_convertToJSON(
				pc5_qos_flow_item->pc5_flow_bit_rates);
		if(pc5_flow_bit_rates_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pc5_qos_flow_item_convertToJSON() failed [pc5_flow_bit_rates]");
			goto end;
		}
	...
	if(pc5_qos_flow_item->is_range) {
		...
		{
			ogs_error(
				"OpenAPI_pc5_qos_flow_item_convertToJSON() failed [range]");
			goto end;
		}
	}
...
OpenAPI_pc5_qos_flow_item_t *OpenAPI_pc5_qos_flow_item_parseFromJSON(
	...
	if(!pqi) {
		ogs_error(
			"OpenAPI_pc5_qos_flow_item_parseFromJSON() failed [pqi]");
		goto end;
	}
	...
	if(pc5_flow_bit_rates) {
		...
		if(!pc5_flow_bit_rates_local_nonprim) {
			ogs_error(
				"OpenAPI_pc5_flow_bit_rates_parseFromJSON failed [pc5_flow_bit_rates]");
			goto end;
		}
	}

	range = cJSON_GetObjectItemCaseSensitive(pc5_qos_flow_itemJSON,
	                                         "range");
	if(range) {
		if(!cJSON_IsNumber(range)) {
			ogs_error(
				"OpenAPI_pc5_qos_flow_item_parseFromJSON() failed [range]");
			goto end;
		}
	}
...
OpenAPI_pc5_qos_flow_item_t *OpenAPI_pc5_qos_flow_item_copy(
	OpenAPI_pc5_qos_flow_item_t *dst, OpenAPI_pc5_qos_flow_item_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
