...
OpenAPI_velocity_estimate_t *OpenAPI_velocity_estimate_create(float	h_speed,
                                                              int	bearing,
                                                              float	v_speed,
                                                              OpenAPI_vertical_direction_e
                                                              v_direction,
                                                              float
                                                              h_uncertainty,
                                                              float
                                                                v_uncertainty,
                                                              OpenAPI_radial_velocity_t
                                                              *
                                                                r_velocity,
...
{
	OpenAPI_velocity_estimate_t *velocity_estimate_local_var =
		ogs_malloc(sizeof(OpenAPI_velocity_estimate_t));
	...
	velocity_estimate_local_var->a_transverse_velocity =
		a_transverse_velocity;
	velocity_estimate_local_var->e_transverse_velocity =
		e_transverse_velocity;

	return velocity_estimate_local_var;
}

void OpenAPI_velocity_estimate_free(
...
cJSON *OpenAPI_velocity_estimate_convertToJSON(
	OpenAPI_velocity_estimate_t *velocity_estimate) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(velocity_estimate == NULL) {
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [VelocityEstimate]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [h_speed]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [bearing]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [v_speed]");
		goto end;
	}

	if(velocity_estimate->v_direction == OpenAPI_vertical_direction_NULL) {
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [v_direction]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "vDirection",
	                           OpenAPI_vertical_direction_ToString(
	...
	{
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [h_uncertainty]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_velocity_estimate_convertToJSON() failed [v_uncertainty]");
		goto end;
	}

	if(velocity_estimate->r_velocity) {
		cJSON *r_velocity_local_JSON =
			OpenAPI_radial_velocity_convertToJSON(
				velocity_estimate->r_velocity);
		if(r_velocity_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_velocity_estimate_convertToJSON() failed [r_velocity]");
			goto end;
		}
	...
	if(velocity_estimate->a_transverse_velocity) {
		cJSON *a_transverse_velocity_local_JSON =
			OpenAPI_angular_velocity_convertToJSON(
				velocity_estimate->a_transverse_velocity);
		if(a_transverse_velocity_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_velocity_estimate_convertToJSON() failed [a_transverse_velocity]");
			goto end;
		}
		cJSON_AddItemToObject(item, "aTransverseVelocity",
		                      a_transverse_velocity_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_velocity_estimate_convertToJSON() failed [a_transverse_velocity]");
			goto end;
	...
	if(velocity_estimate->e_transverse_velocity) {
		cJSON *e_transverse_velocity_local_JSON =
			OpenAPI_angular_velocity_convertToJSON(
				velocity_estimate->e_transverse_velocity);
		if(e_transverse_velocity_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_velocity_estimate_convertToJSON() failed [e_transverse_velocity]");
			goto end;
		}
		cJSON_AddItemToObject(item, "eTransverseVelocity",
		                      e_transverse_velocity_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_velocity_estimate_convertToJSON() failed [e_transverse_velocity]");
			goto end;
...
OpenAPI_velocity_estimate_t *OpenAPI_velocity_estimate_parseFromJSON(
	...
	if(!h_speed) {
		ogs_error(
			"OpenAPI_velocity_estimate_parseFromJSON() failed [h_speed]");
		goto end;
	}
	...
	if(!bearing) {
		ogs_error(
			"OpenAPI_velocity_estimate_parseFromJSON() failed [bearing]");
		goto end;
	}
	...
	if(!v_speed) {
		ogs_error(
			"OpenAPI_velocity_estimate_parseFromJSON() failed [v_speed]");
		goto end;
	}
	...
	if(!v_direction) {
		ogs_error(
			"OpenAPI_velocity_estimate_parseFromJSON() failed [v_direction]");
		goto end;
	}
	...
	v_directionVariable =
		OpenAPI_vertical_direction_FromString(v_direction->valuestring);

	h_uncertainty = cJSON_GetObjectItemCaseSensitive(velocity_estimateJSON,
	                                                 "hUncertainty");
	if(!h_uncertainty) {
		ogs_error(
			"OpenAPI_velocity_estimate_parseFromJSON() failed [h_uncertainty]");
		goto end;
	}
	...
	if(!v_uncertainty) {
		ogs_error(
			"OpenAPI_velocity_estimate_parseFromJSON() failed [v_uncertainty]");
		goto end;
	}
	...
	r_velocity = cJSON_GetObjectItemCaseSensitive(velocity_estimateJSON,
	                                              "rVelocity");
	if(r_velocity) {
		r_velocity_local_nonprim =
			OpenAPI_radial_velocity_parseFromJSON(r_velocity);
		if(!r_velocity_local_nonprim) {
			ogs_error(
				"OpenAPI_radial_velocity_parseFromJSON failed [r_velocity]");
			goto end;
		}
	}

	a_transverse_velocity =
		cJSON_GetObjectItemCaseSensitive(velocity_estimateJSON,
		                                 "aTransverseVelocity");
	if(a_transverse_velocity) {
		a_transverse_velocity_local_nonprim =
			OpenAPI_angular_velocity_parseFromJSON(
				a_transverse_velocity);
		if(!a_transverse_velocity_local_nonprim) {
			ogs_error(
				"OpenAPI_angular_velocity_parseFromJSON failed [a_transverse_velocity]");
			goto end;
		}
	}
	...
	if(e_transverse_velocity) {
		e_transverse_velocity_local_nonprim =
			OpenAPI_angular_velocity_parseFromJSON(
				e_transverse_velocity);
		if(!e_transverse_velocity_local_nonprim) {
			ogs_error(
				"OpenAPI_angular_velocity_parseFromJSON failed [e_transverse_velocity]");
			goto end;
		}
	}
	...
	velocity_estimate_local_var = OpenAPI_velocity_estimate_create(
		...
		a_transverse_velocity ? a_transverse_velocity_local_nonprim :
		NULL,
		e_transverse_velocity ? e_transverse_velocity_local_nonprim :
		NULL
		);
...
OpenAPI_velocity_estimate_t *OpenAPI_velocity_estimate_copy(
	OpenAPI_velocity_estimate_t *dst, OpenAPI_velocity_estimate_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
