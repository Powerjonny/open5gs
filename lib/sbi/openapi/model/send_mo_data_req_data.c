...
OpenAPI_send_mo_data_req_data_t *OpenAPI_send_mo_data_req_data_create(
	...
	OpenAPI_send_mo_data_req_data_t *send_mo_data_req_data_local_var =
		ogs_malloc(sizeof(OpenAPI_send_mo_data_req_data_t));
	ogs_assert(send_mo_data_req_data_local_var);

	send_mo_data_req_data_local_var->mo_data = mo_data;
	send_mo_data_req_data_local_var->mo_exp_data_counter =
		mo_exp_data_counter;
...
void OpenAPI_send_mo_data_req_data_free(
	OpenAPI_send_mo_data_req_data_t *send_mo_data_req_data) {
	...
	if(send_mo_data_req_data->mo_exp_data_counter) {
		OpenAPI_mo_exp_data_counter_free(
			send_mo_data_req_data->mo_exp_data_counter);
...
cJSON *OpenAPI_send_mo_data_req_data_convertToJSON(
	OpenAPI_send_mo_data_req_data_t *send_mo_data_req_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(send_mo_data_req_data == NULL) {
		ogs_error(
			"OpenAPI_send_mo_data_req_data_convertToJSON() failed [SendMoDataReqData]");
		return NULL;
	}
	...
	if(!send_mo_data_req_data->mo_data) {
		ogs_error(
			"OpenAPI_send_mo_data_req_data_convertToJSON() failed [mo_data]");
		return NULL;
	}
	cJSON *mo_data_local_JSON =
		OpenAPI_ref_to_binary_data_convertToJSON(
			send_mo_data_req_data->mo_data);
	...
	if(send_mo_data_req_data->mo_exp_data_counter) {
		...
		if(mo_exp_data_counter_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_send_mo_data_req_data_convertToJSON() failed [mo_exp_data_counter]");
			goto end;
		}
	...
	if(send_mo_data_req_data->ue_location) {
		cJSON *ue_location_local_JSON =
			OpenAPI_user_location_convertToJSON(
				send_mo_data_req_data->ue_location);
		if(ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_send_mo_data_req_data_convertToJSON() failed [ue_location]");
			goto end;
		}
...
OpenAPI_send_mo_data_req_data_t *OpenAPI_send_mo_data_req_data_parseFromJSON(
	cJSON *send_mo_data_req_dataJSON) {
	...
	mo_data = cJSON_GetObjectItemCaseSensitive(send_mo_data_req_dataJSON,
	                                           "moData");
	if(!mo_data) {
		ogs_error(
			"OpenAPI_send_mo_data_req_data_parseFromJSON() failed [mo_data]");
		goto end;
	}
	mo_data_local_nonprim =
		OpenAPI_ref_to_binary_data_parseFromJSON(mo_data);
	if(!mo_data_local_nonprim) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_parseFromJSON failed [mo_data]");
		goto end;
	}

	mo_exp_data_counter =
		cJSON_GetObjectItemCaseSensitive(send_mo_data_req_dataJSON,
		                                 "moExpDataCounter");
...
OpenAPI_send_mo_data_req_data_t *OpenAPI_send_mo_data_req_data_copy(
	OpenAPI_send_mo_data_req_data_t *dst,
	OpenAPI_send_mo_data_req_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_send_mo_data_req_data_convertToJSON() failed");
		return NULL;
	}
