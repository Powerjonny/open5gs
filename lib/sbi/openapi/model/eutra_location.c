...
OpenAPI_eutra_location_t *OpenAPI_eutra_location_create(OpenAPI_tai_t *tai,
                                                        bool
                                                        is_ignore_tai,
                                                        int
                                                        ignore_tai,
                                                        ...
                                                        *
                                                        global_enb_id) {
	OpenAPI_eutra_location_t *eutra_location_local_var =
		ogs_malloc(sizeof(OpenAPI_eutra_location_t));
...
cJSON *OpenAPI_eutra_location_convertToJSON(
	...
	if(eutra_location == NULL) {
		ogs_error(
			"OpenAPI_eutra_location_convertToJSON() failed [EutraLocation]");
		return NULL;
	}
	...
	if(!eutra_location->tai) {
		ogs_error(
			"OpenAPI_eutra_location_convertToJSON() failed [tai]");
		return NULL;
	}
	...
	if(eutra_location->is_ignore_tai) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [ignore_tai]");
			goto end;
		}
	}
	...
	if(!eutra_location->ecgi) {
		ogs_error(
			"OpenAPI_eutra_location_convertToJSON() failed [ecgi]");
		return NULL;
	}
	cJSON *ecgi_local_JSON =
		OpenAPI_ecgi_convertToJSON(eutra_location->ecgi);
	...
	if(eutra_location->is_ignore_ecgi) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [ignore_ecgi]");
			goto end;
		}
	}
	...
	if(eutra_location->is_age_of_location_information) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [age_of_location_information]");
			goto end;
		}
	}
	...
	if(eutra_location->ue_location_timestamp) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [ue_location_timestamp]");
			goto end;
		}
	}
	...
	if(eutra_location->geographical_information) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [geographical_information]");
			goto end;
		}
	}
	...
	if(eutra_location->geodetic_information) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [geodetic_information]");
			goto end;
		}
	}
	...
	if(eutra_location->global_ngenb_id) {
		...
		if(global_ngenb_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [global_ngenb_id]");
			goto end;
		}
	...
	if(eutra_location->global_enb_id) {
		...
		if(global_enb_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_eutra_location_convertToJSON() failed [global_enb_id]");
			goto end;
		}
...
OpenAPI_eutra_location_t *OpenAPI_eutra_location_parseFromJSON(
	cJSON *eutra_locationJSON) {
	...
	if(!tai) {
		ogs_error(
			"OpenAPI_eutra_location_parseFromJSON() failed [tai]");
		goto end;
	}
	...
	if(ignore_tai) {
		if(!cJSON_IsBool(ignore_tai)) {
			ogs_error(
				"OpenAPI_eutra_location_parseFromJSON() failed [ignore_tai]");
			goto end;
		}
	}
	...
	if(!ecgi) {
		ogs_error(
			"OpenAPI_eutra_location_parseFromJSON() failed [ecgi]");
		goto end;
	}
	...
	if(ignore_ecgi) {
		if(!cJSON_IsBool(ignore_ecgi)) {
			ogs_error(
				"OpenAPI_eutra_location_parseFromJSON() failed [ignore_ecgi]");
			goto end;
		}
	}

	age_of_location_information =
		cJSON_GetObjectItemCaseSensitive(eutra_locationJSON,
		                                 "ageOfLocationInformation");
	if(age_of_location_information) {
		if(!cJSON_IsNumber(age_of_location_information)) {
			ogs_error(
				"OpenAPI_eutra_location_parseFromJSON() failed [age_of_location_information]");
			goto end;
		}
	}
	...
	if(ue_location_timestamp) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_parseFromJSON() failed [ue_location_timestamp]");
			goto end;
		}
	}
	...
	if(geographical_information) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_parseFromJSON() failed [geographical_information]");
			goto end;
		}
	}
	...
	if(geodetic_information) {
		...
		{
			ogs_error(
				"OpenAPI_eutra_location_parseFromJSON() failed [geodetic_information]");
			goto end;
		}
	}
	...
	if(global_ngenb_id) {
		...
		if(!global_ngenb_id_local_nonprim) {
			ogs_error(
				"OpenAPI_global_ran_node_id_parseFromJSON failed [global_ngenb_id]");
			goto end;
		}
	}
	...
	global_enb_id = cJSON_GetObjectItemCaseSensitive(eutra_locationJSON,
	                                                 "globalENbId");
	if(global_enb_id) {
		global_enb_id_local_nonprim =
			OpenAPI_global_ran_node_id_parseFromJSON(global_enb_id);
		if(!global_enb_id_local_nonprim) {
			ogs_error(
				"OpenAPI_global_ran_node_id_parseFromJSON failed [global_enb_id]");
			goto end;
		}
	}
...
OpenAPI_eutra_location_t *OpenAPI_eutra_location_copy(
	OpenAPI_eutra_location_t *dst, OpenAPI_eutra_location_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
