...
OpenAPI_smf_registration_modification_create(
	...
	OpenAPI_smf_registration_modification_t *
		...
		ogs_malloc(sizeof(OpenAPI_smf_registration_modification_t));
	ogs_assert(smf_registration_modification_local_var);

	smf_registration_modification_local_var->smf_instance_id =
		smf_instance_id;
...
void OpenAPI_smf_registration_modification_free(
	OpenAPI_smf_registration_modification_t *smf_registration_modification)
{
...
cJSON *OpenAPI_smf_registration_modification_convertToJSON(
	OpenAPI_smf_registration_modification_t *smf_registration_modification)
{
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(smf_registration_modification == NULL) {
		ogs_error(
			"OpenAPI_smf_registration_modification_convertToJSON() failed [SmfRegistrationModification]");
		return NULL;
	}
	...
	if(!smf_registration_modification->smf_instance_id) {
		ogs_error(
			"OpenAPI_smf_registration_modification_convertToJSON() failed [smf_instance_id]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "smfInstanceId",
	                           smf_registration_modification->
	...
	if(smf_registration_modification->smf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_modification_convertToJSON() failed [smf_set_id]");
			goto end;
		}
	}

	if(smf_registration_modification->pgw_fqdn) {
		cJSON *pgw_fqdn_local_JSON =
			OpenAPI_fqdn_rm_convertToJSON(
				smf_registration_modification->pgw_fqdn);
		if(pgw_fqdn_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_smf_registration_modification_convertToJSON() failed [pgw_fqdn]");
			goto end;
		}
...
OpenAPI_smf_registration_modification_t *
OpenAPI_smf_registration_modification_parseFromJSON(
	cJSON *smf_registration_modificationJSON) {
	OpenAPI_smf_registration_modification_t *
	        smf_registration_modification_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	smf_instance_id =
		cJSON_GetObjectItemCaseSensitive(
			smf_registration_modificationJSON, "smfInstanceId");
	if(!smf_instance_id) {
		ogs_error(
			"OpenAPI_smf_registration_modification_parseFromJSON() failed [smf_instance_id]");
		goto end;
	}
	...
	smf_set_id =
		cJSON_GetObjectItemCaseSensitive(
			smf_registration_modificationJSON, "smfSetId");
	if(smf_set_id) {
		if(!cJSON_IsString(smf_set_id) &&
		   !cJSON_IsNull(smf_set_id))
		{
			ogs_error(
				"OpenAPI_smf_registration_modification_parseFromJSON() failed [smf_set_id]");
			goto end;
		}
	}
	...
	pgw_fqdn =
		cJSON_GetObjectItemCaseSensitive(
			smf_registration_modificationJSON, "pgwFqdn");
	if(pgw_fqdn) {
		pgw_fqdn_local_nonprim =
			OpenAPI_fqdn_rm_parseFromJSON(pgw_fqdn);
		if(!pgw_fqdn_local_nonprim) {
			ogs_error(
				"OpenAPI_fqdn_rm_parseFromJSON failed [pgw_fqdn]");
			goto end;
		}
	}
...
OpenAPI_smf_registration_modification_t *
OpenAPI_smf_registration_modification_copy(
	OpenAPI_smf_registration_modification_t *dst,
	OpenAPI_smf_registration_modification_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_smf_registration_modification_convertToJSON() failed");
		return NULL;
	}
