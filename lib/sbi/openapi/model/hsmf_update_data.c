...
char *OpenAPI_sm_policy_notify_indhsmf_update_data_ToString(
	OpenAPI_hsmf_update_data_sm_policy_notify_ind_e sm_policy_notify_ind) {
	const char *sm_policy_notify_indArray[] = { "NULL", "true" };
	size_t sizeofArray = sizeof(sm_policy_notify_indArray) /
	                     sizeof(sm_policy_notify_indArray[0]);
...
OpenAPI_hsmf_update_data_sm_policy_notify_ind_e
OpenAPI_sm_policy_notify_indhsmf_update_data_FromString(
	char *sm_policy_notify_ind) {
	int stringToReturn = 0;
	const char *sm_policy_notify_indArray[] = { "NULL", "true" };
	size_t sizeofArray = sizeof(sm_policy_notify_indArray) /
	                     sizeof(sm_policy_notify_indArray[0]);
	while(stringToReturn < sizeofArray) {
		if(strcmp(sm_policy_notify_ind,
		          sm_policy_notify_indArray[stringToReturn]) == 0)
		{
...
OpenAPI_hsmf_update_data_t *OpenAPI_hsmf_update_data_create(
	OpenAPI_request_indication_e request_indication, char *pei,
	...
	OpenAPI_plmn_id_nid_t *serving_network, OpenAPI_access_type_e an_type,
	...
	OpenAPI_user_location_t *add_ue_location, bool is_pause_charging,
	int pause_charging, bool is_pti, int pti,
	...
	OpenAPI_list_t *qos_flows_notify_list, OpenAPI_list_t *notify_list,
	OpenAPI_list_t *eps_bearer_id, bool is_ho_preparation_indication,
	int ho_preparation_indication, OpenAPI_list_t *revoke_ebi_list,
	OpenAPI_cause_e cause, OpenAPI_ng_ap_cause_t *ng_ap_cause,
	bool is__5g_mm_cause_value, int _5g_mm_cause_value,
	...
	bool is_an_type_can_be_changed, int an_type_can_be_changed,
	OpenAPI_ma_release_indication_e ma_release_ind,
	bool is_ma_nw_upgrade_ind, int ma_nw_upgrade_ind,
	bool is_ma_request_ind, int ma_request_ind,
	OpenAPI_unavailable_access_indication_e unavailable_access_ind,
	OpenAPI_list_t *psa_info, OpenAPI_ulcl_bp_information_t *ulcl_bp_info,
	OpenAPI_n4_information_t *n4_info,
	OpenAPI_n4_information_t *n4_info_ext1,
	OpenAPI_n4_information_t *n4_info_ext2,
	OpenAPI_presence_state_e presence_in_ladn, char *vsmf_pdu_session_uri,
	char *vsmf_id, char *v_smf_service_instance_id,
	char *ismf_pdu_session_uri, char *ismf_id,
	char *i_smf_service_instance_id, bool is_dl_serving_plmn_rate_ctl_null,
	bool is_dl_serving_plmn_rate_ctl, int dl_serving_plmn_rate_ctl,
	OpenAPI_list_t *dnai_list, char *supported_features,
	...
	OpenAPI_up_security_info_t *up_security_info, char *amf_nf_id,
	...
	OpenAPI_hsmf_update_data_t *hsmf_update_data_local_var =
		ogs_malloc(sizeof(OpenAPI_hsmf_update_data_t));
	...
	hsmf_update_data_local_var->additional_cn_tunnel_info =
	...
	hsmf_update_data_local_var->qos_flows_rel_notify_list =
		qos_flows_rel_notify_list;
	hsmf_update_data_local_var->qos_flows_notify_list =
	...
	hsmf_update_data_local_var->is_ho_preparation_indication =
		is_ho_preparation_indication;
	hsmf_update_data_local_var->ho_preparation_indication =
	...
	hsmf_update_data_local_var->is__5g_mm_cause_value =
		is__5g_mm_cause_value;
	hsmf_update_data_local_var->_5g_mm_cause_value = _5g_mm_cause_value;
	hsmf_update_data_local_var->is_always_on_requested =
	...
	hsmf_update_data_local_var->secondary_rat_usage_report =
		secondary_rat_usage_report;
	hsmf_update_data_local_var->secondary_rat_usage_info =
		secondary_rat_usage_info;
	hsmf_update_data_local_var->is_an_type_can_be_changed =
		is_an_type_can_be_changed;
	hsmf_update_data_local_var->an_type_can_be_changed =
		an_type_can_be_changed;
	...
	hsmf_update_data_local_var->unavailable_access_ind =
		unavailable_access_ind;
	...
	hsmf_update_data_local_var->v_smf_service_instance_id =
	...
	hsmf_update_data_local_var->i_smf_service_instance_id =
		i_smf_service_instance_id;
	hsmf_update_data_local_var->is_dl_serving_plmn_rate_ctl_null =
		is_dl_serving_plmn_rate_ctl_null;
	hsmf_update_data_local_var->is_dl_serving_plmn_rate_ctl =
		is_dl_serving_plmn_rate_ctl;
	hsmf_update_data_local_var->dl_serving_plmn_rate_ctl =
	...
	hsmf_update_data_local_var->roaming_charging_profile =
	...
	hsmf_update_data_local_var->secondary_rat_usage_data_report_container =
		secondary_rat_usage_data_report_container;
	hsmf_update_data_local_var->sm_policy_notify_ind = sm_policy_notify_ind;
	hsmf_update_data_local_var->is_pcf_ue_callback_info_null =
		is_pcf_ue_callback_info_null;
	hsmf_update_data_local_var->pcf_ue_callback_info = pcf_ue_callback_info;
	hsmf_update_data_local_var->satellite_backhaul_cat =
		satellite_backhaul_cat;
	hsmf_update_data_local_var->max_integrity_protected_data_rate_ul =
		max_integrity_protected_data_rate_ul;
	hsmf_update_data_local_var->max_integrity_protected_data_rate_dl =
		max_integrity_protected_data_rate_dl;
...
void OpenAPI_hsmf_update_data_free(
	OpenAPI_hsmf_update_data_t *hsmf_update_data) {
	...
	if(hsmf_update_data->additional_cn_tunnel_info) {
		OpenAPI_tunnel_info_free(
			hsmf_update_data->additional_cn_tunnel_info);
	...
	if(hsmf_update_data->qos_flows_rel_notify_list) {
		OpenAPI_list_for_each(
			hsmf_update_data->qos_flows_rel_notify_list, node) {
	...
	if(hsmf_update_data->qos_flows_notify_list) {
		OpenAPI_list_for_each(hsmf_update_data->qos_flows_notify_list,
		                      node) {
	...
	if(hsmf_update_data->secondary_rat_usage_report) {
		OpenAPI_list_for_each(
			hsmf_update_data->secondary_rat_usage_report, node) {
	...
	if(hsmf_update_data->secondary_rat_usage_info) {
		OpenAPI_list_for_each(
			hsmf_update_data->secondary_rat_usage_info, node) {
	...
	if(hsmf_update_data->roaming_charging_profile) {
		OpenAPI_roaming_charging_profile_free(
			hsmf_update_data->roaming_charging_profile);
		hsmf_update_data->roaming_charging_profile = NULL;
	}
	if(hsmf_update_data->mo_exp_data_counter) {
		OpenAPI_mo_exp_data_counter_free(
			hsmf_update_data->mo_exp_data_counter);
	...
	if(hsmf_update_data->up_security_info) {
		OpenAPI_up_security_info_free(
			hsmf_update_data->up_security_info);
	...
	if(hsmf_update_data->secondary_rat_usage_data_report_container) {
		OpenAPI_list_for_each(
			hsmf_update_data->
			secondary_rat_usage_data_report_container, node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
			hsmf_update_data->
			secondary_rat_usage_data_report_container);
		hsmf_update_data->secondary_rat_usage_data_report_container =
			NULL;
	}
	if(hsmf_update_data->pcf_ue_callback_info) {
		OpenAPI_pcf_ue_callback_info_free(
			hsmf_update_data->pcf_ue_callback_info);
		hsmf_update_data->pcf_ue_callback_info = NULL;
	}
	ogs_free(hsmf_update_data);
}

cJSON *OpenAPI_hsmf_update_data_convertToJSON(
	OpenAPI_hsmf_update_data_t *hsmf_update_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(hsmf_update_data == NULL) {
		ogs_error(
			"OpenAPI_hsmf_update_data_convertToJSON() failed [HsmfUpdateData]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(hsmf_update_data->request_indication ==
	   OpenAPI_request_indication_NULL)
	{
		ogs_error(
			"OpenAPI_hsmf_update_data_convertToJSON() failed [request_indication]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "requestIndication",
	                           OpenAPI_request_indication_ToString(
					   hsmf_update_data->request_indication))
	   == NULL)
	{
		ogs_error(
			"OpenAPI_hsmf_update_data_convertToJSON() failed [request_indication]");
	...
	if(hsmf_update_data->pei) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->vcn_tunnel_info) {
		cJSON *vcn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				hsmf_update_data->vcn_tunnel_info);
		if(vcn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [vcn_tunnel_info]");
			goto end;
		}
	...
	if(hsmf_update_data->icn_tunnel_info) {
		cJSON *icn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				hsmf_update_data->icn_tunnel_info);
		if(icn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [icn_tunnel_info]");
			goto end;
		}
	...
	if(hsmf_update_data->additional_cn_tunnel_info) {
		...
		if(additional_cn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [additional_cn_tunnel_info]");
			goto end;
		}
	...
	if(hsmf_update_data->serving_network) {
		cJSON *serving_network_local_JSON =
			OpenAPI_plmn_id_nid_convertToJSON(
				hsmf_update_data->serving_network);
		if(serving_network_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [serving_network]");
			goto end;
		}
	...
	if(hsmf_update_data->an_type != OpenAPI_access_type_NULL) {
		if(cJSON_AddStringToObject(item, "anType",
						   ...
						   hsmf_update_data->an_type))
		   == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [an_type]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->additional_an_type != OpenAPI_access_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [additional_an_type]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->rat_type != OpenAPI_rat_type_NULL) {
		if(cJSON_AddStringToObject(item, "ratType",
						   ...
						   hsmf_update_data->rat_type))
		   == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [rat_type]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->ue_location) {
		cJSON *ue_location_local_JSON =
			OpenAPI_user_location_convertToJSON(
				hsmf_update_data->ue_location);
		if(ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ue_location]");
			goto end;
		}
	...
	if(hsmf_update_data->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           hsmf_update_data->ue_time_zone) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->add_ue_location) {
		cJSON *add_ue_location_local_JSON =
			OpenAPI_user_location_convertToJSON(
				hsmf_update_data->add_ue_location);
		if(add_ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [add_ue_location]");
			goto end;
		}
	...
	if(hsmf_update_data->is_pause_charging) {
		if(cJSON_AddBoolToObject(item, "pauseCharging",
		                         hsmf_update_data->pause_charging) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [pause_charging]");
			goto end;
		}
	}

	if(hsmf_update_data->is_pti) {
		if(cJSON_AddNumberToObject(item, "pti",
		                           hsmf_update_data->pti) == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [pti]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->n1_sm_info_from_ue) {
		...
		if(n1_sm_info_from_ue_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [n1_sm_info_from_ue]");
			goto end;
		}
	...
	if(hsmf_update_data->unknown_n1_sm_info) {
		...
		if(unknown_n1_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [unknown_n1_sm_info]");
			goto end;
		}
	...
	if(hsmf_update_data->qos_flows_rel_notify_list) {
		cJSON *qos_flows_rel_notify_listList =
			cJSON_AddArrayToObject(item, "qosFlowsRelNotifyList");
		if(qos_flows_rel_notify_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [qos_flows_rel_notify_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			hsmf_update_data->qos_flows_rel_notify_list, node) {
			cJSON *itemLocal =
				OpenAPI_qos_flow_item_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_hsmf_update_data_convertToJSON() failed [qos_flows_rel_notify_list]");
				goto end;
			}
			cJSON_AddItemToArray(qos_flows_rel_notify_listList,
			                     itemLocal);
		}
	}

	if(hsmf_update_data->qos_flows_notify_list) {
		cJSON *qos_flows_notify_listList = cJSON_AddArrayToObject(item,
		                                                          "qosFlowsNotifyList");
		if(qos_flows_notify_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [qos_flows_notify_list]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_update_data->qos_flows_notify_list,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_qos_flow_notify_item_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_hsmf_update_data_convertToJSON() failed [qos_flows_notify_list]");
			...
			cJSON_AddItemToArray(qos_flows_notify_listList,
			                     itemLocal);
		}
	}

	if(hsmf_update_data->notify_list) {
		cJSON *notify_listList = cJSON_AddArrayToObject(item,
		                                                "NotifyList");
		if(notify_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [notify_list]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_update_data->notify_list, node) {
			cJSON *itemLocal =
				OpenAPI_pdu_session_notify_item_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_hsmf_update_data_convertToJSON() failed [notify_list]");
	...
	if(hsmf_update_data->eps_bearer_id) {
		...
		if(eps_bearer_idList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [eps_bearer_id]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_update_data->eps_bearer_id, node) {
			if(node->data == NULL) {
	...
	if(hsmf_update_data->is_ho_preparation_indication) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ho_preparation_indication]");
			goto end;
		}
	}

	if(hsmf_update_data->revoke_ebi_list) {
		cJSON *revoke_ebi_listList = cJSON_AddArrayToObject(item,
		                                                    "revokeEbiList");
		if(revoke_ebi_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [revoke_ebi_list]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_update_data->revoke_ebi_list, node) {
			if(node->data == NULL) {
			...
			if(cJSON_AddNumberToObject(revoke_ebi_listList, "",
			                           *(double *) node->data) ==
			   NULL)
			{
				ogs_error(
	...
	if(hsmf_update_data->cause != OpenAPI_cause_NULL) {
		if(cJSON_AddStringToObject(item, "cause",
		                           OpenAPI_cause_ToString(
						   hsmf_update_data->cause)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->ng_ap_cause) {
		cJSON *ng_ap_cause_local_JSON =
			OpenAPI_ng_ap_cause_convertToJSON(
				hsmf_update_data->ng_ap_cause);
		if(ng_ap_cause_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ng_ap_cause]");
			goto end;
		}
		cJSON_AddItemToObject(item, "ngApCause",
		                      ng_ap_cause_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ng_ap_cause]");
			goto end;
	...
	if(hsmf_update_data->is__5g_mm_cause_value) {
		if(cJSON_AddNumberToObject(item, "5gMmCauseValue",
		                           hsmf_update_data->_5g_mm_cause_value)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [_5g_mm_cause_value]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->is_always_on_requested) {
		if(cJSON_AddBoolToObject(item, "alwaysOnRequested",
		                         hsmf_update_data->always_on_requested)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [always_on_requested]");
			goto end;
		}
	}
	   ...
	   OpenAPI_eps_interworking_indication_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [eps_interworking_ind]");
			goto end;
		}
	}

	if(hsmf_update_data->secondary_rat_usage_report) {
		cJSON *secondary_rat_usage_reportList =
			cJSON_AddArrayToObject(item, "secondaryRatUsageReport");
		if(secondary_rat_usage_reportList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [secondary_rat_usage_report]");
			goto end;
		}
		OpenAPI_list_for_each(
			hsmf_update_data->secondary_rat_usage_report, node) {
			cJSON *itemLocal =
				OpenAPI_secondary_rat_usage_report_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_hsmf_update_data_convertToJSON() failed [secondary_rat_usage_report]");
			...
			cJSON_AddItemToArray(secondary_rat_usage_reportList,
			                     itemLocal);
		}
	}
	...
	if(hsmf_update_data->secondary_rat_usage_info) {
		...
		if(secondary_rat_usage_infoList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [secondary_rat_usage_info]");
			goto end;
		}
		OpenAPI_list_for_each(
			hsmf_update_data->secondary_rat_usage_info, node) {
	...
	if(hsmf_update_data->is_an_type_can_be_changed) {
		if(cJSON_AddBoolToObject(item, "anTypeCanBeChanged",
		                         hsmf_update_data->
		                         an_type_can_be_changed) == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [an_type_can_be_changed]");
			goto end;
		}
	}

	if(hsmf_update_data->ma_release_ind !=
	   OpenAPI_ma_release_indication_NULL)
	{
		if(cJSON_AddStringToObject(item, "maReleaseInd",
		                           OpenAPI_ma_release_indication_ToString
		                                   (hsmf_update_data->
		                                   ma_release_ind)) == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ma_release_ind]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->is_ma_nw_upgrade_ind) {
		if(cJSON_AddBoolToObject(item, "maNwUpgradeInd",
		                         hsmf_update_data->ma_nw_upgrade_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->is_ma_request_ind) {
		if(cJSON_AddBoolToObject(item, "maRequestInd",
		                         hsmf_update_data->ma_request_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ma_request_ind]");
			goto end;
		}
	}

	if(hsmf_update_data->unavailable_access_ind !=
	   OpenAPI_unavailable_access_indication_NULL)
	{
		if(cJSON_AddStringToObject(item, "unavailableAccessInd",
		                           OpenAPI_unavailable_access_indication_ToString
		                                   (hsmf_update_data->
		                                   unavailable_access_ind)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [unavailable_access_ind]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->psa_info) {
		...
		if(psa_infoList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [psa_info]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_update_data->psa_info, node) {
			cJSON *itemLocal =
				OpenAPI_psa_information_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_hsmf_update_data_convertToJSON() failed [psa_info]");
	...
	if(hsmf_update_data->ulcl_bp_info) {
		cJSON *ulcl_bp_info_local_JSON =
			OpenAPI_ulcl_bp_information_convertToJSON(
				hsmf_update_data->ulcl_bp_info);
		if(ulcl_bp_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ulcl_bp_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "ulclBpInfo",
		                      ulcl_bp_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ulcl_bp_info]");
			goto end;
	...
	if(hsmf_update_data->n4_info) {
		cJSON *n4_info_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				hsmf_update_data->n4_info);
		if(n4_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [n4_info]");
			goto end;
		}
	...
	if(hsmf_update_data->n4_info_ext1) {
		cJSON *n4_info_ext1_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				hsmf_update_data->n4_info_ext1);
		if(n4_info_ext1_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [n4_info_ext1]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n4InfoExt1",
		                      n4_info_ext1_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [n4_info_ext1]");
			goto end;
	...
	if(hsmf_update_data->n4_info_ext2) {
		cJSON *n4_info_ext2_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				hsmf_update_data->n4_info_ext2);
		if(n4_info_ext2_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [n4_info_ext2]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n4InfoExt2",
		                      n4_info_ext2_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [n4_info_ext2]");
			goto end;
	...
	if(hsmf_update_data->presence_in_ladn != OpenAPI_presence_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [presence_in_ladn]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->vsmf_pdu_session_uri) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [vsmf_pdu_session_uri]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->vsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [vsmf_id]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->v_smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [v_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->ismf_pdu_session_uri) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ismf_pdu_session_uri]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->ismf_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [ismf_id]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->i_smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [i_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->is_dl_serving_plmn_rate_ctl) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [dl_serving_plmn_rate_ctl]");
			goto end;
		}
	} else if(hsmf_update_data->is_dl_serving_plmn_rate_ctl_null) {
		if(cJSON_AddNullToObject(item,
		                         "dlServingPlmnRateCtl") == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [dl_serving_plmn_rate_ctl]");
			goto end;
	...
	if(hsmf_update_data->dnai_list) {
		...
		if(dnai_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [dnai_list]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_update_data->dnai_list, node) {
	...
	if(hsmf_update_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->roaming_charging_profile) {
		...
		if(roaming_charging_profile_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [roaming_charging_profile]");
			goto end;
		}
	...
	if(hsmf_update_data->mo_exp_data_counter) {
		...
		if(mo_exp_data_counter_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [mo_exp_data_counter]");
			goto end;
		}
	...
	if(hsmf_update_data->vplmn_qos) {
		cJSON *vplmn_qos_local_JSON =
			OpenAPI_vplmn_qos_convertToJSON(
				hsmf_update_data->vplmn_qos);
		if(vplmn_qos_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [vplmn_qos]");
			goto end;
		}
	...
	if(hsmf_update_data->security_result) {
		cJSON *security_result_local_JSON =
			OpenAPI_security_result_convertToJSON(
				hsmf_update_data->security_result);
		if(security_result_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [security_result]");
			goto end;
		}
		cJSON_AddItemToObject(item, "securityResult",
		                      security_result_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [security_result]");
			goto end;
	...
	if(hsmf_update_data->up_security_info) {
		...
		if(up_security_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [up_security_info]");
			goto end;
		}
	...
	if(hsmf_update_data->amf_nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [amf_nf_id]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->guami) {
		cJSON *guami_local_JSON =
			OpenAPI_guami_convertToJSON(hsmf_update_data->guami);
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [guami]");
			goto end;
		}
	...
	if(hsmf_update_data->secondary_rat_usage_data_report_container) {
		cJSON *secondary_rat_usage_data_report_containerList =
			cJSON_AddArrayToObject(item,
			                       "secondaryRatUsageDataReportContainer");
		if(secondary_rat_usage_data_report_containerList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [secondary_rat_usage_data_report_container]");
			goto end;
		}
		OpenAPI_list_for_each(
			hsmf_update_data->
	...
	if(hsmf_update_data->sm_policy_notify_ind !=
	   OpenAPI_hsmf_update_data_SMPOLICYNOTIFYIND_NULL)
	{
		if(cJSON_AddStringToObject(item, "smPolicyNotifyInd",
		                           OpenAPI_sm_policy_notify_indhsmf_update_data_ToString
		                                   (hsmf_update_data->
		                                   sm_policy_notify_ind)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->pcf_ue_callback_info) {
		...
		if(pcf_ue_callback_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [pcf_ue_callback_info]");
			goto end;
		}
	...
	if(hsmf_update_data->satellite_backhaul_cat !=
	   OpenAPI_satellite_backhaul_category_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	}

	if(hsmf_update_data->max_integrity_protected_data_rate_ul !=
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	}

	if(hsmf_update_data->max_integrity_protected_data_rate_dl !=
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		if(cJSON_AddStringToObject(item,
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	}
	...
	if(hsmf_update_data->up_cnx_state != OpenAPI_up_cnx_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_convertToJSON() failed [up_cnx_state]");
			goto end;
		}
	}
...
OpenAPI_hsmf_update_data_t *OpenAPI_hsmf_update_data_parseFromJSON(
	cJSON *hsmf_update_dataJSON) {
	...
	OpenAPI_hsmf_update_data_sm_policy_notify_ind_e
	        sm_policy_notify_indVariable = 0;
	...
	request_indication =
		cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
		                                 "requestIndication");
	if(!request_indication) {
		ogs_error(
			"OpenAPI_hsmf_update_data_parseFromJSON() failed [request_indication]");
		goto end;
	}
	...
	request_indicationVariable =
		OpenAPI_request_indication_FromString(
			request_indication->valuestring);
	...
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [pei]");
			goto end;
		}
	}

	vcn_tunnel_info = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                   "vcnTunnelInfo");
	if(vcn_tunnel_info) {
	...
	icn_tunnel_info = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                   "icnTunnelInfo");
	if(icn_tunnel_info) {
	...
	serving_network = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                   "servingNetwork");
	if(serving_network) {
	...
	an_type = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                           "anType");
	if(an_type) {
		if(!cJSON_IsString(an_type)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [an_type]");
			goto end;
		}
		an_typeVariable =
	...
	if(additional_an_type) {
		if(!cJSON_IsString(additional_an_type)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [additional_an_type]");
			goto end;
		}
	...
	rat_type = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                            "ratType");
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	ue_location = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                               "ueLocation");
	if(ue_location) {
	...
	ue_time_zone = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                "ueTimeZone");
	if(ue_time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}

	add_ue_location = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                   "addUeLocation");
	if(add_ue_location) {
	...
	pause_charging = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                  "pauseCharging");
	if(pause_charging) {
		if(!cJSON_IsBool(pause_charging)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [pause_charging]");
			goto end;
		}
	}
	...
	if(pti) {
		if(!cJSON_IsNumber(pti)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [pti]");
			goto end;
		}
	}
	...
	if(qos_flows_rel_notify_list) {
		...
		if(!cJSON_IsArray(qos_flows_rel_notify_list)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [qos_flows_rel_notify_list]");
			goto end;
		}

		qos_flows_rel_notify_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(qos_flows_rel_notify_list_local,
		                   qos_flows_rel_notify_list) {
			...
			OpenAPI_qos_flow_item_t *qos_flows_rel_notify_listItem =
				OpenAPI_qos_flow_item_parseFromJSON(
					qos_flows_rel_notify_list_local);
			if(!qos_flows_rel_notify_listItem) {
				ogs_error("No qos_flows_rel_notify_listItem");
				goto end;
			}
			OpenAPI_list_add(qos_flows_rel_notify_listList,
			                 qos_flows_rel_notify_listItem);
		}
	}
	...
	if(qos_flows_notify_list) {
		...
		if(!cJSON_IsArray(qos_flows_notify_list)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [qos_flows_notify_list]");
			goto end;
		}

		qos_flows_notify_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(qos_flows_notify_list_local,
		                   qos_flows_notify_list) {
			...
			OpenAPI_qos_flow_notify_item_t *
			        qos_flows_notify_listItem =
				OpenAPI_qos_flow_notify_item_parseFromJSON(
					qos_flows_notify_list_local);
			if(!qos_flows_notify_listItem) {
				ogs_error("No qos_flows_notify_listItem");
				goto end;
			}
			OpenAPI_list_add(qos_flows_notify_listList,
			                 qos_flows_notify_listItem);
		}
	}

	notify_list = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                               "NotifyList");
	if(notify_list) {
		cJSON *notify_list_local = NULL;
		if(!cJSON_IsArray(notify_list)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [notify_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(notify_list_local, notify_list) {
			...
			OpenAPI_pdu_session_notify_item_t *notify_listItem =
	...
	eps_bearer_id = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                 "epsBearerId");
	if(eps_bearer_id) {
		cJSON *eps_bearer_id_local = NULL;
		if(!cJSON_IsArray(eps_bearer_id)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [eps_bearer_id]");
			goto end;
		}
	...
	if(ho_preparation_indication) {
		if(!cJSON_IsBool(ho_preparation_indication)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ho_preparation_indication]");
			goto end;
		}
	}

	revoke_ebi_list = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                   "revokeEbiList");
	if(revoke_ebi_list) {
		cJSON *revoke_ebi_list_local = NULL;
		if(!cJSON_IsArray(revoke_ebi_list)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [revoke_ebi_list]");
			goto end;
		}
	...
	if(cause) {
		if(!cJSON_IsString(cause)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [cause]");
			goto end;
		}
		causeVariable = OpenAPI_cause_FromString(cause->valuestring);
	}

	ng_ap_cause = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                               "ngApCause");
	if(ng_ap_cause) {
		ng_ap_cause_local_nonprim =
			OpenAPI_ng_ap_cause_parseFromJSON(ng_ap_cause);
		if(!ng_ap_cause_local_nonprim) {
			ogs_error(
				"OpenAPI_ng_ap_cause_parseFromJSON failed [ng_ap_cause]");
			goto end;
		}
	}
	...
	if(_5g_mm_cause_value) {
		if(!cJSON_IsNumber(_5g_mm_cause_value)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [_5g_mm_cause_value]");
			goto end;
		}
	}
	...
	if(always_on_requested) {
		if(!cJSON_IsBool(always_on_requested)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [always_on_requested]");
			goto end;
		}
	}
	...
	if(eps_interworking_ind) {
		if(!cJSON_IsString(eps_interworking_ind)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [eps_interworking_ind]");
			goto end;
		}
	...
	if(secondary_rat_usage_report) {
		...
		if(!cJSON_IsArray(secondary_rat_usage_report)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [secondary_rat_usage_report]");
			goto end;
		}

		secondary_rat_usage_reportList = OpenAPI_list_create();

		cJSON_ArrayForEach(secondary_rat_usage_report_local,
		                   secondary_rat_usage_report) {
			...
			OpenAPI_secondary_rat_usage_report_t *
			        secondary_rat_usage_reportItem =
				OpenAPI_secondary_rat_usage_report_parseFromJSON
				        (secondary_rat_usage_report_local);
			if(!secondary_rat_usage_reportItem) {
				ogs_error("No secondary_rat_usage_reportItem");
				goto end;
			}
			OpenAPI_list_add(secondary_rat_usage_reportList,
			                 secondary_rat_usage_reportItem);
		}
	}
	...
	if(secondary_rat_usage_info) {
		...
		if(!cJSON_IsArray(secondary_rat_usage_info)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [secondary_rat_usage_info]");
			goto end;
		}
	...
	if(an_type_can_be_changed) {
		if(!cJSON_IsBool(an_type_can_be_changed)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [an_type_can_be_changed]");
			goto end;
		}
	}

	ma_release_ind = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                  "maReleaseInd");
	if(ma_release_ind) {
		if(!cJSON_IsString(ma_release_ind)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ma_release_ind]");
			goto end;
		}
		ma_release_indVariable =
			OpenAPI_ma_release_indication_FromString(
				ma_release_ind->valuestring);
	}
	...
	if(ma_nw_upgrade_ind) {
		if(!cJSON_IsBool(ma_nw_upgrade_ind)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}

	ma_request_ind = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                  "maRequestInd");
	if(ma_request_ind) {
		if(!cJSON_IsBool(ma_request_ind)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ma_request_ind]");
			goto end;
		}
	}
	...
	if(unavailable_access_ind) {
		if(!cJSON_IsString(unavailable_access_ind)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [unavailable_access_ind]");
			goto end;
		}
		unavailable_access_indVariable =
			OpenAPI_unavailable_access_indication_FromString(
				unavailable_access_ind->valuestring);
	}

	psa_info = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                            "psaInfo");
	if(psa_info) {
		cJSON *psa_info_local = NULL;
		if(!cJSON_IsArray(psa_info)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [psa_info]");
			goto end;
		}
		...
		cJSON_ArrayForEach(psa_info_local, psa_info) {
			...
			OpenAPI_psa_information_t *psa_infoItem =
				OpenAPI_psa_information_parseFromJSON(
					psa_info_local);
			if(!psa_infoItem) {
	...
	ulcl_bp_info = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                "ulclBpInfo");
	if(ulcl_bp_info) {
		ulcl_bp_info_local_nonprim =
			OpenAPI_ulcl_bp_information_parseFromJSON(ulcl_bp_info);
		if(!ulcl_bp_info_local_nonprim) {
			ogs_error(
				"OpenAPI_ulcl_bp_information_parseFromJSON failed [ulcl_bp_info]");
			goto end;
		}
	}

	n4_info = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                           "n4Info");
	if(n4_info) {
		n4_info_local_nonprim =
			OpenAPI_n4_information_parseFromJSON(n4_info);
		if(!n4_info_local_nonprim) {
			ogs_error(
				"OpenAPI_n4_information_parseFromJSON failed [n4_info]");
			goto end;
		}
	}

	n4_info_ext1 = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                "n4InfoExt1");
	if(n4_info_ext1) {
		n4_info_ext1_local_nonprim =
			OpenAPI_n4_information_parseFromJSON(n4_info_ext1);
		if(!n4_info_ext1_local_nonprim) {
			ogs_error(
				"OpenAPI_n4_information_parseFromJSON failed [n4_info_ext1]");
			goto end;
		}
	}

	n4_info_ext2 = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                "n4InfoExt2");
	if(n4_info_ext2) {
		n4_info_ext2_local_nonprim =
			OpenAPI_n4_information_parseFromJSON(n4_info_ext2);
		if(!n4_info_ext2_local_nonprim) {
			ogs_error(
				"OpenAPI_n4_information_parseFromJSON failed [n4_info_ext2]");
			goto end;
		}
	}
	...
	if(presence_in_ladn) {
		if(!cJSON_IsString(presence_in_ladn)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [presence_in_ladn]");
			goto end;
		}
	...
	if(vsmf_pdu_session_uri) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [vsmf_pdu_session_uri]");
			goto end;
		}
	}

	vsmf_id = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                           "vsmfId");
	if(vsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [vsmf_id]");
			goto end;
		}
	}
	...
	if(v_smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [v_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(ismf_pdu_session_uri) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ismf_pdu_session_uri]");
			goto end;
		}
	}

	ismf_id = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                           "ismfId");
	if(ismf_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [ismf_id]");
			goto end;
		}
	}
	...
	if(i_smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [i_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(dl_serving_plmn_rate_ctl) {
		if(!cJSON_IsNull(dl_serving_plmn_rate_ctl)) {
			if(!cJSON_IsNumber(dl_serving_plmn_rate_ctl)) {
				ogs_error(
					"OpenAPI_hsmf_update_data_parseFromJSON() failed [dl_serving_plmn_rate_ctl]");
				goto end;
			}
		}
	}

	dnai_list = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                             "dnaiList");
	if(dnai_list) {
		cJSON *dnai_list_local = NULL;
		if(!cJSON_IsArray(dnai_list)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [dnai_list]");
			goto end;
		}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(mo_exp_data_counter) {
		mo_exp_data_counter_local_nonprim =
			OpenAPI_mo_exp_data_counter_parseFromJSON(
				mo_exp_data_counter);
		if(!mo_exp_data_counter_local_nonprim) {
			ogs_error(
				"OpenAPI_mo_exp_data_counter_parseFromJSON failed [mo_exp_data_counter]");
			goto end;
		}
	}

	vplmn_qos = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                             "vplmnQos");
	if(vplmn_qos) {
	...
	security_result = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                   "securityResult");
	if(security_result) {
		security_result_local_nonprim =
			OpenAPI_security_result_parseFromJSON(security_result);
		if(!security_result_local_nonprim) {
			ogs_error(
				"OpenAPI_security_result_parseFromJSON failed [security_result]");
			goto end;
		}
	}
	...
	amf_nf_id = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                             "amfNfId");
	if(amf_nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [amf_nf_id]");
			goto end;
		}
	}
	...
	if(secondary_rat_usage_data_report_container) {
		...
		if(!cJSON_IsArray(secondary_rat_usage_data_report_container)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [secondary_rat_usage_data_report_container]");
			goto end;
		}
		...
		cJSON_ArrayForEach(
			secondary_rat_usage_data_report_container_local,
			secondary_rat_usage_data_report_container) {
			double *localDouble = NULL;
			int *localInt = NULL;
			if(!cJSON_IsString(
	...
	if(sm_policy_notify_ind) {
		if(!cJSON_IsString(sm_policy_notify_ind)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
		sm_policy_notify_indVariable =
			OpenAPI_sm_policy_notify_indhsmf_update_data_FromString(
				sm_policy_notify_ind->valuestring);
	}
	...
	if(satellite_backhaul_cat) {
		if(!cJSON_IsString(satellite_backhaul_cat)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	...
	if(max_integrity_protected_data_rate_ul) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_ul)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	...
	if(max_integrity_protected_data_rate_dl) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	...
	up_cnx_state = cJSON_GetObjectItemCaseSensitive(hsmf_update_dataJSON,
	                                                "upCnxState");
	if(up_cnx_state) {
		if(!cJSON_IsString(up_cnx_state)) {
			ogs_error(
				"OpenAPI_hsmf_update_data_parseFromJSON() failed [up_cnx_state]");
			goto end;
		}
	...
	hsmf_update_data_local_var = OpenAPI_hsmf_update_data_create(
		...
		qos_flows_rel_notify_list ? qos_flows_rel_notify_listList :
		NULL,
		...
		secondary_rat_usage_report ? secondary_rat_usage_reportList :
		NULL,
		...
		vsmf_id &&
		!cJSON_IsNull(vsmf_id) ? ogs_strdup(vsmf_id->valuestring) :
		NULL,
		v_smf_service_instance_id &&
		!cJSON_IsNull(v_smf_service_instance_id) ?
		ogs_strdup(v_smf_service_instance_id->valuestring) : NULL,
		ismf_pdu_session_uri &&
		!cJSON_IsNull(ismf_pdu_session_uri) ?
		ogs_strdup(ismf_pdu_session_uri->valuestring) : NULL,
		ismf_id &&
		!cJSON_IsNull(ismf_id) ? ogs_strdup(ismf_id->valuestring) :
		NULL,
		i_smf_service_instance_id &&
		!cJSON_IsNull(i_smf_service_instance_id) ?
		ogs_strdup(i_smf_service_instance_id->valuestring) : NULL,
		dl_serving_plmn_rate_ctl &&
		cJSON_IsNull(dl_serving_plmn_rate_ctl) ? true : false,
		...
		amf_nf_id &&
		!cJSON_IsNull(amf_nf_id) ? ogs_strdup(amf_nf_id->valuestring) :
		NULL,
		...
		pcf_ue_callback_info ? pcf_ue_callback_info_local_nonprim :
		NULL,
	...
	if(secondary_rat_usage_data_report_containerList) {
		OpenAPI_list_for_each(
			secondary_rat_usage_data_report_containerList, node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
			secondary_rat_usage_data_report_containerList);
...
OpenAPI_hsmf_update_data_t *OpenAPI_hsmf_update_data_copy(
	OpenAPI_hsmf_update_data_t *dst, OpenAPI_hsmf_update_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
