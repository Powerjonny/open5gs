...
OpenAPI_traffic_characterization_t *OpenAPI_traffic_characterization_create(
	char *dnn, OpenAPI_snssai_t *snssai, char *app_id,
	OpenAPI_list_t *f_descs, bool is_ul_vol, long ul_vol,
	bool is_ul_vol_variance, float ul_vol_variance, bool is_dl_vol,
	long dl_vol, bool is_dl_vol_variance, float dl_vol_variance) {
	OpenAPI_traffic_characterization_t *traffic_characterization_local_var =
		ogs_malloc(sizeof(OpenAPI_traffic_characterization_t));
...
void OpenAPI_traffic_characterization_free(
	OpenAPI_traffic_characterization_t *traffic_characterization) {
...
cJSON *OpenAPI_traffic_characterization_convertToJSON(
	...
	if(traffic_characterization == NULL) {
		ogs_error(
			"OpenAPI_traffic_characterization_convertToJSON() failed [TrafficCharacterization]");
		return NULL;
	}
	...
	if(traffic_characterization->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(traffic_characterization->snssai) {
		...
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [snssai]");
			goto end;
		}
	...
	if(traffic_characterization->app_id) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [app_id]");
			goto end;
		}
	}
	...
	if(traffic_characterization->f_descs) {
		...
		if(f_descsList == NULL) {
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [f_descs]");
			goto end;
		}
		OpenAPI_list_for_each(traffic_characterization->f_descs, node) {
			cJSON *itemLocal =
	...
	if(traffic_characterization->is_ul_vol) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [ul_vol]");
			goto end;
		}
	}
	...
	if(traffic_characterization->is_ul_vol_variance) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [ul_vol_variance]");
			goto end;
		}
	}
	...
	if(traffic_characterization->is_dl_vol) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [dl_vol]");
			goto end;
		}
	}
	...
	if(traffic_characterization->is_dl_vol_variance) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_convertToJSON() failed [dl_vol_variance]");
			goto end;
		}
	}
...
OpenAPI_traffic_characterization_parseFromJSON(
	...
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(app_id) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [app_id]");
			goto end;
		}
	}
	...
	if(f_descs) {
		...
		if(!cJSON_IsArray(f_descs)) {
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [f_descs]");
			goto end;
		}
		...
		cJSON_ArrayForEach(f_descs_local, f_descs) {
			...
			OpenAPI_ip_eth_flow_description_t *f_descsItem =
	...
	if(ul_vol) {
		if(!cJSON_IsNumber(ul_vol)) {
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [ul_vol]");
			goto end;
		}
	}

	ul_vol_variance =
		cJSON_GetObjectItemCaseSensitive(traffic_characterizationJSON,
		                                 "ulVolVariance");
	if(ul_vol_variance) {
		if(!cJSON_IsNumber(ul_vol_variance)) {
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [ul_vol_variance]");
			goto end;
		}
	}
	...
	if(dl_vol) {
		if(!cJSON_IsNumber(dl_vol)) {
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [dl_vol]");
			goto end;
		}
	}
	...
	if(dl_vol_variance) {
		if(!cJSON_IsNumber(dl_vol_variance)) {
			ogs_error(
				"OpenAPI_traffic_characterization_parseFromJSON() failed [dl_vol_variance]");
			goto end;
		}
	}

	traffic_characterization_local_var =
...
OpenAPI_traffic_characterization_t *OpenAPI_traffic_characterization_copy(
	OpenAPI_traffic_characterization_t	*dst,
	OpenAPI_traffic_characterization_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_traffic_characterization_convertToJSON() failed");
		return NULL;
	}
