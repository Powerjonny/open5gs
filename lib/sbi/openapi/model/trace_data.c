...
OpenAPI_trace_data_t *OpenAPI_trace_data_create(char *trace_ref,
                                                ...
                                                char *interface_list) {
	OpenAPI_trace_data_t *trace_data_local_var =
		ogs_malloc(sizeof(OpenAPI_trace_data_t));
...
cJSON *OpenAPI_trace_data_convertToJSON(OpenAPI_trace_data_t *trace_data) {
	...
	if(trace_data == NULL) {
		ogs_error(
			"OpenAPI_trace_data_convertToJSON() failed [TraceData]");
		return NULL;
	}
	...
	if(!trace_data->trace_ref) {
		ogs_error(
			"OpenAPI_trace_data_convertToJSON() failed [trace_ref]");
		return NULL;
	}
	...
	if(!trace_data->ne_type_list) {
		ogs_error(
			"OpenAPI_trace_data_convertToJSON() failed [ne_type_list]");
		return NULL;
	}
	...
	if(!trace_data->event_list) {
		ogs_error(
			"OpenAPI_trace_data_convertToJSON() failed [event_list]");
		return NULL;
	}
	...
	if(trace_data->collection_entity_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_convertToJSON() failed [collection_entity_ipv4_addr]");
			goto end;
		}
	}
	...
	if(trace_data->collection_entity_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_convertToJSON() failed [collection_entity_ipv6_addr]");
			goto end;
		}
	}
	...
	if(trace_data->interface_list) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_convertToJSON() failed [interface_list]");
			goto end;
		}
	}
...
OpenAPI_trace_data_t *OpenAPI_trace_data_parseFromJSON(cJSON *trace_dataJSON) {
	...
	trace_ref = cJSON_GetObjectItemCaseSensitive(trace_dataJSON,
	                                             "traceRef");
	if(!trace_ref) {
		ogs_error(
			"OpenAPI_trace_data_parseFromJSON() failed [trace_ref]");
		goto end;
	}
	...
	if(!trace_depth) {
		ogs_error(
			"OpenAPI_trace_data_parseFromJSON() failed [trace_depth]");
		goto end;
	}
	...
	if(!ne_type_list) {
		ogs_error(
			"OpenAPI_trace_data_parseFromJSON() failed [ne_type_list]");
		goto end;
	}
	...
	if(!event_list) {
		ogs_error(
			"OpenAPI_trace_data_parseFromJSON() failed [event_list]");
		goto end;
	}
	...
	collection_entity_ipv4_addr =
		cJSON_GetObjectItemCaseSensitive(trace_dataJSON,
	...
	if(collection_entity_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_parseFromJSON() failed [collection_entity_ipv4_addr]");
			goto end;
		}
	}
	...
	if(collection_entity_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_parseFromJSON() failed [collection_entity_ipv6_addr]");
			goto end;
		}
	}
	...
	if(interface_list) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_parseFromJSON() failed [interface_list]");
			goto end;
		}
	}
...
OpenAPI_trace_data_t *OpenAPI_trace_data_copy(OpenAPI_trace_data_t	*dst,
                                              OpenAPI_trace_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
