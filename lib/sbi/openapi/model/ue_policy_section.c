...
OpenAPI_ue_policy_section_t *OpenAPI_ue_policy_section_create(
	char *ue_policy_section_info, char *upsi) {
	OpenAPI_ue_policy_section_t *ue_policy_section_local_var =
		ogs_malloc(sizeof(OpenAPI_ue_policy_section_t));
	ogs_assert(ue_policy_section_local_var);

	ue_policy_section_local_var->ue_policy_section_info =
...
void OpenAPI_ue_policy_section_free(
	OpenAPI_ue_policy_section_t *ue_policy_section) {
...
cJSON *OpenAPI_ue_policy_section_convertToJSON(
	OpenAPI_ue_policy_section_t *ue_policy_section) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_policy_section == NULL) {
		ogs_error(
			"OpenAPI_ue_policy_section_convertToJSON() failed [UePolicySection]");
		return NULL;
	}
	...
	if(!ue_policy_section->ue_policy_section_info) {
		ogs_error(
			"OpenAPI_ue_policy_section_convertToJSON() failed [ue_policy_section_info]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "uePolicySectionInfo",
	                           ue_policy_section->ue_policy_section_info) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_ue_policy_section_convertToJSON() failed [ue_policy_section_info]");
	...
	if(!ue_policy_section->upsi) {
		ogs_error(
			"OpenAPI_ue_policy_section_convertToJSON() failed [upsi]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "upsi",
	                           ue_policy_section->upsi) == NULL)
	{
		ogs_error(
			"OpenAPI_ue_policy_section_convertToJSON() failed [upsi]");
...
OpenAPI_ue_policy_section_t *OpenAPI_ue_policy_section_parseFromJSON(
	cJSON *ue_policy_sectionJSON) {
	OpenAPI_ue_policy_section_t *ue_policy_section_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *ue_policy_section_info = NULL;
	cJSON *upsi = NULL;
	ue_policy_section_info =
		cJSON_GetObjectItemCaseSensitive(ue_policy_sectionJSON,
		                                 "uePolicySectionInfo");
	if(!ue_policy_section_info) {
		ogs_error(
			"OpenAPI_ue_policy_section_parseFromJSON() failed [ue_policy_section_info]");
		goto end;
	}
	...
	if(!upsi) {
		ogs_error(
			"OpenAPI_ue_policy_section_parseFromJSON() failed [upsi]");
		goto end;
	}
...
OpenAPI_ue_policy_section_t *OpenAPI_ue_policy_section_copy(
	OpenAPI_ue_policy_section_t *dst, OpenAPI_ue_policy_section_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
