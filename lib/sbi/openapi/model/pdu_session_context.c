...
OpenAPI_pdu_session_context_t *OpenAPI_pdu_session_context_create(
	int pdu_session_id, char *sm_context_ref, OpenAPI_snssai_t *s_nssai,
	char *dnn, char *selected_dnn, OpenAPI_access_type_e access_type,
	OpenAPI_access_type_e additional_access_type,
	OpenAPI_list_t *allocated_ebi_list, char *hsmf_id, char *hsmf_set_id,
	char *hsmf_service_set_id, OpenAPI_sbi_binding_level_e smf_binding,
	char *vsmf_id, char *vsmf_set_id, char *vsmf_service_set_id,
	OpenAPI_sbi_binding_level_e vsmf_binding, char *ismf_id,
	char *ismf_set_id, char *ismf_service_set_id,
	OpenAPI_sbi_binding_level_e ismf_binding, char *ns_instance,
	char *smf_service_instance_id, bool is_ma_pdu_session,
	int ma_pdu_session,
	OpenAPI_cn_assisted_ran_para_t *cn_assisted_ran_para,
	char *nrf_management_uri, char *nrf_discovery_uri,
	char *nrf_access_token_uri, char *smf_binding_info,
	char *vsmf_binding_info, char *ismf_binding_info,
	OpenAPI_snssai_t *additional_snssai, char *inter_plmn_api_root,
	char *pgw_fqdn, OpenAPI_ip_address_t *pgw_ip_addr,
	OpenAPI_plmn_id_t *plmn_id, char *anchor_smf_supported_features,
	bool is_anchor_smf_oauth2_required, int anchor_smf_oauth2_required) {
	OpenAPI_pdu_session_context_t *pdu_session_context_local_var =
...
void OpenAPI_pdu_session_context_free(
	OpenAPI_pdu_session_context_t *pdu_session_context) {
	...
	if(pdu_session_context->allocated_ebi_list) {
		OpenAPI_list_for_each(pdu_session_context->allocated_ebi_list,
		                      node) {
	...
	if(pdu_session_context->cn_assisted_ran_para) {
		OpenAPI_cn_assisted_ran_para_free(
...
cJSON *OpenAPI_pdu_session_context_convertToJSON(
	OpenAPI_pdu_session_context_t *pdu_session_context) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pdu_session_context == NULL) {
		ogs_error(
			"OpenAPI_pdu_session_context_convertToJSON() failed [PduSessionContext]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_pdu_session_context_convertToJSON() failed [pdu_session_id]");
		goto end;
	}

	if(!pdu_session_context->sm_context_ref) {
		ogs_error(
			"OpenAPI_pdu_session_context_convertToJSON() failed [sm_context_ref]");
		return NULL;
	}
	...
	if(!pdu_session_context->s_nssai) {
		ogs_error(
			"OpenAPI_pdu_session_context_convertToJSON() failed [s_nssai]");
		return NULL;
	}
	cJSON *s_nssai_local_JSON =
		OpenAPI_snssai_convertToJSON(pdu_session_context->s_nssai);
	...
	if(!pdu_session_context->dnn) {
		ogs_error(
			"OpenAPI_pdu_session_context_convertToJSON() failed [dnn]");
		return NULL;
	}
	...
	if(pdu_session_context->selected_dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [selected_dnn]");
			goto end;
		}
	}
	...
	if(pdu_session_context->access_type == OpenAPI_access_type_NULL) {
		ogs_error(
			"OpenAPI_pdu_session_context_convertToJSON() failed [access_type]");
		return NULL;
	}
	   ...
	   OpenAPI_access_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [additional_access_type]");
			goto end;
		}
	}
	...
	if(pdu_session_context->allocated_ebi_list) {
		...
		if(allocated_ebi_listList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [allocated_ebi_list]");
			goto end;
		}
		OpenAPI_list_for_each(pdu_session_context->allocated_ebi_list,
		                      node) {
	...
	if(pdu_session_context->hsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [hsmf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->hsmf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [hsmf_set_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->hsmf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [hsmf_service_set_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->smf_binding != OpenAPI_sbi_binding_level_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [smf_binding]");
			goto end;
		}
	}
	...
	if(pdu_session_context->vsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [vsmf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->vsmf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [vsmf_set_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->vsmf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [vsmf_service_set_id]");
			goto end;
		}
	}
	   ...
	   OpenAPI_sbi_binding_level_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [vsmf_binding]");
			goto end;
		}
	}
	...
	if(pdu_session_context->ismf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ismf_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->ismf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ismf_set_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->ismf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ismf_service_set_id]");
			goto end;
		}
	}
	   ...
	   OpenAPI_sbi_binding_level_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ismf_binding]");
			goto end;
		}
	}
	...
	if(pdu_session_context->ns_instance) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ns_instance]");
			goto end;
		}
	}
	...
	if(pdu_session_context->smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_context->is_ma_pdu_session) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ma_pdu_session]");
			goto end;
		}
	}
	...
	if(pdu_session_context->cn_assisted_ran_para) {
		cJSON *cn_assisted_ran_para_local_JSON =
			OpenAPI_cn_assisted_ran_para_convertToJSON(
				pdu_session_context->cn_assisted_ran_para);
		if(cn_assisted_ran_para_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [cn_assisted_ran_para]");
			goto end;
		}
	...
	if(pdu_session_context->nrf_management_uri) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [nrf_management_uri]");
			goto end;
		}
	}
	...
	if(pdu_session_context->nrf_discovery_uri) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [nrf_discovery_uri]");
			goto end;
		}
	}
	...
	if(pdu_session_context->nrf_access_token_uri) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [nrf_access_token_uri]");
			goto end;
		}
	}
	...
	if(pdu_session_context->smf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [smf_binding_info]");
			goto end;
		}
	}
	...
	if(pdu_session_context->vsmf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [vsmf_binding_info]");
			goto end;
		}
	}
	...
	if(pdu_session_context->ismf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [ismf_binding_info]");
			goto end;
		}
	}

	if(pdu_session_context->additional_snssai) {
		cJSON *additional_snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				pdu_session_context->additional_snssai);
		if(additional_snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [additional_snssai]");
			goto end;
		}
	...
	if(pdu_session_context->inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(pdu_session_context->pgw_fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [pgw_fqdn]");
			goto end;
		}
	}

	if(pdu_session_context->pgw_ip_addr) {
		cJSON *pgw_ip_addr_local_JSON =
			OpenAPI_ip_address_convertToJSON(
				pdu_session_context->pgw_ip_addr);
		if(pgw_ip_addr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [pgw_ip_addr]");
			goto end;
		}
	...
	if(pdu_session_context->plmn_id) {
		...
		if(plmn_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [plmn_id]");
			goto end;
		}
	...
	if(pdu_session_context->anchor_smf_supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [anchor_smf_supported_features]");
			goto end;
		}
	}
	...
	if(pdu_session_context->is_anchor_smf_oauth2_required) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_convertToJSON() failed [anchor_smf_oauth2_required]");
			goto end;
		}
	}
...
OpenAPI_pdu_session_context_t *OpenAPI_pdu_session_context_parseFromJSON(
	...
	OpenAPI_cn_assisted_ran_para_t *cn_assisted_ran_para_local_nonprim =
		NULL;
	...
	pdu_session_id =
		cJSON_GetObjectItemCaseSensitive(pdu_session_contextJSON,
		                                 "pduSessionId");
	if(!pdu_session_id) {
		ogs_error(
			"OpenAPI_pdu_session_context_parseFromJSON() failed [pdu_session_id]");
		goto end;
	}
	...
	if(!sm_context_ref) {
		ogs_error(
			"OpenAPI_pdu_session_context_parseFromJSON() failed [sm_context_ref]");
		goto end;
	}
	...
	if(!s_nssai) {
		ogs_error(
			"OpenAPI_pdu_session_context_parseFromJSON() failed [s_nssai]");
		goto end;
	}
	...
	if(!dnn) {
		ogs_error(
			"OpenAPI_pdu_session_context_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	if(selected_dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [selected_dnn]");
			goto end;
		}
	}
	...
	if(!access_type) {
		ogs_error(
			"OpenAPI_pdu_session_context_parseFromJSON() failed [access_type]");
		goto end;
	}
	...
	access_typeVariable =
		OpenAPI_access_type_FromString(access_type->valuestring);
	...
	if(additional_access_type) {
		if(!cJSON_IsString(additional_access_type)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [additional_access_type]");
			goto end;
		}
	...
	if(allocated_ebi_list) {
		...
		if(!cJSON_IsArray(allocated_ebi_list)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [allocated_ebi_list]");
			goto end;
		}
	...
	if(hsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [hsmf_id]");
			goto end;
		}
	}
	...
	if(hsmf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [hsmf_set_id]");
			goto end;
		}
	}
	...
	if(hsmf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [hsmf_service_set_id]");
			goto end;
		}
	}
	...
	if(smf_binding) {
		if(!cJSON_IsString(smf_binding)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [smf_binding]");
			goto end;
		}
		smf_bindingVariable =
	...
	if(vsmf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [vsmf_id]");
			goto end;
		}
	}
	...
	if(vsmf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [vsmf_set_id]");
			goto end;
		}
	}
	...
	if(vsmf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [vsmf_service_set_id]");
			goto end;
		}
	}
	...
	if(vsmf_binding) {
		if(!cJSON_IsString(vsmf_binding)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [vsmf_binding]");
			goto end;
		}
		vsmf_bindingVariable =
			OpenAPI_sbi_binding_level_FromString(
	...
	if(ismf_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ismf_id]");
			goto end;
		}
	}
	...
	if(ismf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ismf_set_id]");
			goto end;
		}
	}
	...
	if(ismf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ismf_service_set_id]");
			goto end;
		}
	}
	...
	if(ismf_binding) {
		if(!cJSON_IsString(ismf_binding)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ismf_binding]");
			goto end;
		}
		ismf_bindingVariable =
			OpenAPI_sbi_binding_level_FromString(
	...
	if(ns_instance) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ns_instance]");
			goto end;
		}
	}
	...
	if(smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(ma_pdu_session) {
		if(!cJSON_IsBool(ma_pdu_session)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ma_pdu_session]");
			goto end;
		}
	}
	...
	if(cn_assisted_ran_para) {
		...
		if(!cn_assisted_ran_para_local_nonprim) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_parseFromJSON failed [cn_assisted_ran_para]");
			goto end;
		}
	}
	...
	if(nrf_management_uri) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [nrf_management_uri]");
			goto end;
		}
	}
	...
	if(nrf_discovery_uri) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [nrf_discovery_uri]");
			goto end;
		}
	}
	...
	if(nrf_access_token_uri) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [nrf_access_token_uri]");
			goto end;
		}
	}
	...
	if(smf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [smf_binding_info]");
			goto end;
		}
	}
	...
	if(vsmf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [vsmf_binding_info]");
			goto end;
		}
	}
	...
	if(ismf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [ismf_binding_info]");
			goto end;
		}
	}
	...
	if(additional_snssai) {
		additional_snssai_local_nonprim =
			OpenAPI_snssai_parseFromJSON(additional_snssai);
		if(!additional_snssai_local_nonprim) {
			ogs_error(
				"OpenAPI_snssai_parseFromJSON failed [additional_snssai]");
			goto end;
		}
	}
	...
	if(inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(pgw_fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [pgw_fqdn]");
			goto end;
		}
	}
	...
	if(pgw_ip_addr) {
		pgw_ip_addr_local_nonprim =
			OpenAPI_ip_address_parseFromJSON(pgw_ip_addr);
		if(!pgw_ip_addr_local_nonprim) {
			ogs_error(
				"OpenAPI_ip_address_parseFromJSON failed [pgw_ip_addr]");
			goto end;
		}
	}
	...
	if(anchor_smf_supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [anchor_smf_supported_features]");
			goto end;
		}
	}
	...
	if(anchor_smf_oauth2_required) {
		if(!cJSON_IsBool(anchor_smf_oauth2_required)) {
			ogs_error(
				"OpenAPI_pdu_session_context_parseFromJSON() failed [anchor_smf_oauth2_required]");
			goto end;
		}
	}
	...
	pdu_session_context_local_var = OpenAPI_pdu_session_context_create(
		...
		hsmf_id &&
		!cJSON_IsNull(hsmf_id) ? ogs_strdup(hsmf_id->valuestring) :
		NULL,
		hsmf_set_id &&
		!cJSON_IsNull(hsmf_set_id) ?
		ogs_strdup(hsmf_set_id->valuestring) : NULL,
		hsmf_service_set_id &&
		!cJSON_IsNull(hsmf_service_set_id) ?
		ogs_strdup(hsmf_service_set_id->valuestring) : NULL,
		...
		vsmf_set_id &&
		!cJSON_IsNull(vsmf_set_id) ?
		ogs_strdup(vsmf_set_id->valuestring) : NULL,
		vsmf_service_set_id &&
		!cJSON_IsNull(vsmf_service_set_id) ?
		ogs_strdup(vsmf_service_set_id->valuestring) : NULL,
		...
		ismf_set_id &&
		!cJSON_IsNull(ismf_set_id) ?
		ogs_strdup(ismf_set_id->valuestring) : NULL,
		ismf_service_set_id &&
		!cJSON_IsNull(ismf_service_set_id) ?
		ogs_strdup(ismf_service_set_id->valuestring) : NULL,
		ismf_binding ? ismf_bindingVariable : 0,
		ns_instance &&
		!cJSON_IsNull(ns_instance) ?
		ogs_strdup(ns_instance->valuestring) : NULL,
		smf_service_instance_id &&
		!cJSON_IsNull(smf_service_instance_id) ?
		ogs_strdup(smf_service_instance_id->valuestring) : NULL,
		ma_pdu_session ? true : false,
		ma_pdu_session ? ma_pdu_session->valueint : 0,
		cn_assisted_ran_para ? cn_assisted_ran_para_local_nonprim :
		NULL,
		nrf_management_uri &&
		!cJSON_IsNull(nrf_management_uri) ?
		...
		vsmf_binding_info &&
		!cJSON_IsNull(vsmf_binding_info) ?
		ogs_strdup(vsmf_binding_info->valuestring) : NULL,
		ismf_binding_info &&
		!cJSON_IsNull(ismf_binding_info) ?
		ogs_strdup(ismf_binding_info->valuestring) : NULL,
		additional_snssai ? additional_snssai_local_nonprim : NULL,
		inter_plmn_api_root &&
		!cJSON_IsNull(inter_plmn_api_root) ?
		ogs_strdup(inter_plmn_api_root->valuestring) : NULL,
		pgw_fqdn &&
		!cJSON_IsNull(pgw_fqdn) ? ogs_strdup(pgw_fqdn->valuestring) :
		NULL,
		pgw_ip_addr ? pgw_ip_addr_local_nonprim : NULL,
		plmn_id ? plmn_id_local_nonprim : NULL,
		anchor_smf_supported_features &&
		!cJSON_IsNull(anchor_smf_supported_features) ?
		ogs_strdup(anchor_smf_supported_features->valuestring) : NULL,
...
OpenAPI_pdu_session_context_t *OpenAPI_pdu_session_context_copy(
	OpenAPI_pdu_session_context_t	*dst,
	OpenAPI_pdu_session_context_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
