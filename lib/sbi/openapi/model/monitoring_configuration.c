...
OpenAPI_monitoring_configuration_t *OpenAPI_monitoring_configuration_create(
	...
	bool is_idle_status_ind, int idle_status_ind) {
	OpenAPI_monitoring_configuration_t *monitoring_configuration_local_var =
		ogs_malloc(sizeof(OpenAPI_monitoring_configuration_t));
	ogs_assert(monitoring_configuration_local_var);

	monitoring_configuration_local_var->event_type = event_type;
	monitoring_configuration_local_var->is_immediate_flag =
		is_immediate_flag;
	monitoring_configuration_local_var->immediate_flag = immediate_flag;
	monitoring_configuration_local_var->location_reporting_configuration =
		location_reporting_configuration;
	monitoring_configuration_local_var->association_type = association_type;
	monitoring_configuration_local_var->datalink_report_cfg =
		datalink_report_cfg;
	monitoring_configuration_local_var->loss_connectivity_cfg =
		loss_connectivity_cfg;
	monitoring_configuration_local_var->is_maximum_latency =
		is_maximum_latency;
	monitoring_configuration_local_var->maximum_latency = maximum_latency;
	monitoring_configuration_local_var->is_maximum_response_time =
		is_maximum_response_time;
	monitoring_configuration_local_var->maximum_response_time =
		maximum_response_time;
	monitoring_configuration_local_var->is_suggested_packet_num_dl =
		is_suggested_packet_num_dl;
	monitoring_configuration_local_var->suggested_packet_num_dl =
	...
	monitoring_configuration_local_var->pdu_session_status_cfg =
		pdu_session_status_cfg;
	monitoring_configuration_local_var->reachability_for_sms_cfg =
		reachability_for_sms_cfg;
	monitoring_configuration_local_var->mtc_provider_information =
		mtc_provider_information;
	monitoring_configuration_local_var->af_id = af_id;
	monitoring_configuration_local_var->reachability_for_data_cfg =
		reachability_for_data_cfg;
	monitoring_configuration_local_var->is_idle_status_ind =
		is_idle_status_ind;
...
void OpenAPI_monitoring_configuration_free(
	OpenAPI_monitoring_configuration_t *monitoring_configuration) {
	...
	if(monitoring_configuration->location_reporting_configuration) {
		OpenAPI_location_reporting_configuration_free(
			monitoring_configuration->
			location_reporting_configuration);
		monitoring_configuration->location_reporting_configuration =
			NULL;
	}
	...
	if(monitoring_configuration->datalink_report_cfg) {
		OpenAPI_datalink_reporting_configuration_free(
			monitoring_configuration->datalink_report_cfg);
		monitoring_configuration->datalink_report_cfg = NULL;
	}
	if(monitoring_configuration->loss_connectivity_cfg) {
		OpenAPI_loss_connectivity_cfg_free(
	...
	if(monitoring_configuration->pdu_session_status_cfg) {
		OpenAPI_pdu_session_status_cfg_free(
			monitoring_configuration->pdu_session_status_cfg);
	...
	if(monitoring_configuration->reachability_for_sms_cfg) {
		OpenAPI_reachability_for_sms_configuration_free(
			monitoring_configuration->reachability_for_sms_cfg);
	...
	if(monitoring_configuration->reachability_for_data_cfg) {
		OpenAPI_reachability_for_data_configuration_free(
			monitoring_configuration->reachability_for_data_cfg);
		monitoring_configuration->reachability_for_data_cfg = NULL;
	}
	ogs_free(monitoring_configuration);
}

cJSON *OpenAPI_monitoring_configuration_convertToJSON(
	OpenAPI_monitoring_configuration_t *monitoring_configuration) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(monitoring_configuration == NULL) {
		ogs_error(
			"OpenAPI_monitoring_configuration_convertToJSON() failed [MonitoringConfiguration]");
		return NULL;
	}
	...
	if(!monitoring_configuration->event_type) {
		ogs_error(
			"OpenAPI_monitoring_configuration_convertToJSON() failed [event_type]");
		return NULL;
	}
	...
	if(monitoring_configuration->is_immediate_flag) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [immediate_flag]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->location_reporting_configuration) {
		cJSON *location_reporting_configuration_local_JSON =
			OpenAPI_location_reporting_configuration_convertToJSON(
				monitoring_configuration->
				location_reporting_configuration);
		if(location_reporting_configuration_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [location_reporting_configuration]");
			goto end;
		}
	...
	if(monitoring_configuration->association_type) {
		...
		if(association_type_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [association_type]");
			goto end;
		}
	...
	if(monitoring_configuration->datalink_report_cfg) {
		cJSON *datalink_report_cfg_local_JSON =
			OpenAPI_datalink_reporting_configuration_convertToJSON(
				monitoring_configuration->datalink_report_cfg);
		if(datalink_report_cfg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [datalink_report_cfg]");
			goto end;
		}
	...
	if(monitoring_configuration->loss_connectivity_cfg) {
		cJSON *loss_connectivity_cfg_local_JSON =
			OpenAPI_loss_connectivity_cfg_convertToJSON(
				monitoring_configuration->loss_connectivity_cfg);
		if(loss_connectivity_cfg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [loss_connectivity_cfg]");
			goto end;
		}
	...
	if(monitoring_configuration->is_maximum_latency) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [maximum_latency]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->is_maximum_response_time) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [maximum_response_time]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->is_suggested_packet_num_dl) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [suggested_packet_num_dl]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->dnn) {
		if(cJSON_AddStringToObject(item, "dnn",
		                           monitoring_configuration->dnn) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->single_nssai) {
		...
		if(single_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [single_nssai]");
			goto end;
		}
	...
	if(monitoring_configuration->pdu_session_status_cfg) {
		cJSON *pdu_session_status_cfg_local_JSON =
			OpenAPI_pdu_session_status_cfg_convertToJSON(
				monitoring_configuration->pdu_session_status_cfg);
		if(pdu_session_status_cfg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [pdu_session_status_cfg]");
			goto end;
		}
	...
	if(monitoring_configuration->reachability_for_sms_cfg) {
		...
		if(reachability_for_sms_cfg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [reachability_for_sms_cfg]");
			goto end;
		}
	...
	if(monitoring_configuration->mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->af_id) {
		if(cJSON_AddStringToObject(item, "afId",
		                           monitoring_configuration->af_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [af_id]");
			goto end;
		}
	}
	...
	if(monitoring_configuration->reachability_for_data_cfg) {
		...
		if(reachability_for_data_cfg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [reachability_for_data_cfg]");
			goto end;
		}
	...
	if(monitoring_configuration->is_idle_status_ind) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_convertToJSON() failed [idle_status_ind]");
			goto end;
		}
	}
...
OpenAPI_monitoring_configuration_parseFromJSON(
	cJSON *monitoring_configurationJSON) {
	OpenAPI_monitoring_configuration_t *monitoring_configuration_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	OpenAPI_loss_connectivity_cfg_t *loss_connectivity_cfg_local_nonprim =
		NULL;
	...
	OpenAPI_pdu_session_status_cfg_t *pdu_session_status_cfg_local_nonprim =
		NULL;
	...
	event_type =
		cJSON_GetObjectItemCaseSensitive(monitoring_configurationJSON,
		                                 "eventType");
	if(!event_type) {
		ogs_error(
			"OpenAPI_monitoring_configuration_parseFromJSON() failed [event_type]");
		goto end;
	}
	...
	if(immediate_flag) {
		if(!cJSON_IsBool(immediate_flag)) {
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [immediate_flag]");
			goto end;
		}
	}
	...
	if(location_reporting_configuration) {
		location_reporting_configuration_local_nonprim =
			OpenAPI_location_reporting_configuration_parseFromJSON(
				location_reporting_configuration);
		if(!location_reporting_configuration_local_nonprim) {
			ogs_error(
				"OpenAPI_location_reporting_configuration_parseFromJSON failed [location_reporting_configuration]");
			goto end;
		}
	}
	...
	if(datalink_report_cfg) {
		datalink_report_cfg_local_nonprim =
			OpenAPI_datalink_reporting_configuration_parseFromJSON(
				datalink_report_cfg);
		if(!datalink_report_cfg_local_nonprim) {
			ogs_error(
				"OpenAPI_datalink_reporting_configuration_parseFromJSON failed [datalink_report_cfg]");
			goto end;
		}
	}
	...
	if(loss_connectivity_cfg) {
		...
		if(!loss_connectivity_cfg_local_nonprim) {
			ogs_error(
				"OpenAPI_loss_connectivity_cfg_parseFromJSON failed [loss_connectivity_cfg]");
			goto end;
		}
	}
	...
	if(maximum_latency) {
		if(!cJSON_IsNumber(maximum_latency)) {
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [maximum_latency]");
			goto end;
		}
	}
	...
	if(maximum_response_time) {
		if(!cJSON_IsNumber(maximum_response_time)) {
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [maximum_response_time]");
			goto end;
		}
	}
	...
	if(suggested_packet_num_dl) {
		if(!cJSON_IsNumber(suggested_packet_num_dl)) {
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [suggested_packet_num_dl]");
			goto end;
		}
	}

	dnn = cJSON_GetObjectItemCaseSensitive(monitoring_configurationJSON,
	                                       "dnn");
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(pdu_session_status_cfg) {
		...
		if(!pdu_session_status_cfg_local_nonprim) {
			ogs_error(
				"OpenAPI_pdu_session_status_cfg_parseFromJSON failed [pdu_session_status_cfg]");
			goto end;
		}
	}
	...
	if(mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [mtc_provider_information]");
			goto end;
		}
	}

	af_id = cJSON_GetObjectItemCaseSensitive(monitoring_configurationJSON,
	                                         "afId");
	if(af_id) {
		...
		{
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [af_id]");
			goto end;
		}
	}
	...
	if(reachability_for_data_cfg) {
		...
		if(!reachability_for_data_cfg_local_nonprim) {
			ogs_error(
				"OpenAPI_reachability_for_data_configuration_parseFromJSON failed [reachability_for_data_cfg]");
			goto end;
		}
	}
	...
	if(idle_status_ind) {
		if(!cJSON_IsBool(idle_status_ind)) {
			ogs_error(
				"OpenAPI_monitoring_configuration_parseFromJSON() failed [idle_status_ind]");
			goto end;
		}
	}

	monitoring_configuration_local_var =
		OpenAPI_monitoring_configuration_create(
...
OpenAPI_monitoring_configuration_t *OpenAPI_monitoring_configuration_copy(
	OpenAPI_monitoring_configuration_t	*dst,
	OpenAPI_monitoring_configuration_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_monitoring_configuration_convertToJSON() failed");
		return NULL;
	}
