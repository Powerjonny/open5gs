...
typedef enum { OpenAPI_reachability_for_data_report_config_any_of_NULL = 0,
	       OpenAPI_reachability_for_data_report_config_any_of_DIRECT_REPORT,
	       OpenAPI_reachability_for_data_report_config_any_of_INDIRECT_REPORT }
