...
OpenAPI_api_ie_mapping_t *OpenAPI_api_ie_mapping_create(
	...
	OpenAPI_api_ie_mapping_t *api_ie_mapping_local_var =
		ogs_malloc(sizeof(OpenAPI_api_ie_mapping_t));
...
cJSON *OpenAPI_api_ie_mapping_convertToJSON(
	...
	if(api_ie_mapping == NULL) {
		ogs_error(
			"OpenAPI_api_ie_mapping_convertToJSON() failed [ApiIeMapping]");
		return NULL;
	}
	...
	if(!api_ie_mapping->api_signature) {
		ogs_error(
			"OpenAPI_api_ie_mapping_convertToJSON() failed [api_signature]");
		return NULL;
	}
	cJSON *api_signature_local_JSON =
		OpenAPI_api_signature_convertToJSON(
			api_ie_mapping->api_signature);
	...
	if(api_ie_mapping->api_method == OpenAPI_http_method_NULL) {
		ogs_error(
			"OpenAPI_api_ie_mapping_convertToJSON() failed [api_method]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "apiMethod",
	                           OpenAPI_http_method_ToString(
					   api_ie_mapping->api_method)) == NULL)
	{
		ogs_error(
			"OpenAPI_api_ie_mapping_convertToJSON() failed [api_method]");
		goto end;
	...
	if(!api_ie_mapping->ie_list) {
		ogs_error(
			"OpenAPI_api_ie_mapping_convertToJSON() failed [ie_list]");
		return NULL;
	}
...
OpenAPI_api_ie_mapping_t *OpenAPI_api_ie_mapping_parseFromJSON(
	...
	api_signature = cJSON_GetObjectItemCaseSensitive(api_ie_mappingJSON,
	                                                 "apiSignature");
	if(!api_signature) {
		ogs_error(
			"OpenAPI_api_ie_mapping_parseFromJSON() failed [api_signature]");
		goto end;
	}
	api_signature_local_nonprim =
		OpenAPI_api_signature_parseFromJSON(api_signature);
	if(!api_signature_local_nonprim) {
		ogs_error(
			"OpenAPI_api_signature_parseFromJSON failed [api_signature]");
		goto end;
	}

	api_method = cJSON_GetObjectItemCaseSensitive(api_ie_mappingJSON,
	                                              "apiMethod");
	if(!api_method) {
		ogs_error(
			"OpenAPI_api_ie_mapping_parseFromJSON() failed [api_method]");
		goto end;
	}
	...
	api_methodVariable =
		OpenAPI_http_method_FromString(api_method->valuestring);

	ie_list = cJSON_GetObjectItemCaseSensitive(api_ie_mappingJSON,
	                                           "IeList");
	if(!ie_list) {
		ogs_error(
			"OpenAPI_api_ie_mapping_parseFromJSON() failed [ie_list]");
		goto end;
	}
	...
	cJSON_ArrayForEach(ie_list_local, ie_list) {
		...
		OpenAPI_ie_info_t *ie_listItem =
			OpenAPI_ie_info_parseFromJSON(ie_list_local);
		if(!ie_listItem) {
