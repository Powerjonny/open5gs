...
OpenAPI_modification_notification_t *OpenAPI_modification_notification_create(
	...
	OpenAPI_modification_notification_t *modification_notification_local_var
	        = ogs_malloc(sizeof(OpenAPI_modification_notification_t));
...
void OpenAPI_modification_notification_free(
	...
	if(modification_notification->notify_items) {
		OpenAPI_list_for_each(modification_notification->notify_items,
		                      node) {
...
cJSON *OpenAPI_modification_notification_convertToJSON(
	...
	if(modification_notification == NULL) {
		ogs_error(
			"OpenAPI_modification_notification_convertToJSON() failed [ModificationNotification]");
		return NULL;
	}
	...
	if(!modification_notification->notify_items) {
		ogs_error(
			"OpenAPI_modification_notification_convertToJSON() failed [notify_items]");
		return NULL;
	}
...
OpenAPI_modification_notification_parseFromJSON(
	...
	notify_items =
		cJSON_GetObjectItemCaseSensitive(modification_notificationJSON,
		                                 "notifyItems");
	if(!notify_items) {
		ogs_error(
			"OpenAPI_modification_notification_parseFromJSON() failed [notify_items]");
		goto end;
	}
	...
	cJSON_ArrayForEach(notify_items_local, notify_items) {
		...
		OpenAPI_notify_item_t *notify_itemsItem =
			OpenAPI_notify_item_parseFromJSON(notify_items_local);
		if(!notify_itemsItem) {
	...
	modification_notification_local_var =
		OpenAPI_modification_notification_create(
			notify_itemsList
			);
...
OpenAPI_modification_notification_t *OpenAPI_modification_notification_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_modification_notification_convertToJSON() failed");
		return NULL;
	}
