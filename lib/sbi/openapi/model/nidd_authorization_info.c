...
OpenAPI_nidd_authorization_info_t *OpenAPI_nidd_authorization_info_create(
	...
	OpenAPI_nidd_authorization_info_t *nidd_authorization_info_local_var =
		ogs_malloc(sizeof(OpenAPI_nidd_authorization_info_t));
	ogs_assert(nidd_authorization_info_local_var);

	nidd_authorization_info_local_var->nidd_authorization_list =
		nidd_authorization_list;
...
void OpenAPI_nidd_authorization_info_free(
	...
	if(nidd_authorization_info->nidd_authorization_list) {
		OpenAPI_list_for_each(
			nidd_authorization_info->nidd_authorization_list,
			node) {
...
cJSON *OpenAPI_nidd_authorization_info_convertToJSON(
	...
	if(nidd_authorization_info == NULL) {
		ogs_error(
			"OpenAPI_nidd_authorization_info_convertToJSON() failed [NiddAuthorizationInfo]");
		return NULL;
	}
	...
	if(!nidd_authorization_info->nidd_authorization_list) {
		ogs_error(
			"OpenAPI_nidd_authorization_info_convertToJSON() failed [nidd_authorization_list]");
		return NULL;
	}
	cJSON *nidd_authorization_listList = cJSON_AddArrayToObject(item,
	...
	OpenAPI_list_for_each(nidd_authorization_info->nidd_authorization_list,
	                      node) {
		cJSON *itemLocal =
...
OpenAPI_nidd_authorization_info_t *OpenAPI_nidd_authorization_info_parseFromJSON
	...
	nidd_authorization_list =
		cJSON_GetObjectItemCaseSensitive(nidd_authorization_infoJSON,
		                                 "niddAuthorizationList");
	if(!nidd_authorization_list) {
		ogs_error(
			"OpenAPI_nidd_authorization_info_parseFromJSON() failed [nidd_authorization_list]");
		goto end;
	}
	...
	cJSON_ArrayForEach(nidd_authorization_list_local,
	                   nidd_authorization_list) {
		...
		OpenAPI_authorization_info_t *nidd_authorization_listItem =
			OpenAPI_authorization_info_parseFromJSON(
				nidd_authorization_list_local);
		if(!nidd_authorization_listItem) {
			ogs_error("No nidd_authorization_listItem");
			goto end;
		}
		OpenAPI_list_add(nidd_authorization_listList,
		                 nidd_authorization_listItem);
	}

	nidd_authorization_info_local_var =
		OpenAPI_nidd_authorization_info_create(
...
OpenAPI_nidd_authorization_info_t *OpenAPI_nidd_authorization_info_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nidd_authorization_info_convertToJSON() failed");
		return NULL;
	}
