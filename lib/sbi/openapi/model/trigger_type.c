...
OpenAPI_trigger_type_t *OpenAPI_trigger_type_create() {
	OpenAPI_trigger_type_t *trigger_type_local_var =
		ogs_malloc(sizeof(OpenAPI_trigger_type_t));
...
cJSON *OpenAPI_trigger_type_convertToJSON(
	...
	if(trigger_type == NULL) {
		ogs_error(
			"OpenAPI_trigger_type_convertToJSON() failed [TriggerType]");
		return NULL;
	}
