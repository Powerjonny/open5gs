...
char * OpenAPI_location_privacy_ind_ToString(
	...
	const char *location_privacy_indArray[] = { "NULL",
		                                    "LOCATION_DISALLOWED",
		                                    "LOCATION_ALLOWED" };
	size_t sizeofArray = sizeof(location_privacy_indArray) /
	                     sizeof(location_privacy_indArray[0]);
...
OpenAPI_location_privacy_ind_e OpenAPI_location_privacy_ind_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(location_privacy_ind,
		          location_privacy_indArray[stringToReturn]) == 0) {
