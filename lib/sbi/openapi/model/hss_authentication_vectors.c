...
OpenAPI_hss_authentication_vectors_t *OpenAPI_hss_authentication_vectors_create()
{
	OpenAPI_hss_authentication_vectors_t *
		...
		ogs_malloc(sizeof(OpenAPI_hss_authentication_vectors_t));
...
cJSON *OpenAPI_hss_authentication_vectors_convertToJSON(
	...
	if(hss_authentication_vectors == NULL) {
		ogs_error(
			"OpenAPI_hss_authentication_vectors_convertToJSON() failed [HssAuthenticationVectors]");
		return NULL;
	}
...
OpenAPI_hss_authentication_vectors_parseFromJSON(
	...
	OpenAPI_hss_authentication_vectors_t *
	        hss_authentication_vectors_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	hss_authentication_vectors_local_var =
...
OpenAPI_hss_authentication_vectors_t *OpenAPI_hss_authentication_vectors_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_hss_authentication_vectors_convertToJSON() failed");
		return NULL;
	}
