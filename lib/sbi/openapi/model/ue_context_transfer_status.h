...
typedef enum { OpenAPI_ue_context_transfer_status_NULL = 0,
...
char * OpenAPI_ue_context_transfer_status_ToString(
	OpenAPI_ue_context_transfer_status_e ue_context_transfer_status);

OpenAPI_ue_context_transfer_status_e
OpenAPI_ue_context_transfer_status_FromString(char *ue_context_transfer_status);
