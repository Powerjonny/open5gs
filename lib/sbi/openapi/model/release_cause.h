...
typedef enum { OpenAPI_release_cause_NULL = 0,
	       OpenAPI_release_cause_SNPN_SNPN_MOBILITY,
	       OpenAPI_release_cause_NO_HR_AGREEMENT,
	       OpenAPI_release_cause_UNSPECIFIED } OpenAPI_release_cause_e;
