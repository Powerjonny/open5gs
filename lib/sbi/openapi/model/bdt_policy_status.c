...
OpenAPI_bdt_policy_status_t *OpenAPI_bdt_policy_status_create() {
	OpenAPI_bdt_policy_status_t *bdt_policy_status_local_var =
		ogs_malloc(sizeof(OpenAPI_bdt_policy_status_t));
...
void OpenAPI_bdt_policy_status_free(
	OpenAPI_bdt_policy_status_t *bdt_policy_status) {
...
cJSON *OpenAPI_bdt_policy_status_convertToJSON(
	OpenAPI_bdt_policy_status_t *bdt_policy_status) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(bdt_policy_status == NULL) {
		ogs_error(
			"OpenAPI_bdt_policy_status_convertToJSON() failed [BdtPolicyStatus]");
		return NULL;
	}
...
OpenAPI_bdt_policy_status_t *OpenAPI_bdt_policy_status_parseFromJSON(
	cJSON *bdt_policy_statusJSON) {
...
OpenAPI_bdt_policy_status_t *OpenAPI_bdt_policy_status_copy(
	OpenAPI_bdt_policy_status_t *dst, OpenAPI_bdt_policy_status_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
