...
OpenAPI_transfer_mt_data_error_t *OpenAPI_transfer_mt_data_error_create(
	...
	bool is_remote_error, int remote_error, bool is_max_waiting_time,
	int max_waiting_time) {
	OpenAPI_transfer_mt_data_error_t *transfer_mt_data_error_local_var =
		ogs_malloc(sizeof(OpenAPI_transfer_mt_data_error_t));
	...
	transfer_mt_data_error_local_var->supported_features =
		supported_features;
	transfer_mt_data_error_local_var->access_token_error =
		access_token_error;
	transfer_mt_data_error_local_var->access_token_request =
	...
	transfer_mt_data_error_local_var->is_max_waiting_time =
		is_max_waiting_time;
...
void OpenAPI_transfer_mt_data_error_free(
	OpenAPI_transfer_mt_data_error_t *transfer_mt_data_error) {
	...
	if(transfer_mt_data_error->access_token_error) {
		OpenAPI_access_token_err_free(
			transfer_mt_data_error->access_token_error);
	...
	if(transfer_mt_data_error->access_token_request) {
		OpenAPI_access_token_req_free(
			transfer_mt_data_error->access_token_request);
...
cJSON *OpenAPI_transfer_mt_data_error_convertToJSON(
	OpenAPI_transfer_mt_data_error_t *transfer_mt_data_error) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(transfer_mt_data_error == NULL) {
		ogs_error(
			"OpenAPI_transfer_mt_data_error_convertToJSON() failed [TransferMtDataError]");
		return NULL;
	}
	...
	if(transfer_mt_data_error->type) {
		if(cJSON_AddStringToObject(item, "type",
		                           transfer_mt_data_error->type) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [type]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->title) {
		if(cJSON_AddStringToObject(item, "title",
		                           transfer_mt_data_error->title) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [title]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->is_status) {
		if(cJSON_AddNumberToObject(item, "status",
		                           transfer_mt_data_error->status) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [status]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->detail) {
		if(cJSON_AddStringToObject(item, "detail",
		                           transfer_mt_data_error->detail) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [detail]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->instance) {
		if(cJSON_AddStringToObject(item, "instance",
		                           transfer_mt_data_error->instance) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [instance]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->cause) {
		if(cJSON_AddStringToObject(item, "cause",
		                           transfer_mt_data_error->cause) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->invalid_params) {
		...
		if(invalid_paramsList == NULL) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [invalid_params]");
			goto end;
		}
		OpenAPI_list_for_each(transfer_mt_data_error->invalid_params,
		                      node) {
	...
	if(transfer_mt_data_error->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->access_token_error) {
		...
		if(access_token_error_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [access_token_error]");
			goto end;
		}
	...
	if(transfer_mt_data_error->access_token_request) {
		...
		if(access_token_request_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [access_token_request]");
			goto end;
		}
	...
	if(transfer_mt_data_error->nrf_id) {
		if(cJSON_AddStringToObject(item, "nrfId",
		                           transfer_mt_data_error->nrf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [nrf_id]");
			goto end;
		}
	}

	if(transfer_mt_data_error->is_remote_error) {
		if(cJSON_AddBoolToObject(item, "remoteError",
		                         transfer_mt_data_error->remote_error)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [remote_error]");
			goto end;
		}
	}
	...
	if(transfer_mt_data_error->is_max_waiting_time) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_convertToJSON() failed [max_waiting_time]");
			goto end;
		}
	}
...
OpenAPI_transfer_mt_data_error_t *OpenAPI_transfer_mt_data_error_parseFromJSON(
	cJSON *transfer_mt_data_errorJSON) {
	OpenAPI_transfer_mt_data_error_t *transfer_mt_data_error_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *type = NULL;
	...
	type = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                        "type");
	if(type) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [type]");
			goto end;
		}
	}

	title = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                         "title");
	if(title) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [title]");
			goto end;
		}
	}

	status = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                          "status");
	if(status) {
		if(!cJSON_IsNumber(status)) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [status]");
			goto end;
		}
	}

	detail = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                          "detail");
	if(detail) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [detail]");
			goto end;
		}
	}

	instance = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                            "instance");
	if(instance) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [instance]");
			goto end;
		}
	}

	cause = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                         "cause");
	if(cause) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [cause]");
			goto end;
		}
	}

	invalid_params =
		cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
		                                 "invalidParams");
	if(invalid_params) {
		cJSON *invalid_params_local = NULL;
		if(!cJSON_IsArray(invalid_params)) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [invalid_params]");
			goto end;
		}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	nrf_id = cJSON_GetObjectItemCaseSensitive(transfer_mt_data_errorJSON,
	                                          "nrfId");
	if(nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [nrf_id]");
			goto end;
		}
	}
	...
	if(remote_error) {
		if(!cJSON_IsBool(remote_error)) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [remote_error]");
			goto end;
		}
	}
	...
	if(max_waiting_time) {
		if(!cJSON_IsNumber(max_waiting_time)) {
			ogs_error(
				"OpenAPI_transfer_mt_data_error_parseFromJSON() failed [max_waiting_time]");
			goto end;
		}
	}

	transfer_mt_data_error_local_var =
...
OpenAPI_transfer_mt_data_error_t *OpenAPI_transfer_mt_data_error_copy(
	OpenAPI_transfer_mt_data_error_t	*dst,
	OpenAPI_transfer_mt_data_error_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_transfer_mt_data_error_convertToJSON() failed");
		return NULL;
	}
