...
OpenAPI_output_strategy_t *OpenAPI_output_strategy_create() {
	OpenAPI_output_strategy_t *output_strategy_local_var =
		ogs_malloc(sizeof(OpenAPI_output_strategy_t));
...
cJSON *OpenAPI_output_strategy_convertToJSON(
	OpenAPI_output_strategy_t *output_strategy) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(output_strategy == NULL) {
		ogs_error(
			"OpenAPI_output_strategy_convertToJSON() failed [OutputStrategy]");
		return NULL;
	}
...
OpenAPI_output_strategy_t *OpenAPI_output_strategy_parseFromJSON(
	cJSON *output_strategyJSON) {
...
OpenAPI_output_strategy_t *OpenAPI_output_strategy_copy(
	OpenAPI_output_strategy_t *dst, OpenAPI_output_strategy_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
