...
char * OpenAPI_pdu_session_status_ToString(
	...
	const char *pdu_session_statusArray[] = { "NULL", "ACTIVE",
		                                  "RELEASED" };
	size_t sizeofArray = sizeof(pdu_session_statusArray) /
	                     sizeof(pdu_session_statusArray[0]);
...
OpenAPI_pdu_session_status_e OpenAPI_pdu_session_status_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(pdu_session_status,
		          pdu_session_statusArray[stringToReturn]) == 0)
		{
