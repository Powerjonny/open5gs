...
OpenAPI_lcs_broadcast_assistance_types_data_create(
	...
	OpenAPI_lcs_broadcast_assistance_types_data_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_lcs_broadcast_assistance_types_data_t));
...
void OpenAPI_lcs_broadcast_assistance_types_data_free(
	OpenAPI_lcs_broadcast_assistance_types_data_t *
...
cJSON *OpenAPI_lcs_broadcast_assistance_types_data_convertToJSON(
	OpenAPI_lcs_broadcast_assistance_types_data_t *
	lcs_broadcast_assistance_types_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(lcs_broadcast_assistance_types_data == NULL) {
		ogs_error(
			"OpenAPI_lcs_broadcast_assistance_types_data_convertToJSON() failed [LcsBroadcastAssistanceTypesData]");
		return NULL;
	}
	...
	if(!lcs_broadcast_assistance_types_data->location_assistance_type) {
		ogs_error(
			"OpenAPI_lcs_broadcast_assistance_types_data_convertToJSON() failed [location_assistance_type]");
		return NULL;
	}
	char *encoded_str_location_assistance_type =
		OpenAPI_base64encode(
			lcs_broadcast_assistance_types_data->
			location_assistance_type->data,
			lcs_broadcast_assistance_types_data->
			location_assistance_type->len);
...
OpenAPI_lcs_broadcast_assistance_types_data_parseFromJSON(
	...
	if(!location_assistance_type) {
		ogs_error(
			"OpenAPI_lcs_broadcast_assistance_types_data_parseFromJSON() failed [location_assistance_type]");
		goto end;
	}
	...
	decoded_str_location_assistance_type->data =
		OpenAPI_base64decode(location_assistance_type->valuestring,
		                     strlen(
					     location_assistance_type->
					     valuestring),
...
OpenAPI_lcs_broadcast_assistance_types_data_copy(
	OpenAPI_lcs_broadcast_assistance_types_data_t	*dst,
	OpenAPI_lcs_broadcast_assistance_types_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_lcs_broadcast_assistance_types_data_convertToJSON() failed");
		return NULL;
	}
