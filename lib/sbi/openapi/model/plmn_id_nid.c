...
OpenAPI_plmn_id_nid_t *OpenAPI_plmn_id_nid_create(char *mcc, char *mnc,
                                                  char *nid) {
	OpenAPI_plmn_id_nid_t *plmn_id_nid_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_id_nid_t));
...
cJSON *OpenAPI_plmn_id_nid_convertToJSON(OpenAPI_plmn_id_nid_t *plmn_id_nid) {
	...
	if(plmn_id_nid == NULL) {
		ogs_error(
			"OpenAPI_plmn_id_nid_convertToJSON() failed [PlmnIdNid]");
		return NULL;
	}
	...
	if(plmn_id_nid->nid) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_id_nid_convertToJSON() failed [nid]");
			goto end;
		}
	}
...
OpenAPI_plmn_id_nid_t *OpenAPI_plmn_id_nid_parseFromJSON(
	...
	if(nid) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_id_nid_parseFromJSON() failed [nid]");
			goto end;
		}
	}
