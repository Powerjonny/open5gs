...
OpenAPI_red_trans_exp_ordering_criterion_create() {
	OpenAPI_red_trans_exp_ordering_criterion_t *
		...
		ogs_malloc(sizeof(OpenAPI_red_trans_exp_ordering_criterion_t));
...
cJSON *OpenAPI_red_trans_exp_ordering_criterion_convertToJSON(
	...
	if(red_trans_exp_ordering_criterion == NULL) {
		ogs_error(
			"OpenAPI_red_trans_exp_ordering_criterion_convertToJSON() failed [RedTransExpOrderingCriterion]");
		return NULL;
	}
...
OpenAPI_red_trans_exp_ordering_criterion_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_red_trans_exp_ordering_criterion_convertToJSON() failed");
		return NULL;
	}
