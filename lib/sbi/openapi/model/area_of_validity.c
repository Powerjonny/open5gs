...
OpenAPI_area_of_validity_t *OpenAPI_area_of_validity_create(
	...
	OpenAPI_area_of_validity_t *area_of_validity_local_var =
		ogs_malloc(sizeof(OpenAPI_area_of_validity_t));
...
void OpenAPI_area_of_validity_free(
...
cJSON *OpenAPI_area_of_validity_convertToJSON(
	OpenAPI_area_of_validity_t *area_of_validity) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(area_of_validity == NULL) {
		ogs_error(
			"OpenAPI_area_of_validity_convertToJSON() failed [AreaOfValidity]");
		return NULL;
	}
	...
	if(!area_of_validity->tai_list) {
		ogs_error(
			"OpenAPI_area_of_validity_convertToJSON() failed [tai_list]");
		return NULL;
	}
...
OpenAPI_area_of_validity_t *OpenAPI_area_of_validity_parseFromJSON(
	cJSON *area_of_validityJSON) {
	...
	if(!tai_list) {
		ogs_error(
			"OpenAPI_area_of_validity_parseFromJSON() failed [tai_list]");
		goto end;
	}
...
OpenAPI_area_of_validity_t *OpenAPI_area_of_validity_copy(
	OpenAPI_area_of_validity_t *dst, OpenAPI_area_of_validity_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
