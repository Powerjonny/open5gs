...
typedef enum { OpenAPI_upf_cond_CONDITIONTYPE_NULL = 0,
	       OpenAPI_upf_cond_CONDITIONTYPE_UPF_COND }
OpenAPI_upf_cond_condition_type_e;

char * OpenAPI_upf_cond_condition_type_ToString(
	OpenAPI_upf_cond_condition_type_e condition_type);

OpenAPI_upf_cond_condition_type_e OpenAPI_upf_cond_condition_type_FromString(
	char *condition_type);
