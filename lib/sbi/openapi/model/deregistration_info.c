...
OpenAPI_deregistration_info_t *OpenAPI_deregistration_info_create(char *supi,
                                                                  char	*
                                                                  supported_features)
{
	OpenAPI_deregistration_info_t *deregistration_info_local_var =
		ogs_malloc(sizeof(OpenAPI_deregistration_info_t));
...
void OpenAPI_deregistration_info_free(
	OpenAPI_deregistration_info_t *deregistration_info) {
...
cJSON *OpenAPI_deregistration_info_convertToJSON(
	OpenAPI_deregistration_info_t *deregistration_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(deregistration_info == NULL) {
		ogs_error(
			"OpenAPI_deregistration_info_convertToJSON() failed [DeregistrationInfo]");
		return NULL;
	}
	...
	if(!deregistration_info->supi) {
		ogs_error(
			"OpenAPI_deregistration_info_convertToJSON() failed [supi]");
		return NULL;
	}
	...
	if(deregistration_info->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_deregistration_info_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_deregistration_info_t *OpenAPI_deregistration_info_parseFromJSON(
	cJSON *deregistration_infoJSON) {
	OpenAPI_deregistration_info_t *deregistration_info_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *supi = NULL;
	cJSON *supported_features = NULL;
	supi = cJSON_GetObjectItemCaseSensitive(deregistration_infoJSON,
	                                        "supi");
	if(!supi) {
		ogs_error(
			"OpenAPI_deregistration_info_parseFromJSON() failed [supi]");
		goto end;
	}
	...
	supported_features =
		cJSON_GetObjectItemCaseSensitive(deregistration_infoJSON,
		                                 "supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_deregistration_info_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_deregistration_info_t *OpenAPI_deregistration_info_copy(
	OpenAPI_deregistration_info_t	*dst,
	OpenAPI_deregistration_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
