...
typedef enum { OpenAPI_response_time_NULL = 0, OpenAPI_response_time_LOW_DELAY,
	       OpenAPI_response_time_DELAY_TOLERANT,
	       OpenAPI_response_time_NO_DELAY } OpenAPI_response_time_e;
