...
OpenAPI_ue_identity_info_t *OpenAPI_ue_identity_info_create(char	*gpsi,
                                                            char	*pei,
                                                            char	*supi) {
	OpenAPI_ue_identity_info_t *ue_identity_info_local_var =
		ogs_malloc(sizeof(OpenAPI_ue_identity_info_t));
...
void OpenAPI_ue_identity_info_free(
...
cJSON *OpenAPI_ue_identity_info_convertToJSON(
	OpenAPI_ue_identity_info_t *ue_identity_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_identity_info == NULL) {
		ogs_error(
			"OpenAPI_ue_identity_info_convertToJSON() failed [UeIdentityInfo]");
		return NULL;
	}
	...
	if(ue_identity_info->gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_ue_identity_info_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(ue_identity_info->pei) {
		...
		{
			ogs_error(
				"OpenAPI_ue_identity_info_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(ue_identity_info->supi) {
		...
		{
			ogs_error(
				"OpenAPI_ue_identity_info_convertToJSON() failed [supi]");
			goto end;
		}
	}
...
OpenAPI_ue_identity_info_t *OpenAPI_ue_identity_info_parseFromJSON(
	...
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_ue_identity_info_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_ue_identity_info_parseFromJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_ue_identity_info_parseFromJSON() failed [supi]");
			goto end;
		}
	}
...
OpenAPI_ue_identity_info_t *OpenAPI_ue_identity_info_copy(
	OpenAPI_ue_identity_info_t *dst, OpenAPI_ue_identity_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
