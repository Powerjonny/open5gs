...
OpenAPI_port_management_container_t *OpenAPI_port_management_container_create(
	...
	OpenAPI_port_management_container_t *port_management_container_local_var
	        = ogs_malloc(sizeof(OpenAPI_port_management_container_t));
...
cJSON *OpenAPI_port_management_container_convertToJSON(
	...
	if(port_management_container == NULL) {
		ogs_error(
			"OpenAPI_port_management_container_convertToJSON() failed [PortManagementContainer]");
		return NULL;
	}
	...
	if(!port_management_container->port_man_cont) {
		ogs_error(
			"OpenAPI_port_management_container_convertToJSON() failed [port_man_cont]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "portManCont",
	                           port_management_container->port_man_cont) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_port_management_container_convertToJSON() failed [port_man_cont]");
	...
	if(cJSON_AddNumberToObject(item, "portNum",
	                           port_management_container->port_num) == NULL)
	{
		ogs_error(
			"OpenAPI_port_management_container_convertToJSON() failed [port_num]");
		goto end;
	}
...
OpenAPI_port_management_container_parseFromJSON(
	...
	cJSON *port_num = NULL;
	port_man_cont =
		cJSON_GetObjectItemCaseSensitive(port_management_containerJSON,
		                                 "portManCont");
	if(!port_man_cont) {
		ogs_error(
			"OpenAPI_port_management_container_parseFromJSON() failed [port_man_cont]");
		goto end;
	}
	...
	if(!port_num) {
		ogs_error(
			"OpenAPI_port_management_container_parseFromJSON() failed [port_num]");
		goto end;
	}
	...
	port_management_container_local_var =
...
OpenAPI_port_management_container_t *OpenAPI_port_management_container_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_port_management_container_convertToJSON() failed");
		return NULL;
	}
