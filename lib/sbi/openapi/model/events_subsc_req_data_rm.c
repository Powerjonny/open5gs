...
OpenAPI_events_subsc_req_data_rm_t *OpenAPI_events_subsc_req_data_rm_create(
	...
	OpenAPI_list_t *req_qos_mon_params, bool is_qos_mon_null,
	OpenAPI_qos_monitoring_information_rm_t *qos_mon,
	OpenAPI_list_t *req_anis, bool is_usg_thres_null,
	OpenAPI_usage_threshold_rm_t *usg_thres, char *notif_corre_id,
	bool is_direct_notif_ind_null, bool is_direct_notif_ind,
	int direct_notif_ind) {
	OpenAPI_events_subsc_req_data_rm_t *events_subsc_req_data_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_events_subsc_req_data_rm_t));
	...
	events_subsc_req_data_rm_local_var->req_qos_mon_params =
		req_qos_mon_params;
	...
	events_subsc_req_data_rm_local_var->is_usg_thres_null =
		is_usg_thres_null;
	events_subsc_req_data_rm_local_var->usg_thres = usg_thres;
	events_subsc_req_data_rm_local_var->notif_corre_id = notif_corre_id;
	events_subsc_req_data_rm_local_var->is_direct_notif_ind_null =
		is_direct_notif_ind_null;
	events_subsc_req_data_rm_local_var->is_direct_notif_ind =
		is_direct_notif_ind;
...
void OpenAPI_events_subsc_req_data_rm_free(
	OpenAPI_events_subsc_req_data_rm_t *events_subsc_req_data_rm) {
	...
	if(events_subsc_req_data_rm->qos_mon) {
		OpenAPI_qos_monitoring_information_rm_free(
			events_subsc_req_data_rm->qos_mon);
	...
	if(events_subsc_req_data_rm->usg_thres) {
		OpenAPI_usage_threshold_rm_free(
			events_subsc_req_data_rm->usg_thres);
...
cJSON *OpenAPI_events_subsc_req_data_rm_convertToJSON(
	OpenAPI_events_subsc_req_data_rm_t *events_subsc_req_data_rm) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(events_subsc_req_data_rm == NULL) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [EventsSubscReqDataRm]");
		return NULL;
	}
	...
	if(!events_subsc_req_data_rm->events) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [events]");
		return NULL;
	}
	...
	if(events_subsc_req_data_rm->notif_uri) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [notif_uri]");
			goto end;
		}
	}
	   ...
	   OpenAPI_requested_qos_monitoring_parameter_NULL)
	{
		...
		if(req_qos_mon_paramsList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [req_qos_mon_params]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_subsc_req_data_rm->req_qos_mon_params, node) {
	...
	if(events_subsc_req_data_rm->qos_mon) {
		cJSON *qos_mon_local_JSON =
			OpenAPI_qos_monitoring_information_rm_convertToJSON(
				events_subsc_req_data_rm->qos_mon);
		if(qos_mon_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [qos_mon]");
			goto end;
		}
	   ...
	   OpenAPI_required_access_info_NULL)
	{
		...
		if(req_anisList == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [req_anis]");
			goto end;
		}
		OpenAPI_list_for_each(events_subsc_req_data_rm->req_anis,
		                      node) {
	...
	if(events_subsc_req_data_rm->usg_thres) {
		cJSON *usg_thres_local_JSON =
			OpenAPI_usage_threshold_rm_convertToJSON(
				events_subsc_req_data_rm->usg_thres);
		if(usg_thres_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [usg_thres]");
			goto end;
		}
	...
	if(events_subsc_req_data_rm->notif_corre_id) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [notif_corre_id]");
			goto end;
		}
	}
	...
	if(events_subsc_req_data_rm->is_direct_notif_ind) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed [direct_notif_ind]");
			goto end;
		}
...
OpenAPI_events_subsc_req_data_rm_parseFromJSON(
	cJSON *events_subsc_req_data_rmJSON) {
	OpenAPI_events_subsc_req_data_rm_t *events_subsc_req_data_rm_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *events = NULL;
	...
	events = cJSON_GetObjectItemCaseSensitive(events_subsc_req_data_rmJSON,
	                                          "events");
	if(!events) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed [events]");
		goto end;
	}
	...
	notif_uri =
		cJSON_GetObjectItemCaseSensitive(events_subsc_req_data_rmJSON,
		                                 "notifUri");
	if(notif_uri) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed [notif_uri]");
			goto end;
		}
	}
	...
	if(req_qos_mon_params) {
		...
		if(!cJSON_IsArray(req_qos_mon_params)) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed [req_qos_mon_params]");
			goto end;
		}
		...
		if(req_qos_mon_paramsList->count == 0) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed: Expected req_qos_mon_paramsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	qos_mon = cJSON_GetObjectItemCaseSensitive(events_subsc_req_data_rmJSON,
	                                           "qosMon");
	if(qos_mon) {
		if(!cJSON_IsNull(qos_mon)) {
			qos_mon_local_nonprim =
				OpenAPI_qos_monitoring_information_rm_parseFromJSON
				        (qos_mon);
			if(!qos_mon_local_nonprim) {
				ogs_error(
					"OpenAPI_qos_monitoring_information_rm_parseFromJSON failed [qos_mon]");
				goto end;
			}
		}
	}
	...
	if(req_anis) {
		...
		if(!cJSON_IsArray(req_anis)) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed [req_anis]");
			goto end;
		}
		...
		if(req_anisList->count == 0) {
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed: Expected req_anisList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(usg_thres) {
		if(!cJSON_IsNull(usg_thres)) {
			usg_thres_local_nonprim =
				OpenAPI_usage_threshold_rm_parseFromJSON(
					usg_thres);
			if(!usg_thres_local_nonprim) {
				ogs_error(
					"OpenAPI_usage_threshold_rm_parseFromJSON failed [usg_thres]");
				goto end;
			}
		}
	}
	...
	if(notif_corre_id) {
		...
		{
			ogs_error(
				"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed [notif_corre_id]");
			goto end;
		}
	}
	...
	if(direct_notif_ind) {
		if(!cJSON_IsNull(direct_notif_ind)) {
			if(!cJSON_IsBool(direct_notif_ind)) {
				ogs_error(
					"OpenAPI_events_subsc_req_data_rm_parseFromJSON() failed [direct_notif_ind]");
				goto end;
			}
		}
	}
	...
	events_subsc_req_data_rm_local_var =
		OpenAPI_events_subsc_req_data_rm_create(
			eventsList,
			notif_uri &&
			!cJSON_IsNull(notif_uri) ?
...
OpenAPI_events_subsc_req_data_rm_t *OpenAPI_events_subsc_req_data_rm_copy(
	OpenAPI_events_subsc_req_data_rm_t	*dst,
	OpenAPI_events_subsc_req_data_rm_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_events_subsc_req_data_rm_convertToJSON() failed");
		return NULL;
	}
