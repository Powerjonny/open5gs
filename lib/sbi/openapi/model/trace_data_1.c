...
OpenAPI_trace_data_1_t *OpenAPI_trace_data_1_create(char *trace_ref,
                                                    OpenAPI_trace_depth_e
                                                    trace_depth,
                                                    char	*ne_type_list,
                                                    char	*event_list,
                                                    char *
                                                    ...
                                                    char *interface_list) {
	OpenAPI_trace_data_1_t *trace_data_1_local_var =
		ogs_malloc(sizeof(OpenAPI_trace_data_1_t));
	...
	trace_data_1_local_var->collection_entity_ipv4_addr =
		collection_entity_ipv4_addr;
	trace_data_1_local_var->collection_entity_ipv6_addr =
		collection_entity_ipv6_addr;
...
cJSON *OpenAPI_trace_data_1_convertToJSON(
	...
	if(trace_data_1 == NULL) {
		ogs_error(
			"OpenAPI_trace_data_1_convertToJSON() failed [TraceData_1]");
		return NULL;
	}
	...
	if(!trace_data_1->trace_ref) {
		ogs_error(
			"OpenAPI_trace_data_1_convertToJSON() failed [trace_ref]");
		return NULL;
	}
	...
	if(cJSON_AddStringToObject(item, "traceDepth",
	                           OpenAPI_trace_depth_ToString(
					   trace_data_1->trace_depth)) == NULL)
	{
		ogs_error(
			"OpenAPI_trace_data_1_convertToJSON() failed [trace_depth]");
		goto end;
	...
	if(!trace_data_1->ne_type_list) {
		ogs_error(
			"OpenAPI_trace_data_1_convertToJSON() failed [ne_type_list]");
		return NULL;
	}
	...
	if(!trace_data_1->event_list) {
		ogs_error(
			"OpenAPI_trace_data_1_convertToJSON() failed [event_list]");
		return NULL;
	}
	...
	if(trace_data_1->collection_entity_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_1_convertToJSON() failed [collection_entity_ipv4_addr]");
			goto end;
		}
	}

	if(trace_data_1->collection_entity_ipv6_addr) {
		if(cJSON_AddStringToObject(item, "collectionEntityIpv6Addr",
		                           trace_data_1->
		                           collection_entity_ipv6_addr) == NULL)
		{
			ogs_error(
				"OpenAPI_trace_data_1_convertToJSON() failed [collection_entity_ipv6_addr]");
			goto end;
		}
	}
	...
	if(trace_data_1->interface_list) {
		if(cJSON_AddStringToObject(item, "interfaceList",
		                           trace_data_1->interface_list) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_trace_data_1_convertToJSON() failed [interface_list]");
			goto end;
		}
	}
...
OpenAPI_trace_data_1_t *OpenAPI_trace_data_1_parseFromJSON(
	...
	trace_ref = cJSON_GetObjectItemCaseSensitive(trace_data_1JSON,
	                                             "traceRef");
	if(!trace_ref) {
		ogs_error(
			"OpenAPI_trace_data_1_parseFromJSON() failed [trace_ref]");
		goto end;
	}
	...
	trace_depth = cJSON_GetObjectItemCaseSensitive(trace_data_1JSON,
	                                               "traceDepth");
	if(!trace_depth) {
		ogs_error(
			"OpenAPI_trace_data_1_parseFromJSON() failed [trace_depth]");
		goto end;
	}
	...
	trace_depthVariable =
		OpenAPI_trace_depth_FromString(trace_depth->valuestring);

	ne_type_list = cJSON_GetObjectItemCaseSensitive(trace_data_1JSON,
	                                                "neTypeList");
	if(!ne_type_list) {
		ogs_error(
			"OpenAPI_trace_data_1_parseFromJSON() failed [ne_type_list]");
		goto end;
	}
	...
	event_list = cJSON_GetObjectItemCaseSensitive(trace_data_1JSON,
	                                              "eventList");
	if(!event_list) {
		ogs_error(
			"OpenAPI_trace_data_1_parseFromJSON() failed [event_list]");
		goto end;
	}
	...
	if(collection_entity_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_1_parseFromJSON() failed [collection_entity_ipv4_addr]");
			goto end;
		}
	}
	...
	if(collection_entity_ipv6_addr) {
		if(!cJSON_IsString(collection_entity_ipv6_addr) &&
		   !cJSON_IsNull(collection_entity_ipv6_addr))
		{
			ogs_error(
				"OpenAPI_trace_data_1_parseFromJSON() failed [collection_entity_ipv6_addr]");
			goto end;
		}
	}

	interface_list = cJSON_GetObjectItemCaseSensitive(trace_data_1JSON,
	                                                  "interfaceList");
	if(interface_list) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_1_parseFromJSON() failed [interface_list]");
			goto end;
		}
	}
	...
	trace_data_1_local_var = OpenAPI_trace_data_1_create(
		...
		collection_entity_ipv4_addr &&
		!cJSON_IsNull(collection_entity_ipv4_addr) ?
		ogs_strdup(collection_entity_ipv4_addr->valuestring) : NULL,
		collection_entity_ipv6_addr &&
		!cJSON_IsNull(collection_entity_ipv6_addr) ?
		ogs_strdup(collection_entity_ipv6_addr->valuestring) : NULL,
		interface_list &&
		!cJSON_IsNull(interface_list) ?
		ogs_strdup(interface_list->valuestring) : NULL
		);
...
OpenAPI_trace_data_1_t *OpenAPI_trace_data_1_copy(
	OpenAPI_trace_data_1_t	*dst,
