...
OpenAPI_bdt_policy_data_t *OpenAPI_bdt_policy_data_create(char *inter_group_id,
                                                          char *supi,
                                                          char *bdt_ref_id,
                                                          char *dnn,
                                                          OpenAPI_snssai_t *
                                                          ...
                                                          OpenAPI_list_t *
                                                          reset_ids) {
	OpenAPI_bdt_policy_data_t *bdt_policy_data_local_var =
		ogs_malloc(sizeof(OpenAPI_bdt_policy_data_t));
...
cJSON *OpenAPI_bdt_policy_data_convertToJSON(
	...
	if(bdt_policy_data == NULL) {
		ogs_error(
			"OpenAPI_bdt_policy_data_convertToJSON() failed [BdtPolicyData]");
		return NULL;
	}
	...
	if(bdt_policy_data->inter_group_id) {
		if(cJSON_AddStringToObject(item, "interGroupId",
		                           bdt_policy_data->inter_group_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_convertToJSON() failed [inter_group_id]");
			goto end;
		}
	}
	...
	if(bdt_policy_data->supi) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_convertToJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(!bdt_policy_data->bdt_ref_id) {
		ogs_error(
			"OpenAPI_bdt_policy_data_convertToJSON() failed [bdt_ref_id]");
		return NULL;
	}
	...
	if(bdt_policy_data->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(bdt_policy_data->snssai) {
		cJSON *snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(bdt_policy_data->snssai);
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_bdt_policy_data_convertToJSON() failed [snssai]");
			goto end;
		}
	...
	if(bdt_policy_data->res_uri) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_convertToJSON() failed [res_uri]");
			goto end;
		}
	}
	...
	if(bdt_policy_data->reset_ids) {
		...
		if(reset_idsList == NULL) {
			ogs_error(
				"OpenAPI_bdt_policy_data_convertToJSON() failed [reset_ids]");
			goto end;
		}
		OpenAPI_list_for_each(bdt_policy_data->reset_ids, node) {
...
OpenAPI_bdt_policy_data_t *OpenAPI_bdt_policy_data_parseFromJSON(
	cJSON *bdt_policy_dataJSON) {
	...
	inter_group_id = cJSON_GetObjectItemCaseSensitive(bdt_policy_dataJSON,
	                                                  "interGroupId");
	if(inter_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_parseFromJSON() failed [inter_group_id]");
			goto end;
		}
	}
	...
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_parseFromJSON() failed [supi]");
			goto end;
		}
	}

	bdt_ref_id = cJSON_GetObjectItemCaseSensitive(bdt_policy_dataJSON,
	                                              "bdtRefId");
	if(!bdt_ref_id) {
		ogs_error(
			"OpenAPI_bdt_policy_data_parseFromJSON() failed [bdt_ref_id]");
		goto end;
	}
	...
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_parseFromJSON() failed [dnn]");
			goto end;
		}
	}

	snssai = cJSON_GetObjectItemCaseSensitive(bdt_policy_dataJSON,
	                                          "snssai");
	if(snssai) {
	...
	res_uri = cJSON_GetObjectItemCaseSensitive(bdt_policy_dataJSON,
	                                           "resUri");
	if(res_uri) {
		...
		{
			ogs_error(
				"OpenAPI_bdt_policy_data_parseFromJSON() failed [res_uri]");
			goto end;
		}
	}

	reset_ids = cJSON_GetObjectItemCaseSensitive(bdt_policy_dataJSON,
	                                             "resetIds");
	if(reset_ids) {
		cJSON *reset_ids_local = NULL;
		if(!cJSON_IsArray(reset_ids)) {
			ogs_error(
				"OpenAPI_bdt_policy_data_parseFromJSON() failed [reset_ids]");
			goto end;
		}
...
OpenAPI_bdt_policy_data_t *OpenAPI_bdt_policy_data_copy(
	OpenAPI_bdt_policy_data_t *dst, OpenAPI_bdt_policy_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
