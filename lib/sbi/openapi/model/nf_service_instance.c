...
OpenAPI_nf_service_instance_t *OpenAPI_nf_service_instance_create(
	char *service_instance_id, char *nf_instance_id,
	char *nf_service_set_id) {
	OpenAPI_nf_service_instance_t *nf_service_instance_local_var =
		ogs_malloc(sizeof(OpenAPI_nf_service_instance_t));
...
void OpenAPI_nf_service_instance_free(
...
cJSON *OpenAPI_nf_service_instance_convertToJSON(
	OpenAPI_nf_service_instance_t *nf_service_instance) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nf_service_instance == NULL) {
		ogs_error(
			"OpenAPI_nf_service_instance_convertToJSON() failed [NfServiceInstance]");
		return NULL;
	}
	...
	if(nf_service_instance->service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_instance_convertToJSON() failed [service_instance_id]");
			goto end;
		}
	}
	...
	if(nf_service_instance->nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_instance_convertToJSON() failed [nf_instance_id]");
			goto end;
		}
	}
	...
	if(nf_service_instance->nf_service_set_id) {
		if(cJSON_AddStringToObject(item, "nfServiceSetId",
		                           nf_service_instance->
		                           nf_service_set_id) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_service_instance_convertToJSON() failed [nf_service_set_id]");
			goto end;
		}
	}
...
OpenAPI_nf_service_instance_t *OpenAPI_nf_service_instance_parseFromJSON(
	cJSON *nf_service_instanceJSON) {
	...
	service_instance_id =
		cJSON_GetObjectItemCaseSensitive(nf_service_instanceJSON,
		                                 "serviceInstanceId");
	if(service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_instance_parseFromJSON() failed [service_instance_id]");
			goto end;
		}
	}
	...
	if(nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_instance_parseFromJSON() failed [nf_instance_id]");
			goto end;
		}
	}
	...
	if(nf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_instance_parseFromJSON() failed [nf_service_set_id]");
			goto end;
		}
	}
...
OpenAPI_nf_service_instance_t *OpenAPI_nf_service_instance_copy(
	OpenAPI_nf_service_instance_t	*dst,
	OpenAPI_nf_service_instance_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
