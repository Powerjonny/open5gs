...
char * OpenAPI_sponsoring_status_ToString(
	...
	const char *sponsoring_statusArray[] = { "NULL", "SPONSOR_DISABLED",
		                                 "SPONSOR_ENABLED" };
	size_t sizeofArray = sizeof(sponsoring_statusArray) /
	                     sizeof(sponsoring_statusArray[0]);
...
OpenAPI_sponsoring_status_e OpenAPI_sponsoring_status_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(sponsoring_status,
		          sponsoring_statusArray[stringToReturn]) == 0) {
