...
OpenAPI_point_altitude_uncertainty_t *OpenAPI_point_altitude_uncertainty_create(
	...
	OpenAPI_point_altitude_uncertainty_t *
		...
		ogs_malloc(sizeof(OpenAPI_point_altitude_uncertainty_t));
...
void OpenAPI_point_altitude_uncertainty_free(
	OpenAPI_point_altitude_uncertainty_t *point_altitude_uncertainty) {
	...
	if(point_altitude_uncertainty->point) {
		OpenAPI_geographical_coordinates_free(
...
cJSON *OpenAPI_point_altitude_uncertainty_convertToJSON(
	OpenAPI_point_altitude_uncertainty_t *point_altitude_uncertainty) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(point_altitude_uncertainty == NULL) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [PointAltitudeUncertainty]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!point_altitude_uncertainty->point) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [altitude]");
		goto end;
	}

	if(!point_altitude_uncertainty->uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [confidence]");
		goto end;
	}
	...
	if(point_altitude_uncertainty->is_v_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_point_altitude_uncertainty_convertToJSON() failed [v_confidence]");
			goto end;
		}
	}
...
OpenAPI_point_altitude_uncertainty_parseFromJSON(
	...
	OpenAPI_point_altitude_uncertainty_t *
	        point_altitude_uncertainty_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *shape = NULL;
	...
	if(!shape) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	altitude =
		cJSON_GetObjectItemCaseSensitive(point_altitude_uncertaintyJSON,
		                                 "altitude");
	if(!altitude) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [altitude]");
		goto end;
	}
	...
	if(!uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	...
	if(!uncertainty_altitude) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [confidence]");
		goto end;
	}
	...
	if(v_confidence) {
		if(!cJSON_IsNumber(v_confidence)) {
			ogs_error(
				"OpenAPI_point_altitude_uncertainty_parseFromJSON() failed [v_confidence]");
			goto end;
		}
	}

	point_altitude_uncertainty_local_var =
		OpenAPI_point_altitude_uncertainty_create(
			shapeVariable,
			point_local_nonprim,
...
OpenAPI_point_altitude_uncertainty_t *OpenAPI_point_altitude_uncertainty_copy(
	OpenAPI_point_altitude_uncertainty_t	*dst,
	OpenAPI_point_altitude_uncertainty_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_altitude_uncertainty_convertToJSON() failed");
		return NULL;
	}
