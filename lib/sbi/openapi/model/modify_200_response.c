...
OpenAPI_modify_200_response_t *OpenAPI_modify_200_response_create(
	char *nf_instance_id, bool is_implicit_unsubscribe,
	int implicit_unsubscribe, char *expires, char *callback_reference,
	char *amf_service_name, OpenAPI_list_t *monitored_resource_uris,
	OpenAPI_snssai_t *single_nssai, char *dnn, char *subscription_id,
	OpenAPI_plmn_id_t *plmn_id, bool is_immediate_report,
	int immediate_report, OpenAPI_list_t *report, char *supported_features,
	OpenAPI_context_info_t *context_info, bool is_nf_change_filter,
	int nf_change_filter, bool is_unique_subscription,
	int unique_subscription, OpenAPI_list_t *reset_ids,
	OpenAPI_ue_context_in_smf_data_sub_filter_t *ue_con_smf_data_sub_filter)
{
	OpenAPI_modify_200_response_t *modify_200_response_local_var =
		ogs_malloc(sizeof(OpenAPI_modify_200_response_t));
	ogs_assert(modify_200_response_local_var);

	modify_200_response_local_var->nf_instance_id = nf_instance_id;
	modify_200_response_local_var->is_implicit_unsubscribe =
		is_implicit_unsubscribe;
	modify_200_response_local_var->implicit_unsubscribe =
		implicit_unsubscribe;
	...
	modify_200_response_local_var->monitored_resource_uris =
	...
	modify_200_response_local_var->is_immediate_report =
		is_immediate_report;
	...
	modify_200_response_local_var->is_nf_change_filter =
		is_nf_change_filter;
	modify_200_response_local_var->nf_change_filter = nf_change_filter;
	modify_200_response_local_var->is_unique_subscription =
		is_unique_subscription;
	modify_200_response_local_var->unique_subscription =
		unique_subscription;
	modify_200_response_local_var->reset_ids = reset_ids;
	modify_200_response_local_var->ue_con_smf_data_sub_filter =
...
void OpenAPI_modify_200_response_free(
	OpenAPI_modify_200_response_t *modify_200_response) {
	...
	if(modify_200_response->monitored_resource_uris) {
		OpenAPI_list_for_each(
			modify_200_response->monitored_resource_uris, node) {
			ogs_free(node->data);
		}
	...
	if(modify_200_response->ue_con_smf_data_sub_filter) {
		OpenAPI_ue_context_in_smf_data_sub_filter_free(
			modify_200_response->ue_con_smf_data_sub_filter);
		modify_200_response->ue_con_smf_data_sub_filter = NULL;
	}
	ogs_free(modify_200_response);
}

cJSON *OpenAPI_modify_200_response_convertToJSON(
	OpenAPI_modify_200_response_t *modify_200_response) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(modify_200_response == NULL) {
		ogs_error(
			"OpenAPI_modify_200_response_convertToJSON() failed [Modify_200_response]");
		return NULL;
	}
	...
	if(!modify_200_response->nf_instance_id) {
		ogs_error(
			"OpenAPI_modify_200_response_convertToJSON() failed [nf_instance_id]");
		return NULL;
	}
	...
	if(modify_200_response->is_implicit_unsubscribe) {
		if(cJSON_AddBoolToObject(item, "implicitUnsubscribe",
		                         modify_200_response->
		                         implicit_unsubscribe) == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [implicit_unsubscribe]");
			goto end;
		}
	}

	if(modify_200_response->expires) {
		if(cJSON_AddStringToObject(item, "expires",
		                           modify_200_response->expires) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [expires]");
			goto end;
		}
	}
	...
	if(!modify_200_response->callback_reference) {
		ogs_error(
			"OpenAPI_modify_200_response_convertToJSON() failed [callback_reference]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "callbackReference",
	                           modify_200_response->callback_reference) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_modify_200_response_convertToJSON() failed [callback_reference]");
	...
	if(modify_200_response->amf_service_name) {
		if(cJSON_AddStringToObject(item, "amfServiceName",
		                           modify_200_response->amf_service_name)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [amf_service_name]");
			goto end;
		}
	}
	...
	if(!modify_200_response->monitored_resource_uris) {
		ogs_error(
			"OpenAPI_modify_200_response_convertToJSON() failed [monitored_resource_uris]");
		return NULL;
	}
	cJSON *monitored_resource_urisList = cJSON_AddArrayToObject(item,
	...
	OpenAPI_list_for_each(modify_200_response->monitored_resource_uris,
	                      node) {
		if(cJSON_AddStringToObject(monitored_resource_urisList, "",
		                           (char *) node->data) == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [monitored_resource_uris]");
	...
	if(modify_200_response->single_nssai) {
		cJSON *single_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				modify_200_response->single_nssai);
		if(single_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [single_nssai]");
			goto end;
		}
	...
	if(modify_200_response->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(modify_200_response->subscription_id) {
		if(cJSON_AddStringToObject(item, "subscriptionId",
		                           modify_200_response->subscription_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [subscription_id]");
			goto end;
		}
	}
	...
	if(modify_200_response->plmn_id) {
		cJSON *plmn_id_local_JSON =
			OpenAPI_plmn_id_convertToJSON(
				modify_200_response->plmn_id);
		if(plmn_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [plmn_id]");
			goto end;
		}
	...
	if(modify_200_response->is_immediate_report) {
		if(cJSON_AddBoolToObject(item, "immediateReport",
		                         modify_200_response->immediate_report)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [immediate_report]");
			goto end;
		}
	}
	...
	if(!modify_200_response->report) {
		ogs_error(
			"OpenAPI_modify_200_response_convertToJSON() failed [report]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(modify_200_response->report, node) {
		cJSON *itemLocal =
			OpenAPI_report_item_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [report]");
			goto end;
	...
	if(modify_200_response->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(modify_200_response->context_info) {
		cJSON *context_info_local_JSON =
			OpenAPI_context_info_convertToJSON(
				modify_200_response->context_info);
		if(context_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [context_info]");
			goto end;
		}
	...
	if(modify_200_response->is_nf_change_filter) {
		if(cJSON_AddBoolToObject(item, "nfChangeFilter",
		                         modify_200_response->nf_change_filter)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [nf_change_filter]");
			goto end;
		}
	}

	if(modify_200_response->is_unique_subscription) {
		if(cJSON_AddBoolToObject(item, "uniqueSubscription",
		                         modify_200_response->
		                         unique_subscription) == NULL)
		{
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [unique_subscription]");
			goto end;
		}
	}
	...
	if(modify_200_response->reset_ids) {
		...
		if(reset_idsList == NULL) {
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [reset_ids]");
			goto end;
		}
		OpenAPI_list_for_each(modify_200_response->reset_ids, node) {
	...
	if(modify_200_response->ue_con_smf_data_sub_filter) {
		cJSON *ue_con_smf_data_sub_filter_local_JSON =
			OpenAPI_ue_context_in_smf_data_sub_filter_convertToJSON(
				modify_200_response->ue_con_smf_data_sub_filter);
		if(ue_con_smf_data_sub_filter_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_modify_200_response_convertToJSON() failed [ue_con_smf_data_sub_filter]");
			goto end;
		}
		cJSON_AddItemToObject(item, "ueConSmfDataSubFilter",
...
OpenAPI_modify_200_response_t *OpenAPI_modify_200_response_parseFromJSON(
	cJSON *modify_200_responseJSON) {
	...
	nf_instance_id =
		cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
		                                 "nfInstanceId");
	if(!nf_instance_id) {
		ogs_error(
			"OpenAPI_modify_200_response_parseFromJSON() failed [nf_instance_id]");
		goto end;
	}
	...
	if(implicit_unsubscribe) {
		if(!cJSON_IsBool(implicit_unsubscribe)) {
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [implicit_unsubscribe]");
			goto end;
		}
	}

	expires = cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
	                                           "expires");
	if(expires) {
		if(!cJSON_IsString(expires) &&
		   !cJSON_IsNull(expires))
		{
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [expires]");
			goto end;
		}
	}
	...
	if(!callback_reference) {
		ogs_error(
			"OpenAPI_modify_200_response_parseFromJSON() failed [callback_reference]");
		goto end;
	}
	...
	if(amf_service_name) {
		if(!cJSON_IsString(amf_service_name) &&
		   !cJSON_IsNull(amf_service_name))
		{
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [amf_service_name]");
			goto end;
		}
	}
	...
	if(!monitored_resource_uris) {
		ogs_error(
			"OpenAPI_modify_200_response_parseFromJSON() failed [monitored_resource_uris]");
		goto end;
	}
	...
	cJSON_ArrayForEach(monitored_resource_uris_local,
	                   monitored_resource_uris) {
		...
		OpenAPI_list_add(monitored_resource_urisList,
		                 ogs_strdup(
					 monitored_resource_uris_local->
					 valuestring));
	}

	single_nssai = cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
	                                                "singleNssai");
	if(single_nssai) {
	...
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(subscription_id) {
		...
		{
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [subscription_id]");
			goto end;
		}
	}

	plmn_id = cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
	                                           "plmnId");
	if(plmn_id) {
	...
	if(immediate_report) {
		if(!cJSON_IsBool(immediate_report)) {
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [immediate_report]");
			goto end;
		}
	}

	report = cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
	                                          "report");
	if(!report) {
		ogs_error(
			"OpenAPI_modify_200_response_parseFromJSON() failed [report]");
		goto end;
	}
	...
	cJSON_ArrayForEach(report_local, report) {
		...
		OpenAPI_report_item_t *reportItem =
			OpenAPI_report_item_parseFromJSON(report_local);
		if(!reportItem) {
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	context_info = cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
	                                                "contextInfo");
	if(context_info) {
	...
	if(nf_change_filter) {
		if(!cJSON_IsBool(nf_change_filter)) {
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [nf_change_filter]");
			goto end;
		}
	}
	...
	if(unique_subscription) {
		if(!cJSON_IsBool(unique_subscription)) {
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [unique_subscription]");
			goto end;
		}
	}

	reset_ids = cJSON_GetObjectItemCaseSensitive(modify_200_responseJSON,
	                                             "resetIds");
	if(reset_ids) {
		cJSON *reset_ids_local = NULL;
		if(!cJSON_IsArray(reset_ids)) {
			ogs_error(
				"OpenAPI_modify_200_response_parseFromJSON() failed [reset_ids]");
			goto end;
		}
	...
	if(ue_con_smf_data_sub_filter) {
		ue_con_smf_data_sub_filter_local_nonprim =
			OpenAPI_ue_context_in_smf_data_sub_filter_parseFromJSON(
				ue_con_smf_data_sub_filter);
		if(!ue_con_smf_data_sub_filter_local_nonprim) {
			ogs_error(
				"OpenAPI_ue_context_in_smf_data_sub_filter_parseFromJSON failed [ue_con_smf_data_sub_filter]");
			goto end;
		}
	}
	...
	modify_200_response_local_var = OpenAPI_modify_200_response_create(
		...
		expires &&
		!cJSON_IsNull(expires) ? ogs_strdup(expires->valuestring) :
		NULL,
		ogs_strdup(callback_reference->valuestring),
		amf_service_name &&
		!cJSON_IsNull(amf_service_name) ?
		ogs_strdup(amf_service_name->valuestring) : NULL,
...
OpenAPI_modify_200_response_t *OpenAPI_modify_200_response_copy(
	OpenAPI_modify_200_response_t	*dst,
	OpenAPI_modify_200_response_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
