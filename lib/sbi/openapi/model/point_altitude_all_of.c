...
OpenAPI_point_altitude_all_of_t *OpenAPI_point_altitude_all_of_create(
	...
	OpenAPI_point_altitude_all_of_t *point_altitude_all_of_local_var =
		ogs_malloc(sizeof(OpenAPI_point_altitude_all_of_t));
...
void OpenAPI_point_altitude_all_of_free(
	OpenAPI_point_altitude_all_of_t *point_altitude_all_of) {
...
cJSON *OpenAPI_point_altitude_all_of_convertToJSON(
	OpenAPI_point_altitude_all_of_t *point_altitude_all_of) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(point_altitude_all_of == NULL) {
		ogs_error(
			"OpenAPI_point_altitude_all_of_convertToJSON() failed [PointAltitude_allOf]");
		return NULL;
	}
	...
	if(!point_altitude_all_of->point) {
		ogs_error(
			"OpenAPI_point_altitude_all_of_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_all_of_convertToJSON() failed [altitude]");
		goto end;
	}
...
OpenAPI_point_altitude_all_of_t *OpenAPI_point_altitude_all_of_parseFromJSON(
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_altitude_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	if(!altitude) {
		ogs_error(
			"OpenAPI_point_altitude_all_of_parseFromJSON() failed [altitude]");
		goto end;
	}
...
OpenAPI_point_altitude_all_of_t *OpenAPI_point_altitude_all_of_copy(
	OpenAPI_point_altitude_all_of_t *dst,
	OpenAPI_point_altitude_all_of_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_altitude_all_of_convertToJSON() failed");
		return NULL;
	}
