...
OpenAPI_ce_mode_b_ind_t *OpenAPI_ce_mode_b_ind_create(
	...
	OpenAPI_ce_mode_b_ind_t *ce_mode_b_ind_local_var =
		ogs_malloc(sizeof(OpenAPI_ce_mode_b_ind_t));
...
cJSON *OpenAPI_ce_mode_b_ind_convertToJSON(
	...
	if(ce_mode_b_ind == NULL) {
		ogs_error(
			"OpenAPI_ce_mode_b_ind_convertToJSON() failed [CeModeBInd]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ce_mode_b_ind_convertToJSON() failed [ce_mode_b_support_ind]");
		goto end;
	}
...
OpenAPI_ce_mode_b_ind_t *OpenAPI_ce_mode_b_ind_parseFromJSON(
	cJSON *ce_mode_b_indJSON) {
	OpenAPI_ce_mode_b_ind_t *ce_mode_b_ind_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *ce_mode_b_support_ind = NULL;
	ce_mode_b_support_ind =
		cJSON_GetObjectItemCaseSensitive(ce_mode_b_indJSON,
		                                 "ceModeBSupportInd");
	if(!ce_mode_b_support_ind) {
		ogs_error(
			"OpenAPI_ce_mode_b_ind_parseFromJSON() failed [ce_mode_b_support_ind]");
		goto end;
	}
...
OpenAPI_ce_mode_b_ind_t *OpenAPI_ce_mode_b_ind_copy(
	OpenAPI_ce_mode_b_ind_t *dst, OpenAPI_ce_mode_b_ind_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
