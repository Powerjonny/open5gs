...
OpenAPI_sm_policy_delete_data_t *OpenAPI_sm_policy_delete_data_create(
	...
	OpenAPI_sm_policy_delete_data_t *sm_policy_delete_data_local_var =
		ogs_malloc(sizeof(OpenAPI_sm_policy_delete_data_t));
	ogs_assert(sm_policy_delete_data_local_var);

	sm_policy_delete_data_local_var->user_location_info =
		user_location_info;
	sm_policy_delete_data_local_var->ue_time_zone = ue_time_zone;
	sm_policy_delete_data_local_var->serving_network = serving_network;
	sm_policy_delete_data_local_var->user_location_info_time =
		user_location_info_time;
	sm_policy_delete_data_local_var->ran_nas_rel_causes =
		ran_nas_rel_causes;
	sm_policy_delete_data_local_var->accu_usage_reports =
		accu_usage_reports;
	sm_policy_delete_data_local_var->pdu_sess_rel_cause =
		pdu_sess_rel_cause;
...
void OpenAPI_sm_policy_delete_data_free(
	...
	if(sm_policy_delete_data->user_location_info) {
		OpenAPI_user_location_free(
			sm_policy_delete_data->user_location_info);
	...
	if(sm_policy_delete_data->ran_nas_rel_causes) {
		OpenAPI_list_for_each(sm_policy_delete_data->ran_nas_rel_causes,
		                      node) {
	...
	if(sm_policy_delete_data->accu_usage_reports) {
		OpenAPI_list_for_each(sm_policy_delete_data->accu_usage_reports,
		                      node) {
	...
	if(sm_policy_delete_data->qos_mon_reports) {
		OpenAPI_list_for_each(sm_policy_delete_data->qos_mon_reports,
		                      node) {
...
cJSON *OpenAPI_sm_policy_delete_data_convertToJSON(
	...
	if(sm_policy_delete_data == NULL) {
		ogs_error(
			"OpenAPI_sm_policy_delete_data_convertToJSON() failed [SmPolicyDeleteData]");
		return NULL;
	}
	...
	if(sm_policy_delete_data->user_location_info) {
		...
		if(user_location_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [user_location_info]");
			goto end;
		}
	...
	if(sm_policy_delete_data->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           sm_policy_delete_data->ue_time_zone)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(sm_policy_delete_data->serving_network) {
		...
		if(serving_network_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [serving_network]");
			goto end;
		}
	...
	if(sm_policy_delete_data->user_location_info_time) {
		if(cJSON_AddStringToObject(item, "userLocationInfoTime",
		                           sm_policy_delete_data->
		                           user_location_info_time) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [user_location_info_time]");
			goto end;
		}
	}
	...
	if(sm_policy_delete_data->ran_nas_rel_causes) {
		...
		if(ran_nas_rel_causesList == NULL) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [ran_nas_rel_causes]");
			goto end;
		}
		OpenAPI_list_for_each(sm_policy_delete_data->ran_nas_rel_causes,
		                      node) {
	...
	if(sm_policy_delete_data->accu_usage_reports) {
		...
		if(accu_usage_reportsList == NULL) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [accu_usage_reports]");
			goto end;
		}
		OpenAPI_list_for_each(sm_policy_delete_data->accu_usage_reports,
		                      node) {
	...
	if(sm_policy_delete_data->pdu_sess_rel_cause !=
	   OpenAPI_pdu_session_rel_cause_NULL)
	{
		if(cJSON_AddStringToObject(item, "pduSessRelCause",
		                           OpenAPI_pdu_session_rel_cause_ToString
		                                   (sm_policy_delete_data->
		                                   pdu_sess_rel_cause)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [pdu_sess_rel_cause]");
			goto end;
		}
	}
	...
	if(sm_policy_delete_data->qos_mon_reports) {
		...
		if(qos_mon_reportsList == NULL) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_convertToJSON() failed [qos_mon_reports]");
			goto end;
		}
		OpenAPI_list_for_each(sm_policy_delete_data->qos_mon_reports,
		                      node) {
...
OpenAPI_sm_policy_delete_data_t *OpenAPI_sm_policy_delete_data_parseFromJSON(
	...
	user_location_info =
		cJSON_GetObjectItemCaseSensitive(sm_policy_delete_dataJSON,
		                                 "userLocationInfo");
	...
	if(ue_time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_sm_policy_delete_data_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(user_location_info_time) {
		...
		{
			ogs_error(
				"OpenAPI_sm_policy_delete_data_parseFromJSON() failed [user_location_info_time]");
			goto end;
		}
	}
	...
	if(ran_nas_rel_causes) {
		...
		if(!cJSON_IsArray(ran_nas_rel_causes)) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_parseFromJSON() failed [ran_nas_rel_causes]");
			goto end;
		}
	...
	if(accu_usage_reports) {
		...
		if(!cJSON_IsArray(accu_usage_reports)) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_parseFromJSON() failed [accu_usage_reports]");
			goto end;
		}
	...
	if(pdu_sess_rel_cause) {
		if(!cJSON_IsString(pdu_sess_rel_cause)) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_parseFromJSON() failed [pdu_sess_rel_cause]");
			goto end;
		}
		pdu_sess_rel_causeVariable =
			OpenAPI_pdu_session_rel_cause_FromString(
				pdu_sess_rel_cause->valuestring);
	}
	...
	if(qos_mon_reports) {
		...
		if(!cJSON_IsArray(qos_mon_reports)) {
			ogs_error(
				"OpenAPI_sm_policy_delete_data_parseFromJSON() failed [qos_mon_reports]");
			goto end;
		}
...
OpenAPI_sm_policy_delete_data_t *OpenAPI_sm_policy_delete_data_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_sm_policy_delete_data_convertToJSON() failed");
		return NULL;
	}
