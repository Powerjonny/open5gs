...
OpenAPI_horizontal_velocity_with_uncertainty_create(float h_speed, int bearing,
                                                    float h_uncertainty) {
	OpenAPI_horizontal_velocity_with_uncertainty_t *
	        horizontal_velocity_with_uncertainty_local_var =
		ogs_malloc(
			sizeof(OpenAPI_horizontal_velocity_with_uncertainty_t));
...
void OpenAPI_horizontal_velocity_with_uncertainty_free(
	OpenAPI_horizontal_velocity_with_uncertainty_t *
...
cJSON *OpenAPI_horizontal_velocity_with_uncertainty_convertToJSON(
	OpenAPI_horizontal_velocity_with_uncertainty_t *
	horizontal_velocity_with_uncertainty) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(horizontal_velocity_with_uncertainty == NULL) {
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_convertToJSON() failed [HorizontalVelocityWithUncertainty]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_convertToJSON() failed [h_speed]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_convertToJSON() failed [bearing]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_convertToJSON() failed [h_uncertainty]");
		goto end;
	}
...
OpenAPI_horizontal_velocity_with_uncertainty_t *
OpenAPI_horizontal_velocity_with_uncertainty_parseFromJSON(
	...
	if(!h_speed) {
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_parseFromJSON() failed [h_speed]");
		goto end;
	}
	...
	if(!bearing) {
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_parseFromJSON() failed [bearing]");
		goto end;
	}
	...
	h_uncertainty =
		cJSON_GetObjectItemCaseSensitive(
			horizontal_velocity_with_uncertaintyJSON,
			"hUncertainty");
	if(!h_uncertainty) {
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_parseFromJSON() failed [h_uncertainty]");
		goto end;
	}
	...
	horizontal_velocity_with_uncertainty_local_var =
		OpenAPI_horizontal_velocity_with_uncertainty_create(
...
OpenAPI_horizontal_velocity_with_uncertainty_t *
OpenAPI_horizontal_velocity_with_uncertainty_copy(
	OpenAPI_horizontal_velocity_with_uncertainty_t	*dst,
	OpenAPI_horizontal_velocity_with_uncertainty_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_horizontal_velocity_with_uncertainty_convertToJSON() failed");
		return NULL;
	}
