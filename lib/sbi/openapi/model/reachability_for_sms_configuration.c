...
OpenAPI_reachability_for_sms_configuration_create() {
	OpenAPI_reachability_for_sms_configuration_t *
	        reachability_for_sms_configuration_local_var =
		ogs_malloc(
...
void OpenAPI_reachability_for_sms_configuration_free(
	OpenAPI_reachability_for_sms_configuration_t *
	reachability_for_sms_configuration) {
...
cJSON *OpenAPI_reachability_for_sms_configuration_convertToJSON(
	OpenAPI_reachability_for_sms_configuration_t *
	reachability_for_sms_configuration) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(reachability_for_sms_configuration == NULL) {
		ogs_error(
			"OpenAPI_reachability_for_sms_configuration_convertToJSON() failed [ReachabilityForSmsConfiguration]");
		return NULL;
	}
...
OpenAPI_reachability_for_sms_configuration_parseFromJSON(
	cJSON *reachability_for_sms_configurationJSON) {
	OpenAPI_reachability_for_sms_configuration_t *
	        reachability_for_sms_configuration_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	reachability_for_sms_configuration_local_var =
		OpenAPI_reachability_for_sms_configuration_create(
			);
...
OpenAPI_reachability_for_sms_configuration_copy(
	OpenAPI_reachability_for_sms_configuration_t	*dst,
	OpenAPI_reachability_for_sms_configuration_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_reachability_for_sms_configuration_convertToJSON() failed");
		return NULL;
	}
