...
char * OpenAPI_am_influ_event_any_of_ToString(
	...
	const char *am_influ_event_any_ofArray[] = { "NULL",
		                                     "SERVICE_AREA_COVRG_OUTCOME" };
	size_t sizeofArray = sizeof(am_influ_event_any_ofArray) /
	                     sizeof(am_influ_event_any_ofArray[0]);
...
OpenAPI_am_influ_event_any_of_e OpenAPI_am_influ_event_any_of_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(am_influ_event_any_of,
		          am_influ_event_any_ofArray[stringToReturn]) == 0) {
