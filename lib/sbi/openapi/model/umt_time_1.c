...
OpenAPI_umt_time_1_t *OpenAPI_umt_time_1_create(char	*time_of_day,
                                                int	day_of_week) {
	OpenAPI_umt_time_1_t *umt_time_1_local_var =
		ogs_malloc(sizeof(OpenAPI_umt_time_1_t));
...
cJSON *OpenAPI_umt_time_1_convertToJSON(OpenAPI_umt_time_1_t *umt_time_1) {
	...
	if(umt_time_1 == NULL) {
		ogs_error(
			"OpenAPI_umt_time_1_convertToJSON() failed [UmtTime_1]");
		return NULL;
	}
	...
	if(cJSON_AddNumberToObject(item, "dayOfWeek",
	                           umt_time_1->day_of_week) == NULL)
	{
		ogs_error(
			"OpenAPI_umt_time_1_convertToJSON() failed [day_of_week]");
		goto end;
	}
...
OpenAPI_umt_time_1_t *OpenAPI_umt_time_1_parseFromJSON(cJSON *umt_time_1JSON) {
	...
	time_of_day = cJSON_GetObjectItemCaseSensitive(umt_time_1JSON,
	                                               "timeOfDay");
	if(!time_of_day) {
		ogs_error(
	...
	day_of_week = cJSON_GetObjectItemCaseSensitive(umt_time_1JSON,
	                                               "dayOfWeek");
	if(!day_of_week) {
		ogs_error(
			"OpenAPI_umt_time_1_parseFromJSON() failed [day_of_week]");
		goto end;
	}
...
OpenAPI_umt_time_1_t *OpenAPI_umt_time_1_copy(OpenAPI_umt_time_1_t	*dst,
                                              OpenAPI_umt_time_1_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
