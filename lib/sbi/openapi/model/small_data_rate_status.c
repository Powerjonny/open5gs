...
OpenAPI_small_data_rate_status_t *OpenAPI_small_data_rate_status_create(
	...
	OpenAPI_small_data_rate_status_t *small_data_rate_status_local_var =
		ogs_malloc(sizeof(OpenAPI_small_data_rate_status_t));
...
void OpenAPI_small_data_rate_status_free(
...
cJSON *OpenAPI_small_data_rate_status_convertToJSON(
	OpenAPI_small_data_rate_status_t *small_data_rate_status) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(small_data_rate_status == NULL) {
		ogs_error(
			"OpenAPI_small_data_rate_status_convertToJSON() failed [SmallDataRateStatus]");
		return NULL;
	}
	...
	if(small_data_rate_status->is_remain_packets_ul) {
		...
		{
			ogs_error(
				"OpenAPI_small_data_rate_status_convertToJSON() failed [remain_packets_ul]");
			goto end;
		}
	}
	...
	if(small_data_rate_status->is_remain_packets_dl) {
		...
		{
			ogs_error(
				"OpenAPI_small_data_rate_status_convertToJSON() failed [remain_packets_dl]");
			goto end;
		}
	}
	...
	if(small_data_rate_status->validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_small_data_rate_status_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(small_data_rate_status->is_remain_ex_reports_ul) {
		...
		{
			ogs_error(
				"OpenAPI_small_data_rate_status_convertToJSON() failed [remain_ex_reports_ul]");
			goto end;
		}
	}
	...
	if(small_data_rate_status->is_remain_ex_reports_dl) {
		...
		{
			ogs_error(
				"OpenAPI_small_data_rate_status_convertToJSON() failed [remain_ex_reports_dl]");
			goto end;
		}
	}
...
OpenAPI_small_data_rate_status_t *OpenAPI_small_data_rate_status_parseFromJSON(
	...
	remain_packets_ul =
		cJSON_GetObjectItemCaseSensitive(small_data_rate_statusJSON,
		                                 "remainPacketsUl");
	if(remain_packets_ul) {
		if(!cJSON_IsNumber(remain_packets_ul)) {
			ogs_error(
				"OpenAPI_small_data_rate_status_parseFromJSON() failed [remain_packets_ul]");
			goto end;
		}
	}
	...
	if(remain_packets_dl) {
		if(!cJSON_IsNumber(remain_packets_dl)) {
			ogs_error(
				"OpenAPI_small_data_rate_status_parseFromJSON() failed [remain_packets_dl]");
			goto end;
		}
	}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_small_data_rate_status_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(remain_ex_reports_ul) {
		if(!cJSON_IsNumber(remain_ex_reports_ul)) {
			ogs_error(
				"OpenAPI_small_data_rate_status_parseFromJSON() failed [remain_ex_reports_ul]");
			goto end;
		}
	}
	...
	if(remain_ex_reports_dl) {
		if(!cJSON_IsNumber(remain_ex_reports_dl)) {
			ogs_error(
				"OpenAPI_small_data_rate_status_parseFromJSON() failed [remain_ex_reports_dl]");
			goto end;
		}
	}

	small_data_rate_status_local_var =
		OpenAPI_small_data_rate_status_create(
			...
			remain_ex_reports_ul ?
			remain_ex_reports_ul->valuedouble : 0,
			remain_ex_reports_dl ? true : false,
			remain_ex_reports_dl ?
			remain_ex_reports_dl->valuedouble : 0
			);
...
OpenAPI_small_data_rate_status_t *OpenAPI_small_data_rate_status_copy(
	OpenAPI_small_data_rate_status_t	*dst,
	OpenAPI_small_data_rate_status_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_small_data_rate_status_convertToJSON() failed");
		return NULL;
	}
