...
OpenAPI_ue_area_indication_t *OpenAPI_ue_area_indication_create(char *country,
                                                                bool
                                                                is_international_area_ind,
                                                                int
                                                                international_area_ind)
{
	OpenAPI_ue_area_indication_t *ue_area_indication_local_var =
		ogs_malloc(sizeof(OpenAPI_ue_area_indication_t));
...
void OpenAPI_ue_area_indication_free(
	OpenAPI_ue_area_indication_t *ue_area_indication) {
...
cJSON *OpenAPI_ue_area_indication_convertToJSON(
	OpenAPI_ue_area_indication_t *ue_area_indication) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_area_indication == NULL) {
		ogs_error(
			"OpenAPI_ue_area_indication_convertToJSON() failed [UeAreaIndication]");
		return NULL;
	}
	...
	if(ue_area_indication->country) {
		...
		{
			ogs_error(
				"OpenAPI_ue_area_indication_convertToJSON() failed [country]");
			goto end;
		}
	}
	...
	if(ue_area_indication->is_international_area_ind) {
		...
		{
			ogs_error(
				"OpenAPI_ue_area_indication_convertToJSON() failed [international_area_ind]");
			goto end;
		}
	}
...
OpenAPI_ue_area_indication_t *OpenAPI_ue_area_indication_parseFromJSON(
	...
	if(country) {
		...
		{
			ogs_error(
				"OpenAPI_ue_area_indication_parseFromJSON() failed [country]");
			goto end;
		}
	}

	international_area_ind =
		cJSON_GetObjectItemCaseSensitive(ue_area_indicationJSON,
		                                 "internationalAreaInd");
	if(international_area_ind) {
		if(!cJSON_IsBool(international_area_ind)) {
			ogs_error(
				"OpenAPI_ue_area_indication_parseFromJSON() failed [international_area_ind]");
			goto end;
		}
	}
...
OpenAPI_ue_area_indication_t *OpenAPI_ue_area_indication_copy(
	OpenAPI_ue_area_indication_t *dst, OpenAPI_ue_area_indication_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
