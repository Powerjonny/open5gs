...
OpenAPI_exception_id_t *OpenAPI_exception_id_create() {
	OpenAPI_exception_id_t *exception_id_local_var =
		ogs_malloc(sizeof(OpenAPI_exception_id_t));
...
cJSON *OpenAPI_exception_id_convertToJSON(
	OpenAPI_exception_id_t *exception_id) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(exception_id == NULL) {
		ogs_error(
			"OpenAPI_exception_id_convertToJSON() failed [ExceptionId]");
		return NULL;
	}
...
OpenAPI_exception_id_t *OpenAPI_exception_id_parseFromJSON(
	cJSON *exception_idJSON) {
...
OpenAPI_exception_id_t *OpenAPI_exception_id_copy(
	OpenAPI_exception_id_t	*dst,
