...
char * OpenAPI_trigger_type_any_of_ToString(
	...
	const char *trigger_type_any_ofArray[] = { "NULL", "QUOTA_THRESHOLD",
		                                   "QHT", "FINAL",
		                                   "QUOTA_EXHAUSTED",
		                                   "VALIDITY_TIME",
		                                   "OTHER_QUOTA_TYPE",
		                                   ...
		                                   "ABNORMAL_RELEASE",
		                                   "QOS_CHANGE", "VOLUME_LIMIT",
		                                   "TIME_LIMIT",
		                                   "EVENT_LIMIT", "PLMN_CHANGE",
		                                   ...
		                                   "CGI_SAI_CHANGE",
		                                   "RAI_CHANGE" };
	size_t sizeofArray = sizeof(trigger_type_any_ofArray) /
	                     sizeof(trigger_type_any_ofArray[0]);
...
OpenAPI_trigger_type_any_of_e OpenAPI_trigger_type_any_of_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(trigger_type_any_of,
		          trigger_type_any_ofArray[stringToReturn]) == 0) {
