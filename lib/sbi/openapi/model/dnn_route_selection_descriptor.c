...
OpenAPI_dnn_route_selection_descriptor_create(char		*dnn,
	...
	OpenAPI_dnn_route_selection_descriptor_t *
		...
		ogs_malloc(sizeof(OpenAPI_dnn_route_selection_descriptor_t));
	...
	dnn_route_selection_descriptor_local_var->pdu_sess_types =
		pdu_sess_types;
...
void OpenAPI_dnn_route_selection_descriptor_free(
	OpenAPI_dnn_route_selection_descriptor_t *dnn_route_selection_descriptor)
{
	...
	if(dnn_route_selection_descriptor->pdu_sess_types) {
		OpenAPI_list_free(
			dnn_route_selection_descriptor->pdu_sess_types);
		dnn_route_selection_descriptor->pdu_sess_types = NULL;
	}
	ogs_free(dnn_route_selection_descriptor);
}

cJSON *OpenAPI_dnn_route_selection_descriptor_convertToJSON(
	OpenAPI_dnn_route_selection_descriptor_t *dnn_route_selection_descriptor)
{
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(dnn_route_selection_descriptor == NULL) {
		ogs_error(
			"OpenAPI_dnn_route_selection_descriptor_convertToJSON() failed [DnnRouteSelectionDescriptor]");
		return NULL;
	}
	...
	if(!dnn_route_selection_descriptor->dnn) {
		ogs_error(
			"OpenAPI_dnn_route_selection_descriptor_convertToJSON() failed [dnn]");
		return NULL;
	}
	...
	if(dnn_route_selection_descriptor->ssc_modes != OpenAPI_ssc_mode_NULL) {
		...
		if(ssc_modesList == NULL) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_convertToJSON() failed [ssc_modes]");
			goto end;
		}
		OpenAPI_list_for_each(dnn_route_selection_descriptor->ssc_modes,
		                      node) {
			if(cJSON_AddStringToObject(ssc_modesList, "",
	...
	{
		cJSON *pdu_sess_typesList = cJSON_AddArrayToObject(item,
		                                                   "pduSessTypes");
		if(pdu_sess_typesList == NULL) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_convertToJSON() failed [pdu_sess_types]");
			goto end;
		}
		OpenAPI_list_for_each(
			dnn_route_selection_descriptor->pdu_sess_types, node) {
			if(cJSON_AddStringToObject(pdu_sess_typesList, "",
	...
	if(dnn_route_selection_descriptor->is_atsss_info) {
		if(cJSON_AddBoolToObject(item, "atsssInfo",
		                         dnn_route_selection_descriptor->
		                         atsss_info) == NULL)
		{
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_convertToJSON() failed [atsss_info]");
			goto end;
		}
	}
...
OpenAPI_dnn_route_selection_descriptor_parseFromJSON(
	cJSON *dnn_route_selection_descriptorJSON) {
	OpenAPI_dnn_route_selection_descriptor_t *
	        dnn_route_selection_descriptor_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *dnn = NULL;
	...
	dnn =
		cJSON_GetObjectItemCaseSensitive(
			dnn_route_selection_descriptorJSON, "dnn");
	if(!dnn) {
		ogs_error(
			"OpenAPI_dnn_route_selection_descriptor_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	ssc_modes =
		cJSON_GetObjectItemCaseSensitive(
			dnn_route_selection_descriptorJSON, "sscModes");
	if(ssc_modes) {
		cJSON *ssc_modes_local = NULL;
		if(!cJSON_IsArray(ssc_modes)) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_parseFromJSON() failed [ssc_modes]");
			goto end;
		}
		...
		cJSON_ArrayForEach(ssc_modes_local, ssc_modes) {
			...
			localEnum =
				OpenAPI_ssc_mode_FromString(
					ssc_modes_local->valuestring);
			if(!localEnum) {
				ogs_info(
					"Enum value \"%s\" for field \"ssc_modes\" is not supported. Ignoring it ...",
					ssc_modes_local->valuestring);
			} else {
				OpenAPI_list_add(ssc_modesList,
				                 (void *) localEnum);
			}
		}
		if(ssc_modesList->count == 0) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_parseFromJSON() failed: Expected ssc_modesList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	pdu_sess_types =
		cJSON_GetObjectItemCaseSensitive(
			dnn_route_selection_descriptorJSON, "pduSessTypes");
	if(pdu_sess_types) {
		cJSON *pdu_sess_types_local = NULL;
		if(!cJSON_IsArray(pdu_sess_types)) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_parseFromJSON() failed [pdu_sess_types]");
			goto end;
		}
		...
		cJSON_ArrayForEach(pdu_sess_types_local, pdu_sess_types) {
			...
			if(!localEnum) {
				ogs_info(
					"Enum value \"%s\" for field \"pdu_sess_types\" is not supported. Ignoring it ...",
					pdu_sess_types_local->valuestring);
			} else {
				OpenAPI_list_add(pdu_sess_typesList,
				                 (void *) localEnum);
			}
		}
		if(pdu_sess_typesList->count == 0) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_parseFromJSON() failed: Expected pdu_sess_typesList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	atsss_info =
		cJSON_GetObjectItemCaseSensitive(
			dnn_route_selection_descriptorJSON, "atsssInfo");
	if(atsss_info) {
		if(!cJSON_IsBool(atsss_info)) {
			ogs_error(
				"OpenAPI_dnn_route_selection_descriptor_parseFromJSON() failed [atsss_info]");
			goto end;
		}
	}
...
OpenAPI_dnn_route_selection_descriptor_t *
OpenAPI_dnn_route_selection_descriptor_copy(
	OpenAPI_dnn_route_selection_descriptor_t	*dst,
	OpenAPI_dnn_route_selection_descriptor_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_dnn_route_selection_descriptor_convertToJSON() failed");
		return NULL;
	}
