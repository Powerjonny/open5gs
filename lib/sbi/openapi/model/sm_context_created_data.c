...
OpenAPI_sm_context_created_data_t *OpenAPI_sm_context_created_data_create(
	char *h_smf_uri, char *smf_uri, bool is_pdu_session_id,
	...
	OpenAPI_list_t *allocated_ebi_list, OpenAPI_ho_state_e ho_state,
	char *gpsi, char *smf_service_instance_id, char *recovery_time,
	char *supported_features, char *selected_smf_id,
	char *selected_old_smf_id, char *inter_plmn_api_root) {
	OpenAPI_sm_context_created_data_t *sm_context_created_data_local_var =
		ogs_malloc(sizeof(OpenAPI_sm_context_created_data_t));
	...
	sm_context_created_data_local_var->is_pdu_session_id =
		is_pdu_session_id;
	...
	sm_context_created_data_local_var->allocated_ebi_list =
		allocated_ebi_list;
	sm_context_created_data_local_var->ho_state = ho_state;
	sm_context_created_data_local_var->gpsi = gpsi;
	sm_context_created_data_local_var->smf_service_instance_id =
		smf_service_instance_id;
	sm_context_created_data_local_var->recovery_time = recovery_time;
	sm_context_created_data_local_var->supported_features =
		supported_features;
	sm_context_created_data_local_var->selected_smf_id = selected_smf_id;
	sm_context_created_data_local_var->selected_old_smf_id =
		selected_old_smf_id;
	sm_context_created_data_local_var->inter_plmn_api_root =
		inter_plmn_api_root;

	return sm_context_created_data_local_var;
}

void OpenAPI_sm_context_created_data_free(
	OpenAPI_sm_context_created_data_t *sm_context_created_data) {
...
cJSON *OpenAPI_sm_context_created_data_convertToJSON(
	OpenAPI_sm_context_created_data_t *sm_context_created_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(sm_context_created_data == NULL) {
		ogs_error(
			"OpenAPI_sm_context_created_data_convertToJSON() failed [SmContextCreatedData]");
		return NULL;
	}
	...
	if(sm_context_created_data->h_smf_uri) {
		if(cJSON_AddStringToObject(item, "hSmfUri",
		                           sm_context_created_data->h_smf_uri)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [h_smf_uri]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->smf_uri) {
		if(cJSON_AddStringToObject(item, "smfUri",
		                           sm_context_created_data->smf_uri) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [smf_uri]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->is_pdu_session_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [pdu_session_id]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->s_nssai) {
		cJSON *s_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				sm_context_created_data->s_nssai);
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(sm_context_created_data->up_cnx_state != OpenAPI_up_cnx_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [up_cnx_state]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->n2_sm_info) {
		...
		if(n2_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [n2_sm_info]");
			goto end;
		}
	   ...
	   OpenAPI_n2_sm_info_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [n2_sm_info_type]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->allocated_ebi_list) {
		...
		if(allocated_ebi_listList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [allocated_ebi_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_created_data->allocated_ebi_list, node) {
	...
	if(sm_context_created_data->ho_state != OpenAPI_ho_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [ho_state]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->gpsi) {
		if(cJSON_AddStringToObject(item, "gpsi",
		                           sm_context_created_data->gpsi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->selected_smf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [selected_smf_id]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->selected_old_smf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [selected_old_smf_id]");
			goto end;
		}
	}
	...
	if(sm_context_created_data->inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_convertToJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
...
OpenAPI_sm_context_created_data_t *OpenAPI_sm_context_created_data_parseFromJSON
        (cJSON *sm_context_created_dataJSON) {
	OpenAPI_sm_context_created_data_t *sm_context_created_data_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	h_smf_uri =
		cJSON_GetObjectItemCaseSensitive(sm_context_created_dataJSON,
		                                 "hSmfUri");
	if(h_smf_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [h_smf_uri]");
			goto end;
		}
	}

	smf_uri = cJSON_GetObjectItemCaseSensitive(sm_context_created_dataJSON,
	                                           "smfUri");
	if(smf_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [smf_uri]");
			goto end;
		}
	}
	...
	if(pdu_session_id) {
		if(!cJSON_IsNumber(pdu_session_id)) {
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [pdu_session_id]");
			goto end;
		}
	}

	s_nssai = cJSON_GetObjectItemCaseSensitive(sm_context_created_dataJSON,
	                                           "sNssai");
	if(s_nssai) {
	...
	if(up_cnx_state) {
		if(!cJSON_IsString(up_cnx_state)) {
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [up_cnx_state]");
			goto end;
		}
	...
	if(n2_sm_info_type) {
		if(!cJSON_IsString(n2_sm_info_type)) {
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [n2_sm_info_type]");
			goto end;
		}
	...
	if(allocated_ebi_list) {
		...
		if(!cJSON_IsArray(allocated_ebi_list)) {
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [allocated_ebi_list]");
			goto end;
		}
	...
	ho_state = cJSON_GetObjectItemCaseSensitive(sm_context_created_dataJSON,
	                                            "hoState");
	if(ho_state) {
		if(!cJSON_IsString(ho_state)) {
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [ho_state]");
			goto end;
		}
		ho_stateVariable =
	...
	gpsi = cJSON_GetObjectItemCaseSensitive(sm_context_created_dataJSON,
	                                        "gpsi");
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(selected_smf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [selected_smf_id]");
			goto end;
		}
	}
	...
	if(selected_old_smf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [selected_old_smf_id]");
			goto end;
		}
	}
	...
	if(inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_created_data_parseFromJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
...
OpenAPI_sm_context_created_data_t *OpenAPI_sm_context_created_data_copy(
	OpenAPI_sm_context_created_data_t	*dst,
	OpenAPI_sm_context_created_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_sm_context_created_data_convertToJSON() failed");
		return NULL;
	}
