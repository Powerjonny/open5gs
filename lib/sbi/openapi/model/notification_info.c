...
OpenAPI_notification_info_t *OpenAPI_notification_info_create(
	...
	int up_buffer_ind)
{
	OpenAPI_notification_info_t *notification_info_local_var =
		ogs_malloc(sizeof(OpenAPI_notification_info_t));
...
void OpenAPI_notification_info_free(
	OpenAPI_notification_info_t *notification_info) {
...
cJSON *OpenAPI_notification_info_convertToJSON(
	OpenAPI_notification_info_t *notification_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(notification_info == NULL) {
		ogs_error(
			"OpenAPI_notification_info_convertToJSON() failed [NotificationInfo]");
		return NULL;
	}
	...
	if(!notification_info->notif_id) {
		ogs_error(
			"OpenAPI_notification_info_convertToJSON() failed [notif_id]");
		return NULL;
	}
	...
	if(!notification_info->notif_uri) {
		ogs_error(
			"OpenAPI_notification_info_convertToJSON() failed [notif_uri]");
		return NULL;
	}
	...
	if(notification_info->is_up_buffer_ind) {
		if(cJSON_AddBoolToObject(item, "upBufferInd",
		                         notification_info->up_buffer_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_notification_info_convertToJSON() failed [up_buffer_ind]");
			goto end;
		}
	}
...
OpenAPI_notification_info_t *OpenAPI_notification_info_parseFromJSON(
	...
	notif_id = cJSON_GetObjectItemCaseSensitive(notification_infoJSON,
	                                            "notifId");
	if(!notif_id) {
		ogs_error(
			"OpenAPI_notification_info_parseFromJSON() failed [notif_id]");
		goto end;
	}
	...
	notif_uri = cJSON_GetObjectItemCaseSensitive(notification_infoJSON,
	                                             "notifUri");
	if(!notif_uri) {
		ogs_error(
			"OpenAPI_notification_info_parseFromJSON() failed [notif_uri]");
		goto end;
	}
	...
	up_buffer_ind = cJSON_GetObjectItemCaseSensitive(notification_infoJSON,
	                                                 "upBufferInd");
	if(up_buffer_ind) {
		if(!cJSON_IsBool(up_buffer_ind)) {
			ogs_error(
				"OpenAPI_notification_info_parseFromJSON() failed [up_buffer_ind]");
			goto end;
		}
	}
...
OpenAPI_notification_info_t *OpenAPI_notification_info_copy(
	OpenAPI_notification_info_t *dst, OpenAPI_notification_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
