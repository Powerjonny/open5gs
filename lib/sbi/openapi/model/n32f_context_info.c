...
OpenAPI_n32f_context_info_t *OpenAPI_n32f_context_info_create(
	...
	OpenAPI_n32f_context_info_t *n32f_context_info_local_var =
		ogs_malloc(sizeof(OpenAPI_n32f_context_info_t));
...
void OpenAPI_n32f_context_info_free(
	OpenAPI_n32f_context_info_t *n32f_context_info) {
...
cJSON *OpenAPI_n32f_context_info_convertToJSON(
	OpenAPI_n32f_context_info_t *n32f_context_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n32f_context_info == NULL) {
		ogs_error(
			"OpenAPI_n32f_context_info_convertToJSON() failed [N32fContextInfo]");
		return NULL;
	}
	...
	if(!n32f_context_info->n32f_context_id) {
		ogs_error(
			"OpenAPI_n32f_context_info_convertToJSON() failed [n32f_context_id]");
		return NULL;
	}
...
OpenAPI_n32f_context_info_t *OpenAPI_n32f_context_info_parseFromJSON(
	cJSON *n32f_context_infoJSON) {
	OpenAPI_n32f_context_info_t *n32f_context_info_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *n32f_context_id = NULL;
	n32f_context_id =
		cJSON_GetObjectItemCaseSensitive(n32f_context_infoJSON,
		                                 "n32fContextId");
	if(!n32f_context_id) {
		ogs_error(
			"OpenAPI_n32f_context_info_parseFromJSON() failed [n32f_context_id]");
		goto end;
	}
...
OpenAPI_n32f_context_info_t *OpenAPI_n32f_context_info_copy(
	OpenAPI_n32f_context_info_t *dst, OpenAPI_n32f_context_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
