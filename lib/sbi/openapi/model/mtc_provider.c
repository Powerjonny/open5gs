...
OpenAPI_mtc_provider_t *OpenAPI_mtc_provider_create(
	...
	OpenAPI_mtc_provider_t *mtc_provider_local_var =
		ogs_malloc(sizeof(OpenAPI_mtc_provider_t));
	ogs_assert(mtc_provider_local_var);

	mtc_provider_local_var->mtc_provider_information =
...
cJSON *OpenAPI_mtc_provider_convertToJSON(
	OpenAPI_mtc_provider_t *mtc_provider) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(mtc_provider == NULL) {
		ogs_error(
			"OpenAPI_mtc_provider_convertToJSON() failed [MtcProvider]");
		return NULL;
	}
	...
	if(mtc_provider->mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_mtc_provider_convertToJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
	...
	if(mtc_provider->af_id) {
		...
		{
			ogs_error(
				"OpenAPI_mtc_provider_convertToJSON() failed [af_id]");
			goto end;
		}
	}
...
OpenAPI_mtc_provider_t *OpenAPI_mtc_provider_parseFromJSON(
	...
	if(mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_mtc_provider_parseFromJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
	...
	if(af_id) {
		...
		{
			ogs_error(
				"OpenAPI_mtc_provider_parseFromJSON() failed [af_id]");
			goto end;
		}
	}
...
OpenAPI_mtc_provider_t *OpenAPI_mtc_provider_copy(
	OpenAPI_mtc_provider_t	*dst,
