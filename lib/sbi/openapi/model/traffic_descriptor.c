...
OpenAPI_traffic_descriptor_t *OpenAPI_traffic_descriptor_create(
	...
	*ddd_traffic_descriptor_list) {
	OpenAPI_traffic_descriptor_t *traffic_descriptor_local_var =
		ogs_malloc(sizeof(OpenAPI_traffic_descriptor_t));
...
void OpenAPI_traffic_descriptor_free(
	...
	if(traffic_descriptor->ddd_traffic_descriptor_list) {
		OpenAPI_list_for_each(
			traffic_descriptor->ddd_traffic_descriptor_list, node) {
			OpenAPI_ddd_traffic_descriptor_free(node->data);
		}
		OpenAPI_list_free(
			traffic_descriptor->ddd_traffic_descriptor_list);
...
cJSON *OpenAPI_traffic_descriptor_convertToJSON(
	...
	if(traffic_descriptor == NULL) {
		ogs_error(
			"OpenAPI_traffic_descriptor_convertToJSON() failed [TrafficDescriptor]");
		return NULL;
	}
	...
	if(traffic_descriptor->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_descriptor_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(traffic_descriptor->s_nssai) {
		...
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_traffic_descriptor_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(traffic_descriptor->ddd_traffic_descriptor_list) {
		...
		if(ddd_traffic_descriptor_listList == NULL) {
			ogs_error(
				"OpenAPI_traffic_descriptor_convertToJSON() failed [ddd_traffic_descriptor_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			traffic_descriptor->ddd_traffic_descriptor_list, node) {
...
OpenAPI_traffic_descriptor_t *OpenAPI_traffic_descriptor_parseFromJSON(
	...
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_traffic_descriptor_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	ddd_traffic_descriptor_list =
		cJSON_GetObjectItemCaseSensitive(traffic_descriptorJSON,
		                                 "dddTrafficDescriptorList");
	if(ddd_traffic_descriptor_list) {
		cJSON *ddd_traffic_descriptor_list_local = NULL;
		if(!cJSON_IsArray(ddd_traffic_descriptor_list)) {
			ogs_error(
				"OpenAPI_traffic_descriptor_parseFromJSON() failed [ddd_traffic_descriptor_list]");
			goto end;
		}
