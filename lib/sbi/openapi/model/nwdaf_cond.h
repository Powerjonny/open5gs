...
typedef enum { OpenAPI_nwdaf_cond_CONDITIONTYPE_NULL = 0,
	       OpenAPI_nwdaf_cond_CONDITIONTYPE_NWDAF_COND }
OpenAPI_nwdaf_cond_condition_type_e;

char * OpenAPI_nwdaf_cond_condition_type_ToString(
	OpenAPI_nwdaf_cond_condition_type_e condition_type);

OpenAPI_nwdaf_cond_condition_type_e OpenAPI_nwdaf_cond_condition_type_FromString
        (char *condition_type);
