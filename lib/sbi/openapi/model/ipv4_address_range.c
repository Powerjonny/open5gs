...
OpenAPI_ipv4_address_range_t *OpenAPI_ipv4_address_range_create(char	*start,
                                                                char	*end) {
	OpenAPI_ipv4_address_range_t *ipv4_address_range_local_var =
		ogs_malloc(sizeof(OpenAPI_ipv4_address_range_t));
...
cJSON *OpenAPI_ipv4_address_range_convertToJSON(
	...
	if(ipv4_address_range == NULL) {
		ogs_error(
			"OpenAPI_ipv4_address_range_convertToJSON() failed [Ipv4AddressRange]");
		return NULL;
	}
	...
	if(ipv4_address_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_ipv4_address_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(ipv4_address_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_ipv4_address_range_convertToJSON() failed [end]");
			goto end;
		}
	}
...
OpenAPI_ipv4_address_range_t *OpenAPI_ipv4_address_range_parseFromJSON(
	...
	cJSON *start = NULL;
	cJSON *end = NULL;
	start = cJSON_GetObjectItemCaseSensitive(ipv4_address_rangeJSON,
	                                         "start");
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_ipv4_address_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_ipv4_address_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
