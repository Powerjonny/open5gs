...
OpenAPI_service_area_id_t *OpenAPI_service_area_id_create(
	...
	OpenAPI_service_area_id_t *service_area_id_local_var =
		ogs_malloc(sizeof(OpenAPI_service_area_id_t));
...
cJSON *OpenAPI_service_area_id_convertToJSON(
	...
	if(service_area_id == NULL) {
		ogs_error(
			"OpenAPI_service_area_id_convertToJSON() failed [ServiceAreaId]");
		return NULL;
	}
	...
	if(!service_area_id->plmn_id) {
		ogs_error(
			"OpenAPI_service_area_id_convertToJSON() failed [plmn_id]");
		return NULL;
	}
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_convertToJSON(service_area_id->plmn_id);
	...
	if(!service_area_id->lac) {
		ogs_error(
			"OpenAPI_service_area_id_convertToJSON() failed [lac]");
		return NULL;
	}
	...
	if(!service_area_id->sac) {
		ogs_error(
			"OpenAPI_service_area_id_convertToJSON() failed [sac]");
		return NULL;
	}
...
OpenAPI_service_area_id_t *OpenAPI_service_area_id_parseFromJSON(
	...
	cJSON *lac = NULL;
	cJSON *sac = NULL;
	plmn_id = cJSON_GetObjectItemCaseSensitive(service_area_idJSON,
	                                           "plmnId");
	if(!plmn_id) {
		ogs_error(
			"OpenAPI_service_area_id_parseFromJSON() failed [plmn_id]");
		goto end;
	}
	...
	if(!lac) {
		ogs_error(
			"OpenAPI_service_area_id_parseFromJSON() failed [lac]");
		goto end;
	}
	...
	if(!sac) {
		ogs_error(
			"OpenAPI_service_area_id_parseFromJSON() failed [sac]");
		goto end;
	}
