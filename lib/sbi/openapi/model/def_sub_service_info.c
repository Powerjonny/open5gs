...
OpenAPI_def_sub_service_info_t *OpenAPI_def_sub_service_info_create(
	OpenAPI_list_t *versions, char *supported_features) {
	OpenAPI_def_sub_service_info_t *def_sub_service_info_local_var =
		ogs_malloc(sizeof(OpenAPI_def_sub_service_info_t));
...
void OpenAPI_def_sub_service_info_free(
	OpenAPI_def_sub_service_info_t *def_sub_service_info) {
...
cJSON *OpenAPI_def_sub_service_info_convertToJSON(
	OpenAPI_def_sub_service_info_t *def_sub_service_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(def_sub_service_info == NULL) {
		ogs_error(
			"OpenAPI_def_sub_service_info_convertToJSON() failed [DefSubServiceInfo]");
		return NULL;
	}
	...
	if(def_sub_service_info->versions) {
		...
		if(versionsList == NULL) {
			ogs_error(
				"OpenAPI_def_sub_service_info_convertToJSON() failed [versions]");
			goto end;
		}
		OpenAPI_list_for_each(def_sub_service_info->versions, node) {
	...
	if(def_sub_service_info->supported_features) {
		if(cJSON_AddStringToObject(item, "supportedFeatures",
		                           def_sub_service_info->
		                           supported_features) == NULL)
		{
			ogs_error(
				"OpenAPI_def_sub_service_info_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_def_sub_service_info_t *OpenAPI_def_sub_service_info_parseFromJSON(
	cJSON *def_sub_service_infoJSON) {
	OpenAPI_def_sub_service_info_t *def_sub_service_info_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *versions = NULL;
	OpenAPI_list_t *versionsList = NULL;
	cJSON *supported_features = NULL;
	versions = cJSON_GetObjectItemCaseSensitive(def_sub_service_infoJSON,
	                                            "versions");
	if(versions) {
		cJSON *versions_local = NULL;
		if(!cJSON_IsArray(versions)) {
			ogs_error(
				"OpenAPI_def_sub_service_info_parseFromJSON() failed [versions]");
			goto end;
		}
	...
	supported_features =
		cJSON_GetObjectItemCaseSensitive(def_sub_service_infoJSON,
		                                 "supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_def_sub_service_info_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_def_sub_service_info_t *OpenAPI_def_sub_service_info_copy(
	OpenAPI_def_sub_service_info_t	*dst,
	OpenAPI_def_sub_service_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_def_sub_service_info_convertToJSON() failed");
		return NULL;
	}
