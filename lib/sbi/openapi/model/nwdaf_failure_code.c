...
OpenAPI_nwdaf_failure_code_t *OpenAPI_nwdaf_failure_code_create() {
	OpenAPI_nwdaf_failure_code_t *nwdaf_failure_code_local_var =
		ogs_malloc(sizeof(OpenAPI_nwdaf_failure_code_t));
...
void OpenAPI_nwdaf_failure_code_free(
	OpenAPI_nwdaf_failure_code_t *nwdaf_failure_code) {
...
cJSON *OpenAPI_nwdaf_failure_code_convertToJSON(
	OpenAPI_nwdaf_failure_code_t *nwdaf_failure_code) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nwdaf_failure_code == NULL) {
		ogs_error(
			"OpenAPI_nwdaf_failure_code_convertToJSON() failed [NwdafFailureCode]");
		return NULL;
	}
...
OpenAPI_nwdaf_failure_code_t *OpenAPI_nwdaf_failure_code_parseFromJSON(
...
OpenAPI_nwdaf_failure_code_t *OpenAPI_nwdaf_failure_code_copy(
	OpenAPI_nwdaf_failure_code_t *dst, OpenAPI_nwdaf_failure_code_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
