...
OpenAPI_reachability_for_data_configuration_create(
	...
	OpenAPI_reachability_for_data_configuration_t *
	        reachability_for_data_configuration_local_var =
		ogs_malloc(
			sizeof(OpenAPI_reachability_for_data_configuration_t));
	...
	reachability_for_data_configuration_local_var->is_min_interval =
		is_min_interval;
	reachability_for_data_configuration_local_var->min_interval =
		min_interval;

	return reachability_for_data_configuration_local_var;
}

void OpenAPI_reachability_for_data_configuration_free(
	OpenAPI_reachability_for_data_configuration_t *
	...
	if(reachability_for_data_configuration->report_cfg) {
		OpenAPI_reachability_for_data_report_config_free(
			reachability_for_data_configuration->report_cfg);
...
cJSON *OpenAPI_reachability_for_data_configuration_convertToJSON(
	...
	if(reachability_for_data_configuration == NULL) {
		ogs_error(
			"OpenAPI_reachability_for_data_configuration_convertToJSON() failed [ReachabilityForDataConfiguration]");
		return NULL;
	}
	...
	if(!reachability_for_data_configuration->report_cfg) {
		ogs_error(
			"OpenAPI_reachability_for_data_configuration_convertToJSON() failed [report_cfg]");
		return NULL;
	}
	...
	if(reachability_for_data_configuration->is_min_interval) {
		...
		{
			ogs_error(
				"OpenAPI_reachability_for_data_configuration_convertToJSON() failed [min_interval]");
			goto end;
		}
	}
...
OpenAPI_reachability_for_data_configuration_parseFromJSON(
	...
	OpenAPI_reachability_for_data_configuration_t *
	        reachability_for_data_configuration_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	report_cfg =
		cJSON_GetObjectItemCaseSensitive(
			reachability_for_data_configurationJSON, "reportCfg");
	if(!report_cfg) {
		ogs_error(
			"OpenAPI_reachability_for_data_configuration_parseFromJSON() failed [report_cfg]");
		goto end;
	}
	...
	min_interval =
		cJSON_GetObjectItemCaseSensitive(
			reachability_for_data_configurationJSON, "minInterval");
	if(min_interval) {
		if(!cJSON_IsNumber(min_interval)) {
			ogs_error(
				"OpenAPI_reachability_for_data_configuration_parseFromJSON() failed [min_interval]");
			goto end;
		}
	}
...
OpenAPI_reachability_for_data_configuration_t *
OpenAPI_reachability_for_data_configuration_copy(
	OpenAPI_reachability_for_data_configuration_t	*dst,
	OpenAPI_reachability_for_data_configuration_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_reachability_for_data_configuration_convertToJSON() failed");
		return NULL;
	}
