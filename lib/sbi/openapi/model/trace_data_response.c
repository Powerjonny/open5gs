...
OpenAPI_trace_data_response_t *OpenAPI_trace_data_response_create(
	...
	OpenAPI_trace_data_response_t *trace_data_response_local_var =
		ogs_malloc(sizeof(OpenAPI_trace_data_response_t));
	...
	trace_data_response_local_var->shared_trace_data_id =
		shared_trace_data_id;

	return trace_data_response_local_var;
}

void OpenAPI_trace_data_response_free(
	OpenAPI_trace_data_response_t *trace_data_response) {
...
cJSON *OpenAPI_trace_data_response_convertToJSON(
	OpenAPI_trace_data_response_t *trace_data_response) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(trace_data_response == NULL) {
		ogs_error(
			"OpenAPI_trace_data_response_convertToJSON() failed [TraceDataResponse]");
		return NULL;
	}
	...
	if(trace_data_response->trace_data) {
		...
		if(trace_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_trace_data_response_convertToJSON() failed [trace_data]");
			goto end;
		}
	...
	if(trace_data_response->shared_trace_data_id) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_response_convertToJSON() failed [shared_trace_data_id]");
			goto end;
		}
	}
...
OpenAPI_trace_data_response_t *OpenAPI_trace_data_response_parseFromJSON(
	cJSON *trace_data_responseJSON) {
	...
	trace_data = cJSON_GetObjectItemCaseSensitive(trace_data_responseJSON,
	                                              "traceData");
	if(trace_data) {
	...
	shared_trace_data_id =
		cJSON_GetObjectItemCaseSensitive(trace_data_responseJSON,
		                                 "sharedTraceDataId");
	if(shared_trace_data_id) {
		...
		{
			ogs_error(
				"OpenAPI_trace_data_response_parseFromJSON() failed [shared_trace_data_id]");
			goto end;
		}
	}
...
OpenAPI_trace_data_response_t *OpenAPI_trace_data_response_copy(
	OpenAPI_trace_data_response_t	*dst,
	OpenAPI_trace_data_response_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
