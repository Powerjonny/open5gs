...
OpenAPI_pcf_selection_assistance_info_1_create(char		*dnn,
                                               OpenAPI_snssai_t *single_nssai) {
	OpenAPI_pcf_selection_assistance_info_1_t *
	        pcf_selection_assistance_info_1_local_var =
		ogs_malloc(sizeof(OpenAPI_pcf_selection_assistance_info_1_t));
...
cJSON *OpenAPI_pcf_selection_assistance_info_1_convertToJSON(
	...
	if(pcf_selection_assistance_info_1 == NULL) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_convertToJSON() failed [PcfSelectionAssistanceInfo_1]");
		return NULL;
	}
	...
	if(!pcf_selection_assistance_info_1->dnn) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_convertToJSON() failed [dnn]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "dnn",
	                           pcf_selection_assistance_info_1->dnn) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_convertToJSON() failed [dnn]");
	...
	if(!pcf_selection_assistance_info_1->single_nssai) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_convertToJSON() failed [single_nssai]");
		return NULL;
	}
...
OpenAPI_pcf_selection_assistance_info_1_parseFromJSON(
	cJSON *pcf_selection_assistance_info_1JSON) {
	OpenAPI_pcf_selection_assistance_info_1_t *
	...
	dnn =
		cJSON_GetObjectItemCaseSensitive(
			pcf_selection_assistance_info_1JSON, "dnn");
	if(!dnn) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	single_nssai =
		cJSON_GetObjectItemCaseSensitive(
			pcf_selection_assistance_info_1JSON, "singleNssai");
	if(!single_nssai) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_parseFromJSON() failed [single_nssai]");
		goto end;
	}
	...
	pcf_selection_assistance_info_1_local_var =
		OpenAPI_pcf_selection_assistance_info_1_create(
...
OpenAPI_pcf_selection_assistance_info_1_t *
OpenAPI_pcf_selection_assistance_info_1_copy(
	OpenAPI_pcf_selection_assistance_info_1_t	*dst,
	OpenAPI_pcf_selection_assistance_info_1_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_1_convertToJSON() failed");
		return NULL;
	}
