...
OpenAPI_hsmf_updated_data_t *OpenAPI_hsmf_updated_data_create(
	...
	OpenAPI_n4_information_t *n4_info_ext2, OpenAPI_list_t *dnai_list,
	char *supported_features,
	OpenAPI_roaming_charging_profile_t *roaming_charging_profile,
	char *home_provided_charging_id, OpenAPI_up_security_t *up_security,
	OpenAPI_max_integrity_protected_data_rate_e
	max_integrity_protected_data_rate_ul,
	OpenAPI_max_integrity_protected_data_rate_e
	max_integrity_protected_data_rate_dl, bool is_ipv6_multi_homing_ind,
	int ipv6_multi_homing_ind, OpenAPI_list_t *qos_flows_setup_list,
	OpenAPI_ambr_t *session_ambr,
	OpenAPI_eps_pdn_cnx_info_t *eps_pdn_cnx_info,
	OpenAPI_list_t *eps_bearer_info, bool is_pti, int pti,
	char *inter_plmn_api_root, char *intra_plmn_api_root) {
	OpenAPI_hsmf_updated_data_t *hsmf_updated_data_local_var =
		ogs_malloc(sizeof(OpenAPI_hsmf_updated_data_t));
	...
	hsmf_updated_data_local_var->roaming_charging_profile =
		roaming_charging_profile;
	hsmf_updated_data_local_var->home_provided_charging_id =
		home_provided_charging_id;
	hsmf_updated_data_local_var->up_security = up_security;
	hsmf_updated_data_local_var->max_integrity_protected_data_rate_ul =
		max_integrity_protected_data_rate_ul;
	hsmf_updated_data_local_var->max_integrity_protected_data_rate_dl =
		max_integrity_protected_data_rate_dl;
	hsmf_updated_data_local_var->is_ipv6_multi_homing_ind =
		is_ipv6_multi_homing_ind;
	hsmf_updated_data_local_var->ipv6_multi_homing_ind =
		ipv6_multi_homing_ind;
	hsmf_updated_data_local_var->qos_flows_setup_list =
...
void OpenAPI_hsmf_updated_data_free(
	OpenAPI_hsmf_updated_data_t *hsmf_updated_data) {
	...
	if(hsmf_updated_data->n1_sm_info_to_ue) {
		OpenAPI_ref_to_binary_data_free(
			hsmf_updated_data->n1_sm_info_to_ue);
	...
	if(hsmf_updated_data->roaming_charging_profile) {
		OpenAPI_roaming_charging_profile_free(
			hsmf_updated_data->roaming_charging_profile);
	...
	if(hsmf_updated_data->qos_flows_setup_list) {
		OpenAPI_list_for_each(hsmf_updated_data->qos_flows_setup_list,
		                      node) {
	...
	if(hsmf_updated_data->eps_pdn_cnx_info) {
		OpenAPI_eps_pdn_cnx_info_free(
			hsmf_updated_data->eps_pdn_cnx_info);
		hsmf_updated_data->eps_pdn_cnx_info = NULL;
	}
	if(hsmf_updated_data->eps_bearer_info) {
		OpenAPI_list_for_each(hsmf_updated_data->eps_bearer_info,
		                      node) {
...
cJSON *OpenAPI_hsmf_updated_data_convertToJSON(
	OpenAPI_hsmf_updated_data_t *hsmf_updated_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(hsmf_updated_data == NULL) {
		ogs_error(
			"OpenAPI_hsmf_updated_data_convertToJSON() failed [HsmfUpdatedData]");
		return NULL;
	}
	...
	if(hsmf_updated_data->n1_sm_info_to_ue) {
		...
		if(n1_sm_info_to_ue_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [n1_sm_info_to_ue]");
			goto end;
		}
	...
	if(hsmf_updated_data->n4_info) {
		cJSON *n4_info_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				hsmf_updated_data->n4_info);
		if(n4_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [n4_info]");
			goto end;
		}
	...
	if(hsmf_updated_data->n4_info_ext1) {
		cJSON *n4_info_ext1_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				hsmf_updated_data->n4_info_ext1);
		if(n4_info_ext1_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [n4_info_ext1]");
			goto end;
		}
	...
	if(hsmf_updated_data->n4_info_ext2) {
		cJSON *n4_info_ext2_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				hsmf_updated_data->n4_info_ext2);
		if(n4_info_ext2_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [n4_info_ext2]");
			goto end;
		}
	...
	if(hsmf_updated_data->dnai_list) {
		...
		if(dnai_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [dnai_list]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_updated_data->dnai_list, node) {
	...
	if(hsmf_updated_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(hsmf_updated_data->roaming_charging_profile) {
		...
		if(roaming_charging_profile_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [roaming_charging_profile]");
			goto end;
		}
	...
	if(hsmf_updated_data->home_provided_charging_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [home_provided_charging_id]");
			goto end;
		}
	}
	...
	if(hsmf_updated_data->up_security) {
		cJSON *up_security_local_JSON =
			OpenAPI_up_security_convertToJSON(
				hsmf_updated_data->up_security);
		if(up_security_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [up_security]");
			goto end;
		}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	}
	...
	if(hsmf_updated_data->is_ipv6_multi_homing_ind) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [ipv6_multi_homing_ind]");
			goto end;
		}
	}
	...
	if(hsmf_updated_data->qos_flows_setup_list) {
		...
		if(qos_flows_setup_listList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [qos_flows_setup_list]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_updated_data->qos_flows_setup_list,
		                      node) {
	...
	if(hsmf_updated_data->session_ambr) {
		cJSON *session_ambr_local_JSON =
			OpenAPI_ambr_convertToJSON(
				hsmf_updated_data->session_ambr);
		if(session_ambr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [session_ambr]");
			goto end;
		}
	...
	if(hsmf_updated_data->eps_pdn_cnx_info) {
		...
		if(eps_pdn_cnx_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [eps_pdn_cnx_info]");
			goto end;
		}
	...
	if(hsmf_updated_data->eps_bearer_info) {
		...
		if(eps_bearer_infoList == NULL) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [eps_bearer_info]");
			goto end;
		}
		OpenAPI_list_for_each(hsmf_updated_data->eps_bearer_info,
		                      node) {
	...
	if(hsmf_updated_data->is_pti) {
		if(cJSON_AddNumberToObject(item, "pti",
		                           hsmf_updated_data->pti) == NULL)
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [pti]");
			goto end;
		}
	}
	...
	if(hsmf_updated_data->inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(hsmf_updated_data->intra_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_convertToJSON() failed [intra_plmn_api_root]");
			goto end;
		}
	}
...
OpenAPI_hsmf_updated_data_t *OpenAPI_hsmf_updated_data_parseFromJSON(
	cJSON *hsmf_updated_dataJSON) {
	...
	n4_info = cJSON_GetObjectItemCaseSensitive(hsmf_updated_dataJSON,
	                                           "n4Info");
	if(n4_info) {
	...
	n4_info_ext1 = cJSON_GetObjectItemCaseSensitive(hsmf_updated_dataJSON,
	                                                "n4InfoExt1");
	if(n4_info_ext1) {
	...
	n4_info_ext2 = cJSON_GetObjectItemCaseSensitive(hsmf_updated_dataJSON,
	                                                "n4InfoExt2");
	if(n4_info_ext2) {
	...
	dnai_list = cJSON_GetObjectItemCaseSensitive(hsmf_updated_dataJSON,
	                                             "dnaiList");
	if(dnai_list) {
		cJSON *dnai_list_local = NULL;
		if(!cJSON_IsArray(dnai_list)) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [dnai_list]");
			goto end;
		}
	...
	if(home_provided_charging_id) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [home_provided_charging_id]");
			goto end;
		}
	}

	up_security = cJSON_GetObjectItemCaseSensitive(hsmf_updated_dataJSON,
	                                               "upSecurity");
	if(up_security) {
	...
	if(max_integrity_protected_data_rate_ul) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_ul)) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	...
	if(max_integrity_protected_data_rate_dl) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	...
	if(qos_flows_setup_list) {
		...
		if(!cJSON_IsArray(qos_flows_setup_list)) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [qos_flows_setup_list]");
			goto end;
		}
	...
	session_ambr = cJSON_GetObjectItemCaseSensitive(hsmf_updated_dataJSON,
	                                                "sessionAmbr");
	if(session_ambr) {
	...
	if(eps_bearer_info) {
		...
		if(!cJSON_IsArray(eps_bearer_info)) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [eps_bearer_info]");
			goto end;
		}
	...
	if(pti) {
		if(!cJSON_IsNumber(pti)) {
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [pti]");
			goto end;
		}
	}
	...
	if(inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(intra_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_hsmf_updated_data_parseFromJSON() failed [intra_plmn_api_root]");
			goto end;
		}
	}
	...
	hsmf_updated_data_local_var = OpenAPI_hsmf_updated_data_create(
		...
		home_provided_charging_id &&
		!cJSON_IsNull(home_provided_charging_id) ?
		ogs_strdup(home_provided_charging_id->valuestring) : NULL,
...
OpenAPI_hsmf_updated_data_t *OpenAPI_hsmf_updated_data_copy(
	OpenAPI_hsmf_updated_data_t *dst, OpenAPI_hsmf_updated_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
