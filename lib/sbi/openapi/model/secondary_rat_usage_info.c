...
OpenAPI_secondary_rat_usage_info_t *OpenAPI_secondary_rat_usage_info_create(
	...
	OpenAPI_secondary_rat_usage_info_t *secondary_rat_usage_info_local_var =
		ogs_malloc(sizeof(OpenAPI_secondary_rat_usage_info_t));
	ogs_assert(secondary_rat_usage_info_local_var);

	secondary_rat_usage_info_local_var->secondary_rat_type =
		secondary_rat_type;
	secondary_rat_usage_info_local_var->qos_flows_usage_data =
		qos_flows_usage_data;
	secondary_rat_usage_info_local_var->pdu_session_usage_data =
		pdu_session_usage_data;

	return secondary_rat_usage_info_local_var;
}

void OpenAPI_secondary_rat_usage_info_free(
	OpenAPI_secondary_rat_usage_info_t *secondary_rat_usage_info) {
	...
	if(secondary_rat_usage_info->qos_flows_usage_data) {
		OpenAPI_list_for_each(
			secondary_rat_usage_info->qos_flows_usage_data, node) {
	...
	if(secondary_rat_usage_info->pdu_session_usage_data) {
		OpenAPI_list_for_each(
			secondary_rat_usage_info->pdu_session_usage_data,
			node) {
...
cJSON *OpenAPI_secondary_rat_usage_info_convertToJSON(
	OpenAPI_secondary_rat_usage_info_t *secondary_rat_usage_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(secondary_rat_usage_info == NULL) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [SecondaryRatUsageInfo]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [secondary_rat_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "secondaryRatType",
	                           OpenAPI_rat_type_ToString(
					   secondary_rat_usage_info->
					   secondary_rat_type)) == NULL)
	{
		ogs_error(
			"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [secondary_rat_type]");
		goto end;
	...
	if(secondary_rat_usage_info->qos_flows_usage_data) {
		cJSON *qos_flows_usage_dataList = cJSON_AddArrayToObject(item,
		                                                         "qosFlowsUsageData");
		if(qos_flows_usage_dataList == NULL) {
			ogs_error(
				"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [qos_flows_usage_data]");
			goto end;
		}
		OpenAPI_list_for_each(
			secondary_rat_usage_info->qos_flows_usage_data, node) {
			cJSON *itemLocal =
				OpenAPI_qos_flow_usage_report_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [qos_flows_usage_data]");
			...
			cJSON_AddItemToArray(qos_flows_usage_dataList,
			                     itemLocal);
		}
	}

	if(secondary_rat_usage_info->pdu_session_usage_data) {
		cJSON *pdu_session_usage_dataList = cJSON_AddArrayToObject(item,
		                                                           "pduSessionUsageData");
		if(pdu_session_usage_dataList == NULL) {
			ogs_error(
				"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [pdu_session_usage_data]");
			goto end;
		}
		OpenAPI_list_for_each(
			secondary_rat_usage_info->pdu_session_usage_data,
			node) {
			cJSON *itemLocal =
				OpenAPI_volume_timed_report_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_secondary_rat_usage_info_convertToJSON() failed [pdu_session_usage_data]");
			...
			cJSON_AddItemToArray(pdu_session_usage_dataList,
			                     itemLocal);
		}
	}
...
OpenAPI_secondary_rat_usage_info_parseFromJSON(
	cJSON *secondary_rat_usage_infoJSON) {
	OpenAPI_secondary_rat_usage_info_t *secondary_rat_usage_info_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	secondary_rat_type =
		cJSON_GetObjectItemCaseSensitive(secondary_rat_usage_infoJSON,
		                                 "secondaryRatType");
	if(!secondary_rat_type) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_info_parseFromJSON() failed [secondary_rat_type]");
		goto end;
	}
	...
	secondary_rat_typeVariable =
		OpenAPI_rat_type_FromString(secondary_rat_type->valuestring);
	...
	if(qos_flows_usage_data) {
		...
		if(!cJSON_IsArray(qos_flows_usage_data)) {
			ogs_error(
				"OpenAPI_secondary_rat_usage_info_parseFromJSON() failed [qos_flows_usage_data]");
			goto end;
		}

		qos_flows_usage_dataList = OpenAPI_list_create();

		cJSON_ArrayForEach(qos_flows_usage_data_local,
		                   qos_flows_usage_data) {
			...
			OpenAPI_qos_flow_usage_report_t *
				...
				OpenAPI_qos_flow_usage_report_parseFromJSON(
					qos_flows_usage_data_local);
			if(!qos_flows_usage_dataItem) {
				ogs_error("No qos_flows_usage_dataItem");
				goto end;
			}
			OpenAPI_list_add(qos_flows_usage_dataList,
			                 qos_flows_usage_dataItem);
		}
	}
	...
	if(pdu_session_usage_data) {
		...
		if(!cJSON_IsArray(pdu_session_usage_data)) {
			ogs_error(
				"OpenAPI_secondary_rat_usage_info_parseFromJSON() failed [pdu_session_usage_data]");
			goto end;
		}

		pdu_session_usage_dataList = OpenAPI_list_create();

		cJSON_ArrayForEach(pdu_session_usage_data_local,
		                   pdu_session_usage_data) {
			...
			OpenAPI_volume_timed_report_t *
				...
				OpenAPI_volume_timed_report_parseFromJSON(
					pdu_session_usage_data_local);
	...
	secondary_rat_usage_info_local_var =
		OpenAPI_secondary_rat_usage_info_create(
			...
			pdu_session_usage_data ? pdu_session_usage_dataList :
			NULL
			);
...
OpenAPI_secondary_rat_usage_info_t *OpenAPI_secondary_rat_usage_info_copy(
	OpenAPI_secondary_rat_usage_info_t	*dst,
	OpenAPI_secondary_rat_usage_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_info_convertToJSON() failed");
		return NULL;
	}
