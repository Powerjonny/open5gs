...
OpenAPI_dispersion_info_t *OpenAPI_dispersion_info_create(char	*ts_start,
                                                          ...
                                                          *disper_type) {
	OpenAPI_dispersion_info_t *dispersion_info_local_var =
		ogs_malloc(sizeof(OpenAPI_dispersion_info_t));
...
cJSON *OpenAPI_dispersion_info_convertToJSON(
	...
	if(dispersion_info == NULL) {
		ogs_error(
			"OpenAPI_dispersion_info_convertToJSON() failed [DispersionInfo]");
		return NULL;
	}
	...
	if(!dispersion_info->ts_start) {
		ogs_error(
			"OpenAPI_dispersion_info_convertToJSON() failed [ts_start]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_dispersion_info_convertToJSON() failed [ts_duration]");
		goto end;
	}

	if(!dispersion_info->disper_collects) {
		ogs_error(
			"OpenAPI_dispersion_info_convertToJSON() failed [disper_collects]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(dispersion_info->disper_collects, node) {
		cJSON *itemLocal =
			OpenAPI_dispersion_collection_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_dispersion_info_convertToJSON() failed [disper_collects]");
			goto end;
	...
	if(!dispersion_info->disper_type) {
		ogs_error(
			"OpenAPI_dispersion_info_convertToJSON() failed [disper_type]");
		return NULL;
	}
...
OpenAPI_dispersion_info_t *OpenAPI_dispersion_info_parseFromJSON(
	...
	if(!ts_start) {
		ogs_error(
			"OpenAPI_dispersion_info_parseFromJSON() failed [ts_start]");
		goto end;
	}
	...
	if(!ts_duration) {
		ogs_error(
			"OpenAPI_dispersion_info_parseFromJSON() failed [ts_duration]");
		goto end;
	}
	...
	if(!disper_collects) {
		ogs_error(
			"OpenAPI_dispersion_info_parseFromJSON() failed [disper_collects]");
		goto end;
	}
	...
	cJSON_ArrayForEach(disper_collects_local, disper_collects) {
		...
		OpenAPI_dispersion_collection_t *disper_collectsItem =
			OpenAPI_dispersion_collection_parseFromJSON(
	...
	if(!disper_type) {
		ogs_error(
			"OpenAPI_dispersion_info_parseFromJSON() failed [disper_type]");
		goto end;
	}
