...
OpenAPI_network_perf_requirement_t *OpenAPI_network_perf_requirement_create(
	OpenAPI_network_perf_type_t *nw_perf_type, bool is_relative_ratio,
	int relative_ratio, bool is_absolute_num, int absolute_num) {
	OpenAPI_network_perf_requirement_t *network_perf_requirement_local_var =
		ogs_malloc(sizeof(OpenAPI_network_perf_requirement_t));
...
void OpenAPI_network_perf_requirement_free(
	OpenAPI_network_perf_requirement_t *network_perf_requirement) {
	...
	if(network_perf_requirement->nw_perf_type) {
		OpenAPI_network_perf_type_free(
...
cJSON *OpenAPI_network_perf_requirement_convertToJSON(
	OpenAPI_network_perf_requirement_t *network_perf_requirement) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(network_perf_requirement == NULL) {
		ogs_error(
			"OpenAPI_network_perf_requirement_convertToJSON() failed [NetworkPerfRequirement]");
		return NULL;
	}
	...
	if(!network_perf_requirement->nw_perf_type) {
		ogs_error(
			"OpenAPI_network_perf_requirement_convertToJSON() failed [nw_perf_type]");
		return NULL;
	}
	cJSON *nw_perf_type_local_JSON =
		OpenAPI_network_perf_type_convertToJSON(
			network_perf_requirement->nw_perf_type);
	...
	if(network_perf_requirement->is_relative_ratio) {
		...
		{
			ogs_error(
				"OpenAPI_network_perf_requirement_convertToJSON() failed [relative_ratio]");
			goto end;
		}
	}
	...
	if(network_perf_requirement->is_absolute_num) {
		...
		{
			ogs_error(
				"OpenAPI_network_perf_requirement_convertToJSON() failed [absolute_num]");
			goto end;
		}
	}
...
OpenAPI_network_perf_requirement_parseFromJSON(
	...
	nw_perf_type =
		cJSON_GetObjectItemCaseSensitive(network_perf_requirementJSON,
		                                 "nwPerfType");
	if(!nw_perf_type) {
		ogs_error(
			"OpenAPI_network_perf_requirement_parseFromJSON() failed [nw_perf_type]");
		goto end;
	}
	nw_perf_type_local_nonprim =
		OpenAPI_network_perf_type_parseFromJSON(nw_perf_type);
	if(!nw_perf_type_local_nonprim) {
		ogs_error(
			"OpenAPI_network_perf_type_parseFromJSON failed [nw_perf_type]");
		goto end;
	}
	...
	if(relative_ratio) {
		if(!cJSON_IsNumber(relative_ratio)) {
			ogs_error(
				"OpenAPI_network_perf_requirement_parseFromJSON() failed [relative_ratio]");
			goto end;
		}
	}
	...
	if(absolute_num) {
		if(!cJSON_IsNumber(absolute_num)) {
			ogs_error(
				"OpenAPI_network_perf_requirement_parseFromJSON() failed [absolute_num]");
			goto end;
		}
	}

	network_perf_requirement_local_var =
		OpenAPI_network_perf_requirement_create(
			nw_perf_type_local_nonprim,
...
OpenAPI_network_perf_requirement_t *OpenAPI_network_perf_requirement_copy(
	OpenAPI_network_perf_requirement_t	*dst,
	OpenAPI_network_perf_requirement_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_network_perf_requirement_convertToJSON() failed");
		return NULL;
	}
