...
OpenAPI_final_unit_action_t *OpenAPI_final_unit_action_create() {
	OpenAPI_final_unit_action_t *final_unit_action_local_var =
		ogs_malloc(sizeof(OpenAPI_final_unit_action_t));
...
void OpenAPI_final_unit_action_free(
...
cJSON *OpenAPI_final_unit_action_convertToJSON(
	OpenAPI_final_unit_action_t *final_unit_action) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(final_unit_action == NULL) {
		ogs_error(
			"OpenAPI_final_unit_action_convertToJSON() failed [FinalUnitAction]");
		return NULL;
	}
...
OpenAPI_final_unit_action_t *OpenAPI_final_unit_action_parseFromJSON(
	cJSON *final_unit_actionJSON) {
...
OpenAPI_final_unit_action_t *OpenAPI_final_unit_action_copy(
	OpenAPI_final_unit_action_t *dst, OpenAPI_final_unit_action_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
