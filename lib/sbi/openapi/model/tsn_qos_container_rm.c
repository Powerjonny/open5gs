...
OpenAPI_tsn_qos_container_rm_t *OpenAPI_tsn_qos_container_rm_create(
	bool is_max_tsc_burst_size_null, bool is_max_tsc_burst_size,
	int max_tsc_burst_size, bool is_tsc_pack_delay_null,
	bool is_tsc_pack_delay, int tsc_pack_delay, bool is_tsc_prio_level_null,
	bool is_tsc_prio_level, int tsc_prio_level) {
	OpenAPI_tsn_qos_container_rm_t *tsn_qos_container_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_tsn_qos_container_rm_t));
	ogs_assert(tsn_qos_container_rm_local_var);

	tsn_qos_container_rm_local_var->is_max_tsc_burst_size_null =
		is_max_tsc_burst_size_null;
	tsn_qos_container_rm_local_var->is_max_tsc_burst_size =
		is_max_tsc_burst_size;
	tsn_qos_container_rm_local_var->max_tsc_burst_size = max_tsc_burst_size;
	tsn_qos_container_rm_local_var->is_tsc_pack_delay_null =
		is_tsc_pack_delay_null;
	...
	tsn_qos_container_rm_local_var->is_tsc_prio_level_null =
		is_tsc_prio_level_null;
...
void OpenAPI_tsn_qos_container_rm_free(
	OpenAPI_tsn_qos_container_rm_t *tsn_qos_container_rm) {
...
cJSON *OpenAPI_tsn_qos_container_rm_convertToJSON(
	...
	if(tsn_qos_container_rm == NULL) {
		ogs_error(
			"OpenAPI_tsn_qos_container_rm_convertToJSON() failed [TsnQosContainerRm]");
		return NULL;
	}
	...
	if(tsn_qos_container_rm->is_max_tsc_burst_size) {
		if(cJSON_AddNumberToObject(item, "maxTscBurstSize",
		                           tsn_qos_container_rm->
		                           max_tsc_burst_size) == NULL)
		{
			ogs_error(
				"OpenAPI_tsn_qos_container_rm_convertToJSON() failed [max_tsc_burst_size]");
			goto end;
		}
	...
	if(tsn_qos_container_rm->is_tsc_pack_delay) {
		if(cJSON_AddNumberToObject(item, "tscPackDelay",
		                           tsn_qos_container_rm->tsc_pack_delay)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_tsn_qos_container_rm_convertToJSON() failed [tsc_pack_delay]");
			goto end;
		}
	...
	if(tsn_qos_container_rm->is_tsc_prio_level) {
		if(cJSON_AddNumberToObject(item, "tscPrioLevel",
		                           tsn_qos_container_rm->tsc_prio_level)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_tsn_qos_container_rm_convertToJSON() failed [tsc_prio_level]");
			goto end;
		}
...
OpenAPI_tsn_qos_container_rm_t *OpenAPI_tsn_qos_container_rm_parseFromJSON(
	cJSON *tsn_qos_container_rmJSON) {
	...
	max_tsc_burst_size =
		cJSON_GetObjectItemCaseSensitive(tsn_qos_container_rmJSON,
		                                 "maxTscBurstSize");
	if(max_tsc_burst_size) {
		if(!cJSON_IsNull(max_tsc_burst_size)) {
			if(!cJSON_IsNumber(max_tsc_burst_size)) {
				ogs_error(
					"OpenAPI_tsn_qos_container_rm_parseFromJSON() failed [max_tsc_burst_size]");
				goto end;
			}
		}
	}
	...
	if(tsc_pack_delay) {
		if(!cJSON_IsNull(tsc_pack_delay)) {
			if(!cJSON_IsNumber(tsc_pack_delay)) {
				ogs_error(
					"OpenAPI_tsn_qos_container_rm_parseFromJSON() failed [tsc_pack_delay]");
				goto end;
			}
		}
	}
	...
	if(tsc_prio_level) {
		if(!cJSON_IsNull(tsc_prio_level)) {
			if(!cJSON_IsNumber(tsc_prio_level)) {
				ogs_error(
					"OpenAPI_tsn_qos_container_rm_parseFromJSON() failed [tsc_prio_level]");
				goto end;
			}
		}
	}
...
OpenAPI_tsn_qos_container_rm_t *OpenAPI_tsn_qos_container_rm_copy(
	OpenAPI_tsn_qos_container_rm_t	*dst,
	OpenAPI_tsn_qos_container_rm_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_tsn_qos_container_rm_convertToJSON() failed");
		return NULL;
	}
