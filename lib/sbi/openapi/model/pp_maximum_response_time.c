...
OpenAPI_pp_maximum_response_time_t *OpenAPI_pp_maximum_response_time_create(
	int maximum_response_time, char *af_instance_id, int reference_id,
	char *validity_time, char *mtc_provider_information) {
	OpenAPI_pp_maximum_response_time_t *pp_maximum_response_time_local_var =
		ogs_malloc(sizeof(OpenAPI_pp_maximum_response_time_t));
	ogs_assert(pp_maximum_response_time_local_var);

	pp_maximum_response_time_local_var->maximum_response_time =
	...
	pp_maximum_response_time_local_var->mtc_provider_information =
		mtc_provider_information;

	return pp_maximum_response_time_local_var;
}

void OpenAPI_pp_maximum_response_time_free(
...
cJSON *OpenAPI_pp_maximum_response_time_convertToJSON(
	OpenAPI_pp_maximum_response_time_t *pp_maximum_response_time) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pp_maximum_response_time == NULL) {
		ogs_error(
			"OpenAPI_pp_maximum_response_time_convertToJSON() failed [PpMaximumResponseTime]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_pp_maximum_response_time_convertToJSON() failed [maximum_response_time]");
		goto end;
	}

	if(!pp_maximum_response_time->af_instance_id) {
		ogs_error(
			"OpenAPI_pp_maximum_response_time_convertToJSON() failed [af_instance_id]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "afInstanceId",
	                           pp_maximum_response_time->af_instance_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_pp_maximum_response_time_convertToJSON() failed [af_instance_id]");
	...
	if(cJSON_AddNumberToObject(item, "referenceId",
	                           pp_maximum_response_time->reference_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_pp_maximum_response_time_convertToJSON() failed [reference_id]");
		goto end;
	}
	...
	if(pp_maximum_response_time->validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_response_time_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(pp_maximum_response_time->mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_response_time_convertToJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
...
OpenAPI_pp_maximum_response_time_parseFromJSON(
	cJSON *pp_maximum_response_timeJSON) {
	OpenAPI_pp_maximum_response_time_t *pp_maximum_response_time_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(!maximum_response_time) {
		ogs_error(
			"OpenAPI_pp_maximum_response_time_parseFromJSON() failed [maximum_response_time]");
		goto end;
	}
	...
	if(!af_instance_id) {
		ogs_error(
			"OpenAPI_pp_maximum_response_time_parseFromJSON() failed [af_instance_id]");
		goto end;
	}
	...
	if(!reference_id) {
		ogs_error(
			"OpenAPI_pp_maximum_response_time_parseFromJSON() failed [reference_id]");
		goto end;
	}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_response_time_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_response_time_parseFromJSON() failed [mtc_provider_information]");
			goto end;
		}
	}

	pp_maximum_response_time_local_var =
		OpenAPI_pp_maximum_response_time_create(
...
OpenAPI_pp_maximum_response_time_t *OpenAPI_pp_maximum_response_time_copy(
	OpenAPI_pp_maximum_response_time_t	*dst,
	OpenAPI_pp_maximum_response_time_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pp_maximum_response_time_convertToJSON() failed");
		return NULL;
	}
