...
OpenAPI_local2d_point_uncertainty_ellipse_all_of_create(
...
void OpenAPI_local2d_point_uncertainty_ellipse_all_of_free(
	OpenAPI_local2d_point_uncertainty_ellipse_all_of_t *
...
cJSON *OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON(
	OpenAPI_local2d_point_uncertainty_ellipse_all_of_t *
	local2d_point_uncertainty_ellipse_all_of) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(local2d_point_uncertainty_ellipse_all_of == NULL) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON() failed [Local2dPointUncertaintyEllipse_allOf]");
		return NULL;
	}
	...
	if(!local2d_point_uncertainty_ellipse_all_of->local_origin) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON() failed [local_origin]");
		return NULL;
	}
	...
	if(!local2d_point_uncertainty_ellipse_all_of->point) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON() failed [point]");
		return NULL;
	}
	...
	if(!local2d_point_uncertainty_ellipse_all_of->uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_local2d_point_uncertainty_ellipse_all_of_t *
OpenAPI_local2d_point_uncertainty_ellipse_all_of_parseFromJSON(
	...
	if(!local_origin) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_parseFromJSON() failed [local_origin]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	if(!uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_parseFromJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_local2d_point_uncertainty_ellipse_all_of_t *
OpenAPI_local2d_point_uncertainty_ellipse_all_of_copy(
	OpenAPI_local2d_point_uncertainty_ellipse_all_of_t	*dst,
	OpenAPI_local2d_point_uncertainty_ellipse_all_of_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON(
			src);
	if(!item) {
		ogs_error(
			"OpenAPI_local2d_point_uncertainty_ellipse_all_of_convertToJSON() failed");
		return NULL;
	}
