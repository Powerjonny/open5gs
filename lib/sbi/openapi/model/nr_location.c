...
OpenAPI_nr_location_t *OpenAPI_nr_location_create(OpenAPI_tai_t		*tai,
                                                  OpenAPI_ncgi_t	*ncgi,
                                                  bool
                                                  is_ignore_ncgi,
                                                  int
                                                  ...
                                                  *
                                                  ...
                                                  OpenAPI_global_ran_node_id_t
                                                        *global_gnb_id) {
	OpenAPI_nr_location_t *nr_location_local_var =
		ogs_malloc(sizeof(OpenAPI_nr_location_t));
...
cJSON *OpenAPI_nr_location_convertToJSON(OpenAPI_nr_location_t *nr_location) {
	...
	if(nr_location == NULL) {
		ogs_error(
			"OpenAPI_nr_location_convertToJSON() failed [NrLocation]");
		return NULL;
	}
	...
	if(nr_location->is_ignore_ncgi) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_convertToJSON() failed [ignore_ncgi]");
			goto end;
		}
	}
	...
	if(nr_location->is_age_of_location_information) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_convertToJSON() failed [age_of_location_information]");
			goto end;
		}
	}
	...
	if(nr_location->ue_location_timestamp) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_convertToJSON() failed [ue_location_timestamp]");
			goto end;
		}
	}
	...
	if(nr_location->geographical_information) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_convertToJSON() failed [geographical_information]");
			goto end;
		}
	}
	...
	if(nr_location->geodetic_information) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_convertToJSON() failed [geodetic_information]");
			goto end;
		}
	}
	...
	if(nr_location->global_gnb_id) {
		...
		if(global_gnb_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nr_location_convertToJSON() failed [global_gnb_id]");
			goto end;
		}
...
OpenAPI_nr_location_t *OpenAPI_nr_location_parseFromJSON(
	cJSON *nr_locationJSON) {
	...
	if(ignore_ncgi) {
		if(!cJSON_IsBool(ignore_ncgi)) {
			ogs_error(
				"OpenAPI_nr_location_parseFromJSON() failed [ignore_ncgi]");
			goto end;
		}
	}

	age_of_location_information =
		cJSON_GetObjectItemCaseSensitive(nr_locationJSON,
		                                 "ageOfLocationInformation");
	if(age_of_location_information) {
		if(!cJSON_IsNumber(age_of_location_information)) {
			ogs_error(
				"OpenAPI_nr_location_parseFromJSON() failed [age_of_location_information]");
			goto end;
		}
	}
	...
	if(ue_location_timestamp) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_parseFromJSON() failed [ue_location_timestamp]");
			goto end;
		}
	}
	...
	if(geographical_information) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_parseFromJSON() failed [geographical_information]");
			goto end;
		}
	}
	...
	if(geodetic_information) {
		...
		{
			ogs_error(
				"OpenAPI_nr_location_parseFromJSON() failed [geodetic_information]");
			goto end;
		}
	}
...
OpenAPI_nr_location_t *OpenAPI_nr_location_copy(OpenAPI_nr_location_t	*dst,
                                                OpenAPI_nr_location_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
