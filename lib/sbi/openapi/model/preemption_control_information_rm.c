...
OpenAPI_preemption_control_information_rm_create() {
	OpenAPI_preemption_control_information_rm_t *
	        preemption_control_information_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_preemption_control_information_rm_t));
...
cJSON *OpenAPI_preemption_control_information_rm_convertToJSON(
	...
	if(preemption_control_information_rm == NULL) {
		ogs_error(
			"OpenAPI_preemption_control_information_rm_convertToJSON() failed [PreemptionControlInformationRm]");
		return NULL;
	}
...
OpenAPI_preemption_control_information_rm_parseFromJSON(
	...
	OpenAPI_preemption_control_information_rm_t *
	        preemption_control_information_rm_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	preemption_control_information_rm_local_var =
		OpenAPI_preemption_control_information_rm_create(
			);
...
OpenAPI_preemption_control_information_rm_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_preemption_control_information_rm_convertToJSON() failed");
		return NULL;
	}
