...
typedef enum { OpenAPI_ims_vo_ps_NULL = 0,
	       OpenAPI_ims_vo_ps_HOMOGENEOUS_SUPPORT,
	       OpenAPI_ims_vo_ps_HOMOGENEOUS_NON_SUPPORT,
	       OpenAPI_ims_vo_ps_NON_HOMOGENEOUS_OR_UNKNOWN }
OpenAPI_ims_vo_ps_e;
