...
OpenAPI_ue_reachability_t *OpenAPI_ue_reachability_create() {
	OpenAPI_ue_reachability_t *ue_reachability_local_var =
		ogs_malloc(sizeof(OpenAPI_ue_reachability_t));
...
cJSON *OpenAPI_ue_reachability_convertToJSON(
	OpenAPI_ue_reachability_t *ue_reachability) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(ue_reachability == NULL) {
		ogs_error(
			"OpenAPI_ue_reachability_convertToJSON() failed [UeReachability]");
		return NULL;
	}
...
OpenAPI_ue_reachability_t *OpenAPI_ue_reachability_parseFromJSON(
	cJSON *ue_reachabilityJSON) {
...
OpenAPI_ue_reachability_t *OpenAPI_ue_reachability_copy(
	OpenAPI_ue_reachability_t *dst, OpenAPI_ue_reachability_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
