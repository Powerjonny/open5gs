...
OpenAPI_association_type_t *OpenAPI_association_type_create() {
	OpenAPI_association_type_t *association_type_local_var =
		ogs_malloc(sizeof(OpenAPI_association_type_t));
...
void OpenAPI_association_type_free(
...
cJSON *OpenAPI_association_type_convertToJSON(
	OpenAPI_association_type_t *association_type) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(association_type == NULL) {
		ogs_error(
			"OpenAPI_association_type_convertToJSON() failed [AssociationType]");
		return NULL;
	}
...
OpenAPI_association_type_t *OpenAPI_association_type_parseFromJSON(
	cJSON *association_typeJSON) {
...
OpenAPI_association_type_t *OpenAPI_association_type_copy(
	OpenAPI_association_type_t *dst, OpenAPI_association_type_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
