...
typedef enum { OpenAPI_lmf_info_AIMLPOSIND_NULL = 0,
	       OpenAPI_lmf_info_AIMLPOSIND__true }
OpenAPI_lmf_info_aiml_pos_ind_e;

char * OpenAPI_lmf_info_aiml_pos_ind_ToString(
	OpenAPI_lmf_info_aiml_pos_ind_e aiml_pos_ind);

OpenAPI_lmf_info_aiml_pos_ind_e OpenAPI_lmf_info_aiml_pos_ind_FromString(
	char *aiml_pos_ind);
