...
OpenAPI_amf_non3_gpp_access_registration_modification_create(
	OpenAPI_guami_t *guami, bool is_purge_flag, int purge_flag, char *pei,
	OpenAPI_ims_vo_ps_e ims_vo_ps, OpenAPI_list_t *backup_amf_info) {
	OpenAPI_amf_non3_gpp_access_registration_modification_t *
	...
	amf_non3_gpp_access_registration_modification_local_var->is_purge_flag =
		is_purge_flag;
	amf_non3_gpp_access_registration_modification_local_var->purge_flag =
		purge_flag;
	amf_non3_gpp_access_registration_modification_local_var->pei = pei;
	amf_non3_gpp_access_registration_modification_local_var->ims_vo_ps =
		ims_vo_ps;
	amf_non3_gpp_access_registration_modification_local_var->backup_amf_info
	        = backup_amf_info;

	return amf_non3_gpp_access_registration_modification_local_var;
}

void OpenAPI_amf_non3_gpp_access_registration_modification_free(
	OpenAPI_amf_non3_gpp_access_registration_modification_t *
	...
	if(amf_non3_gpp_access_registration_modification->guami) {
		OpenAPI_guami_free(
			amf_non3_gpp_access_registration_modification->guami);
	...
	if(amf_non3_gpp_access_registration_modification->backup_amf_info) {
		...
		OpenAPI_list_free(
			amf_non3_gpp_access_registration_modification->
			backup_amf_info);
		amf_non3_gpp_access_registration_modification->backup_amf_info =
			NULL;
	}
...
cJSON *OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON(
	...
	if(amf_non3_gpp_access_registration_modification == NULL) {
		ogs_error(
			"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed [AmfNon3GppAccessRegistrationModification]");
		return NULL;
	}
	...
	if(!amf_non3_gpp_access_registration_modification->guami) {
		ogs_error(
			"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed [guami]");
		return NULL;
	}
	...
	if(amf_non3_gpp_access_registration_modification->is_purge_flag) {
		...
		{
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed [purge_flag]");
			goto end;
		}
	}
	...
	if(amf_non3_gpp_access_registration_modification->pei) {
		...
		{
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed [pei]");
			goto end;
		}
	}
	   ...
	   OpenAPI_ims_vo_ps_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed [ims_vo_ps]");
			goto end;
		}
	}
	...
	if(amf_non3_gpp_access_registration_modification->backup_amf_info) {
		...
		if(backup_amf_infoList == NULL) {
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed [backup_amf_info]");
			goto end;
		}
		OpenAPI_list_for_each(
			amf_non3_gpp_access_registration_modification->
...
OpenAPI_amf_non3_gpp_access_registration_modification_t *
OpenAPI_amf_non3_gpp_access_registration_modification_parseFromJSON(
	cJSON *amf_non3_gpp_access_registration_modificationJSON) {
	OpenAPI_amf_non3_gpp_access_registration_modification_t *
	        amf_non3_gpp_access_registration_modification_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *guami = NULL;
	...
	guami =
		cJSON_GetObjectItemCaseSensitive(
			amf_non3_gpp_access_registration_modificationJSON,
			"guami");
	if(!guami) {
		ogs_error(
			"OpenAPI_amf_non3_gpp_access_registration_modification_parseFromJSON() failed [guami]");
		goto end;
	}
	...
	if(purge_flag) {
		if(!cJSON_IsBool(purge_flag)) {
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_parseFromJSON() failed [purge_flag]");
			goto end;
		}
	}
	...
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_parseFromJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(ims_vo_ps) {
		if(!cJSON_IsString(ims_vo_ps)) {
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_parseFromJSON() failed [ims_vo_ps]");
			goto end;
		}
		ims_vo_psVariable =
	...
	if(backup_amf_info) {
		...
		if(!cJSON_IsArray(backup_amf_info)) {
			ogs_error(
				"OpenAPI_amf_non3_gpp_access_registration_modification_parseFromJSON() failed [backup_amf_info]");
			goto end;
		}
...
OpenAPI_amf_non3_gpp_access_registration_modification_copy(
	OpenAPI_amf_non3_gpp_access_registration_modification_t *dst,
	OpenAPI_amf_non3_gpp_access_registration_modification_t *src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON
		        (src);
	if(!item) {
		ogs_error(
			"OpenAPI_amf_non3_gpp_access_registration_modification_convertToJSON() failed");
		return NULL;
	}
