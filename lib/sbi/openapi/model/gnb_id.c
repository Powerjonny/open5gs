...
OpenAPI_gnb_id_t *OpenAPI_gnb_id_create(int bit_length, char *g_nb_value) {
	OpenAPI_gnb_id_t *gnb_id_local_var =
		ogs_malloc(sizeof(OpenAPI_gnb_id_t));
...
OpenAPI_gnb_id_t *OpenAPI_gnb_id_copy(OpenAPI_gnb_id_t	*dst,
                                      OpenAPI_gnb_id_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
