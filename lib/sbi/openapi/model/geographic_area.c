...
OpenAPI_geographic_area_t *OpenAPI_geographic_area_create(
	...
	OpenAPI_geographic_area_t *geographic_area_local_var =
		ogs_malloc(sizeof(OpenAPI_geographic_area_t));
...
void OpenAPI_geographic_area_free(OpenAPI_geographic_area_t *geographic_area) {
	...
	if(geographic_area->uncertainty_ellipse) {
		OpenAPI_uncertainty_ellipse_free(
...
cJSON *OpenAPI_geographic_area_convertToJSON(
	...
	if(geographic_area == NULL) {
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [GeographicArea]");
		return NULL;
	}
	...
	if(geographic_area->shape == OpenAPI_supported_gad_shapes_NULL) {
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!geographic_area->point) {
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [point]");
		return NULL;
	}
	cJSON *point_local_JSON =
		OpenAPI_geographical_coordinates_convertToJSON(
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [uncertainty]");
		goto end;
	}

	if(!geographic_area->uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	cJSON *uncertainty_ellipse_local_JSON =
		OpenAPI_uncertainty_ellipse_convertToJSON(
			geographic_area->uncertainty_ellipse);
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [confidence]");
		goto end;
	}

	if(!geographic_area->point_list) {
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [point_list]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [altitude]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	if(geographic_area->is_v_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_geographic_area_convertToJSON() failed [v_confidence]");
			goto end;
		}
	}
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [inner_radius]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [uncertainty_radius]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [offset_angle]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographic_area_convertToJSON() failed [included_angle]");
		goto end;
	}
...
OpenAPI_geographic_area_t *OpenAPI_geographic_area_parseFromJSON(
	...
	if(!shape) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
		OpenAPI_geographical_coordinates_parseFromJSON(point);
	if(!point_local_nonprim) {
		ogs_error(
			"OpenAPI_geographical_coordinates_parseFromJSON failed [point]");
		goto end;
	}
	...
	if(!uncertainty) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [uncertainty]");
		goto end;
	}
	...
	uncertainty_ellipse =
		cJSON_GetObjectItemCaseSensitive(geographic_areaJSON,
		                                 "uncertaintyEllipse");
	if(!uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	uncertainty_ellipse_local_nonprim =
		OpenAPI_uncertainty_ellipse_parseFromJSON(uncertainty_ellipse);
	if(!uncertainty_ellipse_local_nonprim) {
		ogs_error(
			"OpenAPI_uncertainty_ellipse_parseFromJSON failed [uncertainty_ellipse]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [confidence]");
		goto end;
	}
	...
	if(!point_list) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [point_list]");
		goto end;
	}
	...
	cJSON_ArrayForEach(point_list_local, point_list) {
		...
		OpenAPI_geographical_coordinates_t *point_listItem =
	...
	if(!altitude) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [altitude]");
		goto end;
	}
	...
	if(!uncertainty_altitude) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [uncertainty_altitude]");
		goto end;
	}
	...
	if(v_confidence) {
		if(!cJSON_IsNumber(v_confidence)) {
			ogs_error(
				"OpenAPI_geographic_area_parseFromJSON() failed [v_confidence]");
			goto end;
		}
	}
	...
	if(!inner_radius) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [inner_radius]");
		goto end;
	}
	...
	if(!uncertainty_radius) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [uncertainty_radius]");
		goto end;
	}
	...
	if(!offset_angle) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [offset_angle]");
		goto end;
	}
	...
	if(!included_angle) {
		ogs_error(
			"OpenAPI_geographic_area_parseFromJSON() failed [included_angle]");
		goto end;
	}
