...
OpenAPI_plmn_id_nid_1_t *OpenAPI_plmn_id_nid_1_create(char *mcc, char *mnc,
                                                      char *nid) {
	OpenAPI_plmn_id_nid_1_t *plmn_id_nid_1_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_id_nid_1_t));
...
cJSON *OpenAPI_plmn_id_nid_1_convertToJSON(
	OpenAPI_plmn_id_nid_1_t *plmn_id_nid_1) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(plmn_id_nid_1 == NULL) {
		ogs_error(
			"OpenAPI_plmn_id_nid_1_convertToJSON() failed [PlmnIdNid_1]");
		return NULL;
	}
	...
	if(plmn_id_nid_1->nid) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_id_nid_1_convertToJSON() failed [nid]");
			goto end;
		}
	}
...
OpenAPI_plmn_id_nid_1_t *OpenAPI_plmn_id_nid_1_parseFromJSON(
	cJSON *plmn_id_nid_1JSON) {
	...
	if(nid) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_id_nid_1_parseFromJSON() failed [nid]");
			goto end;
		}
	}
...
OpenAPI_plmn_id_nid_1_t *OpenAPI_plmn_id_nid_1_copy(
	OpenAPI_plmn_id_nid_1_t *dst, OpenAPI_plmn_id_nid_1_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
