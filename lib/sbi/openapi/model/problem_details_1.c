...
OpenAPI_problem_details_1_t *OpenAPI_problem_details_1_create(char	*type,
                                                              char	*title,
                                                              bool
                                                              is_status,
                                                              int	status,
                                                              ...
                                                              *
                                                              ...
                                                              char *nrf_id) {
	OpenAPI_problem_details_1_t *problem_details_1_local_var =
		ogs_malloc(sizeof(OpenAPI_problem_details_1_t));
	...
	problem_details_1_local_var->access_token_request =
		access_token_request;
...
void OpenAPI_problem_details_1_free(
	OpenAPI_problem_details_1_t *problem_details_1) {
	...
	if(problem_details_1->access_token_request) {
		OpenAPI_access_token_req_free(
			problem_details_1->access_token_request);
...
cJSON *OpenAPI_problem_details_1_convertToJSON(
	OpenAPI_problem_details_1_t *problem_details_1) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(problem_details_1 == NULL) {
		ogs_error(
			"OpenAPI_problem_details_1_convertToJSON() failed [ProblemDetails_1]");
		return NULL;
	}
	...
	if(problem_details_1->type) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [type]");
			goto end;
		}
	}
	...
	if(problem_details_1->title) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [title]");
			goto end;
		}
	}
	...
	if(problem_details_1->is_status) {
		if(cJSON_AddNumberToObject(item, "status",
		                           problem_details_1->status) == NULL)
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [status]");
			goto end;
		}
	}
	...
	if(problem_details_1->detail) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [detail]");
			goto end;
		}
	}
	...
	if(problem_details_1->instance) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [instance]");
			goto end;
		}
	}
	...
	if(problem_details_1->cause) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(problem_details_1->invalid_params) {
		...
		if(invalid_paramsList == NULL) {
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [invalid_params]");
			goto end;
		}
		OpenAPI_list_for_each(problem_details_1->invalid_params, node) {
			cJSON *itemLocal =
	...
	if(problem_details_1->supported_features) {
		if(cJSON_AddStringToObject(item, "supportedFeatures",
		                           problem_details_1->supported_features)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(problem_details_1->access_token_error) {
		...
		if(access_token_error_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [access_token_error]");
			goto end;
		}
	...
	if(problem_details_1->access_token_request) {
		...
		if(access_token_request_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [access_token_request]");
			goto end;
		}
	...
	if(problem_details_1->nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_convertToJSON() failed [nrf_id]");
			goto end;
		}
	}
...
OpenAPI_problem_details_1_t *OpenAPI_problem_details_1_parseFromJSON(
	cJSON *problem_details_1JSON) {
	...
	if(type) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [type]");
			goto end;
		}
	}

	title = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                         "title");
	if(title) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [title]");
			goto end;
		}
	}

	status = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                          "status");
	if(status) {
		if(!cJSON_IsNumber(status)) {
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [status]");
			goto end;
		}
	}

	detail = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                          "detail");
	if(detail) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [detail]");
			goto end;
		}
	}

	instance = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                            "instance");
	if(instance) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [instance]");
			goto end;
		}
	}

	cause = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                         "cause");
	if(cause) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [cause]");
			goto end;
		}
	}

	invalid_params = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                                  "invalidParams");
	if(invalid_params) {
		cJSON *invalid_params_local = NULL;
		if(!cJSON_IsArray(invalid_params)) {
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [invalid_params]");
			goto end;
		}
	...
	supported_features =
		cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
		                                 "supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	nrf_id = cJSON_GetObjectItemCaseSensitive(problem_details_1JSON,
	                                          "nrfId");
	if(nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_1_parseFromJSON() failed [nrf_id]");
			goto end;
		}
	}
...
OpenAPI_problem_details_1_t *OpenAPI_problem_details_1_copy(
	OpenAPI_problem_details_1_t *dst, OpenAPI_problem_details_1_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
