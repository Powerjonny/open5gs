...
OpenAPI_point_altitude_t *OpenAPI_point_altitude_create(
	...
	OpenAPI_point_altitude_t *point_altitude_local_var =
		ogs_malloc(sizeof(OpenAPI_point_altitude_t));
...
cJSON *OpenAPI_point_altitude_convertToJSON(
	...
	if(point_altitude == NULL) {
		ogs_error(
			"OpenAPI_point_altitude_convertToJSON() failed [PointAltitude]");
		return NULL;
	}
	...
	if(point_altitude->shape == OpenAPI_supported_gad_shapes_NULL) {
		ogs_error(
			"OpenAPI_point_altitude_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!point_altitude->point) {
		ogs_error(
			"OpenAPI_point_altitude_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_altitude_convertToJSON() failed [altitude]");
		goto end;
	}
...
OpenAPI_point_altitude_t *OpenAPI_point_altitude_parseFromJSON(
	...
	if(!shape) {
		ogs_error(
			"OpenAPI_point_altitude_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_altitude_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	if(!altitude) {
		ogs_error(
			"OpenAPI_point_altitude_parseFromJSON() failed [altitude]");
		goto end;
	}
