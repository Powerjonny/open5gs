...
OpenAPI_ellipsoid_arc_all_of_t *OpenAPI_ellipsoid_arc_all_of_create(
	...
	int confidence) {
	OpenAPI_ellipsoid_arc_all_of_t *ellipsoid_arc_all_of_local_var =
		ogs_malloc(sizeof(OpenAPI_ellipsoid_arc_all_of_t));
...
void OpenAPI_ellipsoid_arc_all_of_free(
	OpenAPI_ellipsoid_arc_all_of_t *ellipsoid_arc_all_of) {
...
cJSON *OpenAPI_ellipsoid_arc_all_of_convertToJSON(
	OpenAPI_ellipsoid_arc_all_of_t *ellipsoid_arc_all_of) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ellipsoid_arc_all_of == NULL) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [EllipsoidArc_allOf]");
		return NULL;
	}
	...
	if(!ellipsoid_arc_all_of->point) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [inner_radius]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [uncertainty_radius]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [offset_angle]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [included_angle]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_ellipsoid_arc_all_of_t *OpenAPI_ellipsoid_arc_all_of_parseFromJSON(
	...
	if(!point) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	inner_radius =
		cJSON_GetObjectItemCaseSensitive(ellipsoid_arc_all_ofJSON,
		                                 "innerRadius");
	if(!inner_radius) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_parseFromJSON() failed [inner_radius]");
		goto end;
	}
	...
	if(!uncertainty_radius) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_parseFromJSON() failed [uncertainty_radius]");
		goto end;
	}
	...
	if(!offset_angle) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_parseFromJSON() failed [offset_angle]");
		goto end;
	}
	...
	if(!included_angle) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_parseFromJSON() failed [included_angle]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_parseFromJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_ellipsoid_arc_all_of_t *OpenAPI_ellipsoid_arc_all_of_copy(
	OpenAPI_ellipsoid_arc_all_of_t	*dst,
	OpenAPI_ellipsoid_arc_all_of_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_all_of_convertToJSON() failed");
		return NULL;
	}
