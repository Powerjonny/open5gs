...
OpenAPI_acs_info_t *OpenAPI_acs_info_create(char *acs_url, char *acs_ipv4_addr,
                                            char *acs_ipv6_addr) {
	OpenAPI_acs_info_t *acs_info_local_var =
		ogs_malloc(sizeof(OpenAPI_acs_info_t));
...
cJSON *OpenAPI_acs_info_convertToJSON(OpenAPI_acs_info_t *acs_info) {
	...
	if(acs_info->acs_url) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_convertToJSON() failed [acs_url]");
			goto end;
		}
	}
	...
	if(acs_info->acs_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_convertToJSON() failed [acs_ipv4_addr]");
			goto end;
		}
	}
	...
	if(acs_info->acs_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_convertToJSON() failed [acs_ipv6_addr]");
			goto end;
		}
	}
...
OpenAPI_acs_info_t *OpenAPI_acs_info_parseFromJSON(cJSON *acs_infoJSON) {
	...
	if(acs_url) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_parseFromJSON() failed [acs_url]");
			goto end;
		}
	}

	acs_ipv4_addr = cJSON_GetObjectItemCaseSensitive(acs_infoJSON,
	                                                 "acsIpv4Addr");
	if(acs_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_parseFromJSON() failed [acs_ipv4_addr]");
			goto end;
		}
	}

	acs_ipv6_addr = cJSON_GetObjectItemCaseSensitive(acs_infoJSON,
	                                                 "acsIpv6Addr");
	if(acs_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_parseFromJSON() failed [acs_ipv6_addr]");
			goto end;
		}
	}
...
OpenAPI_acs_info_t *OpenAPI_acs_info_copy(OpenAPI_acs_info_t	*dst,
                                          OpenAPI_acs_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
