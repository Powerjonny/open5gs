...
OpenAPI_polygon_all_of_t *OpenAPI_polygon_all_of_create(
	...
	OpenAPI_polygon_all_of_t *polygon_all_of_local_var =
		ogs_malloc(sizeof(OpenAPI_polygon_all_of_t));
...
cJSON *OpenAPI_polygon_all_of_convertToJSON(
	OpenAPI_polygon_all_of_t *polygon_all_of) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(polygon_all_of == NULL) {
		ogs_error(
			"OpenAPI_polygon_all_of_convertToJSON() failed [Polygon_allOf]");
		return NULL;
	}
	...
	if(!polygon_all_of->point_list) {
		ogs_error(
			"OpenAPI_polygon_all_of_convertToJSON() failed [point_list]");
		return NULL;
	}
...
OpenAPI_polygon_all_of_t *OpenAPI_polygon_all_of_parseFromJSON(
	cJSON *polygon_all_ofJSON) {
	...
	if(!point_list) {
		ogs_error(
			"OpenAPI_polygon_all_of_parseFromJSON() failed [point_list]");
		goto end;
	}
...
OpenAPI_polygon_all_of_t *OpenAPI_polygon_all_of_copy(
	OpenAPI_polygon_all_of_t *dst, OpenAPI_polygon_all_of_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
