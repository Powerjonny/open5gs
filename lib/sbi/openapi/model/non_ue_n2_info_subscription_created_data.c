...
OpenAPI_non_ue_n2_info_subscription_created_data_create(
	char *n2_notify_subscription_id, char *supported_features,
...
cJSON *OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON(
	OpenAPI_non_ue_n2_info_subscription_created_data_t *
	non_ue_n2_info_subscription_created_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(non_ue_n2_info_subscription_created_data == NULL) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON() failed [NonUeN2InfoSubscriptionCreatedData]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON() failed [n2_notify_subscription_id]");
		return NULL;
	}
	...
	if(non_ue_n2_info_subscription_created_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	   ...
	   OpenAPI_n2_information_class_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON() failed [n2_information_class]");
			goto end;
		}
	}
...
OpenAPI_non_ue_n2_info_subscription_created_data_parseFromJSON(
	...
	if(!n2_notify_subscription_id) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_created_data_parseFromJSON() failed [n2_notify_subscription_id]");
		goto end;
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_created_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(n2_information_class) {
		if(!cJSON_IsString(n2_information_class)) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_created_data_parseFromJSON() failed [n2_information_class]");
			goto end;
		}
...
OpenAPI_non_ue_n2_info_subscription_created_data_copy(
	OpenAPI_non_ue_n2_info_subscription_created_data_t	*dst,
	OpenAPI_non_ue_n2_info_subscription_created_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON(
			src);
	if(!item) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_created_data_convertToJSON() failed");
		return NULL;
	}
