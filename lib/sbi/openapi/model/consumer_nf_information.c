...
OpenAPI_consumer_nf_information_t *OpenAPI_consumer_nf_information_create(
	char *nf_id, char *nf_set_id, OpenAPI_list_t *tai_list) {
	OpenAPI_consumer_nf_information_t *consumer_nf_information_local_var =
		ogs_malloc(sizeof(OpenAPI_consumer_nf_information_t));
...
void OpenAPI_consumer_nf_information_free(
...
cJSON *OpenAPI_consumer_nf_information_convertToJSON(
	OpenAPI_consumer_nf_information_t *consumer_nf_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(consumer_nf_information == NULL) {
		ogs_error(
			"OpenAPI_consumer_nf_information_convertToJSON() failed [ConsumerNfInformation]");
		return NULL;
	}
	...
	if(consumer_nf_information->nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_consumer_nf_information_convertToJSON() failed [nf_id]");
			goto end;
		}
	}
	...
	if(consumer_nf_information->nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_consumer_nf_information_convertToJSON() failed [nf_set_id]");
			goto end;
		}
	}
	...
	if(consumer_nf_information->tai_list) {
		...
		if(tai_listList == NULL) {
			ogs_error(
				"OpenAPI_consumer_nf_information_convertToJSON() failed [tai_list]");
			goto end;
		}
		OpenAPI_list_for_each(consumer_nf_information->tai_list, node) {
			cJSON *itemLocal =
...
OpenAPI_consumer_nf_information_t *OpenAPI_consumer_nf_information_parseFromJSON
	...
	if(nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_consumer_nf_information_parseFromJSON() failed [nf_id]");
			goto end;
		}
	}

	nf_set_id =
		cJSON_GetObjectItemCaseSensitive(consumer_nf_informationJSON,
		                                 "nfSetId");
	if(nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_consumer_nf_information_parseFromJSON() failed [nf_set_id]");
			goto end;
		}
	}
	...
	if(tai_list) {
		...
		if(!cJSON_IsArray(tai_list)) {
			ogs_error(
				"OpenAPI_consumer_nf_information_parseFromJSON() failed [tai_list]");
			goto end;
		}
	...
	consumer_nf_information_local_var =
...
OpenAPI_consumer_nf_information_t *OpenAPI_consumer_nf_information_copy(
	OpenAPI_consumer_nf_information_t	*dst,
	OpenAPI_consumer_nf_information_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_consumer_nf_information_convertToJSON() failed");
		return NULL;
	}
