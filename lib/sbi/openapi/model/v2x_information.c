...
OpenAPI_v2x_information_t *OpenAPI_v2x_information_create(
	...
	OpenAPI_v2x_information_t *v2x_information_local_var =
		ogs_malloc(sizeof(OpenAPI_v2x_information_t));
...
cJSON *OpenAPI_v2x_information_convertToJSON(
	OpenAPI_v2x_information_t *v2x_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(v2x_information == NULL) {
		ogs_error(
			"OpenAPI_v2x_information_convertToJSON() failed [V2xInformation]");
		return NULL;
	}
	...
	if(v2x_information->n2_pc5_pol) {
		...
		if(n2_pc5_pol_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_v2x_information_convertToJSON() failed [n2_pc5_pol]");
			goto end;
		}
...
OpenAPI_v2x_information_t *OpenAPI_v2x_information_parseFromJSON(
...
OpenAPI_v2x_information_t *OpenAPI_v2x_information_copy(
	OpenAPI_v2x_information_t *dst, OpenAPI_v2x_information_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
