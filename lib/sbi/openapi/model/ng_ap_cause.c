...
OpenAPI_ng_ap_cause_t *OpenAPI_ng_ap_cause_create(int group, int value) {
	OpenAPI_ng_ap_cause_t *ng_ap_cause_local_var =
		ogs_malloc(sizeof(OpenAPI_ng_ap_cause_t));
...
cJSON *OpenAPI_ng_ap_cause_convertToJSON(OpenAPI_ng_ap_cause_t *ng_ap_cause) {
	...
	if(ng_ap_cause == NULL) {
		ogs_error(
			"OpenAPI_ng_ap_cause_convertToJSON() failed [NgApCause]");
		return NULL;
	}
...
OpenAPI_ng_ap_cause_t *OpenAPI_ng_ap_cause_parseFromJSON(
	cJSON *ng_ap_causeJSON) {
...
OpenAPI_ng_ap_cause_t *OpenAPI_ng_ap_cause_copy(OpenAPI_ng_ap_cause_t	*dst,
                                                OpenAPI_ng_ap_cause_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
