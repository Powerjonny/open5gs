...
char * OpenAPI_aerial_ue_indication_ToString(
	...
	const char *aerial_ue_indicationArray[] = { "NULL", "AERIAL_UE_ALLOWED",
		                                    "AERIAL_UE_NOT_ALLOWED" };
	size_t sizeofArray = sizeof(aerial_ue_indicationArray) /
	                     sizeof(aerial_ue_indicationArray[0]);
...
OpenAPI_aerial_ue_indication_e OpenAPI_aerial_ue_indication_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(aerial_ue_indication,
		          aerial_ue_indicationArray[stringToReturn]) == 0) {
