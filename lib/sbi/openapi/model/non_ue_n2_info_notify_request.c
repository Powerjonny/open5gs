...
OpenAPI_non_ue_n2_info_notify_request_create(
	...
	non_ue_n2_info_notify_request_local_var->binary_data_n2_information =
	...
	OpenAPI_non_ue_n2_info_notify_request_t *non_ue_n2_info_notify_request)
{
	...
	if(non_ue_n2_info_notify_request->binary_data_n2_information) {
		...
		non_ue_n2_info_notify_request->binary_data_n2_information =
			NULL;
	}
	...
	OpenAPI_non_ue_n2_info_notify_request_t *non_ue_n2_info_notify_request)
{
	...
	if(non_ue_n2_info_notify_request == NULL) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_notify_request_convertToJSON() failed [NonUeN2InfoNotify_request]");
		return NULL;
	}
	...
	if(non_ue_n2_info_notify_request->json_data) {
		...
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_notify_request_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(non_ue_n2_info_notify_request->binary_data_n2_information) {
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_notify_request_convertToJSON() failed [binary_data_n2_information]");
			goto end;
		}
...
OpenAPI_non_ue_n2_info_notify_request_parseFromJSON(
	...
	OpenAPI_non_ue_n2_info_notify_request_t *
	        non_ue_n2_info_notify_request_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	binary_data_n2_information =
		cJSON_GetObjectItemCaseSensitive(
			non_ue_n2_info_notify_requestJSON,
	...
	if(binary_data_n2_information) {
		...
		if(!cJSON_IsString(binary_data_n2_information)) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_notify_request_parseFromJSON() failed [binary_data_n2_information]");
			goto end;
		}
...
OpenAPI_non_ue_n2_info_notify_request_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_notify_request_convertToJSON() failed");
		return NULL;
	}
