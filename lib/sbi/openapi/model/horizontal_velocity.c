...
OpenAPI_horizontal_velocity_t *OpenAPI_horizontal_velocity_create(float h_speed,
                                                                  int	bearing)
{
	OpenAPI_horizontal_velocity_t *horizontal_velocity_local_var =
		ogs_malloc(sizeof(OpenAPI_horizontal_velocity_t));
...
void OpenAPI_horizontal_velocity_free(
	OpenAPI_horizontal_velocity_t *horizontal_velocity) {
...
cJSON *OpenAPI_horizontal_velocity_convertToJSON(
	OpenAPI_horizontal_velocity_t *horizontal_velocity) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(horizontal_velocity == NULL) {
		ogs_error(
			"OpenAPI_horizontal_velocity_convertToJSON() failed [HorizontalVelocity]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_velocity_convertToJSON() failed [h_speed]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_velocity_convertToJSON() failed [bearing]");
		goto end;
	}
...
OpenAPI_horizontal_velocity_t *OpenAPI_horizontal_velocity_parseFromJSON(
	...
	if(!h_speed) {
		ogs_error(
			"OpenAPI_horizontal_velocity_parseFromJSON() failed [h_speed]");
		goto end;
	}
	...
	if(!bearing) {
		ogs_error(
			"OpenAPI_horizontal_velocity_parseFromJSON() failed [bearing]");
		goto end;
	}
...
OpenAPI_horizontal_velocity_t *OpenAPI_horizontal_velocity_copy(
	OpenAPI_horizontal_velocity_t	*dst,
	OpenAPI_horizontal_velocity_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
