...
typedef enum { OpenAPI_external_client_type_NULL = 0,
	       OpenAPI_external_client_type_EMERGENCY_SERVICES,
	       OpenAPI_external_client_type_VALUE_ADDED_SERVICES,
	       OpenAPI_external_client_type_PLMN_OPERATOR_SERVICES,
	       ...
	       OpenAPI_external_client_type_SL_POS }
OpenAPI_external_client_type_e;

char * OpenAPI_external_client_type_ToString(
	OpenAPI_external_client_type_e external_client_type);

OpenAPI_external_client_type_e OpenAPI_external_client_type_FromString(
