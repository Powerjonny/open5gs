...
OpenAPI_nsi_load_level_info_t *OpenAPI_nsi_load_level_info_create(
	int load_level_information, OpenAPI_snssai_t *snssai, char *nsi_id,
	OpenAPI_resource_usage_t *res_usage,
	bool is_num_of_exceed_load_level_thr, int num_of_exceed_load_level_thr,
	bool is_exceed_load_level_thr_ind, int exceed_load_level_thr_ind,
	...
	OpenAPI_number_average_t *num_of_pdu_sess, bool is_confidence,
	int confidence) {
	OpenAPI_nsi_load_level_info_t *nsi_load_level_info_local_var =
		ogs_malloc(sizeof(OpenAPI_nsi_load_level_info_t));
...
void OpenAPI_nsi_load_level_info_free(
	OpenAPI_nsi_load_level_info_t *nsi_load_level_info) {
...
cJSON *OpenAPI_nsi_load_level_info_convertToJSON(
	OpenAPI_nsi_load_level_info_t *nsi_load_level_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nsi_load_level_info == NULL) {
		ogs_error(
			"OpenAPI_nsi_load_level_info_convertToJSON() failed [NsiLoadLevelInfo]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_nsi_load_level_info_convertToJSON() failed [load_level_information]");
		goto end;
	}

	if(!nsi_load_level_info->snssai) {
		ogs_error(
			"OpenAPI_nsi_load_level_info_convertToJSON() failed [snssai]");
		return NULL;
	}
	cJSON *snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(nsi_load_level_info->snssai);
	...
	if(nsi_load_level_info->nsi_id) {
		...
		{
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [nsi_id]");
			goto end;
		}
	}

	if(nsi_load_level_info->res_usage) {
		cJSON *res_usage_local_JSON =
			OpenAPI_resource_usage_convertToJSON(
				nsi_load_level_info->res_usage);
		if(res_usage_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [res_usage]");
			goto end;
		}
	...
	if(nsi_load_level_info->is_num_of_exceed_load_level_thr) {
		...
		{
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [num_of_exceed_load_level_thr]");
			goto end;
		}
	}
	...
	if(nsi_load_level_info->is_exceed_load_level_thr_ind) {
		...
		{
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [exceed_load_level_thr_ind]");
			goto end;
		}
	}
	...
	if(nsi_load_level_info->network_area) {
		...
		if(network_area_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [network_area]");
			goto end;
		}
	...
	if(nsi_load_level_info->time_period) {
		cJSON *time_period_local_JSON =
			OpenAPI_time_window_convertToJSON(
				nsi_load_level_info->time_period);
		if(time_period_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [time_period]");
			goto end;
		}
	...
	if(nsi_load_level_info->res_usg_thr_cross_time_period) {
		...
		if(res_usg_thr_cross_time_periodList == NULL) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [res_usg_thr_cross_time_period]");
			goto end;
		}
		OpenAPI_list_for_each(
			nsi_load_level_info->res_usg_thr_cross_time_period,
			node) {
			cJSON *itemLocal =
				OpenAPI_time_window_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nsi_load_level_info_convertToJSON() failed [res_usg_thr_cross_time_period]");
				goto end;
	...
	if(nsi_load_level_info->num_of_ues) {
		cJSON *num_of_ues_local_JSON =
			OpenAPI_number_average_convertToJSON(
				nsi_load_level_info->num_of_ues);
		if(num_of_ues_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [num_of_ues]");
			goto end;
		}
	...
	if(nsi_load_level_info->num_of_pdu_sess) {
		...
		if(num_of_pdu_sess_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [num_of_pdu_sess]");
			goto end;
		}
	...
	if(nsi_load_level_info->is_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_nsi_load_level_info_convertToJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_nsi_load_level_info_t *OpenAPI_nsi_load_level_info_parseFromJSON(
	...
	load_level_information =
		cJSON_GetObjectItemCaseSensitive(nsi_load_level_infoJSON,
		                                 "loadLevelInformation");
	if(!load_level_information) {
		ogs_error(
			"OpenAPI_nsi_load_level_info_parseFromJSON() failed [load_level_information]");
		goto end;
	}
	...
	if(!snssai) {
		ogs_error(
			"OpenAPI_nsi_load_level_info_parseFromJSON() failed [snssai]");
		goto end;
	}
	...
	if(nsi_id) {
		...
		{
			ogs_error(
				"OpenAPI_nsi_load_level_info_parseFromJSON() failed [nsi_id]");
			goto end;
		}
	}
	...
	if(res_usage) {
		res_usage_local_nonprim =
			OpenAPI_resource_usage_parseFromJSON(res_usage);
		if(!res_usage_local_nonprim) {
			ogs_error(
				"OpenAPI_resource_usage_parseFromJSON failed [res_usage]");
			goto end;
		}
	}
	...
	if(num_of_exceed_load_level_thr) {
		if(!cJSON_IsNumber(num_of_exceed_load_level_thr)) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_parseFromJSON() failed [num_of_exceed_load_level_thr]");
			goto end;
		}
	}
	...
	if(exceed_load_level_thr_ind) {
		if(!cJSON_IsBool(exceed_load_level_thr_ind)) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_parseFromJSON() failed [exceed_load_level_thr_ind]");
			goto end;
		}
	}
	...
	time_period = cJSON_GetObjectItemCaseSensitive(nsi_load_level_infoJSON,
	                                               "timePeriod");
	if(time_period) {
		time_period_local_nonprim =
			OpenAPI_time_window_parseFromJSON(time_period);
		if(!time_period_local_nonprim) {
			ogs_error(
				"OpenAPI_time_window_parseFromJSON failed [time_period]");
			goto end;
		}
	}
	...
	if(res_usg_thr_cross_time_period) {
		...
		if(!cJSON_IsArray(res_usg_thr_cross_time_period)) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_parseFromJSON() failed [res_usg_thr_cross_time_period]");
			goto end;
		}
		...
		cJSON_ArrayForEach(res_usg_thr_cross_time_period_local,
			...
			OpenAPI_time_window_t *res_usg_thr_cross_time_periodItem
			        = OpenAPI_time_window_parseFromJSON(
					  res_usg_thr_cross_time_period_local);
			if(!res_usg_thr_cross_time_periodItem) {
				ogs_error(
					"No res_usg_thr_cross_time_periodItem");
				goto end;
			}
			OpenAPI_list_add(res_usg_thr_cross_time_periodList,
	...
	if(num_of_ues) {
		num_of_ues_local_nonprim =
			OpenAPI_number_average_parseFromJSON(num_of_ues);
		if(!num_of_ues_local_nonprim) {
			ogs_error(
				"OpenAPI_number_average_parseFromJSON failed [num_of_ues]");
			goto end;
		}
	}
	...
	num_of_pdu_sess =
		cJSON_GetObjectItemCaseSensitive(nsi_load_level_infoJSON,
		                                 "numOfPduSess");
	if(num_of_pdu_sess) {
		num_of_pdu_sess_local_nonprim =
			OpenAPI_number_average_parseFromJSON(num_of_pdu_sess);
		if(!num_of_pdu_sess_local_nonprim) {
			ogs_error(
				"OpenAPI_number_average_parseFromJSON failed [num_of_pdu_sess]");
			goto end;
		}
	}
	...
	if(confidence) {
		if(!cJSON_IsNumber(confidence)) {
			ogs_error(
				"OpenAPI_nsi_load_level_info_parseFromJSON() failed [confidence]");
			goto end;
		}
	}
	...
	nsi_load_level_info_local_var = OpenAPI_nsi_load_level_info_create(
		...
		nsi_id &&
		!cJSON_IsNull(nsi_id) ? ogs_strdup(nsi_id->valuestring) : NULL,
		res_usage ? res_usage_local_nonprim : NULL,
		num_of_exceed_load_level_thr ? true : false,
		num_of_exceed_load_level_thr ?
		num_of_exceed_load_level_thr->valuedouble : 0,
		exceed_load_level_thr_ind ? true : false,
		exceed_load_level_thr_ind ?
		exceed_load_level_thr_ind->valueint : 0,
...
OpenAPI_nsi_load_level_info_t *OpenAPI_nsi_load_level_info_copy(
	OpenAPI_nsi_load_level_info_t	*dst,
	OpenAPI_nsi_load_level_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
