...
OpenAPI_dispersion_type_t *OpenAPI_dispersion_type_create() {
	OpenAPI_dispersion_type_t *dispersion_type_local_var =
		ogs_malloc(sizeof(OpenAPI_dispersion_type_t));
...
cJSON *OpenAPI_dispersion_type_convertToJSON(
	OpenAPI_dispersion_type_t *dispersion_type) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(dispersion_type == NULL) {
		ogs_error(
			"OpenAPI_dispersion_type_convertToJSON() failed [DispersionType]");
		return NULL;
	}
...
OpenAPI_dispersion_type_t *OpenAPI_dispersion_type_parseFromJSON(
	cJSON *dispersion_typeJSON) {
...
OpenAPI_dispersion_type_t *OpenAPI_dispersion_type_copy(
	OpenAPI_dispersion_type_t *dst, OpenAPI_dispersion_type_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
