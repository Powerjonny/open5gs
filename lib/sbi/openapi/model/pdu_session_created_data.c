...
OpenAPI_pdu_session_created_data_t *OpenAPI_pdu_session_created_data_create(
	OpenAPI_pdu_session_type_e pdu_session_type, char *ssc_mode,
	OpenAPI_tunnel_info_t *hcn_tunnel_info,
	OpenAPI_tunnel_info_t *cn_tunnel_info,
	OpenAPI_tunnel_info_t *additional_cn_tunnel_info,
	OpenAPI_ambr_t *session_ambr, OpenAPI_list_t *qos_flows_setup_list,
	char *h_smf_instance_id, char *smf_instance_id, bool is_pdu_session_id,
	int pdu_session_id, OpenAPI_snssai_t *s_nssai,
	bool is_enable_pause_charging, int enable_pause_charging,
	char *ue_ipv4_address, char *ue_ipv6_prefix,
	OpenAPI_ref_to_binary_data_t *n1_sm_info_to_ue,
	OpenAPI_eps_pdn_cnx_info_t *eps_pdn_cnx_info,
	OpenAPI_list_t *eps_bearer_info, char *supported_features,
	OpenAPI_max_integrity_protected_data_rate_e
	max_integrity_protected_data_rate,
	OpenAPI_max_integrity_protected_data_rate_e
	max_integrity_protected_data_rate_dl, bool is_always_on_granted,
	int always_on_granted, char *gpsi, OpenAPI_up_security_t *up_security,
	OpenAPI_roaming_charging_profile_t *roaming_charging_profile,
	char *h_smf_service_instance_id, char *smf_service_instance_id,
	char *recovery_time, OpenAPI_list_t *dnai_list,
	bool is_ipv6_multi_homing_ind, int ipv6_multi_homing_ind,
	bool is_ma_accepted_ind, int ma_accepted_ind,
	char *home_provided_charging_id, bool is_nef_ext_buf_support_ind,
	int nef_ext_buf_support_ind, bool is_small_data_rate_control_enabled,
	int small_data_rate_control_enabled, char *ue_ipv6_interface_id,
	bool is_ipv6_index, int ipv6_index,
	OpenAPI_ip_address_t *dn_aaa_address,
	OpenAPI_redundant_pdu_session_information_t *redundant_pdu_session_info,
	bool is_nspu_support_ind, int nspu_support_ind,
	char *inter_plmn_api_root, char *intra_plmn_api_root) {
	OpenAPI_pdu_session_created_data_t *pdu_session_created_data_local_var =
		ogs_malloc(sizeof(OpenAPI_pdu_session_created_data_t));
	...
	pdu_session_created_data_local_var->additional_cn_tunnel_info =
		additional_cn_tunnel_info;
	pdu_session_created_data_local_var->session_ambr = session_ambr;
	pdu_session_created_data_local_var->qos_flows_setup_list =
		qos_flows_setup_list;
	pdu_session_created_data_local_var->h_smf_instance_id =
		h_smf_instance_id;
	pdu_session_created_data_local_var->smf_instance_id = smf_instance_id;
	pdu_session_created_data_local_var->is_pdu_session_id =
		is_pdu_session_id;
	pdu_session_created_data_local_var->pdu_session_id = pdu_session_id;
	pdu_session_created_data_local_var->s_nssai = s_nssai;
	pdu_session_created_data_local_var->is_enable_pause_charging =
		is_enable_pause_charging;
	pdu_session_created_data_local_var->enable_pause_charging =
	...
	pdu_session_created_data_local_var->supported_features =
		supported_features;
	pdu_session_created_data_local_var->max_integrity_protected_data_rate =
		max_integrity_protected_data_rate;
	pdu_session_created_data_local_var->max_integrity_protected_data_rate_dl
	        = max_integrity_protected_data_rate_dl;
	pdu_session_created_data_local_var->is_always_on_granted =
		is_always_on_granted;
	pdu_session_created_data_local_var->always_on_granted =
		always_on_granted;
	pdu_session_created_data_local_var->gpsi = gpsi;
	pdu_session_created_data_local_var->up_security = up_security;
	pdu_session_created_data_local_var->roaming_charging_profile =
		roaming_charging_profile;
	pdu_session_created_data_local_var->h_smf_service_instance_id =
		h_smf_service_instance_id;
	pdu_session_created_data_local_var->smf_service_instance_id =
	...
	pdu_session_created_data_local_var->is_ipv6_multi_homing_ind =
		is_ipv6_multi_homing_ind;
	pdu_session_created_data_local_var->ipv6_multi_homing_ind =
		ipv6_multi_homing_ind;
	pdu_session_created_data_local_var->is_ma_accepted_ind =
		is_ma_accepted_ind;
	pdu_session_created_data_local_var->ma_accepted_ind = ma_accepted_ind;
	pdu_session_created_data_local_var->home_provided_charging_id =
		home_provided_charging_id;
	pdu_session_created_data_local_var->is_nef_ext_buf_support_ind =
		is_nef_ext_buf_support_ind;
	pdu_session_created_data_local_var->nef_ext_buf_support_ind =
		nef_ext_buf_support_ind;
	pdu_session_created_data_local_var->is_small_data_rate_control_enabled =
		is_small_data_rate_control_enabled;
	pdu_session_created_data_local_var->small_data_rate_control_enabled =
		small_data_rate_control_enabled;
	pdu_session_created_data_local_var->ue_ipv6_interface_id =
		ue_ipv6_interface_id;
	...
	pdu_session_created_data_local_var->redundant_pdu_session_info =
		redundant_pdu_session_info;
	pdu_session_created_data_local_var->is_nspu_support_ind =
		is_nspu_support_ind;
	pdu_session_created_data_local_var->nspu_support_ind = nspu_support_ind;
	pdu_session_created_data_local_var->inter_plmn_api_root =
		inter_plmn_api_root;
	pdu_session_created_data_local_var->intra_plmn_api_root =
		intra_plmn_api_root;

	return pdu_session_created_data_local_var;
}

void OpenAPI_pdu_session_created_data_free(
	OpenAPI_pdu_session_created_data_t *pdu_session_created_data) {
	...
	if(pdu_session_created_data->qos_flows_setup_list) {
		OpenAPI_list_for_each(
			pdu_session_created_data->qos_flows_setup_list, node) {
			OpenAPI_qos_flow_setup_item_free(node->data);
		}
		OpenAPI_list_free(
			pdu_session_created_data->qos_flows_setup_list);
	...
	if(pdu_session_created_data->roaming_charging_profile) {
		OpenAPI_roaming_charging_profile_free(
			pdu_session_created_data->roaming_charging_profile);
	...
	if(pdu_session_created_data->dnai_list) {
		OpenAPI_list_for_each(pdu_session_created_data->dnai_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(pdu_session_created_data->dn_aaa_address) {
		OpenAPI_ip_address_free(
			pdu_session_created_data->dn_aaa_address);
...
cJSON *OpenAPI_pdu_session_created_data_convertToJSON(
	OpenAPI_pdu_session_created_data_t *pdu_session_created_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pdu_session_created_data == NULL) {
		ogs_error(
			"OpenAPI_pdu_session_created_data_convertToJSON() failed [PduSessionCreatedData]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_pdu_session_created_data_convertToJSON() failed [pdu_session_type]");
		return NULL;
	}
	...
	if(!pdu_session_created_data->ssc_mode) {
		ogs_error(
			"OpenAPI_pdu_session_created_data_convertToJSON() failed [ssc_mode]");
		return NULL;
	}
	...
	if(pdu_session_created_data->hcn_tunnel_info) {
		cJSON *hcn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				pdu_session_created_data->hcn_tunnel_info);
		if(hcn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [hcn_tunnel_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "hcnTunnelInfo",
		                      hcn_tunnel_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [hcn_tunnel_info]");
			goto end;
	...
	if(pdu_session_created_data->cn_tunnel_info) {
		cJSON *cn_tunnel_info_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				pdu_session_created_data->cn_tunnel_info);
		if(cn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [cn_tunnel_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "cnTunnelInfo",
		                      cn_tunnel_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [cn_tunnel_info]");
			goto end;
	...
	if(pdu_session_created_data->additional_cn_tunnel_info) {
		...
		if(additional_cn_tunnel_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [additional_cn_tunnel_info]");
			goto end;
		}
	...
	if(pdu_session_created_data->session_ambr) {
		cJSON *session_ambr_local_JSON =
			OpenAPI_ambr_convertToJSON(
				pdu_session_created_data->session_ambr);
		if(session_ambr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [session_ambr]");
			goto end;
		}
		cJSON_AddItemToObject(item, "sessionAmbr",
		                      session_ambr_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [session_ambr]");
			goto end;
	...
	if(pdu_session_created_data->qos_flows_setup_list) {
		cJSON *qos_flows_setup_listList = cJSON_AddArrayToObject(item,
		                                                         "qosFlowsSetupList");
		if(qos_flows_setup_listList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [qos_flows_setup_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			pdu_session_created_data->qos_flows_setup_list, node) {
			cJSON *itemLocal =
				OpenAPI_qos_flow_setup_item_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_pdu_session_created_data_convertToJSON() failed [qos_flows_setup_list]");
			...
			cJSON_AddItemToArray(qos_flows_setup_listList,
			                     itemLocal);
		}
	}
	...
	if(pdu_session_created_data->h_smf_instance_id) {
		if(cJSON_AddStringToObject(item, "hSmfInstanceId",
		                           pdu_session_created_data->
		                           h_smf_instance_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [h_smf_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->smf_instance_id) {
		if(cJSON_AddStringToObject(item, "smfInstanceId",
		                           pdu_session_created_data->
		                           smf_instance_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [smf_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->is_pdu_session_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [pdu_session_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->s_nssai) {
		cJSON *s_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				pdu_session_created_data->s_nssai);
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(pdu_session_created_data->is_enable_pause_charging) {
		if(cJSON_AddBoolToObject(item, "enablePauseCharging",
		                         pdu_session_created_data->
		                         enable_pause_charging) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [enable_pause_charging]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->ue_ipv4_address) {
		if(cJSON_AddStringToObject(item, "ueIpv4Address",
		                           pdu_session_created_data->
		                           ue_ipv4_address) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [ue_ipv4_address]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->ue_ipv6_prefix) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [ue_ipv6_prefix]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->n1_sm_info_to_ue) {
		...
		if(n1_sm_info_to_ue_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [n1_sm_info_to_ue]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n1SmInfoToUe",
		                      n1_sm_info_to_ue_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [n1_sm_info_to_ue]");
			goto end;
	...
	if(pdu_session_created_data->eps_pdn_cnx_info) {
		...
		if(eps_pdn_cnx_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [eps_pdn_cnx_info]");
			goto end;
		}
	...
	if(pdu_session_created_data->eps_bearer_info) {
		...
		if(eps_bearer_infoList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [eps_bearer_info]");
			goto end;
		}
		OpenAPI_list_for_each(pdu_session_created_data->eps_bearer_info,
		                      node) {
	...
	if(pdu_session_created_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [max_integrity_protected_data_rate]");
			goto end;
		}
	}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->is_always_on_granted) {
		if(cJSON_AddBoolToObject(item, "alwaysOnGranted",
		                         pdu_session_created_data->
		                         always_on_granted) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [always_on_granted]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->gpsi) {
		if(cJSON_AddStringToObject(item, "gpsi",
		                           pdu_session_created_data->gpsi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->up_security) {
		cJSON *up_security_local_JSON =
			OpenAPI_up_security_convertToJSON(
				pdu_session_created_data->up_security);
		if(up_security_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [up_security]");
			goto end;
		}
	...
	if(pdu_session_created_data->roaming_charging_profile) {
		...
		if(roaming_charging_profile_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [roaming_charging_profile]");
			goto end;
		}
	...
	if(pdu_session_created_data->h_smf_service_instance_id) {
		if(cJSON_AddStringToObject(item, "hSmfServiceInstanceId",
		                           pdu_session_created_data->
		                           h_smf_service_instance_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [h_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->dnai_list) {
		...
		if(dnai_listList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [dnai_list]");
			goto end;
		}
		OpenAPI_list_for_each(pdu_session_created_data->dnai_list,
		                      node) {
	...
	if(pdu_session_created_data->is_ipv6_multi_homing_ind) {
		if(cJSON_AddBoolToObject(item, "ipv6MultiHomingInd",
		                         pdu_session_created_data->
		                         ipv6_multi_homing_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [ipv6_multi_homing_ind]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->is_ma_accepted_ind) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [ma_accepted_ind]");
			goto end;
		}
	}

	if(pdu_session_created_data->home_provided_charging_id) {
		if(cJSON_AddStringToObject(item, "homeProvidedChargingId",
		                           pdu_session_created_data->
		                           home_provided_charging_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [home_provided_charging_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->is_nef_ext_buf_support_ind) {
		if(cJSON_AddBoolToObject(item, "nefExtBufSupportInd",
		                         pdu_session_created_data->
		                         nef_ext_buf_support_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [nef_ext_buf_support_ind]");
			goto end;
		}
	}

	if(pdu_session_created_data->is_small_data_rate_control_enabled) {
		if(cJSON_AddBoolToObject(item, "smallDataRateControlEnabled",
		                         pdu_session_created_data->
		                         small_data_rate_control_enabled) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [small_data_rate_control_enabled]");
			goto end;
		}
	}

	if(pdu_session_created_data->ue_ipv6_interface_id) {
		if(cJSON_AddStringToObject(item, "ueIpv6InterfaceId",
		                           pdu_session_created_data->
		                           ue_ipv6_interface_id) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [ue_ipv6_interface_id]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->is_ipv6_index) {
		if(cJSON_AddNumberToObject(item, "ipv6Index",
		                           pdu_session_created_data->ipv6_index)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [ipv6_index]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->dn_aaa_address) {
		...
		if(dn_aaa_address_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [dn_aaa_address]");
			goto end;
		}
	...
	if(pdu_session_created_data->redundant_pdu_session_info) {
		...
		if(redundant_pdu_session_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [redundant_pdu_session_info]");
			goto end;
		}
	...
	if(pdu_session_created_data->is_nspu_support_ind) {
		if(cJSON_AddBoolToObject(item, "nspuSupportInd",
		                         pdu_session_created_data->
		                         nspu_support_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [nspu_support_ind]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(pdu_session_created_data->intra_plmn_api_root) {
		if(cJSON_AddStringToObject(item, "intraPlmnApiRoot",
		                           pdu_session_created_data->
		                           intra_plmn_api_root) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_convertToJSON() failed [intra_plmn_api_root]");
			goto end;
		}
	}
...
OpenAPI_pdu_session_created_data_parseFromJSON(
	cJSON *pdu_session_created_dataJSON) {
	OpenAPI_pdu_session_created_data_t *pdu_session_created_data_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	pdu_session_type =
		cJSON_GetObjectItemCaseSensitive(pdu_session_created_dataJSON,
		                                 "pduSessionType");
	if(!pdu_session_type) {
		ogs_error(
			"OpenAPI_pdu_session_created_data_parseFromJSON() failed [pdu_session_type]");
		goto end;
	}
	...
	if(!ssc_mode) {
		ogs_error(
			"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ssc_mode]");
		goto end;
	}
	...
	hcn_tunnel_info =
		cJSON_GetObjectItemCaseSensitive(pdu_session_created_dataJSON,
		                                 "hcnTunnelInfo");
	if(hcn_tunnel_info) {
		hcn_tunnel_info_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(hcn_tunnel_info);
		if(!hcn_tunnel_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [hcn_tunnel_info]");
			goto end;
		}
	}
	...
	cn_tunnel_info =
		cJSON_GetObjectItemCaseSensitive(pdu_session_created_dataJSON,
		                                 "cnTunnelInfo");
	if(cn_tunnel_info) {
		cn_tunnel_info_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(cn_tunnel_info);
		if(!cn_tunnel_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [cn_tunnel_info]");
			goto end;
		}
	}
	...
	if(session_ambr) {
		session_ambr_local_nonprim =
			OpenAPI_ambr_parseFromJSON(session_ambr);
		if(!session_ambr_local_nonprim) {
			ogs_error(
				"OpenAPI_ambr_parseFromJSON failed [session_ambr]");
			goto end;
		}
	}
	...
	if(qos_flows_setup_list) {
		...
		if(!cJSON_IsArray(qos_flows_setup_list)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [qos_flows_setup_list]");
			goto end;
		}

		qos_flows_setup_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(qos_flows_setup_list_local,
		                   qos_flows_setup_list) {
			...
			OpenAPI_qos_flow_setup_item_t *qos_flows_setup_listItem
			        = OpenAPI_qos_flow_setup_item_parseFromJSON(
					  qos_flows_setup_list_local);
			if(!qos_flows_setup_listItem) {
				ogs_error("No qos_flows_setup_listItem");
				goto end;
			}
			OpenAPI_list_add(qos_flows_setup_listList,
			                 qos_flows_setup_listItem);
		}
	}
	...
	if(h_smf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [h_smf_instance_id]");
			goto end;
		}
	}
	...
	if(smf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [smf_instance_id]");
			goto end;
		}
	}
	...
	if(pdu_session_id) {
		if(!cJSON_IsNumber(pdu_session_id)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [pdu_session_id]");
			goto end;
		}
	}

	s_nssai = cJSON_GetObjectItemCaseSensitive(pdu_session_created_dataJSON,
	                                           "sNssai");
	if(s_nssai) {
	...
	if(enable_pause_charging) {
		if(!cJSON_IsBool(enable_pause_charging)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [enable_pause_charging]");
			goto end;
		}
	}
	...
	if(ue_ipv4_address) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ue_ipv4_address]");
			goto end;
		}
	}
	...
	if(ue_ipv6_prefix) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ue_ipv6_prefix]");
			goto end;
		}
	}
	...
	if(n1_sm_info_to_ue) {
		...
		if(!n1_sm_info_to_ue_local_nonprim) {
			ogs_error(
				"OpenAPI_ref_to_binary_data_parseFromJSON failed [n1_sm_info_to_ue]");
			goto end;
		}
	}
	...
	if(eps_bearer_info) {
		...
		if(!cJSON_IsArray(eps_bearer_info)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [eps_bearer_info]");
			goto end;
		}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(max_integrity_protected_data_rate) {
		if(!cJSON_IsString(max_integrity_protected_data_rate)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [max_integrity_protected_data_rate]");
			goto end;
		}
	...
	if(max_integrity_protected_data_rate_dl) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	...
	if(always_on_granted) {
		if(!cJSON_IsBool(always_on_granted)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [always_on_granted]");
			goto end;
		}
	}

	gpsi = cJSON_GetObjectItemCaseSensitive(pdu_session_created_dataJSON,
	                                        "gpsi");
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(h_smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [h_smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(smf_service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [smf_service_instance_id]");
			goto end;
		}
	}
	...
	if(recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(dnai_list) {
		...
		if(!cJSON_IsArray(dnai_list)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [dnai_list]");
			goto end;
		}
	...
	if(ipv6_multi_homing_ind) {
		if(!cJSON_IsBool(ipv6_multi_homing_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ipv6_multi_homing_ind]");
			goto end;
		}
	}
	...
	if(ma_accepted_ind) {
		if(!cJSON_IsBool(ma_accepted_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ma_accepted_ind]");
			goto end;
		}
	}
	...
	if(home_provided_charging_id) {
		if(!cJSON_IsString(home_provided_charging_id) &&
		   !cJSON_IsNull(home_provided_charging_id))
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [home_provided_charging_id]");
			goto end;
		}
	}
	...
	if(nef_ext_buf_support_ind) {
		if(!cJSON_IsBool(nef_ext_buf_support_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [nef_ext_buf_support_ind]");
			goto end;
		}
	}
	...
	if(small_data_rate_control_enabled) {
		if(!cJSON_IsBool(small_data_rate_control_enabled)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [small_data_rate_control_enabled]");
			goto end;
		}
	}
	...
	if(ue_ipv6_interface_id) {
		if(!cJSON_IsString(ue_ipv6_interface_id) &&
		   !cJSON_IsNull(ue_ipv6_interface_id))
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ue_ipv6_interface_id]");
			goto end;
		}
	}
	...
	if(ipv6_index) {
		if(!cJSON_IsNumber(ipv6_index)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [ipv6_index]");
			goto end;
		}
	}
	...
	if(nspu_support_ind) {
		if(!cJSON_IsBool(nspu_support_ind)) {
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [nspu_support_ind]");
			goto end;
		}
	}
	...
	if(inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(intra_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_created_data_parseFromJSON() failed [intra_plmn_api_root]");
			goto end;
		}
	}
	...
	pdu_session_created_data_local_var =
		OpenAPI_pdu_session_created_data_create(
			...
			enable_pause_charging ?
			enable_pause_charging->valueint : 0,
			ue_ipv4_address &&
			!cJSON_IsNull(ue_ipv4_address) ?
			...
			n1_sm_info_to_ue ? n1_sm_info_to_ue_local_nonprim :
			NULL,
			eps_pdn_cnx_info ? eps_pdn_cnx_info_local_nonprim :
			NULL,
			...
			h_smf_service_instance_id &&
			!cJSON_IsNull(h_smf_service_instance_id) ?
			ogs_strdup(h_smf_service_instance_id->valuestring) :
			NULL,
			smf_service_instance_id &&
			!cJSON_IsNull(smf_service_instance_id) ?
			...
			ipv6_multi_homing_ind ?
			ipv6_multi_homing_ind->valueint : 0,
			ma_accepted_ind ? true : false,
			ma_accepted_ind ? ma_accepted_ind->valueint : 0,
			home_provided_charging_id &&
			!cJSON_IsNull(home_provided_charging_id) ?
			ogs_strdup(home_provided_charging_id->valuestring) :
			NULL,
			nef_ext_buf_support_ind ? true : false,
			nef_ext_buf_support_ind ?
			nef_ext_buf_support_ind->valueint : 0,
			small_data_rate_control_enabled ? true : false,
			small_data_rate_control_enabled ?
			small_data_rate_control_enabled->valueint : 0,
			ue_ipv6_interface_id &&
			!cJSON_IsNull(ue_ipv6_interface_id) ?
			ogs_strdup(ue_ipv6_interface_id->valuestring) : NULL,
...
OpenAPI_pdu_session_created_data_t *OpenAPI_pdu_session_created_data_copy(
	OpenAPI_pdu_session_created_data_t	*dst,
	OpenAPI_pdu_session_created_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pdu_session_created_data_convertToJSON() failed");
		return NULL;
	}
