...
OpenAPI_allowed_snssai_t *OpenAPI_allowed_snssai_create(
	OpenAPI_snssai_t *allowed_snssai, OpenAPI_list_t *nsi_information_list,
	OpenAPI_snssai_t *mapped_home_snssai) {
	OpenAPI_allowed_snssai_t *allowed_snssai_local_var =
		ogs_malloc(sizeof(OpenAPI_allowed_snssai_t));
...
void OpenAPI_allowed_snssai_free(OpenAPI_allowed_snssai_t *allowed_snssai) {
	...
	if(allowed_snssai->nsi_information_list) {
		OpenAPI_list_for_each(allowed_snssai->nsi_information_list,
		                      node) {
...
cJSON *OpenAPI_allowed_snssai_convertToJSON(
	OpenAPI_allowed_snssai_t *allowed_snssai) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(allowed_snssai == NULL) {
		ogs_error(
			"OpenAPI_allowed_snssai_convertToJSON() failed [AllowedSnssai]");
		return NULL;
	}
	...
	if(!allowed_snssai->allowed_snssai) {
		ogs_error(
			"OpenAPI_allowed_snssai_convertToJSON() failed [allowed_snssai]");
		return NULL;
	}
	cJSON *allowed_snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(allowed_snssai->allowed_snssai);
	...
	if(allowed_snssai->nsi_information_list) {
		...
		if(nsi_information_listList == NULL) {
			ogs_error(
				"OpenAPI_allowed_snssai_convertToJSON() failed [nsi_information_list]");
			goto end;
		}
		OpenAPI_list_for_each(allowed_snssai->nsi_information_list,
		                      node) {
...
OpenAPI_allowed_snssai_t *OpenAPI_allowed_snssai_parseFromJSON(
	cJSON *allowed_snssaiJSON) {
	...
	if(!allowed_snssai) {
		ogs_error(
			"OpenAPI_allowed_snssai_parseFromJSON() failed [allowed_snssai]");
		goto end;
	}
	allowed_snssai_local_nonprim =
		OpenAPI_snssai_parseFromJSON(allowed_snssai);
	if(!allowed_snssai_local_nonprim) {
		ogs_error(
			"OpenAPI_snssai_parseFromJSON failed [allowed_snssai]");
		goto end;
	}

	nsi_information_list =
		cJSON_GetObjectItemCaseSensitive(allowed_snssaiJSON,
		                                 "nsiInformationList");
	if(nsi_information_list) {
		cJSON *nsi_information_list_local = NULL;
		if(!cJSON_IsArray(nsi_information_list)) {
			ogs_error(
				"OpenAPI_allowed_snssai_parseFromJSON() failed [nsi_information_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nsi_information_list_local,
			...
			OpenAPI_nsi_information_t *nsi_information_listItem =
				OpenAPI_nsi_information_parseFromJSON(
					nsi_information_list_local);
			if(!nsi_information_listItem) {
				ogs_error("No nsi_information_listItem");
				goto end;
			}
			OpenAPI_list_add(nsi_information_listList,
	...
	if(mapped_home_snssai) {
		mapped_home_snssai_local_nonprim =
			OpenAPI_snssai_parseFromJSON(mapped_home_snssai);
		if(!mapped_home_snssai_local_nonprim) {
			ogs_error(
				"OpenAPI_snssai_parseFromJSON failed [mapped_home_snssai]");
			goto end;
		}
	}
...
OpenAPI_allowed_snssai_t *OpenAPI_allowed_snssai_copy(
	OpenAPI_allowed_snssai_t *dst, OpenAPI_allowed_snssai_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
