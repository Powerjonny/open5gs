...
OpenAPI_av5_ghe_aka_t *OpenAPI_av5_ghe_aka_create(OpenAPI_av_type_e av_type,
	...
	OpenAPI_av5_ghe_aka_t *av5_ghe_aka_local_var =
		ogs_malloc(sizeof(OpenAPI_av5_ghe_aka_t));
...
cJSON *OpenAPI_av5_ghe_aka_convertToJSON(OpenAPI_av5_ghe_aka_t *av5_ghe_aka) {
	...
	if(av5_ghe_aka == NULL) {
		ogs_error(
			"OpenAPI_av5_ghe_aka_convertToJSON() failed [Av5GHeAka]");
		return NULL;
	}
	...
	if(av5_ghe_aka->av_type == OpenAPI_av_type_NULL) {
		ogs_error(
			"OpenAPI_av5_ghe_aka_convertToJSON() failed [av_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "avType",
	                           OpenAPI_av_type_ToString(
					   av5_ghe_aka->av_type)) == NULL)
	{
		ogs_error(
			"OpenAPI_av5_ghe_aka_convertToJSON() failed [av_type]");
		goto end;
	...
	if(av5_ghe_aka->xres_star) {
		...
		{
			ogs_error(
				"OpenAPI_av5_ghe_aka_convertToJSON() failed [xres_star]");
			goto end;
		}
	}
	...
	if(av5_ghe_aka->kausf) {
		...
		{
			ogs_error(
				"OpenAPI_av5_ghe_aka_convertToJSON() failed [kausf]");
			goto end;
		}
	}
...
OpenAPI_av5_ghe_aka_t *OpenAPI_av5_ghe_aka_parseFromJSON(
	...
	if(!av_type) {
		ogs_error(
			"OpenAPI_av5_ghe_aka_parseFromJSON() failed [av_type]");
		goto end;
	}
	...
	xres_star = cJSON_GetObjectItemCaseSensitive(av5_ghe_akaJSON,
	                                             "xresStar");
	if(xres_star) {
		...
		{
			ogs_error(
				"OpenAPI_av5_ghe_aka_parseFromJSON() failed [xres_star]");
			goto end;
		}
	}
	...
	if(kausf) {
		...
		{
			ogs_error(
				"OpenAPI_av5_ghe_aka_parseFromJSON() failed [kausf]");
			goto end;
		}
	}
