...
OpenAPI_vplmn_qos_t *OpenAPI_vplmn_qos_create(bool is__5qi, int _5qi,
                                              OpenAPI_arp_t *arp,
                                              ...
                                              char *gua_fbr_dl,
                                              char *gua_fbr_ul) {
	OpenAPI_vplmn_qos_t *vplmn_qos_local_var =
		ogs_malloc(sizeof(OpenAPI_vplmn_qos_t));
...
cJSON *OpenAPI_vplmn_qos_convertToJSON(OpenAPI_vplmn_qos_t *vplmn_qos) {
	...
	if(vplmn_qos == NULL) {
		ogs_error(
			"OpenAPI_vplmn_qos_convertToJSON() failed [VplmnQos]");
		return NULL;
	}
	...
	if(vplmn_qos->is__5qi) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [_5qi]");
			goto end;
		}
	}
	...
	if(vplmn_qos->arp) {
		cJSON *arp_local_JSON =
			OpenAPI_arp_convertToJSON(vplmn_qos->arp);
		if(arp_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [arp]");
			goto end;
		}
	...
	if(vplmn_qos->session_ambr) {
		cJSON *session_ambr_local_JSON =
			OpenAPI_ambr_convertToJSON(vplmn_qos->session_ambr);
		if(session_ambr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [session_ambr]");
			goto end;
		}
	...
	if(vplmn_qos->max_fbr_dl) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [max_fbr_dl]");
			goto end;
		}
	}
	...
	if(vplmn_qos->max_fbr_ul) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [max_fbr_ul]");
			goto end;
		}
	}
	...
	if(vplmn_qos->gua_fbr_dl) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [gua_fbr_dl]");
			goto end;
		}
	}
	...
	if(vplmn_qos->gua_fbr_ul) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_convertToJSON() failed [gua_fbr_ul]");
			goto end;
		}
	}
...
OpenAPI_vplmn_qos_t *OpenAPI_vplmn_qos_parseFromJSON(cJSON *vplmn_qosJSON) {
	...
	if(_5qi) {
		if(!cJSON_IsNumber(_5qi)) {
			ogs_error(
				"OpenAPI_vplmn_qos_parseFromJSON() failed [_5qi]");
			goto end;
		}
	}
	...
	session_ambr = cJSON_GetObjectItemCaseSensitive(vplmn_qosJSON,
	                                                "sessionAmbr");
	if(session_ambr) {
	...
	max_fbr_dl = cJSON_GetObjectItemCaseSensitive(vplmn_qosJSON,
	                                              "maxFbrDl");
	if(max_fbr_dl) {
		if(!cJSON_IsString(max_fbr_dl) &&
		   !cJSON_IsNull(max_fbr_dl))
		{
			ogs_error(
				"OpenAPI_vplmn_qos_parseFromJSON() failed [max_fbr_dl]");
			goto end;
		}
	}

	max_fbr_ul = cJSON_GetObjectItemCaseSensitive(vplmn_qosJSON,
	                                              "maxFbrUl");
	if(max_fbr_ul) {
		if(!cJSON_IsString(max_fbr_ul) &&
		   !cJSON_IsNull(max_fbr_ul))
		{
			ogs_error(
				"OpenAPI_vplmn_qos_parseFromJSON() failed [max_fbr_ul]");
			goto end;
		}
	}

	gua_fbr_dl = cJSON_GetObjectItemCaseSensitive(vplmn_qosJSON,
	                                              "guaFbrDl");
	if(gua_fbr_dl) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_parseFromJSON() failed [gua_fbr_dl]");
			goto end;
		}
	}

	gua_fbr_ul = cJSON_GetObjectItemCaseSensitive(vplmn_qosJSON,
	                                              "guaFbrUl");
	if(gua_fbr_ul) {
		...
		{
			ogs_error(
				"OpenAPI_vplmn_qos_parseFromJSON() failed [gua_fbr_ul]");
			goto end;
		}
	}
	...
	vplmn_qos_local_var = OpenAPI_vplmn_qos_create(
		...
		max_fbr_dl &&
		!cJSON_IsNull(max_fbr_dl) ?
		ogs_strdup(max_fbr_dl->valuestring) : NULL,
		max_fbr_ul &&
		!cJSON_IsNull(max_fbr_ul) ?
		ogs_strdup(max_fbr_ul->valuestring) : NULL,
		gua_fbr_dl &&
		!cJSON_IsNull(gua_fbr_dl) ?
...
OpenAPI_vplmn_qos_t *OpenAPI_vplmn_qos_copy(OpenAPI_vplmn_qos_t *dst,
                                            OpenAPI_vplmn_qos_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
