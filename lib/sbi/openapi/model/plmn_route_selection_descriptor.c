...
OpenAPI_plmn_route_selection_descriptor_create(
	...
	OpenAPI_plmn_route_selection_descriptor_t *
	        plmn_route_selection_descriptor_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_route_selection_descriptor_t));
	ogs_assert(plmn_route_selection_descriptor_local_var);

	plmn_route_selection_descriptor_local_var->serving_plmn = serving_plmn;
	plmn_route_selection_descriptor_local_var->snssai_route_sel_descs =
		snssai_route_sel_descs;

	return plmn_route_selection_descriptor_local_var;
}

void OpenAPI_plmn_route_selection_descriptor_free(
	OpenAPI_plmn_route_selection_descriptor_t *
	...
	if(plmn_route_selection_descriptor->snssai_route_sel_descs) {
		OpenAPI_list_for_each(
			plmn_route_selection_descriptor->snssai_route_sel_descs,
			node) {
			OpenAPI_snssai_route_selection_descriptor_free(
				node->data);
		}
		OpenAPI_list_free(
			plmn_route_selection_descriptor->snssai_route_sel_descs);
...
cJSON *OpenAPI_plmn_route_selection_descriptor_convertToJSON(
	OpenAPI_plmn_route_selection_descriptor_t *
	plmn_route_selection_descriptor) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(plmn_route_selection_descriptor == NULL) {
		ogs_error(
			"OpenAPI_plmn_route_selection_descriptor_convertToJSON() failed [PlmnRouteSelectionDescriptor]");
		return NULL;
	}
	...
	if(!plmn_route_selection_descriptor->serving_plmn) {
		ogs_error(
			"OpenAPI_plmn_route_selection_descriptor_convertToJSON() failed [serving_plmn]");
		return NULL;
	}
	...
	if(plmn_route_selection_descriptor->snssai_route_sel_descs) {
		cJSON *snssai_route_sel_descsList = cJSON_AddArrayToObject(item,
		                                                           "snssaiRouteSelDescs");
		if(snssai_route_sel_descsList == NULL) {
			ogs_error(
				"OpenAPI_plmn_route_selection_descriptor_convertToJSON() failed [snssai_route_sel_descs]");
			goto end;
		}
		OpenAPI_list_for_each(
			plmn_route_selection_descriptor->snssai_route_sel_descs,
			node) {
			cJSON *itemLocal =
				OpenAPI_snssai_route_selection_descriptor_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_plmn_route_selection_descriptor_convertToJSON() failed [snssai_route_sel_descs]");
			...
			cJSON_AddItemToArray(snssai_route_sel_descsList,
			                     itemLocal);
		}
	}
...
OpenAPI_plmn_route_selection_descriptor_parseFromJSON(
	cJSON *plmn_route_selection_descriptorJSON) {
	OpenAPI_plmn_route_selection_descriptor_t *
	        plmn_route_selection_descriptor_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	serving_plmn =
		cJSON_GetObjectItemCaseSensitive(
			plmn_route_selection_descriptorJSON, "servingPlmn");
	if(!serving_plmn) {
		ogs_error(
			"OpenAPI_plmn_route_selection_descriptor_parseFromJSON() failed [serving_plmn]");
		goto end;
	}
	serving_plmn_local_nonprim =
		OpenAPI_plmn_id_1_parseFromJSON(serving_plmn);
	if(!serving_plmn_local_nonprim) {
		ogs_error(
			"OpenAPI_plmn_id_1_parseFromJSON failed [serving_plmn]");
		goto end;
	}

	snssai_route_sel_descs =
		cJSON_GetObjectItemCaseSensitive(
			plmn_route_selection_descriptorJSON,
			"snssaiRouteSelDescs");
	if(snssai_route_sel_descs) {
		cJSON *snssai_route_sel_descs_local = NULL;
		if(!cJSON_IsArray(snssai_route_sel_descs)) {
			ogs_error(
				"OpenAPI_plmn_route_selection_descriptor_parseFromJSON() failed [snssai_route_sel_descs]");
			goto end;
		}

		snssai_route_sel_descsList = OpenAPI_list_create();

		cJSON_ArrayForEach(snssai_route_sel_descs_local,
		                   snssai_route_sel_descs) {
			...
			OpenAPI_snssai_route_selection_descriptor_t *
				...
				OpenAPI_snssai_route_selection_descriptor_parseFromJSON
				        (snssai_route_sel_descs_local);
			if(!snssai_route_sel_descsItem) {
				ogs_error("No snssai_route_sel_descsItem");
				goto end;
			}
			OpenAPI_list_add(snssai_route_sel_descsList,
			                 snssai_route_sel_descsItem);
		}
	}
	...
	plmn_route_selection_descriptor_local_var =
		OpenAPI_plmn_route_selection_descriptor_create(
			serving_plmn_local_nonprim,
			snssai_route_sel_descs ? snssai_route_sel_descsList :
			NULL
			);
...
OpenAPI_plmn_route_selection_descriptor_t *
OpenAPI_plmn_route_selection_descriptor_copy(
	OpenAPI_plmn_route_selection_descriptor_t	*dst,
	OpenAPI_plmn_route_selection_descriptor_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_plmn_route_selection_descriptor_convertToJSON() failed");
		return NULL;
	}
