...
OpenAPI_ipv6_prefix_range_t *OpenAPI_ipv6_prefix_range_create(char	*start,
                                                              char	*end) {
	OpenAPI_ipv6_prefix_range_t *ipv6_prefix_range_local_var =
...
void OpenAPI_ipv6_prefix_range_free(
	OpenAPI_ipv6_prefix_range_t *ipv6_prefix_range) {
...
cJSON *OpenAPI_ipv6_prefix_range_convertToJSON(
	...
	if(ipv6_prefix_range == NULL) {
		ogs_error(
			"OpenAPI_ipv6_prefix_range_convertToJSON() failed [Ipv6PrefixRange]");
		return NULL;
	}
	...
	if(ipv6_prefix_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_ipv6_prefix_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(ipv6_prefix_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_ipv6_prefix_range_convertToJSON() failed [end]");
			goto end;
		}
	}
...
OpenAPI_ipv6_prefix_range_t *OpenAPI_ipv6_prefix_range_parseFromJSON(
	cJSON *ipv6_prefix_rangeJSON) {
	OpenAPI_ipv6_prefix_range_t *ipv6_prefix_range_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *start = NULL;
	cJSON *end = NULL;
	start = cJSON_GetObjectItemCaseSensitive(ipv6_prefix_rangeJSON,
	                                         "start");
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_ipv6_prefix_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_ipv6_prefix_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
...
OpenAPI_ipv6_prefix_range_t *OpenAPI_ipv6_prefix_range_copy(
	OpenAPI_ipv6_prefix_range_t *dst, OpenAPI_ipv6_prefix_range_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
