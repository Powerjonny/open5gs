...
OpenAPI_eps_nas_security_mode_t *OpenAPI_eps_nas_security_mode_create(
	...
	OpenAPI_eps_nas_security_mode_t *eps_nas_security_mode_local_var =
		ogs_malloc(sizeof(OpenAPI_eps_nas_security_mode_t));
...
void OpenAPI_eps_nas_security_mode_free(
...
cJSON *OpenAPI_eps_nas_security_mode_convertToJSON(
	...
	if(eps_nas_security_mode == NULL) {
		ogs_error(
			"OpenAPI_eps_nas_security_mode_convertToJSON() failed [EpsNasSecurityMode]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(eps_nas_security_mode->integrity_algorithm ==
	   OpenAPI_eps_nas_integrity_algorithm_NULL)
	{
		ogs_error(
			"OpenAPI_eps_nas_security_mode_convertToJSON() failed [integrity_algorithm]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "integrityAlgorithm",
	                           OpenAPI_eps_nas_integrity_algorithm_ToString(
	...
	if(eps_nas_security_mode->ciphering_algorithm ==
	   OpenAPI_eps_nas_ciphering_algorithm_NULL)
	{
		ogs_error(
			"OpenAPI_eps_nas_security_mode_convertToJSON() failed [ciphering_algorithm]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "cipheringAlgorithm",
	                           OpenAPI_eps_nas_ciphering_algorithm_ToString(
					   eps_nas_security_mode->
...
OpenAPI_eps_nas_security_mode_t *OpenAPI_eps_nas_security_mode_parseFromJSON(
	...
	integrity_algorithm =
		cJSON_GetObjectItemCaseSensitive(eps_nas_security_modeJSON,
		                                 "integrityAlgorithm");
	if(!integrity_algorithm) {
		ogs_error(
			"OpenAPI_eps_nas_security_mode_parseFromJSON() failed [integrity_algorithm]");
		goto end;
	}
	...
	integrity_algorithmVariable =
		OpenAPI_eps_nas_integrity_algorithm_FromString(
	...
	if(!ciphering_algorithm) {
		ogs_error(
			"OpenAPI_eps_nas_security_mode_parseFromJSON() failed [ciphering_algorithm]");
		goto end;
	}
...
OpenAPI_eps_nas_security_mode_t *OpenAPI_eps_nas_security_mode_copy(
	OpenAPI_eps_nas_security_mode_t *dst,
	OpenAPI_eps_nas_security_mode_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_eps_nas_security_mode_convertToJSON() failed");
		return NULL;
	}
