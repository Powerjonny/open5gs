...
OpenAPI_gba_authentication_info_result_create(
	...
	OpenAPI_gba_authentication_info_result_t *
	        gba_authentication_info_result_local_var =
		ogs_malloc(sizeof(OpenAPI_gba_authentication_info_result_t));
	ogs_assert(gba_authentication_info_result_local_var);

	gba_authentication_info_result_local_var->_3g_aka_av = _3g_aka_av;
	gba_authentication_info_result_local_var->supported_features =
		supported_features;
	...
	OpenAPI_gba_authentication_info_result_t *gba_authentication_info_result)
{
	...
	if(gba_authentication_info_result->_3g_aka_av) {
		OpenAPI_model_3_g_aka_av_free(
			gba_authentication_info_result->_3g_aka_av);
	...
	OpenAPI_gba_authentication_info_result_t *gba_authentication_info_result)
{
	...
	if(gba_authentication_info_result == NULL) {
		ogs_error(
			"OpenAPI_gba_authentication_info_result_convertToJSON() failed [GbaAuthenticationInfoResult]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(gba_authentication_info_result->_3g_aka_av) {
		cJSON *_3g_aka_av_local_JSON =
			OpenAPI_model_3_g_aka_av_convertToJSON(
				gba_authentication_info_result->_3g_aka_av);
		if(_3g_aka_av_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_gba_authentication_info_result_convertToJSON() failed [_3g_aka_av]");
			goto end;
		}
	...
	if(gba_authentication_info_result->supported_features) {
		if(cJSON_AddStringToObject(item, "supportedFeatures",
		                           gba_authentication_info_result->
		                           supported_features) == NULL)
		{
			ogs_error(
				"OpenAPI_gba_authentication_info_result_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_gba_authentication_info_result_parseFromJSON(
	...
	OpenAPI_gba_authentication_info_result_t *
	        gba_authentication_info_result_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	_3g_aka_av =
		cJSON_GetObjectItemCaseSensitive(
			gba_authentication_info_resultJSON, "3gAkaAv");
	if(_3g_aka_av) {
		_3g_aka_av_local_nonprim =
			OpenAPI_model_3_g_aka_av_parseFromJSON(_3g_aka_av);
		if(!_3g_aka_av_local_nonprim) {
			ogs_error(
				"OpenAPI_model_3_g_aka_av_parseFromJSON failed [_3g_aka_av]");
			goto end;
		}
	}
	...
	supported_features =
		cJSON_GetObjectItemCaseSensitive(
			gba_authentication_info_resultJSON,
			"supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_gba_authentication_info_result_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_gba_authentication_info_result_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_gba_authentication_info_result_convertToJSON() failed");
		return NULL;
	}
