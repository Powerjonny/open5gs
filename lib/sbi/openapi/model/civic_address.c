...
OpenAPI_civic_address_t *OpenAPI_civic_address_create(char *country, char *a1,
                                                      char *a2, char *a3,
                                                      char *a4, char *a5,
                                                      char *a6, char *prd,
                                                      char *pod, char *sts,
                                                      ...
                                                      char *plc, char *pcn,
                                                      char *pobox,
                                                      char *addcode, char *seat,
                                                      char *rd, char *rdsec,
                                                      char *rdbr, char *rdsubbr,
                                                      char *prm, char *pom,
                                                      char *usage_rules,
                                                      char *method,
                                                      char *provided_by) {
	OpenAPI_civic_address_t *civic_address_local_var =
		ogs_malloc(sizeof(OpenAPI_civic_address_t));
...
cJSON *OpenAPI_civic_address_convertToJSON(
	...
	if(civic_address == NULL) {
		ogs_error(
			"OpenAPI_civic_address_convertToJSON() failed [CivicAddress]");
		return NULL;
	}
	...
	if(civic_address->country) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [country]");
			goto end;
		}
	}
	...
	if(civic_address->a1) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [a1]");
			goto end;
		}
	}
	...
	if(civic_address->a2) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [a2]");
			goto end;
		}
	}
	...
	if(civic_address->a3) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [a3]");
			goto end;
		}
	}
	...
	if(civic_address->a4) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [a4]");
			goto end;
		}
	}
	...
	if(civic_address->a5) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [a5]");
			goto end;
		}
	}
	...
	if(civic_address->a6) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [a6]");
			goto end;
		}
	}
	...
	if(civic_address->prd) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [prd]");
			goto end;
		}
	}
	...
	if(civic_address->pod) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [pod]");
			goto end;
		}
	}
	...
	if(civic_address->sts) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [sts]");
			goto end;
		}
	}
	...
	if(civic_address->hno) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [hno]");
			goto end;
		}
	}
	...
	if(civic_address->hns) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [hns]");
			goto end;
		}
	}
	...
	if(civic_address->lmk) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [lmk]");
			goto end;
		}
	}
	...
	if(civic_address->loc) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [loc]");
			goto end;
		}
	}
	...
	if(civic_address->nam) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [nam]");
			goto end;
		}
	}
	...
	if(civic_address->pc) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [pc]");
			goto end;
		}
	}
	...
	if(civic_address->bld) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [bld]");
			goto end;
		}
	}
	...
	if(civic_address->unit) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [unit]");
			goto end;
		}
	}
	...
	if(civic_address->flr) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [flr]");
			goto end;
		}
	}
	...
	if(civic_address->room) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [room]");
			goto end;
		}
	}
	...
	if(civic_address->plc) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [plc]");
			goto end;
		}
	}
	...
	if(civic_address->pcn) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [pcn]");
			goto end;
		}
	}
	...
	if(civic_address->pobox) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [pobox]");
			goto end;
		}
	}
	...
	if(civic_address->addcode) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [addcode]");
			goto end;
		}
	}
	...
	if(civic_address->seat) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [seat]");
			goto end;
		}
	}
	...
	if(civic_address->rd) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [rd]");
			goto end;
		}
	}
	...
	if(civic_address->rdsec) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [rdsec]");
			goto end;
		}
	}
	...
	if(civic_address->rdbr) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [rdbr]");
			goto end;
		}
	}
	...
	if(civic_address->rdsubbr) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [rdsubbr]");
			goto end;
		}
	}
	...
	if(civic_address->prm) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [prm]");
			goto end;
		}
	}
	...
	if(civic_address->pom) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [pom]");
			goto end;
		}
	}
	...
	if(civic_address->usage_rules) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [usage_rules]");
			goto end;
		}
	}
	...
	if(civic_address->method) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [method]");
			goto end;
		}
	}
	...
	if(civic_address->provided_by) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_convertToJSON() failed [provided_by]");
			goto end;
		}
	}
...
OpenAPI_civic_address_t *OpenAPI_civic_address_parseFromJSON(
	cJSON *civic_addressJSON) {
	...
	country = cJSON_GetObjectItemCaseSensitive(civic_addressJSON,
	                                           "country");
	if(country) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [country]");
			goto end;
		}
	}
	...
	if(a1) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [a1]");
			goto end;
		}
	}
	...
	if(a2) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [a2]");
			goto end;
		}
	}
	...
	if(a3) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [a3]");
			goto end;
		}
	}
	...
	if(a4) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [a4]");
			goto end;
		}
	}
	...
	if(a5) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [a5]");
			goto end;
		}
	}
	...
	if(a6) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [a6]");
			goto end;
		}
	}
	...
	if(prd) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [prd]");
			goto end;
		}
	}
	...
	if(pod) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [pod]");
			goto end;
		}
	}
	...
	if(sts) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [sts]");
			goto end;
		}
	}
	...
	if(hno) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [hno]");
			goto end;
		}
	}
	...
	if(hns) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [hns]");
			goto end;
		}
	}
	...
	if(lmk) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [lmk]");
			goto end;
		}
	}
	...
	if(loc) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [loc]");
			goto end;
		}
	}
	...
	if(nam) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [nam]");
			goto end;
		}
	}
	...
	if(pc) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [pc]");
			goto end;
		}
	}
	...
	if(bld) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [bld]");
			goto end;
		}
	}
	...
	if(unit) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [unit]");
			goto end;
		}
	}
	...
	if(flr) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [flr]");
			goto end;
		}
	}
	...
	if(room) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [room]");
			goto end;
		}
	}
	...
	if(plc) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [plc]");
			goto end;
		}
	}
	...
	if(pcn) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [pcn]");
			goto end;
		}
	}
	...
	if(pobox) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [pobox]");
			goto end;
		}
	}

	addcode = cJSON_GetObjectItemCaseSensitive(civic_addressJSON,
	                                           "ADDCODE");
	if(addcode) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [addcode]");
			goto end;
		}
	}
	...
	if(seat) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [seat]");
			goto end;
		}
	}
	...
	if(rd) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [rd]");
			goto end;
		}
	}
	...
	if(rdsec) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [rdsec]");
			goto end;
		}
	}
	...
	if(rdbr) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [rdbr]");
			goto end;
		}
	}

	rdsubbr = cJSON_GetObjectItemCaseSensitive(civic_addressJSON,
	                                           "RDSUBBR");
	if(rdsubbr) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [rdsubbr]");
			goto end;
		}
	}
	...
	if(prm) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [prm]");
			goto end;
		}
	}
	...
	if(pom) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [pom]");
			goto end;
		}
	}
	...
	if(usage_rules) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [usage_rules]");
			goto end;
		}
	}
	...
	if(method) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [method]");
			goto end;
		}
	}
	...
	if(provided_by) {
		...
		{
			ogs_error(
				"OpenAPI_civic_address_parseFromJSON() failed [provided_by]");
			goto end;
		}
	}
	...
	civic_address_local_var = OpenAPI_civic_address_create(
		country &&
		!cJSON_IsNull(country) ? ogs_strdup(country->valuestring) :
		NULL,
		a1 &&
		!cJSON_IsNull(a1) ? ogs_strdup(a1->valuestring) : NULL,
		a2 &&
		!cJSON_IsNull(a2) ? ogs_strdup(a2->valuestring) : NULL,
		a3 &&
		!cJSON_IsNull(a3) ? ogs_strdup(a3->valuestring) : NULL,
		a4 &&
		!cJSON_IsNull(a4) ? ogs_strdup(a4->valuestring) : NULL,
		a5 &&
		!cJSON_IsNull(a5) ? ogs_strdup(a5->valuestring) : NULL,
		a6 &&
		!cJSON_IsNull(a6) ? ogs_strdup(a6->valuestring) : NULL,
		prd &&
		!cJSON_IsNull(prd) ? ogs_strdup(prd->valuestring) : NULL,
		pod &&
		!cJSON_IsNull(pod) ? ogs_strdup(pod->valuestring) : NULL,
		sts &&
		!cJSON_IsNull(sts) ? ogs_strdup(sts->valuestring) : NULL,
		hno &&
		!cJSON_IsNull(hno) ? ogs_strdup(hno->valuestring) : NULL,
		hns &&
		!cJSON_IsNull(hns) ? ogs_strdup(hns->valuestring) : NULL,
		lmk &&
		!cJSON_IsNull(lmk) ? ogs_strdup(lmk->valuestring) : NULL,
		loc &&
		!cJSON_IsNull(loc) ? ogs_strdup(loc->valuestring) : NULL,
		nam &&
		!cJSON_IsNull(nam) ? ogs_strdup(nam->valuestring) : NULL,
		pc &&
		!cJSON_IsNull(pc) ? ogs_strdup(pc->valuestring) : NULL,
		bld &&
		!cJSON_IsNull(bld) ? ogs_strdup(bld->valuestring) : NULL,
		unit &&
		!cJSON_IsNull(unit) ? ogs_strdup(unit->valuestring) : NULL,
		flr &&
		!cJSON_IsNull(flr) ? ogs_strdup(flr->valuestring) : NULL,
		room &&
		!cJSON_IsNull(room) ? ogs_strdup(room->valuestring) : NULL,
		plc &&
		!cJSON_IsNull(plc) ? ogs_strdup(plc->valuestring) : NULL,
		pcn &&
		!cJSON_IsNull(pcn) ? ogs_strdup(pcn->valuestring) : NULL,
		pobox &&
		!cJSON_IsNull(pobox) ? ogs_strdup(pobox->valuestring) : NULL,
		addcode &&
		!cJSON_IsNull(addcode) ? ogs_strdup(addcode->valuestring) :
		NULL,
		seat &&
		!cJSON_IsNull(seat) ? ogs_strdup(seat->valuestring) : NULL,
		rd &&
		!cJSON_IsNull(rd) ? ogs_strdup(rd->valuestring) : NULL,
		rdsec &&
		!cJSON_IsNull(rdsec) ? ogs_strdup(rdsec->valuestring) : NULL,
		rdbr &&
		!cJSON_IsNull(rdbr) ? ogs_strdup(rdbr->valuestring) : NULL,
		rdsubbr &&
		!cJSON_IsNull(rdsubbr) ? ogs_strdup(rdsubbr->valuestring) :
		NULL,
		prm &&
		!cJSON_IsNull(prm) ? ogs_strdup(prm->valuestring) : NULL,
		pom &&
		!cJSON_IsNull(pom) ? ogs_strdup(pom->valuestring) : NULL,
		usage_rules &&
		!cJSON_IsNull(usage_rules) ?
		ogs_strdup(usage_rules->valuestring) : NULL,
		method &&
		!cJSON_IsNull(method) ? ogs_strdup(method->valuestring) : NULL,
		provided_by &&
		!cJSON_IsNull(provided_by) ?
		ogs_strdup(provided_by->valuestring) : NULL
		);
...
OpenAPI_civic_address_t *OpenAPI_civic_address_copy(
	OpenAPI_civic_address_t *dst, OpenAPI_civic_address_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
