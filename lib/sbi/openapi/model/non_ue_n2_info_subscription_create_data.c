...
OpenAPI_non_ue_n2_info_subscription_create_data_create(
	...
	OpenAPI_non_ue_n2_info_subscription_create_data_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_non_ue_n2_info_subscription_create_data_t));
...
cJSON *OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON(
	...
	if(non_ue_n2_info_subscription_create_data == NULL) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [NonUeN2InfoSubscriptionCreateData]");
		return NULL;
	}
	...
	if(non_ue_n2_info_subscription_create_data->global_ran_node_list) {
		...
		if(global_ran_node_listList == NULL) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [global_ran_node_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			non_ue_n2_info_subscription_create_data->
	   ...
	   OpenAPI_access_type_NULL)
	{
		...
		if(an_type_listList == NULL) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [an_type_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			non_ue_n2_info_subscription_create_data->an_type_list,
	...
	{
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [n2_information_class]");
		return NULL;
	}
	...
	if(!non_ue_n2_info_subscription_create_data->n2_notify_callback_uri) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [n2_notify_callback_uri]");
		return NULL;
	}
	...
	if(non_ue_n2_info_subscription_create_data->nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [nf_id]");
			goto end;
		}
	}
	...
	if(non_ue_n2_info_subscription_create_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON(
	...
	if(global_ran_node_list) {
		...
		if(!cJSON_IsArray(global_ran_node_list)) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [global_ran_node_list]");
			goto end;
		}
	...
	if(an_type_list) {
		...
		if(!cJSON_IsArray(an_type_list)) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [an_type_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(an_type_list_local, an_type_list) {
			...
			if(!localEnum) {
				...
				OpenAPI_list_add(an_type_listList,
				                 (void *) localEnum);
			}
		}
		if(an_type_listList->count == 0) {
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed: Expected an_type_listList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(!n2_information_class) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [n2_information_class]");
		goto end;
	}
	...
	if(!n2_notify_callback_uri) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [n2_notify_callback_uri]");
		goto end;
	}
	...
	if(nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_non_ue_n2_info_subscription_create_data_parseFromJSON() failed [nf_id]");
			goto end;
		}
	}
...
OpenAPI_non_ue_n2_info_subscription_create_data_copy(
	...
	ogs_assert(src);
	item =
		OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON(
			src);
	if(!item) {
		ogs_error(
			"OpenAPI_non_ue_n2_info_subscription_create_data_convertToJSON() failed");
		return NULL;
	}
