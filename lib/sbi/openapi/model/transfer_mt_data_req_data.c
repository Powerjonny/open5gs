...
OpenAPI_transfer_mt_data_req_data_t *OpenAPI_transfer_mt_data_req_data_create(
	...
	OpenAPI_transfer_mt_data_req_data_t *transfer_mt_data_req_data_local_var
	        = ogs_malloc(sizeof(OpenAPI_transfer_mt_data_req_data_t));
...
void OpenAPI_transfer_mt_data_req_data_free(
	...
	if(transfer_mt_data_req_data->mt_data) {
		OpenAPI_ref_to_binary_data_free(
			transfer_mt_data_req_data->mt_data);
...
cJSON *OpenAPI_transfer_mt_data_req_data_convertToJSON(
	...
	if(transfer_mt_data_req_data == NULL) {
		ogs_error(
			"OpenAPI_transfer_mt_data_req_data_convertToJSON() failed [TransferMtDataReqData]");
		return NULL;
	}
	...
	if(!transfer_mt_data_req_data->mt_data) {
		ogs_error(
			"OpenAPI_transfer_mt_data_req_data_convertToJSON() failed [mt_data]");
		return NULL;
	}
...
OpenAPI_transfer_mt_data_req_data_parseFromJSON(
	...
	mt_data =
		cJSON_GetObjectItemCaseSensitive(transfer_mt_data_req_dataJSON,
		                                 "mtData");
	if(!mt_data) {
		ogs_error(
			"OpenAPI_transfer_mt_data_req_data_parseFromJSON() failed [mt_data]");
		goto end;
	}
	...
	transfer_mt_data_req_data_local_var =
		OpenAPI_transfer_mt_data_req_data_create(
			mt_data_local_nonprim
			);
...
OpenAPI_transfer_mt_data_req_data_t *OpenAPI_transfer_mt_data_req_data_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_transfer_mt_data_req_data_convertToJSON() failed");
		return NULL;
	}
