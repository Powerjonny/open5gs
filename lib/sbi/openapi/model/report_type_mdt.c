...
char * OpenAPI_report_type_mdt_ToString(
	...
	const char *report_type_mdtArray[] = { "NULL", "PERIODICAL",
		                               "EVENT_TRIGGED" };
	size_t sizeofArray = sizeof(report_type_mdtArray) /
	                     sizeof(report_type_mdtArray[0]);
...
OpenAPI_report_type_mdt_e OpenAPI_report_type_mdt_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(report_type_mdt,
		          report_type_mdtArray[stringToReturn]) == 0) {
