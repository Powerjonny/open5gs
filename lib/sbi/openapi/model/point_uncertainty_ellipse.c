...
OpenAPI_point_uncertainty_ellipse_t *OpenAPI_point_uncertainty_ellipse_create(
	...
	OpenAPI_point_uncertainty_ellipse_t *point_uncertainty_ellipse_local_var
	        = ogs_malloc(sizeof(OpenAPI_point_uncertainty_ellipse_t));
...
void OpenAPI_point_uncertainty_ellipse_free(
	OpenAPI_point_uncertainty_ellipse_t *point_uncertainty_ellipse) {
...
cJSON *OpenAPI_point_uncertainty_ellipse_convertToJSON(
	OpenAPI_point_uncertainty_ellipse_t *point_uncertainty_ellipse) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(point_uncertainty_ellipse == NULL) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_convertToJSON() failed [PointUncertaintyEllipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!point_uncertainty_ellipse->point) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_convertToJSON() failed [point]");
		return NULL;
	}
	...
	if(!point_uncertainty_ellipse->uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_convertToJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_point_uncertainty_ellipse_parseFromJSON(
	...
	if(!shape) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	uncertainty_ellipse =
		cJSON_GetObjectItemCaseSensitive(point_uncertainty_ellipseJSON,
		                                 "uncertaintyEllipse");
	if(!uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_parseFromJSON() failed [confidence]");
		goto end;
	}
	...
	point_uncertainty_ellipse_local_var =
		OpenAPI_point_uncertainty_ellipse_create(
			shapeVariable,
			point_local_nonprim,
			uncertainty_ellipse_local_nonprim,
...
OpenAPI_point_uncertainty_ellipse_t *OpenAPI_point_uncertainty_ellipse_copy(
	OpenAPI_point_uncertainty_ellipse_t	*dst,
	OpenAPI_point_uncertainty_ellipse_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_convertToJSON() failed");
		return NULL;
	}
