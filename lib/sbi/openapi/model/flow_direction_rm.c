...
OpenAPI_flow_direction_rm_t *OpenAPI_flow_direction_rm_create() {
	OpenAPI_flow_direction_rm_t *flow_direction_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_flow_direction_rm_t));
...
cJSON *OpenAPI_flow_direction_rm_convertToJSON(
	...
	if(flow_direction_rm == NULL) {
		ogs_error(
			"OpenAPI_flow_direction_rm_convertToJSON() failed [FlowDirectionRm]");
		return NULL;
	}
