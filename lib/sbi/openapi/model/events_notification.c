...
OpenAPI_events_notification_t *OpenAPI_events_notification_create(
	OpenAPI_list_t *ad_reports, OpenAPI_access_type_e access_type,
	...
	OpenAPI_events_notification_t *events_notification_local_var =
		ogs_malloc(sizeof(OpenAPI_events_notification_t));
	...
	events_notification_local_var->failed_resourc_alloc_reports =
		failed_resourc_alloc_reports;
	events_notification_local_var->succ_resourc_alloc_reports =
		succ_resourc_alloc_reports;
	events_notification_local_var->no_net_loc_supp = no_net_loc_supp;
	events_notification_local_var->out_of_cred_reports =
		out_of_cred_reports;
	...
	events_notification_local_var->sat_backhaul_category =
	...
	events_notification_local_var->tsn_bridge_man_cont =
		tsn_bridge_man_cont;
	events_notification_local_var->tsn_port_man_cont_dstt =
		tsn_port_man_cont_dstt;
	events_notification_local_var->tsn_port_man_cont_nwtts =
		tsn_port_man_cont_nwtts;

	return events_notification_local_var;
}

void OpenAPI_events_notification_free(
	OpenAPI_events_notification_t *events_notification) {
	...
	if(events_notification->failed_resourc_alloc_reports) {
		OpenAPI_list_for_each(
			events_notification->failed_resourc_alloc_reports,
			node) {
	...
	if(events_notification->succ_resourc_alloc_reports) {
		OpenAPI_list_for_each(
			events_notification->succ_resourc_alloc_reports, node) {
			OpenAPI_resources_allocation_info_free(node->data);
		}
		OpenAPI_list_free(
			events_notification->succ_resourc_alloc_reports);
		events_notification->succ_resourc_alloc_reports = NULL;
	}
	if(events_notification->out_of_cred_reports) {
		OpenAPI_list_for_each(events_notification->out_of_cred_reports,
		                      node) {
	...
	if(events_notification->qos_mon_reports) {
		OpenAPI_list_for_each(events_notification->qos_mon_reports,
		                      node) {
	...
	if(events_notification->tsn_bridge_man_cont) {
		OpenAPI_bridge_management_container_free(
			events_notification->tsn_bridge_man_cont);
	...
	if(events_notification->tsn_port_man_cont_nwtts) {
		OpenAPI_list_for_each(
			events_notification->tsn_port_man_cont_nwtts, node) {
...
cJSON *OpenAPI_events_notification_convertToJSON(
	OpenAPI_events_notification_t *events_notification) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(events_notification == NULL) {
		ogs_error(
			"OpenAPI_events_notification_convertToJSON() failed [EventsNotification]");
		return NULL;
	}
	...
	if(events_notification->ad_reports) {
		...
		if(ad_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [ad_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_notification->ad_reports, node) {
			cJSON *itemLocal =
	...
	if(events_notification->access_type != OpenAPI_access_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [access_type]");
			goto end;
		}
	}
	...
	if(events_notification->add_access_info) {
		...
		if(add_access_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [add_access_info]");
			goto end;
		}
	...
	if(events_notification->rel_access_info) {
		...
		if(rel_access_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [rel_access_info]");
			goto end;
		}
	...
	if(events_notification->an_charg_addr) {
		...
		if(an_charg_addr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [an_charg_addr]");
			goto end;
		}
	...
	if(events_notification->an_charg_ids) {
		...
		if(an_charg_idsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [an_charg_ids]");
			goto end;
		}
		OpenAPI_list_for_each(events_notification->an_charg_ids, node) {
			cJSON *itemLocal =
	...
	if(events_notification->an_gw_addr) {
		cJSON *an_gw_addr_local_JSON =
			OpenAPI_an_gw_address_convertToJSON(
				events_notification->an_gw_addr);
		if(an_gw_addr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [an_gw_addr]");
			goto end;
		}
	...
	if(!events_notification->ev_subs_uri) {
		ogs_error(
			"OpenAPI_events_notification_convertToJSON() failed [ev_subs_uri]");
		return NULL;
	}
	...
	if(!events_notification->ev_notifs) {
		ogs_error(
			"OpenAPI_events_notification_convertToJSON() failed [ev_notifs]");
		return NULL;
	}
	...
	if(events_notification->failed_resourc_alloc_reports) {
		...
		if(failed_resourc_alloc_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [failed_resourc_alloc_reports]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_notification->failed_resourc_alloc_reports,
	...
	if(events_notification->succ_resourc_alloc_reports) {
		...
		if(succ_resourc_alloc_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [succ_resourc_alloc_reports]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_notification->succ_resourc_alloc_reports, node) {
	   ...
	   OpenAPI_net_loc_access_support_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [no_net_loc_supp]");
			goto end;
		}
	}
	...
	if(events_notification->out_of_cred_reports) {
		...
		if(out_of_cred_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [out_of_cred_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_notification->out_of_cred_reports,
		                      node) {
	...
	if(events_notification->plmn_id) {
		cJSON *plmn_id_local_JSON =
			OpenAPI_plmn_id_nid_convertToJSON(
				events_notification->plmn_id);
		if(plmn_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [plmn_id]");
			goto end;
		}
	...
	if(events_notification->qnc_reports) {
		...
		if(qnc_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [qnc_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_notification->qnc_reports, node) {
			cJSON *itemLocal =
	...
	if(events_notification->qos_mon_reports) {
		...
		if(qos_mon_reportsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [qos_mon_reports]");
			goto end;
		}
		OpenAPI_list_for_each(events_notification->qos_mon_reports,
		                      node) {
	...
	if(events_notification->ran_nas_rel_causes) {
		...
		if(ran_nas_rel_causesList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [ran_nas_rel_causes]");
			goto end;
		}
		OpenAPI_list_for_each(events_notification->ran_nas_rel_causes,
		                      node) {
	...
	if(events_notification->rat_type != OpenAPI_rat_type_NULL) {
		if(cJSON_AddStringToObject(item, "ratType",
						   ...
						   events_notification->rat_type))
		   == NULL)
		{
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [rat_type]");
			goto end;
		}
	}

	if(events_notification->sat_backhaul_category !=
	   OpenAPI_satellite_backhaul_category_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [sat_backhaul_category]");
			goto end;
		}
	}
	...
	if(events_notification->ue_loc) {
		cJSON *ue_loc_local_JSON =
			OpenAPI_user_location_convertToJSON(
				events_notification->ue_loc);
		if(ue_loc_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [ue_loc]");
			goto end;
		}
	...
	if(events_notification->ue_loc_time) {
		if(cJSON_AddStringToObject(item, "ueLocTime",
		                           events_notification->ue_loc_time) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [ue_loc_time]");
			goto end;
		}
	}
	...
	if(events_notification->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           events_notification->ue_time_zone) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(events_notification->usg_rep) {
		cJSON *usg_rep_local_JSON =
			OpenAPI_accumulated_usage_convertToJSON(
				events_notification->usg_rep);
		if(usg_rep_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [usg_rep]");
			goto end;
		}
	...
	if(events_notification->tsn_bridge_man_cont) {
		...
		if(tsn_bridge_man_cont_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [tsn_bridge_man_cont]");
			goto end;
		}
	...
	if(events_notification->tsn_port_man_cont_dstt) {
		...
		if(tsn_port_man_cont_dstt_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [tsn_port_man_cont_dstt]");
			goto end;
		}
	...
	if(events_notification->tsn_port_man_cont_nwtts) {
		...
		if(tsn_port_man_cont_nwttsList == NULL) {
			ogs_error(
				"OpenAPI_events_notification_convertToJSON() failed [tsn_port_man_cont_nwtts]");
			goto end;
		}
		OpenAPI_list_for_each(
			events_notification->tsn_port_man_cont_nwtts, node) {
...
OpenAPI_events_notification_t *OpenAPI_events_notification_parseFromJSON(
	cJSON *events_notificationJSON) {
	...
	ad_reports = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                              "adReports");
	if(ad_reports) {
		cJSON *ad_reports_local = NULL;
		if(!cJSON_IsArray(ad_reports)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [ad_reports]");
			goto end;
		}
	...
	access_type = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                               "accessType");
	if(access_type) {
		if(!cJSON_IsString(access_type)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [access_type]");
			goto end;
		}
		access_typeVariable =
	...
	add_access_info =
		cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
		                                 "addAccessInfo");
	if(add_access_info) {
	...
	an_charg_ids = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                                "anChargIds");
	if(an_charg_ids) {
		cJSON *an_charg_ids_local = NULL;
		if(!cJSON_IsArray(an_charg_ids)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [an_charg_ids]");
			goto end;
		}
	...
	an_gw_addr = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                              "anGwAddr");
	if(an_gw_addr) {
	...
	ev_subs_uri = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                               "evSubsUri");
	if(!ev_subs_uri) {
		ogs_error(
			"OpenAPI_events_notification_parseFromJSON() failed [ev_subs_uri]");
		goto end;
	}
	...
	ev_notifs = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                             "evNotifs");
	if(!ev_notifs) {
		ogs_error(
			"OpenAPI_events_notification_parseFromJSON() failed [ev_notifs]");
		goto end;
	}
	...
	if(failed_resourc_alloc_reports) {
		...
		if(!cJSON_IsArray(failed_resourc_alloc_reports)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [failed_resourc_alloc_reports]");
			goto end;
		}
	...
	if(succ_resourc_alloc_reports) {
		...
		if(!cJSON_IsArray(succ_resourc_alloc_reports)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [succ_resourc_alloc_reports]");
			goto end;
		}
	...
	if(no_net_loc_supp) {
		if(!cJSON_IsString(no_net_loc_supp)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [no_net_loc_supp]");
			goto end;
		}
	...
	if(out_of_cred_reports) {
		...
		if(!cJSON_IsArray(out_of_cred_reports)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [out_of_cred_reports]");
			goto end;
		}
	...
	plmn_id = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                           "plmnId");
	if(plmn_id) {
	...
	qnc_reports = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                               "qncReports");
	if(qnc_reports) {
		cJSON *qnc_reports_local = NULL;
		if(!cJSON_IsArray(qnc_reports)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [qnc_reports]");
			goto end;
		}
	...
	if(qos_mon_reports) {
		...
		if(!cJSON_IsArray(qos_mon_reports)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [qos_mon_reports]");
			goto end;
		}
	...
	if(ran_nas_rel_causes) {
		...
		if(!cJSON_IsArray(ran_nas_rel_causes)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [ran_nas_rel_causes]");
			goto end;
		}
	...
	rat_type = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                            "ratType");
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	if(sat_backhaul_category) {
		if(!cJSON_IsString(sat_backhaul_category)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [sat_backhaul_category]");
			goto end;
		}
	...
	ue_loc = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                          "ueLoc");
	if(ue_loc) {
	...
	ue_loc_time = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                               "ueLocTime");
	if(ue_loc_time) {
		...
		{
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [ue_loc_time]");
			goto end;
		}
	}

	ue_time_zone = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                                "ueTimeZone");
	if(ue_time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}

	usg_rep = cJSON_GetObjectItemCaseSensitive(events_notificationJSON,
	                                           "usgRep");
	if(usg_rep) {
	...
	if(tsn_port_man_cont_nwtts) {
		...
		if(!cJSON_IsArray(tsn_port_man_cont_nwtts)) {
			ogs_error(
				"OpenAPI_events_notification_parseFromJSON() failed [tsn_port_man_cont_nwtts]");
			goto end;
		}
...
OpenAPI_events_notification_t *OpenAPI_events_notification_copy(
	OpenAPI_events_notification_t	*dst,
	OpenAPI_events_notification_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
