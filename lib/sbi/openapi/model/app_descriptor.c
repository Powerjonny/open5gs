...
OpenAPI_app_descriptor_t *OpenAPI_app_descriptor_create(char	*os_id,
                                                        char	*app_id) {
	OpenAPI_app_descriptor_t *app_descriptor_local_var =
...
cJSON *OpenAPI_app_descriptor_convertToJSON(
	OpenAPI_app_descriptor_t *app_descriptor) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(app_descriptor == NULL) {
		ogs_error(
			"OpenAPI_app_descriptor_convertToJSON() failed [AppDescriptor]");
		return NULL;
	}
	...
	if(app_descriptor->os_id) {
		...
		{
			ogs_error(
				"OpenAPI_app_descriptor_convertToJSON() failed [os_id]");
			goto end;
		}
	}
	...
	if(app_descriptor->app_id) {
		...
		{
			ogs_error(
				"OpenAPI_app_descriptor_convertToJSON() failed [app_id]");
			goto end;
		}
	}
...
OpenAPI_app_descriptor_t *OpenAPI_app_descriptor_parseFromJSON(
	cJSON *app_descriptorJSON) {
	...
	if(os_id) {
		...
		{
			ogs_error(
				"OpenAPI_app_descriptor_parseFromJSON() failed [os_id]");
			goto end;
		}
	}
	...
	if(app_id) {
		...
		{
			ogs_error(
				"OpenAPI_app_descriptor_parseFromJSON() failed [app_id]");
			goto end;
		}
	}
	...
	app_descriptor_local_var = OpenAPI_app_descriptor_create(
		os_id &&
		!cJSON_IsNull(os_id) ? ogs_strdup(os_id->valuestring) : NULL,
		app_id &&
...
OpenAPI_app_descriptor_t *OpenAPI_app_descriptor_copy(
	OpenAPI_app_descriptor_t *dst, OpenAPI_app_descriptor_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
