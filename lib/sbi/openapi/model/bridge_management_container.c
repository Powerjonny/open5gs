...
OpenAPI_bridge_management_container_create(char *bridge_man_cont) {
	OpenAPI_bridge_management_container_t *
	        bridge_management_container_local_var =
		ogs_malloc(sizeof(OpenAPI_bridge_management_container_t));
	ogs_assert(bridge_management_container_local_var);

	bridge_management_container_local_var->bridge_man_cont =
		bridge_man_cont;
...
cJSON *OpenAPI_bridge_management_container_convertToJSON(
	...
	if(bridge_management_container == NULL) {
		ogs_error(
			"OpenAPI_bridge_management_container_convertToJSON() failed [BridgeManagementContainer]");
		return NULL;
	}
	...
	if(!bridge_management_container->bridge_man_cont) {
		ogs_error(
			"OpenAPI_bridge_management_container_convertToJSON() failed [bridge_man_cont]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "bridgeManCont",
	                           bridge_management_container->bridge_man_cont)
	   == NULL)
	{
		ogs_error(
			"OpenAPI_bridge_management_container_convertToJSON() failed [bridge_man_cont]");
...
OpenAPI_bridge_management_container_parseFromJSON(
	...
	OpenAPI_bridge_management_container_t *
	        bridge_management_container_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *bridge_man_cont = NULL;
	bridge_man_cont =
		cJSON_GetObjectItemCaseSensitive(
			bridge_management_containerJSON, "bridgeManCont");
	if(!bridge_man_cont) {
		ogs_error(
			"OpenAPI_bridge_management_container_parseFromJSON() failed [bridge_man_cont]");
		goto end;
	}
	...
	bridge_management_container_local_var =
		OpenAPI_bridge_management_container_create(
...
OpenAPI_bridge_management_container_t *OpenAPI_bridge_management_container_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_bridge_management_container_convertToJSON() failed");
		return NULL;
	}
