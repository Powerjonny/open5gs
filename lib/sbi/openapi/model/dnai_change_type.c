...
char * OpenAPI_dnai_change_type_ToString(
	...
	const char *dnai_change_typeArray[] = { "NULL", "EARLY", "EARLY_LATE",
		                                "LATE" };
	size_t sizeofArray = sizeof(dnai_change_typeArray) /
	                     sizeof(dnai_change_typeArray[0]);
...
OpenAPI_dnai_change_type_e OpenAPI_dnai_change_type_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(dnai_change_type,
		          dnai_change_typeArray[stringToReturn]) == 0) {
