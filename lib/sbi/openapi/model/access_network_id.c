...
char * OpenAPI_access_network_id_ToString(
	...
	const char *access_network_idArray[] = { "NULL", "HRPD", "WIMAX",
		                                 "WLAN", "ETHERNET" };
	size_t sizeofArray = sizeof(access_network_idArray) /
	                     sizeof(access_network_idArray[0]);
...
OpenAPI_access_network_id_e OpenAPI_access_network_id_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(access_network_id,
		          access_network_idArray[stringToReturn]) == 0) {
