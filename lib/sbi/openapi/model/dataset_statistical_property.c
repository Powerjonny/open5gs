...
OpenAPI_dataset_statistical_property_create() {
	OpenAPI_dataset_statistical_property_t *
	        dataset_statistical_property_local_var =
		ogs_malloc(sizeof(OpenAPI_dataset_statistical_property_t));
...
void OpenAPI_dataset_statistical_property_free(
	OpenAPI_dataset_statistical_property_t *dataset_statistical_property) {
...
cJSON *OpenAPI_dataset_statistical_property_convertToJSON(
	...
	if(dataset_statistical_property == NULL) {
		ogs_error(
			"OpenAPI_dataset_statistical_property_convertToJSON() failed [DatasetStatisticalProperty]");
		return NULL;
	}
...
OpenAPI_dataset_statistical_property_parseFromJSON(
	...
	OpenAPI_dataset_statistical_property_t *
	        dataset_statistical_property_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	dataset_statistical_property_local_var =
		OpenAPI_dataset_statistical_property_create(
			);
...
OpenAPI_dataset_statistical_property_copy(
	OpenAPI_dataset_statistical_property_t	*dst,
	OpenAPI_dataset_statistical_property_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_dataset_statistical_property_convertToJSON() failed");
		return NULL;
	}
