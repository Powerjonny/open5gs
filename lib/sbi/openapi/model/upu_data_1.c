...
OpenAPI_upu_data_1_t *OpenAPI_upu_data_1_create(char *sec_packet,
                                                OpenAPI_list_t *
                                                default_conf_nssai,
                                                char *routing_id) {
	OpenAPI_upu_data_1_t *upu_data_1_local_var =
		ogs_malloc(sizeof(OpenAPI_upu_data_1_t));
...
cJSON *OpenAPI_upu_data_1_convertToJSON(OpenAPI_upu_data_1_t *upu_data_1) {
	...
	if(upu_data_1 == NULL) {
		ogs_error(
			"OpenAPI_upu_data_1_convertToJSON() failed [UpuData_1]");
		return NULL;
	}
	...
	if(upu_data_1->sec_packet) {
		...
		{
			ogs_error(
				"OpenAPI_upu_data_1_convertToJSON() failed [sec_packet]");
			goto end;
		}
	}
	...
	if(upu_data_1->default_conf_nssai) {
		...
		if(default_conf_nssaiList == NULL) {
			ogs_error(
				"OpenAPI_upu_data_1_convertToJSON() failed [default_conf_nssai]");
			goto end;
		}
		OpenAPI_list_for_each(upu_data_1->default_conf_nssai, node) {
			cJSON *itemLocal =
	...
	if(upu_data_1->routing_id) {
		...
		{
			ogs_error(
				"OpenAPI_upu_data_1_convertToJSON() failed [routing_id]");
			goto end;
		}
	}
...
OpenAPI_upu_data_1_t *OpenAPI_upu_data_1_parseFromJSON(cJSON *upu_data_1JSON) {
	...
	sec_packet = cJSON_GetObjectItemCaseSensitive(upu_data_1JSON,
	                                              "secPacket");
	if(sec_packet) {
		...
		{
			ogs_error(
				"OpenAPI_upu_data_1_parseFromJSON() failed [sec_packet]");
			goto end;
		}
	}

	default_conf_nssai = cJSON_GetObjectItemCaseSensitive(upu_data_1JSON,
	                                                      "defaultConfNssai");
	if(default_conf_nssai) {
		cJSON *default_conf_nssai_local = NULL;
		if(!cJSON_IsArray(default_conf_nssai)) {
			ogs_error(
				"OpenAPI_upu_data_1_parseFromJSON() failed [default_conf_nssai]");
			goto end;
		}
	...
	routing_id = cJSON_GetObjectItemCaseSensitive(upu_data_1JSON,
	                                              "routingId");
	if(routing_id) {
		...
		{
			ogs_error(
				"OpenAPI_upu_data_1_parseFromJSON() failed [routing_id]");
			goto end;
		}
	}
...
OpenAPI_upu_data_1_t *OpenAPI_upu_data_1_copy(OpenAPI_upu_data_1_t	*dst,
                                              OpenAPI_upu_data_1_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
