...
OpenAPI_smf_registration_t *OpenAPI_smf_registration_create(
	...
	OpenAPI_smf_registration_t *smf_registration_local_var =
		ogs_malloc(sizeof(OpenAPI_smf_registration_t));
	...
	smf_registration_local_var->is_emergency_services =
		is_emergency_services;
	smf_registration_local_var->emergency_services = emergency_services;
	smf_registration_local_var->pcscf_restoration_callback_uri =
	...
	smf_registration_local_var->data_restoration_callback_uri =
	...
	smf_registration_local_var->last_synchronization_time =
...
cJSON *OpenAPI_smf_registration_convertToJSON(
	...
	if(smf_registration == NULL) {
		ogs_error(
			"OpenAPI_smf_registration_convertToJSON() failed [SmfRegistration]");
		return NULL;
	}
	...
	if(!smf_registration->smf_instance_id) {
		ogs_error(
			"OpenAPI_smf_registration_convertToJSON() failed [smf_instance_id]");
		return NULL;
	}
	...
	if(smf_registration->smf_set_id) {
		if(cJSON_AddStringToObject(item, "smfSetId",
		                           smf_registration->smf_set_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [smf_set_id]");
			goto end;
		}
	}
	...
	if(smf_registration->supported_features) {
		if(cJSON_AddStringToObject(item, "supportedFeatures",
		                           smf_registration->supported_features)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [supported_features]");
			goto end;
		}
	}

	if(cJSON_AddNumberToObject(item, "pduSessionId",
	                           smf_registration->pdu_session_id) == NULL)
	{
		ogs_error(
			"OpenAPI_smf_registration_convertToJSON() failed [pdu_session_id]");
		goto end;
	}

	if(!smf_registration->single_nssai) {
		ogs_error(
			"OpenAPI_smf_registration_convertToJSON() failed [single_nssai]");
		return NULL;
	}
	cJSON *single_nssai_local_JSON =
		OpenAPI_snssai_convertToJSON(smf_registration->single_nssai);
	...
	if(smf_registration->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [dnn]");
			goto end;
		}
	}

	if(smf_registration->is_emergency_services) {
		if(cJSON_AddBoolToObject(item, "emergencyServices",
		                         smf_registration->emergency_services)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [emergency_services]");
			goto end;
		}
	}
	...
	if(smf_registration->pcscf_restoration_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [pcscf_restoration_callback_uri]");
			goto end;
		}
	}
	...
	if(!smf_registration->plmn_id) {
		ogs_error(
			"OpenAPI_smf_registration_convertToJSON() failed [plmn_id]");
		return NULL;
	}
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_convertToJSON(smf_registration->plmn_id);
	...
	if(smf_registration->pgw_fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [pgw_fqdn]");
			goto end;
		}
	}
	...
	if(smf_registration->pgw_ip_addr) {
		cJSON *pgw_ip_addr_local_JSON =
			OpenAPI_ip_address_convertToJSON(
				smf_registration->pgw_ip_addr);
		if(pgw_ip_addr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [pgw_ip_addr]");
			goto end;
		}
	...
	if(smf_registration->is_epdg_ind) {
		if(cJSON_AddBoolToObject(item, "epdgInd",
		                         smf_registration->epdg_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [epdg_ind]");
			goto end;
		}
	}
	...
	if(smf_registration->dereg_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [dereg_callback_uri]");
			goto end;
		}
	}

	if(smf_registration->registration_reason !=
	   OpenAPI_registration_reason_NULL)
	{
		if(cJSON_AddStringToObject(item, "registrationReason",
		                           OpenAPI_registration_reason_ToString(
						   smf_registration->
						   registration_reason)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [registration_reason]");
			goto end;
		}
	}
	...
	if(smf_registration->registration_time) {
		if(cJSON_AddStringToObject(item, "registrationTime",
		                           smf_registration->registration_time)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [registration_time]");
			goto end;
		}
	}
	...
	if(smf_registration->context_info) {
		cJSON *context_info_local_JSON =
			OpenAPI_context_info_convertToJSON(
				smf_registration->context_info);
		if(context_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [context_info]");
			goto end;
		}
	...
	if(smf_registration->pcf_id) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [pcf_id]");
			goto end;
		}
	}
	...
	if(smf_registration->data_restoration_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [data_restoration_callback_uri]");
			goto end;
		}
	}
	...
	if(smf_registration->reset_ids) {
		...
		if(reset_idsList == NULL) {
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [reset_ids]");
			goto end;
		}
		OpenAPI_list_for_each(smf_registration->reset_ids, node) {
	...
	if(smf_registration->is_udr_restart_ind) {
		if(cJSON_AddBoolToObject(item, "udrRestartInd",
		                         smf_registration->udr_restart_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [udr_restart_ind]");
			goto end;
		}
	}
	...
	if(smf_registration->last_synchronization_time) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_convertToJSON() failed [last_synchronization_time]");
			goto end;
		}
	}
...
OpenAPI_smf_registration_t *OpenAPI_smf_registration_parseFromJSON(
	...
	smf_instance_id = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                                   "smfInstanceId");
	if(!smf_instance_id) {
		ogs_error(
			"OpenAPI_smf_registration_parseFromJSON() failed [smf_instance_id]");
		goto end;
	}
	...
	smf_set_id = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                              "smfSetId");
	if(smf_set_id) {
		if(!cJSON_IsString(smf_set_id) &&
		   !cJSON_IsNull(smf_set_id))
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [smf_set_id]");
			goto end;
		}
	}
	...
	pdu_session_id = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                                  "pduSessionId");
	if(!pdu_session_id) {
		ogs_error(
			"OpenAPI_smf_registration_parseFromJSON() failed [pdu_session_id]");
		goto end;
	}
	...
	single_nssai = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                                "singleNssai");
	if(!single_nssai) {
		ogs_error(
			"OpenAPI_smf_registration_parseFromJSON() failed [single_nssai]");
		goto end;
	}
	...
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(emergency_services) {
		if(!cJSON_IsBool(emergency_services)) {
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [emergency_services]");
			goto end;
		}
	}
	...
	if(pcscf_restoration_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [pcscf_restoration_callback_uri]");
			goto end;
		}
	}

	plmn_id = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                           "plmnId");
	if(!plmn_id) {
		ogs_error(
			"OpenAPI_smf_registration_parseFromJSON() failed [plmn_id]");
		goto end;
	}
	...
	pgw_fqdn = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                            "pgwFqdn");
	if(pgw_fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [pgw_fqdn]");
			goto end;
		}
	}

	pgw_ip_addr = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                               "pgwIpAddr");
	if(pgw_ip_addr) {
	...
	epdg_ind = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                            "epdgInd");
	if(epdg_ind) {
		if(!cJSON_IsBool(epdg_ind)) {
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [epdg_ind]");
			goto end;
		}
	}
	...
	if(dereg_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [dereg_callback_uri]");
			goto end;
		}
	}
	...
	if(registration_reason) {
		if(!cJSON_IsString(registration_reason)) {
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [registration_reason]");
			goto end;
		}
		registration_reasonVariable =
			OpenAPI_registration_reason_FromString(
				registration_reason->valuestring);
	}
	...
	if(registration_time) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [registration_time]");
			goto end;
		}
	}

	context_info = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                                "contextInfo");
	if(context_info) {
	...
	pcf_id = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                          "pcfId");
	if(pcf_id) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [pcf_id]");
			goto end;
		}
	}
	...
	if(data_restoration_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [data_restoration_callback_uri]");
			goto end;
		}
	}

	reset_ids = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                             "resetIds");
	if(reset_ids) {
		cJSON *reset_ids_local = NULL;
		if(!cJSON_IsArray(reset_ids)) {
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [reset_ids]");
			goto end;
		}
	...
	udr_restart_ind = cJSON_GetObjectItemCaseSensitive(smf_registrationJSON,
	                                                   "udrRestartInd");
	if(udr_restart_ind) {
		if(!cJSON_IsBool(udr_restart_ind)) {
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [udr_restart_ind]");
			goto end;
		}
	}
	...
	if(last_synchronization_time) {
		...
		{
			ogs_error(
				"OpenAPI_smf_registration_parseFromJSON() failed [last_synchronization_time]");
			goto end;
		}
	}
	...
	smf_registration_local_var = OpenAPI_smf_registration_create(
		...
		smf_set_id &&
		!cJSON_IsNull(smf_set_id) ?
		ogs_strdup(smf_set_id->valuestring) : NULL,
		supported_features &&
		!cJSON_IsNull(supported_features) ?
		...
		pcscf_restoration_callback_uri &&
		!cJSON_IsNull(pcscf_restoration_callback_uri) ?
		ogs_strdup(pcscf_restoration_callback_uri->valuestring) : NULL,
		...
		dereg_callback_uri &&
		!cJSON_IsNull(dereg_callback_uri) ?
		ogs_strdup(dereg_callback_uri->valuestring) : NULL,
		...
		last_synchronization_time &&
		!cJSON_IsNull(last_synchronization_time) ?
		ogs_strdup(last_synchronization_time->valuestring) : NULL
		);
