...
OpenAPI_nrf_info_served_ausf_info_value_create(char		*group_id,
                                               OpenAPI_list_t	*supi_ranges,
                                               OpenAPI_list_t *
                                               routing_indicators,
                                               OpenAPI_list_t *suci_infos) {
	OpenAPI_nrf_info_served_ausf_info_value_t *
	        nrf_info_served_ausf_info_value_local_var =
		ogs_malloc(sizeof(OpenAPI_nrf_info_served_ausf_info_value_t));
	...
	nrf_info_served_ausf_info_value_local_var->routing_indicators =
		routing_indicators;
...
void OpenAPI_nrf_info_served_ausf_info_value_free(
	OpenAPI_nrf_info_served_ausf_info_value_t *
	...
	if(nrf_info_served_ausf_info_value->supi_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_ausf_info_value->supi_ranges, node) {
	...
	if(nrf_info_served_ausf_info_value->routing_indicators) {
		OpenAPI_list_for_each(
			nrf_info_served_ausf_info_value->routing_indicators,
			node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
	...
	if(nrf_info_served_ausf_info_value->suci_infos) {
		OpenAPI_list_for_each(
			nrf_info_served_ausf_info_value->suci_infos, node) {
...
cJSON *OpenAPI_nrf_info_served_ausf_info_value_convertToJSON(
	OpenAPI_nrf_info_served_ausf_info_value_t *
	nrf_info_served_ausf_info_value) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nrf_info_served_ausf_info_value == NULL) {
		ogs_error(
			"OpenAPI_nrf_info_served_ausf_info_value_convertToJSON() failed [NrfInfo_servedAusfInfo_value]");
		return NULL;
	}
	...
	if(nrf_info_served_ausf_info_value->group_id) {
		...
		{
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_convertToJSON() failed [group_id]");
			goto end;
		}
	}
	...
	if(nrf_info_served_ausf_info_value->supi_ranges) {
		...
		if(supi_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_convertToJSON() failed [supi_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_ausf_info_value->supi_ranges, node) {
	...
	if(nrf_info_served_ausf_info_value->routing_indicators) {
		...
		if(routing_indicatorsList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_convertToJSON() failed [routing_indicators]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_ausf_info_value->routing_indicators,
	...
	if(nrf_info_served_ausf_info_value->suci_infos) {
		...
		if(suci_infosList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_convertToJSON() failed [suci_infos]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_ausf_info_value->suci_infos, node) {
...
OpenAPI_nrf_info_served_ausf_info_value_parseFromJSON(
	cJSON *nrf_info_served_ausf_info_valueJSON) {
	OpenAPI_nrf_info_served_ausf_info_value_t *
	        nrf_info_served_ausf_info_value_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *group_id = NULL;
	...
	group_id =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_ausf_info_valueJSON, "groupId");
	if(group_id) {
		if(!cJSON_IsString(group_id) &&
		   !cJSON_IsNull(group_id))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_parseFromJSON() failed [group_id]");
			goto end;
		}
	}
	...
	supi_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_ausf_info_valueJSON, "supiRanges");
	if(supi_ranges) {
		cJSON *supi_ranges_local = NULL;
		if(!cJSON_IsArray(supi_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_parseFromJSON() failed [supi_ranges]");
			goto end;
		}
	...
	if(routing_indicators) {
		...
		if(!cJSON_IsArray(routing_indicators)) {
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_parseFromJSON() failed [routing_indicators]");
			goto end;
		}
	...
	suci_infos =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_ausf_info_valueJSON, "suciInfos");
	if(suci_infos) {
		cJSON *suci_infos_local = NULL;
		if(!cJSON_IsArray(suci_infos)) {
			ogs_error(
				"OpenAPI_nrf_info_served_ausf_info_value_parseFromJSON() failed [suci_infos]");
			goto end;
		}
...
OpenAPI_nrf_info_served_ausf_info_value_t *
OpenAPI_nrf_info_served_ausf_info_value_copy(
	OpenAPI_nrf_info_served_ausf_info_value_t	*dst,
	OpenAPI_nrf_info_served_ausf_info_value_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nrf_info_served_ausf_info_value_convertToJSON() failed");
		return NULL;
	}
