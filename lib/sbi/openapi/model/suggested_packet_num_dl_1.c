...
OpenAPI_suggested_packet_num_dl_1_t *OpenAPI_suggested_packet_num_dl_1_create(
	...
	OpenAPI_suggested_packet_num_dl_1_t *suggested_packet_num_dl_1_local_var
	        = ogs_malloc(sizeof(OpenAPI_suggested_packet_num_dl_1_t));
	ogs_assert(suggested_packet_num_dl_1_local_var);

	suggested_packet_num_dl_1_local_var->suggested_packet_num_dl =
...
void OpenAPI_suggested_packet_num_dl_1_free(
...
cJSON *OpenAPI_suggested_packet_num_dl_1_convertToJSON(
	...
	if(suggested_packet_num_dl_1 == NULL) {
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_1_convertToJSON() failed [SuggestedPacketNumDl_1]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(cJSON_AddNumberToObject(item, "suggestedPacketNumDl",
	                           suggested_packet_num_dl_1->
	                           suggested_packet_num_dl) == NULL)
	{
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_1_convertToJSON() failed [suggested_packet_num_dl]");
		goto end;
	}
	...
	if(suggested_packet_num_dl_1->validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_suggested_packet_num_dl_1_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_suggested_packet_num_dl_1_parseFromJSON(
	cJSON *suggested_packet_num_dl_1JSON) {
	OpenAPI_suggested_packet_num_dl_1_t *suggested_packet_num_dl_1_local_var
	        = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	suggested_packet_num_dl =
		cJSON_GetObjectItemCaseSensitive(suggested_packet_num_dl_1JSON,
		                                 "suggestedPacketNumDl");
	if(!suggested_packet_num_dl) {
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_1_parseFromJSON() failed [suggested_packet_num_dl]");
		goto end;
	}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_suggested_packet_num_dl_1_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_suggested_packet_num_dl_1_t *OpenAPI_suggested_packet_num_dl_1_copy(
	OpenAPI_suggested_packet_num_dl_1_t	*dst,
	OpenAPI_suggested_packet_num_dl_1_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_1_convertToJSON() failed");
		return NULL;
	}
