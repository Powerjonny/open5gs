...
OpenAPI_access_right_status_t *OpenAPI_access_right_status_create() {
	OpenAPI_access_right_status_t *access_right_status_local_var =
		ogs_malloc(sizeof(OpenAPI_access_right_status_t));
...
void OpenAPI_access_right_status_free(
	OpenAPI_access_right_status_t *access_right_status) {
...
cJSON *OpenAPI_access_right_status_convertToJSON(
	OpenAPI_access_right_status_t *access_right_status) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(access_right_status == NULL) {
		ogs_error(
			"OpenAPI_access_right_status_convertToJSON() failed [AccessRightStatus]");
		return NULL;
	}
...
OpenAPI_access_right_status_t *OpenAPI_access_right_status_parseFromJSON(
	cJSON *access_right_statusJSON) {
...
OpenAPI_access_right_status_t *OpenAPI_access_right_status_copy(
	OpenAPI_access_right_status_t	*dst,
	OpenAPI_access_right_status_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
