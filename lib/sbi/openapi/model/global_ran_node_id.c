...
OpenAPI_global_ran_node_id_t *OpenAPI_global_ran_node_id_create(
	OpenAPI_plmn_id_t *plmn_id, char *n3_iwf_id, OpenAPI_gnb_id_t *g_nb_id,
	char *nge_nb_id, char *wagf_id, char *tngf_id, char *nid,
	char *e_nb_id) {
	OpenAPI_global_ran_node_id_t *global_ran_node_id_local_var =
		ogs_malloc(sizeof(OpenAPI_global_ran_node_id_t));
...
void OpenAPI_global_ran_node_id_free(
	OpenAPI_global_ran_node_id_t *global_ran_node_id) {
...
cJSON *OpenAPI_global_ran_node_id_convertToJSON(
	OpenAPI_global_ran_node_id_t *global_ran_node_id) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(global_ran_node_id == NULL) {
		ogs_error(
			"OpenAPI_global_ran_node_id_convertToJSON() failed [GlobalRanNodeId]");
		return NULL;
	}
	...
	if(!global_ran_node_id->plmn_id) {
		ogs_error(
			"OpenAPI_global_ran_node_id_convertToJSON() failed [plmn_id]");
		return NULL;
	}
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_convertToJSON(global_ran_node_id->plmn_id);
	...
	if(global_ran_node_id->n3_iwf_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [n3_iwf_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id->g_nb_id) {
		...
		if(g_nb_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [g_nb_id]");
			goto end;
		}
	...
	if(global_ran_node_id->nge_nb_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [nge_nb_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id->wagf_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [wagf_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id->tngf_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [tngf_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id->nid) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [nid]");
			goto end;
		}
	}
	...
	if(global_ran_node_id->e_nb_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_convertToJSON() failed [e_nb_id]");
			goto end;
		}
	}
...
OpenAPI_global_ran_node_id_t *OpenAPI_global_ran_node_id_parseFromJSON(
	...
	if(!plmn_id) {
		ogs_error(
			"OpenAPI_global_ran_node_id_parseFromJSON() failed [plmn_id]");
		goto end;
	}
	...
	if(nge_nb_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_parseFromJSON() failed [nge_nb_id]");
			goto end;
		}
	}
	...
	if(nid) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_parseFromJSON() failed [nid]");
			goto end;
		}
	}
	...
	if(e_nb_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_parseFromJSON() failed [e_nb_id]");
			goto end;
		}
	}
...
OpenAPI_global_ran_node_id_t *OpenAPI_global_ran_node_id_copy(
	OpenAPI_global_ran_node_id_t *dst, OpenAPI_global_ran_node_id_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
