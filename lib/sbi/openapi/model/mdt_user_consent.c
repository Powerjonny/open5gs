...
char * OpenAPI_mdt_user_consent_ToString(
	...
	const char *mdt_user_consentArray[] = { "NULL", "CONSENT_NOT_GIVEN",
		                                "CONSENT_GIVEN" };
	size_t sizeofArray = sizeof(mdt_user_consentArray) /
	                     sizeof(mdt_user_consentArray[0]);
...
OpenAPI_mdt_user_consent_e OpenAPI_mdt_user_consent_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(mdt_user_consent,
		          mdt_user_consentArray[stringToReturn]) == 0) {
