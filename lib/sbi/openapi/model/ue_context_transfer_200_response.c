	...
	OpenAPI_binary_t			*binary_data_n2_information_ext2)
{
	OpenAPI_ue_context_transfer_200_response_t *
		...
		ogs_malloc(sizeof(OpenAPI_ue_context_transfer_200_response_t));
...
void OpenAPI_ue_context_transfer_200_response_free(
	OpenAPI_ue_context_transfer_200_response_t *
	...
	if(ue_context_transfer_200_response->json_data) {
		OpenAPI_ue_context_transfer_rsp_data_free(
...
cJSON *OpenAPI_ue_context_transfer_200_response_convertToJSON(
	OpenAPI_ue_context_transfer_200_response_t *
	ue_context_transfer_200_response) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_context_transfer_200_response == NULL) {
		ogs_error(
			"OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [UEContextTransfer_200_response]");
		return NULL;
	}
	...
	if(ue_context_transfer_200_response->json_data) {
		cJSON *json_data_local_JSON =
			OpenAPI_ue_context_transfer_rsp_data_convertToJSON(
				ue_context_transfer_200_response->json_data);
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(ue_context_transfer_200_response->binary_data_n2_information) {
		...
		{
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	if(ue_context_transfer_200_response->binary_data_n2_information_ext1) {
		...
		{
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [binary_data_n2_information_ext1]");
			goto end;
		}
	...
	if(ue_context_transfer_200_response->binary_data_n2_information_ext2) {
		...
		{
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_convertToJSON() failed [binary_data_n2_information_ext2]");
			goto end;
		}
...
OpenAPI_ue_context_transfer_200_response_t *
OpenAPI_ue_context_transfer_200_response_parseFromJSON(
	...
	if(json_data) {
		...
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_ue_context_transfer_rsp_data_parseFromJSON failed [json_data]");
			goto end;
		}
	}
	...
	if(binary_data_n2_information) {
		...
		if(!cJSON_IsString(binary_data_n2_information)) {
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_parseFromJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext1) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext1)) {
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_parseFromJSON() failed [binary_data_n2_information_ext1]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext2) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext2)) {
			ogs_error(
				"OpenAPI_ue_context_transfer_200_response_parseFromJSON() failed [binary_data_n2_information_ext2]");
			goto end;
		}
...
OpenAPI_ue_context_transfer_200_response_t *
OpenAPI_ue_context_transfer_200_response_copy(
	OpenAPI_ue_context_transfer_200_response_t	*dst,
	OpenAPI_ue_context_transfer_200_response_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_ue_context_transfer_200_response_convertToJSON() failed");
		return NULL;
	}
