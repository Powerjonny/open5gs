...
OpenAPI_nrf_info_served_mb_smf_info_list_value_value_create(
	...
	OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *
	        nrf_info_served_mb_smf_info_list_value_value_local_var =
		ogs_malloc(
			sizeof(
				OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t));
	...
	nrf_info_served_mb_smf_info_list_value_value_local_var->
	s_nssai_info_list = s_nssai_info_list;
	nrf_info_served_mb_smf_info_list_value_value_local_var->tmgi_range_list
	        = tmgi_range_list;
	nrf_info_served_mb_smf_info_list_value_value_local_var->tai_list =
		tai_list;
	nrf_info_served_mb_smf_info_list_value_value_local_var->tai_range_list =
		tai_range_list;
	nrf_info_served_mb_smf_info_list_value_value_local_var->mbs_session_list
	        = mbs_session_list;
...
void OpenAPI_nrf_info_served_mb_smf_info_list_value_value_free(
	...
	if(nrf_info_served_mb_smf_info_list_value_value->s_nssai_info_list) {
		OpenAPI_list_for_each(
			nrf_info_served_mb_smf_info_list_value_value->
			s_nssai_info_list, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
			OpenAPI_snssai_mb_smf_info_item_free(
				localKeyValue->value);
		...
		OpenAPI_list_free(
			nrf_info_served_mb_smf_info_list_value_value->
			s_nssai_info_list);
		nrf_info_served_mb_smf_info_list_value_value->s_nssai_info_list
		        = NULL;
	}
	if(nrf_info_served_mb_smf_info_list_value_value->tmgi_range_list) {
		OpenAPI_list_for_each(
			nrf_info_served_mb_smf_info_list_value_value->
			tmgi_range_list, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
		...
		OpenAPI_list_free(
			nrf_info_served_mb_smf_info_list_value_value->
			tmgi_range_list);
		nrf_info_served_mb_smf_info_list_value_value->tmgi_range_list =
			NULL;
	}
	if(nrf_info_served_mb_smf_info_list_value_value->tai_list) {
		OpenAPI_list_for_each(
			nrf_info_served_mb_smf_info_list_value_value->tai_list,
			node) {
	...
	if(nrf_info_served_mb_smf_info_list_value_value->tai_range_list) {
		...
		OpenAPI_list_free(
			nrf_info_served_mb_smf_info_list_value_value->
			tai_range_list);
		nrf_info_served_mb_smf_info_list_value_value->tai_range_list =
			NULL;
	}
	if(nrf_info_served_mb_smf_info_list_value_value->mbs_session_list) {
		OpenAPI_list_for_each(
			nrf_info_served_mb_smf_info_list_value_value->
			mbs_session_list, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
		...
		OpenAPI_list_free(
			nrf_info_served_mb_smf_info_list_value_value->
			mbs_session_list);
		nrf_info_served_mb_smf_info_list_value_value->mbs_session_list =
			NULL;
	}
...
cJSON *OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON(
	...
	if(nrf_info_served_mb_smf_info_list_value_value == NULL) {
		ogs_error(
			"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [NrfInfo_servedMbSmfInfoList_value_value]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(nrf_info_served_mb_smf_info_list_value_value->s_nssai_info_list) {
		cJSON *s_nssai_info_list = cJSON_AddObjectToObject(item,
		                                                   "sNssaiInfoList");
		if(s_nssai_info_list == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [s_nssai_info_list]");
			goto end;
		}
		cJSON *localMapObject = s_nssai_info_list;
		if(nrf_info_served_mb_smf_info_list_value_value->
		   s_nssai_info_list)
		{
			OpenAPI_list_for_each(
				nrf_info_served_mb_smf_info_list_value_value->
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_snssai_mb_smf_info_item_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
					ogs_error(
						"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [inner]");
					goto end;
				}
	...
	if(nrf_info_served_mb_smf_info_list_value_value->tmgi_range_list) {
		cJSON *tmgi_range_list = cJSON_AddObjectToObject(item,
		                                                 "tmgiRangeList");
		if(tmgi_range_list == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [tmgi_range_list]");
			goto end;
		}
		...
		if(nrf_info_served_mb_smf_info_list_value_value->tmgi_range_list)
		{
			OpenAPI_list_for_each(
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_tmgi_range_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nrf_info_served_mb_smf_info_list_value_value->tai_list) {
		...
		if(tai_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [tai_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_mb_smf_info_list_value_value->tai_list,
	...
	if(nrf_info_served_mb_smf_info_list_value_value->tai_range_list) {
		...
		if(tai_range_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [tai_range_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_mb_smf_info_list_value_value->
	...
	if(nrf_info_served_mb_smf_info_list_value_value->mbs_session_list) {
		cJSON *mbs_session_list = cJSON_AddObjectToObject(item,
		                                                  "mbsSessionList");
		if(mbs_session_list == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed [mbs_session_list]");
			goto end;
		}
		   ...
		   mbs_session_list)
		{
			OpenAPI_list_for_each(
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_mbs_session_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
...
OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON(
	...
	OpenAPI_nrf_info_served_mb_smf_info_list_value_value_t *
	        nrf_info_served_mb_smf_info_list_value_value_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	s_nssai_info_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_mb_smf_info_list_value_valueJSON,
			"sNssaiInfoList");
	if(s_nssai_info_list) {
		cJSON *s_nssai_info_list_local_map = NULL;
		if(!cJSON_IsObject(s_nssai_info_list) &&
		   !cJSON_IsNull(s_nssai_info_list))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [s_nssai_info_list]");
			goto end;
		}
		if(cJSON_IsObject(s_nssai_info_list)) {
			s_nssai_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(s_nssai_info_list_local_map,
			                   s_nssai_info_list) {
				cJSON *localMapObject =
					s_nssai_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_snssai_mb_smf_info_item_parseFromJSON
						        (localMapObject));
					...
					ogs_error(
						"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [inner]");
					goto end;
				}
				OpenAPI_list_add(s_nssai_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(tmgi_range_list) {
		...
		if(!cJSON_IsObject(tmgi_range_list) &&
		   !cJSON_IsNull(tmgi_range_list))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [tmgi_range_list]");
			goto end;
		}
		if(cJSON_IsObject(tmgi_range_list)) {
			tmgi_range_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(tmgi_range_list_local_map,
			                   tmgi_range_list) {
				cJSON *localMapObject =
					tmgi_range_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_tmgi_range_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(tmgi_range_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(tai_list) {
		...
		if(!cJSON_IsArray(tai_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [tai_list]");
			goto end;
		}
	...
	if(tai_range_list) {
		...
		if(!cJSON_IsArray(tai_range_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [tai_range_list]");
			goto end;
		}
	...
	if(mbs_session_list) {
		...
		if(!cJSON_IsObject(mbs_session_list) &&
		   !cJSON_IsNull(mbs_session_list))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_parseFromJSON() failed [mbs_session_list]");
			goto end;
		}
		if(cJSON_IsObject(mbs_session_list)) {
			mbs_session_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(mbs_session_list_local_map,
			                   mbs_session_list) {
				cJSON *localMapObject =
					mbs_session_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_mbs_session_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(mbs_session_listList,
				                 localMapKeyPair);
			}
		}
	}
...
OpenAPI_nrf_info_served_mb_smf_info_list_value_value_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nrf_info_served_mb_smf_info_list_value_value_convertToJSON() failed");
		return NULL;
	}
