...
char * OpenAPI_notification_flag_ToString(
	...
	const char *notification_flagArray[] = { "NULL", "ACTIVATE",
		                                 "DEACTIVATE", "RETRIEVAL" };
	size_t sizeofArray = sizeof(notification_flagArray) /
	                     sizeof(notification_flagArray[0]);
...
OpenAPI_notification_flag_e OpenAPI_notification_flag_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(notification_flag,
		          notification_flagArray[stringToReturn]) == 0) {
