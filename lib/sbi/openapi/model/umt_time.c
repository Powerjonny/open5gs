...
OpenAPI_umt_time_t *OpenAPI_umt_time_create(char	*time_of_day,
                                            int		day_of_week) {
	OpenAPI_umt_time_t *umt_time_local_var =
		ogs_malloc(sizeof(OpenAPI_umt_time_t));
...
cJSON *OpenAPI_umt_time_convertToJSON(OpenAPI_umt_time_t *umt_time) {
	...
	{
		ogs_error(
			"OpenAPI_umt_time_convertToJSON() failed [day_of_week]");
		goto end;
	}
...
OpenAPI_umt_time_t *OpenAPI_umt_time_parseFromJSON(cJSON *umt_timeJSON) {
	...
	time_of_day = cJSON_GetObjectItemCaseSensitive(umt_timeJSON,
	                                               "timeOfDay");
	if(!time_of_day) {
		ogs_error(
	...
	day_of_week = cJSON_GetObjectItemCaseSensitive(umt_timeJSON,
	                                               "dayOfWeek");
	if(!day_of_week) {
		ogs_error(
			"OpenAPI_umt_time_parseFromJSON() failed [day_of_week]");
		goto end;
	}
...
OpenAPI_umt_time_t *OpenAPI_umt_time_copy(OpenAPI_umt_time_t	*dst,
                                          OpenAPI_umt_time_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
