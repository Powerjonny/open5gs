...
OpenAPI_secondary_rat_usage_report_t *OpenAPI_secondary_rat_usage_report_create(
	...
	OpenAPI_secondary_rat_usage_report_t *
	        secondary_rat_usage_report_local_var =
		ogs_malloc(sizeof(OpenAPI_secondary_rat_usage_report_t));
	ogs_assert(secondary_rat_usage_report_local_var);

	secondary_rat_usage_report_local_var->secondary_rat_type =
		secondary_rat_type;
	secondary_rat_usage_report_local_var->qos_flows_usage_data =
...
void OpenAPI_secondary_rat_usage_report_free(
	OpenAPI_secondary_rat_usage_report_t *secondary_rat_usage_report) {
	...
	if(secondary_rat_usage_report->qos_flows_usage_data) {
		OpenAPI_list_for_each(
			secondary_rat_usage_report->qos_flows_usage_data,
			node) {
...
cJSON *OpenAPI_secondary_rat_usage_report_convertToJSON(
	OpenAPI_secondary_rat_usage_report_t *secondary_rat_usage_report) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(secondary_rat_usage_report == NULL) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_report_convertToJSON() failed [SecondaryRatUsageReport]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_secondary_rat_usage_report_convertToJSON() failed [secondary_rat_type]");
		return NULL;
	}
	...
	if(!secondary_rat_usage_report->qos_flows_usage_data) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_report_convertToJSON() failed [qos_flows_usage_data]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(secondary_rat_usage_report->qos_flows_usage_data,
	                      node) {
		cJSON *itemLocal =
			OpenAPI_qos_flow_usage_report_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_secondary_rat_usage_report_convertToJSON() failed [qos_flows_usage_data]");
			goto end;
...
OpenAPI_secondary_rat_usage_report_parseFromJSON(
	cJSON *secondary_rat_usage_reportJSON) {
	OpenAPI_secondary_rat_usage_report_t *
	        secondary_rat_usage_report_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	secondary_rat_type =
		cJSON_GetObjectItemCaseSensitive(secondary_rat_usage_reportJSON,
		                                 "secondaryRatType");
	if(!secondary_rat_type) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_report_parseFromJSON() failed [secondary_rat_type]");
		goto end;
	}
	...
	if(!qos_flows_usage_data) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_report_parseFromJSON() failed [qos_flows_usage_data]");
		goto end;
	}
	...
	secondary_rat_usage_report_local_var =
		OpenAPI_secondary_rat_usage_report_create(
			secondary_rat_typeVariable,
...
OpenAPI_secondary_rat_usage_report_t *OpenAPI_secondary_rat_usage_report_copy(
	OpenAPI_secondary_rat_usage_report_t	*dst,
	OpenAPI_secondary_rat_usage_report_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_secondary_rat_usage_report_convertToJSON() failed");
		return NULL;
	}
