...
OpenAPI_partial_record_method_t *OpenAPI_partial_record_method_create() {
	OpenAPI_partial_record_method_t *partial_record_method_local_var =
		ogs_malloc(sizeof(OpenAPI_partial_record_method_t));
...
cJSON *OpenAPI_partial_record_method_convertToJSON(
	...
	if(partial_record_method == NULL) {
		ogs_error(
			"OpenAPI_partial_record_method_convertToJSON() failed [PartialRecordMethod]");
		return NULL;
	}
...
OpenAPI_partial_record_method_t *OpenAPI_partial_record_method_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_partial_record_method_convertToJSON() failed");
		return NULL;
	}
