...
char * OpenAPI_data_ind_any_of_ToString(
	...
	const char *data_ind_any_ofArray[] = { "NULL", "PFD", "IPTV", "BDT",
		                               "SVC_PARAM", "AM" };
	size_t sizeofArray = sizeof(data_ind_any_ofArray) /
	                     sizeof(data_ind_any_ofArray[0]);
...
OpenAPI_data_ind_any_of_e OpenAPI_data_ind_any_of_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(data_ind_any_of,
		          data_ind_any_ofArray[stringToReturn]) == 0) {
