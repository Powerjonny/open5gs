...
OpenAPI_service_specific_authorization_info_create(
	...
	OpenAPI_service_specific_authorization_info_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_service_specific_authorization_info_t));
	ogs_assert(service_specific_authorization_info_local_var);

	service_specific_authorization_info_local_var->
	service_specific_authorization_list =
		service_specific_authorization_list;
...
void OpenAPI_service_specific_authorization_info_free(
	...
	if(service_specific_authorization_info->
	   service_specific_authorization_list)
	{
		OpenAPI_list_for_each(
			service_specific_authorization_info->
			service_specific_authorization_list, node) {
		...
		OpenAPI_list_free(
			...
			service_specific_authorization_list);
		service_specific_authorization_info->
		service_specific_authorization_list = NULL;
	}
...
cJSON *OpenAPI_service_specific_authorization_info_convertToJSON(
	...
	if(service_specific_authorization_info == NULL) {
		ogs_error(
			"OpenAPI_service_specific_authorization_info_convertToJSON() failed [ServiceSpecificAuthorizationInfo]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_service_specific_authorization_info_convertToJSON() failed [service_specific_authorization_list]");
		return NULL;
	}
	cJSON *service_specific_authorization_listList =
	...
	OpenAPI_list_for_each(
		...
		service_specific_authorization_list, node) {
		cJSON *itemLocal =
			OpenAPI_authorization_info_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_service_specific_authorization_info_convertToJSON() failed [service_specific_authorization_list]");
			goto end;
		}
		cJSON_AddItemToArray(service_specific_authorization_listList,
		                     itemLocal);
	}
...
OpenAPI_service_specific_authorization_info_parseFromJSON(
	...
	OpenAPI_service_specific_authorization_info_t *
	        service_specific_authorization_info_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *service_specific_authorization_list = NULL;
	OpenAPI_list_t *service_specific_authorization_listList = NULL;
	service_specific_authorization_list =
		cJSON_GetObjectItemCaseSensitive(
			service_specific_authorization_infoJSON,
			"serviceSpecificAuthorizationList");
	if(!service_specific_authorization_list) {
		ogs_error(
			"OpenAPI_service_specific_authorization_info_parseFromJSON() failed [service_specific_authorization_list]");
		goto end;
	}
	...
	cJSON_ArrayForEach(service_specific_authorization_list_local,
	                   service_specific_authorization_list) {
		...
		OpenAPI_authorization_info_t *
		        service_specific_authorization_listItem =
			OpenAPI_authorization_info_parseFromJSON(
				service_specific_authorization_list_local);
		if(!service_specific_authorization_listItem) {
			ogs_error("No service_specific_authorization_listItem");
			goto end;
		}
		OpenAPI_list_add(service_specific_authorization_listList,
		                 service_specific_authorization_listItem);
	}
	...
	if(service_specific_authorization_listList) {
		OpenAPI_list_for_each(service_specific_authorization_listList,
		                      node) {
			OpenAPI_authorization_info_free(node->data);
		}
...
OpenAPI_service_specific_authorization_info_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_service_specific_authorization_info_convertToJSON() failed");
		return NULL;
	}
