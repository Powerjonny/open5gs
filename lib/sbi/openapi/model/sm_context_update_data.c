...
char *OpenAPI_sm_policy_notify_indsm_context_update_data_ToString(
...
OpenAPI_sm_context_update_data_sm_policy_notify_ind_e
OpenAPI_sm_policy_notify_indsm_context_update_data_FromString(
...
OpenAPI_sm_context_update_data_t *OpenAPI_sm_context_update_data_create(
	char *pei, char *serving_nf_id, OpenAPI_guami_t *guami,
	OpenAPI_plmn_id_nid_t *serving_network, bool is_backup_amf_info_null,
	OpenAPI_list_t *backup_amf_info, OpenAPI_access_type_e an_type,
	OpenAPI_access_type_e additional_an_type,
	OpenAPI_access_type_e an_type_to_reactivate,
	OpenAPI_rat_type_e rat_type, OpenAPI_presence_state_e presence_in_ladn,
	OpenAPI_user_location_t *ue_location, char *ue_time_zone,
	OpenAPI_user_location_t *add_ue_location,
	OpenAPI_up_cnx_state_e up_cnx_state, OpenAPI_ho_state_e ho_state,
	bool is_to_be_switched, int to_be_switched,
	bool is_failed_to_be_switched, int failed_to_be_switched,
	OpenAPI_ref_to_binary_data_t *n1_sm_msg,
	OpenAPI_ref_to_binary_data_t *n2_sm_info,
	OpenAPI_n2_sm_info_type_e n2_sm_info_type,
	OpenAPI_ng_ran_target_id_t *target_id, char *target_serving_nf_id,
	char *sm_context_status_uri, bool is_data_forwarding,
	int data_forwarding, OpenAPI_tunnel_info_t *n9_forwarding_tunnel,
	...
	OpenAPI_list_t *eps_bearer_setup, OpenAPI_list_t *revoke_ebi_list,
	bool is_release, int release, OpenAPI_cause_e cause,
	OpenAPI_ng_ap_cause_t *ng_ap_cause, bool is__5g_mm_cause_value,
	int _5g_mm_cause_value, OpenAPI_snssai_t *s_nssai,
	...
	OpenAPI_exemption_ind_t *exemption_ind, char *supported_features,
	OpenAPI_mo_exp_data_counter_t *mo_exp_data_counter,
	bool is_extended_nas_sm_timer_ind, int extended_nas_sm_timer_ind,
	char *forwarding_f_teid, OpenAPI_list_t *forwarding_bearer_contexts,
	...
	OpenAPI_sm_context_update_data_sm_policy_notify_ind_e
	sm_policy_notify_ind, bool is_pcf_ue_callback_info_null,
	OpenAPI_pcf_ue_callback_info_t *pcf_ue_callback_info,
	OpenAPI_satellite_backhaul_category_e satellite_backhaul_cat) {
	OpenAPI_sm_context_update_data_t *sm_context_update_data_local_var =
		ogs_malloc(sizeof(OpenAPI_sm_context_update_data_t));
	...
	sm_context_update_data_local_var->is_backup_amf_info_null =
	...
	sm_context_update_data_local_var->additional_an_type =
		additional_an_type;
	sm_context_update_data_local_var->an_type_to_reactivate =
		an_type_to_reactivate;
	...
	sm_context_update_data_local_var->is_failed_to_be_switched =
		is_failed_to_be_switched;
	sm_context_update_data_local_var->failed_to_be_switched =
		failed_to_be_switched;
	...
	sm_context_update_data_local_var->target_serving_nf_id =
		target_serving_nf_id;
	sm_context_update_data_local_var->sm_context_status_uri =
		sm_context_status_uri;
	sm_context_update_data_local_var->is_data_forwarding =
		is_data_forwarding;
	sm_context_update_data_local_var->data_forwarding = data_forwarding;
	sm_context_update_data_local_var->n9_forwarding_tunnel =
		n9_forwarding_tunnel;
	sm_context_update_data_local_var->n9_dl_forwarding_tnl_list =
		n9_dl_forwarding_tnl_list;
	sm_context_update_data_local_var->n9_ul_forwarding_tnl_list =
		n9_ul_forwarding_tnl_list;
	sm_context_update_data_local_var->n9_dl_forwarding_tunnel =
		n9_dl_forwarding_tunnel;
	sm_context_update_data_local_var->is_n9_inactivity_timer =
		is_n9_inactivity_timer;
	sm_context_update_data_local_var->n9_inactivity_timer =
		n9_inactivity_timer;
	...
	sm_context_update_data_local_var->is__5g_mm_cause_value =
		is__5g_mm_cause_value;
	sm_context_update_data_local_var->_5g_mm_cause_value =
		_5g_mm_cause_value;
	sm_context_update_data_local_var->s_nssai = s_nssai;
	sm_context_update_data_local_var->is_trace_data_null =
		is_trace_data_null;
	sm_context_update_data_local_var->trace_data = trace_data;
	sm_context_update_data_local_var->eps_interworking_ind =
		eps_interworking_ind;
	sm_context_update_data_local_var->is_an_type_can_be_changed =
		is_an_type_can_be_changed;
	sm_context_update_data_local_var->an_type_can_be_changed =
		an_type_can_be_changed;
	sm_context_update_data_local_var->n2_sm_info_ext1 = n2_sm_info_ext1;
	sm_context_update_data_local_var->n2_sm_info_type_ext1 =
		n2_sm_info_type_ext1;
	sm_context_update_data_local_var->ma_release_ind = ma_release_ind;
	sm_context_update_data_local_var->is_ma_nw_upgrade_ind =
	...
	sm_context_update_data_local_var->supported_features =
		supported_features;
	sm_context_update_data_local_var->mo_exp_data_counter =
		mo_exp_data_counter;
	sm_context_update_data_local_var->is_extended_nas_sm_timer_ind =
		is_extended_nas_sm_timer_ind;
	sm_context_update_data_local_var->extended_nas_sm_timer_ind =
		extended_nas_sm_timer_ind;
	sm_context_update_data_local_var->forwarding_f_teid = forwarding_f_teid;
	sm_context_update_data_local_var->forwarding_bearer_contexts =
		forwarding_bearer_contexts;
	sm_context_update_data_local_var->ddn_failure_subs = ddn_failure_subs;
	sm_context_update_data_local_var->is_skip_n2_pdu_session_res_rel_ind =
		is_skip_n2_pdu_session_res_rel_ind;
	sm_context_update_data_local_var->skip_n2_pdu_session_res_rel_ind =
		skip_n2_pdu_session_res_rel_ind;
	sm_context_update_data_local_var->
	secondary_rat_usage_data_report_container =
		secondary_rat_usage_data_report_container;
	sm_context_update_data_local_var->sm_policy_notify_ind =
		sm_policy_notify_ind;
	sm_context_update_data_local_var->is_pcf_ue_callback_info_null =
		is_pcf_ue_callback_info_null;
	sm_context_update_data_local_var->pcf_ue_callback_info =
		pcf_ue_callback_info;
	sm_context_update_data_local_var->satellite_backhaul_cat =
		satellite_backhaul_cat;

	return sm_context_update_data_local_var;
}

void OpenAPI_sm_context_update_data_free(
	OpenAPI_sm_context_update_data_t *sm_context_update_data) {
	...
	if(sm_context_update_data->serving_network) {
		OpenAPI_plmn_id_nid_free(
			sm_context_update_data->serving_network);
		sm_context_update_data->serving_network = NULL;
	}
	if(sm_context_update_data->backup_amf_info) {
		OpenAPI_list_for_each(sm_context_update_data->backup_amf_info,
		                      node) {
	...
	if(sm_context_update_data->n9_forwarding_tunnel) {
		OpenAPI_tunnel_info_free(
			sm_context_update_data->n9_forwarding_tunnel);
	...
	if(sm_context_update_data->n9_dl_forwarding_tnl_list) {
		OpenAPI_list_for_each(
			...
			node) {
			OpenAPI_indirect_data_forwarding_tunnel_info_free(
				node->data);
		}
		OpenAPI_list_free(
			sm_context_update_data->n9_dl_forwarding_tnl_list);
	...
	if(sm_context_update_data->n9_ul_forwarding_tnl_list) {
		OpenAPI_list_for_each(
			sm_context_update_data->n9_ul_forwarding_tnl_list,
			node) {
			OpenAPI_indirect_data_forwarding_tunnel_info_free(
				node->data);
		}
	...
	if(sm_context_update_data->n9_dl_forwarding_tunnel) {
		OpenAPI_tunnel_info_free(
			sm_context_update_data->n9_dl_forwarding_tunnel);
		sm_context_update_data->n9_dl_forwarding_tunnel = NULL;
	}
	if(sm_context_update_data->eps_bearer_setup) {
		OpenAPI_list_for_each(sm_context_update_data->eps_bearer_setup,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(sm_context_update_data->revoke_ebi_list) {
		OpenAPI_list_for_each(sm_context_update_data->revoke_ebi_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(sm_context_update_data->exemption_ind) {
		OpenAPI_exemption_ind_free(
			sm_context_update_data->exemption_ind);
	...
	if(sm_context_update_data->ddn_failure_subs) {
		OpenAPI_ddn_failure_subs_free(
			sm_context_update_data->ddn_failure_subs);
...
cJSON *OpenAPI_sm_context_update_data_convertToJSON(
	...
	if(sm_context_update_data == NULL) {
		ogs_error(
			"OpenAPI_sm_context_update_data_convertToJSON() failed [SmContextUpdateData]");
		return NULL;
	}
	...
	if(sm_context_update_data->pei) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->serving_nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [serving_nf_id]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->guami) {
		cJSON *guami_local_JSON =
			OpenAPI_guami_convertToJSON(
				sm_context_update_data->guami);
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [guami]");
			goto end;
		}
	...
	if(sm_context_update_data->serving_network) {
		...
		if(serving_network_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [serving_network]");
			goto end;
		}
	...
	if(sm_context_update_data->backup_amf_info) {
		...
		if(backup_amf_infoList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [backup_amf_info]");
			goto end;
		}
		OpenAPI_list_for_each(sm_context_update_data->backup_amf_info,
		                      node) {
	...
	if(sm_context_update_data->an_type != OpenAPI_access_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [an_type]");
			goto end;
		}
	}
	   ...
	   OpenAPI_access_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [additional_an_type]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->an_type_to_reactivate !=
	   OpenAPI_access_type_NULL)
	{
		if(cJSON_AddStringToObject(item, "anTypeToReactivate",
		                           OpenAPI_access_type_ToString(
						   sm_context_update_data->
						   an_type_to_reactivate)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [an_type_to_reactivate]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->rat_type != OpenAPI_rat_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [rat_type]");
			goto end;
		}
	}
	   ...
	   OpenAPI_presence_state_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [presence_in_ladn]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->ue_location) {
		cJSON *ue_location_local_JSON =
			OpenAPI_user_location_convertToJSON(
				sm_context_update_data->ue_location);
		if(ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ue_location]");
			goto end;
		}
	...
	if(sm_context_update_data->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           sm_context_update_data->ue_time_zone)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->add_ue_location) {
		...
		if(add_ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [add_ue_location]");
			goto end;
		}
	...
	if(sm_context_update_data->up_cnx_state != OpenAPI_up_cnx_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [up_cnx_state]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->ho_state != OpenAPI_ho_state_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ho_state]");
			goto end;
		}
	}

	if(sm_context_update_data->is_to_be_switched) {
		if(cJSON_AddBoolToObject(item, "toBeSwitched",
		                         sm_context_update_data->to_be_switched)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [to_be_switched]");
			goto end;
		}
	}

	if(sm_context_update_data->is_failed_to_be_switched) {
		if(cJSON_AddBoolToObject(item, "failedToBeSwitched",
		                         sm_context_update_data->
		                         failed_to_be_switched) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [failed_to_be_switched]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->n1_sm_msg) {
		...
		if(n1_sm_msg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n1_sm_msg]");
			goto end;
		}
	...
	if(sm_context_update_data->n2_sm_info) {
		...
		if(n2_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info]");
			goto end;
		}
	   ...
	   OpenAPI_n2_sm_info_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info_type]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->target_id) {
		...
		if(target_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [target_id]");
			goto end;
		}
	...
	if(sm_context_update_data->target_serving_nf_id) {
		if(cJSON_AddStringToObject(item, "targetServingNfId",
		                           sm_context_update_data->
		                           target_serving_nf_id) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [target_serving_nf_id]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->sm_context_status_uri) {
		if(cJSON_AddStringToObject(item, "smContextStatusUri",
		                           sm_context_update_data->
		                           sm_context_status_uri) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [sm_context_status_uri]");
			goto end;
		}
	}

	if(sm_context_update_data->is_data_forwarding) {
		if(cJSON_AddBoolToObject(item, "dataForwarding",
		                         sm_context_update_data->data_forwarding)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [data_forwarding]");
			goto end;
		}
	}

	if(sm_context_update_data->n9_forwarding_tunnel) {
		cJSON *n9_forwarding_tunnel_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				sm_context_update_data->n9_forwarding_tunnel);
		if(n9_forwarding_tunnel_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_forwarding_tunnel]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n9ForwardingTunnel",
		                      n9_forwarding_tunnel_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_forwarding_tunnel]");
			goto end;
	...
	if(sm_context_update_data->n9_dl_forwarding_tnl_list) {
		cJSON *n9_dl_forwarding_tnl_listList =
			cJSON_AddArrayToObject(item, "n9DlForwardingTnlList");
		if(n9_dl_forwarding_tnl_listList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_dl_forwarding_tnl_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_update_data->n9_dl_forwarding_tnl_list,
			node) {
			cJSON *itemLocal =
				OpenAPI_indirect_data_forwarding_tunnel_info_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_dl_forwarding_tnl_list]");
			...
			cJSON_AddItemToArray(n9_dl_forwarding_tnl_listList,
			                     itemLocal);
		}
	}

	if(sm_context_update_data->n9_ul_forwarding_tnl_list) {
		cJSON *n9_ul_forwarding_tnl_listList =
			cJSON_AddArrayToObject(item, "n9UlForwardingTnlList");
		if(n9_ul_forwarding_tnl_listList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_ul_forwarding_tnl_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_update_data->n9_ul_forwarding_tnl_list,
			...
			cJSON_AddItemToArray(n9_ul_forwarding_tnl_listList,
			                     itemLocal);
		}
	}

	if(sm_context_update_data->n9_dl_forwarding_tunnel) {
		cJSON *n9_dl_forwarding_tunnel_local_JSON =
			OpenAPI_tunnel_info_convertToJSON(
				sm_context_update_data->n9_dl_forwarding_tunnel);
		if(n9_dl_forwarding_tunnel_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_dl_forwarding_tunnel]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n9DlForwardingTunnel",
		                      n9_dl_forwarding_tunnel_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_dl_forwarding_tunnel]");
			goto end;
	...
	if(sm_context_update_data->is_n9_inactivity_timer) {
		if(cJSON_AddNumberToObject(item, "n9InactivityTimer",
		                           sm_context_update_data->
		                           n9_inactivity_timer) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n9_inactivity_timer]");
			goto end;
		}
	}

	if(sm_context_update_data->eps_bearer_setup) {
		cJSON *eps_bearer_setupList = cJSON_AddArrayToObject(item,
		                                                     "epsBearerSetup");
		if(eps_bearer_setupList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [eps_bearer_setup]");
			goto end;
		}
		OpenAPI_list_for_each(sm_context_update_data->eps_bearer_setup,
		                      node) {
			if(cJSON_AddStringToObject(eps_bearer_setupList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_sm_context_update_data_convertToJSON() failed [eps_bearer_setup]");
	...
	if(sm_context_update_data->revoke_ebi_list) {
		...
		if(revoke_ebi_listList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [revoke_ebi_list]");
			goto end;
		}
		OpenAPI_list_for_each(sm_context_update_data->revoke_ebi_list,
		                      node) {
	...
	if(sm_context_update_data->is_release) {
		if(cJSON_AddBoolToObject(item, "release",
		                         sm_context_update_data->release) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [release]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->cause != OpenAPI_cause_NULL) {
		if(cJSON_AddStringToObject(item, "cause",
						   ...
						   sm_context_update_data->cause))
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->ng_ap_cause) {
		cJSON *ng_ap_cause_local_JSON =
			OpenAPI_ng_ap_cause_convertToJSON(
				sm_context_update_data->ng_ap_cause);
		if(ng_ap_cause_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ng_ap_cause]");
			goto end;
		}
	...
	if(sm_context_update_data->is__5g_mm_cause_value) {
		if(cJSON_AddNumberToObject(item, "5gMmCauseValue",
		                           sm_context_update_data->
		                           _5g_mm_cause_value) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [_5g_mm_cause_value]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->s_nssai) {
		cJSON *s_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				sm_context_update_data->s_nssai);
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(sm_context_update_data->trace_data) {
		cJSON *trace_data_local_JSON =
			OpenAPI_trace_data_convertToJSON(
				sm_context_update_data->trace_data);
		if(trace_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [trace_data]");
			goto end;
		}
	   ...
	   OpenAPI_eps_interworking_indication_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [eps_interworking_ind]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->is_an_type_can_be_changed) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [an_type_can_be_changed]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->n2_sm_info_ext1) {
		...
		if(n2_sm_info_ext1_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info_ext1]");
			goto end;
		}
	   ...
	   OpenAPI_n2_sm_info_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [n2_sm_info_type_ext1]");
			goto end;
		}
	}
	   ...
	   OpenAPI_ma_release_indication_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ma_release_ind]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->is_ma_nw_upgrade_ind) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->is_ma_request_ind) {
		if(cJSON_AddBoolToObject(item, "maRequestInd",
		                         sm_context_update_data->ma_request_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ma_request_ind]");
			goto end;
		}
	}

	if(sm_context_update_data->exemption_ind) {
		cJSON *exemption_ind_local_JSON =
			OpenAPI_exemption_ind_convertToJSON(
				sm_context_update_data->exemption_ind);
		if(exemption_ind_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [exemption_ind]");
			goto end;
		}
		cJSON_AddItemToObject(item, "exemptionInd",
		                      exemption_ind_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [exemption_ind]");
			goto end;
	...
	if(sm_context_update_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->mo_exp_data_counter) {
		...
		if(mo_exp_data_counter_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [mo_exp_data_counter]");
			goto end;
		}
	...
	if(sm_context_update_data->is_extended_nas_sm_timer_ind) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [extended_nas_sm_timer_ind]");
			goto end;
		}
	}

	if(sm_context_update_data->forwarding_f_teid) {
		if(cJSON_AddStringToObject(item, "forwardingFTeid",
		                           sm_context_update_data->
		                           forwarding_f_teid) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [forwarding_f_teid]");
			goto end;
		}
	}

	if(sm_context_update_data->forwarding_bearer_contexts) {
		cJSON *forwarding_bearer_contextsList =
			cJSON_AddArrayToObject(item,
			                       "forwardingBearerContexts");
		if(forwarding_bearer_contextsList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [forwarding_bearer_contexts]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_update_data->forwarding_bearer_contexts,
			...
			if(cJSON_AddStringToObject(
				   forwarding_bearer_contextsList, "",
				   (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_sm_context_update_data_convertToJSON() failed [forwarding_bearer_contexts]");
	...
	if(sm_context_update_data->ddn_failure_subs) {
		...
		if(ddn_failure_subs_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [ddn_failure_subs]");
			goto end;
		}
	...
	if(sm_context_update_data->is_skip_n2_pdu_session_res_rel_ind) {
		if(cJSON_AddBoolToObject(item, "skipN2PduSessionResRelInd",
		                         sm_context_update_data->
		                         skip_n2_pdu_session_res_rel_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [skip_n2_pdu_session_res_rel_ind]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->secondary_rat_usage_data_report_container) {
		...
		if(secondary_rat_usage_data_report_containerList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [secondary_rat_usage_data_report_container]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_update_data->
	...
	if(sm_context_update_data->sm_policy_notify_ind !=
	   OpenAPI_sm_context_update_data_SMPOLICYNOTIFYIND_NULL)
	{
		if(cJSON_AddStringToObject(item, "smPolicyNotifyInd",
		                           OpenAPI_sm_policy_notify_indsm_context_update_data_ToString
		                                   (sm_context_update_data->
		                                   sm_policy_notify_ind)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	}
	...
	if(sm_context_update_data->pcf_ue_callback_info) {
		...
		if(pcf_ue_callback_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [pcf_ue_callback_info]");
			goto end;
		}
	...
	if(sm_context_update_data->satellite_backhaul_cat !=
	   OpenAPI_satellite_backhaul_category_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_convertToJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	}
...
OpenAPI_sm_context_update_data_t *OpenAPI_sm_context_update_data_parseFromJSON(
	cJSON *sm_context_update_dataJSON) {
	OpenAPI_sm_context_update_data_t *sm_context_update_data_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *pei = NULL;
	...
	OpenAPI_satellite_backhaul_category_e satellite_backhaul_catVariable =
		0;
	pei = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                       "pei");
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [pei]");
			goto end;
		}
	}

	serving_nf_id =
		cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
		                                 "servingNfId");
	if(serving_nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [serving_nf_id]");
			goto end;
		}
	}

	guami = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                         "guami");
	if(guami) {
	...
	if(backup_amf_info) {
		if(!cJSON_IsNull(backup_amf_info)) {
			...
			if(!cJSON_IsArray(backup_amf_info)) {
				ogs_error(
					"OpenAPI_sm_context_update_data_parseFromJSON() failed [backup_amf_info]");
				goto end;
			}

			backup_amf_infoList = OpenAPI_list_create();

			cJSON_ArrayForEach(backup_amf_info_local,
			                   backup_amf_info) {
	...
	an_type = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                           "anType");
	if(an_type) {
		if(!cJSON_IsString(an_type)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [an_type]");
			goto end;
		}
		an_typeVariable =
	...
	if(additional_an_type) {
		if(!cJSON_IsString(additional_an_type)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [additional_an_type]");
			goto end;
		}
	...
	if(an_type_to_reactivate) {
		if(!cJSON_IsString(an_type_to_reactivate)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [an_type_to_reactivate]");
			goto end;
		}
		an_type_to_reactivateVariable =
			OpenAPI_access_type_FromString(
				an_type_to_reactivate->valuestring);
	}

	rat_type = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                            "ratType");
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	if(presence_in_ladn) {
		if(!cJSON_IsString(presence_in_ladn)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [presence_in_ladn]");
			goto end;
		}
	...
	if(ue_time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(up_cnx_state) {
		if(!cJSON_IsString(up_cnx_state)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [up_cnx_state]");
			goto end;
		}
	...
	ho_state = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                            "hoState");
	if(ho_state) {
		if(!cJSON_IsString(ho_state)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [ho_state]");
			goto end;
		}
		ho_stateVariable =
	...
	if(to_be_switched) {
		if(!cJSON_IsBool(to_be_switched)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [to_be_switched]");
			goto end;
		}
	}
	...
	if(failed_to_be_switched) {
		if(!cJSON_IsBool(failed_to_be_switched)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [failed_to_be_switched]");
			goto end;
		}
	}

	n1_sm_msg = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                             "n1SmMsg");
	if(n1_sm_msg) {
	...
	if(n2_sm_info_type) {
		if(!cJSON_IsString(n2_sm_info_type)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [n2_sm_info_type]");
			goto end;
		}
	...
	target_id = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                             "targetId");
	if(target_id) {
	...
	if(target_serving_nf_id) {
		if(!cJSON_IsString(target_serving_nf_id) &&
		   !cJSON_IsNull(target_serving_nf_id))
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [target_serving_nf_id]");
			goto end;
		}
	}
	...
	if(sm_context_status_uri) {
		if(!cJSON_IsString(sm_context_status_uri) &&
		   !cJSON_IsNull(sm_context_status_uri))
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [sm_context_status_uri]");
			goto end;
		}
	}
	...
	if(data_forwarding) {
		if(!cJSON_IsBool(data_forwarding)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [data_forwarding]");
			goto end;
		}
	}
	...
	if(n9_forwarding_tunnel) {
		n9_forwarding_tunnel_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(n9_forwarding_tunnel);
		if(!n9_forwarding_tunnel_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [n9_forwarding_tunnel]");
			goto end;
		}
	}
	...
	if(n9_dl_forwarding_tnl_list) {
		...
		if(!cJSON_IsArray(n9_dl_forwarding_tnl_list)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [n9_dl_forwarding_tnl_list]");
			goto end;
		}

		n9_dl_forwarding_tnl_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(n9_dl_forwarding_tnl_list_local,
		                   n9_dl_forwarding_tnl_list) {
	...
	if(n9_ul_forwarding_tnl_list) {
		...
		if(!cJSON_IsArray(n9_ul_forwarding_tnl_list)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [n9_ul_forwarding_tnl_list]");
			goto end;
		}

		n9_ul_forwarding_tnl_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(n9_ul_forwarding_tnl_list_local,
		                   n9_ul_forwarding_tnl_list) {
			...
			OpenAPI_indirect_data_forwarding_tunnel_info_t *
			        n9_ul_forwarding_tnl_listItem =
				OpenAPI_indirect_data_forwarding_tunnel_info_parseFromJSON
				        (n9_ul_forwarding_tnl_list_local);
			if(!n9_ul_forwarding_tnl_listItem) {
				ogs_error("No n9_ul_forwarding_tnl_listItem");
				goto end;
			}
			OpenAPI_list_add(n9_ul_forwarding_tnl_listList,
			                 n9_ul_forwarding_tnl_listItem);
		}
	}
	...
	if(n9_dl_forwarding_tunnel) {
		n9_dl_forwarding_tunnel_local_nonprim =
			OpenAPI_tunnel_info_parseFromJSON(
				n9_dl_forwarding_tunnel);
		if(!n9_dl_forwarding_tunnel_local_nonprim) {
			ogs_error(
				"OpenAPI_tunnel_info_parseFromJSON failed [n9_dl_forwarding_tunnel]");
			goto end;
		}
	}
	...
	if(n9_inactivity_timer) {
		if(!cJSON_IsNumber(n9_inactivity_timer)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [n9_inactivity_timer]");
			goto end;
		}
	}
	...
	if(eps_bearer_setup) {
		...
		if(!cJSON_IsArray(eps_bearer_setup)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [eps_bearer_setup]");
			goto end;
		}
		...
		cJSON_ArrayForEach(eps_bearer_setup_local, eps_bearer_setup) {
			...
			OpenAPI_list_add(eps_bearer_setupList,
			                 ogs_strdup(
						 eps_bearer_setup_local->
						 valuestring));
		}
	}
	...
	if(revoke_ebi_list) {
		...
		if(!cJSON_IsArray(revoke_ebi_list)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [revoke_ebi_list]");
			goto end;
		}
	...
	release = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                           "release");
	if(release) {
		if(!cJSON_IsBool(release)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [release]");
			goto end;
		}
	}

	cause = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                         "cause");
	if(cause) {
		if(!cJSON_IsString(cause)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [cause]");
			goto end;
		}
	...
	if(_5g_mm_cause_value) {
		if(!cJSON_IsNumber(_5g_mm_cause_value)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [_5g_mm_cause_value]");
			goto end;
		}
	}

	s_nssai = cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
	                                           "sNssai");
	if(s_nssai) {
	...
	if(eps_interworking_ind) {
		if(!cJSON_IsString(eps_interworking_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [eps_interworking_ind]");
			goto end;
		}
	...
	if(an_type_can_be_changed) {
		if(!cJSON_IsBool(an_type_can_be_changed)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [an_type_can_be_changed]");
			goto end;
		}
	}
	...
	if(n2_sm_info_type_ext1) {
		if(!cJSON_IsString(n2_sm_info_type_ext1)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [n2_sm_info_type_ext1]");
			goto end;
		}
	...
	if(ma_release_ind) {
		if(!cJSON_IsString(ma_release_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [ma_release_ind]");
			goto end;
		}
	...
	if(ma_nw_upgrade_ind) {
		if(!cJSON_IsBool(ma_nw_upgrade_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}
	...
	if(ma_request_ind) {
		if(!cJSON_IsBool(ma_request_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [ma_request_ind]");
			goto end;
		}
	}
	...
	exemption_ind =
		cJSON_GetObjectItemCaseSensitive(sm_context_update_dataJSON,
		                                 "exemptionInd");
	if(exemption_ind) {
		exemption_ind_local_nonprim =
			OpenAPI_exemption_ind_parseFromJSON(exemption_ind);
		if(!exemption_ind_local_nonprim) {
			ogs_error(
				"OpenAPI_exemption_ind_parseFromJSON failed [exemption_ind]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(extended_nas_sm_timer_ind) {
		if(!cJSON_IsBool(extended_nas_sm_timer_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [extended_nas_sm_timer_ind]");
			goto end;
		}
	}
	...
	if(forwarding_f_teid) {
		if(!cJSON_IsString(forwarding_f_teid) &&
		   !cJSON_IsNull(forwarding_f_teid))
		{
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [forwarding_f_teid]");
			goto end;
		}
	}
	...
	if(forwarding_bearer_contexts) {
		...
		if(!cJSON_IsArray(forwarding_bearer_contexts)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [forwarding_bearer_contexts]");
			goto end;
		}

		forwarding_bearer_contextsList = OpenAPI_list_create();

		cJSON_ArrayForEach(forwarding_bearer_contexts_local,
		                   forwarding_bearer_contexts) {
			double *localDouble = NULL;
			int *localInt = NULL;
			...
			OpenAPI_list_add(forwarding_bearer_contextsList,
			                 ogs_strdup(
						 forwarding_bearer_contexts_local
						 ->valuestring));
		}
	}
	...
	if(skip_n2_pdu_session_res_rel_ind) {
		if(!cJSON_IsBool(skip_n2_pdu_session_res_rel_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [skip_n2_pdu_session_res_rel_ind]");
			goto end;
		}
	}
	...
	if(secondary_rat_usage_data_report_container) {
		...
		if(!cJSON_IsArray(secondary_rat_usage_data_report_container)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [secondary_rat_usage_data_report_container]");
			goto end;
		}
	...
	if(sm_policy_notify_ind) {
		if(!cJSON_IsString(sm_policy_notify_ind)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	...
	if(satellite_backhaul_cat) {
		if(!cJSON_IsString(satellite_backhaul_cat)) {
			ogs_error(
				"OpenAPI_sm_context_update_data_parseFromJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	...
	sm_context_update_data_local_var =
		OpenAPI_sm_context_update_data_create(
			...
			failed_to_be_switched ?
			failed_to_be_switched->valueint : 0,
			...
			target_serving_nf_id &&
			!cJSON_IsNull(target_serving_nf_id) ?
			ogs_strdup(target_serving_nf_id->valuestring) : NULL,
			sm_context_status_uri &&
			!cJSON_IsNull(sm_context_status_uri) ?
			ogs_strdup(sm_context_status_uri->valuestring) : NULL,
			...
			NULL,
			n9_dl_forwarding_tnl_list ?
			n9_dl_forwarding_tnl_listList :
			NULL,
			n9_ul_forwarding_tnl_list ?
			n9_ul_forwarding_tnl_listList :
			NULL,
			n9_dl_forwarding_tunnel ?
			n9_dl_forwarding_tunnel_local_nonprim : NULL,
			n9_inactivity_timer ? true : false,
			n9_inactivity_timer ? n9_inactivity_timer->valuedouble :
			0,
			...
			_5g_mm_cause_value ? _5g_mm_cause_value->valuedouble :
			0,
			...
			an_type_can_be_changed ?
			an_type_can_be_changed->valueint : 0,
			...
			forwarding_f_teid &&
			!cJSON_IsNull(forwarding_f_teid) ?
			ogs_strdup(forwarding_f_teid->valuestring) : NULL,
			forwarding_bearer_contexts ?
			forwarding_bearer_contextsList :
			NULL,
			...
			skip_n2_pdu_session_res_rel_ind ?
			skip_n2_pdu_session_res_rel_ind->valueint : 0,
			secondary_rat_usage_data_report_container ?
...
OpenAPI_sm_context_update_data_t *OpenAPI_sm_context_update_data_copy(
	OpenAPI_sm_context_update_data_t	*dst,
	OpenAPI_sm_context_update_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_sm_context_update_data_convertToJSON() failed");
		return NULL;
	}
