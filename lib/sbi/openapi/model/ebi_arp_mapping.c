...
OpenAPI_ebi_arp_mapping_t *OpenAPI_ebi_arp_mapping_create(
	int		eps_bearer_id,
	OpenAPI_arp_t	*arp) {
	OpenAPI_ebi_arp_mapping_t *ebi_arp_mapping_local_var =
		ogs_malloc(sizeof(OpenAPI_ebi_arp_mapping_t));
...
cJSON *OpenAPI_ebi_arp_mapping_convertToJSON(
	OpenAPI_ebi_arp_mapping_t *ebi_arp_mapping) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(ebi_arp_mapping == NULL) {
		ogs_error(
			"OpenAPI_ebi_arp_mapping_convertToJSON() failed [EbiArpMapping]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ebi_arp_mapping_convertToJSON() failed [eps_bearer_id]");
		goto end;
	}

	if(!ebi_arp_mapping->arp) {
		ogs_error(
			"OpenAPI_ebi_arp_mapping_convertToJSON() failed [arp]");
		return NULL;
	}
...
OpenAPI_ebi_arp_mapping_t *OpenAPI_ebi_arp_mapping_parseFromJSON(
	cJSON *ebi_arp_mappingJSON) {
	...
	if(!eps_bearer_id) {
		ogs_error(
			"OpenAPI_ebi_arp_mapping_parseFromJSON() failed [eps_bearer_id]");
		goto end;
	}
	...
	if(!arp) {
		ogs_error(
			"OpenAPI_ebi_arp_mapping_parseFromJSON() failed [arp]");
		goto end;
	}
...
OpenAPI_ebi_arp_mapping_t *OpenAPI_ebi_arp_mapping_copy(
	OpenAPI_ebi_arp_mapping_t *dst, OpenAPI_ebi_arp_mapping_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
