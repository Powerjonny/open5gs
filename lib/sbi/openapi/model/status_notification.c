...
OpenAPI_status_notification_t *OpenAPI_status_notification_create(
	...
	OpenAPI_target_dnai_info_t *target_dnai_info, char *old_pdu_session_ref,
	char *new_smf_id, OpenAPI_eps_pdn_cnx_info_t *eps_pdn_cnx_info,
	char *inter_plmn_api_root, char *intra_plmn_api_root) {
	OpenAPI_status_notification_t *status_notification_local_var =
		ogs_malloc(sizeof(OpenAPI_status_notification_t));
	ogs_assert(status_notification_local_var);

	status_notification_local_var->status_info = status_info;
	status_notification_local_var->small_data_rate_status =
	...
	status_notification_local_var->old_pdu_session_ref =
		old_pdu_session_ref;
	status_notification_local_var->new_smf_id = new_smf_id;
	status_notification_local_var->eps_pdn_cnx_info = eps_pdn_cnx_info;
	status_notification_local_var->inter_plmn_api_root =
		inter_plmn_api_root;
	status_notification_local_var->intra_plmn_api_root =
		intra_plmn_api_root;

	return status_notification_local_var;
}

void OpenAPI_status_notification_free(
	OpenAPI_status_notification_t *status_notification) {
...
cJSON *OpenAPI_status_notification_convertToJSON(
	OpenAPI_status_notification_t *status_notification) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(status_notification == NULL) {
		ogs_error(
			"OpenAPI_status_notification_convertToJSON() failed [StatusNotification]");
		return NULL;
	}
	...
	if(!status_notification->status_info) {
		ogs_error(
			"OpenAPI_status_notification_convertToJSON() failed [status_info]");
		return NULL;
	}
	cJSON *status_info_local_JSON =
		OpenAPI_status_info_convertToJSON(
			status_notification->status_info);
	...
	if(status_notification->small_data_rate_status) {
		...
		if(small_data_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [small_data_rate_status]");
			goto end;
		}
	...
	if(status_notification->apn_rate_status) {
		...
		if(apn_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [apn_rate_status]");
			goto end;
		}
	...
	if(status_notification->target_dnai_info) {
		...
		if(target_dnai_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [target_dnai_info]");
			goto end;
		}
	...
	if(status_notification->old_pdu_session_ref) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [old_pdu_session_ref]");
			goto end;
		}
	}
	...
	if(status_notification->new_smf_id) {
		if(cJSON_AddStringToObject(item, "newSmfId",
		                           status_notification->new_smf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [new_smf_id]");
			goto end;
		}
	}
	...
	if(status_notification->eps_pdn_cnx_info) {
		...
		if(eps_pdn_cnx_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [eps_pdn_cnx_info]");
			goto end;
		}
	...
	if(status_notification->inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(status_notification->intra_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_convertToJSON() failed [intra_plmn_api_root]");
			goto end;
		}
	}
...
OpenAPI_status_notification_t *OpenAPI_status_notification_parseFromJSON(
	cJSON *status_notificationJSON) {
	...
	status_info = cJSON_GetObjectItemCaseSensitive(status_notificationJSON,
	                                               "statusInfo");
	if(!status_info) {
		ogs_error(
			"OpenAPI_status_notification_parseFromJSON() failed [status_info]");
		goto end;
	}
	...
	if(old_pdu_session_ref) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_parseFromJSON() failed [old_pdu_session_ref]");
			goto end;
		}
	}

	new_smf_id = cJSON_GetObjectItemCaseSensitive(status_notificationJSON,
	                                              "newSmfId");
	if(new_smf_id) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_parseFromJSON() failed [new_smf_id]");
			goto end;
		}
	}
	...
	if(inter_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_parseFromJSON() failed [inter_plmn_api_root]");
			goto end;
		}
	}
	...
	if(intra_plmn_api_root) {
		...
		{
			ogs_error(
				"OpenAPI_status_notification_parseFromJSON() failed [intra_plmn_api_root]");
			goto end;
		}
	}
	...
	status_notification_local_var = OpenAPI_status_notification_create(
		status_info_local_nonprim,
		small_data_rate_status ? small_data_rate_status_local_nonprim :
		NULL,
...
OpenAPI_status_notification_t *OpenAPI_status_notification_copy(
	OpenAPI_status_notification_t	*dst,
	OpenAPI_status_notification_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
