...
OpenAPI_ulcl_bp_information_t *OpenAPI_ulcl_bp_information_create(
	char *ulcl_bp_upf_id) {
	OpenAPI_ulcl_bp_information_t *ulcl_bp_information_local_var =
		ogs_malloc(sizeof(OpenAPI_ulcl_bp_information_t));
...
void OpenAPI_ulcl_bp_information_free(
	OpenAPI_ulcl_bp_information_t *ulcl_bp_information) {
...
cJSON *OpenAPI_ulcl_bp_information_convertToJSON(
	...
	if(ulcl_bp_information == NULL) {
		ogs_error(
			"OpenAPI_ulcl_bp_information_convertToJSON() failed [UlclBpInformation]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(ulcl_bp_information->ulcl_bp_upf_id) {
		if(cJSON_AddStringToObject(item, "ulclBpUpfId",
		                           ulcl_bp_information->ulcl_bp_upf_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_ulcl_bp_information_convertToJSON() failed [ulcl_bp_upf_id]");
			goto end;
		}
	}
...
OpenAPI_ulcl_bp_information_t *OpenAPI_ulcl_bp_information_parseFromJSON(
	cJSON *ulcl_bp_informationJSON) {
	OpenAPI_ulcl_bp_information_t *ulcl_bp_information_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *ulcl_bp_upf_id = NULL;
	ulcl_bp_upf_id =
		cJSON_GetObjectItemCaseSensitive(ulcl_bp_informationJSON,
		                                 "ulclBpUpfId");
	if(ulcl_bp_upf_id) {
		if(!cJSON_IsString(ulcl_bp_upf_id) &&
		   !cJSON_IsNull(ulcl_bp_upf_id))
		{
			ogs_error(
				"OpenAPI_ulcl_bp_information_parseFromJSON() failed [ulcl_bp_upf_id]");
			goto end;
		}
	}
	...
	ulcl_bp_information_local_var = OpenAPI_ulcl_bp_information_create(
		ulcl_bp_upf_id &&
		!cJSON_IsNull(ulcl_bp_upf_id) ?
		ogs_strdup(ulcl_bp_upf_id->valuestring) : NULL
		);
...
OpenAPI_ulcl_bp_information_t *OpenAPI_ulcl_bp_information_copy(
	OpenAPI_ulcl_bp_information_t	*dst,
	OpenAPI_ulcl_bp_information_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
