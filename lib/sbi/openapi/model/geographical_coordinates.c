...
OpenAPI_geographical_coordinates_t *OpenAPI_geographical_coordinates_create(
	...
	OpenAPI_geographical_coordinates_t *geographical_coordinates_local_var =
		ogs_malloc(sizeof(OpenAPI_geographical_coordinates_t));
...
void OpenAPI_geographical_coordinates_free(
	OpenAPI_geographical_coordinates_t *geographical_coordinates) {
...
cJSON *OpenAPI_geographical_coordinates_convertToJSON(
	OpenAPI_geographical_coordinates_t *geographical_coordinates) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(geographical_coordinates == NULL) {
		ogs_error(
			"OpenAPI_geographical_coordinates_convertToJSON() failed [GeographicalCoordinates]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographical_coordinates_convertToJSON() failed [lon]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_geographical_coordinates_convertToJSON() failed [lat]");
		goto end;
	}
...
OpenAPI_geographical_coordinates_parseFromJSON(
	...
	if(!lon) {
		ogs_error(
			"OpenAPI_geographical_coordinates_parseFromJSON() failed [lon]");
		goto end;
	}
	...
	if(!lat) {
		ogs_error(
			"OpenAPI_geographical_coordinates_parseFromJSON() failed [lat]");
		goto end;
	}
	...
	geographical_coordinates_local_var =
		OpenAPI_geographical_coordinates_create(
...
OpenAPI_geographical_coordinates_t *OpenAPI_geographical_coordinates_copy(
	OpenAPI_geographical_coordinates_t	*dst,
	OpenAPI_geographical_coordinates_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_geographical_coordinates_convertToJSON() failed");
		return NULL;
	}
