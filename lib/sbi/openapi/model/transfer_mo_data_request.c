...
OpenAPI_transfer_mo_data_request_t *OpenAPI_transfer_mo_data_request_create(
	...
	OpenAPI_transfer_mo_data_request_t *transfer_mo_data_request_local_var =
		ogs_malloc(sizeof(OpenAPI_transfer_mo_data_request_t));
...
void OpenAPI_transfer_mo_data_request_free(
	OpenAPI_transfer_mo_data_request_t *transfer_mo_data_request) {
	...
	if(transfer_mo_data_request->json_data) {
		OpenAPI_transfer_mo_data_req_data_free(
			transfer_mo_data_request->json_data);
...
cJSON *OpenAPI_transfer_mo_data_request_convertToJSON(
	...
	if(transfer_mo_data_request == NULL) {
		ogs_error(
			"OpenAPI_transfer_mo_data_request_convertToJSON() failed [TransferMoData_request]");
		return NULL;
	}
	...
	if(transfer_mo_data_request->json_data) {
		cJSON *json_data_local_JSON =
			OpenAPI_transfer_mo_data_req_data_convertToJSON(
				transfer_mo_data_request->json_data);
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_transfer_mo_data_request_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(transfer_mo_data_request->binary_mo_data) {
		char *encoded_str_binary_mo_data =
			OpenAPI_base64encode(
				transfer_mo_data_request->binary_mo_data->data,
				transfer_mo_data_request->binary_mo_data->len);
		if(cJSON_AddStringToObject(item, "binaryMoData",
		                           encoded_str_binary_mo_data) == NULL)
		{
			ogs_error(
				"OpenAPI_transfer_mo_data_request_convertToJSON() failed [binary_mo_data]");
			goto end;
		}
...
OpenAPI_transfer_mo_data_request_parseFromJSON(
	...
	json_data =
		cJSON_GetObjectItemCaseSensitive(transfer_mo_data_requestJSON,
		                                 "jsonData");
	if(json_data) {
		...
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_transfer_mo_data_req_data_parseFromJSON failed [json_data]");
			goto end;
		}
	}
	...
	if(binary_mo_data) {
		...
		if(!cJSON_IsString(binary_mo_data)) {
			ogs_error(
				"OpenAPI_transfer_mo_data_request_parseFromJSON() failed [binary_mo_data]");
			goto end;
		}
	...
	transfer_mo_data_request_local_var =
...
OpenAPI_transfer_mo_data_request_t *OpenAPI_transfer_mo_data_request_copy(
	OpenAPI_transfer_mo_data_request_t	*dst,
	OpenAPI_transfer_mo_data_request_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_transfer_mo_data_request_convertToJSON() failed");
		return NULL;
	}
