...
typedef enum { OpenAPI_ngap_ie_type_NULL = 0,
	       ...
	       OpenAPI_ngap_ie_type_TAR_TO_SRC_FAIL_CONTAINER,
	       ...
	       OpenAPI_ngap_ie_type_PC5_QOS_PARA,
	       OpenAPI_ngap_ie_type_EARLY_STATUS_TRANS_CONTAINER,
	       OpenAPI_ngap_ie_type_UE_RADIO_CAPABILITY_FOR_PAGING }
