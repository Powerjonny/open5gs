...
OpenAPI_operator_specific_data_container_value_create() {
	OpenAPI_operator_specific_data_container_value_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_operator_specific_data_container_value_t));
...
cJSON *OpenAPI_operator_specific_data_container_value_convertToJSON(
	...
	if(operator_specific_data_container_value == NULL) {
		ogs_error(
			"OpenAPI_operator_specific_data_container_value_convertToJSON() failed [OperatorSpecificDataContainer_value]");
		return NULL;
	}
...
OpenAPI_operator_specific_data_container_value_parseFromJSON(
	...
	OpenAPI_operator_specific_data_container_value_t *
	        operator_specific_data_container_value_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	operator_specific_data_container_value_local_var =
		OpenAPI_operator_specific_data_container_value_create(
			);
...
OpenAPI_operator_specific_data_container_value_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_operator_specific_data_container_value_convertToJSON() failed");
		return NULL;
	}
