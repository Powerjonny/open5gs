...
char * OpenAPI_notification_control_ToString(
	...
	const char *notification_controlArray[] = { "NULL", "REQUESTED",
		                                    "NOT_REQUESTED" };
	size_t sizeofArray = sizeof(notification_controlArray) /
	                     sizeof(notification_controlArray[0]);
...
OpenAPI_notification_control_e OpenAPI_notification_control_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(notification_control,
		          notification_controlArray[stringToReturn]) == 0) {
