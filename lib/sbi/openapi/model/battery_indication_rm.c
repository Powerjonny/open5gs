...
OpenAPI_battery_indication_rm_t *OpenAPI_battery_indication_rm_create(
	...
	OpenAPI_battery_indication_rm_t *battery_indication_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_battery_indication_rm_t));
	...
	battery_indication_rm_local_var->is_replaceable_ind =
		is_replaceable_ind;
	battery_indication_rm_local_var->replaceable_ind = replaceable_ind;
	battery_indication_rm_local_var->is_rechargeable_ind =
		is_rechargeable_ind;
...
cJSON *OpenAPI_battery_indication_rm_convertToJSON(
	...
	if(battery_indication_rm == NULL) {
		ogs_error(
			"OpenAPI_battery_indication_rm_convertToJSON() failed [BatteryIndicationRm]");
		return NULL;
	}
	...
	if(battery_indication_rm->is_battery_ind) {
		if(cJSON_AddBoolToObject(item, "batteryInd",
		                         battery_indication_rm->battery_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_battery_indication_rm_convertToJSON() failed [battery_ind]");
			goto end;
		}
	}
	...
	if(battery_indication_rm->is_replaceable_ind) {
		if(cJSON_AddBoolToObject(item, "replaceableInd",
		                         battery_indication_rm->replaceable_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_battery_indication_rm_convertToJSON() failed [replaceable_ind]");
			goto end;
		}
	}
	...
	if(battery_indication_rm->is_rechargeable_ind) {
		if(cJSON_AddBoolToObject(item, "rechargeableInd",
		                         battery_indication_rm->rechargeable_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_battery_indication_rm_convertToJSON() failed [rechargeable_ind]");
			goto end;
		}
	}
...
OpenAPI_battery_indication_rm_t *OpenAPI_battery_indication_rm_parseFromJSON(
	...
	battery_ind =
		cJSON_GetObjectItemCaseSensitive(battery_indication_rmJSON,
		                                 "batteryInd");
	if(battery_ind) {
		if(!cJSON_IsBool(battery_ind)) {
			ogs_error(
				"OpenAPI_battery_indication_rm_parseFromJSON() failed [battery_ind]");
			goto end;
		}
	}
	...
	if(replaceable_ind) {
		if(!cJSON_IsBool(replaceable_ind)) {
			ogs_error(
				"OpenAPI_battery_indication_rm_parseFromJSON() failed [replaceable_ind]");
			goto end;
		}
	}
	...
	if(rechargeable_ind) {
		if(!cJSON_IsBool(rechargeable_ind)) {
			ogs_error(
				"OpenAPI_battery_indication_rm_parseFromJSON() failed [rechargeable_ind]");
			goto end;
		}
	}
...
OpenAPI_battery_indication_rm_t *OpenAPI_battery_indication_rm_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_battery_indication_rm_convertToJSON() failed");
		return NULL;
	}
