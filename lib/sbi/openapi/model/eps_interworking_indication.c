...
char * OpenAPI_eps_interworking_indication_ToString(
	...
	const char *eps_interworking_indicationArray[] = { "NULL", "NONE",
		                                           "WITH_N26",
		                                           "WITHOUT_N26",
		                                           "IWK_NON_3GPP" };
	size_t sizeofArray = sizeof(eps_interworking_indicationArray) /
	                     sizeof(eps_interworking_indicationArray[0]);
	if(eps_interworking_indication < sizeofArray) {
		return (char *) eps_interworking_indicationArray[
...
OpenAPI_eps_interworking_indication_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(eps_interworking_indication,
		          eps_interworking_indicationArray[stringToReturn]) ==
		   0) {
