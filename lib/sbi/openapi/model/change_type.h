...
typedef enum { OpenAPI_change_type_NULL = 0, OpenAPI_change_type_ADD,
	       OpenAPI_change_type_MOVE, OpenAPI_change_type__REMOVE,
	       OpenAPI_change_type_REPLACE } OpenAPI_change_type_e;
