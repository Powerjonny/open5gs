...
char *OpenAPI_grant_typeaccess_token_req_ToString(
...
OpenAPI_access_token_req_grant_type_e
OpenAPI_grant_typeaccess_token_req_FromString(char *grant_type) {
...
OpenAPI_access_token_req_t *OpenAPI_access_token_req_create(
	OpenAPI_access_token_req_grant_type_e grant_type, char *nf_instance_id,
	OpenAPI_nf_type_e nf_type, OpenAPI_nf_type_e target_nf_type,
	char *scope, char *target_nf_instance_id,
	OpenAPI_plmn_id_t *requester_plmn, OpenAPI_list_t *requester_plmn_list,
	OpenAPI_list_t *requester_snssai_list, char *requester_fqdn,
	OpenAPI_list_t *requester_snpn_list, OpenAPI_plmn_id_t *target_plmn,
	OpenAPI_plmn_id_nid_t *target_snpn, OpenAPI_list_t *target_snssai_list,
	OpenAPI_list_t *target_nsi_list, char *target_nf_set_id,
	char *target_nf_service_set_id, char *hnrf_access_token_uri,
	char *source_nf_instance_id) {
	OpenAPI_access_token_req_t *access_token_req_local_var =
		ogs_malloc(sizeof(OpenAPI_access_token_req_t));
...
void OpenAPI_access_token_req_free(
	OpenAPI_access_token_req_t *access_token_req) {
	...
	if(access_token_req->requester_plmn_list) {
		OpenAPI_list_for_each(access_token_req->requester_plmn_list,
		                      node) {
	...
	if(access_token_req->requester_snssai_list) {
		OpenAPI_list_for_each(access_token_req->requester_snssai_list,
		                      node) {
	...
	if(access_token_req->requester_snpn_list) {
		OpenAPI_list_for_each(access_token_req->requester_snpn_list,
		                      node) {
	...
	if(access_token_req->target_snssai_list) {
		OpenAPI_list_for_each(access_token_req->target_snssai_list,
		                      node) {
			OpenAPI_snssai_free(node->data);
		}
...
cJSON *OpenAPI_access_token_req_convertToJSON(
	OpenAPI_access_token_req_t *access_token_req) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(access_token_req == NULL) {
		ogs_error(
			"OpenAPI_access_token_req_convertToJSON() failed [AccessTokenReq]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(access_token_req->grant_type ==
	   OpenAPI_access_token_req_GRANTTYPE_NULL)
	{
		ogs_error(
			"OpenAPI_access_token_req_convertToJSON() failed [grant_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "grant_type",
	                           OpenAPI_grant_typeaccess_token_req_ToString(
	...
	if(!access_token_req->nf_instance_id) {
		ogs_error(
			"OpenAPI_access_token_req_convertToJSON() failed [nf_instance_id]");
		return NULL;
	}
	...
	if(access_token_req->nf_type != OpenAPI_nf_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [nf_type]");
			goto end;
		}
	}

	if(access_token_req->target_nf_type != OpenAPI_nf_type_NULL) {
		if(cJSON_AddStringToObject(item, "targetNfType",
		                           OpenAPI_nf_type_ToString(
						   access_token_req->
						   target_nf_type)) == NULL)
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_nf_type]");
			goto end;
		}
	}
	...
	if(!access_token_req->scope) {
		ogs_error(
			"OpenAPI_access_token_req_convertToJSON() failed [scope]");
		return NULL;
	}
	...
	if(access_token_req->target_nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_nf_instance_id]");
			goto end;
		}
	}

	if(access_token_req->requester_plmn) {
		cJSON *requester_plmn_local_JSON =
			OpenAPI_plmn_id_convertToJSON(
				access_token_req->requester_plmn);
		if(requester_plmn_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [requester_plmn]");
			goto end;
		}
	...
	if(access_token_req->requester_plmn_list) {
		...
		if(requester_plmn_listList == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [requester_plmn_list]");
			goto end;
		}
		OpenAPI_list_for_each(access_token_req->requester_plmn_list,
		                      node) {
	...
	if(access_token_req->requester_snssai_list) {
		...
		if(requester_snssai_listList == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [requester_snssai_list]");
			goto end;
		}
		OpenAPI_list_for_each(access_token_req->requester_snssai_list,
		                      node) {
	...
	if(access_token_req->requester_fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [requester_fqdn]");
			goto end;
		}
	}
	...
	if(access_token_req->requester_snpn_list) {
		...
		if(requester_snpn_listList == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [requester_snpn_list]");
			goto end;
		}
		OpenAPI_list_for_each(access_token_req->requester_snpn_list,
		                      node) {
	...
	if(access_token_req->target_plmn) {
		cJSON *target_plmn_local_JSON =
			OpenAPI_plmn_id_convertToJSON(
				access_token_req->target_plmn);
		if(target_plmn_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_plmn]");
			goto end;
		}
	...
	if(access_token_req->target_snssai_list) {
		...
		if(target_snssai_listList == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_snssai_list]");
			goto end;
		}
		OpenAPI_list_for_each(access_token_req->target_snssai_list,
		                      node) {
	...
	if(access_token_req->target_nsi_list) {
		...
		if(target_nsi_listList == NULL) {
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_nsi_list]");
			goto end;
		}
		OpenAPI_list_for_each(access_token_req->target_nsi_list, node) {
	...
	if(access_token_req->target_nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_nf_set_id]");
			goto end;
		}
	}
	...
	if(access_token_req->target_nf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [target_nf_service_set_id]");
			goto end;
		}
	}
	...
	if(access_token_req->hnrf_access_token_uri) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [hnrf_access_token_uri]");
			goto end;
		}
	}
	...
	if(access_token_req->source_nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_convertToJSON() failed [source_nf_instance_id]");
			goto end;
		}
	}
...
OpenAPI_access_token_req_t *OpenAPI_access_token_req_parseFromJSON(
	cJSON *access_token_reqJSON) {
	...
	if(!grant_type) {
		ogs_error(
			"OpenAPI_access_token_req_parseFromJSON() failed [grant_type]");
		goto end;
	}
	...
	grant_typeVariable =
		OpenAPI_grant_typeaccess_token_req_FromString(
	...
	if(!nf_instance_id) {
		ogs_error(
			"OpenAPI_access_token_req_parseFromJSON() failed [nf_instance_id]");
		goto end;
	}
	...
	if(nf_type) {
		if(!cJSON_IsString(nf_type)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [nf_type]");
			goto end;
		}
		nf_typeVariable =
			OpenAPI_nf_type_FromString(nf_type->valuestring);
	}
	...
	if(target_nf_type) {
		if(!cJSON_IsString(target_nf_type)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [target_nf_type]");
			goto end;
		}
		target_nf_typeVariable =
	...
	if(!scope) {
		ogs_error(
			"OpenAPI_access_token_req_parseFromJSON() failed [scope]");
		goto end;
	}
	...
	if(target_nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [target_nf_instance_id]");
			goto end;
		}
	}
	...
	requester_plmn = cJSON_GetObjectItemCaseSensitive(access_token_reqJSON,
	                                                  "requesterPlmn");
	if(requester_plmn) {
		requester_plmn_local_nonprim =
			OpenAPI_plmn_id_parseFromJSON(requester_plmn);
		if(!requester_plmn_local_nonprim) {
			ogs_error(
				"OpenAPI_plmn_id_parseFromJSON failed [requester_plmn]");
			goto end;
		}
	}
	...
	if(requester_plmn_list) {
		...
		if(!cJSON_IsArray(requester_plmn_list)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [requester_plmn_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(requester_plmn_list_local,
			...
			OpenAPI_plmn_id_t *requester_plmn_listItem =
				OpenAPI_plmn_id_parseFromJSON(
					requester_plmn_list_local);
			if(!requester_plmn_listItem) {
				ogs_error("No requester_plmn_listItem");
				goto end;
			}
			OpenAPI_list_add(requester_plmn_listList,
	...
	if(requester_snssai_list) {
		...
		if(!cJSON_IsArray(requester_snssai_list)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [requester_snssai_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(requester_snssai_list_local,
			...
			OpenAPI_snssai_t *requester_snssai_listItem =
				OpenAPI_snssai_parseFromJSON(
					requester_snssai_list_local);
			if(!requester_snssai_listItem) {
				ogs_error("No requester_snssai_listItem");
				goto end;
			}
			OpenAPI_list_add(requester_snssai_listList,
	...
	if(requester_fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [requester_fqdn]");
			goto end;
		}
	}
	...
	if(requester_snpn_list) {
		...
		if(!cJSON_IsArray(requester_snpn_list)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [requester_snpn_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(requester_snpn_list_local,
			...
			OpenAPI_plmn_id_nid_t *requester_snpn_listItem =
			...
			OpenAPI_list_add(requester_snpn_listList,
	...
	target_plmn = cJSON_GetObjectItemCaseSensitive(access_token_reqJSON,
	                                               "targetPlmn");
	if(target_plmn) {
		target_plmn_local_nonprim =
			OpenAPI_plmn_id_parseFromJSON(target_plmn);
		if(!target_plmn_local_nonprim) {
			ogs_error(
				"OpenAPI_plmn_id_parseFromJSON failed [target_plmn]");
			goto end;
		}
	}
	...
	target_snpn = cJSON_GetObjectItemCaseSensitive(access_token_reqJSON,
	                                               "targetSnpn");
	if(target_snpn) {
		target_snpn_local_nonprim =
			OpenAPI_plmn_id_nid_parseFromJSON(target_snpn);
		if(!target_snpn_local_nonprim) {
			ogs_error(
				"OpenAPI_plmn_id_nid_parseFromJSON failed [target_snpn]");
			goto end;
		}
	}
	...
	if(target_snssai_list) {
		...
		if(!cJSON_IsArray(target_snssai_list)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [target_snssai_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(target_snssai_list_local,
			...
			OpenAPI_snssai_t *target_snssai_listItem =
				OpenAPI_snssai_parseFromJSON(
			...
			OpenAPI_list_add(target_snssai_listList,
	...
	if(target_nsi_list) {
		...
		if(!cJSON_IsArray(target_nsi_list)) {
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [target_nsi_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(target_nsi_list_local, target_nsi_list) {
			...
			OpenAPI_list_add(target_nsi_listList,
			                 ogs_strdup(
						 target_nsi_list_local->
						 valuestring));
		}
	}
	...
	if(target_nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [target_nf_set_id]");
			goto end;
		}
	}
	...
	if(target_nf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [target_nf_service_set_id]");
			goto end;
		}
	}
	...
	if(hnrf_access_token_uri) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [hnrf_access_token_uri]");
			goto end;
		}
	}
	...
	if(source_nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_access_token_req_parseFromJSON() failed [source_nf_instance_id]");
			goto end;
		}
	}
	...
	access_token_req_local_var = OpenAPI_access_token_req_create(
		...
		target_nf_instance_id &&
		!cJSON_IsNull(target_nf_instance_id) ?
		ogs_strdup(target_nf_instance_id->valuestring) : NULL,
		...
		requester_fqdn &&
		!cJSON_IsNull(requester_fqdn) ?
		ogs_strdup(requester_fqdn->valuestring) : NULL,
		...
		target_nf_set_id &&
		!cJSON_IsNull(target_nf_set_id) ?
		ogs_strdup(target_nf_set_id->valuestring) : NULL,
		target_nf_service_set_id &&
		!cJSON_IsNull(target_nf_service_set_id) ?
		ogs_strdup(target_nf_service_set_id->valuestring) : NULL,
		hnrf_access_token_uri &&
		!cJSON_IsNull(hnrf_access_token_uri) ?
		ogs_strdup(hnrf_access_token_uri->valuestring) : NULL,
		source_nf_instance_id &&
		!cJSON_IsNull(source_nf_instance_id) ?
		ogs_strdup(source_nf_instance_id->valuestring) : NULL
		);
...
OpenAPI_access_token_req_t *OpenAPI_access_token_req_copy(
	OpenAPI_access_token_req_t *dst, OpenAPI_access_token_req_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
