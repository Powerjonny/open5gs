...
OpenAPI_twap_id_t *OpenAPI_twap_id_create(char *ss_id, char *bss_id,
                                          char *civic_address) {
	OpenAPI_twap_id_t *twap_id_local_var =
		ogs_malloc(sizeof(OpenAPI_twap_id_t));
...
cJSON *OpenAPI_twap_id_convertToJSON(OpenAPI_twap_id_t *twap_id) {
	...
	if(twap_id->bss_id) {
		...
		{
			ogs_error(
				"OpenAPI_twap_id_convertToJSON() failed [bss_id]");
			goto end;
		}
	}
	...
	if(twap_id->civic_address) {
		...
		{
			ogs_error(
				"OpenAPI_twap_id_convertToJSON() failed [civic_address]");
			goto end;
		}
	}
...
OpenAPI_twap_id_t *OpenAPI_twap_id_parseFromJSON(cJSON *twap_idJSON) {
	...
	if(bss_id) {
		...
		{
			ogs_error(
				"OpenAPI_twap_id_parseFromJSON() failed [bss_id]");
			goto end;
		}
	}
	...
	if(civic_address) {
		...
		{
			ogs_error(
				"OpenAPI_twap_id_parseFromJSON() failed [civic_address]");
			goto end;
		}
	}
...
OpenAPI_twap_id_t *OpenAPI_twap_id_copy(OpenAPI_twap_id_t	*dst,
                                        OpenAPI_twap_id_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
