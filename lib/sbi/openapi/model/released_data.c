...
OpenAPI_released_data_t *OpenAPI_released_data_create(
	...
	OpenAPI_released_data_t *released_data_local_var =
		ogs_malloc(sizeof(OpenAPI_released_data_t));
	ogs_assert(released_data_local_var);

	released_data_local_var->small_data_rate_status =
...
cJSON *OpenAPI_released_data_convertToJSON(
	OpenAPI_released_data_t *released_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(released_data == NULL) {
		ogs_error(
			"OpenAPI_released_data_convertToJSON() failed [ReleasedData]");
		return NULL;
	}
	...
	if(released_data->small_data_rate_status) {
		...
		if(small_data_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_released_data_convertToJSON() failed [small_data_rate_status]");
			goto end;
		}
	...
	if(released_data->apn_rate_status) {
		cJSON *apn_rate_status_local_JSON =
			OpenAPI_apn_rate_status_convertToJSON(
				released_data->apn_rate_status);
		if(apn_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_released_data_convertToJSON() failed [apn_rate_status]");
			goto end;
		}
	...
	if(released_data->n4_info) {
		cJSON *n4_info_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				released_data->n4_info);
		if(n4_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_released_data_convertToJSON() failed [n4_info]");
			goto end;
		}
	...
	if(released_data->n4_info_ext1) {
		cJSON *n4_info_ext1_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				released_data->n4_info_ext1);
		if(n4_info_ext1_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_released_data_convertToJSON() failed [n4_info_ext1]");
			goto end;
		}
	...
	if(released_data->n4_info_ext2) {
		cJSON *n4_info_ext2_local_JSON =
			OpenAPI_n4_information_convertToJSON(
				released_data->n4_info_ext2);
		if(n4_info_ext2_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_released_data_convertToJSON() failed [n4_info_ext2]");
			goto end;
		}
...
OpenAPI_released_data_t *OpenAPI_released_data_parseFromJSON(
	cJSON *released_dataJSON) {
	...
	small_data_rate_status =
		cJSON_GetObjectItemCaseSensitive(released_dataJSON,
		                                 "smallDataRateStatus");
	...
	apn_rate_status = cJSON_GetObjectItemCaseSensitive(released_dataJSON,
	                                                   "apnRateStatus");
	if(apn_rate_status) {
	...
	n4_info_ext1 = cJSON_GetObjectItemCaseSensitive(released_dataJSON,
	                                                "n4InfoExt1");
	if(n4_info_ext1) {
	...
	n4_info_ext2 = cJSON_GetObjectItemCaseSensitive(released_dataJSON,
	                                                "n4InfoExt2");
	if(n4_info_ext2) {
...
OpenAPI_released_data_t *OpenAPI_released_data_copy(
	OpenAPI_released_data_t *dst, OpenAPI_released_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
