...
OpenAPI_create_ue_context_request_t *OpenAPI_create_ue_context_request_create(
	...
	OpenAPI_create_ue_context_request_t *create_ue_context_request_local_var
	        = ogs_malloc(sizeof(OpenAPI_create_ue_context_request_t));
...
void OpenAPI_create_ue_context_request_free(
	...
	if(create_ue_context_request->json_data) {
		OpenAPI_ue_context_create_data_free(
	...
	if(create_ue_context_request->binary_data_n2_information_ext17) {
		ogs_free(
			create_ue_context_request->
			binary_data_n2_information_ext17->data);
...
cJSON *OpenAPI_create_ue_context_request_convertToJSON(
	OpenAPI_create_ue_context_request_t *create_ue_context_request) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(create_ue_context_request == NULL) {
		ogs_error(
			"OpenAPI_create_ue_context_request_convertToJSON() failed [CreateUEContext_request]");
		return NULL;
	}
	...
	if(create_ue_context_request->json_data) {
		cJSON *json_data_local_JSON =
			OpenAPI_ue_context_create_data_convertToJSON(
				create_ue_context_request->json_data);
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext1) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext1]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext2) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext2]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext3) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext3]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext4) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext4]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext5) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext5]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext6) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext6]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext7) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext7]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext8) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext8]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext9) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext9]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext10) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext10]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext11) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext11]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext12) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext12]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext13) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext13]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext14) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext14]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext15) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext15]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext16) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext16]");
			goto end;
		}
	...
	if(create_ue_context_request->binary_data_n2_information_ext17) {
		char *encoded_str_binary_data_n2_information_ext17 =
			OpenAPI_base64encode(
				...
				binary_data_n2_information_ext17->data,
				create_ue_context_request->
				binary_data_n2_information_ext17->len);
		if(cJSON_AddStringToObject(item, "binaryDataN2InformationExt17",
		                           encoded_str_binary_data_n2_information_ext17)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext17]");
			goto end;
		}
...
OpenAPI_create_ue_context_request_parseFromJSON(
	...
	json_data =
		cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON,
		                                 "jsonData");
	if(json_data) {
		json_data_local_nonprim =
			OpenAPI_ue_context_create_data_parseFromJSON(json_data);
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_ue_context_create_data_parseFromJSON failed [json_data]");
			goto end;
		}
	}
	...
	if(binary_data_n2_information) {
		...
		if(!cJSON_IsString(binary_data_n2_information)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext1) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext1)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext1]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext2) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext2)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext2]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext3) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext3)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext3]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext4) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext4)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext4]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext5) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext5)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext5]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext6) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext6)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext6]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext7) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext7)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext7]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext8) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext8)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext8]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext9) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext9)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext9]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext10) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext10)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext10]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext11) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext11)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext11]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext12) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext12)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext12]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext13) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext13)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext13]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext14) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext14)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext14]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext15) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext15)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext15]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext16) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext16)) {
			ogs_error(
				"OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext16]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext17) {
		...
		decoded_str_binary_data_n2_information_ext17->data =
			OpenAPI_base64decode(
				binary_data_n2_information_ext17->valuestring,
				strlen(
					binary_data_n2_information_ext17->
					valuestring),
				&decoded_str_binary_data_n2_information_ext17->
	...
	create_ue_context_request_local_var =
		OpenAPI_create_ue_context_request_create(
			...
			binary_data_n2_information_ext17 ?
			decoded_str_binary_data_n2_information_ext17 : NULL
			);
...
OpenAPI_create_ue_context_request_t *OpenAPI_create_ue_context_request_copy(
	OpenAPI_create_ue_context_request_t	*dst,
	OpenAPI_create_ue_context_request_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_create_ue_context_request_convertToJSON() failed");
		return NULL;
	}
