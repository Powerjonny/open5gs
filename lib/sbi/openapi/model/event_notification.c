...
OpenAPI_event_notification_t *OpenAPI_event_notification_create(
	OpenAPI_nwdaf_event_t *event, char *start, char *expiry,
	char *time_stamp_gen, OpenAPI_nwdaf_failure_code_t *fail_notify_code,
	bool is_rv_wait_time, int rv_wait_time,
	...
	OpenAPI_list_t *svc_exps, OpenAPI_list_t *qos_sustain_infos,
	OpenAPI_list_t *ue_comms, OpenAPI_list_t *ue_mobs,
	OpenAPI_list_t *user_data_cong_infos, OpenAPI_list_t *abnor_behavrs,
	OpenAPI_list_t *nw_perfs, OpenAPI_list_t *dn_perf_infos,
	OpenAPI_list_t *disper_infos, OpenAPI_list_t *red_trans_infos,
	OpenAPI_list_t *wlan_infos, OpenAPI_list_t *smcc_exps) {
	OpenAPI_event_notification_t *event_notification_local_var =
		ogs_malloc(sizeof(OpenAPI_event_notification_t));
...
void OpenAPI_event_notification_free(
	OpenAPI_event_notification_t *event_notification) {
	...
	if(event_notification->nsi_load_level_infos) {
		OpenAPI_list_for_each(event_notification->nsi_load_level_infos,
		                      node) {
	...
	if(event_notification->user_data_cong_infos) {
		OpenAPI_list_for_each(event_notification->user_data_cong_infos,
		                      node) {
	...
	if(event_notification->red_trans_infos) {
		OpenAPI_list_for_each(event_notification->red_trans_infos,
		                      node) {
			OpenAPI_redundant_transmission_exp_info_free(
				node->data);
		}
...
cJSON *OpenAPI_event_notification_convertToJSON(
	OpenAPI_event_notification_t *event_notification) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(event_notification == NULL) {
		ogs_error(
			"OpenAPI_event_notification_convertToJSON() failed [EventNotification]");
		return NULL;
	}
	...
	if(!event_notification->event) {
		ogs_error(
			"OpenAPI_event_notification_convertToJSON() failed [event]");
		return NULL;
	}
	cJSON *event_local_JSON =
		OpenAPI_nwdaf_event_convertToJSON(event_notification->event);
	...
	if(event_notification->start) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(event_notification->expiry) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [expiry]");
			goto end;
		}
	}
	...
	if(event_notification->time_stamp_gen) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [time_stamp_gen]");
			goto end;
		}
	}
	...
	if(event_notification->fail_notify_code) {
		cJSON *fail_notify_code_local_JSON =
			OpenAPI_nwdaf_failure_code_convertToJSON(
				event_notification->fail_notify_code);
		if(fail_notify_code_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [fail_notify_code]");
			goto end;
		}
	...
	if(event_notification->is_rv_wait_time) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [rv_wait_time]");
			goto end;
		}
	}
	...
	if(event_notification->ana_meta_info) {
		...
		if(ana_meta_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [ana_meta_info]");
			goto end;
		}
	...
	if(event_notification->nf_load_level_infos) {
		...
		if(nf_load_level_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [nf_load_level_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->nf_load_level_infos,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_nf_load_level_information_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [nf_load_level_infos]");
	...
	if(event_notification->nsi_load_level_infos) {
		...
		if(nsi_load_level_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [nsi_load_level_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->nsi_load_level_infos,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_nsi_load_level_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [nsi_load_level_infos]");
	...
	if(event_notification->slice_load_level_info) {
		...
		if(slice_load_level_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [slice_load_level_info]");
			goto end;
		}
	...
	if(event_notification->svc_exps) {
		...
		if(svc_expsList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [svc_exps]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->svc_exps, node) {
			cJSON *itemLocal =
	...
	if(event_notification->qos_sustain_infos) {
		...
		if(qos_sustain_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [qos_sustain_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->qos_sustain_infos,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_qos_sustainability_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [qos_sustain_infos]");
	...
	if(event_notification->ue_comms) {
		...
		if(ue_commsList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [ue_comms]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->ue_comms, node) {
			cJSON *itemLocal =
				OpenAPI_ue_communication_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [ue_comms]");
	...
	if(event_notification->ue_mobs) {
		...
		if(ue_mobsList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [ue_mobs]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->ue_mobs, node) {
			cJSON *itemLocal =
				OpenAPI_ue_mobility_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [ue_mobs]");
				goto end;
	...
	if(event_notification->user_data_cong_infos) {
		...
		if(user_data_cong_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [user_data_cong_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->user_data_cong_infos,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_user_data_congestion_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [user_data_cong_infos]");
	...
	if(event_notification->abnor_behavrs) {
		...
		if(abnor_behavrsList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [abnor_behavrs]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->abnor_behavrs, node) {
			cJSON *itemLocal =
				OpenAPI_abnormal_behaviour_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [abnor_behavrs]");
	...
	if(event_notification->nw_perfs) {
		...
		if(nw_perfsList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [nw_perfs]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->nw_perfs, node) {
			cJSON *itemLocal =
				OpenAPI_network_perf_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [nw_perfs]");
	...
	if(event_notification->dn_perf_infos) {
		...
		if(dn_perf_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [dn_perf_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->dn_perf_infos, node) {
			cJSON *itemLocal =
				OpenAPI_dn_perf_info_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [dn_perf_infos]");
				goto end;
	...
	if(event_notification->disper_infos) {
		...
		if(disper_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [disper_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->disper_infos, node) {
			cJSON *itemLocal =
				OpenAPI_dispersion_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [disper_infos]");
	...
	if(event_notification->red_trans_infos) {
		...
		if(red_trans_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [red_trans_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->red_trans_infos,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_redundant_transmission_exp_info_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [red_trans_infos]");
	...
	if(event_notification->wlan_infos) {
		cJSON *wlan_infosList = cJSON_AddArrayToObject(item,
		                                               "wlanInfos");
		if(wlan_infosList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [wlan_infos]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->wlan_infos, node) {
			cJSON *itemLocal =
				OpenAPI_wlan_performance_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [wlan_infos]");
	...
	if(event_notification->smcc_exps) {
		...
		if(smcc_expsList == NULL) {
			ogs_error(
				"OpenAPI_event_notification_convertToJSON() failed [smcc_exps]");
			goto end;
		}
		OpenAPI_list_for_each(event_notification->smcc_exps, node) {
			cJSON *itemLocal =
				OpenAPI_smcce_info_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_event_notification_convertToJSON() failed [smcc_exps]");
				goto end;
...
OpenAPI_event_notification_t *OpenAPI_event_notification_parseFromJSON(
	...
	event = cJSON_GetObjectItemCaseSensitive(event_notificationJSON,
	                                         "event");
	if(!event) {
		ogs_error(
			"OpenAPI_event_notification_parseFromJSON() failed [event]");
		goto end;
	}
	...
	start = cJSON_GetObjectItemCaseSensitive(event_notificationJSON,
	                                         "start");
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(expiry) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [expiry]");
			goto end;
		}
	}
	...
	if(time_stamp_gen) {
		...
		{
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [time_stamp_gen]");
			goto end;
		}
	}
	...
	if(fail_notify_code) {
		fail_notify_code_local_nonprim =
			OpenAPI_nwdaf_failure_code_parseFromJSON(
				fail_notify_code);
		if(!fail_notify_code_local_nonprim) {
			ogs_error(
				"OpenAPI_nwdaf_failure_code_parseFromJSON failed [fail_notify_code]");
			goto end;
		}
	}
	...
	if(rv_wait_time) {
		if(!cJSON_IsNumber(rv_wait_time)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [rv_wait_time]");
			goto end;
		}
	}
	...
	if(ana_meta_info) {
		ana_meta_info_local_nonprim =
			OpenAPI_analytics_metadata_info_parseFromJSON(
				ana_meta_info);
		if(!ana_meta_info_local_nonprim) {
			ogs_error(
				"OpenAPI_analytics_metadata_info_parseFromJSON failed [ana_meta_info]");
			goto end;
		}
	}
	...
	if(nf_load_level_infos) {
		...
		if(!cJSON_IsArray(nf_load_level_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [nf_load_level_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nf_load_level_infos_local,
			...
			OpenAPI_nf_load_level_information_t *
				...
				OpenAPI_nf_load_level_information_parseFromJSON(
					nf_load_level_infos_local);
			if(!nf_load_level_infosItem) {
				ogs_error("No nf_load_level_infosItem");
				goto end;
			}
			OpenAPI_list_add(nf_load_level_infosList,
			                 nf_load_level_infosItem);
		}
	}
	...
	if(nsi_load_level_infos) {
		...
		if(!cJSON_IsArray(nsi_load_level_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [nsi_load_level_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nsi_load_level_infos_local,
			...
			OpenAPI_nsi_load_level_info_t *nsi_load_level_infosItem
			...
			OpenAPI_list_add(nsi_load_level_infosList,
	...
	if(slice_load_level_info) {
		slice_load_level_info_local_nonprim =
			OpenAPI_slice_load_level_information_parseFromJSON(
				slice_load_level_info);
		if(!slice_load_level_info_local_nonprim) {
			ogs_error(
				"OpenAPI_slice_load_level_information_parseFromJSON failed [slice_load_level_info]");
			goto end;
		}
	}
	...
	if(svc_exps) {
		...
		if(!cJSON_IsArray(svc_exps)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [svc_exps]");
			goto end;
		}
		...
		cJSON_ArrayForEach(svc_exps_local, svc_exps) {
			...
			OpenAPI_service_experience_info_t *svc_expsItem =
	...
	if(qos_sustain_infos) {
		...
		if(!cJSON_IsArray(qos_sustain_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [qos_sustain_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(qos_sustain_infos_local, qos_sustain_infos) {
			...
			OpenAPI_qos_sustainability_info_t *qos_sustain_infosItem
			        = OpenAPI_qos_sustainability_info_parseFromJSON(
					  qos_sustain_infos_local);
			if(!qos_sustain_infosItem) {
				ogs_error("No qos_sustain_infosItem");
				goto end;
			}
			OpenAPI_list_add(qos_sustain_infosList,
			                 qos_sustain_infosItem);
		}
	}
	...
	if(ue_comms) {
		...
		if(!cJSON_IsArray(ue_comms)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [ue_comms]");
			goto end;
		}
		...
		cJSON_ArrayForEach(ue_comms_local, ue_comms) {
			...
			OpenAPI_ue_communication_t *ue_commsItem =
				OpenAPI_ue_communication_parseFromJSON(
					ue_comms_local);
			if(!ue_commsItem) {
	...
	if(ue_mobs) {
		...
		if(!cJSON_IsArray(ue_mobs)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [ue_mobs]");
			goto end;
		}
		...
		cJSON_ArrayForEach(ue_mobs_local, ue_mobs) {
			...
			OpenAPI_ue_mobility_t *ue_mobsItem =
				OpenAPI_ue_mobility_parseFromJSON(
					ue_mobs_local);
			if(!ue_mobsItem) {
	...
	if(user_data_cong_infos) {
		...
		if(!cJSON_IsArray(user_data_cong_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [user_data_cong_infos]");
			goto end;
		}
	...
	if(abnor_behavrs) {
		...
		if(!cJSON_IsArray(abnor_behavrs)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [abnor_behavrs]");
			goto end;
		}
		...
		cJSON_ArrayForEach(abnor_behavrs_local, abnor_behavrs) {
			...
			OpenAPI_abnormal_behaviour_t *abnor_behavrsItem =
				OpenAPI_abnormal_behaviour_parseFromJSON(
					abnor_behavrs_local);
	...
	if(nw_perfs) {
		...
		if(!cJSON_IsArray(nw_perfs)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [nw_perfs]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nw_perfs_local, nw_perfs) {
			...
			OpenAPI_network_perf_info_t *nw_perfsItem =
				OpenAPI_network_perf_info_parseFromJSON(
					nw_perfs_local);
			if(!nw_perfsItem) {
	...
	if(dn_perf_infos) {
		...
		if(!cJSON_IsArray(dn_perf_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [dn_perf_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(dn_perf_infos_local, dn_perf_infos) {
			...
			OpenAPI_dn_perf_info_t *dn_perf_infosItem =
	...
	if(disper_infos) {
		...
		if(!cJSON_IsArray(disper_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [disper_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(disper_infos_local, disper_infos) {
			...
			OpenAPI_dispersion_info_t *disper_infosItem =
	...
	if(red_trans_infos) {
		...
		if(!cJSON_IsArray(red_trans_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [red_trans_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(red_trans_infos_local, red_trans_infos) {
			...
			OpenAPI_list_add(red_trans_infosList,
			                 red_trans_infosItem);
		}
	}
	...
	if(wlan_infos) {
		...
		if(!cJSON_IsArray(wlan_infos)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [wlan_infos]");
			goto end;
		}
		...
		cJSON_ArrayForEach(wlan_infos_local, wlan_infos) {
			...
			OpenAPI_wlan_performance_info_t *wlan_infosItem =
	...
	if(smcc_exps) {
		...
		if(!cJSON_IsArray(smcc_exps)) {
			ogs_error(
				"OpenAPI_event_notification_parseFromJSON() failed [smcc_exps]");
			goto end;
		}
		...
		cJSON_ArrayForEach(smcc_exps_local, smcc_exps) {
			...
			OpenAPI_smcce_info_t *smcc_expsItem =
				OpenAPI_smcce_info_parseFromJSON(
					smcc_exps_local);
			if(!smcc_expsItem) {
	...
	event_notification_local_var = OpenAPI_event_notification_create(
		event_local_nonprim,
		start &&
		!cJSON_IsNull(start) ? ogs_strdup(start->valuestring) : NULL,
		expiry &&
		!cJSON_IsNull(expiry) ? ogs_strdup(expiry->valuestring) : NULL,
		time_stamp_gen &&
		!cJSON_IsNull(time_stamp_gen) ?
		ogs_strdup(time_stamp_gen->valuestring) : NULL,
		...
		slice_load_level_info ? slice_load_level_info_local_nonprim :
		NULL,
...
OpenAPI_event_notification_t *OpenAPI_event_notification_copy(
	OpenAPI_event_notification_t *dst, OpenAPI_event_notification_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
