...
char * OpenAPI_ip_reachability_ToString(
	...
	const char *ip_reachabilityArray[] = { "NULL", "IPV4", "IPV6",
		                               "IPV4V6" };
	size_t sizeofArray = sizeof(ip_reachabilityArray) /
	                     sizeof(ip_reachabilityArray[0]);
...
OpenAPI_ip_reachability_e OpenAPI_ip_reachability_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(ip_reachability,
		          ip_reachabilityArray[stringToReturn]) == 0) {
