...
char * OpenAPI_data_set_id_ToString(OpenAPI_data_set_id_e data_set_id) {
	const char *data_set_idArray[] = { "NULL", "SUBSCRIPTION", "POLICY",
		                           "EXPOSURE", "APPLICATION", "A_PFD",
		                           "A_AFTI", "A_IPTV", "A_BDT", "A_SPD",
		                           "A_EASD", "A_AMI", "P_UE", "P_SCD",
		                           "P_BDT", "P_PLMNUE", "P_NSSCD" };
	size_t sizeofArray = sizeof(data_set_idArray) /
	                     sizeof(data_set_idArray[0]);
