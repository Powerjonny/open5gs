...
OpenAPI_cancel_loc_data_t *OpenAPI_cancel_loc_data_create(
	...
	char *lcs_correlation_id, char *supported_features) {
	OpenAPI_cancel_loc_data_t *cancel_loc_data_local_var =
		ogs_malloc(sizeof(OpenAPI_cancel_loc_data_t));
...
cJSON *OpenAPI_cancel_loc_data_convertToJSON(
	OpenAPI_cancel_loc_data_t *cancel_loc_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(cancel_loc_data == NULL) {
		ogs_error(
			"OpenAPI_cancel_loc_data_convertToJSON() failed [CancelLocData]");
		return NULL;
	}
	...
	if(!cancel_loc_data->hgmlc_call_back_uri) {
		ogs_error(
			"OpenAPI_cancel_loc_data_convertToJSON() failed [hgmlc_call_back_uri]");
		return NULL;
	}
	...
	if(!cancel_loc_data->ldr_reference) {
		ogs_error(
			"OpenAPI_cancel_loc_data_convertToJSON() failed [ldr_reference]");
		return NULL;
	}
	...
	if(cancel_loc_data->lcs_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_cancel_loc_data_convertToJSON() failed [lcs_correlation_id]");
			goto end;
		}
	}
	...
	if(cancel_loc_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_cancel_loc_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_cancel_loc_data_t *OpenAPI_cancel_loc_data_parseFromJSON(
	cJSON *cancel_loc_dataJSON) {
	...
	hgmlc_call_back_uri =
		cJSON_GetObjectItemCaseSensitive(cancel_loc_dataJSON,
		                                 "hgmlcCallBackURI");
	if(!hgmlc_call_back_uri) {
		ogs_error(
			"OpenAPI_cancel_loc_data_parseFromJSON() failed [hgmlc_call_back_uri]");
		goto end;
	}
	...
	if(!ldr_reference) {
		ogs_error(
			"OpenAPI_cancel_loc_data_parseFromJSON() failed [ldr_reference]");
		goto end;
	}
	...
	if(lcs_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_cancel_loc_data_parseFromJSON() failed [lcs_correlation_id]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_cancel_loc_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_cancel_loc_data_t *OpenAPI_cancel_loc_data_copy(
	OpenAPI_cancel_loc_data_t *dst, OpenAPI_cancel_loc_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
