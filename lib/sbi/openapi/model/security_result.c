...
OpenAPI_security_result_t *OpenAPI_security_result_create(
	...
	OpenAPI_security_result_t *security_result_local_var =
		ogs_malloc(sizeof(OpenAPI_security_result_t));
	ogs_assert(security_result_local_var);

	security_result_local_var->integrity_protection_result =
		integrity_protection_result;
	security_result_local_var->confidentiality_protection_result =
...
cJSON *OpenAPI_security_result_convertToJSON(
	...
	if(security_result == NULL) {
		ogs_error(
			"OpenAPI_security_result_convertToJSON() failed [SecurityResult]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(security_result->integrity_protection_result !=
	   OpenAPI_protection_result_NULL)
	{
		if(cJSON_AddStringToObject(item, "integrityProtectionResult",
		                           OpenAPI_protection_result_ToString(
						   security_result->
						   integrity_protection_result))
		   == NULL)
		{
			ogs_error(
				"OpenAPI_security_result_convertToJSON() failed [integrity_protection_result]");
			goto end;
		}
	}
	   ...
	   OpenAPI_protection_result_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_security_result_convertToJSON() failed [confidentiality_protection_result]");
			goto end;
		}
	}
...
OpenAPI_security_result_t *OpenAPI_security_result_parseFromJSON(
	cJSON *security_resultJSON) {
	...
	OpenAPI_protection_result_e confidentiality_protection_resultVariable =
		0;
	integrity_protection_result =
		cJSON_GetObjectItemCaseSensitive(security_resultJSON,
		                                 "integrityProtectionResult");
	if(integrity_protection_result) {
		if(!cJSON_IsString(integrity_protection_result)) {
			ogs_error(
				"OpenAPI_security_result_parseFromJSON() failed [integrity_protection_result]");
			goto end;
		}
		integrity_protection_resultVariable =
			OpenAPI_protection_result_FromString(
				integrity_protection_result->valuestring);
	}
	...
	if(confidentiality_protection_result) {
		if(!cJSON_IsString(confidentiality_protection_result)) {
			ogs_error(
				"OpenAPI_security_result_parseFromJSON() failed [confidentiality_protection_result]");
			goto end;
		}
		confidentiality_protection_resultVariable =
			OpenAPI_protection_result_FromString(
				confidentiality_protection_result->valuestring);
	}

	security_result_local_var = OpenAPI_security_result_create(
		integrity_protection_result ?
		integrity_protection_resultVariable : 0,
		confidentiality_protection_result ?
		confidentiality_protection_resultVariable : 0
		);
...
OpenAPI_security_result_t *OpenAPI_security_result_copy(
	OpenAPI_security_result_t *dst, OpenAPI_security_result_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
