...
OpenAPI_policy_association_request_t *OpenAPI_policy_association_request_create(
	char *notification_uri, OpenAPI_list_t *alt_notif_ipv4_addrs,
	OpenAPI_list_t *alt_notif_ipv6_addrs, OpenAPI_list_t *alt_notif_fqdns,
	char *supi, char *gpsi, OpenAPI_access_type_e access_type,
	OpenAPI_list_t *access_types, char *pei,
	OpenAPI_user_location_t *user_loc, char *time_zone,
	OpenAPI_plmn_id_nid_t *serving_plmn, OpenAPI_rat_type_e rat_type,
	OpenAPI_list_t *rat_types, OpenAPI_list_t *group_ids,
	...
	OpenAPI_list_t *ue_slice_mbrs, OpenAPI_list_t *allowed_snssais,
	OpenAPI_list_t *target_snssais, OpenAPI_list_t *mapping_snssais,
	OpenAPI_list_t *n3g_allowed_snssais, OpenAPI_guami_t *guami,
	char *service_name, bool is_trace_req_null,
	OpenAPI_trace_data_t *trace_req, OpenAPI_list_t *nwdaf_datas,
	char *supp_feat) {
	OpenAPI_policy_association_request_t *
	        policy_association_request_local_var =
		ogs_malloc(sizeof(OpenAPI_policy_association_request_t));
	ogs_assert(policy_association_request_local_var);

	policy_association_request_local_var->notification_uri =
		notification_uri;
	policy_association_request_local_var->alt_notif_ipv4_addrs =
		alt_notif_ipv4_addrs;
	policy_association_request_local_var->alt_notif_ipv6_addrs =
	...
	policy_association_request_local_var->wl_serv_area_res =
		wl_serv_area_res;
	...
	policy_association_request_local_var->n3g_allowed_snssais =
		n3g_allowed_snssais;
	policy_association_request_local_var->guami = guami;
	policy_association_request_local_var->service_name = service_name;
	policy_association_request_local_var->is_trace_req_null =
		is_trace_req_null;
...
void OpenAPI_policy_association_request_free(
	...
	if(policy_association_request->alt_notif_ipv4_addrs) {
		OpenAPI_list_for_each(
			policy_association_request->alt_notif_ipv4_addrs,
			node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
	...
	if(policy_association_request->alt_notif_ipv6_addrs) {
		OpenAPI_list_for_each(
			policy_association_request->alt_notif_ipv6_addrs,
			node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
	...
	if(policy_association_request->alt_notif_fqdns) {
		OpenAPI_list_for_each(
			policy_association_request->alt_notif_fqdns, node) {
			ogs_free(node->data);
		}
	...
	if(policy_association_request->user_loc) {
		OpenAPI_user_location_free(
			policy_association_request->user_loc);
	...
	if(policy_association_request->group_ids) {
		OpenAPI_list_for_each(policy_association_request->group_ids,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(policy_association_request->serv_area_res) {
		OpenAPI_service_area_restriction_free(
			policy_association_request->serv_area_res);
	...
	if(policy_association_request->ue_slice_mbrs) {
		OpenAPI_list_for_each(policy_association_request->ue_slice_mbrs,
		                      node) {
	...
	if(policy_association_request->allowed_snssais) {
		OpenAPI_list_for_each(
			policy_association_request->allowed_snssais, node) {
	...
	if(policy_association_request->target_snssais) {
		OpenAPI_list_for_each(
			policy_association_request->target_snssais, node) {
			OpenAPI_snssai_free(node->data);
		}
	...
	if(policy_association_request->mapping_snssais) {
		OpenAPI_list_for_each(
			policy_association_request->mapping_snssais, node) {
	...
	if(policy_association_request->n3g_allowed_snssais) {
		OpenAPI_list_for_each(
			policy_association_request->n3g_allowed_snssais, node) {
			OpenAPI_snssai_free(node->data);
		}
		OpenAPI_list_free(
			policy_association_request->n3g_allowed_snssais);
	...
	if(policy_association_request->nwdaf_datas) {
		OpenAPI_list_for_each(policy_association_request->nwdaf_datas,
		                      node) {
...
cJSON *OpenAPI_policy_association_request_convertToJSON(
	OpenAPI_policy_association_request_t *policy_association_request) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(policy_association_request == NULL) {
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed [PolicyAssociationRequest]");
		return NULL;
	}
	...
	if(!policy_association_request->notification_uri) {
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed [notification_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "notificationUri",
	                           policy_association_request->notification_uri)
	   == NULL)
	{
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed [notification_uri]");
	...
	if(policy_association_request->alt_notif_ipv4_addrs) {
		...
		if(alt_notif_ipv4_addrsList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [alt_notif_ipv4_addrs]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->alt_notif_ipv4_addrs,
	...
	if(policy_association_request->alt_notif_ipv6_addrs) {
		...
		if(alt_notif_ipv6_addrsList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [alt_notif_ipv6_addrs]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->alt_notif_ipv6_addrs,
	...
	if(policy_association_request->alt_notif_fqdns) {
		...
		if(alt_notif_fqdnsList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [alt_notif_fqdns]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->alt_notif_fqdns, node) {
	...
	if(!policy_association_request->supi) {
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed [supi]");
		return NULL;
	}
	...
	if(policy_association_request->gpsi) {
		if(cJSON_AddStringToObject(item, "gpsi",
		                           policy_association_request->gpsi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	   ...
	   OpenAPI_access_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [access_type]");
			goto end;
		}
	}
	   ...
	   OpenAPI_access_type_NULL)
	{
		...
		if(access_typesList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [access_types]");
			goto end;
		}
		OpenAPI_list_for_each(policy_association_request->access_types,
		                      node) {
	...
	if(policy_association_request->pei) {
		if(cJSON_AddStringToObject(item, "pei",
		                           policy_association_request->pei) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(policy_association_request->user_loc) {
		...
		if(user_loc_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [user_loc]");
			goto end;
		}
	...
	if(policy_association_request->time_zone) {
		if(cJSON_AddStringToObject(item, "timeZone",
		                           policy_association_request->time_zone)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [time_zone]");
			goto end;
		}
	}
	...
	if(policy_association_request->serving_plmn) {
		...
		if(serving_plmn_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [serving_plmn]");
			goto end;
		}
	...
	if(policy_association_request->rat_type != OpenAPI_rat_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [rat_type]");
			goto end;
		}
	}
	...
	if(policy_association_request->rat_types != OpenAPI_rat_type_NULL) {
		...
		if(rat_typesList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [rat_types]");
			goto end;
		}
		OpenAPI_list_for_each(policy_association_request->rat_types,
		                      node) {
	...
	if(policy_association_request->group_ids) {
		...
		if(group_idsList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [group_ids]");
			goto end;
		}
		OpenAPI_list_for_each(policy_association_request->group_ids,
		                      node) {
	...
	if(policy_association_request->serv_area_res) {
		...
		if(serv_area_res_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [serv_area_res]");
			goto end;
		}
	...
	if(policy_association_request->wl_serv_area_res) {
		...
		if(wl_serv_area_res_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [wl_serv_area_res]");
			goto end;
		}
	...
	if(policy_association_request->is_rfsp) {
		if(cJSON_AddNumberToObject(item, "rfsp",
		                           policy_association_request->rfsp) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [rfsp]");
			goto end;
		}
	}
	...
	if(policy_association_request->ue_ambr) {
		cJSON *ue_ambr_local_JSON =
			OpenAPI_ambr_convertToJSON(
				policy_association_request->ue_ambr);
		if(ue_ambr_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [ue_ambr]");
			goto end;
		}
	...
	if(policy_association_request->ue_slice_mbrs) {
		...
		if(ue_slice_mbrsList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [ue_slice_mbrs]");
			goto end;
		}
		OpenAPI_list_for_each(policy_association_request->ue_slice_mbrs,
		                      node) {
	...
	if(policy_association_request->allowed_snssais) {
		...
		if(allowed_snssaisList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [allowed_snssais]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->allowed_snssais, node) {
	...
	if(policy_association_request->target_snssais) {
		...
		if(target_snssaisList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [target_snssais]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->target_snssais, node) {
	...
	if(policy_association_request->mapping_snssais) {
		...
		if(mapping_snssaisList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [mapping_snssais]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->mapping_snssais, node) {
	...
	if(policy_association_request->n3g_allowed_snssais) {
		...
		if(n3g_allowed_snssaisList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [n3g_allowed_snssais]");
			goto end;
		}
		OpenAPI_list_for_each(
			policy_association_request->n3g_allowed_snssais, node) {
	...
	if(policy_association_request->guami) {
		cJSON *guami_local_JSON =
			OpenAPI_guami_convertToJSON(
				policy_association_request->guami);
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [guami]");
			goto end;
		}
	...
	if(policy_association_request->service_name) {
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [service_name]");
			goto end;
		}
	}
	...
	if(policy_association_request->trace_req) {
		...
		if(trace_req_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [trace_req]");
			goto end;
		}
	...
	if(policy_association_request->nwdaf_datas) {
		...
		if(nwdaf_datasList == NULL) {
			ogs_error(
				"OpenAPI_policy_association_request_convertToJSON() failed [nwdaf_datas]");
			goto end;
		}
		OpenAPI_list_for_each(policy_association_request->nwdaf_datas,
		                      node) {
	...
	if(!policy_association_request->supp_feat) {
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed [supp_feat]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "suppFeat",
	                           policy_association_request->supp_feat) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed [supp_feat]");
...
OpenAPI_policy_association_request_parseFromJSON(
	cJSON *policy_association_requestJSON) {
	OpenAPI_policy_association_request_t *
	        policy_association_request_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(!notification_uri) {
		ogs_error(
			"OpenAPI_policy_association_request_parseFromJSON() failed [notification_uri]");
		goto end;
	}
	...
	if(alt_notif_ipv4_addrs) {
		...
		if(!cJSON_IsArray(alt_notif_ipv4_addrs)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [alt_notif_ipv4_addrs]");
			goto end;
		}
	...
	if(alt_notif_ipv6_addrs) {
		...
		if(!cJSON_IsArray(alt_notif_ipv6_addrs)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [alt_notif_ipv6_addrs]");
			goto end;
		}
	...
	if(alt_notif_fqdns) {
		...
		if(!cJSON_IsArray(alt_notif_fqdns)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [alt_notif_fqdns]");
			goto end;
		}
	...
	supi = cJSON_GetObjectItemCaseSensitive(policy_association_requestJSON,
	                                        "supi");
	if(!supi) {
		ogs_error(
			"OpenAPI_policy_association_request_parseFromJSON() failed [supi]");
		goto end;
	}
	...
	gpsi = cJSON_GetObjectItemCaseSensitive(policy_association_requestJSON,
	                                        "gpsi");
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(access_type) {
		if(!cJSON_IsString(access_type)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [access_type]");
			goto end;
		}
		access_typeVariable =
	...
	if(access_types) {
		...
		if(!cJSON_IsArray(access_types)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [access_types]");
			goto end;
		}
		...
		if(access_typesList->count == 0) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed: Expected access_typesList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	pei = cJSON_GetObjectItemCaseSensitive(policy_association_requestJSON,
	                                       "pei");
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(time_zone) {
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [time_zone]");
			goto end;
		}
	}
	...
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	if(rat_types) {
		...
		if(!cJSON_IsArray(rat_types)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [rat_types]");
			goto end;
		}
		...
		if(rat_typesList->count == 0) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed: Expected rat_typesList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(group_ids) {
		...
		if(!cJSON_IsArray(group_ids)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [group_ids]");
			goto end;
		}
	...
	rfsp = cJSON_GetObjectItemCaseSensitive(policy_association_requestJSON,
	                                        "rfsp");
	if(rfsp) {
		if(!cJSON_IsNumber(rfsp)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [rfsp]");
			goto end;
		}
	}
	...
	if(ue_slice_mbrs) {
		...
		if(!cJSON_IsArray(ue_slice_mbrs)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [ue_slice_mbrs]");
			goto end;
		}
	...
	if(allowed_snssais) {
		...
		if(!cJSON_IsArray(allowed_snssais)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [allowed_snssais]");
			goto end;
		}
	...
	if(target_snssais) {
		...
		if(!cJSON_IsArray(target_snssais)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [target_snssais]");
			goto end;
		}
	...
	if(mapping_snssais) {
		...
		if(!cJSON_IsArray(mapping_snssais)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [mapping_snssais]");
			goto end;
		}
	...
	if(n3g_allowed_snssais) {
		...
		if(!cJSON_IsArray(n3g_allowed_snssais)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [n3g_allowed_snssais]");
			goto end;
		}
	...
	guami = cJSON_GetObjectItemCaseSensitive(policy_association_requestJSON,
	                                         "guami");
	if(guami) {
	...
	if(service_name) {
		...
		{
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [service_name]");
			goto end;
		}
	}
	...
	if(nwdaf_datas) {
		...
		if(!cJSON_IsArray(nwdaf_datas)) {
			ogs_error(
				"OpenAPI_policy_association_request_parseFromJSON() failed [nwdaf_datas]");
			goto end;
		}
	...
	if(!supp_feat) {
		ogs_error(
			"OpenAPI_policy_association_request_parseFromJSON() failed [supp_feat]");
		goto end;
	}
...
OpenAPI_policy_association_request_t *OpenAPI_policy_association_request_copy(
	OpenAPI_policy_association_request_t	*dst,
	OpenAPI_policy_association_request_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_policy_association_request_convertToJSON() failed");
		return NULL;
	}
