...
OpenAPI_pro_se_auth_data_t *OpenAPI_pro_se_auth_data_create() {
	OpenAPI_pro_se_auth_data_t *pro_se_auth_data_local_var =
		ogs_malloc(sizeof(OpenAPI_pro_se_auth_data_t));
...
void OpenAPI_pro_se_auth_data_free(
...
cJSON *OpenAPI_pro_se_auth_data_convertToJSON(
	OpenAPI_pro_se_auth_data_t *pro_se_auth_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pro_se_auth_data == NULL) {
		ogs_error(
			"OpenAPI_pro_se_auth_data_convertToJSON() failed [ProSeAuthData]");
		return NULL;
	}
...
OpenAPI_pro_se_auth_data_t *OpenAPI_pro_se_auth_data_parseFromJSON(
	cJSON *pro_se_auth_dataJSON) {
...
OpenAPI_pro_se_auth_data_t *OpenAPI_pro_se_auth_data_copy(
	OpenAPI_pro_se_auth_data_t *dst, OpenAPI_pro_se_auth_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
