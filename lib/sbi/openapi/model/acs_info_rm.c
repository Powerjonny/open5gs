...
OpenAPI_acs_info_rm_t *OpenAPI_acs_info_rm_create(char	*acs_url,
                                                  char	*acs_ipv4_addr,
                                                  char	*acs_ipv6_addr) {
	OpenAPI_acs_info_rm_t *acs_info_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_acs_info_rm_t));
...
cJSON *OpenAPI_acs_info_rm_convertToJSON(OpenAPI_acs_info_rm_t *acs_info_rm) {
	...
	if(acs_info_rm == NULL) {
		ogs_error(
			"OpenAPI_acs_info_rm_convertToJSON() failed [AcsInfoRm]");
		return NULL;
	}
	...
	if(acs_info_rm->acs_url) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_rm_convertToJSON() failed [acs_url]");
			goto end;
		}
	}
	...
	if(acs_info_rm->acs_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_rm_convertToJSON() failed [acs_ipv4_addr]");
			goto end;
		}
	}
	...
	if(acs_info_rm->acs_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_rm_convertToJSON() failed [acs_ipv6_addr]");
			goto end;
		}
	}
...
OpenAPI_acs_info_rm_t *OpenAPI_acs_info_rm_parseFromJSON(
	...
	if(acs_url) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_rm_parseFromJSON() failed [acs_url]");
			goto end;
		}
	}

	acs_ipv4_addr = cJSON_GetObjectItemCaseSensitive(acs_info_rmJSON,
	                                                 "acsIpv4Addr");
	if(acs_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_rm_parseFromJSON() failed [acs_ipv4_addr]");
			goto end;
		}
	}

	acs_ipv6_addr = cJSON_GetObjectItemCaseSensitive(acs_info_rmJSON,
	                                                 "acsIpv6Addr");
	if(acs_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_acs_info_rm_parseFromJSON() failed [acs_ipv6_addr]");
			goto end;
		}
	}
