...
OpenAPI_supi_range_t *OpenAPI_supi_range_create(char *start, char *end,
                                                char *pattern) {
	OpenAPI_supi_range_t *supi_range_local_var =
...
cJSON *OpenAPI_supi_range_convertToJSON(OpenAPI_supi_range_t *supi_range) {
	...
	if(supi_range == NULL) {
		ogs_error(
			"OpenAPI_supi_range_convertToJSON() failed [SupiRange]");
		return NULL;
	}
	...
	if(supi_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_supi_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(supi_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_supi_range_convertToJSON() failed [end]");
			goto end;
		}
	}
	...
	if(supi_range->pattern) {
		...
		{
			ogs_error(
				"OpenAPI_supi_range_convertToJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_supi_range_t *OpenAPI_supi_range_parseFromJSON(cJSON *supi_rangeJSON) {
	...
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_supi_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_supi_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
	...
	if(pattern) {
		...
		{
			ogs_error(
				"OpenAPI_supi_range_parseFromJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_supi_range_t *OpenAPI_supi_range_copy(OpenAPI_supi_range_t	*dst,
                                              OpenAPI_supi_range_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
