...
OpenAPI_point_all_of_t *OpenAPI_point_all_of_create(
	...
	OpenAPI_point_all_of_t *point_all_of_local_var =
		ogs_malloc(sizeof(OpenAPI_point_all_of_t));
...
cJSON *OpenAPI_point_all_of_convertToJSON(
	OpenAPI_point_all_of_t *point_all_of) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(point_all_of == NULL) {
		ogs_error(
			"OpenAPI_point_all_of_convertToJSON() failed [Point_allOf]");
		return NULL;
	}
	...
	if(!point_all_of->point) {
		ogs_error(
			"OpenAPI_point_all_of_convertToJSON() failed [point]");
		return NULL;
	}
...
OpenAPI_point_all_of_t *OpenAPI_point_all_of_parseFromJSON(
	cJSON *point_all_ofJSON) {
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
...
OpenAPI_point_all_of_t *OpenAPI_point_all_of_copy(
	OpenAPI_point_all_of_t	*dst,
