...
OpenAPI_valid_time_period_t *OpenAPI_valid_time_period_create(
	...
	char	  *
	end_time) {
	OpenAPI_valid_time_period_t *valid_time_period_local_var =
		ogs_malloc(sizeof(OpenAPI_valid_time_period_t));
...
void OpenAPI_valid_time_period_free(
...
cJSON *OpenAPI_valid_time_period_convertToJSON(
	OpenAPI_valid_time_period_t *valid_time_period) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(valid_time_period == NULL) {
		ogs_error(
			"OpenAPI_valid_time_period_convertToJSON() failed [ValidTimePeriod]");
		return NULL;
	}
	...
	if(valid_time_period->start_time) {
		...
		{
			ogs_error(
				"OpenAPI_valid_time_period_convertToJSON() failed [start_time]");
			goto end;
		}
	}
	...
	if(valid_time_period->end_time) {
		...
		{
			ogs_error(
				"OpenAPI_valid_time_period_convertToJSON() failed [end_time]");
			goto end;
		}
	}
...
OpenAPI_valid_time_period_t *OpenAPI_valid_time_period_parseFromJSON(
	...
	if(start_time) {
		...
		{
			ogs_error(
				"OpenAPI_valid_time_period_parseFromJSON() failed [start_time]");
			goto end;
		}
	}
	...
	if(end_time) {
		...
		{
			ogs_error(
				"OpenAPI_valid_time_period_parseFromJSON() failed [end_time]");
			goto end;
		}
	}
	...
	valid_time_period_local_var = OpenAPI_valid_time_period_create(
		...
		end_time &&
		!cJSON_IsNull(end_time) ? ogs_strdup(end_time->valuestring) :
		NULL
		);
...
OpenAPI_valid_time_period_t *OpenAPI_valid_time_period_copy(
	OpenAPI_valid_time_period_t *dst, OpenAPI_valid_time_period_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
