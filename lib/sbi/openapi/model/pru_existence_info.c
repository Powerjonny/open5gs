...
OpenAPI_pru_existence_info_t *OpenAPI_pru_existence_info_create(
	...
	OpenAPI_pru_existence_info_t *pru_existence_info_local_var =
		ogs_malloc(sizeof(OpenAPI_pru_existence_info_t));
...
void OpenAPI_pru_existence_info_free(
	...
	if(pru_existence_info->tai_range_list) {
		OpenAPI_list_for_each(pru_existence_info->tai_range_list,
		                      node) {
...
cJSON *OpenAPI_pru_existence_info_convertToJSON(
	OpenAPI_pru_existence_info_t *pru_existence_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pru_existence_info == NULL) {
		ogs_error(
			"OpenAPI_pru_existence_info_convertToJSON() failed [PruExistenceInfo]");
		return NULL;
	}
	...
	if(pru_existence_info->tai_list) {
		...
		if(tai_listList == NULL) {
			ogs_error(
				"OpenAPI_pru_existence_info_convertToJSON() failed [tai_list]");
			goto end;
		}
		OpenAPI_list_for_each(pru_existence_info->tai_list, node) {
			cJSON *itemLocal =
	...
	if(pru_existence_info->tai_range_list) {
		...
		if(tai_range_listList == NULL) {
			ogs_error(
				"OpenAPI_pru_existence_info_convertToJSON() failed [tai_range_list]");
			goto end;
		}
		OpenAPI_list_for_each(pru_existence_info->tai_range_list,
		                      node) {
...
OpenAPI_pru_existence_info_t *OpenAPI_pru_existence_info_parseFromJSON(
	cJSON *pru_existence_infoJSON) {
	...
	tai_list = cJSON_GetObjectItemCaseSensitive(pru_existence_infoJSON,
	                                            "taiList");
	if(tai_list) {
		cJSON *tai_list_local = NULL;
		if(!cJSON_IsArray(tai_list)) {
			ogs_error(
				"OpenAPI_pru_existence_info_parseFromJSON() failed [tai_list]");
			goto end;
		}
	...
	tai_range_list =
		cJSON_GetObjectItemCaseSensitive(pru_existence_infoJSON,
		                                 "taiRangeList");
	if(tai_range_list) {
		cJSON *tai_range_list_local = NULL;
		if(!cJSON_IsArray(tai_range_list)) {
			ogs_error(
				"OpenAPI_pru_existence_info_parseFromJSON() failed [tai_range_list]");
			goto end;
		}
...
OpenAPI_pru_existence_info_t *OpenAPI_pru_existence_info_copy(
	OpenAPI_pru_existence_info_t *dst, OpenAPI_pru_existence_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
