...
OpenAPI_point_uncertainty_circle_t *OpenAPI_point_uncertainty_circle_create(
	...
	OpenAPI_point_uncertainty_circle_t *point_uncertainty_circle_local_var =
		ogs_malloc(sizeof(OpenAPI_point_uncertainty_circle_t));
...
void OpenAPI_point_uncertainty_circle_free(
	OpenAPI_point_uncertainty_circle_t *point_uncertainty_circle) {
...
cJSON *OpenAPI_point_uncertainty_circle_convertToJSON(
	OpenAPI_point_uncertainty_circle_t *point_uncertainty_circle) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(point_uncertainty_circle == NULL) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_convertToJSON() failed [PointUncertaintyCircle]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_uncertainty_circle_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!point_uncertainty_circle->point) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_uncertainty_circle_convertToJSON() failed [uncertainty]");
		goto end;
	}
...
OpenAPI_point_uncertainty_circle_parseFromJSON(
	...
	if(!shape) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	uncertainty =
		cJSON_GetObjectItemCaseSensitive(point_uncertainty_circleJSON,
		                                 "uncertainty");
	if(!uncertainty) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_parseFromJSON() failed [uncertainty]");
		goto end;
	}
	...
	point_uncertainty_circle_local_var =
		OpenAPI_point_uncertainty_circle_create(
			shapeVariable,
			point_local_nonprim,
...
OpenAPI_point_uncertainty_circle_t *OpenAPI_point_uncertainty_circle_copy(
	OpenAPI_point_uncertainty_circle_t	*dst,
	OpenAPI_point_uncertainty_circle_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_convertToJSON() failed");
		return NULL;
	}
