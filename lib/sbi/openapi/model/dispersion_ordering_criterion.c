...
OpenAPI_dispersion_ordering_criterion_create() {
	OpenAPI_dispersion_ordering_criterion_t *
		...
		ogs_malloc(sizeof(OpenAPI_dispersion_ordering_criterion_t));
	...
	OpenAPI_dispersion_ordering_criterion_t *dispersion_ordering_criterion)
{
	...
	if(dispersion_ordering_criterion == NULL) {
		ogs_error(
			"OpenAPI_dispersion_ordering_criterion_convertToJSON() failed [DispersionOrderingCriterion]");
		return NULL;
	}
...
OpenAPI_dispersion_ordering_criterion_parseFromJSON(
	...
	OpenAPI_dispersion_ordering_criterion_t *
	        dispersion_ordering_criterion_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	dispersion_ordering_criterion_local_var =
		OpenAPI_dispersion_ordering_criterion_create(
			);
...
OpenAPI_dispersion_ordering_criterion_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_dispersion_ordering_criterion_convertToJSON() failed");
		return NULL;
	}
