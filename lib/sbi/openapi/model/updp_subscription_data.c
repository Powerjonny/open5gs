...
OpenAPI_updp_subscription_data_t *OpenAPI_updp_subscription_data_create(
	...
	OpenAPI_updp_subscription_data_t *updp_subscription_data_local_var =
		ogs_malloc(sizeof(OpenAPI_updp_subscription_data_t));
...
void OpenAPI_updp_subscription_data_free(
...
cJSON *OpenAPI_updp_subscription_data_convertToJSON(
	OpenAPI_updp_subscription_data_t *updp_subscription_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(updp_subscription_data == NULL) {
		ogs_error(
			"OpenAPI_updp_subscription_data_convertToJSON() failed [UpdpSubscriptionData]");
		return NULL;
	}
	...
	if(!updp_subscription_data->updp_notify_subscription_id) {
		ogs_error(
			"OpenAPI_updp_subscription_data_convertToJSON() failed [updp_notify_subscription_id]");
		return NULL;
	}
	...
	if(!updp_subscription_data->updp_notify_callback_uri) {
		ogs_error(
			"OpenAPI_updp_subscription_data_convertToJSON() failed [updp_notify_callback_uri]");
		return NULL;
	}
	...
	if(updp_subscription_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_updp_subscription_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(updp_subscription_data->updp_callback_binding) {
		...
		{
			ogs_error(
				"OpenAPI_updp_subscription_data_convertToJSON() failed [updp_callback_binding]");
			goto end;
		}
	}
...
OpenAPI_updp_subscription_data_t *OpenAPI_updp_subscription_data_parseFromJSON(
	...
	updp_notify_subscription_id =
		cJSON_GetObjectItemCaseSensitive(updp_subscription_dataJSON,
		                                 "updpNotifySubscriptionId");
	if(!updp_notify_subscription_id) {
		ogs_error(
			"OpenAPI_updp_subscription_data_parseFromJSON() failed [updp_notify_subscription_id]");
		goto end;
	}
	...
	if(!updp_notify_callback_uri) {
		ogs_error(
			"OpenAPI_updp_subscription_data_parseFromJSON() failed [updp_notify_callback_uri]");
		goto end;
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_updp_subscription_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(updp_callback_binding) {
		...
		{
			ogs_error(
				"OpenAPI_updp_subscription_data_parseFromJSON() failed [updp_callback_binding]");
			goto end;
		}
	}

	updp_subscription_data_local_var =
		OpenAPI_updp_subscription_data_create(
			...
			updp_callback_binding &&
			!cJSON_IsNull(updp_callback_binding) ?
			ogs_strdup(updp_callback_binding->valuestring) : NULL
			);
...
OpenAPI_updp_subscription_data_t *OpenAPI_updp_subscription_data_copy(
	OpenAPI_updp_subscription_data_t	*dst,
	OpenAPI_updp_subscription_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_updp_subscription_data_convertToJSON() failed");
		return NULL;
	}
