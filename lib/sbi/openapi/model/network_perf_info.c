...
OpenAPI_network_perf_info_t *OpenAPI_network_perf_info_create(
	...
	OpenAPI_network_perf_info_t *network_perf_info_local_var =
		ogs_malloc(sizeof(OpenAPI_network_perf_info_t));
...
void OpenAPI_network_perf_info_free(
	OpenAPI_network_perf_info_t *network_perf_info) {
...
cJSON *OpenAPI_network_perf_info_convertToJSON(
	OpenAPI_network_perf_info_t *network_perf_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(network_perf_info == NULL) {
		ogs_error(
			"OpenAPI_network_perf_info_convertToJSON() failed [NetworkPerfInfo]");
		return NULL;
	}
	...
	if(network_perf_info->network_area) {
		...
		if(network_area_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_network_perf_info_convertToJSON() failed [network_area]");
			goto end;
		}
	...
	if(network_perf_info->nw_perf_type) {
		...
		if(nw_perf_type_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_network_perf_info_convertToJSON() failed [nw_perf_type]");
			goto end;
		}
	...
	if(network_perf_info->is_relative_ratio) {
		...
		{
			ogs_error(
				"OpenAPI_network_perf_info_convertToJSON() failed [relative_ratio]");
			goto end;
		}
	}
	...
	if(network_perf_info->is_absolute_num) {
		...
		{
			ogs_error(
				"OpenAPI_network_perf_info_convertToJSON() failed [absolute_num]");
			goto end;
		}
	}
	...
	if(network_perf_info->is_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_network_perf_info_convertToJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_network_perf_info_t *OpenAPI_network_perf_info_parseFromJSON(
	...
	if(relative_ratio) {
		if(!cJSON_IsNumber(relative_ratio)) {
			ogs_error(
				"OpenAPI_network_perf_info_parseFromJSON() failed [relative_ratio]");
			goto end;
		}
	}
	...
	if(absolute_num) {
		if(!cJSON_IsNumber(absolute_num)) {
			ogs_error(
				"OpenAPI_network_perf_info_parseFromJSON() failed [absolute_num]");
			goto end;
		}
	}
	...
	if(confidence) {
		if(!cJSON_IsNumber(confidence)) {
			ogs_error(
				"OpenAPI_network_perf_info_parseFromJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_network_perf_info_t *OpenAPI_network_perf_info_copy(
	OpenAPI_network_perf_info_t *dst, OpenAPI_network_perf_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
