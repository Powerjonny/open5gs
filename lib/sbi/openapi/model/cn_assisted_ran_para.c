...
OpenAPI_cn_assisted_ran_para_t *OpenAPI_cn_assisted_ran_para_create(
	...
	OpenAPI_cn_assisted_ran_para_t *cn_assisted_ran_para_local_var =
		ogs_malloc(sizeof(OpenAPI_cn_assisted_ran_para_t));
...
void OpenAPI_cn_assisted_ran_para_free(
...
cJSON *OpenAPI_cn_assisted_ran_para_convertToJSON(
	OpenAPI_cn_assisted_ran_para_t *cn_assisted_ran_para) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(cn_assisted_ran_para == NULL) {
		ogs_error(
			"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [CnAssistedRanPara]");
		return NULL;
	}
	   ...
	   OpenAPI_stationary_indication_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [stationary_indication]");
			goto end;
		}
	}
	...
	if(cn_assisted_ran_para->is_communication_duration_time) {
		...
		{
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [communication_duration_time]");
			goto end;
		}
	}
	...
	if(cn_assisted_ran_para->is_periodic_time) {
		...
		{
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [periodic_time]");
			goto end;
		}
	}
	...
	if(cn_assisted_ran_para->scheduled_communication_time) {
		...
		if(scheduled_communication_time_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [scheduled_communication_time]");
			goto end;
		}
	   ...
	   OpenAPI_scheduled_communication_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [scheduled_communication_type]");
			goto end;
		}
	}
	   ...
	   OpenAPI_traffic_profile_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [traffic_profile]");
			goto end;
		}
	}
	...
	if(cn_assisted_ran_para->battery_indication) {
		...
		if(battery_indication_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_convertToJSON() failed [battery_indication]");
			goto end;
		}
...
OpenAPI_cn_assisted_ran_para_t *OpenAPI_cn_assisted_ran_para_parseFromJSON(
	...
	stationary_indication =
		cJSON_GetObjectItemCaseSensitive(cn_assisted_ran_paraJSON,
		                                 "stationaryIndication");
	if(stationary_indication) {
		if(!cJSON_IsString(stationary_indication)) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_parseFromJSON() failed [stationary_indication]");
			goto end;
		}
	...
	if(communication_duration_time) {
		if(!cJSON_IsNumber(communication_duration_time)) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_parseFromJSON() failed [communication_duration_time]");
			goto end;
		}
	}
	...
	if(periodic_time) {
		if(!cJSON_IsNumber(periodic_time)) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_parseFromJSON() failed [periodic_time]");
			goto end;
		}
	}
	...
	if(scheduled_communication_type) {
		if(!cJSON_IsString(scheduled_communication_type)) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_parseFromJSON() failed [scheduled_communication_type]");
			goto end;
		}
	...
	if(traffic_profile) {
		if(!cJSON_IsString(traffic_profile)) {
			ogs_error(
				"OpenAPI_cn_assisted_ran_para_parseFromJSON() failed [traffic_profile]");
			goto end;
		}
...
OpenAPI_cn_assisted_ran_para_t *OpenAPI_cn_assisted_ran_para_copy(
	OpenAPI_cn_assisted_ran_para_t	*dst,
	OpenAPI_cn_assisted_ran_para_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_cn_assisted_ran_para_convertToJSON() failed");
		return NULL;
	}
