...
OpenAPI_sess_inact_timer_for_ue_comm_create(int n4_sess_id,
                                            int sess_inactive_timer) {
	OpenAPI_sess_inact_timer_for_ue_comm_t *
	        sess_inact_timer_for_ue_comm_local_var =
		ogs_malloc(sizeof(OpenAPI_sess_inact_timer_for_ue_comm_t));
...
void OpenAPI_sess_inact_timer_for_ue_comm_free(
	OpenAPI_sess_inact_timer_for_ue_comm_t *sess_inact_timer_for_ue_comm) {
...
cJSON *OpenAPI_sess_inact_timer_for_ue_comm_convertToJSON(
	OpenAPI_sess_inact_timer_for_ue_comm_t *sess_inact_timer_for_ue_comm) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(sess_inact_timer_for_ue_comm == NULL) {
		ogs_error(
			"OpenAPI_sess_inact_timer_for_ue_comm_convertToJSON() failed [SessInactTimerForUeComm]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_sess_inact_timer_for_ue_comm_convertToJSON() failed [n4_sess_id]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_sess_inact_timer_for_ue_comm_convertToJSON() failed [sess_inactive_timer]");
		goto end;
	}
...
OpenAPI_sess_inact_timer_for_ue_comm_parseFromJSON(
	...
	OpenAPI_sess_inact_timer_for_ue_comm_t *
	        sess_inact_timer_for_ue_comm_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(!n4_sess_id) {
		ogs_error(
			"OpenAPI_sess_inact_timer_for_ue_comm_parseFromJSON() failed [n4_sess_id]");
		goto end;
	}
	...
	if(!sess_inactive_timer) {
		ogs_error(
			"OpenAPI_sess_inact_timer_for_ue_comm_parseFromJSON() failed [sess_inactive_timer]");
		goto end;
	}
	...
	sess_inact_timer_for_ue_comm_local_var =
		OpenAPI_sess_inact_timer_for_ue_comm_create(
...
OpenAPI_sess_inact_timer_for_ue_comm_t *
OpenAPI_sess_inact_timer_for_ue_comm_copy(
	OpenAPI_sess_inact_timer_for_ue_comm_t	*dst,
	OpenAPI_sess_inact_timer_for_ue_comm_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_sess_inact_timer_for_ue_comm_convertToJSON() failed");
		return NULL;
	}
