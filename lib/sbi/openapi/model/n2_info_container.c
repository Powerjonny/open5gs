...
OpenAPI_n2_info_container_t *OpenAPI_n2_info_container_create(
	...
	OpenAPI_n2_info_container_t *n2_info_container_local_var =
		ogs_malloc(sizeof(OpenAPI_n2_info_container_t));
...
cJSON *OpenAPI_n2_info_container_convertToJSON(
	...
	if(n2_info_container == NULL) {
		ogs_error(
			"OpenAPI_n2_info_container_convertToJSON() failed [N2InfoContainer]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_n2_info_container_convertToJSON() failed [n2_information_class]");
		return NULL;
	}
	...
	if(n2_info_container->ran_info) {
		cJSON *ran_info_local_JSON =
			OpenAPI_n2_ran_information_convertToJSON(
				n2_info_container->ran_info);
		if(ran_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_info_container_convertToJSON() failed [ran_info]");
			goto end;
		}
	...
	if(n2_info_container->nrppa_info) {
		cJSON *nrppa_info_local_JSON =
			OpenAPI_nrppa_information_convertToJSON(
				n2_info_container->nrppa_info);
		if(nrppa_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_info_container_convertToJSON() failed [nrppa_info]");
			goto end;
		}
	...
	if(n2_info_container->pws_info) {
		cJSON *pws_info_local_JSON =
			OpenAPI_pws_information_convertToJSON(
				n2_info_container->pws_info);
		if(pws_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_info_container_convertToJSON() failed [pws_info]");
			goto end;
		}
	...
	if(n2_info_container->v2x_info) {
		cJSON *v2x_info_local_JSON =
			OpenAPI_v2x_information_convertToJSON(
				n2_info_container->v2x_info);
		if(v2x_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_info_container_convertToJSON() failed [v2x_info]");
			goto end;
		}
...
OpenAPI_n2_info_container_t *OpenAPI_n2_info_container_parseFromJSON(
	...
	n2_information_class =
		cJSON_GetObjectItemCaseSensitive(n2_info_containerJSON,
		                                 "n2InformationClass");
	if(!n2_information_class) {
		ogs_error(
			"OpenAPI_n2_info_container_parseFromJSON() failed [n2_information_class]");
		goto end;
	}
	...
	if(sm_info) {
		sm_info_local_nonprim =
			OpenAPI_n2_sm_information_parseFromJSON(sm_info);
		if(!sm_info_local_nonprim) {
			ogs_error(
				"OpenAPI_n2_sm_information_parseFromJSON failed [sm_info]");
			goto end;
		}
	}
	...
	ran_info = cJSON_GetObjectItemCaseSensitive(n2_info_containerJSON,
	                                            "ranInfo");
	if(ran_info) {
		ran_info_local_nonprim =
			OpenAPI_n2_ran_information_parseFromJSON(ran_info);
		if(!ran_info_local_nonprim) {
			ogs_error(
				"OpenAPI_n2_ran_information_parseFromJSON failed [ran_info]");
			goto end;
		}
	}
	...
	nrppa_info = cJSON_GetObjectItemCaseSensitive(n2_info_containerJSON,
	                                              "nrppaInfo");
	if(nrppa_info) {
		nrppa_info_local_nonprim =
			OpenAPI_nrppa_information_parseFromJSON(nrppa_info);
		if(!nrppa_info_local_nonprim) {
			ogs_error(
				"OpenAPI_nrppa_information_parseFromJSON failed [nrppa_info]");
			goto end;
		}
	}
	...
	if(pws_info) {
		pws_info_local_nonprim =
			OpenAPI_pws_information_parseFromJSON(pws_info);
		if(!pws_info_local_nonprim) {
			ogs_error(
				"OpenAPI_pws_information_parseFromJSON failed [pws_info]");
			goto end;
		}
	}
	...
	if(v2x_info) {
		v2x_info_local_nonprim =
			OpenAPI_v2x_information_parseFromJSON(v2x_info);
		if(!v2x_info_local_nonprim) {
			ogs_error(
				"OpenAPI_v2x_information_parseFromJSON failed [v2x_info]");
			goto end;
		}
	}
	...
	prose_info = cJSON_GetObjectItemCaseSensitive(n2_info_containerJSON,
	                                              "proseInfo");
	if(prose_info) {
		prose_info_local_nonprim =
			OpenAPI_pro_se_information_parseFromJSON(prose_info);
		if(!prose_info_local_nonprim) {
			ogs_error(
				"OpenAPI_pro_se_information_parseFromJSON failed [prose_info]");
			goto end;
		}
	}
