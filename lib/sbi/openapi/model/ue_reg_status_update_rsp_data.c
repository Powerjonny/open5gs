...
OpenAPI_ue_reg_status_update_rsp_data_create(int reg_status_transfer_complete) {
	OpenAPI_ue_reg_status_update_rsp_data_t *
		...
		ogs_malloc(sizeof(OpenAPI_ue_reg_status_update_rsp_data_t));
	...
	OpenAPI_ue_reg_status_update_rsp_data_t *ue_reg_status_update_rsp_data)
{
	...
	if(ue_reg_status_update_rsp_data == NULL) {
		ogs_error(
			"OpenAPI_ue_reg_status_update_rsp_data_convertToJSON() failed [UeRegStatusUpdateRspData]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ue_reg_status_update_rsp_data_convertToJSON() failed [reg_status_transfer_complete]");
		goto end;
	}
...
OpenAPI_ue_reg_status_update_rsp_data_parseFromJSON(
	...
	OpenAPI_ue_reg_status_update_rsp_data_t *
	        ue_reg_status_update_rsp_data_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *reg_status_transfer_complete = NULL;
	reg_status_transfer_complete =
		cJSON_GetObjectItemCaseSensitive(
			ue_reg_status_update_rsp_dataJSON,
			"regStatusTransferComplete");
	if(!reg_status_transfer_complete) {
		ogs_error(
			"OpenAPI_ue_reg_status_update_rsp_data_parseFromJSON() failed [reg_status_transfer_complete]");
		goto end;
	}
	...
	ue_reg_status_update_rsp_data_local_var =
		OpenAPI_ue_reg_status_update_rsp_data_create(
...
OpenAPI_ue_reg_status_update_rsp_data_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_ue_reg_status_update_rsp_data_convertToJSON() failed");
		return NULL;
	}
