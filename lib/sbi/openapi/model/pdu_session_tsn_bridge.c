...
OpenAPI_pdu_session_tsn_bridge_t *OpenAPI_pdu_session_tsn_bridge_create(
	...
	OpenAPI_pdu_session_tsn_bridge_t *pdu_session_tsn_bridge_local_var =
		ogs_malloc(sizeof(OpenAPI_pdu_session_tsn_bridge_t));
	ogs_assert(pdu_session_tsn_bridge_local_var);

	pdu_session_tsn_bridge_local_var->tsn_bridge_info = tsn_bridge_info;
	pdu_session_tsn_bridge_local_var->tsn_bridge_man_cont =
		tsn_bridge_man_cont;
	pdu_session_tsn_bridge_local_var->tsn_port_man_cont_dstt =
		tsn_port_man_cont_dstt;
	pdu_session_tsn_bridge_local_var->tsn_port_man_cont_nwtts =
	...
	pdu_session_tsn_bridge_local_var->ue_ipv6_addr_prefix =
		ue_ipv6_addr_prefix;
...
void OpenAPI_pdu_session_tsn_bridge_free(
	...
	if(pdu_session_tsn_bridge->tsn_bridge_info) {
		OpenAPI_tsn_bridge_info_free(
			pdu_session_tsn_bridge->tsn_bridge_info);
	...
	if(pdu_session_tsn_bridge->tsn_bridge_man_cont) {
		OpenAPI_bridge_management_container_free(
			pdu_session_tsn_bridge->tsn_bridge_man_cont);
...
cJSON *OpenAPI_pdu_session_tsn_bridge_convertToJSON(
	...
	if(pdu_session_tsn_bridge == NULL) {
		ogs_error(
			"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [PduSessionTsnBridge]");
		return NULL;
	}
	...
	if(!pdu_session_tsn_bridge->tsn_bridge_info) {
		ogs_error(
			"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [tsn_bridge_info]");
		return NULL;
	}
	...
	if(pdu_session_tsn_bridge->tsn_bridge_man_cont) {
		...
		if(tsn_bridge_man_cont_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [tsn_bridge_man_cont]");
			goto end;
		}
	...
	if(pdu_session_tsn_bridge->tsn_port_man_cont_dstt) {
		...
		if(tsn_port_man_cont_dstt_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [tsn_port_man_cont_dstt]");
			goto end;
		}
	...
	if(pdu_session_tsn_bridge->tsn_port_man_cont_nwtts) {
		...
		if(tsn_port_man_cont_nwttsList == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [tsn_port_man_cont_nwtts]");
			goto end;
		}
		OpenAPI_list_for_each(
			pdu_session_tsn_bridge->tsn_port_man_cont_nwtts, node) {
	...
	if(pdu_session_tsn_bridge->ue_ipv4_addr) {
		if(cJSON_AddStringToObject(item, "ueIpv4Addr",
		                           pdu_session_tsn_bridge->ue_ipv4_addr)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [ue_ipv4_addr]");
			goto end;
		}
	}
	...
	if(pdu_session_tsn_bridge->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(pdu_session_tsn_bridge->snssai) {
		cJSON *snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				pdu_session_tsn_bridge->snssai);
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [snssai]");
			goto end;
		}
	...
	if(pdu_session_tsn_bridge->ip_domain) {
		if(cJSON_AddStringToObject(item, "ipDomain",
		                           pdu_session_tsn_bridge->ip_domain) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [ip_domain]");
			goto end;
		}
	}

	if(pdu_session_tsn_bridge->ue_ipv6_addr_prefix) {
		if(cJSON_AddStringToObject(item, "ueIpv6AddrPrefix",
		                           pdu_session_tsn_bridge->
		                           ue_ipv6_addr_prefix) == NULL)
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed [ue_ipv6_addr_prefix]");
			goto end;
		}
	}
...
OpenAPI_pdu_session_tsn_bridge_t *OpenAPI_pdu_session_tsn_bridge_parseFromJSON(
	...
	tsn_bridge_info =
		cJSON_GetObjectItemCaseSensitive(pdu_session_tsn_bridgeJSON,
		                                 "tsnBridgeInfo");
	if(!tsn_bridge_info) {
		ogs_error(
			"OpenAPI_pdu_session_tsn_bridge_parseFromJSON() failed [tsn_bridge_info]");
		goto end;
	}
	...
	if(tsn_port_man_cont_nwtts) {
		...
		if(!cJSON_IsArray(tsn_port_man_cont_nwtts)) {
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_parseFromJSON() failed [tsn_port_man_cont_nwtts]");
			goto end;
		}
	...
	if(ue_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_parseFromJSON() failed [ue_ipv4_addr]");
			goto end;
		}
	}

	dnn = cJSON_GetObjectItemCaseSensitive(pdu_session_tsn_bridgeJSON,
	                                       "dnn");
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_parseFromJSON() failed [dnn]");
			goto end;
		}
	}

	snssai = cJSON_GetObjectItemCaseSensitive(pdu_session_tsn_bridgeJSON,
	                                          "snssai");
	if(snssai) {
	...
	ip_domain = cJSON_GetObjectItemCaseSensitive(pdu_session_tsn_bridgeJSON,
	                                             "ipDomain");
	if(ip_domain) {
		...
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_parseFromJSON() failed [ip_domain]");
			goto end;
		}
	}
	...
	if(ue_ipv6_addr_prefix) {
		if(!cJSON_IsString(ue_ipv6_addr_prefix) &&
		   !cJSON_IsNull(ue_ipv6_addr_prefix))
		{
			ogs_error(
				"OpenAPI_pdu_session_tsn_bridge_parseFromJSON() failed [ue_ipv6_addr_prefix]");
			goto end;
		}
	}

	pdu_session_tsn_bridge_local_var =
		OpenAPI_pdu_session_tsn_bridge_create(
			tsn_bridge_info_local_nonprim,
			tsn_bridge_man_cont ?
			...
			ue_ipv4_addr &&
			!cJSON_IsNull(ue_ipv4_addr) ?
			ogs_strdup(ue_ipv4_addr->valuestring) : NULL,
			dnn &&
			...
			ue_ipv6_addr_prefix &&
			!cJSON_IsNull(ue_ipv6_addr_prefix) ?
			ogs_strdup(ue_ipv6_addr_prefix->valuestring) : NULL
			);
...
OpenAPI_pdu_session_tsn_bridge_t *OpenAPI_pdu_session_tsn_bridge_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pdu_session_tsn_bridge_convertToJSON() failed");
		return NULL;
	}
