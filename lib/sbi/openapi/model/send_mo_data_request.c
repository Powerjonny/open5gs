...
OpenAPI_send_mo_data_request_t *OpenAPI_send_mo_data_request_create(
	...
	OpenAPI_send_mo_data_request_t *send_mo_data_request_local_var =
		ogs_malloc(sizeof(OpenAPI_send_mo_data_request_t));
...
void OpenAPI_send_mo_data_request_free(
	OpenAPI_send_mo_data_request_t *send_mo_data_request) {
	...
	if(send_mo_data_request->json_data) {
		OpenAPI_send_mo_data_req_data_free(
			send_mo_data_request->json_data);
...
cJSON *OpenAPI_send_mo_data_request_convertToJSON(
	OpenAPI_send_mo_data_request_t *send_mo_data_request) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(send_mo_data_request == NULL) {
		ogs_error(
			"OpenAPI_send_mo_data_request_convertToJSON() failed [SendMoData_request]");
		return NULL;
	}
	...
	if(send_mo_data_request->json_data) {
		cJSON *json_data_local_JSON =
			OpenAPI_send_mo_data_req_data_convertToJSON(
				send_mo_data_request->json_data);
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_send_mo_data_request_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(send_mo_data_request->binary_mo_data) {
		char *encoded_str_binary_mo_data =
			OpenAPI_base64encode(
				send_mo_data_request->binary_mo_data->data,
				send_mo_data_request->binary_mo_data->len);
		if(cJSON_AddStringToObject(item, "binaryMoData",
		                           encoded_str_binary_mo_data) == NULL)
		{
			ogs_error(
				"OpenAPI_send_mo_data_request_convertToJSON() failed [binary_mo_data]");
			goto end;
		}
...
OpenAPI_send_mo_data_request_t *OpenAPI_send_mo_data_request_parseFromJSON(
	cJSON *send_mo_data_requestJSON) {
	...
	json_data = cJSON_GetObjectItemCaseSensitive(send_mo_data_requestJSON,
	                                             "jsonData");
	if(json_data) {
		json_data_local_nonprim =
			OpenAPI_send_mo_data_req_data_parseFromJSON(json_data);
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_send_mo_data_req_data_parseFromJSON failed [json_data]");
			goto end;
		}
	}

	binary_mo_data =
		cJSON_GetObjectItemCaseSensitive(send_mo_data_requestJSON,
		                                 "binaryMoData");
	if(binary_mo_data) {
		...
		if(!cJSON_IsString(binary_mo_data)) {
			ogs_error(
				"OpenAPI_send_mo_data_request_parseFromJSON() failed [binary_mo_data]");
			goto end;
		}
		decoded_str_binary_mo_data->data =
			OpenAPI_base64decode(binary_mo_data->valuestring,
			                     strlen(
						     binary_mo_data->valuestring),
			                     &decoded_str_binary_mo_data->len);
...
OpenAPI_send_mo_data_request_t *OpenAPI_send_mo_data_request_copy(
	OpenAPI_send_mo_data_request_t	*dst,
	OpenAPI_send_mo_data_request_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_send_mo_data_request_convertToJSON() failed");
		return NULL;
	}
