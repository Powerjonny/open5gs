...
OpenAPI_preemption_capability_rm_t *OpenAPI_preemption_capability_rm_create() {
	OpenAPI_preemption_capability_rm_t *preemption_capability_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_preemption_capability_rm_t));
...
cJSON *OpenAPI_preemption_capability_rm_convertToJSON(
	...
	if(preemption_capability_rm == NULL) {
		ogs_error(
			"OpenAPI_preemption_capability_rm_convertToJSON() failed [PreemptionCapabilityRm]");
		return NULL;
	}
...
OpenAPI_preemption_capability_rm_parseFromJSON(
	...
	preemption_capability_rm_local_var =
		OpenAPI_preemption_capability_rm_create(
			);
...
OpenAPI_preemption_capability_rm_t *OpenAPI_preemption_capability_rm_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_preemption_capability_rm_convertToJSON() failed");
		return NULL;
	}
