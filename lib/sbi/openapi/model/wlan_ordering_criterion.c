...
OpenAPI_wlan_ordering_criterion_t *OpenAPI_wlan_ordering_criterion_create() {
	OpenAPI_wlan_ordering_criterion_t *wlan_ordering_criterion_local_var =
		ogs_malloc(sizeof(OpenAPI_wlan_ordering_criterion_t));
...
cJSON *OpenAPI_wlan_ordering_criterion_convertToJSON(
	...
	if(wlan_ordering_criterion == NULL) {
		ogs_error(
			"OpenAPI_wlan_ordering_criterion_convertToJSON() failed [WlanOrderingCriterion]");
		return NULL;
	}
...
OpenAPI_wlan_ordering_criterion_t *OpenAPI_wlan_ordering_criterion_parseFromJSON
	...
	OpenAPI_wlan_ordering_criterion_t *wlan_ordering_criterion_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	wlan_ordering_criterion_local_var =
...
OpenAPI_wlan_ordering_criterion_t *OpenAPI_wlan_ordering_criterion_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_wlan_ordering_criterion_convertToJSON() failed");
		return NULL;
	}
