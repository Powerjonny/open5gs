...
OpenAPI_nf_profile_t *OpenAPI_nf_profile_create(
	...
	nf_status,
	OpenAPI_list_t *
	collocated_nf_instances,
	bool is_heart_beat_timer,
	int heart_beat_timer, OpenAPI_list_t *plmn_list,
	OpenAPI_list_t *snpn_list, OpenAPI_list_t *s_nssais,
	OpenAPI_list_t *per_plmn_snssai_list, OpenAPI_list_t *nsi_list,
	char *fqdn, char *inter_plmn_fqdn, OpenAPI_list_t *ipv4_addresses,
	OpenAPI_list_t *ipv6_addresses, OpenAPI_list_t *allowed_plmns,
	OpenAPI_list_t *allowed_snpns, OpenAPI_list_t *allowed_nf_types,
	OpenAPI_list_t *allowed_nf_domains, OpenAPI_list_t *allowed_nssais,
	bool is_priority, int priority, bool is_capacity, int capacity,
	bool is_load, int load, char *load_time_stamp, char *locality,
	OpenAPI_udr_info_t *udr_info, OpenAPI_list_t *udr_info_list,
	OpenAPI_udm_info_t *udm_info, OpenAPI_list_t *udm_info_list,
	OpenAPI_ausf_info_t *ausf_info, OpenAPI_list_t *ausf_info_list,
	OpenAPI_amf_info_t *amf_info, OpenAPI_list_t *amf_info_list,
	OpenAPI_smf_info_t *smf_info, OpenAPI_list_t *smf_info_list,
	OpenAPI_upf_info_t *upf_info, OpenAPI_list_t *upf_info_list,
	OpenAPI_pcf_info_t *pcf_info, OpenAPI_list_t *pcf_info_list,
	OpenAPI_bsf_info_t *bsf_info, OpenAPI_list_t *bsf_info_list,
	OpenAPI_chf_info_t *chf_info, OpenAPI_list_t *chf_info_list,
	OpenAPI_nef_info_t *nef_info, OpenAPI_nrf_info_t *nrf_info,
	OpenAPI_udsf_info_t *udsf_info, OpenAPI_list_t *udsf_info_list,
	OpenAPI_nwdaf_info_t *nwdaf_info, OpenAPI_list_t *nwdaf_info_list,
	OpenAPI_list_t *pcscf_info_list, OpenAPI_list_t *hss_info_list,
	OpenAPI_object_t *custom_info, char *recovery_time,
	bool is_nf_service_persistence, int nf_service_persistence,
	OpenAPI_list_t *nf_services, OpenAPI_list_t *nf_service_list,
	...
	OpenAPI_lmf_info_t *lmf_info, OpenAPI_gmlc_info_t *gmlc_info,
	OpenAPI_list_t *nf_set_id_list, OpenAPI_list_t *serving_scope,
	bool is_lc_h_support_ind, int lc_h_support_ind,
	bool is_olc_h_support_ind, int olc_h_support_ind,
	OpenAPI_list_t *nf_set_recovery_time_list,
	OpenAPI_list_t *service_set_recovery_time_list,
	OpenAPI_list_t *scp_domains, OpenAPI_scp_info_t *scp_info,
	OpenAPI_sepp_info_t *sepp_info, char *vendor_id,
	...
	OpenAPI_mfaf_info_t *mfaf_info, OpenAPI_list_t *easdf_info_list,
	OpenAPI_dccf_info_t *dccf_info, OpenAPI_list_t *nsacf_info_list,
	OpenAPI_list_t *mb_smf_info_list, OpenAPI_list_t *tsctsf_info_list,
	OpenAPI_list_t *mb_upf_info_list,
	OpenAPI_trust_af_info_t *trust_af_info,
	OpenAPI_nssaaf_info_t *nssaaf_info, OpenAPI_list_t *hni_list,
	OpenAPI_iwmsc_info_t *iwmsc_info, OpenAPI_mnpf_info_t *mnpf_info) {
	OpenAPI_nf_profile_t *nf_profile_local_var =
		ogs_malloc(sizeof(OpenAPI_nf_profile_t));
	...
	nf_profile_local_var->is_nf_service_persistence =
		is_nf_service_persistence;
	...
	nf_profile_local_var->is_nf_profile_changes_support_ind =
		is_nf_profile_changes_support_ind;
	nf_profile_local_var->nf_profile_changes_support_ind =
		nf_profile_changes_support_ind;
	nf_profile_local_var->is_nf_profile_changes_ind =
		is_nf_profile_changes_ind;
	nf_profile_local_var->nf_profile_changes_ind = nf_profile_changes_ind;
	nf_profile_local_var->default_notification_subscriptions =
	...
	nf_profile_local_var->nf_set_recovery_time_list =
		nf_set_recovery_time_list;
	nf_profile_local_var->service_set_recovery_time_list =
	...
	nf_profile_local_var->supported_vendor_specific_features =
...
void OpenAPI_nf_profile_free(OpenAPI_nf_profile_t *nf_profile) {
	...
	if(nf_profile->default_notification_subscriptions) {
		OpenAPI_list_for_each(
			nf_profile->default_notification_subscriptions, node) {
			OpenAPI_default_notification_subscription_free(
				node->data);
		}
		OpenAPI_list_free(
			nf_profile->default_notification_subscriptions);
	...
	if(nf_profile->nf_set_recovery_time_list) {
		OpenAPI_list_for_each(nf_profile->nf_set_recovery_time_list,
		                      node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
	...
	if(nf_profile->service_set_recovery_time_list) {
		OpenAPI_list_for_each(
			nf_profile->service_set_recovery_time_list, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
			ogs_free(localKeyValue->value);
	...
	if(nf_profile->supported_vendor_specific_features) {
		OpenAPI_list_for_each(
			nf_profile->supported_vendor_specific_features, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
			ogs_free(localKeyValue->value);
		...
		OpenAPI_list_free(
			nf_profile->supported_vendor_specific_features);
...
cJSON *OpenAPI_nf_profile_convertToJSON(OpenAPI_nf_profile_t *nf_profile) {
	...
	if(nf_profile == NULL) {
		ogs_error(
			"OpenAPI_nf_profile_convertToJSON() failed [NFProfile]");
		return NULL;
	}
	...
	if(!nf_profile->nf_instance_id) {
		ogs_error(
			"OpenAPI_nf_profile_convertToJSON() failed [nf_instance_id]");
		return NULL;
	}
	...
	if(nf_profile->nf_instance_name) {
		if(cJSON_AddStringToObject(item, "nfInstanceName",
		                           nf_profile->nf_instance_name) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_instance_name]");
			goto end;
		}
	}
	...
	if(nf_profile->nf_type == OpenAPI_nf_type_NULL) {
		ogs_error(
			"OpenAPI_nf_profile_convertToJSON() failed [nf_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "nfType",
	                           OpenAPI_nf_type_ToString(
					   nf_profile->nf_type)) == NULL)
	{
		ogs_error(
			"OpenAPI_nf_profile_convertToJSON() failed [nf_type]");
		goto end;
	...
	if(nf_profile->nf_status == OpenAPI_nf_status_NULL) {
		ogs_error(
			"OpenAPI_nf_profile_convertToJSON() failed [nf_status]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "nfStatus",
	                           OpenAPI_nf_status_ToString(
					   nf_profile->nf_status)) == NULL)
	{
		ogs_error(
			"OpenAPI_nf_profile_convertToJSON() failed [nf_status]");
		goto end;
	...
	if(nf_profile->collocated_nf_instances) {
		cJSON *collocated_nf_instancesList =
			cJSON_AddArrayToObject(item, "collocatedNfInstances");
		if(collocated_nf_instancesList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [collocated_nf_instances]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->collocated_nf_instances,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_collocated_nf_instance_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [collocated_nf_instances]");
			...
			cJSON_AddItemToArray(collocated_nf_instancesList,
			                     itemLocal);
		}
	}

	if(nf_profile->is_heart_beat_timer) {
		if(cJSON_AddNumberToObject(item, "heartBeatTimer",
		                           nf_profile->heart_beat_timer) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [heart_beat_timer]");
			goto end;
		}
	}
	...
	if(nf_profile->plmn_list) {
		...
		if(plmn_listList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [plmn_list]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->plmn_list, node) {
			cJSON *itemLocal =
				OpenAPI_plmn_id_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [plmn_list]");
				goto end;
	...
	if(nf_profile->snpn_list) {
		...
		if(snpn_listList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [snpn_list]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->snpn_list, node) {
			cJSON *itemLocal =
				OpenAPI_plmn_id_nid_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [snpn_list]");
				goto end;
	...
	if(nf_profile->s_nssais) {
		...
		if(s_nssaisList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [s_nssais]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->s_nssais, node) {
			cJSON *itemLocal =
				OpenAPI_ext_snssai_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [s_nssais]");
				goto end;
	...
	if(nf_profile->per_plmn_snssai_list) {
		cJSON *per_plmn_snssai_listList = cJSON_AddArrayToObject(item,
		                                                         "perPlmnSnssaiList");
		if(per_plmn_snssai_listList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [per_plmn_snssai_list]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->per_plmn_snssai_list, node) {
			cJSON *itemLocal =
				OpenAPI_plmn_snssai_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [per_plmn_snssai_list]");
				goto end;
			}
			cJSON_AddItemToArray(per_plmn_snssai_listList,
			                     itemLocal);
		}
	}
	...
	if(nf_profile->nsi_list) {
		...
		if(nsi_listList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nsi_list]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->nsi_list, node) {
			if(cJSON_AddStringToObject(nsi_listList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [nsi_list]");
	...
	if(nf_profile->fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [fqdn]");
			goto end;
		}
	}

	if(nf_profile->inter_plmn_fqdn) {
		if(cJSON_AddStringToObject(item, "interPlmnFqdn",
		                           nf_profile->inter_plmn_fqdn) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [inter_plmn_fqdn]");
			goto end;
		}
	}

	if(nf_profile->ipv4_addresses) {
		cJSON *ipv4_addressesList = cJSON_AddArrayToObject(item,
		                                                   "ipv4Addresses");
		if(ipv4_addressesList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [ipv4_addresses]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->ipv4_addresses, node) {
			if(cJSON_AddStringToObject(ipv4_addressesList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [ipv4_addresses]");
	...
	if(nf_profile->ipv6_addresses) {
		cJSON *ipv6_addressesList = cJSON_AddArrayToObject(item,
		                                                   "ipv6Addresses");
		if(ipv6_addressesList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [ipv6_addresses]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->ipv6_addresses, node) {
			if(cJSON_AddStringToObject(ipv6_addressesList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [ipv6_addresses]");
	...
	if(nf_profile->allowed_plmns) {
		cJSON *allowed_plmnsList = cJSON_AddArrayToObject(item,
		                                                  "allowedPlmns");
		if(allowed_plmnsList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [allowed_plmns]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->allowed_plmns, node) {
			cJSON *itemLocal =
	...
	if(nf_profile->allowed_snpns) {
		cJSON *allowed_snpnsList = cJSON_AddArrayToObject(item,
		                                                  "allowedSnpns");
		if(allowed_snpnsList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [allowed_snpns]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->allowed_snpns, node) {
			cJSON *itemLocal =
	...
	if(nf_profile->allowed_nf_types != OpenAPI_nf_type_NULL) {
		cJSON *allowed_nf_typesList = cJSON_AddArrayToObject(item,
		                                                     "allowedNfTypes");
		if(allowed_nf_typesList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [allowed_nf_types]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->allowed_nf_types, node) {
			if(cJSON_AddStringToObject(allowed_nf_typesList, "",
			                           OpenAPI_nf_type_ToString(
							   (intptr_t) node->data))
			   == NULL)
			{
	...
	if(nf_profile->allowed_nf_domains) {
		cJSON *allowed_nf_domainsList = cJSON_AddArrayToObject(item,
		                                                       "allowedNfDomains");
		if(allowed_nf_domainsList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [allowed_nf_domains]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->allowed_nf_domains, node) {
			if(cJSON_AddStringToObject(allowed_nf_domainsList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [allowed_nf_domains]");
	...
	if(nf_profile->allowed_nssais) {
		cJSON *allowed_nssaisList = cJSON_AddArrayToObject(item,
		                                                   "allowedNssais");
		if(allowed_nssaisList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [allowed_nssais]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->allowed_nssais, node) {
			cJSON *itemLocal =
	...
	if(nf_profile->is_priority) {
		if(cJSON_AddNumberToObject(item, "priority",
		                           nf_profile->priority) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [priority]");
			goto end;
		}
	}

	if(nf_profile->is_capacity) {
		if(cJSON_AddNumberToObject(item, "capacity",
		                           nf_profile->capacity) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [capacity]");
			goto end;
		}
	}

	if(nf_profile->is_load) {
		if(cJSON_AddNumberToObject(item, "load",
		                           nf_profile->load) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [load]");
			goto end;
		}
	}

	if(nf_profile->load_time_stamp) {
		if(cJSON_AddStringToObject(item, "loadTimeStamp",
		                           nf_profile->load_time_stamp) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [load_time_stamp]");
			goto end;
		}
	}

	if(nf_profile->locality) {
		if(cJSON_AddStringToObject(item, "locality",
		                           nf_profile->locality) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [locality]");
			goto end;
		}
	}

	if(nf_profile->udr_info) {
		cJSON *udr_info_local_JSON =
			OpenAPI_udr_info_convertToJSON(nf_profile->udr_info);
		if(udr_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [udr_info]");
			goto end;
		}
	...
	if(nf_profile->udr_info_list) {
		cJSON *udr_info_list = cJSON_AddObjectToObject(item,
		                                               "udrInfoList");
		if(udr_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [udr_info_list]");
			goto end;
		}
		...
		if(nf_profile->udr_info_list) {
			OpenAPI_list_for_each(nf_profile->udr_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_udr_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
					ogs_error(
						"OpenAPI_nf_profile_convertToJSON() failed [inner]");
					goto end;
				}
	...
	if(nf_profile->udm_info) {
		cJSON *udm_info_local_JSON =
			OpenAPI_udm_info_convertToJSON(nf_profile->udm_info);
		if(udm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [udm_info]");
			goto end;
		}
	...
	if(nf_profile->udm_info_list) {
		cJSON *udm_info_list = cJSON_AddObjectToObject(item,
		                                               "udmInfoList");
		if(udm_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [udm_info_list]");
			goto end;
		}
		...
		if(nf_profile->udm_info_list) {
			OpenAPI_list_for_each(nf_profile->udm_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_udm_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->ausf_info) {
		...
		if(ausf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [ausf_info]");
			goto end;
		}
	...
	if(nf_profile->ausf_info_list) {
		cJSON *ausf_info_list = cJSON_AddObjectToObject(item,
		                                                "ausfInfoList");
		if(ausf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [ausf_info_list]");
			goto end;
		}
		cJSON *localMapObject = ausf_info_list;
		if(nf_profile->ausf_info_list) {
			OpenAPI_list_for_each(nf_profile->ausf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_ausf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->amf_info) {
		cJSON *amf_info_local_JSON =
			OpenAPI_amf_info_convertToJSON(nf_profile->amf_info);
		if(amf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [amf_info]");
			goto end;
		}
	...
	if(nf_profile->amf_info_list) {
		cJSON *amf_info_list = cJSON_AddObjectToObject(item,
		                                               "amfInfoList");
		if(amf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [amf_info_list]");
			goto end;
		}
		...
		if(nf_profile->amf_info_list) {
			OpenAPI_list_for_each(nf_profile->amf_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_amf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->smf_info) {
		cJSON *smf_info_local_JSON =
			OpenAPI_smf_info_convertToJSON(nf_profile->smf_info);
		if(smf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [smf_info]");
			goto end;
		}
	...
	if(nf_profile->smf_info_list) {
		cJSON *smf_info_list = cJSON_AddObjectToObject(item,
		                                               "smfInfoList");
		if(smf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [smf_info_list]");
			goto end;
		}
		...
		if(nf_profile->smf_info_list) {
			OpenAPI_list_for_each(nf_profile->smf_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_smf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->upf_info) {
		cJSON *upf_info_local_JSON =
			OpenAPI_upf_info_convertToJSON(nf_profile->upf_info);
		if(upf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [upf_info]");
			goto end;
		}
	...
	if(nf_profile->upf_info_list) {
		cJSON *upf_info_list = cJSON_AddObjectToObject(item,
		                                               "upfInfoList");
		if(upf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [upf_info_list]");
			goto end;
		}
		...
		if(nf_profile->upf_info_list) {
			OpenAPI_list_for_each(nf_profile->upf_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_upf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->pcf_info) {
		cJSON *pcf_info_local_JSON =
			OpenAPI_pcf_info_convertToJSON(nf_profile->pcf_info);
		if(pcf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [pcf_info]");
			goto end;
		}
	...
	if(nf_profile->pcf_info_list) {
		cJSON *pcf_info_list = cJSON_AddObjectToObject(item,
		                                               "pcfInfoList");
		if(pcf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [pcf_info_list]");
			goto end;
		}
		...
		if(nf_profile->pcf_info_list) {
			OpenAPI_list_for_each(nf_profile->pcf_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_pcf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->bsf_info) {
		cJSON *bsf_info_local_JSON =
			OpenAPI_bsf_info_convertToJSON(nf_profile->bsf_info);
		if(bsf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [bsf_info]");
			goto end;
		}
	...
	if(nf_profile->bsf_info_list) {
		cJSON *bsf_info_list = cJSON_AddObjectToObject(item,
		                                               "bsfInfoList");
		if(bsf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [bsf_info_list]");
			goto end;
		}
		...
		if(nf_profile->bsf_info_list) {
			OpenAPI_list_for_each(nf_profile->bsf_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_bsf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->chf_info) {
		cJSON *chf_info_local_JSON =
			OpenAPI_chf_info_convertToJSON(nf_profile->chf_info);
		if(chf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [chf_info]");
			goto end;
		}
	...
	if(nf_profile->chf_info_list) {
		cJSON *chf_info_list = cJSON_AddObjectToObject(item,
		                                               "chfInfoList");
		if(chf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [chf_info_list]");
			goto end;
		}
		...
		if(nf_profile->chf_info_list) {
			OpenAPI_list_for_each(nf_profile->chf_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_chf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->nef_info) {
		cJSON *nef_info_local_JSON =
			OpenAPI_nef_info_convertToJSON(nf_profile->nef_info);
		if(nef_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nef_info]");
			goto end;
		}
	...
	if(nf_profile->nrf_info) {
		cJSON *nrf_info_local_JSON =
			OpenAPI_nrf_info_convertToJSON(nf_profile->nrf_info);
		if(nrf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nrf_info]");
			goto end;
		}
	...
	if(nf_profile->udsf_info) {
		cJSON *udsf_info_local_JSON =
			OpenAPI_udsf_info_convertToJSON(nf_profile->udsf_info);
		if(udsf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [udsf_info]");
			goto end;
		}
	...
	if(nf_profile->udsf_info_list) {
		cJSON *udsf_info_list = cJSON_AddObjectToObject(item,
		                                                "udsfInfoList");
		if(udsf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [udsf_info_list]");
			goto end;
		}
		cJSON *localMapObject = udsf_info_list;
		if(nf_profile->udsf_info_list) {
			OpenAPI_list_for_each(nf_profile->udsf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
	...
	if(nf_profile->nwdaf_info) {
		cJSON *nwdaf_info_local_JSON =
			OpenAPI_nwdaf_info_convertToJSON(
				nf_profile->nwdaf_info);
		if(nwdaf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nwdaf_info]");
			goto end;
		}
	...
	if(nf_profile->nwdaf_info_list) {
		cJSON *nwdaf_info_list = cJSON_AddObjectToObject(item,
		                                                 "nwdafInfoList");
		if(nwdaf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nwdaf_info_list]");
			goto end;
		}
		cJSON *localMapObject = nwdaf_info_list;
		if(nf_profile->nwdaf_info_list) {
			OpenAPI_list_for_each(nf_profile->nwdaf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
	...
	if(nf_profile->pcscf_info_list) {
		cJSON *pcscf_info_list = cJSON_AddObjectToObject(item,
		                                                 "pcscfInfoList");
		if(pcscf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [pcscf_info_list]");
			goto end;
		}
		cJSON *localMapObject = pcscf_info_list;
		if(nf_profile->pcscf_info_list) {
			OpenAPI_list_for_each(nf_profile->pcscf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_pcscf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->hss_info_list) {
		cJSON *hss_info_list = cJSON_AddObjectToObject(item,
		                                               "hssInfoList");
		if(hss_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [hss_info_list]");
			goto end;
		}
		...
		if(nf_profile->hss_info_list) {
			OpenAPI_list_for_each(nf_profile->hss_info_list, node) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_hss_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->custom_info) {
		cJSON *custom_info_object =
			OpenAPI_object_convertToJSON(nf_profile->custom_info);
		if(custom_info_object == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [custom_info]");
			goto end;
		}
	...
	if(nf_profile->recovery_time) {
		if(cJSON_AddStringToObject(item, "recoveryTime",
		                           nf_profile->recovery_time) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [recovery_time]");
			goto end;
		}
	}

	if(nf_profile->is_nf_service_persistence) {
		if(cJSON_AddBoolToObject(item, "nfServicePersistence",
		                         nf_profile->nf_service_persistence) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_service_persistence]");
			goto end;
		}
	}

	if(nf_profile->nf_services) {
		cJSON *nf_servicesList = cJSON_AddArrayToObject(item,
		                                                "nfServices");
		if(nf_servicesList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_services]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->nf_services, node) {
			cJSON *itemLocal =
				OpenAPI_nf_service_convertToJSON(node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [nf_services]");
				goto end;
	...
	if(nf_profile->nf_service_list) {
		cJSON *nf_service_list = cJSON_AddObjectToObject(item,
		                                                 "nfServiceList");
		if(nf_service_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_service_list]");
			goto end;
		}
		cJSON *localMapObject = nf_service_list;
		if(nf_profile->nf_service_list) {
			OpenAPI_list_for_each(nf_profile->nf_service_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_nf_service_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->is_nf_profile_changes_support_ind) {
		if(cJSON_AddBoolToObject(item, "nfProfileChangesSupportInd",
		                         nf_profile->
		                         nf_profile_changes_support_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_profile_changes_support_ind]");
			goto end;
		}
	}

	if(nf_profile->is_nf_profile_changes_ind) {
		if(cJSON_AddBoolToObject(item, "nfProfileChangesInd",
		                         nf_profile->nf_profile_changes_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_profile_changes_ind]");
			goto end;
		}
	}

	if(nf_profile->default_notification_subscriptions) {
		cJSON *default_notification_subscriptionsList =
			cJSON_AddArrayToObject(item,
			                       "defaultNotificationSubscriptions");
		if(default_notification_subscriptionsList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [default_notification_subscriptions]");
			goto end;
		}
		OpenAPI_list_for_each(
			nf_profile->default_notification_subscriptions, node) {
			cJSON *itemLocal =
				OpenAPI_default_notification_subscription_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [default_notification_subscriptions]");
	...
	if(nf_profile->lmf_info) {
		cJSON *lmf_info_local_JSON =
			OpenAPI_lmf_info_convertToJSON(nf_profile->lmf_info);
		if(lmf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [lmf_info]");
			goto end;
		}
	...
	if(nf_profile->gmlc_info) {
		cJSON *gmlc_info_local_JSON =
			OpenAPI_gmlc_info_convertToJSON(nf_profile->gmlc_info);
		if(gmlc_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [gmlc_info]");
			goto end;
		}
	...
	if(nf_profile->nf_set_id_list) {
		cJSON *nf_set_id_listList = cJSON_AddArrayToObject(item,
		                                                   "nfSetIdList");
		if(nf_set_id_listList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_set_id_list]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->nf_set_id_list, node) {
			if(cJSON_AddStringToObject(nf_set_id_listList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [nf_set_id_list]");
	...
	if(nf_profile->serving_scope) {
		cJSON *serving_scopeList = cJSON_AddArrayToObject(item,
		                                                  "servingScope");
		if(serving_scopeList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [serving_scope]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->serving_scope, node) {
			if(cJSON_AddStringToObject(serving_scopeList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [serving_scope]");
	...
	if(nf_profile->is_lc_h_support_ind) {
		if(cJSON_AddBoolToObject(item, "lcHSupportInd",
		                         nf_profile->lc_h_support_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [lc_h_support_ind]");
			goto end;
		}
	}

	if(nf_profile->is_olc_h_support_ind) {
		if(cJSON_AddBoolToObject(item, "olcHSupportInd",
		                         nf_profile->olc_h_support_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [olc_h_support_ind]");
			goto end;
		}
	}

	if(nf_profile->nf_set_recovery_time_list) {
		cJSON *nf_set_recovery_time_list = cJSON_AddObjectToObject(item,
		                                                           "nfSetRecoveryTimeList");
		if(nf_set_recovery_time_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nf_set_recovery_time_list]");
			goto end;
		}
		cJSON *localMapObject = nf_set_recovery_time_list;
		if(nf_profile->nf_set_recovery_time_list) {
			OpenAPI_list_for_each(
				nf_profile->nf_set_recovery_time_list, node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
					ogs_error(
	...
	if(nf_profile->service_set_recovery_time_list) {
		cJSON *service_set_recovery_time_list =
			cJSON_AddObjectToObject(item,
			                        "serviceSetRecoveryTimeList");
		if(service_set_recovery_time_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [service_set_recovery_time_list]");
			goto end;
		}
		cJSON *localMapObject = service_set_recovery_time_list;
		if(nf_profile->service_set_recovery_time_list) {
			OpenAPI_list_for_each(
				nf_profile->service_set_recovery_time_list,
				node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
	...
	if(nf_profile->scp_domains) {
		cJSON *scp_domainsList = cJSON_AddArrayToObject(item,
		                                                "scpDomains");
		if(scp_domainsList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [scp_domains]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->scp_domains, node) {
			if(cJSON_AddStringToObject(scp_domainsList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [scp_domains]");
	...
	if(nf_profile->scp_info) {
		cJSON *scp_info_local_JSON =
			OpenAPI_scp_info_convertToJSON(nf_profile->scp_info);
		if(scp_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [scp_info]");
			goto end;
		}
	...
	if(nf_profile->sepp_info) {
		cJSON *sepp_info_local_JSON =
			OpenAPI_sepp_info_convertToJSON(nf_profile->sepp_info);
		if(sepp_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [sepp_info]");
			goto end;
		}
	...
	if(nf_profile->vendor_id) {
		if(cJSON_AddStringToObject(item, "vendorId",
		                           nf_profile->vendor_id) == NULL)
		{
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [vendor_id]");
			goto end;
		}
	}

	if(nf_profile->supported_vendor_specific_features) {
		cJSON *supported_vendor_specific_features =
			cJSON_AddObjectToObject(item,
			                        "supportedVendorSpecificFeatures");
		if(supported_vendor_specific_features == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [supported_vendor_specific_features]");
			goto end;
		}
		...
		if(nf_profile->supported_vendor_specific_features) {
			OpenAPI_list_for_each(
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_vendor_specific_feature_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->aanf_info_list) {
		cJSON *aanf_info_list = cJSON_AddObjectToObject(item,
		                                                "aanfInfoList");
		if(aanf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [aanf_info_list]");
			goto end;
		}
		cJSON *localMapObject = aanf_info_list;
		if(nf_profile->aanf_info_list) {
			OpenAPI_list_for_each(nf_profile->aanf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_aanf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->_5g_ddnmf_info) {
		cJSON *_5g_ddnmf_info_local_JSON =
			OpenAPI_model_5_g_ddnmf_info_convertToJSON(
				nf_profile->_5g_ddnmf_info);
		if(_5g_ddnmf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [_5g_ddnmf_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "5gDdnmfInfo",
		                      _5g_ddnmf_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [_5g_ddnmf_info]");
			goto end;
	...
	if(nf_profile->mfaf_info) {
		cJSON *mfaf_info_local_JSON =
			OpenAPI_mfaf_info_convertToJSON(nf_profile->mfaf_info);
		if(mfaf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [mfaf_info]");
			goto end;
		}
	...
	if(nf_profile->easdf_info_list) {
		cJSON *easdf_info_list = cJSON_AddObjectToObject(item,
		                                                 "easdfInfoList");
		if(easdf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [easdf_info_list]");
			goto end;
		}
		cJSON *localMapObject = easdf_info_list;
		if(nf_profile->easdf_info_list) {
			OpenAPI_list_for_each(nf_profile->easdf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_easdf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->dccf_info) {
		cJSON *dccf_info_local_JSON =
			OpenAPI_dccf_info_convertToJSON(nf_profile->dccf_info);
		if(dccf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [dccf_info]");
			goto end;
		}
	...
	if(nf_profile->nsacf_info_list) {
		cJSON *nsacf_info_list = cJSON_AddObjectToObject(item,
		                                                 "nsacfInfoList");
		if(nsacf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nsacf_info_list]");
			goto end;
		}
		cJSON *localMapObject = nsacf_info_list;
		if(nf_profile->nsacf_info_list) {
			OpenAPI_list_for_each(nf_profile->nsacf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_nsacf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->mb_smf_info_list) {
		cJSON *mb_smf_info_list = cJSON_AddObjectToObject(item,
		                                                  "mbSmfInfoList");
		if(mb_smf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [mb_smf_info_list]");
			goto end;
		}
		...
		if(nf_profile->mb_smf_info_list) {
			OpenAPI_list_for_each(nf_profile->mb_smf_info_list,
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_mb_smf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->tsctsf_info_list) {
		cJSON *tsctsf_info_list = cJSON_AddObjectToObject(item,
		                                                  "tsctsfInfoList");
		if(tsctsf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [tsctsf_info_list]");
			goto end;
		}
		cJSON *localMapObject = tsctsf_info_list;
		if(nf_profile->tsctsf_info_list) {
			OpenAPI_list_for_each(nf_profile->tsctsf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_tsctsf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->mb_upf_info_list) {
		cJSON *mb_upf_info_list = cJSON_AddObjectToObject(item,
		                                                  "mbUpfInfoList");
		if(mb_upf_info_list == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [mb_upf_info_list]");
			goto end;
		}
		cJSON *localMapObject = mb_upf_info_list;
		if(nf_profile->mb_upf_info_list) {
			OpenAPI_list_for_each(nf_profile->mb_upf_info_list,
			                      node) {
				OpenAPI_map_t *localKeyValue =
					(OpenAPI_map_t *) node->data;
				if(localKeyValue == NULL) {
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_mb_upf_info_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	...
	if(nf_profile->trust_af_info) {
		cJSON *trust_af_info_local_JSON =
			OpenAPI_trust_af_info_convertToJSON(
				nf_profile->trust_af_info);
		if(trust_af_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [trust_af_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "trustAfInfo",
		                      trust_af_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [trust_af_info]");
			goto end;
	...
	if(nf_profile->nssaaf_info) {
		cJSON *nssaaf_info_local_JSON =
			OpenAPI_nssaaf_info_convertToJSON(
				nf_profile->nssaaf_info);
		if(nssaaf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nssaaf_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "nssaafInfo",
		                      nssaaf_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [nssaaf_info]");
			goto end;
	...
	if(nf_profile->hni_list) {
		...
		if(hni_listList == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [hni_list]");
			goto end;
		}
		OpenAPI_list_for_each(nf_profile->hni_list, node) {
			if(cJSON_AddStringToObject(hni_listList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nf_profile_convertToJSON() failed [hni_list]");
	...
	if(nf_profile->iwmsc_info) {
		cJSON *iwmsc_info_local_JSON =
			OpenAPI_iwmsc_info_convertToJSON(
				nf_profile->iwmsc_info);
		if(iwmsc_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [iwmsc_info]");
			goto end;
		}
	...
	if(nf_profile->mnpf_info) {
		cJSON *mnpf_info_local_JSON =
			OpenAPI_mnpf_info_convertToJSON(nf_profile->mnpf_info);
		if(mnpf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_profile_convertToJSON() failed [mnpf_info]");
			goto end;
		}
...
OpenAPI_nf_profile_t *OpenAPI_nf_profile_parseFromJSON(cJSON *nf_profileJSON) {
	...
	nf_instance_id = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "nfInstanceId");
	if(!nf_instance_id) {
		ogs_error(
			"OpenAPI_nf_profile_parseFromJSON() failed [nf_instance_id]");
		goto end;
	}
	...
	nf_instance_name = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "nfInstanceName");
	if(nf_instance_name) {
		if(!cJSON_IsString(nf_instance_name) &&
		   !cJSON_IsNull(nf_instance_name))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_instance_name]");
			goto end;
		}
	}
	...
	if(!nf_type) {
		ogs_error(
			"OpenAPI_nf_profile_parseFromJSON() failed [nf_type]");
		goto end;
	}
	...
	nf_status = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "nfStatus");
	if(!nf_status) {
		ogs_error(
			"OpenAPI_nf_profile_parseFromJSON() failed [nf_status]");
		goto end;
	}
	...
	nf_statusVariable =
		OpenAPI_nf_status_FromString(nf_status->valuestring);

	collocated_nf_instances =
		cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	...
	if(collocated_nf_instances) {
		...
		if(!cJSON_IsArray(collocated_nf_instances)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [collocated_nf_instances]");
			goto end;
		}

		collocated_nf_instancesList = OpenAPI_list_create();

		cJSON_ArrayForEach(collocated_nf_instances_local,
		                   collocated_nf_instances) {
			...
			OpenAPI_collocated_nf_instance_t *
				...
				OpenAPI_collocated_nf_instance_parseFromJSON(
					collocated_nf_instances_local);
			if(!collocated_nf_instancesItem) {
				ogs_error("No collocated_nf_instancesItem");
				goto end;
			}
			OpenAPI_list_add(collocated_nf_instancesList,
			                 collocated_nf_instancesItem);
		}
	}

	heart_beat_timer = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "heartBeatTimer");
	if(heart_beat_timer) {
		if(!cJSON_IsNumber(heart_beat_timer)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [heart_beat_timer]");
			goto end;
		}
	}

	plmn_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "plmnList");
	if(plmn_list) {
		...
		cJSON_ArrayForEach(plmn_list_local, plmn_list) {
			...
			OpenAPI_plmn_id_t *plmn_listItem =
				OpenAPI_plmn_id_parseFromJSON(plmn_list_local);
			if(!plmn_listItem) {
	...
	snpn_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "snpnList");
	if(snpn_list) {
		cJSON *snpn_list_local = NULL;
		if(!cJSON_IsArray(snpn_list)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [snpn_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(snpn_list_local, snpn_list) {
			...
			OpenAPI_plmn_id_nid_t *snpn_listItem =
	...
	if(s_nssais) {
		...
		if(!cJSON_IsArray(s_nssais)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [s_nssais]");
			goto end;
		}
		...
		cJSON_ArrayForEach(s_nssais_local, s_nssais) {
			...
			OpenAPI_ext_snssai_t *s_nssaisItem =
	...
	per_plmn_snssai_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                        "perPlmnSnssaiList");
	if(per_plmn_snssai_list) {
		cJSON *per_plmn_snssai_list_local = NULL;
		if(!cJSON_IsArray(per_plmn_snssai_list)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [per_plmn_snssai_list]");
			goto end;
		}

		per_plmn_snssai_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(per_plmn_snssai_list_local,
			...
			OpenAPI_plmn_snssai_t *per_plmn_snssai_listItem =
				OpenAPI_plmn_snssai_parseFromJSON(
					per_plmn_snssai_list_local);
			if(!per_plmn_snssai_listItem) {
				ogs_error("No per_plmn_snssai_listItem");
				goto end;
			}
			OpenAPI_list_add(per_plmn_snssai_listList,
			                 per_plmn_snssai_listItem);
		}
	}
	...
	if(nsi_list) {
		...
		if(!cJSON_IsArray(nsi_list)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nsi_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nsi_list_local, nsi_list) {
			...
			OpenAPI_list_add(nsi_listList,
			                 ogs_strdup(
						 nsi_list_local->valuestring));
		}
	}
	...
	if(fqdn) {
		...
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [fqdn]");
			goto end;
		}
	}

	inter_plmn_fqdn = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "interPlmnFqdn");
	if(inter_plmn_fqdn) {
		if(!cJSON_IsString(inter_plmn_fqdn) &&
		   !cJSON_IsNull(inter_plmn_fqdn))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [inter_plmn_fqdn]");
			goto end;
		}
	}

	ipv4_addresses = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "ipv4Addresses");
	if(ipv4_addresses) {
		cJSON *ipv4_addresses_local = NULL;
		if(!cJSON_IsArray(ipv4_addresses)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [ipv4_addresses]");
			goto end;
		}
		...
		cJSON_ArrayForEach(ipv4_addresses_local, ipv4_addresses) {
			...
			OpenAPI_list_add(ipv4_addressesList,
			                 ogs_strdup(
						 ipv4_addresses_local->
						 valuestring));
		}
	}

	ipv6_addresses = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "ipv6Addresses");
	if(ipv6_addresses) {
		...
		cJSON_ArrayForEach(ipv6_addresses_local, ipv6_addresses) {
			...
			OpenAPI_list_add(ipv6_addressesList,
			                 ogs_strdup(
	...
	allowed_plmns = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "allowedPlmns");
	if(allowed_plmns) {
		cJSON *allowed_plmns_local = NULL;
		if(!cJSON_IsArray(allowed_plmns)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [allowed_plmns]");
			goto end;
		}
		...
		cJSON_ArrayForEach(allowed_plmns_local, allowed_plmns) {
			...
			OpenAPI_plmn_id_t *allowed_plmnsItem =
				OpenAPI_plmn_id_parseFromJSON(
					allowed_plmns_local);
	...
	allowed_snpns = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "allowedSnpns");
	if(allowed_snpns) {
		cJSON *allowed_snpns_local = NULL;
		if(!cJSON_IsArray(allowed_snpns)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [allowed_snpns]");
			goto end;
		}
		...
		cJSON_ArrayForEach(allowed_snpns_local, allowed_snpns) {
			...
			OpenAPI_plmn_id_nid_t *allowed_snpnsItem =
				OpenAPI_plmn_id_nid_parseFromJSON(
					allowed_snpns_local);
	...
	allowed_nf_types = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "allowedNfTypes");
	if(allowed_nf_types) {
		cJSON *allowed_nf_types_local = NULL;
		if(!cJSON_IsArray(allowed_nf_types)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [allowed_nf_types]");
			goto end;
		}
		...
		cJSON_ArrayForEach(allowed_nf_types_local, allowed_nf_types) {
			...
			localEnum =
				OpenAPI_nf_type_FromString(
					allowed_nf_types_local->valuestring);
			if(!localEnum) {
				ogs_info(
					"Enum value \"%s\" for field \"allowed_nf_types\" is not supported. Ignoring it ...",
					allowed_nf_types_local->valuestring);
			} else {
				OpenAPI_list_add(allowed_nf_typesList,
				                 (void *) localEnum);
			}
		}
		if(allowed_nf_typesList->count == 0) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed: Expected allowed_nf_typesList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}

	allowed_nf_domains = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                      "allowedNfDomains");
	if(allowed_nf_domains) {
		cJSON *allowed_nf_domains_local = NULL;
		if(!cJSON_IsArray(allowed_nf_domains)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [allowed_nf_domains]");
			goto end;
		}

		allowed_nf_domainsList = OpenAPI_list_create();

		cJSON_ArrayForEach(allowed_nf_domains_local,
		                   allowed_nf_domains) {
			double *localDouble = NULL;
			int *localInt = NULL;
			...
			OpenAPI_list_add(allowed_nf_domainsList,
			                 ogs_strdup(
						 allowed_nf_domains_local->
						 valuestring));
		}
	}

	allowed_nssais = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "allowedNssais");
	if(allowed_nssais) {
		cJSON *allowed_nssais_local = NULL;
		if(!cJSON_IsArray(allowed_nssais)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [allowed_nssais]");
			goto end;
		}
		...
		cJSON_ArrayForEach(allowed_nssais_local, allowed_nssais) {
			...
			OpenAPI_ext_snssai_t *allowed_nssaisItem =
				OpenAPI_ext_snssai_parseFromJSON(
					allowed_nssais_local);
			if(!allowed_nssaisItem) {
				ogs_error("No allowed_nssaisItem");
				goto end;
			}
			OpenAPI_list_add(allowed_nssaisList,
			                 allowed_nssaisItem);
		}
	}
	...
	if(priority) {
		if(!cJSON_IsNumber(priority)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [priority]");
			goto end;
		}
	}
	...
	if(capacity) {
		if(!cJSON_IsNumber(capacity)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [capacity]");
			goto end;
		}
	}
	...
	if(load) {
		if(!cJSON_IsNumber(load)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [load]");
			goto end;
		}
	}

	load_time_stamp = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "loadTimeStamp");
	if(load_time_stamp) {
		if(!cJSON_IsString(load_time_stamp) &&
		   !cJSON_IsNull(load_time_stamp))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [load_time_stamp]");
			goto end;
		}
	}
	...
	if(locality) {
		if(!cJSON_IsString(locality) &&
		   !cJSON_IsNull(locality))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [locality]");
			goto end;
		}
	}
	...
	if(udr_info) {
		udr_info_local_nonprim =
			OpenAPI_udr_info_parseFromJSON(udr_info);
		if(!udr_info_local_nonprim) {
			ogs_error(
				"OpenAPI_udr_info_parseFromJSON failed [udr_info]");
			goto end;
		}
	}

	udr_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "udrInfoList");
	if(udr_info_list) {
		cJSON *udr_info_list_local_map = NULL;
		if(!cJSON_IsObject(udr_info_list) &&
		   !cJSON_IsNull(udr_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [udr_info_list]");
			goto end;
		}
		if(cJSON_IsObject(udr_info_list)) {
			udr_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(udr_info_list_local_map,
			                   udr_info_list) {
				...
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						...
						OpenAPI_udr_info_parseFromJSON(
							localMapObject));
					...
					ogs_error(
						"OpenAPI_nf_profile_parseFromJSON() failed [inner]");
					goto end;
				}
				OpenAPI_list_add(udr_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(udm_info) {
		udm_info_local_nonprim =
			OpenAPI_udm_info_parseFromJSON(udm_info);
		if(!udm_info_local_nonprim) {
			ogs_error(
				"OpenAPI_udm_info_parseFromJSON failed [udm_info]");
			goto end;
		}
	}

	udm_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "udmInfoList");
	if(udm_info_list) {
		cJSON *udm_info_list_local_map = NULL;
		if(!cJSON_IsObject(udm_info_list) &&
		   !cJSON_IsNull(udm_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [udm_info_list]");
			goto end;
		}
		if(cJSON_IsObject(udm_info_list)) {
			udm_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(udm_info_list_local_map,
			                   udm_info_list) {
	...
	ausf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "ausfInfo");
	if(ausf_info) {
		ausf_info_local_nonprim =
			OpenAPI_ausf_info_parseFromJSON(ausf_info);
		if(!ausf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_ausf_info_parseFromJSON failed [ausf_info]");
			goto end;
		}
	}

	ausf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "ausfInfoList");
	if(ausf_info_list) {
		cJSON *ausf_info_list_local_map = NULL;
		if(!cJSON_IsObject(ausf_info_list) &&
		   !cJSON_IsNull(ausf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [ausf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(ausf_info_list)) {
			ausf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(ausf_info_list_local_map,
			                   ausf_info_list) {
				cJSON *localMapObject =
					ausf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
				...
				OpenAPI_list_add(ausf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(amf_info) {
		amf_info_local_nonprim =
			OpenAPI_amf_info_parseFromJSON(amf_info);
		if(!amf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_amf_info_parseFromJSON failed [amf_info]");
			goto end;
		}
	}

	amf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "amfInfoList");
	if(amf_info_list) {
		cJSON *amf_info_list_local_map = NULL;
		if(!cJSON_IsObject(amf_info_list) &&
		   !cJSON_IsNull(amf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [amf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(amf_info_list)) {
			...
			cJSON_ArrayForEach(amf_info_list_local_map,
				...
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_amf_info_parseFromJSON(
							localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(amf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(smf_info) {
		smf_info_local_nonprim =
			OpenAPI_smf_info_parseFromJSON(smf_info);
		if(!smf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_smf_info_parseFromJSON failed [smf_info]");
			goto end;
		}
	}

	smf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "smfInfoList");
	if(smf_info_list) {
		cJSON *smf_info_list_local_map = NULL;
		if(!cJSON_IsObject(smf_info_list) &&
		   !cJSON_IsNull(smf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [smf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(smf_info_list)) {
			smf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(smf_info_list_local_map,
			                   smf_info_list) {
				...
				OpenAPI_list_add(smf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(upf_info) {
		upf_info_local_nonprim =
			OpenAPI_upf_info_parseFromJSON(upf_info);
		if(!upf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_upf_info_parseFromJSON failed [upf_info]");
			goto end;
		}
	}

	upf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "upfInfoList");
	if(upf_info_list) {
		cJSON *upf_info_list_local_map = NULL;
		if(!cJSON_IsObject(upf_info_list) &&
		   !cJSON_IsNull(upf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [upf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(upf_info_list)) {
			...
			cJSON_ArrayForEach(upf_info_list_local_map,
				...
				OpenAPI_list_add(upf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(pcf_info) {
		pcf_info_local_nonprim =
			OpenAPI_pcf_info_parseFromJSON(pcf_info);
		if(!pcf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_pcf_info_parseFromJSON failed [pcf_info]");
			goto end;
		}
	}

	pcf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "pcfInfoList");
	if(pcf_info_list) {
		cJSON *pcf_info_list_local_map = NULL;
		if(!cJSON_IsObject(pcf_info_list) &&
		   !cJSON_IsNull(pcf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [pcf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(pcf_info_list)) {
			pcf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(pcf_info_list_local_map,
			                   pcf_info_list) {
				...
				OpenAPI_list_add(pcf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(bsf_info) {
		bsf_info_local_nonprim =
			OpenAPI_bsf_info_parseFromJSON(bsf_info);
		if(!bsf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_bsf_info_parseFromJSON failed [bsf_info]");
			goto end;
		}
	}

	bsf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "bsfInfoList");
	if(bsf_info_list) {
		cJSON *bsf_info_list_local_map = NULL;
		if(!cJSON_IsObject(bsf_info_list) &&
		   !cJSON_IsNull(bsf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [bsf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(bsf_info_list)) {
			bsf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(bsf_info_list_local_map,
			                   bsf_info_list) {
				...
				OpenAPI_list_add(bsf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(chf_info) {
		chf_info_local_nonprim =
			OpenAPI_chf_info_parseFromJSON(chf_info);
		if(!chf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_chf_info_parseFromJSON failed [chf_info]");
			goto end;
		}
	}

	chf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "chfInfoList");
	if(chf_info_list) {
		cJSON *chf_info_list_local_map = NULL;
		if(!cJSON_IsObject(chf_info_list) &&
		   !cJSON_IsNull(chf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [chf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(chf_info_list)) {
			chf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(chf_info_list_local_map,
			                   chf_info_list) {
				...
				OpenAPI_list_add(chf_info_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(nef_info) {
		nef_info_local_nonprim =
			OpenAPI_nef_info_parseFromJSON(nef_info);
		if(!nef_info_local_nonprim) {
			ogs_error(
				"OpenAPI_nef_info_parseFromJSON failed [nef_info]");
			goto end;
		}
	}
	...
	if(nrf_info) {
		nrf_info_local_nonprim =
			OpenAPI_nrf_info_parseFromJSON(nrf_info);
		if(!nrf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_nrf_info_parseFromJSON failed [nrf_info]");
			goto end;
		}
	}

	udsf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "udsfInfo");
	if(udsf_info) {
		udsf_info_local_nonprim =
			OpenAPI_udsf_info_parseFromJSON(udsf_info);
		if(!udsf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_udsf_info_parseFromJSON failed [udsf_info]");
			goto end;
		}
	}

	udsf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "udsfInfoList");
	if(udsf_info_list) {
		cJSON *udsf_info_list_local_map = NULL;
		if(!cJSON_IsObject(udsf_info_list) &&
		   !cJSON_IsNull(udsf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [udsf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(udsf_info_list)) {
			udsf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(udsf_info_list_local_map,
			                   udsf_info_list) {
				cJSON *localMapObject =
					udsf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_udsf_info_parseFromJSON(
							localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(udsf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	nwdaf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                              "nwdafInfo");
	if(nwdaf_info) {
		nwdaf_info_local_nonprim =
			OpenAPI_nwdaf_info_parseFromJSON(nwdaf_info);
		if(!nwdaf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_nwdaf_info_parseFromJSON failed [nwdaf_info]");
			goto end;
		}
	}

	nwdaf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "nwdafInfoList");
	if(nwdaf_info_list) {
		cJSON *nwdaf_info_list_local_map = NULL;
		if(!cJSON_IsObject(nwdaf_info_list) &&
		   !cJSON_IsNull(nwdaf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nwdaf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(nwdaf_info_list)) {
			nwdaf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(nwdaf_info_list_local_map,
			                   nwdaf_info_list) {
				cJSON *localMapObject =
					nwdaf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_nwdaf_info_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(nwdaf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	pcscf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "pcscfInfoList");
	if(pcscf_info_list) {
		cJSON *pcscf_info_list_local_map = NULL;
		if(!cJSON_IsObject(pcscf_info_list) &&
		   !cJSON_IsNull(pcscf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [pcscf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(pcscf_info_list)) {
			pcscf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(pcscf_info_list_local_map,
			                   pcscf_info_list) {
				cJSON *localMapObject =
					pcscf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
				...
				OpenAPI_list_add(pcscf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	hss_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "hssInfoList");
	if(hss_info_list) {
		cJSON *hss_info_list_local_map = NULL;
		if(!cJSON_IsObject(hss_info_list) &&
		   !cJSON_IsNull(hss_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [hss_info_list]");
			goto end;
		}
		if(cJSON_IsObject(hss_info_list)) {
			...
			cJSON_ArrayForEach(hss_info_list_local_map,
				...
				OpenAPI_list_add(hss_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	custom_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                               "customInfo");
	if(custom_info) {
		if(!cJSON_IsObject(custom_info)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [custom_info]");
			goto end;
		}
		custom_info_local_object =
			OpenAPI_object_parseFromJSON(custom_info);
	}

	recovery_time = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "recoveryTime");
	if(recovery_time) {
		if(!cJSON_IsString(recovery_time) &&
		   !cJSON_IsNull(recovery_time))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [recovery_time]");
			goto end;
		}
	}
	...
	if(nf_service_persistence) {
		if(!cJSON_IsBool(nf_service_persistence)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_service_persistence]");
			goto end;
		}
	}

	nf_services = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                               "nfServices");
	if(nf_services) {
		cJSON *nf_services_local = NULL;
		if(!cJSON_IsArray(nf_services)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_services]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nf_services_local, nf_services) {
			...
			OpenAPI_nf_service_t *nf_servicesItem =
	...
	nf_service_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "nfServiceList");
	if(nf_service_list) {
		cJSON *nf_service_list_local_map = NULL;
		if(!cJSON_IsObject(nf_service_list) &&
		   !cJSON_IsNull(nf_service_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_service_list]");
			goto end;
		}
		if(cJSON_IsObject(nf_service_list)) {
			nf_service_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(nf_service_list_local_map,
			                   nf_service_list) {
				cJSON *localMapObject =
					nf_service_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
				...
				OpenAPI_list_add(nf_service_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(nf_profile_changes_support_ind) {
		if(!cJSON_IsBool(nf_profile_changes_support_ind)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_profile_changes_support_ind]");
			goto end;
		}
	}
	...
	if(nf_profile_changes_ind) {
		if(!cJSON_IsBool(nf_profile_changes_ind)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_profile_changes_ind]");
			goto end;
		}
	}
	...
	if(default_notification_subscriptions) {
		...
		if(!cJSON_IsArray(default_notification_subscriptions)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [default_notification_subscriptions]");
			goto end;
		}

		default_notification_subscriptionsList = OpenAPI_list_create();

		cJSON_ArrayForEach(default_notification_subscriptions_local,
		                   default_notification_subscriptions) {
			if(!cJSON_IsObject(
				   default_notification_subscriptions_local))
			{
				ogs_error(
					"OpenAPI_nf_profile_parseFromJSON() failed [default_notification_subscriptions]");
				goto end;
			...
			OpenAPI_default_notification_subscription_t *
			        default_notification_subscriptionsItem =
				OpenAPI_default_notification_subscription_parseFromJSON
				(
					default_notification_subscriptions_local);
			if(!default_notification_subscriptionsItem) {
				ogs_error(
					"No default_notification_subscriptionsItem");
				goto end;
			}
			OpenAPI_list_add(default_notification_subscriptionsList,
			                 default_notification_subscriptionsItem);
		}
	}
	...
	if(lmf_info) {
		lmf_info_local_nonprim =
			OpenAPI_lmf_info_parseFromJSON(lmf_info);
		if(!lmf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_lmf_info_parseFromJSON failed [lmf_info]");
			goto end;
		}
	}

	gmlc_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "gmlcInfo");
	if(gmlc_info) {
		gmlc_info_local_nonprim =
			OpenAPI_gmlc_info_parseFromJSON(gmlc_info);
		if(!gmlc_info_local_nonprim) {
			ogs_error(
				"OpenAPI_gmlc_info_parseFromJSON failed [gmlc_info]");
			goto end;
		}
	}

	nf_set_id_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "nfSetIdList");
	if(nf_set_id_list) {
		cJSON *nf_set_id_list_local = NULL;
		if(!cJSON_IsArray(nf_set_id_list)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_set_id_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(nf_set_id_list_local, nf_set_id_list) {
			...
			OpenAPI_list_add(nf_set_id_listList,
			                 ogs_strdup(
						 nf_set_id_list_local->
						 valuestring));
		}
	}

	serving_scope = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "servingScope");
	if(serving_scope) {
		cJSON *serving_scope_local = NULL;
		if(!cJSON_IsArray(serving_scope)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [serving_scope]");
			goto end;
		}
		...
		cJSON_ArrayForEach(serving_scope_local, serving_scope) {
			...
			OpenAPI_list_add(serving_scopeList,
			                 ogs_strdup(
						 serving_scope_local->
						 valuestring));
		}
	...
	lc_h_support_ind = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "lcHSupportInd");
	if(lc_h_support_ind) {
		if(!cJSON_IsBool(lc_h_support_ind)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [lc_h_support_ind]");
			goto end;
		}
	}

	olc_h_support_ind = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                     "olcHSupportInd");
	if(olc_h_support_ind) {
		if(!cJSON_IsBool(olc_h_support_ind)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [olc_h_support_ind]");
			goto end;
		}
	}
	...
	if(nf_set_recovery_time_list) {
		...
		if(!cJSON_IsObject(nf_set_recovery_time_list) &&
		   !cJSON_IsNull(nf_set_recovery_time_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nf_set_recovery_time_list]");
			goto end;
		}
		if(cJSON_IsObject(nf_set_recovery_time_list)) {
			nf_set_recovery_time_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(nf_set_recovery_time_list_local_map,
			                   nf_set_recovery_time_list) {
				cJSON *localMapObject =
					nf_set_recovery_time_list_local_map;
				double *localDouble = NULL;
				int *localInt = NULL;
				OpenAPI_list_add(nf_set_recovery_time_listList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(service_set_recovery_time_list) {
		...
		if(!cJSON_IsObject(service_set_recovery_time_list) &&
		   !cJSON_IsNull(service_set_recovery_time_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [service_set_recovery_time_list]");
			goto end;
		}
		if(cJSON_IsObject(service_set_recovery_time_list)) {
			service_set_recovery_time_listList =
				OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(
				service_set_recovery_time_list_local_map,
				service_set_recovery_time_list) {
				cJSON *localMapObject =
					service_set_recovery_time_list_local_map;
				double *localDouble = NULL;
	...
	scp_domains = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                               "scpDomains");
	if(scp_domains) {
		cJSON *scp_domains_local = NULL;
		if(!cJSON_IsArray(scp_domains)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [scp_domains]");
			goto end;
		}
		...
		cJSON_ArrayForEach(scp_domains_local, scp_domains) {
			...
			OpenAPI_list_add(scp_domainsList,
			                 ogs_strdup(
	...
	if(scp_info) {
		scp_info_local_nonprim =
			OpenAPI_scp_info_parseFromJSON(scp_info);
		if(!scp_info_local_nonprim) {
			ogs_error(
				"OpenAPI_scp_info_parseFromJSON failed [scp_info]");
			goto end;
		}
	}

	sepp_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "seppInfo");
	if(sepp_info) {
		sepp_info_local_nonprim =
			OpenAPI_sepp_info_parseFromJSON(sepp_info);
		if(!sepp_info_local_nonprim) {
			ogs_error(
				"OpenAPI_sepp_info_parseFromJSON failed [sepp_info]");
			goto end;
		}
	}

	vendor_id = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "vendorId");
	if(vendor_id) {
		if(!cJSON_IsString(vendor_id) &&
		   !cJSON_IsNull(vendor_id))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [vendor_id]");
			goto end;
		}
	}
	...
	if(supported_vendor_specific_features) {
		...
		if(!cJSON_IsObject(supported_vendor_specific_features) &&
		   !cJSON_IsNull(supported_vendor_specific_features))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [supported_vendor_specific_features]");
			goto end;
		}
		if(cJSON_IsObject(supported_vendor_specific_features)) {
			supported_vendor_specific_featuresList =
				OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(
				supported_vendor_specific_features_local_map,
				supported_vendor_specific_features) {
				cJSON *localMapObject =
					supported_vendor_specific_features_local_map;
				double *localDouble = NULL;
				...
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_vendor_specific_feature_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
	...
	aanf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "aanfInfoList");
	if(aanf_info_list) {
		cJSON *aanf_info_list_local_map = NULL;
		if(!cJSON_IsObject(aanf_info_list) &&
		   !cJSON_IsNull(aanf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [aanf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(aanf_info_list)) {
			aanf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(aanf_info_list_local_map,
			                   aanf_info_list) {
				cJSON *localMapObject =
					aanf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_aanf_info_parseFromJSON(
							localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(aanf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	_5g_ddnmf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                  "5gDdnmfInfo");
	if(_5g_ddnmf_info) {
		_5g_ddnmf_info_local_nonprim =
			OpenAPI_model_5_g_ddnmf_info_parseFromJSON(
				_5g_ddnmf_info);
		if(!_5g_ddnmf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_model_5_g_ddnmf_info_parseFromJSON failed [_5g_ddnmf_info]");
			goto end;
		}
	}

	mfaf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "mfafInfo");
	if(mfaf_info) {
		mfaf_info_local_nonprim =
			OpenAPI_mfaf_info_parseFromJSON(mfaf_info);
		if(!mfaf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_mfaf_info_parseFromJSON failed [mfaf_info]");
			goto end;
		}
	}

	easdf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "easdfInfoList");
	if(easdf_info_list) {
		cJSON *easdf_info_list_local_map = NULL;
		if(!cJSON_IsObject(easdf_info_list) &&
		   !cJSON_IsNull(easdf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [easdf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(easdf_info_list)) {
			easdf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(easdf_info_list_local_map,
			                   easdf_info_list) {
				cJSON *localMapObject =
					easdf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_easdf_info_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(easdf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	dccf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "dccfInfo");
	if(dccf_info) {
		dccf_info_local_nonprim =
			OpenAPI_dccf_info_parseFromJSON(dccf_info);
		if(!dccf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_dccf_info_parseFromJSON failed [dccf_info]");
			goto end;
		}
	}

	nsacf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                   "nsacfInfoList");
	if(nsacf_info_list) {
		cJSON *nsacf_info_list_local_map = NULL;
		if(!cJSON_IsObject(nsacf_info_list) &&
		   !cJSON_IsNull(nsacf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [nsacf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(nsacf_info_list)) {
			nsacf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(nsacf_info_list_local_map,
			                   nsacf_info_list) {
				cJSON *localMapObject =
					nsacf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_nsacf_info_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(nsacf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	mb_smf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "mbSmfInfoList");
	if(mb_smf_info_list) {
		cJSON *mb_smf_info_list_local_map = NULL;
		if(!cJSON_IsObject(mb_smf_info_list) &&
		   !cJSON_IsNull(mb_smf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [mb_smf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(mb_smf_info_list)) {
			mb_smf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(mb_smf_info_list_local_map,
			                   mb_smf_info_list) {
				cJSON *localMapObject =
					mb_smf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_mb_smf_info_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(mb_smf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	tsctsf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "tsctsfInfoList");
	if(tsctsf_info_list) {
		cJSON *tsctsf_info_list_local_map = NULL;
		if(!cJSON_IsObject(tsctsf_info_list) &&
		   !cJSON_IsNull(tsctsf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [tsctsf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(tsctsf_info_list)) {
			...
			cJSON_ArrayForEach(tsctsf_info_list_local_map,
			                   tsctsf_info_list) {
				cJSON *localMapObject =
					tsctsf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_tsctsf_info_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(tsctsf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	mb_upf_info_list = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                    "mbUpfInfoList");
	if(mb_upf_info_list) {
		cJSON *mb_upf_info_list_local_map = NULL;
		if(!cJSON_IsObject(mb_upf_info_list) &&
		   !cJSON_IsNull(mb_upf_info_list))
		{
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [mb_upf_info_list]");
			goto end;
		}
		if(cJSON_IsObject(mb_upf_info_list)) {
			mb_upf_info_listList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(mb_upf_info_list_local_map,
			                   mb_upf_info_list) {
				cJSON *localMapObject =
					mb_upf_info_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_mb_upf_info_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
				...
				OpenAPI_list_add(mb_upf_info_listList,
				                 localMapKeyPair);
			}
		}
	}

	trust_af_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                                 "trustAfInfo");
	if(trust_af_info) {
		trust_af_info_local_nonprim =
			OpenAPI_trust_af_info_parseFromJSON(trust_af_info);
		if(!trust_af_info_local_nonprim) {
			ogs_error(
				"OpenAPI_trust_af_info_parseFromJSON failed [trust_af_info]");
			goto end;
		}
	}

	nssaaf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                               "nssaafInfo");
	if(nssaaf_info) {
		nssaaf_info_local_nonprim =
			OpenAPI_nssaaf_info_parseFromJSON(nssaaf_info);
		if(!nssaaf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_nssaaf_info_parseFromJSON failed [nssaaf_info]");
			goto end;
		}
	}
	...
	if(hni_list) {
		...
		if(!cJSON_IsArray(hni_list)) {
			ogs_error(
				"OpenAPI_nf_profile_parseFromJSON() failed [hni_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(hni_list_local, hni_list) {
			...
			OpenAPI_list_add(hni_listList,
			                 ogs_strdup(
						 hni_list_local->valuestring));
		}
	}

	iwmsc_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                              "iwmscInfo");
	if(iwmsc_info) {
		iwmsc_info_local_nonprim =
			OpenAPI_iwmsc_info_parseFromJSON(iwmsc_info);
		if(!iwmsc_info_local_nonprim) {
			ogs_error(
				"OpenAPI_iwmsc_info_parseFromJSON failed [iwmsc_info]");
			goto end;
		}
	}

	mnpf_info = cJSON_GetObjectItemCaseSensitive(nf_profileJSON,
	                                             "mnpfInfo");
	if(mnpf_info) {
		mnpf_info_local_nonprim =
			OpenAPI_mnpf_info_parseFromJSON(mnpf_info);
		if(!mnpf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_mnpf_info_parseFromJSON failed [mnpf_info]");
			goto end;
		}
	}
	...
	nf_profile_local_var = OpenAPI_nf_profile_create(
		...
		nf_instance_name &&
		!cJSON_IsNull(nf_instance_name) ?
		ogs_strdup(nf_instance_name->valuestring) : NULL,
		nf_typeVariable,
		nf_statusVariable,
		...
		inter_plmn_fqdn &&
		!cJSON_IsNull(inter_plmn_fqdn) ?
		ogs_strdup(inter_plmn_fqdn->valuestring) : NULL,
		...
		load_time_stamp &&
		!cJSON_IsNull(load_time_stamp) ?
		ogs_strdup(load_time_stamp->valuestring) : NULL,
		locality &&
		!cJSON_IsNull(locality) ? ogs_strdup(locality->valuestring) :
		NULL,
		...
		recovery_time &&
		!cJSON_IsNull(recovery_time) ?
		ogs_strdup(recovery_time->valuestring) : NULL,
		...
		nf_profile_changes_support_ind ?
		nf_profile_changes_support_ind->valueint : 0,
		...
		nf_set_recovery_time_list ? nf_set_recovery_time_listList :
		NULL,
		service_set_recovery_time_list ?
		...
		vendor_id &&
		!cJSON_IsNull(vendor_id) ? ogs_strdup(vendor_id->valuestring) :
		NULL,
		supported_vendor_specific_features ?
	...
	if(default_notification_subscriptionsList) {
		OpenAPI_list_for_each(default_notification_subscriptionsList,
		                      node) {
			OpenAPI_default_notification_subscription_free(
				node->data);
		}
	...
	if(supported_vendor_specific_featuresList) {
		OpenAPI_list_for_each(supported_vendor_specific_featuresList,
		                      node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
...
OpenAPI_nf_profile_t *OpenAPI_nf_profile_copy(OpenAPI_nf_profile_t	*dst,
                                              OpenAPI_nf_profile_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
