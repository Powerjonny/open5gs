...
OpenAPI_edrx_parameters_t *OpenAPI_edrx_parameters_create(
	...
	OpenAPI_edrx_parameters_t *edrx_parameters_local_var =
		ogs_malloc(sizeof(OpenAPI_edrx_parameters_t));
...
cJSON *OpenAPI_edrx_parameters_convertToJSON(
	OpenAPI_edrx_parameters_t *edrx_parameters) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(edrx_parameters == NULL) {
		ogs_error(
			"OpenAPI_edrx_parameters_convertToJSON() failed [EdrxParameters]");
		return NULL;
	}
	...
	if(edrx_parameters->rat_type == OpenAPI_rat_type_NULL) {
		ogs_error(
			"OpenAPI_edrx_parameters_convertToJSON() failed [rat_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "ratType",
	                           OpenAPI_rat_type_ToString(
					   edrx_parameters->rat_type)) == NULL)
	{
		ogs_error(
			"OpenAPI_edrx_parameters_convertToJSON() failed [rat_type]");
		goto end;
	...
	if(!edrx_parameters->edrx_value) {
		ogs_error(
			"OpenAPI_edrx_parameters_convertToJSON() failed [edrx_value]");
		return NULL;
	}
...
OpenAPI_edrx_parameters_t *OpenAPI_edrx_parameters_parseFromJSON(
	cJSON *edrx_parametersJSON) {
	OpenAPI_edrx_parameters_t *edrx_parameters_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *rat_type = NULL;
	OpenAPI_rat_type_e rat_typeVariable = 0;
	cJSON *edrx_value = NULL;
	rat_type = cJSON_GetObjectItemCaseSensitive(edrx_parametersJSON,
	                                            "ratType");
	if(!rat_type) {
		ogs_error(
			"OpenAPI_edrx_parameters_parseFromJSON() failed [rat_type]");
		goto end;
	}
	...
	edrx_value = cJSON_GetObjectItemCaseSensitive(edrx_parametersJSON,
	                                              "edrxValue");
	if(!edrx_value) {
		ogs_error(
			"OpenAPI_edrx_parameters_parseFromJSON() failed [edrx_value]");
		goto end;
	}
...
OpenAPI_edrx_parameters_t *OpenAPI_edrx_parameters_copy(
	OpenAPI_edrx_parameters_t *dst, OpenAPI_edrx_parameters_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
