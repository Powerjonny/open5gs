...
OpenAPI_exception_trend_t *OpenAPI_exception_trend_create() {
	OpenAPI_exception_trend_t *exception_trend_local_var =
		ogs_malloc(sizeof(OpenAPI_exception_trend_t));
...
cJSON *OpenAPI_exception_trend_convertToJSON(
	OpenAPI_exception_trend_t *exception_trend) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(exception_trend == NULL) {
		ogs_error(
			"OpenAPI_exception_trend_convertToJSON() failed [ExceptionTrend]");
		return NULL;
	}
...
OpenAPI_exception_trend_t *OpenAPI_exception_trend_parseFromJSON(
	cJSON *exception_trendJSON) {
...
OpenAPI_exception_trend_t *OpenAPI_exception_trend_copy(
	OpenAPI_exception_trend_t *dst, OpenAPI_exception_trend_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
