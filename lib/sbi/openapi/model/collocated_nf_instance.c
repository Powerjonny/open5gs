...
OpenAPI_collocated_nf_instance_t *OpenAPI_collocated_nf_instance_create(
	...
	OpenAPI_collocated_nf_instance_t *collocated_nf_instance_local_var =
		ogs_malloc(sizeof(OpenAPI_collocated_nf_instance_t));
...
cJSON *OpenAPI_collocated_nf_instance_convertToJSON(
	...
	if(collocated_nf_instance == NULL) {
		ogs_error(
			"OpenAPI_collocated_nf_instance_convertToJSON() failed [CollocatedNfInstance]");
		return NULL;
	}
	...
	if(!collocated_nf_instance->nf_instance_id) {
		ogs_error(
			"OpenAPI_collocated_nf_instance_convertToJSON() failed [nf_instance_id]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "nfInstanceId",
	                           collocated_nf_instance->nf_instance_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_collocated_nf_instance_convertToJSON() failed [nf_instance_id]");
	...
	if(collocated_nf_instance->nf_type == OpenAPI_collocated_nf_type_NULL) {
		ogs_error(
			"OpenAPI_collocated_nf_instance_convertToJSON() failed [nf_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "nfType",
	                           OpenAPI_collocated_nf_type_ToString(
					   collocated_nf_instance->nf_type)) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_collocated_nf_instance_convertToJSON() failed [nf_type]");
...
OpenAPI_collocated_nf_instance_t *OpenAPI_collocated_nf_instance_parseFromJSON(
	...
	nf_instance_id =
		cJSON_GetObjectItemCaseSensitive(collocated_nf_instanceJSON,
		                                 "nfInstanceId");
	if(!nf_instance_id) {
		ogs_error(
			"OpenAPI_collocated_nf_instance_parseFromJSON() failed [nf_instance_id]");
		goto end;
	}
	...
	nf_type = cJSON_GetObjectItemCaseSensitive(collocated_nf_instanceJSON,
	                                           "nfType");
	if(!nf_type) {
		ogs_error(
			"OpenAPI_collocated_nf_instance_parseFromJSON() failed [nf_type]");
		goto end;
	}
	...
	nf_typeVariable =
		OpenAPI_collocated_nf_type_FromString(nf_type->valuestring);

	collocated_nf_instance_local_var =
		OpenAPI_collocated_nf_instance_create(
...
OpenAPI_collocated_nf_instance_t *OpenAPI_collocated_nf_instance_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_collocated_nf_instance_convertToJSON() failed");
		return NULL;
	}
