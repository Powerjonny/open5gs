...
typedef enum { OpenAPI_dccf_cond_CONDITIONTYPE_NULL = 0,
	       OpenAPI_dccf_cond_CONDITIONTYPE_DCCF_COND }
OpenAPI_dccf_cond_condition_type_e;

char * OpenAPI_dccf_cond_condition_type_ToString(
	OpenAPI_dccf_cond_condition_type_e condition_type);

OpenAPI_dccf_cond_condition_type_e OpenAPI_dccf_cond_condition_type_FromString(
	char *condition_type);
