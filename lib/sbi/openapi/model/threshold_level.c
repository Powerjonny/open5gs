...
OpenAPI_threshold_level_t *OpenAPI_threshold_level_create(bool	is_cong_level,
                                                          int	cong_level,
                                                          ...
                                                          float svc_exp_level) {
	OpenAPI_threshold_level_t *threshold_level_local_var =
		ogs_malloc(sizeof(OpenAPI_threshold_level_t));
...
cJSON *OpenAPI_threshold_level_convertToJSON(
	OpenAPI_threshold_level_t *threshold_level) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(threshold_level == NULL) {
		ogs_error(
			"OpenAPI_threshold_level_convertToJSON() failed [ThresholdLevel]");
		return NULL;
	}
	...
	if(threshold_level->is_cong_level) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [cong_level]");
			goto end;
		}
	}
	...
	if(threshold_level->is_nf_load_level) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [nf_load_level]");
			goto end;
		}
	}
	...
	if(threshold_level->is_nf_cpu_usage) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [nf_cpu_usage]");
			goto end;
		}
	}
	...
	if(threshold_level->is_nf_memory_usage) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [nf_memory_usage]");
			goto end;
		}
	}
	...
	if(threshold_level->is_nf_storage_usage) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [nf_storage_usage]");
			goto end;
		}
	}
	...
	if(threshold_level->avg_traffic_rate) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [avg_traffic_rate]");
			goto end;
		}
	}
	...
	if(threshold_level->max_traffic_rate) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [max_traffic_rate]");
			goto end;
		}
	}
	...
	if(threshold_level->is_avg_packet_delay) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [avg_packet_delay]");
			goto end;
		}
	}
	...
	if(threshold_level->is_max_packet_delay) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [max_packet_delay]");
			goto end;
		}
	}
	...
	if(threshold_level->is_avg_packet_loss_rate) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [avg_packet_loss_rate]");
			goto end;
		}
	}
	...
	if(threshold_level->is_svc_exp_level) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_convertToJSON() failed [svc_exp_level]");
			goto end;
		}
	}
...
OpenAPI_threshold_level_t *OpenAPI_threshold_level_parseFromJSON(
	cJSON *threshold_levelJSON) {
	...
	if(cong_level) {
		if(!cJSON_IsNumber(cong_level)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [cong_level]");
			goto end;
		}
	}
	...
	if(nf_load_level) {
		if(!cJSON_IsNumber(nf_load_level)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [nf_load_level]");
			goto end;
		}
	}
	...
	if(nf_cpu_usage) {
		if(!cJSON_IsNumber(nf_cpu_usage)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [nf_cpu_usage]");
			goto end;
		}
	}
	...
	if(nf_memory_usage) {
		if(!cJSON_IsNumber(nf_memory_usage)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [nf_memory_usage]");
			goto end;
		}
	}
	...
	if(nf_storage_usage) {
		if(!cJSON_IsNumber(nf_storage_usage)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [nf_storage_usage]");
			goto end;
		}
	}
	...
	if(avg_traffic_rate) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [avg_traffic_rate]");
			goto end;
		}
	}
	...
	if(max_traffic_rate) {
		...
		{
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [max_traffic_rate]");
			goto end;
		}
	}
	...
	if(avg_packet_delay) {
		if(!cJSON_IsNumber(avg_packet_delay)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [avg_packet_delay]");
			goto end;
		}
	}
	...
	if(max_packet_delay) {
		if(!cJSON_IsNumber(max_packet_delay)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [max_packet_delay]");
			goto end;
		}
	}

	avg_packet_loss_rate =
		cJSON_GetObjectItemCaseSensitive(threshold_levelJSON,
		                                 "avgPacketLossRate");
	if(avg_packet_loss_rate) {
		if(!cJSON_IsNumber(avg_packet_loss_rate)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [avg_packet_loss_rate]");
			goto end;
		}
	}
	...
	if(svc_exp_level) {
		if(!cJSON_IsNumber(svc_exp_level)) {
			ogs_error(
				"OpenAPI_threshold_level_parseFromJSON() failed [svc_exp_level]");
			goto end;
		}
	}
	...
	threshold_level_local_var = OpenAPI_threshold_level_create(
		...
		avg_traffic_rate &&
		!cJSON_IsNull(avg_traffic_rate) ?
		ogs_strdup(avg_traffic_rate->valuestring) : NULL,
		max_traffic_rate &&
		!cJSON_IsNull(max_traffic_rate) ?
		ogs_strdup(max_traffic_rate->valuestring) : NULL,
...
OpenAPI_threshold_level_t *OpenAPI_threshold_level_copy(
	OpenAPI_threshold_level_t *dst, OpenAPI_threshold_level_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
