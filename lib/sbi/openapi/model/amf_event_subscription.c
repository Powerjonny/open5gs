...
OpenAPI_amf_event_subscription_t *OpenAPI_amf_event_subscription_create(
	...
	OpenAPI_amf_event_subscription_t *amf_event_subscription_local_var =
		ogs_malloc(sizeof(OpenAPI_amf_event_subscription_t));
...
void OpenAPI_amf_event_subscription_free(
	OpenAPI_amf_event_subscription_t *amf_event_subscription) {
	...
	if(amf_event_subscription->event_list) {
		OpenAPI_list_for_each(amf_event_subscription->event_list,
		                      node) {
	...
	if(amf_event_subscription->exclude_supi_list) {
		OpenAPI_list_for_each(amf_event_subscription->exclude_supi_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(amf_event_subscription->exclude_gpsi_list) {
		OpenAPI_list_for_each(amf_event_subscription->exclude_gpsi_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(amf_event_subscription->include_supi_list) {
		OpenAPI_list_for_each(amf_event_subscription->include_supi_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(amf_event_subscription->include_gpsi_list) {
		OpenAPI_list_for_each(amf_event_subscription->include_gpsi_list,
		                      node) {
			ogs_free(node->data);
		}
...
cJSON *OpenAPI_amf_event_subscription_convertToJSON(
	OpenAPI_amf_event_subscription_t *amf_event_subscription) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(amf_event_subscription == NULL) {
		ogs_error(
			"OpenAPI_amf_event_subscription_convertToJSON() failed [AmfEventSubscription]");
		return NULL;
	}
	...
	if(!amf_event_subscription->event_list) {
		ogs_error(
			"OpenAPI_amf_event_subscription_convertToJSON() failed [event_list]");
		return NULL;
	}
	...
	if(!amf_event_subscription->event_notify_uri) {
		ogs_error(
			"OpenAPI_amf_event_subscription_convertToJSON() failed [event_notify_uri]");
		return NULL;
	}
	...
	if(!amf_event_subscription->notify_correlation_id) {
		ogs_error(
			"OpenAPI_amf_event_subscription_convertToJSON() failed [notify_correlation_id]");
		return NULL;
	}
	...
	if(!amf_event_subscription->nf_id) {
		ogs_error(
			"OpenAPI_amf_event_subscription_convertToJSON() failed [nf_id]");
		return NULL;
	}
	...
	if(amf_event_subscription->subs_change_notify_uri) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [subs_change_notify_uri]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->subs_change_notify_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [subs_change_notify_correlation_id]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->supi) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->group_id) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [group_id]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->exclude_supi_list) {
		...
		if(exclude_supi_listList == NULL) {
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [exclude_supi_list]");
			goto end;
		}
		OpenAPI_list_for_each(amf_event_subscription->exclude_supi_list,
		                      node) {
	...
	if(amf_event_subscription->exclude_gpsi_list) {
		...
		if(exclude_gpsi_listList == NULL) {
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [exclude_gpsi_list]");
			goto end;
		}
		OpenAPI_list_for_each(amf_event_subscription->exclude_gpsi_list,
		                      node) {
	...
	if(amf_event_subscription->include_supi_list) {
		...
		if(include_supi_listList == NULL) {
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [include_supi_list]");
			goto end;
		}
		OpenAPI_list_for_each(amf_event_subscription->include_supi_list,
		                      node) {
	...
	if(amf_event_subscription->include_gpsi_list) {
		...
		if(include_gpsi_listList == NULL) {
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [include_gpsi_list]");
			goto end;
		}
		OpenAPI_list_for_each(amf_event_subscription->include_gpsi_list,
		                      node) {
	...
	if(amf_event_subscription->gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->pei) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->is_any_ue) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [any_ue]");
			goto end;
		}
	}
	...
	if(amf_event_subscription->options) {
		...
		if(options_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [options]");
			goto end;
		}
	...
	if(amf_event_subscription->source_nf_type != OpenAPI_nf_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_convertToJSON() failed [source_nf_type]");
			goto end;
		}
	}
...
OpenAPI_amf_event_subscription_t *OpenAPI_amf_event_subscription_parseFromJSON(
	...
	if(!event_list) {
		ogs_error(
			"OpenAPI_amf_event_subscription_parseFromJSON() failed [event_list]");
		goto end;
	}
	...
	if(!event_notify_uri) {
		ogs_error(
			"OpenAPI_amf_event_subscription_parseFromJSON() failed [event_notify_uri]");
		goto end;
	}
	...
	if(!notify_correlation_id) {
		ogs_error(
			"OpenAPI_amf_event_subscription_parseFromJSON() failed [notify_correlation_id]");
		goto end;
	}
	...
	if(!nf_id) {
		ogs_error(
			"OpenAPI_amf_event_subscription_parseFromJSON() failed [nf_id]");
		goto end;
	}
	...
	if(subs_change_notify_uri) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [subs_change_notify_uri]");
			goto end;
		}
	}
	...
	if(subs_change_notify_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [subs_change_notify_correlation_id]");
			goto end;
		}
	}
	...
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(group_id) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [group_id]");
			goto end;
		}
	}
	...
	if(exclude_supi_list) {
		...
		if(!cJSON_IsArray(exclude_supi_list)) {
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [exclude_supi_list]");
			goto end;
		}
	...
	if(exclude_gpsi_list) {
		...
		if(!cJSON_IsArray(exclude_gpsi_list)) {
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [exclude_gpsi_list]");
			goto end;
		}
	...
	if(include_supi_list) {
		...
		if(!cJSON_IsArray(include_supi_list)) {
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [include_supi_list]");
			goto end;
		}
	...
	if(include_gpsi_list) {
		...
		if(!cJSON_IsArray(include_gpsi_list)) {
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [include_gpsi_list]");
			goto end;
		}
	...
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}

	pei = cJSON_GetObjectItemCaseSensitive(amf_event_subscriptionJSON,
	                                       "pei");
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(any_ue) {
		if(!cJSON_IsBool(any_ue)) {
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [any_ue]");
			goto end;
		}
	}
	...
	if(source_nf_type) {
		if(!cJSON_IsString(source_nf_type)) {
			ogs_error(
				"OpenAPI_amf_event_subscription_parseFromJSON() failed [source_nf_type]");
			goto end;
		}
	...
	amf_event_subscription_local_var =
...
OpenAPI_amf_event_subscription_t *OpenAPI_amf_event_subscription_copy(
	OpenAPI_amf_event_subscription_t	*dst,
	OpenAPI_amf_event_subscription_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_amf_event_subscription_convertToJSON() failed");
		return NULL;
	}
