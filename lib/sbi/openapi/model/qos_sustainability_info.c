...
OpenAPI_qos_sustainability_info_t *OpenAPI_qos_sustainability_info_create(
	OpenAPI_network_area_info_t *area_info, char *start_ts, char *end_ts,
	OpenAPI_retainability_threshold_t *qos_flow_ret_thd,
	char *ran_ue_throu_thd, OpenAPI_snssai_t *snssai, bool is_confidence,
	int confidence) {
	OpenAPI_qos_sustainability_info_t *qos_sustainability_info_local_var =
		ogs_malloc(sizeof(OpenAPI_qos_sustainability_info_t));
...
void OpenAPI_qos_sustainability_info_free(
	OpenAPI_qos_sustainability_info_t *qos_sustainability_info) {
...
cJSON *OpenAPI_qos_sustainability_info_convertToJSON(
	OpenAPI_qos_sustainability_info_t *qos_sustainability_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(qos_sustainability_info == NULL) {
		ogs_error(
			"OpenAPI_qos_sustainability_info_convertToJSON() failed [QosSustainabilityInfo]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(qos_sustainability_info->area_info) {
		cJSON *area_info_local_JSON =
			OpenAPI_network_area_info_convertToJSON(
				qos_sustainability_info->area_info);
		if(area_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [area_info]");
			goto end;
		}
	...
	if(qos_sustainability_info->start_ts) {
		if(cJSON_AddStringToObject(item, "startTs",
		                           qos_sustainability_info->start_ts) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [start_ts]");
			goto end;
		}
	}
	...
	if(qos_sustainability_info->end_ts) {
		...
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [end_ts]");
			goto end;
		}
	}
	...
	if(qos_sustainability_info->qos_flow_ret_thd) {
		...
		if(qos_flow_ret_thd_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [qos_flow_ret_thd]");
			goto end;
		}
	...
	if(qos_sustainability_info->ran_ue_throu_thd) {
		...
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [ran_ue_throu_thd]");
			goto end;
		}
	}
	...
	if(qos_sustainability_info->snssai) {
		...
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [snssai]");
			goto end;
		}
	...
	if(qos_sustainability_info->is_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_convertToJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_qos_sustainability_info_t *OpenAPI_qos_sustainability_info_parseFromJSON
	...
	OpenAPI_retainability_threshold_t *qos_flow_ret_thd_local_nonprim =
		NULL;
	...
	area_info =
		cJSON_GetObjectItemCaseSensitive(qos_sustainability_infoJSON,
		                                 "areaInfo");
	if(area_info) {
		area_info_local_nonprim =
			OpenAPI_network_area_info_parseFromJSON(area_info);
		if(!area_info_local_nonprim) {
			ogs_error(
				"OpenAPI_network_area_info_parseFromJSON failed [area_info]");
			goto end;
		}
	}

	start_ts = cJSON_GetObjectItemCaseSensitive(qos_sustainability_infoJSON,
	                                            "startTs");
	if(start_ts) {
		...
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_parseFromJSON() failed [start_ts]");
			goto end;
		}
	}
	...
	if(end_ts) {
		...
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_parseFromJSON() failed [end_ts]");
			goto end;
		}
	}
	...
	if(qos_flow_ret_thd) {
		...
		if(!qos_flow_ret_thd_local_nonprim) {
			ogs_error(
				"OpenAPI_retainability_threshold_parseFromJSON failed [qos_flow_ret_thd]");
			goto end;
		}
	}
	...
	if(ran_ue_throu_thd) {
		...
		{
			ogs_error(
				"OpenAPI_qos_sustainability_info_parseFromJSON() failed [ran_ue_throu_thd]");
			goto end;
		}
	}
	...
	if(confidence) {
		if(!cJSON_IsNumber(confidence)) {
			ogs_error(
				"OpenAPI_qos_sustainability_info_parseFromJSON() failed [confidence]");
			goto end;
		}
	}

	qos_sustainability_info_local_var =
		OpenAPI_qos_sustainability_info_create(
			...
			qos_flow_ret_thd ? qos_flow_ret_thd_local_nonprim :
			NULL,
			ran_ue_throu_thd &&
			!cJSON_IsNull(ran_ue_throu_thd) ?
			ogs_strdup(ran_ue_throu_thd->valuestring) : NULL,
...
OpenAPI_qos_sustainability_info_t *OpenAPI_qos_sustainability_info_copy(
	OpenAPI_qos_sustainability_info_t	*dst,
	OpenAPI_qos_sustainability_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_qos_sustainability_info_convertToJSON() failed");
		return NULL;
	}
