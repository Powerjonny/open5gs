...
OpenAPI_amf_event_trigger_t *OpenAPI_amf_event_trigger_create() {
	OpenAPI_amf_event_trigger_t *amf_event_trigger_local_var =
		ogs_malloc(sizeof(OpenAPI_amf_event_trigger_t));
...
void OpenAPI_amf_event_trigger_free(
	OpenAPI_amf_event_trigger_t *amf_event_trigger) {
...
cJSON *OpenAPI_amf_event_trigger_convertToJSON(
	OpenAPI_amf_event_trigger_t *amf_event_trigger) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(amf_event_trigger == NULL) {
		ogs_error(
			"OpenAPI_amf_event_trigger_convertToJSON() failed [AmfEventTrigger]");
		return NULL;
	}
...
OpenAPI_amf_event_trigger_t *OpenAPI_amf_event_trigger_parseFromJSON(
...
OpenAPI_amf_event_trigger_t *OpenAPI_amf_event_trigger_copy(
	OpenAPI_amf_event_trigger_t *dst, OpenAPI_amf_event_trigger_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
