...
OpenAPI_horizontal_with_vertical_velocity_create(float h_speed, int bearing,
                                                 float v_speed,
                                                 OpenAPI_vertical_direction_e
                                                 v_direction) {
	OpenAPI_horizontal_with_vertical_velocity_t *
	        horizontal_with_vertical_velocity_local_var =
		ogs_malloc(sizeof(OpenAPI_horizontal_with_vertical_velocity_t));
...
void OpenAPI_horizontal_with_vertical_velocity_free(
	OpenAPI_horizontal_with_vertical_velocity_t *
...
cJSON *OpenAPI_horizontal_with_vertical_velocity_convertToJSON(
	OpenAPI_horizontal_with_vertical_velocity_t *
	horizontal_with_vertical_velocity) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(horizontal_with_vertical_velocity == NULL) {
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [HorizontalWithVerticalVelocity]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [h_speed]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [bearing]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [v_speed]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed [v_direction]");
		return NULL;
	}
...
OpenAPI_horizontal_with_vertical_velocity_t *
OpenAPI_horizontal_with_vertical_velocity_parseFromJSON(
	...
	if(!h_speed) {
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [h_speed]");
		goto end;
	}
	...
	if(!bearing) {
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [bearing]");
		goto end;
	}
	...
	if(!v_speed) {
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [v_speed]");
		goto end;
	}
	...
	if(!v_direction) {
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_parseFromJSON() failed [v_direction]");
		goto end;
	}
	...
	horizontal_with_vertical_velocity_local_var =
		OpenAPI_horizontal_with_vertical_velocity_create(
...
OpenAPI_horizontal_with_vertical_velocity_t *
OpenAPI_horizontal_with_vertical_velocity_copy(
	OpenAPI_horizontal_with_vertical_velocity_t	*dst,
	OpenAPI_horizontal_with_vertical_velocity_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_horizontal_with_vertical_velocity_convertToJSON() failed");
		return NULL;
	}
