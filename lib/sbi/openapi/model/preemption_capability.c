...
char * OpenAPI_preemption_capability_ToString(
	...
	const char *preemption_capabilityArray[] = { "NULL", "NOT_PREEMPT",
		                                     "MAY_PREEMPT" };
	size_t sizeofArray = sizeof(preemption_capabilityArray) /
	                     sizeof(preemption_capabilityArray[0]);
...
OpenAPI_preemption_capability_e OpenAPI_preemption_capability_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(preemption_capability,
		          preemption_capabilityArray[stringToReturn]) == 0) {
