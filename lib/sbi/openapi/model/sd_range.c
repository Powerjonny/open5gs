...
OpenAPI_sd_range_t *OpenAPI_sd_range_create(char *start, char *end) {
	OpenAPI_sd_range_t *sd_range_local_var =
		ogs_malloc(sizeof(OpenAPI_sd_range_t));
...
cJSON *OpenAPI_sd_range_convertToJSON(OpenAPI_sd_range_t *sd_range) {
	...
	if(sd_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_sd_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(sd_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_sd_range_convertToJSON() failed [end]");
			goto end;
		}
	}
...
OpenAPI_sd_range_t *OpenAPI_sd_range_parseFromJSON(cJSON *sd_rangeJSON) {
	...
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_sd_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_sd_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
