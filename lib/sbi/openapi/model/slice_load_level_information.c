...
OpenAPI_slice_load_level_information_create(
	...
	OpenAPI_slice_load_level_information_t *
		...
		ogs_malloc(sizeof(OpenAPI_slice_load_level_information_t));
...
void OpenAPI_slice_load_level_information_free(
	OpenAPI_slice_load_level_information_t *slice_load_level_information) {
	...
	if(slice_load_level_information->snssais) {
		OpenAPI_list_for_each(slice_load_level_information->snssais,
		                      node) {
...
cJSON *OpenAPI_slice_load_level_information_convertToJSON(
	OpenAPI_slice_load_level_information_t *slice_load_level_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(slice_load_level_information == NULL) {
		ogs_error(
			"OpenAPI_slice_load_level_information_convertToJSON() failed [SliceLoadLevelInformation]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_slice_load_level_information_convertToJSON() failed [load_level_information]");
		goto end;
	}

	if(!slice_load_level_information->snssais) {
		ogs_error(
			"OpenAPI_slice_load_level_information_convertToJSON() failed [snssais]");
		return NULL;
	}
...
OpenAPI_slice_load_level_information_parseFromJSON(
	...
	OpenAPI_slice_load_level_information_t *
	        slice_load_level_information_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	load_level_information =
		cJSON_GetObjectItemCaseSensitive(
			slice_load_level_informationJSON,
			"loadLevelInformation");
	if(!load_level_information) {
		ogs_error(
			"OpenAPI_slice_load_level_information_parseFromJSON() failed [load_level_information]");
		goto end;
	}
	...
	if(!snssais) {
		ogs_error(
			"OpenAPI_slice_load_level_information_parseFromJSON() failed [snssais]");
		goto end;
	}
...
OpenAPI_slice_load_level_information_copy(
	OpenAPI_slice_load_level_information_t	*dst,
	OpenAPI_slice_load_level_information_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_slice_load_level_information_convertToJSON() failed");
		return NULL;
	}
