...
OpenAPI_trigger_request_t *OpenAPI_trigger_request_create(
	...
	OpenAPI_pcscf_address_t
	        *failed_pcscf) {
	OpenAPI_trigger_request_t *trigger_request_local_var =
		ogs_malloc(sizeof(OpenAPI_trigger_request_t));
...
cJSON *OpenAPI_trigger_request_convertToJSON(
	OpenAPI_trigger_request_t *trigger_request) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(trigger_request == NULL) {
		ogs_error(
			"OpenAPI_trigger_request_convertToJSON() failed [TriggerRequest]");
		return NULL;
	}
	...
	if(!trigger_request->supi) {
		ogs_error(
			"OpenAPI_trigger_request_convertToJSON() failed [supi]");
		return NULL;
	}
	...
	if(trigger_request->failed_pcscf) {
		cJSON *failed_pcscf_local_JSON =
			OpenAPI_pcscf_address_convertToJSON(
				trigger_request->failed_pcscf);
		if(failed_pcscf_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_trigger_request_convertToJSON() failed [failed_pcscf]");
			goto end;
		}
...
OpenAPI_trigger_request_t *OpenAPI_trigger_request_parseFromJSON(
	cJSON *trigger_requestJSON) {
	...
	if(!supi) {
		ogs_error(
			"OpenAPI_trigger_request_parseFromJSON() failed [supi]");
		goto end;
	}
	...
	failed_pcscf = cJSON_GetObjectItemCaseSensitive(trigger_requestJSON,
	                                                "failedPcscf");
	if(failed_pcscf) {
...
OpenAPI_trigger_request_t *OpenAPI_trigger_request_copy(
	OpenAPI_trigger_request_t *dst, OpenAPI_trigger_request_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
