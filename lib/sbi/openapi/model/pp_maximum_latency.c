...
OpenAPI_pp_maximum_latency_t *OpenAPI_pp_maximum_latency_create(
	...
	OpenAPI_pp_maximum_latency_t *pp_maximum_latency_local_var =
		ogs_malloc(sizeof(OpenAPI_pp_maximum_latency_t));
	...
	pp_maximum_latency_local_var->mtc_provider_information =
...
cJSON *OpenAPI_pp_maximum_latency_convertToJSON(
	...
	if(pp_maximum_latency == NULL) {
		ogs_error(
			"OpenAPI_pp_maximum_latency_convertToJSON() failed [PpMaximumLatency]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(cJSON_AddNumberToObject(item, "maximumLatency",
	                           pp_maximum_latency->maximum_latency) == NULL)
	{
		ogs_error(
			"OpenAPI_pp_maximum_latency_convertToJSON() failed [maximum_latency]");
		goto end;
	}

	if(!pp_maximum_latency->af_instance_id) {
		ogs_error(
			"OpenAPI_pp_maximum_latency_convertToJSON() failed [af_instance_id]");
		return NULL;
	}
	...
	if(cJSON_AddNumberToObject(item, "referenceId",
	                           pp_maximum_latency->reference_id) == NULL)
	{
		ogs_error(
			"OpenAPI_pp_maximum_latency_convertToJSON() failed [reference_id]");
		goto end;
	}

	if(pp_maximum_latency->validity_time) {
		if(cJSON_AddStringToObject(item, "validityTime",
		                           pp_maximum_latency->validity_time) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_pp_maximum_latency_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(pp_maximum_latency->mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_latency_convertToJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
...
OpenAPI_pp_maximum_latency_t *OpenAPI_pp_maximum_latency_parseFromJSON(
	...
	maximum_latency =
		cJSON_GetObjectItemCaseSensitive(pp_maximum_latencyJSON,
		                                 "maximumLatency");
	if(!maximum_latency) {
		ogs_error(
			"OpenAPI_pp_maximum_latency_parseFromJSON() failed [maximum_latency]");
		goto end;
	}
	...
	if(!af_instance_id) {
		ogs_error(
			"OpenAPI_pp_maximum_latency_parseFromJSON() failed [af_instance_id]");
		goto end;
	}
	...
	reference_id = cJSON_GetObjectItemCaseSensitive(pp_maximum_latencyJSON,
	                                                "referenceId");
	if(!reference_id) {
		ogs_error(
			"OpenAPI_pp_maximum_latency_parseFromJSON() failed [reference_id]");
		goto end;
	}
	...
	validity_time = cJSON_GetObjectItemCaseSensitive(pp_maximum_latencyJSON,
	                                                 "validityTime");
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_latency_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_pp_maximum_latency_parseFromJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
