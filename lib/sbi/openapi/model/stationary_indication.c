...
char * OpenAPI_stationary_indication_ToString(
	...
	const char *stationary_indicationArray[] = { "NULL", "STATIONARY",
		                                     "MOBILE" };
	size_t sizeofArray = sizeof(stationary_indicationArray) /
	                     sizeof(stationary_indicationArray[0]);
...
OpenAPI_stationary_indication_e OpenAPI_stationary_indication_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(stationary_indication,
		          stationary_indicationArray[stringToReturn]) == 0) {
