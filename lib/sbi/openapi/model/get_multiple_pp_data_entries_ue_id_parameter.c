...
cJSON *OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_convertToJSON(
	OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_t *
	get_multiple_pp_data_entries_ue_id_parameter) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(get_multiple_pp_data_entries_ue_id_parameter == NULL) {
		ogs_error(
			"OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_convertToJSON() failed [Get_Multiple_PP_Data_Entries_ueId_parameter]");
		return NULL;
	}
...
OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_parseFromJSON(
	cJSON *get_multiple_pp_data_entries_ue_id_parameterJSON) {
	OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_t *
	        get_multiple_pp_data_entries_ue_id_parameter_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	get_multiple_pp_data_entries_ue_id_parameter_local_var =
		OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_create(
			);
...
OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_copy(
	OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_t	*dst,
	OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_convertToJSON
		        (src);
	if(!item) {
		ogs_error(
			"OpenAPI_get_multiple_pp_data_entries_ue_id_parameter_convertToJSON() failed");
		return NULL;
	}
