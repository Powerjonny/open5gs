...
OpenAPI_n1_message_container_t *OpenAPI_n1_message_container_create(
	...
	OpenAPI_ref_to_binary_data_t *n1_message_content, char *nf_id,
	char *service_instance_id) {
	OpenAPI_n1_message_container_t *n1_message_container_local_var =
...
void OpenAPI_n1_message_container_free(
...
cJSON *OpenAPI_n1_message_container_convertToJSON(
	OpenAPI_n1_message_container_t *n1_message_container) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n1_message_container == NULL) {
		ogs_error(
			"OpenAPI_n1_message_container_convertToJSON() failed [N1MessageContainer]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_n1_message_container_convertToJSON() failed [n1_message_class]");
		return NULL;
	}
	...
	if(!n1_message_container->n1_message_content) {
		ogs_error(
			"OpenAPI_n1_message_container_convertToJSON() failed [n1_message_content]");
		return NULL;
	}
	cJSON *n1_message_content_local_JSON =
	...
	if(n1_message_container->nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_container_convertToJSON() failed [nf_id]");
			goto end;
		}
	}
	...
	if(n1_message_container->service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_container_convertToJSON() failed [service_instance_id]");
			goto end;
		}
	}
...
OpenAPI_n1_message_container_t *OpenAPI_n1_message_container_parseFromJSON(
	...
	n1_message_class =
		cJSON_GetObjectItemCaseSensitive(n1_message_containerJSON,
		                                 "n1MessageClass");
	if(!n1_message_class) {
		ogs_error(
			"OpenAPI_n1_message_container_parseFromJSON() failed [n1_message_class]");
		goto end;
	}
	...
	if(!n1_message_content) {
		ogs_error(
			"OpenAPI_n1_message_container_parseFromJSON() failed [n1_message_content]");
		goto end;
	}
	n1_message_content_local_nonprim =
		OpenAPI_ref_to_binary_data_parseFromJSON(n1_message_content);
	if(!n1_message_content_local_nonprim) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_parseFromJSON failed [n1_message_content]");
		goto end;
	}
	...
	if(nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_container_parseFromJSON() failed [nf_id]");
			goto end;
		}
	}
	...
	if(service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_n1_message_container_parseFromJSON() failed [service_instance_id]");
			goto end;
		}
	}
	...
	n1_message_container_local_var = OpenAPI_n1_message_container_create(
		...
		service_instance_id &&
		!cJSON_IsNull(service_instance_id) ?
		ogs_strdup(service_instance_id->valuestring) : NULL
		);
...
OpenAPI_n1_message_container_t *OpenAPI_n1_message_container_copy(
	OpenAPI_n1_message_container_t	*dst,
	OpenAPI_n1_message_container_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n1_message_container_convertToJSON() failed");
		return NULL;
	}
