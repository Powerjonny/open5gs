...
OpenAPI_ellipsoid_arc_t *OpenAPI_ellipsoid_arc_create(
	...
	int confidence) {
	OpenAPI_ellipsoid_arc_t *ellipsoid_arc_local_var =
		ogs_malloc(sizeof(OpenAPI_ellipsoid_arc_t));
...
cJSON *OpenAPI_ellipsoid_arc_convertToJSON(
	...
	if(ellipsoid_arc == NULL) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [EllipsoidArc]");
		return NULL;
	}
	...
	if(ellipsoid_arc->shape == OpenAPI_supported_gad_shapes_NULL) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [shape]");
		return NULL;
	}
	...
	if(!ellipsoid_arc->point) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [inner_radius]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [uncertainty_radius]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [offset_angle]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [included_angle]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ellipsoid_arc_convertToJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_ellipsoid_arc_t *OpenAPI_ellipsoid_arc_parseFromJSON(
	...
	if(!shape) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [shape]");
		goto end;
	}
	...
	if(!point) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	if(!inner_radius) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [inner_radius]");
		goto end;
	}
	...
	if(!uncertainty_radius) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [uncertainty_radius]");
		goto end;
	}
	...
	if(!offset_angle) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [offset_angle]");
		goto end;
	}
	...
	if(!included_angle) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [included_angle]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_ellipsoid_arc_parseFromJSON() failed [confidence]");
		goto end;
	}
