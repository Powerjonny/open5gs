...
char * OpenAPI_reporting_frequency_ToString(
	...
	const char *reporting_frequencyArray[] = { "NULL", "EVENT_TRIGGERED",
		                                   "PERIODIC",
		                                   "SESSION_RELEASE" };
	size_t sizeofArray = sizeof(reporting_frequencyArray) /
	                     sizeof(reporting_frequencyArray[0]);
...
OpenAPI_reporting_frequency_e OpenAPI_reporting_frequency_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(reporting_frequency,
		          reporting_frequencyArray[stringToReturn]) == 0) {
