...
OpenAPI_uncertainty_ellipsoid_t *OpenAPI_uncertainty_ellipsoid_create(
	float semi_major, float semi_minor, float vertical,
	int orientation_major) {
	OpenAPI_uncertainty_ellipsoid_t *uncertainty_ellipsoid_local_var =
		ogs_malloc(sizeof(OpenAPI_uncertainty_ellipsoid_t));
...
void OpenAPI_uncertainty_ellipsoid_free(
...
cJSON *OpenAPI_uncertainty_ellipsoid_convertToJSON(
	...
	if(uncertainty_ellipsoid == NULL) {
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_convertToJSON() failed [UncertaintyEllipsoid]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_convertToJSON() failed [semi_major]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_convertToJSON() failed [semi_minor]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_convertToJSON() failed [vertical]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_convertToJSON() failed [orientation_major]");
		goto end;
	}
...
OpenAPI_uncertainty_ellipsoid_t *OpenAPI_uncertainty_ellipsoid_parseFromJSON(
	...
	if(!semi_major) {
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_parseFromJSON() failed [semi_major]");
		goto end;
	}
	...
	if(!semi_minor) {
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_parseFromJSON() failed [semi_minor]");
		goto end;
	}
	...
	if(!vertical) {
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_parseFromJSON() failed [vertical]");
		goto end;
	}
	...
	orientation_major =
		cJSON_GetObjectItemCaseSensitive(uncertainty_ellipsoidJSON,
		                                 "orientationMajor");
	if(!orientation_major) {
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_parseFromJSON() failed [orientation_major]");
		goto end;
	}
...
OpenAPI_uncertainty_ellipsoid_t *OpenAPI_uncertainty_ellipsoid_copy(
	OpenAPI_uncertainty_ellipsoid_t *dst,
	OpenAPI_uncertainty_ellipsoid_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_uncertainty_ellipsoid_convertToJSON() failed");
		return NULL;
	}
