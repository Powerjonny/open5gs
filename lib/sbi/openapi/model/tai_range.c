...
OpenAPI_tai_range_t *OpenAPI_tai_range_create(OpenAPI_plmn_id_t *plmn_id,
                                              ...
                                              char		*nid) {
	OpenAPI_tai_range_t *tai_range_local_var =
		ogs_malloc(sizeof(OpenAPI_tai_range_t));
...
cJSON *OpenAPI_tai_range_convertToJSON(OpenAPI_tai_range_t *tai_range) {
	...
	if(tai_range == NULL) {
		ogs_error(
			"OpenAPI_tai_range_convertToJSON() failed [TaiRange]");
		return NULL;
	}
	...
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_convertToJSON(tai_range->plmn_id);
	...
	if(!tai_range->tac_range_list) {
		ogs_error(
			"OpenAPI_tai_range_convertToJSON() failed [tac_range_list]");
		return NULL;
	}
	cJSON *tac_range_listList = cJSON_AddArrayToObject(item,
	                                                   "tacRangeList");
	...
	if(tai_range->nid) {
		...
		{
			ogs_error(
				"OpenAPI_tai_range_convertToJSON() failed [nid]");
			goto end;
		}
	}
...
OpenAPI_tai_range_t *OpenAPI_tai_range_parseFromJSON(cJSON *tai_rangeJSON) {
	...
	if(!tac_range_list) {
		ogs_error(
			"OpenAPI_tai_range_parseFromJSON() failed [tac_range_list]");
		goto end;
	}
	...
	cJSON_ArrayForEach(tac_range_list_local, tac_range_list) {
		...
		OpenAPI_tac_range_t *tac_range_listItem =
			OpenAPI_tac_range_parseFromJSON(tac_range_list_local);
	...
	if(nid) {
		...
		{
			ogs_error(
				"OpenAPI_tai_range_parseFromJSON() failed [nid]");
			goto end;
		}
	}
