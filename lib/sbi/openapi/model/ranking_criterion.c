...
OpenAPI_ranking_criterion_t *OpenAPI_ranking_criterion_create(
	...
	int	low_base)
{
	OpenAPI_ranking_criterion_t *ranking_criterion_local_var =
		ogs_malloc(sizeof(OpenAPI_ranking_criterion_t));
...
cJSON *OpenAPI_ranking_criterion_convertToJSON(
	...
	if(ranking_criterion == NULL) {
		ogs_error(
			"OpenAPI_ranking_criterion_convertToJSON() failed [RankingCriterion]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ranking_criterion_convertToJSON() failed [high_base]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_ranking_criterion_convertToJSON() failed [low_base]");
		goto end;
	}
...
OpenAPI_ranking_criterion_t *OpenAPI_ranking_criterion_parseFromJSON(
	...
	if(!high_base) {
		ogs_error(
			"OpenAPI_ranking_criterion_parseFromJSON() failed [high_base]");
		goto end;
	}
	...
	if(!low_base) {
		ogs_error(
			"OpenAPI_ranking_criterion_parseFromJSON() failed [low_base]");
		goto end;
	}
