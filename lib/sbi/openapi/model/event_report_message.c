...
OpenAPI_event_report_message_t *OpenAPI_event_report_message_create(
	...
	OpenAPI_event_report_message_t *event_report_message_local_var =
		ogs_malloc(sizeof(OpenAPI_event_report_message_t));
...
void OpenAPI_event_report_message_free(
...
cJSON *OpenAPI_event_report_message_convertToJSON(
	OpenAPI_event_report_message_t *event_report_message) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(event_report_message == NULL) {
		ogs_error(
			"OpenAPI_event_report_message_convertToJSON() failed [EventReportMessage]");
		return NULL;
	}
	...
	if(event_report_message->event_class == OpenAPI_event_class_NULL) {
		ogs_error(
			"OpenAPI_event_report_message_convertToJSON() failed [event_class]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "eventClass",
	                           OpenAPI_event_class_ToString(
	...
	if(!event_report_message->event_content) {
		ogs_error(
			"OpenAPI_event_report_message_convertToJSON() failed [event_content]");
		return NULL;
	}
	cJSON *event_content_local_JSON =
...
OpenAPI_event_report_message_t *OpenAPI_event_report_message_parseFromJSON(
	...
	if(!event_class) {
		ogs_error(
			"OpenAPI_event_report_message_parseFromJSON() failed [event_class]");
		goto end;
	}
	...
	event_classVariable =
		OpenAPI_event_class_FromString(event_class->valuestring);

	event_content =
		cJSON_GetObjectItemCaseSensitive(event_report_messageJSON,
		                                 "eventContent");
	if(!event_content) {
		ogs_error(
			"OpenAPI_event_report_message_parseFromJSON() failed [event_content]");
		goto end;
	}
	event_content_local_nonprim =
		OpenAPI_ref_to_binary_data_parseFromJSON(event_content);
	if(!event_content_local_nonprim) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_parseFromJSON failed [event_content]");
		goto end;
	}
...
OpenAPI_event_report_message_t *OpenAPI_event_report_message_copy(
	OpenAPI_event_report_message_t	*dst,
	OpenAPI_event_report_message_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_event_report_message_convertToJSON() failed");
		return NULL;
	}
