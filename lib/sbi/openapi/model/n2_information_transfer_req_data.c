...
OpenAPI_n2_information_transfer_req_data_create(OpenAPI_list_t *tai_list,
                                                OpenAPI_rat_selector_e
                                                rat_selector,
                                                OpenAPI_list_t *
	...
	OpenAPI_n2_information_transfer_req_data_t *
		...
		ogs_malloc(sizeof(OpenAPI_n2_information_transfer_req_data_t));
...
void OpenAPI_n2_information_transfer_req_data_free(
	OpenAPI_n2_information_transfer_req_data_t *
	...
	if(n2_information_transfer_req_data->tai_list) {
		OpenAPI_list_for_each(
			n2_information_transfer_req_data->tai_list, node) {
...
cJSON *OpenAPI_n2_information_transfer_req_data_convertToJSON(
	OpenAPI_n2_information_transfer_req_data_t *
	n2_information_transfer_req_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n2_information_transfer_req_data == NULL) {
		ogs_error(
			"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed [N2InformationTransferReqData]");
		return NULL;
	}
	...
	if(n2_information_transfer_req_data->tai_list) {
		...
		if(tai_listList == NULL) {
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed [tai_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			n2_information_transfer_req_data->tai_list, node) {
	...
	if(n2_information_transfer_req_data->rat_selector !=
	   OpenAPI_rat_selector_NULL)
	{
		if(cJSON_AddStringToObject(item, "ratSelector",
		                           OpenAPI_rat_selector_ToString(
						   n2_information_transfer_req_data
						   ->rat_selector)) == NULL)
		{
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed [rat_selector]");
			goto end;
		}
	}
	...
	if(n2_information_transfer_req_data->global_ran_node_list) {
		...
		if(global_ran_node_listList == NULL) {
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed [global_ran_node_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			n2_information_transfer_req_data->global_ran_node_list,
	...
	if(!n2_information_transfer_req_data->n2_information) {
		ogs_error(
			"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed [n2_information]");
		return NULL;
	}
	cJSON *n2_information_local_JSON =
	...
	if(n2_information_transfer_req_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_n2_information_transfer_req_data_t *
OpenAPI_n2_information_transfer_req_data_parseFromJSON(
	...
	if(tai_list) {
		...
		if(!cJSON_IsArray(tai_list)) {
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_parseFromJSON() failed [tai_list]");
			goto end;
		}
	...
	if(rat_selector) {
		if(!cJSON_IsString(rat_selector)) {
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_parseFromJSON() failed [rat_selector]");
			goto end;
		}
		rat_selectorVariable =
	...
	if(global_ran_node_list) {
		...
		if(!cJSON_IsArray(global_ran_node_list)) {
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_parseFromJSON() failed [global_ran_node_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(global_ran_node_list_local,
			...
			OpenAPI_global_ran_node_id_t *global_ran_node_listItem =
			...
			OpenAPI_list_add(global_ran_node_listList,
	...
	if(!n2_information) {
		ogs_error(
			"OpenAPI_n2_information_transfer_req_data_parseFromJSON() failed [n2_information]");
		goto end;
	}
	n2_information_local_nonprim =
		OpenAPI_n2_info_container_parseFromJSON(n2_information);
	if(!n2_information_local_nonprim) {
		ogs_error(
			"OpenAPI_n2_info_container_parseFromJSON failed [n2_information]");
		goto end;
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_transfer_req_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	n2_information_transfer_req_data_local_var =
		OpenAPI_n2_information_transfer_req_data_create(
...
OpenAPI_n2_information_transfer_req_data_t *
OpenAPI_n2_information_transfer_req_data_copy(
	OpenAPI_n2_information_transfer_req_data_t	*dst,
	OpenAPI_n2_information_transfer_req_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n2_information_transfer_req_data_convertToJSON() failed");
		return NULL;
	}
