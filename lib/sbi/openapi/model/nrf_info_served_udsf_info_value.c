...
OpenAPI_nrf_info_served_udsf_info_value_create(char		*group_id,
                                               OpenAPI_list_t	*supi_ranges,
                                               OpenAPI_list_t	*
                                               storage_id_ranges) {
	OpenAPI_nrf_info_served_udsf_info_value_t *
	        nrf_info_served_udsf_info_value_local_var =
		ogs_malloc(sizeof(OpenAPI_nrf_info_served_udsf_info_value_t));
	...
	nrf_info_served_udsf_info_value_local_var->storage_id_ranges =
		storage_id_ranges;

	return nrf_info_served_udsf_info_value_local_var;
}

void OpenAPI_nrf_info_served_udsf_info_value_free(
	OpenAPI_nrf_info_served_udsf_info_value_t *
	...
	if(nrf_info_served_udsf_info_value->supi_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_udsf_info_value->supi_ranges, node) {
	...
	if(nrf_info_served_udsf_info_value->storage_id_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_udsf_info_value->storage_id_ranges,
			node) {
...
cJSON *OpenAPI_nrf_info_served_udsf_info_value_convertToJSON(
	OpenAPI_nrf_info_served_udsf_info_value_t *
	nrf_info_served_udsf_info_value) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nrf_info_served_udsf_info_value == NULL) {
		ogs_error(
			"OpenAPI_nrf_info_served_udsf_info_value_convertToJSON() failed [NrfInfo_servedUdsfInfo_value]");
		return NULL;
	}
	...
	if(nrf_info_served_udsf_info_value->group_id) {
		...
		{
			ogs_error(
				"OpenAPI_nrf_info_served_udsf_info_value_convertToJSON() failed [group_id]");
			goto end;
		}
	}
	...
	if(nrf_info_served_udsf_info_value->supi_ranges) {
		...
		if(supi_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_udsf_info_value_convertToJSON() failed [supi_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_udsf_info_value->supi_ranges, node) {
	...
	if(nrf_info_served_udsf_info_value->storage_id_ranges) {
		cJSON *storage_id_ranges = cJSON_AddObjectToObject(item,
		                                                   "storageIdRanges");
		if(storage_id_ranges == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_udsf_info_value_convertToJSON() failed [storage_id_ranges]");
			goto end;
		}
		...
		if(nrf_info_served_udsf_info_value->storage_id_ranges) {
			OpenAPI_list_for_each(
				...
				if(itemLocal == NULL) {
					ogs_error(
						"OpenAPI_nrf_info_served_udsf_info_value_convertToJSON() failed [inner]");
					goto end;
				}
...
OpenAPI_nrf_info_served_udsf_info_value_parseFromJSON(
	cJSON *nrf_info_served_udsf_info_valueJSON) {
	OpenAPI_nrf_info_served_udsf_info_value_t *
	        nrf_info_served_udsf_info_value_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *group_id = NULL;
	...
	group_id =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_udsf_info_valueJSON, "groupId");
	if(group_id) {
		if(!cJSON_IsString(group_id) &&
		   !cJSON_IsNull(group_id))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_udsf_info_value_parseFromJSON() failed [group_id]");
			goto end;
		}
	}
	...
	supi_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_udsf_info_valueJSON, "supiRanges");
	if(supi_ranges) {
		cJSON *supi_ranges_local = NULL;
		if(!cJSON_IsArray(supi_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_udsf_info_value_parseFromJSON() failed [supi_ranges]");
			goto end;
		}
	...
	storage_id_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_udsf_info_valueJSON, "storageIdRanges");
	if(storage_id_ranges) {
		cJSON *storage_id_ranges_local_map = NULL;
		if(!cJSON_IsObject(storage_id_ranges) &&
		   !cJSON_IsNull(storage_id_ranges))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_udsf_info_value_parseFromJSON() failed [storage_id_ranges]");
			goto end;
		}
		if(cJSON_IsObject(storage_id_ranges)) {
			storage_id_rangesList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(storage_id_ranges_local_map,
			                   storage_id_ranges) {
				cJSON *localMapObject =
					storage_id_ranges_local_map;
				...
				if(cJSON_IsObject(localMapObject)) {
					...
					ogs_error(
						"OpenAPI_nrf_info_served_udsf_info_value_parseFromJSON() failed [inner]");
					goto end;
				}
				OpenAPI_list_add(storage_id_rangesList,
				                 localMapKeyPair);
			}
		}
	}
	...
	nrf_info_served_udsf_info_value_local_var =
		OpenAPI_nrf_info_served_udsf_info_value_create(
			group_id &&
			!cJSON_IsNull(group_id) ?
...
OpenAPI_nrf_info_served_udsf_info_value_t *
OpenAPI_nrf_info_served_udsf_info_value_copy(
	OpenAPI_nrf_info_served_udsf_info_value_t	*dst,
	OpenAPI_nrf_info_served_udsf_info_value_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nrf_info_served_udsf_info_value_convertToJSON() failed");
		return NULL;
	}
