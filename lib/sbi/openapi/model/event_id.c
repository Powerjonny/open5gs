...
OpenAPI_event_id_t *OpenAPI_event_id_create() {
	OpenAPI_event_id_t *event_id_local_var =
		ogs_malloc(sizeof(OpenAPI_event_id_t));
...
OpenAPI_event_id_t *OpenAPI_event_id_copy(OpenAPI_event_id_t	*dst,
                                          OpenAPI_event_id_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
