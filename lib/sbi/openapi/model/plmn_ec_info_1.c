...
OpenAPI_plmn_ec_info_1_t *OpenAPI_plmn_ec_info_1_create(
	...
	OpenAPI_plmn_ec_info_1_t *plmn_ec_info_1_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_ec_info_1_t));
	ogs_assert(plmn_ec_info_1_local_var);

	plmn_ec_info_1_local_var->plmn_id = plmn_id;
	plmn_ec_info_1_local_var->ec_restriction_data_wb =
		ec_restriction_data_wb;
	plmn_ec_info_1_local_var->is_ec_restriction_data_nb =
		is_ec_restriction_data_nb;
	plmn_ec_info_1_local_var->ec_restriction_data_nb =
...
void OpenAPI_plmn_ec_info_1_free(OpenAPI_plmn_ec_info_1_t *plmn_ec_info_1) {
	...
	if(plmn_ec_info_1->ec_restriction_data_wb) {
		OpenAPI_ec_restriction_data_wb_free(
			plmn_ec_info_1->ec_restriction_data_wb);
...
cJSON *OpenAPI_plmn_ec_info_1_convertToJSON(
	OpenAPI_plmn_ec_info_1_t *plmn_ec_info_1) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(plmn_ec_info_1 == NULL) {
		ogs_error(
			"OpenAPI_plmn_ec_info_1_convertToJSON() failed [PlmnEcInfo_1]");
		return NULL;
	}
	...
	if(!plmn_ec_info_1->plmn_id) {
		ogs_error(
			"OpenAPI_plmn_ec_info_1_convertToJSON() failed [plmn_id]");
		return NULL;
	}
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_1_convertToJSON(plmn_ec_info_1->plmn_id);
	...
	if(plmn_ec_info_1->ec_restriction_data_wb) {
		...
		if(ec_restriction_data_wb_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_plmn_ec_info_1_convertToJSON() failed [ec_restriction_data_wb]");
			goto end;
		}
	...
	if(plmn_ec_info_1->is_ec_restriction_data_nb) {
		if(cJSON_AddBoolToObject(item, "ecRestrictionDataNb",
		                         plmn_ec_info_1->ec_restriction_data_nb)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_plmn_ec_info_1_convertToJSON() failed [ec_restriction_data_nb]");
			goto end;
		}
	}
...
OpenAPI_plmn_ec_info_1_t *OpenAPI_plmn_ec_info_1_parseFromJSON(
	cJSON *plmn_ec_info_1JSON) {
	...
	plmn_id = cJSON_GetObjectItemCaseSensitive(plmn_ec_info_1JSON,
	                                           "plmnId");
	if(!plmn_id) {
		ogs_error(
			"OpenAPI_plmn_ec_info_1_parseFromJSON() failed [plmn_id]");
		goto end;
	}
	...
	ec_restriction_data_wb =
		cJSON_GetObjectItemCaseSensitive(plmn_ec_info_1JSON,
		                                 "ecRestrictionDataWb");
	...
	if(ec_restriction_data_nb) {
		if(!cJSON_IsBool(ec_restriction_data_nb)) {
			ogs_error(
				"OpenAPI_plmn_ec_info_1_parseFromJSON() failed [ec_restriction_data_nb]");
			goto end;
		}
	}
...
OpenAPI_plmn_ec_info_1_t *OpenAPI_plmn_ec_info_1_copy(
	OpenAPI_plmn_ec_info_1_t *dst, OpenAPI_plmn_ec_info_1_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
