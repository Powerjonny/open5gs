...
OpenAPI_snssai_route_selection_descriptor_create(OpenAPI_snssai_t *snssai,
                                                 OpenAPI_list_t		*
                                                 dnn_route_sel_descs) {
	OpenAPI_snssai_route_selection_descriptor_t *
	        snssai_route_selection_descriptor_local_var =
		ogs_malloc(sizeof(OpenAPI_snssai_route_selection_descriptor_t));
	ogs_assert(snssai_route_selection_descriptor_local_var);

	snssai_route_selection_descriptor_local_var->snssai = snssai;
	snssai_route_selection_descriptor_local_var->dnn_route_sel_descs =
		dnn_route_sel_descs;

	return snssai_route_selection_descriptor_local_var;
}

void OpenAPI_snssai_route_selection_descriptor_free(
	OpenAPI_snssai_route_selection_descriptor_t *
	...
	if(snssai_route_selection_descriptor->dnn_route_sel_descs) {
		OpenAPI_list_for_each(
			snssai_route_selection_descriptor->dnn_route_sel_descs,
			node) {
...
cJSON *OpenAPI_snssai_route_selection_descriptor_convertToJSON(
	OpenAPI_snssai_route_selection_descriptor_t *
	snssai_route_selection_descriptor) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(snssai_route_selection_descriptor == NULL) {
		ogs_error(
			"OpenAPI_snssai_route_selection_descriptor_convertToJSON() failed [SnssaiRouteSelectionDescriptor]");
		return NULL;
	}
	...
	if(!snssai_route_selection_descriptor->snssai) {
		ogs_error(
			"OpenAPI_snssai_route_selection_descriptor_convertToJSON() failed [snssai]");
		return NULL;
	}
	cJSON *snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(
			snssai_route_selection_descriptor->snssai);
	...
	if(snssai_route_selection_descriptor->dnn_route_sel_descs) {
		cJSON *dnn_route_sel_descsList = cJSON_AddArrayToObject(item,
		                                                        "dnnRouteSelDescs");
		if(dnn_route_sel_descsList == NULL) {
			ogs_error(
				"OpenAPI_snssai_route_selection_descriptor_convertToJSON() failed [dnn_route_sel_descs]");
			goto end;
		}
		OpenAPI_list_for_each(
			snssai_route_selection_descriptor->dnn_route_sel_descs,
			node) {
			cJSON *itemLocal =
				OpenAPI_dnn_route_selection_descriptor_convertToJSON
				        (node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_snssai_route_selection_descriptor_convertToJSON() failed [dnn_route_sel_descs]");
			...
			cJSON_AddItemToArray(dnn_route_sel_descsList,
			                     itemLocal);
		}
	}
...
OpenAPI_snssai_route_selection_descriptor_parseFromJSON(
	cJSON *snssai_route_selection_descriptorJSON) {
	OpenAPI_snssai_route_selection_descriptor_t *
	        snssai_route_selection_descriptor_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *snssai = NULL;
	...
	snssai =
		cJSON_GetObjectItemCaseSensitive(
			snssai_route_selection_descriptorJSON, "snssai");
	if(!snssai) {
		ogs_error(
			"OpenAPI_snssai_route_selection_descriptor_parseFromJSON() failed [snssai]");
		goto end;
	}
	...
	dnn_route_sel_descs =
		cJSON_GetObjectItemCaseSensitive(
			snssai_route_selection_descriptorJSON,
			"dnnRouteSelDescs");
	if(dnn_route_sel_descs) {
		cJSON *dnn_route_sel_descs_local = NULL;
		if(!cJSON_IsArray(dnn_route_sel_descs)) {
			ogs_error(
				"OpenAPI_snssai_route_selection_descriptor_parseFromJSON() failed [dnn_route_sel_descs]");
			goto end;
		}

		dnn_route_sel_descsList = OpenAPI_list_create();

		cJSON_ArrayForEach(dnn_route_sel_descs_local,
		                   dnn_route_sel_descs) {
			...
			OpenAPI_dnn_route_selection_descriptor_t *
			        dnn_route_sel_descsItem =
				OpenAPI_dnn_route_selection_descriptor_parseFromJSON
				        (dnn_route_sel_descs_local);
			if(!dnn_route_sel_descsItem) {
				ogs_error("No dnn_route_sel_descsItem");
				goto end;
			}
			OpenAPI_list_add(dnn_route_sel_descsList,
			                 dnn_route_sel_descsItem);
		}
	}

	snssai_route_selection_descriptor_local_var =
		OpenAPI_snssai_route_selection_descriptor_create(
...
OpenAPI_snssai_route_selection_descriptor_copy(
	OpenAPI_snssai_route_selection_descriptor_t	*dst,
	OpenAPI_snssai_route_selection_descriptor_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_snssai_route_selection_descriptor_convertToJSON() failed");
		return NULL;
	}
