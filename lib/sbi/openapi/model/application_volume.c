...
OpenAPI_application_volume_t *OpenAPI_application_volume_create(char *app_id,
                                                                long
                                                                app_volume) {
	OpenAPI_application_volume_t *application_volume_local_var =
		ogs_malloc(sizeof(OpenAPI_application_volume_t));
...
void OpenAPI_application_volume_free(
	OpenAPI_application_volume_t *application_volume) {
...
cJSON *OpenAPI_application_volume_convertToJSON(
	OpenAPI_application_volume_t *application_volume) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(application_volume == NULL) {
		ogs_error(
			"OpenAPI_application_volume_convertToJSON() failed [ApplicationVolume]");
		return NULL;
	}
	...
	if(!application_volume->app_id) {
		ogs_error(
			"OpenAPI_application_volume_convertToJSON() failed [app_id]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_application_volume_convertToJSON() failed [app_volume]");
		goto end;
	}
...
OpenAPI_application_volume_t *OpenAPI_application_volume_parseFromJSON(
	...
	if(!app_id) {
		ogs_error(
			"OpenAPI_application_volume_parseFromJSON() failed [app_id]");
		goto end;
	}
	...
	if(!app_volume) {
		ogs_error(
			"OpenAPI_application_volume_parseFromJSON() failed [app_volume]");
		goto end;
	}
...
OpenAPI_application_volume_t *OpenAPI_application_volume_copy(
	OpenAPI_application_volume_t *dst, OpenAPI_application_volume_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
