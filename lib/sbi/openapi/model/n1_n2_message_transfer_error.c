...
OpenAPI_n1_n2_message_transfer_error_create(
...
void OpenAPI_n1_n2_message_transfer_error_free(
	OpenAPI_n1_n2_message_transfer_error_t *n1_n2_message_transfer_error) {
...
cJSON *OpenAPI_n1_n2_message_transfer_error_convertToJSON(
	OpenAPI_n1_n2_message_transfer_error_t *n1_n2_message_transfer_error) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n1_n2_message_transfer_error == NULL) {
		ogs_error(
			"OpenAPI_n1_n2_message_transfer_error_convertToJSON() failed [N1N2MessageTransferError]");
		return NULL;
	}
	...
	if(!n1_n2_message_transfer_error->error) {
		ogs_error(
			"OpenAPI_n1_n2_message_transfer_error_convertToJSON() failed [error]");
		return NULL;
	}
	...
	if(n1_n2_message_transfer_error->err_info) {
		cJSON *err_info_local_JSON =
			OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON(
				n1_n2_message_transfer_error->err_info);
		if(err_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_n2_message_transfer_error_convertToJSON() failed [err_info]");
			goto end;
		}
...
OpenAPI_n1_n2_message_transfer_error_parseFromJSON(
	...
	OpenAPI_n1_n2_message_transfer_error_t *
	        n1_n2_message_transfer_error_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *error = NULL;
	...
	if(!error) {
		ogs_error(
			"OpenAPI_n1_n2_message_transfer_error_parseFromJSON() failed [error]");
		goto end;
	}
	...
	if(err_info) {
		...
		if(!err_info_local_nonprim) {
			ogs_error(
				"OpenAPI_n1_n2_msg_txfr_err_detail_parseFromJSON failed [err_info]");
			goto end;
		}
	}
...
OpenAPI_n1_n2_message_transfer_error_t *
OpenAPI_n1_n2_message_transfer_error_copy(
	OpenAPI_n1_n2_message_transfer_error_t	*dst,
	OpenAPI_n1_n2_message_transfer_error_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n1_n2_message_transfer_error_convertToJSON() failed");
		return NULL;
	}
