...
OpenAPI_ue_context_cancel_relocate_data_create(
	char	*supi,
	OpenAPI_ref_to_binary_data_t
	        *relocation_cancel_request) {
	OpenAPI_ue_context_cancel_relocate_data_t *
	        ue_context_cancel_relocate_data_local_var =
		ogs_malloc(sizeof(OpenAPI_ue_context_cancel_relocate_data_t));
...
void OpenAPI_ue_context_cancel_relocate_data_free(
	OpenAPI_ue_context_cancel_relocate_data_t *
...
cJSON *OpenAPI_ue_context_cancel_relocate_data_convertToJSON(
	OpenAPI_ue_context_cancel_relocate_data_t *
	ue_context_cancel_relocate_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_context_cancel_relocate_data == NULL) {
		ogs_error(
			"OpenAPI_ue_context_cancel_relocate_data_convertToJSON() failed [UeContextCancelRelocateData]");
		return NULL;
	}
	...
	if(ue_context_cancel_relocate_data->supi) {
		...
		{
			ogs_error(
				"OpenAPI_ue_context_cancel_relocate_data_convertToJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(!ue_context_cancel_relocate_data->relocation_cancel_request) {
		ogs_error(
			"OpenAPI_ue_context_cancel_relocate_data_convertToJSON() failed [relocation_cancel_request]");
		return NULL;
	}
...
OpenAPI_ue_context_cancel_relocate_data_parseFromJSON(
	...
	OpenAPI_ref_to_binary_data_t *relocation_cancel_request_local_nonprim =
		NULL;
	supi =
	...
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_ue_context_cancel_relocate_data_parseFromJSON() failed [supi]");
			goto end;
		}
	}
	...
	relocation_cancel_request =
		cJSON_GetObjectItemCaseSensitive(
			ue_context_cancel_relocate_dataJSON,
			"relocationCancelRequest");
	if(!relocation_cancel_request) {
		ogs_error(
			"OpenAPI_ue_context_cancel_relocate_data_parseFromJSON() failed [relocation_cancel_request]");
		goto end;
	}
	...
	if(!relocation_cancel_request_local_nonprim) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_parseFromJSON failed [relocation_cancel_request]");
		goto end;
	}
...
OpenAPI_ue_context_cancel_relocate_data_t *
OpenAPI_ue_context_cancel_relocate_data_copy(
	OpenAPI_ue_context_cancel_relocate_data_t	*dst,
	OpenAPI_ue_context_cancel_relocate_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_ue_context_cancel_relocate_data_convertToJSON() failed");
		return NULL;
	}
