...
OpenAPI_gad_shape_t *OpenAPI_gad_shape_create(
	...
	OpenAPI_gad_shape_t *gad_shape_local_var =
		ogs_malloc(sizeof(OpenAPI_gad_shape_t));
...
cJSON *OpenAPI_gad_shape_convertToJSON(OpenAPI_gad_shape_t *gad_shape) {
	...
	if(gad_shape == NULL) {
		ogs_error(
			"OpenAPI_gad_shape_convertToJSON() failed [GADShape]");
		return NULL;
	}
...
OpenAPI_gad_shape_t *OpenAPI_gad_shape_copy(OpenAPI_gad_shape_t *dst,
                                            OpenAPI_gad_shape_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
