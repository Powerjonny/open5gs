...
OpenAPI_authorization_info_t *OpenAPI_authorization_info_create(
	...
	OpenAPI_authorization_info_t *authorization_info_local_var =
		ogs_malloc(sizeof(OpenAPI_authorization_info_t));
	ogs_assert(authorization_info_local_var);

	authorization_info_local_var->snssai = snssai;
	authorization_info_local_var->dnn = dnn;
	authorization_info_local_var->mtc_provider_information =
		mtc_provider_information;
	authorization_info_local_var->auth_update_callback_uri =
...
cJSON *OpenAPI_authorization_info_convertToJSON(
	...
	if(authorization_info == NULL) {
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [AuthorizationInfo]");
		return NULL;
	}
	...
	if(!authorization_info->snssai) {
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [snssai]");
		return NULL;
	}
	cJSON *snssai_local_JSON =
		OpenAPI_snssai_convertToJSON(authorization_info->snssai);
	...
	if(!authorization_info->dnn) {
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [dnn]");
		return NULL;
	}
	...
	if(!authorization_info->mtc_provider_information) {
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [mtc_provider_information]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "mtcProviderInformation",
	                           authorization_info->mtc_provider_information)
	   == NULL)
	{
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [mtc_provider_information]");
	...
	if(!authorization_info->auth_update_callback_uri) {
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [auth_update_callback_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "authUpdateCallbackUri",
	                           authorization_info->auth_update_callback_uri)
	   == NULL)
	{
		ogs_error(
			"OpenAPI_authorization_info_convertToJSON() failed [auth_update_callback_uri]");
	...
	if(authorization_info->af_id) {
		...
		{
			ogs_error(
				"OpenAPI_authorization_info_convertToJSON() failed [af_id]");
			goto end;
		}
	}
	...
	if(authorization_info->nef_id) {
		...
		{
			ogs_error(
				"OpenAPI_authorization_info_convertToJSON() failed [nef_id]");
			goto end;
		}
	}
	...
	if(authorization_info->validity_time) {
		if(cJSON_AddStringToObject(item, "validityTime",
		                           authorization_info->validity_time) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_authorization_info_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(authorization_info->context_info) {
		...
		if(context_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_authorization_info_convertToJSON() failed [context_info]");
			goto end;
		}
...
OpenAPI_authorization_info_t *OpenAPI_authorization_info_parseFromJSON(
	...
	snssai = cJSON_GetObjectItemCaseSensitive(authorization_infoJSON,
	                                          "snssai");
	if(!snssai) {
		ogs_error(
			"OpenAPI_authorization_info_parseFromJSON() failed [snssai]");
		goto end;
	}
	...
	if(!dnn) {
		ogs_error(
			"OpenAPI_authorization_info_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	mtc_provider_information =
		cJSON_GetObjectItemCaseSensitive(authorization_infoJSON,
		                                 "mtcProviderInformation");
	if(!mtc_provider_information) {
		ogs_error(
			"OpenAPI_authorization_info_parseFromJSON() failed [mtc_provider_information]");
		goto end;
	}
	...
	if(!auth_update_callback_uri) {
		ogs_error(
			"OpenAPI_authorization_info_parseFromJSON() failed [auth_update_callback_uri]");
		goto end;
	}
	...
	af_id = cJSON_GetObjectItemCaseSensitive(authorization_infoJSON,
	                                         "afId");
	if(af_id) {
		...
		{
			ogs_error(
				"OpenAPI_authorization_info_parseFromJSON() failed [af_id]");
			goto end;
		}
	}

	nef_id = cJSON_GetObjectItemCaseSensitive(authorization_infoJSON,
	                                          "nefId");
	if(nef_id) {
		...
		{
			ogs_error(
				"OpenAPI_authorization_info_parseFromJSON() failed [nef_id]");
			goto end;
		}
	}

	validity_time = cJSON_GetObjectItemCaseSensitive(authorization_infoJSON,
	                                                 "validityTime");
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_authorization_info_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}

	context_info = cJSON_GetObjectItemCaseSensitive(authorization_infoJSON,
	                                                "contextInfo");
	if(context_info) {
	...
	authorization_info_local_var = OpenAPI_authorization_info_create(
		...
		af_id &&
		!cJSON_IsNull(af_id) ? ogs_strdup(af_id->valuestring) : NULL,
		nef_id &&
