...
OpenAPI_ref_to_binary_data_t *OpenAPI_ref_to_binary_data_create(
	char *content_id) {
	OpenAPI_ref_to_binary_data_t *ref_to_binary_data_local_var =
		ogs_malloc(sizeof(OpenAPI_ref_to_binary_data_t));
...
void OpenAPI_ref_to_binary_data_free(
	OpenAPI_ref_to_binary_data_t *ref_to_binary_data) {
...
cJSON *OpenAPI_ref_to_binary_data_convertToJSON(
	OpenAPI_ref_to_binary_data_t *ref_to_binary_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ref_to_binary_data == NULL) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_convertToJSON() failed [RefToBinaryData]");
		return NULL;
	}
	...
	if(!ref_to_binary_data->content_id) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_convertToJSON() failed [content_id]");
		return NULL;
	}
...
OpenAPI_ref_to_binary_data_t *OpenAPI_ref_to_binary_data_parseFromJSON(
	...
	if(!content_id) {
		ogs_error(
			"OpenAPI_ref_to_binary_data_parseFromJSON() failed [content_id]");
		goto end;
	}
...
OpenAPI_ref_to_binary_data_t *OpenAPI_ref_to_binary_data_copy(
	OpenAPI_ref_to_binary_data_t *dst, OpenAPI_ref_to_binary_data_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
