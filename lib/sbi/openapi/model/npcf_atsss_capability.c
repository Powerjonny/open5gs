...
char * OpenAPI_npcf_atsss_capability_ToString(
	...
	const char *npcf_atsss_capabilityArray[] = { "NULL",
		                                     "MPTCP_ATSSS_LL_WITH_ASMODE_UL",
		                                     "MPTCP_ATSSS_LL_WITH_EXSDMODE_DL_ASMODE_UL",
		                                     "MPTCP_ATSSS_LL_WITH_ASMODE_DLUL",
		                                     "ATSSS_LL",
		                                     "MPTCP_ATSSS_LL" };
	size_t sizeofArray = sizeof(npcf_atsss_capabilityArray) /
	                     sizeof(npcf_atsss_capabilityArray[0]);
...
OpenAPI_npcf_atsss_capability_e OpenAPI_npcf_atsss_capability_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(npcf_atsss_capability,
		          npcf_atsss_capabilityArray[stringToReturn]) == 0) {
