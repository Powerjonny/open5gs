...
OpenAPI_ue_authentication_ctx_5g_auth_data_create(char *rand, char *hxres_star,
                                                  char *autn) {
	OpenAPI_ue_authentication_ctx_5g_auth_data_t *
	        ue_authentication_ctx_5g_auth_data_local_var =
		ogs_malloc(
			sizeof(OpenAPI_ue_authentication_ctx_5g_auth_data_t));
...
void OpenAPI_ue_authentication_ctx_5g_auth_data_free(
	OpenAPI_ue_authentication_ctx_5g_auth_data_t *
	ue_authentication_ctx_5g_auth_data) {
...
cJSON *OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON(
	OpenAPI_ue_authentication_ctx_5g_auth_data_t *
	ue_authentication_ctx_5g_auth_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_authentication_ctx_5g_auth_data == NULL) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed [UEAuthenticationCtx_5gAuthData]");
		return NULL;
	}
	...
	if(!ue_authentication_ctx_5g_auth_data->rand) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed [rand]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "rand",
	                           ue_authentication_ctx_5g_auth_data->rand) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed [rand]");
	...
	if(!ue_authentication_ctx_5g_auth_data->hxres_star) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed [hxres_star]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "hxresStar",
	                           ue_authentication_ctx_5g_auth_data->
	                           hxres_star) == NULL)
	{
		ogs_error(
	...
	if(!ue_authentication_ctx_5g_auth_data->autn) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed [autn]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "autn",
	                           ue_authentication_ctx_5g_auth_data->autn) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed [autn]");
...
OpenAPI_ue_authentication_ctx_5g_auth_data_parseFromJSON(
	cJSON *ue_authentication_ctx_5g_auth_dataJSON) {
	OpenAPI_ue_authentication_ctx_5g_auth_data_t *
	        ue_authentication_ctx_5g_auth_data_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *rand = NULL;
	...
	rand =
		cJSON_GetObjectItemCaseSensitive(
			ue_authentication_ctx_5g_auth_dataJSON, "rand");
	if(!rand) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_parseFromJSON() failed [rand]");
		goto end;
	}
	...
	hxres_star =
		cJSON_GetObjectItemCaseSensitive(
			ue_authentication_ctx_5g_auth_dataJSON, "hxresStar");
	if(!hxres_star) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_parseFromJSON() failed [hxres_star]");
		goto end;
	}
	...
	autn =
		cJSON_GetObjectItemCaseSensitive(
			ue_authentication_ctx_5g_auth_dataJSON, "autn");
	if(!autn) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_parseFromJSON() failed [autn]");
		goto end;
	}
...
OpenAPI_ue_authentication_ctx_5g_auth_data_copy(
	OpenAPI_ue_authentication_ctx_5g_auth_data_t	*dst,
	OpenAPI_ue_authentication_ctx_5g_auth_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_ue_authentication_ctx_5g_auth_data_convertToJSON() failed");
		return NULL;
	}
