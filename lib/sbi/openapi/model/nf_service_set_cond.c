...
OpenAPI_nf_service_set_cond_t *OpenAPI_nf_service_set_cond_create(
	char *nf_service_set_id, char *nf_set_id) {
	OpenAPI_nf_service_set_cond_t *nf_service_set_cond_local_var =
		ogs_malloc(sizeof(OpenAPI_nf_service_set_cond_t));
...
void OpenAPI_nf_service_set_cond_free(
	OpenAPI_nf_service_set_cond_t *nf_service_set_cond) {
...
cJSON *OpenAPI_nf_service_set_cond_convertToJSON(
	OpenAPI_nf_service_set_cond_t *nf_service_set_cond) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nf_service_set_cond == NULL) {
		ogs_error(
			"OpenAPI_nf_service_set_cond_convertToJSON() failed [NfServiceSetCond]");
		return NULL;
	}
	...
	if(!nf_service_set_cond->nf_service_set_id) {
		ogs_error(
			"OpenAPI_nf_service_set_cond_convertToJSON() failed [nf_service_set_id]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "nfServiceSetId",
	                           nf_service_set_cond->nf_service_set_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_nf_service_set_cond_convertToJSON() failed [nf_service_set_id]");
	...
	if(nf_service_set_cond->nf_set_id) {
		if(cJSON_AddStringToObject(item, "nfSetId",
		                           nf_service_set_cond->nf_set_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_nf_service_set_cond_convertToJSON() failed [nf_set_id]");
			goto end;
		}
	}
...
OpenAPI_nf_service_set_cond_t *OpenAPI_nf_service_set_cond_parseFromJSON(
	cJSON *nf_service_set_condJSON) {
	OpenAPI_nf_service_set_cond_t *nf_service_set_cond_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *nf_service_set_id = NULL;
	cJSON *nf_set_id = NULL;
	nf_service_set_id =
		cJSON_GetObjectItemCaseSensitive(nf_service_set_condJSON,
		                                 "nfServiceSetId");
	if(!nf_service_set_id) {
		ogs_error(
			"OpenAPI_nf_service_set_cond_parseFromJSON() failed [nf_service_set_id]");
		goto end;
	}
	...
	nf_set_id = cJSON_GetObjectItemCaseSensitive(nf_service_set_condJSON,
	                                             "nfSetId");
	if(nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_service_set_cond_parseFromJSON() failed [nf_set_id]");
			goto end;
		}
	}
...
OpenAPI_nf_service_set_cond_t *OpenAPI_nf_service_set_cond_copy(
	OpenAPI_nf_service_set_cond_t	*dst,
	OpenAPI_nf_service_set_cond_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
