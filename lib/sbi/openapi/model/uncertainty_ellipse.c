...
OpenAPI_uncertainty_ellipse_t *OpenAPI_uncertainty_ellipse_create(
	float semi_major, float semi_minor, int orientation_major) {
	OpenAPI_uncertainty_ellipse_t *uncertainty_ellipse_local_var =
		ogs_malloc(sizeof(OpenAPI_uncertainty_ellipse_t));
...
cJSON *OpenAPI_uncertainty_ellipse_convertToJSON(
	OpenAPI_uncertainty_ellipse_t *uncertainty_ellipse) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(uncertainty_ellipse == NULL) {
		ogs_error(
			"OpenAPI_uncertainty_ellipse_convertToJSON() failed [UncertaintyEllipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipse_convertToJSON() failed [semi_major]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipse_convertToJSON() failed [semi_minor]");
		goto end;
	}
	...
	{
		ogs_error(
			"OpenAPI_uncertainty_ellipse_convertToJSON() failed [orientation_major]");
		goto end;
	}
...
OpenAPI_uncertainty_ellipse_t *OpenAPI_uncertainty_ellipse_parseFromJSON(
	...
	if(!semi_major) {
		ogs_error(
			"OpenAPI_uncertainty_ellipse_parseFromJSON() failed [semi_major]");
		goto end;
	}
	...
	if(!semi_minor) {
		ogs_error(
			"OpenAPI_uncertainty_ellipse_parseFromJSON() failed [semi_minor]");
		goto end;
	}
	...
	orientation_major =
		cJSON_GetObjectItemCaseSensitive(uncertainty_ellipseJSON,
		                                 "orientationMajor");
	if(!orientation_major) {
		ogs_error(
			"OpenAPI_uncertainty_ellipse_parseFromJSON() failed [orientation_major]");
		goto end;
	}
...
OpenAPI_uncertainty_ellipse_t *OpenAPI_uncertainty_ellipse_copy(
	OpenAPI_uncertainty_ellipse_t	*dst,
	OpenAPI_uncertainty_ellipse_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
