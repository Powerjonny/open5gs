...
OpenAPI_dn_perf_ordering_criterion_t *OpenAPI_dn_perf_ordering_criterion_create()
{
	OpenAPI_dn_perf_ordering_criterion_t *
		...
		ogs_malloc(sizeof(OpenAPI_dn_perf_ordering_criterion_t));
...
cJSON *OpenAPI_dn_perf_ordering_criterion_convertToJSON(
	...
	if(dn_perf_ordering_criterion == NULL) {
		ogs_error(
			"OpenAPI_dn_perf_ordering_criterion_convertToJSON() failed [DnPerfOrderingCriterion]");
		return NULL;
	}
...
OpenAPI_dn_perf_ordering_criterion_parseFromJSON(
	...
	OpenAPI_dn_perf_ordering_criterion_t *
	        dn_perf_ordering_criterion_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	dn_perf_ordering_criterion_local_var =
		OpenAPI_dn_perf_ordering_criterion_create(
			);
...
OpenAPI_dn_perf_ordering_criterion_t *OpenAPI_dn_perf_ordering_criterion_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_dn_perf_ordering_criterion_convertToJSON() failed");
		return NULL;
	}
