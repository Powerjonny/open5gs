...
typedef enum { OpenAPI_hss_auth_type_NULL = 0, OpenAPI_hss_auth_type_EPS_AKA,
	       OpenAPI_hss_auth_type_EAP_AKA,
	       OpenAPI_hss_auth_type_EAP_AKA_PRIME,
	       OpenAPI_hss_auth_type_IMS_AKA, OpenAPI_hss_auth_type_GBA_AKA,
	       OpenAPI_hss_auth_type_UMTS_AKA } OpenAPI_hss_auth_type_e;
