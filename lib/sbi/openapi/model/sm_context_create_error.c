...
OpenAPI_sm_context_create_error_t *OpenAPI_sm_context_create_error_create(
	...
	OpenAPI_n2_sm_info_type_e n2_sm_info_type, char *recovery_time) {
	OpenAPI_sm_context_create_error_t *sm_context_create_error_local_var =
		ogs_malloc(sizeof(OpenAPI_sm_context_create_error_t));
...
void OpenAPI_sm_context_create_error_free(
	OpenAPI_sm_context_create_error_t *sm_context_create_error) {
	...
	if(sm_context_create_error->n2_sm_info) {
		OpenAPI_ref_to_binary_data_free(
			sm_context_create_error->n2_sm_info);
...
cJSON *OpenAPI_sm_context_create_error_convertToJSON(
	...
	if(sm_context_create_error == NULL) {
		ogs_error(
			"OpenAPI_sm_context_create_error_convertToJSON() failed [SmContextCreateError]");
		return NULL;
	}
	...
	if(!sm_context_create_error->error) {
		ogs_error(
			"OpenAPI_sm_context_create_error_convertToJSON() failed [error]");
		return NULL;
	}
	...
	if(sm_context_create_error->n1_sm_msg) {
		...
		if(n1_sm_msg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_error_convertToJSON() failed [n1_sm_msg]");
			goto end;
		}
	...
	if(sm_context_create_error->n2_sm_info) {
		...
		if(n2_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_error_convertToJSON() failed [n2_sm_info]");
			goto end;
		}
	   ...
	   OpenAPI_n2_sm_info_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_error_convertToJSON() failed [n2_sm_info_type]");
			goto end;
		}
	}
	...
	if(sm_context_create_error->recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_error_convertToJSON() failed [recovery_time]");
			goto end;
		}
	}
...
OpenAPI_sm_context_create_error_t *OpenAPI_sm_context_create_error_parseFromJSON
        (cJSON *sm_context_create_errorJSON) {
	OpenAPI_sm_context_create_error_t *sm_context_create_error_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *error = NULL;
	...
	error = cJSON_GetObjectItemCaseSensitive(sm_context_create_errorJSON,
	                                         "error");
	if(!error) {
		ogs_error(
			"OpenAPI_sm_context_create_error_parseFromJSON() failed [error]");
		goto end;
	}
	...
	n1_sm_msg =
		cJSON_GetObjectItemCaseSensitive(sm_context_create_errorJSON,
		                                 "n1SmMsg");
	if(n1_sm_msg) {
	...
	if(n2_sm_info_type) {
		if(!cJSON_IsString(n2_sm_info_type)) {
			ogs_error(
				"OpenAPI_sm_context_create_error_parseFromJSON() failed [n2_sm_info_type]");
			goto end;
		}
	...
	if(recovery_time) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_error_parseFromJSON() failed [recovery_time]");
			goto end;
		}
	}

	sm_context_create_error_local_var =
		OpenAPI_sm_context_create_error_create(
			error_local_nonprim,
...
OpenAPI_sm_context_create_error_t *OpenAPI_sm_context_create_error_copy(
	OpenAPI_sm_context_create_error_t	*dst,
	OpenAPI_sm_context_create_error_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_sm_context_create_error_convertToJSON() failed");
		return NULL;
	}
