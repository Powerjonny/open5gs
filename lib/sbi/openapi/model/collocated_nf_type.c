...
char * OpenAPI_collocated_nf_type_ToString(
	...
	const char *collocated_nf_typeArray[] = { "NULL", "UPF", "SMF",
		                                  "MB_UPF", "MB_SMF" };
	size_t sizeofArray = sizeof(collocated_nf_typeArray) /
	                     sizeof(collocated_nf_typeArray[0]);
...
OpenAPI_collocated_nf_type_e OpenAPI_collocated_nf_type_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(collocated_nf_type,
		          collocated_nf_typeArray[stringToReturn]) == 0) {
