...
OpenAPI_query_param_combination_t *OpenAPI_query_param_combination_create(
	...
	OpenAPI_query_param_combination_t *query_param_combination_local_var =
		ogs_malloc(sizeof(OpenAPI_query_param_combination_t));
...
void OpenAPI_query_param_combination_free(
	OpenAPI_query_param_combination_t *query_param_combination) {
	...
	if(query_param_combination->query_params) {
		OpenAPI_list_for_each(query_param_combination->query_params,
		                      node) {
...
cJSON *OpenAPI_query_param_combination_convertToJSON(
	OpenAPI_query_param_combination_t *query_param_combination) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(query_param_combination == NULL) {
		ogs_error(
			"OpenAPI_query_param_combination_convertToJSON() failed [QueryParamCombination]");
		return NULL;
	}
	...
	if(!query_param_combination->query_params) {
		ogs_error(
			"OpenAPI_query_param_combination_convertToJSON() failed [query_params]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(query_param_combination->query_params, node) {
		cJSON *itemLocal =
			OpenAPI_query_parameter_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_query_param_combination_convertToJSON() failed [query_params]");
			goto end;
...
OpenAPI_query_param_combination_t *OpenAPI_query_param_combination_parseFromJSON
	...
	query_params =
		cJSON_GetObjectItemCaseSensitive(query_param_combinationJSON,
		                                 "queryParams");
	if(!query_params) {
		ogs_error(
			"OpenAPI_query_param_combination_parseFromJSON() failed [query_params]");
		goto end;
	}
	...
	cJSON_ArrayForEach(query_params_local, query_params) {
		...
		OpenAPI_query_parameter_t *query_paramsItem =
			OpenAPI_query_parameter_parseFromJSON(
				query_params_local);
		if(!query_paramsItem) {
	...
	query_param_combination_local_var =
		OpenAPI_query_param_combination_create(
			query_paramsList
			);
...
OpenAPI_query_param_combination_t *OpenAPI_query_param_combination_copy(
	OpenAPI_query_param_combination_t	*dst,
	OpenAPI_query_param_combination_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_query_param_combination_convertToJSON() failed");
		return NULL;
	}
