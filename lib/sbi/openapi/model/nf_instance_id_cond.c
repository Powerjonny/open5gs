...
OpenAPI_nf_instance_id_cond_t *OpenAPI_nf_instance_id_cond_create(
	char *nf_instance_id) {
	OpenAPI_nf_instance_id_cond_t *nf_instance_id_cond_local_var =
		ogs_malloc(sizeof(OpenAPI_nf_instance_id_cond_t));
...
void OpenAPI_nf_instance_id_cond_free(
	OpenAPI_nf_instance_id_cond_t *nf_instance_id_cond) {
...
cJSON *OpenAPI_nf_instance_id_cond_convertToJSON(
	OpenAPI_nf_instance_id_cond_t *nf_instance_id_cond) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nf_instance_id_cond == NULL) {
		ogs_error(
			"OpenAPI_nf_instance_id_cond_convertToJSON() failed [NfInstanceIdCond]");
		return NULL;
	}
	...
	if(!nf_instance_id_cond->nf_instance_id) {
		ogs_error(
			"OpenAPI_nf_instance_id_cond_convertToJSON() failed [nf_instance_id]");
		return NULL;
	}
...
OpenAPI_nf_instance_id_cond_t *OpenAPI_nf_instance_id_cond_parseFromJSON(
	cJSON *nf_instance_id_condJSON) {
	OpenAPI_nf_instance_id_cond_t *nf_instance_id_cond_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *nf_instance_id = NULL;
	nf_instance_id =
		cJSON_GetObjectItemCaseSensitive(nf_instance_id_condJSON,
		                                 "nfInstanceId");
	if(!nf_instance_id) {
		ogs_error(
			"OpenAPI_nf_instance_id_cond_parseFromJSON() failed [nf_instance_id]");
		goto end;
	}
...
OpenAPI_nf_instance_id_cond_t *OpenAPI_nf_instance_id_cond_copy(
	OpenAPI_nf_instance_id_cond_t	*dst,
	OpenAPI_nf_instance_id_cond_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
