...
OpenAPI_pei_update_info_t *OpenAPI_pei_update_info_create(char *pei) {
	OpenAPI_pei_update_info_t *pei_update_info_local_var =
		ogs_malloc(sizeof(OpenAPI_pei_update_info_t));
...
cJSON *OpenAPI_pei_update_info_convertToJSON(
	OpenAPI_pei_update_info_t *pei_update_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(pei_update_info == NULL) {
		ogs_error(
			"OpenAPI_pei_update_info_convertToJSON() failed [PeiUpdateInfo]");
		return NULL;
	}
	...
	if(!pei_update_info->pei) {
		ogs_error(
			"OpenAPI_pei_update_info_convertToJSON() failed [pei]");
		return NULL;
	}
...
OpenAPI_pei_update_info_t *OpenAPI_pei_update_info_parseFromJSON(
	...
	if(!pei) {
		ogs_error(
			"OpenAPI_pei_update_info_parseFromJSON() failed [pei]");
		goto end;
	}
...
OpenAPI_pei_update_info_t *OpenAPI_pei_update_info_copy(
	OpenAPI_pei_update_info_t *dst, OpenAPI_pei_update_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
