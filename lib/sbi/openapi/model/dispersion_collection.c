...
OpenAPI_dispersion_collection_t *OpenAPI_dispersion_collection_create(
	OpenAPI_user_location_t *ue_loc, OpenAPI_snssai_t *snssai,
	OpenAPI_list_t *supis, OpenAPI_list_t *gpsis,
	OpenAPI_list_t *app_volumes, bool is_disper_amount, int disper_amount,
	OpenAPI_dispersion_class_t *disper_class, bool is_usage_rank,
	int usage_rank, bool is_percentile_rank, int percentile_rank,
	bool is_ue_ratio, int ue_ratio, bool is_confidence, int confidence) {
	OpenAPI_dispersion_collection_t *dispersion_collection_local_var =
		ogs_malloc(sizeof(OpenAPI_dispersion_collection_t));
...
void OpenAPI_dispersion_collection_free(
	OpenAPI_dispersion_collection_t *dispersion_collection) {
	...
	if(dispersion_collection->app_volumes) {
		OpenAPI_list_for_each(dispersion_collection->app_volumes,
		                      node) {
...
cJSON *OpenAPI_dispersion_collection_convertToJSON(
	OpenAPI_dispersion_collection_t *dispersion_collection) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(dispersion_collection == NULL) {
		ogs_error(
			"OpenAPI_dispersion_collection_convertToJSON() failed [DispersionCollection]");
		return NULL;
	}
	...
	if(dispersion_collection->ue_loc) {
		...
		if(ue_loc_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [ue_loc]");
			goto end;
		}
	...
	if(dispersion_collection->snssai) {
		...
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [snssai]");
			goto end;
		}
	...
	if(dispersion_collection->supis) {
		...
		if(supisList == NULL) {
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [supis]");
			goto end;
		}
		OpenAPI_list_for_each(dispersion_collection->supis, node) {
	...
	if(dispersion_collection->gpsis) {
		...
		if(gpsisList == NULL) {
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [gpsis]");
			goto end;
		}
		OpenAPI_list_for_each(dispersion_collection->gpsis, node) {
	...
	if(dispersion_collection->app_volumes) {
		...
		if(app_volumesList == NULL) {
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [app_volumes]");
			goto end;
		}
		OpenAPI_list_for_each(dispersion_collection->app_volumes,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_application_volume_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_dispersion_collection_convertToJSON() failed [app_volumes]");
	...
	if(dispersion_collection->is_disper_amount) {
		...
		{
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [disper_amount]");
			goto end;
		}
	}
	...
	if(dispersion_collection->disper_class) {
		...
		if(disper_class_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [disper_class]");
			goto end;
		}
	...
	if(dispersion_collection->is_usage_rank) {
		...
		{
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [usage_rank]");
			goto end;
		}
	}
	...
	if(dispersion_collection->is_percentile_rank) {
		...
		{
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [percentile_rank]");
			goto end;
		}
	}
	...
	if(dispersion_collection->is_ue_ratio) {
		...
		{
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [ue_ratio]");
			goto end;
		}
	}
	...
	if(dispersion_collection->is_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_dispersion_collection_convertToJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_dispersion_collection_t *OpenAPI_dispersion_collection_parseFromJSON(
	...
	if(supis) {
		...
		if(!cJSON_IsArray(supis)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [supis]");
			goto end;
		}
	...
	if(gpsis) {
		...
		if(!cJSON_IsArray(gpsis)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [gpsis]");
			goto end;
		}
	...
	if(app_volumes) {
		...
		if(!cJSON_IsArray(app_volumes)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [app_volumes]");
			goto end;
		}
		...
		cJSON_ArrayForEach(app_volumes_local, app_volumes) {
			...
			OpenAPI_application_volume_t *app_volumesItem =
	...
	if(disper_amount) {
		if(!cJSON_IsNumber(disper_amount)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [disper_amount]");
			goto end;
		}
	}
	...
	if(disper_class) {
		disper_class_local_nonprim =
			OpenAPI_dispersion_class_parseFromJSON(disper_class);
		if(!disper_class_local_nonprim) {
			ogs_error(
				"OpenAPI_dispersion_class_parseFromJSON failed [disper_class]");
			goto end;
		}
	}
	...
	if(usage_rank) {
		if(!cJSON_IsNumber(usage_rank)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [usage_rank]");
			goto end;
		}
	}
	...
	if(percentile_rank) {
		if(!cJSON_IsNumber(percentile_rank)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [percentile_rank]");
			goto end;
		}
	}
	...
	if(ue_ratio) {
		if(!cJSON_IsNumber(ue_ratio)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [ue_ratio]");
			goto end;
		}
	}
	...
	if(confidence) {
		if(!cJSON_IsNumber(confidence)) {
			ogs_error(
				"OpenAPI_dispersion_collection_parseFromJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_dispersion_collection_t *OpenAPI_dispersion_collection_copy(
	OpenAPI_dispersion_collection_t *dst,
	OpenAPI_dispersion_collection_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_dispersion_collection_convertToJSON() failed");
		return NULL;
	}
