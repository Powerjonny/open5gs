...
OpenAPI_analytics_metadata_t *OpenAPI_analytics_metadata_create() {
	OpenAPI_analytics_metadata_t *analytics_metadata_local_var =
		ogs_malloc(sizeof(OpenAPI_analytics_metadata_t));
...
void OpenAPI_analytics_metadata_free(
	OpenAPI_analytics_metadata_t *analytics_metadata) {
...
cJSON *OpenAPI_analytics_metadata_convertToJSON(
	OpenAPI_analytics_metadata_t *analytics_metadata) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(analytics_metadata == NULL) {
		ogs_error(
			"OpenAPI_analytics_metadata_convertToJSON() failed [AnalyticsMetadata]");
		return NULL;
	}
...
OpenAPI_analytics_metadata_t *OpenAPI_analytics_metadata_parseFromJSON(
...
OpenAPI_analytics_metadata_t *OpenAPI_analytics_metadata_copy(
	OpenAPI_analytics_metadata_t *dst, OpenAPI_analytics_metadata_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
