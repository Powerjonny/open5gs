...
OpenAPI_analytics_subset_t *OpenAPI_analytics_subset_create() {
	OpenAPI_analytics_subset_t *analytics_subset_local_var =
		ogs_malloc(sizeof(OpenAPI_analytics_subset_t));
...
void OpenAPI_analytics_subset_free(
	OpenAPI_analytics_subset_t *analytics_subset) {
...
cJSON *OpenAPI_analytics_subset_convertToJSON(
	OpenAPI_analytics_subset_t *analytics_subset) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(analytics_subset == NULL) {
		ogs_error(
			"OpenAPI_analytics_subset_convertToJSON() failed [AnalyticsSubset]");
		return NULL;
	}
...
OpenAPI_analytics_subset_t *OpenAPI_analytics_subset_parseFromJSON(
	cJSON *analytics_subsetJSON) {
...
OpenAPI_analytics_subset_t *OpenAPI_analytics_subset_copy(
	OpenAPI_analytics_subset_t *dst, OpenAPI_analytics_subset_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
