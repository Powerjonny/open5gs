...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_create(
	char *supi, bool is_unauthenticated_supi, int unauthenticated_supi,
	char *pei, char *gpsi, bool is_pdu_session_id, int pdu_session_id,
	char *dnn, char *selected_dnn, OpenAPI_snssai_t *s_nssai,
	OpenAPI_snssai_t *hplmn_snssai, char *serving_nf_id,
	OpenAPI_guami_t *guami, char *service_name,
	OpenAPI_plmn_id_nid_t *serving_network,
	OpenAPI_request_type_e request_type,
	OpenAPI_ref_to_binary_data_t *n1_sm_msg, OpenAPI_access_type_e an_type,
	OpenAPI_access_type_e additional_an_type, OpenAPI_rat_type_e rat_type,
	OpenAPI_presence_state_e presence_in_ladn,
	OpenAPI_user_location_t *ue_location, char *ue_time_zone,
	OpenAPI_user_location_t *add_ue_location, char *sm_context_status_uri,
	char *h_smf_uri, char *h_smf_id, char *smf_uri, char *smf_id,
	OpenAPI_list_t *additional_hsmf_uri, OpenAPI_list_t *additional_hsmf_id,
	OpenAPI_list_t *additional_smf_uri, OpenAPI_list_t *additional_smf_id,
	bool is_old_pdu_session_id, int old_pdu_session_id,
	OpenAPI_list_t *pdu_sessions_activate_list, char *ue_eps_pdn_connection,
	OpenAPI_ho_state_e ho_state, char *pcf_id, char *pcf_group_id,
	char *pcf_set_id, char *nrf_uri, char *supported_features,
	OpenAPI_dnn_selection_mode_e sel_mode, OpenAPI_list_t *backup_amf_info,
	bool is_trace_data_null, OpenAPI_trace_data_t *trace_data,
	char *udm_group_id, char *routing_indicator, bool is_h_nw_pub_key_id,
	int h_nw_pub_key_id,
	OpenAPI_eps_interworking_indication_e eps_interworking_ind,
	bool is_indirect_forwarding_flag, int indirect_forwarding_flag,
	bool is_direct_forwarding_flag, int direct_forwarding_flag,
	OpenAPI_ng_ran_target_id_t *target_id, char *eps_bearer_ctx_status,
	bool is_cp_ciot_enabled, int cp_ciot_enabled, bool is_cp_only_ind,
	int cp_only_ind, bool is_invoke_nef, int invoke_nef,
	bool is_ma_request_ind, int ma_request_ind, bool is_ma_nw_upgrade_ind,
	int ma_nw_upgrade_ind, OpenAPI_ref_to_binary_data_t *n2_sm_info,
	OpenAPI_n2_sm_info_type_e n2_sm_info_type,
	OpenAPI_ref_to_binary_data_t *n2_sm_info_ext1,
	OpenAPI_n2_sm_info_type_e n2_sm_info_type_ext1, char *sm_context_ref,
	OpenAPI_plmn_id_nid_t *sm_context_smf_plmn_id, char *sm_context_smf_id,
	char *sm_context_smf_set_id, char *sm_context_smf_service_set_id,
	OpenAPI_sbi_binding_level_e sm_context_smf_binding,
	OpenAPI_up_cnx_state_e up_cnx_state,
	OpenAPI_small_data_rate_status_t *small_data_rate_status,
	OpenAPI_apn_rate_status_t *apn_rate_status,
	bool is_extended_nas_sm_timer_ind, int extended_nas_sm_timer_ind,
	bool is_dl_data_waiting_ind, int dl_data_waiting_ind,
	OpenAPI_ddn_failure_subs_t *ddn_failure_subs, bool is_smf_transfer_ind,
	int smf_transfer_ind, char *old_smf_id, char *old_sm_context_ref,
	OpenAPI_w_agf_info_t *w_agf_info, OpenAPI_tngf_info_t *tngf_info,
	OpenAPI_twif_info_t *twif_info, bool is_ran_unchanged_ind,
	int ran_unchanged_ind, bool is_same_pcf_selection_ind,
	int same_pcf_selection_ind, char *target_dnai, char *nrf_management_uri,
	char *nrf_discovery_uri, char *nrf_access_token_uri,
	OpenAPI_list_t *nrf_oauth2_required, char *smf_binding_info,
	OpenAPI_list_t *pvs_info, bool is_onboarding_ind, int onboarding_ind,
	char *old_pdu_session_ref, bool is_sm_policy_notify_ind,
	int sm_policy_notify_ind, bool is_pcf_ue_callback_info_null,
	OpenAPI_pcf_ue_callback_info_t *pcf_ue_callback_info,
	OpenAPI_satellite_backhaul_category_e satellite_backhaul_cat,
	bool is_upip_supported, int upip_supported, bool is_uav_authenticated,
	int uav_authenticated, bool is_disaster_roaming_ind,
	int disaster_roaming_ind, bool is_anchor_smf_oauth2_required,
	int anchor_smf_oauth2_required, bool is_sm_context_smf_oauth2_required,
	int sm_context_smf_oauth2_required) {
	OpenAPI_sm_context_create_data_t *sm_context_create_data_local_var =
		ogs_malloc(sizeof(OpenAPI_sm_context_create_data_t));
	ogs_assert(sm_context_create_data_local_var);

	sm_context_create_data_local_var->supi = supi;
	sm_context_create_data_local_var->is_unauthenticated_supi =
		is_unauthenticated_supi;
	sm_context_create_data_local_var->unauthenticated_supi =
	...
	sm_context_create_data_local_var->additional_an_type =
		additional_an_type;
	...
	sm_context_create_data_local_var->sm_context_status_uri =
	...
	sm_context_create_data_local_var->additional_hsmf_uri =
		additional_hsmf_uri;
	sm_context_create_data_local_var->additional_hsmf_id =
		additional_hsmf_id;
	sm_context_create_data_local_var->additional_smf_uri =
		additional_smf_uri;
	sm_context_create_data_local_var->additional_smf_id = additional_smf_id;
	sm_context_create_data_local_var->is_old_pdu_session_id =
		is_old_pdu_session_id;
	sm_context_create_data_local_var->old_pdu_session_id =
		old_pdu_session_id;
	sm_context_create_data_local_var->pdu_sessions_activate_list =
		pdu_sessions_activate_list;
	sm_context_create_data_local_var->ue_eps_pdn_connection =
	...
	sm_context_create_data_local_var->is_h_nw_pub_key_id =
		is_h_nw_pub_key_id;
	sm_context_create_data_local_var->h_nw_pub_key_id = h_nw_pub_key_id;
	sm_context_create_data_local_var->eps_interworking_ind =
		eps_interworking_ind;
	sm_context_create_data_local_var->is_indirect_forwarding_flag =
		is_indirect_forwarding_flag;
	sm_context_create_data_local_var->indirect_forwarding_flag =
		indirect_forwarding_flag;
	sm_context_create_data_local_var->is_direct_forwarding_flag =
		is_direct_forwarding_flag;
	sm_context_create_data_local_var->direct_forwarding_flag =
		direct_forwarding_flag;
	sm_context_create_data_local_var->target_id = target_id;
	sm_context_create_data_local_var->eps_bearer_ctx_status =
		eps_bearer_ctx_status;
	sm_context_create_data_local_var->is_cp_ciot_enabled =
		is_cp_ciot_enabled;
	...
	sm_context_create_data_local_var->is_ma_nw_upgrade_ind =
		is_ma_nw_upgrade_ind;
	...
	sm_context_create_data_local_var->n2_sm_info_type_ext1 =
		n2_sm_info_type_ext1;
	sm_context_create_data_local_var->sm_context_ref = sm_context_ref;
	sm_context_create_data_local_var->sm_context_smf_plmn_id =
		sm_context_smf_plmn_id;
	sm_context_create_data_local_var->sm_context_smf_id = sm_context_smf_id;
	sm_context_create_data_local_var->sm_context_smf_set_id =
		sm_context_smf_set_id;
	sm_context_create_data_local_var->sm_context_smf_service_set_id =
		sm_context_smf_service_set_id;
	sm_context_create_data_local_var->sm_context_smf_binding =
		sm_context_smf_binding;
	sm_context_create_data_local_var->up_cnx_state = up_cnx_state;
	sm_context_create_data_local_var->small_data_rate_status =
		small_data_rate_status;
	sm_context_create_data_local_var->apn_rate_status = apn_rate_status;
	sm_context_create_data_local_var->is_extended_nas_sm_timer_ind =
		is_extended_nas_sm_timer_ind;
	sm_context_create_data_local_var->extended_nas_sm_timer_ind =
		extended_nas_sm_timer_ind;
	sm_context_create_data_local_var->is_dl_data_waiting_ind =
		is_dl_data_waiting_ind;
	sm_context_create_data_local_var->dl_data_waiting_ind =
		dl_data_waiting_ind;
	sm_context_create_data_local_var->ddn_failure_subs = ddn_failure_subs;
	sm_context_create_data_local_var->is_smf_transfer_ind =
		is_smf_transfer_ind;
	sm_context_create_data_local_var->smf_transfer_ind = smf_transfer_ind;
	sm_context_create_data_local_var->old_smf_id = old_smf_id;
	sm_context_create_data_local_var->old_sm_context_ref =
		old_sm_context_ref;
	...
	sm_context_create_data_local_var->is_ran_unchanged_ind =
		is_ran_unchanged_ind;
	sm_context_create_data_local_var->ran_unchanged_ind = ran_unchanged_ind;
	sm_context_create_data_local_var->is_same_pcf_selection_ind =
		is_same_pcf_selection_ind;
	sm_context_create_data_local_var->same_pcf_selection_ind =
		same_pcf_selection_ind;
	sm_context_create_data_local_var->target_dnai = target_dnai;
	sm_context_create_data_local_var->nrf_management_uri =
		nrf_management_uri;
	sm_context_create_data_local_var->nrf_discovery_uri = nrf_discovery_uri;
	sm_context_create_data_local_var->nrf_access_token_uri =
		nrf_access_token_uri;
	sm_context_create_data_local_var->nrf_oauth2_required =
		nrf_oauth2_required;
	...
	sm_context_create_data_local_var->old_pdu_session_ref =
		old_pdu_session_ref;
	sm_context_create_data_local_var->is_sm_policy_notify_ind =
		is_sm_policy_notify_ind;
	sm_context_create_data_local_var->sm_policy_notify_ind =
		sm_policy_notify_ind;
	sm_context_create_data_local_var->is_pcf_ue_callback_info_null =
		is_pcf_ue_callback_info_null;
	sm_context_create_data_local_var->pcf_ue_callback_info =
		pcf_ue_callback_info;
	sm_context_create_data_local_var->satellite_backhaul_cat =
	...
	sm_context_create_data_local_var->is_uav_authenticated =
		is_uav_authenticated;
	sm_context_create_data_local_var->uav_authenticated = uav_authenticated;
	sm_context_create_data_local_var->is_disaster_roaming_ind =
		is_disaster_roaming_ind;
	sm_context_create_data_local_var->disaster_roaming_ind =
		disaster_roaming_ind;
	sm_context_create_data_local_var->is_anchor_smf_oauth2_required =
		is_anchor_smf_oauth2_required;
	sm_context_create_data_local_var->anchor_smf_oauth2_required =
		anchor_smf_oauth2_required;
	sm_context_create_data_local_var->is_sm_context_smf_oauth2_required =
		is_sm_context_smf_oauth2_required;
	sm_context_create_data_local_var->sm_context_smf_oauth2_required =
		sm_context_smf_oauth2_required;

	return sm_context_create_data_local_var;
}

void OpenAPI_sm_context_create_data_free(
	OpenAPI_sm_context_create_data_t *sm_context_create_data) {
	...
	if(sm_context_create_data->serving_network) {
		OpenAPI_plmn_id_nid_free(
			sm_context_create_data->serving_network);
		sm_context_create_data->serving_network = NULL;
	}
	if(sm_context_create_data->n1_sm_msg) {
		OpenAPI_ref_to_binary_data_free(
			sm_context_create_data->n1_sm_msg);
	...
	if(sm_context_create_data->additional_hsmf_uri) {
		OpenAPI_list_for_each(
			sm_context_create_data->additional_hsmf_uri, node) {
			ogs_free(node->data);
		}
	...
	if(sm_context_create_data->additional_hsmf_id) {
		OpenAPI_list_for_each(
			sm_context_create_data->additional_hsmf_id, node) {
			ogs_free(node->data);
		}
	...
	if(sm_context_create_data->additional_smf_uri) {
		OpenAPI_list_for_each(
			sm_context_create_data->additional_smf_uri, node) {
			ogs_free(node->data);
		}
	...
	if(sm_context_create_data->additional_smf_id) {
		OpenAPI_list_for_each(sm_context_create_data->additional_smf_id,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(sm_context_create_data->pdu_sessions_activate_list) {
		OpenAPI_list_for_each(
			sm_context_create_data->pdu_sessions_activate_list,
			node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
	...
	if(sm_context_create_data->backup_amf_info) {
		OpenAPI_list_for_each(sm_context_create_data->backup_amf_info,
		                      node) {
	...
	if(sm_context_create_data->target_id) {
		OpenAPI_ng_ran_target_id_free(
			sm_context_create_data->target_id);
	...
	if(sm_context_create_data->sm_context_smf_plmn_id) {
		OpenAPI_plmn_id_nid_free(
			sm_context_create_data->sm_context_smf_plmn_id);
	...
	if(sm_context_create_data->nrf_oauth2_required) {
		OpenAPI_list_for_each(
			sm_context_create_data->nrf_oauth2_required, node) {
	...
	if(sm_context_create_data->pcf_ue_callback_info) {
		OpenAPI_pcf_ue_callback_info_free(
			sm_context_create_data->pcf_ue_callback_info);
		sm_context_create_data->pcf_ue_callback_info = NULL;
	}
	ogs_free(sm_context_create_data);
}

cJSON *OpenAPI_sm_context_create_data_convertToJSON(
	OpenAPI_sm_context_create_data_t *sm_context_create_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(sm_context_create_data == NULL) {
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [SmContextCreateData]");
		return NULL;
	}
	...
	if(sm_context_create_data->supi) {
		if(cJSON_AddStringToObject(item, "supi",
		                           sm_context_create_data->supi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [supi]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->is_unauthenticated_supi) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [unauthenticated_supi]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->pei) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->gpsi) {
		if(cJSON_AddStringToObject(item, "gpsi",
		                           sm_context_create_data->gpsi) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->is_pdu_session_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pdu_session_id]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->selected_dnn) {
		if(cJSON_AddStringToObject(item, "selectedDnn",
		                           sm_context_create_data->selected_dnn)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [selected_dnn]");
			goto end;
		}
	}

	if(sm_context_create_data->s_nssai) {
		cJSON *s_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				sm_context_create_data->s_nssai);
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(sm_context_create_data->hplmn_snssai) {
		cJSON *hplmn_snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				sm_context_create_data->hplmn_snssai);
		if(hplmn_snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [hplmn_snssai]");
			goto end;
		}
		cJSON_AddItemToObject(item, "hplmnSnssai",
		                      hplmn_snssai_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [hplmn_snssai]");
			goto end;
	...
	if(!sm_context_create_data->serving_nf_id) {
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [serving_nf_id]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "servingNfId",
	                           sm_context_create_data->serving_nf_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [serving_nf_id]");
	...
	if(sm_context_create_data->guami) {
		cJSON *guami_local_JSON =
			OpenAPI_guami_convertToJSON(
				sm_context_create_data->guami);
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [guami]");
			goto end;
		}
	...
	if(sm_context_create_data->service_name) {
		if(cJSON_AddStringToObject(item, "serviceName",
		                           sm_context_create_data->service_name)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [service_name]");
			goto end;
		}
	}
	...
	if(!sm_context_create_data->serving_network) {
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [serving_network]");
		return NULL;
	}
	cJSON *serving_network_local_JSON =
	...
	if(sm_context_create_data->request_type != OpenAPI_request_type_NULL) {
		if(cJSON_AddStringToObject(item, "requestType",
		                           OpenAPI_request_type_ToString(
						   sm_context_create_data->
						   request_type)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [request_type]");
			goto end;
		}
	}

	if(sm_context_create_data->n1_sm_msg) {
		cJSON *n1_sm_msg_local_JSON =
			OpenAPI_ref_to_binary_data_convertToJSON(
				sm_context_create_data->n1_sm_msg);
		if(n1_sm_msg_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [n1_sm_msg]");
			goto end;
		}
	...
	if(sm_context_create_data->an_type == OpenAPI_access_type_NULL) {
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [an_type]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "anType",
	                           OpenAPI_access_type_ToString(
					   sm_context_create_data->an_type)) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [an_type]");
	...
	{
		if(cJSON_AddStringToObject(item, "additionalAnType",
		                           OpenAPI_access_type_ToString(
						   sm_context_create_data->
						   additional_an_type)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_an_type]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->rat_type != OpenAPI_rat_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [rat_type]");
			goto end;
		}
	}

	if(sm_context_create_data->presence_in_ladn !=
	   OpenAPI_presence_state_NULL)
	{
		if(cJSON_AddStringToObject(item, "presenceInLadn",
		                           OpenAPI_presence_state_ToString(
						   sm_context_create_data->
						   presence_in_ladn)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [presence_in_ladn]");
			goto end;
		}
	}

	if(sm_context_create_data->ue_location) {
		cJSON *ue_location_local_JSON =
			OpenAPI_user_location_convertToJSON(
				sm_context_create_data->ue_location);
		if(ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ue_location]");
			goto end;
		}
		cJSON_AddItemToObject(item, "ueLocation",
		                      ue_location_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ue_location]");
			goto end;
	...
	if(sm_context_create_data->ue_time_zone) {
		if(cJSON_AddStringToObject(item, "ueTimeZone",
		                           sm_context_create_data->ue_time_zone)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ue_time_zone]");
			goto end;
		}
	}

	if(sm_context_create_data->add_ue_location) {
		cJSON *add_ue_location_local_JSON =
			OpenAPI_user_location_convertToJSON(
				sm_context_create_data->add_ue_location);
		if(add_ue_location_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [add_ue_location]");
			goto end;
		}
		cJSON_AddItemToObject(item, "addUeLocation",
		                      add_ue_location_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [add_ue_location]");
			goto end;
	...
	if(!sm_context_create_data->sm_context_status_uri) {
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_status_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "smContextStatusUri",
	                           sm_context_create_data->sm_context_status_uri)
	   == NULL)
	{
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_status_uri]");
	...
	if(sm_context_create_data->h_smf_uri) {
		if(cJSON_AddStringToObject(item, "hSmfUri",
		                           sm_context_create_data->h_smf_uri) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [h_smf_uri]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->h_smf_id) {
		if(cJSON_AddStringToObject(item, "hSmfId",
		                           sm_context_create_data->h_smf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [h_smf_id]");
			goto end;
		}
	}

	if(sm_context_create_data->smf_uri) {
		if(cJSON_AddStringToObject(item, "smfUri",
		                           sm_context_create_data->smf_uri) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [smf_uri]");
			goto end;
		}
	}

	if(sm_context_create_data->smf_id) {
		if(cJSON_AddStringToObject(item, "smfId",
		                           sm_context_create_data->smf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [smf_id]");
			goto end;
		}
	}

	if(sm_context_create_data->additional_hsmf_uri) {
		cJSON *additional_hsmf_uriList = cJSON_AddArrayToObject(item,
		                                                        "additionalHsmfUri");
		if(additional_hsmf_uriList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_hsmf_uri]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_create_data->additional_hsmf_uri, node) {
			if(cJSON_AddStringToObject(additional_hsmf_uriList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_hsmf_uri]");
	...
	if(sm_context_create_data->additional_hsmf_id) {
		cJSON *additional_hsmf_idList = cJSON_AddArrayToObject(item,
		                                                       "additionalHsmfId");
		if(additional_hsmf_idList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_hsmf_id]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_create_data->additional_hsmf_id, node) {
			if(cJSON_AddStringToObject(additional_hsmf_idList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_hsmf_id]");
	...
	if(sm_context_create_data->additional_smf_uri) {
		cJSON *additional_smf_uriList = cJSON_AddArrayToObject(item,
		                                                       "additionalSmfUri");
		if(additional_smf_uriList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_smf_uri]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_create_data->additional_smf_uri, node) {
			if(cJSON_AddStringToObject(additional_smf_uriList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_smf_uri]");
	...
	if(sm_context_create_data->additional_smf_id) {
		cJSON *additional_smf_idList = cJSON_AddArrayToObject(item,
		                                                      "additionalSmfId");
		if(additional_smf_idList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_smf_id]");
			goto end;
		}
		OpenAPI_list_for_each(sm_context_create_data->additional_smf_id,
		                      node) {
			if(cJSON_AddStringToObject(additional_smf_idList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_sm_context_create_data_convertToJSON() failed [additional_smf_id]");
	...
	if(sm_context_create_data->is_old_pdu_session_id) {
		if(cJSON_AddNumberToObject(item, "oldPduSessionId",
		                           sm_context_create_data->
		                           old_pdu_session_id) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [old_pdu_session_id]");
			goto end;
		}
	}

	if(sm_context_create_data->pdu_sessions_activate_list) {
		cJSON *pdu_sessions_activate_listList =
			cJSON_AddArrayToObject(item, "pduSessionsActivateList");
		if(pdu_sessions_activate_listList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pdu_sessions_activate_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			sm_context_create_data->pdu_sessions_activate_list,
	...
	if(sm_context_create_data->ue_eps_pdn_connection) {
		if(cJSON_AddStringToObject(item, "ueEpsPdnConnection",
		                           sm_context_create_data->
		                           ue_eps_pdn_connection) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ue_eps_pdn_connection]");
			goto end;
		}
	}

	if(sm_context_create_data->ho_state != OpenAPI_ho_state_NULL) {
		if(cJSON_AddStringToObject(item, "hoState",
		                           OpenAPI_ho_state_ToString(
						   sm_context_create_data->
						   ho_state)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ho_state]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->pcf_id) {
		if(cJSON_AddStringToObject(item, "pcfId",
		                           sm_context_create_data->pcf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_id]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->pcf_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_group_id]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->pcf_set_id) {
		if(cJSON_AddStringToObject(item, "pcfSetId",
		                           sm_context_create_data->pcf_set_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_set_id]");
			goto end;
		}
	}

	if(sm_context_create_data->nrf_uri) {
		if(cJSON_AddStringToObject(item, "nrfUri",
		                           sm_context_create_data->nrf_uri) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_uri]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}

	if(sm_context_create_data->sel_mode !=
	   OpenAPI_dnn_selection_mode_NULL)
	{
		if(cJSON_AddStringToObject(item, "selMode",
		                           OpenAPI_dnn_selection_mode_ToString(
						   sm_context_create_data->
						   sel_mode)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sel_mode]");
			goto end;
		}
	}

	if(sm_context_create_data->backup_amf_info) {
		cJSON *backup_amf_infoList = cJSON_AddArrayToObject(item,
		                                                    "backupAmfInfo");
		if(backup_amf_infoList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [backup_amf_info]");
			goto end;
		}
		OpenAPI_list_for_each(sm_context_create_data->backup_amf_info,
		                      node) {
			cJSON *itemLocal =
				OpenAPI_backup_amf_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_sm_context_create_data_convertToJSON() failed [backup_amf_info]");
	...
	if(sm_context_create_data->trace_data) {
		cJSON *trace_data_local_JSON =
			OpenAPI_trace_data_convertToJSON(
				sm_context_create_data->trace_data);
		if(trace_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [trace_data]");
			goto end;
		}
	...
	if(sm_context_create_data->udm_group_id) {
		if(cJSON_AddStringToObject(item, "udmGroupId",
		                           sm_context_create_data->udm_group_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [udm_group_id]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->routing_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [routing_indicator]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->is_h_nw_pub_key_id) {
		if(cJSON_AddNumberToObject(item, "hNwPubKeyId",
		                           sm_context_create_data->
		                           h_nw_pub_key_id) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [h_nw_pub_key_id]");
			goto end;
		}
	}

	if(sm_context_create_data->eps_interworking_ind !=
	   OpenAPI_eps_interworking_indication_NULL)
	{
		if(cJSON_AddStringToObject(item, "epsInterworkingInd",
		                           OpenAPI_eps_interworking_indication_ToString
		                                   (sm_context_create_data->
		                                   eps_interworking_ind)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [eps_interworking_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->is_indirect_forwarding_flag) {
		if(cJSON_AddBoolToObject(item, "indirectForwardingFlag",
		                         sm_context_create_data->
		                         indirect_forwarding_flag) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [indirect_forwarding_flag]");
			goto end;
		}
	}

	if(sm_context_create_data->is_direct_forwarding_flag) {
		if(cJSON_AddBoolToObject(item, "directForwardingFlag",
		                         sm_context_create_data->
		                         direct_forwarding_flag) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [direct_forwarding_flag]");
			goto end;
		}
	}

	if(sm_context_create_data->target_id) {
		cJSON *target_id_local_JSON =
			OpenAPI_ng_ran_target_id_convertToJSON(
				sm_context_create_data->target_id);
		if(target_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [target_id]");
			goto end;
		}
	...
	if(sm_context_create_data->eps_bearer_ctx_status) {
		if(cJSON_AddStringToObject(item, "epsBearerCtxStatus",
		                           sm_context_create_data->
		                           eps_bearer_ctx_status) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [eps_bearer_ctx_status]");
			goto end;
		}
	}

	if(sm_context_create_data->is_cp_ciot_enabled) {
		if(cJSON_AddBoolToObject(item, "cpCiotEnabled",
		                         sm_context_create_data->cp_ciot_enabled)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [cp_ciot_enabled]");
			goto end;
		}
	}

	if(sm_context_create_data->is_cp_only_ind) {
		if(cJSON_AddBoolToObject(item, "cpOnlyInd",
		                         sm_context_create_data->cp_only_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [cp_only_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->is_invoke_nef) {
		if(cJSON_AddBoolToObject(item, "invokeNef",
		                         sm_context_create_data->invoke_nef) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [invoke_nef]");
			goto end;
		}
	}

	if(sm_context_create_data->is_ma_request_ind) {
		if(cJSON_AddBoolToObject(item, "maRequestInd",
		                         sm_context_create_data->ma_request_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ma_request_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->is_ma_nw_upgrade_ind) {
		if(cJSON_AddBoolToObject(item, "maNwUpgradeInd",
		                         sm_context_create_data->
		                         ma_nw_upgrade_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->n2_sm_info) {
		cJSON *n2_sm_info_local_JSON =
			OpenAPI_ref_to_binary_data_convertToJSON(
				sm_context_create_data->n2_sm_info);
		if(n2_sm_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info]");
			goto end;
		}
	...
	{
		if(cJSON_AddStringToObject(item, "n2SmInfoType",
		                           OpenAPI_n2_sm_info_type_ToString(
						   sm_context_create_data->
						   n2_sm_info_type)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type]");
			goto end;
		}
	}

	if(sm_context_create_data->n2_sm_info_ext1) {
		cJSON *n2_sm_info_ext1_local_JSON =
			OpenAPI_ref_to_binary_data_convertToJSON(
				sm_context_create_data->n2_sm_info_ext1);
		if(n2_sm_info_ext1_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_ext1]");
			goto end;
		}
		cJSON_AddItemToObject(item, "n2SmInfoExt1",
		                      n2_sm_info_ext1_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_ext1]");
			goto end;
	...
	if(sm_context_create_data->n2_sm_info_type_ext1 !=
	   OpenAPI_n2_sm_info_type_NULL)
	{
		if(cJSON_AddStringToObject(item, "n2SmInfoTypeExt1",
		                           OpenAPI_n2_sm_info_type_ToString(
						   sm_context_create_data->
						   n2_sm_info_type_ext1)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type_ext1]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->sm_context_ref) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_ref]");
			goto end;
		}
	}

	if(sm_context_create_data->sm_context_smf_plmn_id) {
		cJSON *sm_context_smf_plmn_id_local_JSON =
			OpenAPI_plmn_id_nid_convertToJSON(
				sm_context_create_data->sm_context_smf_plmn_id);
		if(sm_context_smf_plmn_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_plmn_id]");
			goto end;
		}
		cJSON_AddItemToObject(item, "smContextSmfPlmnId",
		                      sm_context_smf_plmn_id_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_plmn_id]");
			goto end;
	...
	if(sm_context_create_data->sm_context_smf_id) {
		if(cJSON_AddStringToObject(item, "smContextSmfId",
		                           sm_context_create_data->
		                           sm_context_smf_id) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_id]");
			goto end;
		}
	}

	if(sm_context_create_data->sm_context_smf_set_id) {
		if(cJSON_AddStringToObject(item, "smContextSmfSetId",
		                           sm_context_create_data->
		                           sm_context_smf_set_id) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_set_id]");
			goto end;
		}
	}

	if(sm_context_create_data->sm_context_smf_service_set_id) {
		if(cJSON_AddStringToObject(item, "smContextSmfServiceSetId",
		                           sm_context_create_data->
		                           sm_context_smf_service_set_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_service_set_id]");
			goto end;
		}
	}

	if(sm_context_create_data->sm_context_smf_binding !=
	   OpenAPI_sbi_binding_level_NULL)
	{
		if(cJSON_AddStringToObject(item, "smContextSmfBinding",
		                           OpenAPI_sbi_binding_level_ToString(
						   sm_context_create_data->
						   sm_context_smf_binding)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_binding]");
			goto end;
		}
	}

	if(sm_context_create_data->up_cnx_state != OpenAPI_up_cnx_state_NULL) {
		if(cJSON_AddStringToObject(item, "upCnxState",
		                           OpenAPI_up_cnx_state_ToString(
						   sm_context_create_data->
						   up_cnx_state)) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [up_cnx_state]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->small_data_rate_status) {
		cJSON *small_data_rate_status_local_JSON =
			OpenAPI_small_data_rate_status_convertToJSON(
				sm_context_create_data->small_data_rate_status);
		if(small_data_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [small_data_rate_status]");
			goto end;
		}
	...
	if(sm_context_create_data->apn_rate_status) {
		cJSON *apn_rate_status_local_JSON =
			OpenAPI_apn_rate_status_convertToJSON(
				sm_context_create_data->apn_rate_status);
		if(apn_rate_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [apn_rate_status]");
			goto end;
		}
		cJSON_AddItemToObject(item, "apnRateStatus",
		                      apn_rate_status_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [apn_rate_status]");
			goto end;
	...
	if(sm_context_create_data->is_extended_nas_sm_timer_ind) {
		if(cJSON_AddBoolToObject(item, "extendedNasSmTimerInd",
		                         sm_context_create_data->
		                         extended_nas_sm_timer_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [extended_nas_sm_timer_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->is_dl_data_waiting_ind) {
		if(cJSON_AddBoolToObject(item, "dlDataWaitingInd",
		                         sm_context_create_data->
		                         dl_data_waiting_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [dl_data_waiting_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->ddn_failure_subs) {
		cJSON *ddn_failure_subs_local_JSON =
			OpenAPI_ddn_failure_subs_convertToJSON(
				sm_context_create_data->ddn_failure_subs);
		if(ddn_failure_subs_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ddn_failure_subs]");
			goto end;
		}
		cJSON_AddItemToObject(item, "ddnFailureSubs",
		                      ddn_failure_subs_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ddn_failure_subs]");
			goto end;
	...
	if(sm_context_create_data->is_smf_transfer_ind) {
		if(cJSON_AddBoolToObject(item, "smfTransferInd",
		                         sm_context_create_data->
		                         smf_transfer_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [smf_transfer_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->old_smf_id) {
		if(cJSON_AddStringToObject(item, "oldSmfId",
		                           sm_context_create_data->old_smf_id)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [old_smf_id]");
			goto end;
		}
	}

	if(sm_context_create_data->old_sm_context_ref) {
		if(cJSON_AddStringToObject(item, "oldSmContextRef",
		                           sm_context_create_data->
		                           old_sm_context_ref) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [old_sm_context_ref]");
			goto end;
		}
	}

	if(sm_context_create_data->w_agf_info) {
		cJSON *w_agf_info_local_JSON =
			OpenAPI_w_agf_info_convertToJSON(
				sm_context_create_data->w_agf_info);
		if(w_agf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [w_agf_info]");
			goto end;
		}
	...
	if(sm_context_create_data->tngf_info) {
		cJSON *tngf_info_local_JSON =
			OpenAPI_tngf_info_convertToJSON(
				sm_context_create_data->tngf_info);
		if(tngf_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [tngf_info]");
			goto end;
		}
	...
	if(sm_context_create_data->twif_info) {
		cJSON *twif_info_local_JSON =
			OpenAPI_twif_info_convertToJSON(
				sm_context_create_data->twif_info);
		if(twif_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [twif_info]");
			goto end;
		}
	...
	if(sm_context_create_data->is_ran_unchanged_ind) {
		if(cJSON_AddBoolToObject(item, "ranUnchangedInd",
		                         sm_context_create_data->
		                         ran_unchanged_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [ran_unchanged_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->is_same_pcf_selection_ind) {
		if(cJSON_AddBoolToObject(item, "samePcfSelectionInd",
		                         sm_context_create_data->
		                         same_pcf_selection_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [same_pcf_selection_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->target_dnai) {
		if(cJSON_AddStringToObject(item, "targetDnai",
		                           sm_context_create_data->target_dnai)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [target_dnai]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->nrf_management_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_management_uri]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->nrf_discovery_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_discovery_uri]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->nrf_access_token_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_access_token_uri]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->nrf_oauth2_required) {
		...
		if(nrf_oauth2_required == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [nrf_oauth2_required]");
			goto end;
		}
		...
		if(sm_context_create_data->nrf_oauth2_required) {
			OpenAPI_list_for_each(
				...
				{
					ogs_error(
						"OpenAPI_sm_context_create_data_convertToJSON() failed [inner]");
					goto end;
				}
			}
		}
	...
	if(sm_context_create_data->smf_binding_info) {
		if(cJSON_AddStringToObject(item, "smfBindingInfo",
		                           sm_context_create_data->
		                           smf_binding_info) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [smf_binding_info]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->pvs_info) {
		...
		if(pvs_infoList == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pvs_info]");
			goto end;
		}
		OpenAPI_list_for_each(sm_context_create_data->pvs_info, node) {
			cJSON *itemLocal =
				OpenAPI_server_addressing_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_sm_context_create_data_convertToJSON() failed [pvs_info]");
	...
	if(sm_context_create_data->is_onboarding_ind) {
		if(cJSON_AddBoolToObject(item, "onboardingInd",
		                         sm_context_create_data->onboarding_ind)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [onboarding_ind]");
			goto end;
		}
	}

	if(sm_context_create_data->old_pdu_session_ref) {
		if(cJSON_AddStringToObject(item, "oldPduSessionRef",
		                           sm_context_create_data->
		                           old_pdu_session_ref) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [old_pdu_session_ref]");
			goto end;
		}
	}

	if(sm_context_create_data->is_sm_policy_notify_ind) {
		if(cJSON_AddBoolToObject(item, "smPolicyNotifyInd",
		                         sm_context_create_data->
		                         sm_policy_notify_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->pcf_ue_callback_info) {
		...
		if(pcf_ue_callback_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [pcf_ue_callback_info]");
			goto end;
		}
	...
	if(sm_context_create_data->satellite_backhaul_cat !=
	   OpenAPI_satellite_backhaul_category_NULL)
	{
		if(cJSON_AddStringToObject(item, "satelliteBackhaulCat",
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
	}

	if(sm_context_create_data->is_upip_supported) {
		if(cJSON_AddBoolToObject(item, "upipSupported",
		                         sm_context_create_data->upip_supported)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [upip_supported]");
			goto end;
		}
	}

	if(sm_context_create_data->is_uav_authenticated) {
		if(cJSON_AddBoolToObject(item, "uavAuthenticated",
		                         sm_context_create_data->
		                         uav_authenticated) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [uav_authenticated]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->is_disaster_roaming_ind) {
		if(cJSON_AddBoolToObject(item, "disasterRoamingInd",
		                         sm_context_create_data->
		                         disaster_roaming_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [disaster_roaming_ind]");
			goto end;
		}
	}
	...
	if(sm_context_create_data->is_anchor_smf_oauth2_required) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [anchor_smf_oauth2_required]");
			goto end;
		}
	}

	if(sm_context_create_data->is_sm_context_smf_oauth2_required) {
		if(cJSON_AddBoolToObject(item, "smContextSmfOauth2Required",
		                         sm_context_create_data->
		                         sm_context_smf_oauth2_required) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_convertToJSON() failed [sm_context_smf_oauth2_required]");
			goto end;
		}
	}
...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_parseFromJSON(
	cJSON *sm_context_create_dataJSON) {
	OpenAPI_sm_context_create_data_t *sm_context_create_data_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *supi = NULL;
	...
	OpenAPI_small_data_rate_status_t *small_data_rate_status_local_nonprim =
		NULL;
	...
	OpenAPI_pcf_ue_callback_info_t *pcf_ue_callback_info_local_nonprim =
		NULL;
	cJSON *satellite_backhaul_cat = NULL;
	OpenAPI_satellite_backhaul_category_e satellite_backhaul_catVariable =
		0;
	...
	supi = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                        "supi");
	if(supi) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [supi]");
			goto end;
		}
	}

	unauthenticated_supi =
		cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
		                                 "unauthenticatedSupi");
	if(unauthenticated_supi) {
		if(!cJSON_IsBool(unauthenticated_supi)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [unauthenticated_supi]");
			goto end;
		}
	}

	pei = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                       "pei");
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pei]");
			goto end;
		}
	}

	gpsi = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                        "gpsi");
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(pdu_session_id) {
		if(!cJSON_IsNumber(pdu_session_id)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pdu_session_id]");
			goto end;
		}
	}

	dnn = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                       "dnn");
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(selected_dnn) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [selected_dnn]");
			goto end;
		}
	}

	s_nssai = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                           "sNssai");
	if(s_nssai) {
		s_nssai_local_nonprim = OpenAPI_snssai_parseFromJSON(s_nssai);
		if(!s_nssai_local_nonprim) {
			ogs_error(
				"OpenAPI_snssai_parseFromJSON failed [s_nssai]");
			goto end;
		}
	}
	...
	hplmn_snssai =
		cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
		                                 "hplmnSnssai");
	if(hplmn_snssai) {
		hplmn_snssai_local_nonprim =
			OpenAPI_snssai_parseFromJSON(hplmn_snssai);
		if(!hplmn_snssai_local_nonprim) {
			ogs_error(
				"OpenAPI_snssai_parseFromJSON failed [hplmn_snssai]");
			goto end;
		}
	}
	...
	if(!serving_nf_id) {
		ogs_error(
			"OpenAPI_sm_context_create_data_parseFromJSON() failed [serving_nf_id]");
		goto end;
	}
	...
	guami = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                         "guami");
	if(guami) {
	...
	if(service_name) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [service_name]");
			goto end;
		}
	}
	...
	if(!serving_network) {
		ogs_error(
			"OpenAPI_sm_context_create_data_parseFromJSON() failed [serving_network]");
		goto end;
	}
	serving_network_local_nonprim =
		OpenAPI_plmn_id_nid_parseFromJSON(serving_network);
	if(!serving_network_local_nonprim) {
		ogs_error(
			"OpenAPI_plmn_id_nid_parseFromJSON failed [serving_network]");
		goto end;
	}
	...
	if(request_type) {
		if(!cJSON_IsString(request_type)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [request_type]");
			goto end;
		}
		request_typeVariable =
			OpenAPI_request_type_FromString(
				request_type->valuestring);
	}

	n1_sm_msg = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                             "n1SmMsg");
	if(n1_sm_msg) {
		n1_sm_msg_local_nonprim =
			OpenAPI_ref_to_binary_data_parseFromJSON(n1_sm_msg);
		if(!n1_sm_msg_local_nonprim) {
			ogs_error(
				"OpenAPI_ref_to_binary_data_parseFromJSON failed [n1_sm_msg]");
			goto end;
		}
	}

	an_type = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                           "anType");
	if(!an_type) {
		ogs_error(
			"OpenAPI_sm_context_create_data_parseFromJSON() failed [an_type]");
		goto end;
	}
	...
	if(additional_an_type) {
		if(!cJSON_IsString(additional_an_type)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_an_type]");
			goto end;
		}
		additional_an_typeVariable =
			OpenAPI_access_type_FromString(
				additional_an_type->valuestring);
	}

	rat_type = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                            "ratType");
	if(rat_type) {
		if(!cJSON_IsString(rat_type)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [rat_type]");
			goto end;
		}
		rat_typeVariable =
	...
	if(presence_in_ladn) {
		if(!cJSON_IsString(presence_in_ladn)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [presence_in_ladn]");
			goto end;
		}
		presence_in_ladnVariable =
			OpenAPI_presence_state_FromString(
				presence_in_ladn->valuestring);
	}
	...
	if(ue_location) {
		ue_location_local_nonprim =
			OpenAPI_user_location_parseFromJSON(ue_location);
		if(!ue_location_local_nonprim) {
			ogs_error(
				"OpenAPI_user_location_parseFromJSON failed [ue_location]");
			goto end;
		}
	}
	...
	if(ue_time_zone) {
		if(!cJSON_IsString(ue_time_zone) &&
		   !cJSON_IsNull(ue_time_zone))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [ue_time_zone]");
			goto end;
		}
	}
	...
	if(add_ue_location) {
		add_ue_location_local_nonprim =
			OpenAPI_user_location_parseFromJSON(add_ue_location);
		if(!add_ue_location_local_nonprim) {
			ogs_error(
				"OpenAPI_user_location_parseFromJSON failed [add_ue_location]");
			goto end;
		}
	}
	...
	if(!sm_context_status_uri) {
		ogs_error(
			"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_status_uri]");
		goto end;
	}
	...
	h_smf_uri = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                             "hSmfUri");
	if(h_smf_uri) {
		if(!cJSON_IsString(h_smf_uri) &&
		   !cJSON_IsNull(h_smf_uri))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [h_smf_uri]");
			goto end;
		}
	}

	h_smf_id = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                            "hSmfId");
	if(h_smf_id) {
		if(!cJSON_IsString(h_smf_id) &&
		   !cJSON_IsNull(h_smf_id))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [h_smf_id]");
			goto end;
		}
	}

	smf_uri = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                           "smfUri");
	if(smf_uri) {
		if(!cJSON_IsString(smf_uri) &&
		   !cJSON_IsNull(smf_uri))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_uri]");
			goto end;
		}
	}

	smf_id = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                          "smfId");
	if(smf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_id]");
			goto end;
		}
	}
	...
	if(additional_hsmf_uri) {
		...
		if(!cJSON_IsArray(additional_hsmf_uri)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_hsmf_uri]");
			goto end;
		}

		additional_hsmf_uriList = OpenAPI_list_create();

		cJSON_ArrayForEach(additional_hsmf_uri_local,
		                   additional_hsmf_uri) {
			...
			OpenAPI_list_add(additional_hsmf_uriList,
			                 ogs_strdup(
	...
	if(additional_hsmf_id) {
		...
		if(!cJSON_IsArray(additional_hsmf_id)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_hsmf_id]");
			goto end;
		}

		additional_hsmf_idList = OpenAPI_list_create();

		cJSON_ArrayForEach(additional_hsmf_id_local,
		                   additional_hsmf_id) {
			double *localDouble = NULL;
			int *localInt = NULL;
			...
			OpenAPI_list_add(additional_hsmf_idList,
			                 ogs_strdup(
						 additional_hsmf_id_local->
						 valuestring));
		}
	}
	...
	if(additional_smf_uri) {
		...
		if(!cJSON_IsArray(additional_smf_uri)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_smf_uri]");
			goto end;
		}

		additional_smf_uriList = OpenAPI_list_create();

		cJSON_ArrayForEach(additional_smf_uri_local,
		                   additional_smf_uri) {
			double *localDouble = NULL;
			int *localInt = NULL;
			...
			OpenAPI_list_add(additional_smf_uriList,
			                 ogs_strdup(
						 additional_smf_uri_local->
						 valuestring));
		}
	}
	...
	if(additional_smf_id) {
		...
		if(!cJSON_IsArray(additional_smf_id)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [additional_smf_id]");
			goto end;
		}
		...
		cJSON_ArrayForEach(additional_smf_id_local, additional_smf_id) {
			...
			OpenAPI_list_add(additional_smf_idList,
			                 ogs_strdup(
						 additional_smf_id_local->
						 valuestring));
		}
	}
	...
	if(old_pdu_session_id) {
		if(!cJSON_IsNumber(old_pdu_session_id)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [old_pdu_session_id]");
			goto end;
		}
	}
	...
	if(pdu_sessions_activate_list) {
		...
		if(!cJSON_IsArray(pdu_sessions_activate_list)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pdu_sessions_activate_list]");
			goto end;
		}

		pdu_sessions_activate_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(pdu_sessions_activate_list_local,
		                   pdu_sessions_activate_list) {
			double *localDouble = NULL;
			int *localInt = NULL;
			...
			*localDouble =
				pdu_sessions_activate_list_local->valuedouble;
			OpenAPI_list_add(pdu_sessions_activate_listList,
			                 localDouble);
		}
	}
	...
	if(ue_eps_pdn_connection) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [ue_eps_pdn_connection]");
			goto end;
		}
	}

	ho_state = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                            "hoState");
	if(ho_state) {
		if(!cJSON_IsString(ho_state)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [ho_state]");
			goto end;
		}
		ho_stateVariable =
			OpenAPI_ho_state_FromString(ho_state->valuestring);
	}

	pcf_id = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                          "pcfId");
	if(pcf_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pcf_id]");
			goto end;
		}
	}
	...
	if(pcf_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pcf_group_id]");
			goto end;
		}
	}
	...
	if(pcf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pcf_set_id]");
			goto end;
		}
	}

	nrf_uri = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                           "nrfUri");
	if(nrf_uri) {
		if(!cJSON_IsString(nrf_uri) &&
		   !cJSON_IsNull(nrf_uri))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_uri]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	sel_mode = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                            "selMode");
	if(sel_mode) {
		if(!cJSON_IsString(sel_mode)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sel_mode]");
			goto end;
		}
		sel_modeVariable =
			OpenAPI_dnn_selection_mode_FromString(
				sel_mode->valuestring);
	}
	...
	if(backup_amf_info) {
		...
		if(!cJSON_IsArray(backup_amf_info)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [backup_amf_info]");
			goto end;
		}
		...
		cJSON_ArrayForEach(backup_amf_info_local, backup_amf_info) {
			...
			OpenAPI_backup_amf_info_t *backup_amf_infoItem =
				OpenAPI_backup_amf_info_parseFromJSON(
					backup_amf_info_local);
			if(!backup_amf_infoItem) {
				ogs_error("No backup_amf_infoItem");
				goto end;
			}
			OpenAPI_list_add(backup_amf_infoList,
			                 backup_amf_infoItem);
		}
	}
	...
	if(trace_data) {
		if(!cJSON_IsNull(trace_data)) {
			trace_data_local_nonprim =
				OpenAPI_trace_data_parseFromJSON(trace_data);
			if(!trace_data_local_nonprim) {
				ogs_error(
					"OpenAPI_trace_data_parseFromJSON failed [trace_data]");
				goto end;
			}
		}
	}
	...
	if(udm_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [udm_group_id]");
			goto end;
		}
	}
	...
	if(routing_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [routing_indicator]");
			goto end;
		}
	}
	...
	if(h_nw_pub_key_id) {
		if(!cJSON_IsNumber(h_nw_pub_key_id)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [h_nw_pub_key_id]");
			goto end;
		}
	}
	...
	if(eps_interworking_ind) {
		if(!cJSON_IsString(eps_interworking_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [eps_interworking_ind]");
			goto end;
		}
		eps_interworking_indVariable =
			OpenAPI_eps_interworking_indication_FromString(
				eps_interworking_ind->valuestring);
	}
	...
	if(indirect_forwarding_flag) {
		if(!cJSON_IsBool(indirect_forwarding_flag)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [indirect_forwarding_flag]");
			goto end;
		}
	}
	...
	if(direct_forwarding_flag) {
		if(!cJSON_IsBool(direct_forwarding_flag)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [direct_forwarding_flag]");
			goto end;
		}
	}

	target_id = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                             "targetId");
	if(target_id) {
		target_id_local_nonprim =
			OpenAPI_ng_ran_target_id_parseFromJSON(target_id);
		if(!target_id_local_nonprim) {
			ogs_error(
				"OpenAPI_ng_ran_target_id_parseFromJSON failed [target_id]");
			goto end;
		}
	}
	...
	if(eps_bearer_ctx_status) {
		if(!cJSON_IsString(eps_bearer_ctx_status) &&
		   !cJSON_IsNull(eps_bearer_ctx_status))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [eps_bearer_ctx_status]");
			goto end;
		}
	}
	...
	if(cp_ciot_enabled) {
		if(!cJSON_IsBool(cp_ciot_enabled)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [cp_ciot_enabled]");
			goto end;
		}
	}
	...
	if(cp_only_ind) {
		if(!cJSON_IsBool(cp_only_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [cp_only_ind]");
			goto end;
		}
	}
	...
	if(invoke_nef) {
		if(!cJSON_IsBool(invoke_nef)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [invoke_nef]");
			goto end;
		}
	}
	...
	if(ma_request_ind) {
		if(!cJSON_IsBool(ma_request_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [ma_request_ind]");
			goto end;
		}
	}
	...
	if(ma_nw_upgrade_ind) {
		if(!cJSON_IsBool(ma_nw_upgrade_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [ma_nw_upgrade_ind]");
			goto end;
		}
	}
	...
	if(n2_sm_info) {
		n2_sm_info_local_nonprim =
			OpenAPI_ref_to_binary_data_parseFromJSON(n2_sm_info);
		if(!n2_sm_info_local_nonprim) {
			ogs_error(
				"OpenAPI_ref_to_binary_data_parseFromJSON failed [n2_sm_info]");
			goto end;
		}
	}
	...
	if(n2_sm_info_type) {
		if(!cJSON_IsString(n2_sm_info_type)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [n2_sm_info_type]");
			goto end;
		}
		n2_sm_info_typeVariable =
			OpenAPI_n2_sm_info_type_FromString(
				n2_sm_info_type->valuestring);
	}
	...
	n2_sm_info_ext1 =
		cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
		                                 "n2SmInfoExt1");
	if(n2_sm_info_ext1) {
		n2_sm_info_ext1_local_nonprim =
			OpenAPI_ref_to_binary_data_parseFromJSON(
				n2_sm_info_ext1);
		if(!n2_sm_info_ext1_local_nonprim) {
			ogs_error(
				"OpenAPI_ref_to_binary_data_parseFromJSON failed [n2_sm_info_ext1]");
			goto end;
		}
	}
	...
	if(n2_sm_info_type_ext1) {
		if(!cJSON_IsString(n2_sm_info_type_ext1)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [n2_sm_info_type_ext1]");
			goto end;
		}
		n2_sm_info_type_ext1Variable =
			OpenAPI_n2_sm_info_type_FromString(
				n2_sm_info_type_ext1->valuestring);
	}
	...
	if(sm_context_ref) {
		if(!cJSON_IsString(sm_context_ref) &&
		   !cJSON_IsNull(sm_context_ref))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_ref]");
			goto end;
		}
	}
	...
	if(sm_context_smf_plmn_id) {
		...
		if(!sm_context_smf_plmn_id_local_nonprim) {
			ogs_error(
				"OpenAPI_plmn_id_nid_parseFromJSON failed [sm_context_smf_plmn_id]");
			goto end;
		}
	}
	...
	if(sm_context_smf_id) {
		if(!cJSON_IsString(sm_context_smf_id) &&
		   !cJSON_IsNull(sm_context_smf_id))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_id]");
			goto end;
		}
	}
	...
	if(sm_context_smf_set_id) {
		if(!cJSON_IsString(sm_context_smf_set_id) &&
		   !cJSON_IsNull(sm_context_smf_set_id))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_set_id]");
			goto end;
		}
	}
	...
	if(sm_context_smf_service_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_service_set_id]");
			goto end;
		}
	}
	...
	if(sm_context_smf_binding) {
		if(!cJSON_IsString(sm_context_smf_binding)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_binding]");
			goto end;
		}
		sm_context_smf_bindingVariable =
			OpenAPI_sbi_binding_level_FromString(
	...
	if(up_cnx_state) {
		if(!cJSON_IsString(up_cnx_state)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [up_cnx_state]");
			goto end;
		}
		up_cnx_stateVariable =
			OpenAPI_up_cnx_state_FromString(
				up_cnx_state->valuestring);
	}
	...
	if(small_data_rate_status) {
		...
		if(!small_data_rate_status_local_nonprim) {
			ogs_error(
				"OpenAPI_small_data_rate_status_parseFromJSON failed [small_data_rate_status]");
			goto end;
		}
	}
	...
	if(apn_rate_status) {
		apn_rate_status_local_nonprim =
			OpenAPI_apn_rate_status_parseFromJSON(apn_rate_status);
		if(!apn_rate_status_local_nonprim) {
			ogs_error(
				"OpenAPI_apn_rate_status_parseFromJSON failed [apn_rate_status]");
			goto end;
		}
	}
	...
	if(extended_nas_sm_timer_ind) {
		if(!cJSON_IsBool(extended_nas_sm_timer_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [extended_nas_sm_timer_ind]");
			goto end;
		}
	}
	...
	if(dl_data_waiting_ind) {
		if(!cJSON_IsBool(dl_data_waiting_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [dl_data_waiting_ind]");
			goto end;
		}
	}
	...
	if(ddn_failure_subs) {
		...
		if(!ddn_failure_subs_local_nonprim) {
			ogs_error(
				"OpenAPI_ddn_failure_subs_parseFromJSON failed [ddn_failure_subs]");
			goto end;
		}
	}
	...
	if(smf_transfer_ind) {
		if(!cJSON_IsBool(smf_transfer_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_transfer_ind]");
			goto end;
		}
	}
	...
	if(old_smf_id) {
		if(!cJSON_IsString(old_smf_id) &&
		   !cJSON_IsNull(old_smf_id))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [old_smf_id]");
			goto end;
		}
	}
	...
	if(old_sm_context_ref) {
		if(!cJSON_IsString(old_sm_context_ref) &&
		   !cJSON_IsNull(old_sm_context_ref))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [old_sm_context_ref]");
			goto end;
		}
	}
	...
	w_agf_info =
		cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
		                                 "wAgfInfo");
	if(w_agf_info) {
		w_agf_info_local_nonprim =
			OpenAPI_w_agf_info_parseFromJSON(w_agf_info);
		if(!w_agf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_w_agf_info_parseFromJSON failed [w_agf_info]");
			goto end;
		}
	}

	tngf_info = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                             "tngfInfo");
	if(tngf_info) {
		tngf_info_local_nonprim =
			OpenAPI_tngf_info_parseFromJSON(tngf_info);
		if(!tngf_info_local_nonprim) {
			ogs_error(
				"OpenAPI_tngf_info_parseFromJSON failed [tngf_info]");
			goto end;
		}
	}

	twif_info = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                             "twifInfo");
	if(twif_info) {
		...
		if(!twif_info_local_nonprim) {
			ogs_error(
				"OpenAPI_twif_info_parseFromJSON failed [twif_info]");
			goto end;
		}
	}
	...
	if(ran_unchanged_ind) {
		if(!cJSON_IsBool(ran_unchanged_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [ran_unchanged_ind]");
			goto end;
		}
	}
	...
	if(same_pcf_selection_ind) {
		if(!cJSON_IsBool(same_pcf_selection_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [same_pcf_selection_ind]");
			goto end;
		}
	}
	...
	target_dnai =
		cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
		                                 "targetDnai");
	if(target_dnai) {
		if(!cJSON_IsString(target_dnai) &&
		   !cJSON_IsNull(target_dnai))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [target_dnai]");
			goto end;
		}
	}
	...
	if(nrf_management_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_management_uri]");
			goto end;
		}
	}
	...
	if(nrf_discovery_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_discovery_uri]");
			goto end;
		}
	}
	...
	if(nrf_access_token_uri) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_access_token_uri]");
			goto end;
		}
	}
	...
	if(nrf_oauth2_required) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [nrf_oauth2_required]");
			goto end;
		}
		if(cJSON_IsObject(nrf_oauth2_required)) {
			...
			cJSON_ArrayForEach(nrf_oauth2_required_local_map,
				...
				if(!cJSON_IsBool(localMapObject)) {
					ogs_error(
						"OpenAPI_sm_context_create_data_parseFromJSON() failed [inner]");
					goto end;
				}
				...
				*localInt = localMapObject->valueint;
				localMapKeyPair =
					OpenAPI_map_create(ogs_strdup(
								   ...
								   ->string),
					                   localInt);
				OpenAPI_list_add(nrf_oauth2_requiredList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(smf_binding_info) {
		...
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [smf_binding_info]");
			goto end;
		}
	}

	pvs_info = cJSON_GetObjectItemCaseSensitive(sm_context_create_dataJSON,
	                                            "pvsInfo");
	if(pvs_info) {
		cJSON *pvs_info_local = NULL;
		if(!cJSON_IsArray(pvs_info)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [pvs_info]");
			goto end;
		}
		...
		cJSON_ArrayForEach(pvs_info_local, pvs_info) {
			...
			OpenAPI_server_addressing_info_t *pvs_infoItem =
				OpenAPI_server_addressing_info_parseFromJSON(
					pvs_info_local);
			if(!pvs_infoItem) {
	...
	if(onboarding_ind) {
		if(!cJSON_IsBool(onboarding_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [onboarding_ind]");
			goto end;
		}
	}
	...
	if(old_pdu_session_ref) {
		if(!cJSON_IsString(old_pdu_session_ref) &&
		   !cJSON_IsNull(old_pdu_session_ref))
		{
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [old_pdu_session_ref]");
			goto end;
		}
	}
	...
	if(sm_policy_notify_ind) {
		if(!cJSON_IsBool(sm_policy_notify_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_policy_notify_ind]");
			goto end;
		}
	}
	...
	if(pcf_ue_callback_info) {
		if(!cJSON_IsNull(pcf_ue_callback_info)) {
			...
			if(!pcf_ue_callback_info_local_nonprim) {
				ogs_error(
					"OpenAPI_pcf_ue_callback_info_parseFromJSON failed [pcf_ue_callback_info]");
				goto end;
			}
		}
	}
	...
	if(satellite_backhaul_cat) {
		if(!cJSON_IsString(satellite_backhaul_cat)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [satellite_backhaul_cat]");
			goto end;
		}
		satellite_backhaul_catVariable =
			OpenAPI_satellite_backhaul_category_FromString(
				satellite_backhaul_cat->valuestring);
	}
	...
	if(upip_supported) {
		if(!cJSON_IsBool(upip_supported)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [upip_supported]");
			goto end;
		}
	}
	...
	if(uav_authenticated) {
		if(!cJSON_IsBool(uav_authenticated)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [uav_authenticated]");
			goto end;
		}
	}
	...
	if(disaster_roaming_ind) {
		if(!cJSON_IsBool(disaster_roaming_ind)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [disaster_roaming_ind]");
			goto end;
		}
	}
	...
	if(anchor_smf_oauth2_required) {
		if(!cJSON_IsBool(anchor_smf_oauth2_required)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [anchor_smf_oauth2_required]");
			goto end;
		}
	}
	...
	if(sm_context_smf_oauth2_required) {
		if(!cJSON_IsBool(sm_context_smf_oauth2_required)) {
			ogs_error(
				"OpenAPI_sm_context_create_data_parseFromJSON() failed [sm_context_smf_oauth2_required]");
			goto end;
		}
	}

	sm_context_create_data_local_var =
		OpenAPI_sm_context_create_data_create(
			supi &&
			!cJSON_IsNull(supi) ? ogs_strdup(supi->valuestring) :
			NULL,
			unauthenticated_supi ? true : false,
			unauthenticated_supi ? unauthenticated_supi->valueint :
			0,
			pei &&
			...
			selected_dnn &&
			!cJSON_IsNull(selected_dnn) ?
			ogs_strdup(selected_dnn->valuestring) : NULL,
			...
			ue_time_zone &&
			!cJSON_IsNull(ue_time_zone) ?
			ogs_strdup(ue_time_zone->valuestring) : NULL,
			add_ue_location ? add_ue_location_local_nonprim : NULL,
			ogs_strdup(sm_context_status_uri->valuestring),
			h_smf_uri &&
			!cJSON_IsNull(h_smf_uri) ?
			ogs_strdup(h_smf_uri->valuestring) :
			NULL,
			h_smf_id &&
			!cJSON_IsNull(h_smf_id) ?
			ogs_strdup(h_smf_id->valuestring) :
			NULL,
			smf_uri &&
			!cJSON_IsNull(smf_uri) ?
			ogs_strdup(smf_uri->valuestring) :
			NULL,
			smf_id &&
			!cJSON_IsNull(smf_id) ?
			ogs_strdup(smf_id->valuestring) : NULL,
			...
			ue_eps_pdn_connection &&
			!cJSON_IsNull(ue_eps_pdn_connection) ?
			ogs_strdup(ue_eps_pdn_connection->valuestring) : NULL,
			ho_state ? ho_stateVariable : 0,
			pcf_id &&
			!cJSON_IsNull(pcf_id) ?
			ogs_strdup(pcf_id->valuestring) : NULL,
			pcf_group_id &&
			!cJSON_IsNull(pcf_group_id) ?
			ogs_strdup(pcf_group_id->valuestring) : NULL,
			pcf_set_id &&
			!cJSON_IsNull(pcf_set_id) ?
			ogs_strdup(pcf_set_id->valuestring) : NULL,
			nrf_uri &&
			!cJSON_IsNull(nrf_uri) ?
			ogs_strdup(nrf_uri->valuestring) :
			NULL,
			supported_features &&
			!cJSON_IsNull(supported_features) ?
			...
			udm_group_id &&
			!cJSON_IsNull(udm_group_id) ?
			ogs_strdup(udm_group_id->valuestring) : NULL,
			routing_indicator &&
			!cJSON_IsNull(routing_indicator) ?
			...
			indirect_forwarding_flag ?
			indirect_forwarding_flag->valueint :
			0,
			direct_forwarding_flag ? true : false,
			direct_forwarding_flag ?
			direct_forwarding_flag->valueint : 0,
			target_id ? target_id_local_nonprim : NULL,
			eps_bearer_ctx_status &&
			!cJSON_IsNull(eps_bearer_ctx_status) ?
			ogs_strdup(eps_bearer_ctx_status->valuestring) : NULL,
			...
			sm_context_ref &&
			!cJSON_IsNull(sm_context_ref) ?
			ogs_strdup(sm_context_ref->valuestring) : NULL,
			sm_context_smf_plmn_id ?
			sm_context_smf_plmn_id_local_nonprim :
			NULL,
			sm_context_smf_id &&
			!cJSON_IsNull(sm_context_smf_id) ?
			ogs_strdup(sm_context_smf_id->valuestring) : NULL,
			sm_context_smf_set_id &&
			!cJSON_IsNull(sm_context_smf_set_id) ?
			ogs_strdup(sm_context_smf_set_id->valuestring) : NULL,
			sm_context_smf_service_set_id &&
			!cJSON_IsNull(sm_context_smf_service_set_id) ?
			ogs_strdup(sm_context_smf_service_set_id->valuestring) :
			NULL,
			sm_context_smf_binding ?
			sm_context_smf_bindingVariable : 0,
			...
			extended_nas_sm_timer_ind ?
			extended_nas_sm_timer_ind->valueint : 0,
			dl_data_waiting_ind ? true : false,
			dl_data_waiting_ind ? dl_data_waiting_ind->valueint : 0,
			ddn_failure_subs ? ddn_failure_subs_local_nonprim :
			NULL,
			smf_transfer_ind ? true : false,
			smf_transfer_ind ? smf_transfer_ind->valueint : 0,
			old_smf_id &&
			!cJSON_IsNull(old_smf_id) ?
			ogs_strdup(old_smf_id->valuestring) : NULL,
			old_sm_context_ref &&
			!cJSON_IsNull(old_sm_context_ref) ?
			ogs_strdup(old_sm_context_ref->valuestring) : NULL,
			...
			same_pcf_selection_ind ?
			same_pcf_selection_ind->valueint : 0,
			target_dnai &&
			!cJSON_IsNull(target_dnai) ?
			ogs_strdup(target_dnai->valuestring) : NULL,
			nrf_management_uri &&
			!cJSON_IsNull(nrf_management_uri) ?
			ogs_strdup(nrf_management_uri->valuestring) : NULL,
			nrf_discovery_uri &&
			!cJSON_IsNull(nrf_discovery_uri) ?
			ogs_strdup(nrf_discovery_uri->valuestring) : NULL,
			nrf_access_token_uri &&
			!cJSON_IsNull(nrf_access_token_uri) ?
			ogs_strdup(nrf_access_token_uri->valuestring) : NULL,
			nrf_oauth2_required ? nrf_oauth2_requiredList : NULL,
			smf_binding_info &&
			!cJSON_IsNull(smf_binding_info) ?
			ogs_strdup(smf_binding_info->valuestring) : NULL,
			pvs_info ? pvs_infoList : NULL,
			onboarding_ind ? true : false,
			onboarding_ind ? onboarding_ind->valueint : 0,
			old_pdu_session_ref &&
			!cJSON_IsNull(old_pdu_session_ref) ?
			ogs_strdup(old_pdu_session_ref->valuestring) : NULL,
			sm_policy_notify_ind ? true : false,
			sm_policy_notify_ind ? sm_policy_notify_ind->valueint :
			0,
			pcf_ue_callback_info &&
			cJSON_IsNull(pcf_ue_callback_info) ? true : false,
			pcf_ue_callback_info ?
			pcf_ue_callback_info_local_nonprim :
			NULL,
			satellite_backhaul_cat ?
			satellite_backhaul_catVariable : 0,
			...
			disaster_roaming_ind ? disaster_roaming_ind->valueint :
			0,
			anchor_smf_oauth2_required ? true : false,
			anchor_smf_oauth2_required ?
			anchor_smf_oauth2_required->valueint : 0,
			sm_context_smf_oauth2_required ? true : false,
			sm_context_smf_oauth2_required ?
			sm_context_smf_oauth2_required->valueint : 0
			);
...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_copy(
	OpenAPI_sm_context_create_data_t	*dst,
	OpenAPI_sm_context_create_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_sm_context_create_data_convertToJSON() failed");
		return NULL;
	}
