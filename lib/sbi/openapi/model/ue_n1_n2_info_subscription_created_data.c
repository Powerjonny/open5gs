...
OpenAPI_ue_n1_n2_info_subscription_created_data_create(
	...
	OpenAPI_ue_n1_n2_info_subscription_created_data_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_ue_n1_n2_info_subscription_created_data_t));
...
void OpenAPI_ue_n1_n2_info_subscription_created_data_free(
	OpenAPI_ue_n1_n2_info_subscription_created_data_t *
...
cJSON *OpenAPI_ue_n1_n2_info_subscription_created_data_convertToJSON(
	OpenAPI_ue_n1_n2_info_subscription_created_data_t *
	ue_n1_n2_info_subscription_created_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_n1_n2_info_subscription_created_data == NULL) {
		ogs_error(
			"OpenAPI_ue_n1_n2_info_subscription_created_data_convertToJSON() failed [UeN1N2InfoSubscriptionCreatedData]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_ue_n1_n2_info_subscription_created_data_convertToJSON() failed [n1n2_notify_subscription_id]");
		return NULL;
	}
	...
	if(ue_n1_n2_info_subscription_created_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_created_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_ue_n1_n2_info_subscription_created_data_t *
OpenAPI_ue_n1_n2_info_subscription_created_data_parseFromJSON(
	...
	if(!n1n2_notify_subscription_id) {
		ogs_error(
			"OpenAPI_ue_n1_n2_info_subscription_created_data_parseFromJSON() failed [n1n2_notify_subscription_id]");
		goto end;
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_created_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_ue_n1_n2_info_subscription_created_data_t *
OpenAPI_ue_n1_n2_info_subscription_created_data_copy(
	OpenAPI_ue_n1_n2_info_subscription_created_data_t	*dst,
	OpenAPI_ue_n1_n2_info_subscription_created_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_ue_n1_n2_info_subscription_created_data_convertToJSON(
			src);
	if(!item) {
		ogs_error(
			"OpenAPI_ue_n1_n2_info_subscription_created_data_convertToJSON() failed");
		return NULL;
	}
