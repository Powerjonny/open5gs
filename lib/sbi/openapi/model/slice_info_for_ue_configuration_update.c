...
OpenAPI_slice_info_for_ue_configuration_update_create(
	...
	int default_configured_snssai_ind, OpenAPI_list_t *requested_nssai,
	OpenAPI_list_t *mapping_of_nssai, bool is_ue_sup_nssrg_ind,
	int ue_sup_nssrg_ind, bool is_suppress_nssrg_ind,
	int suppress_nssrg_ind, OpenAPI_list_t *rejected_nssai_ra,
	bool is_nsag_supported, int nsag_supported) {
	OpenAPI_slice_info_for_ue_configuration_update_t *
	        slice_info_for_ue_configuration_update_local_var =
		ogs_malloc(
			sizeof(OpenAPI_slice_info_for_ue_configuration_update_t));
	ogs_assert(slice_info_for_ue_configuration_update_local_var);

	slice_info_for_ue_configuration_update_local_var->subscribed_nssai =
		subscribed_nssai;
	slice_info_for_ue_configuration_update_local_var->
	allowed_nssai_current_access = allowed_nssai_current_access;
	slice_info_for_ue_configuration_update_local_var->
	allowed_nssai_other_access = allowed_nssai_other_access;
	slice_info_for_ue_configuration_update_local_var->
	is_default_configured_snssai_ind = is_default_configured_snssai_ind;
	slice_info_for_ue_configuration_update_local_var->
	default_configured_snssai_ind = default_configured_snssai_ind;
	slice_info_for_ue_configuration_update_local_var->requested_nssai =
		requested_nssai;
	slice_info_for_ue_configuration_update_local_var->mapping_of_nssai =
		mapping_of_nssai;
	slice_info_for_ue_configuration_update_local_var->is_ue_sup_nssrg_ind =
		is_ue_sup_nssrg_ind;
	slice_info_for_ue_configuration_update_local_var->ue_sup_nssrg_ind =
		ue_sup_nssrg_ind;
	slice_info_for_ue_configuration_update_local_var->is_suppress_nssrg_ind
	        = is_suppress_nssrg_ind;
	slice_info_for_ue_configuration_update_local_var->suppress_nssrg_ind =
		suppress_nssrg_ind;
	slice_info_for_ue_configuration_update_local_var->rejected_nssai_ra =
		rejected_nssai_ra;
	slice_info_for_ue_configuration_update_local_var->is_nsag_supported =
		is_nsag_supported;
	slice_info_for_ue_configuration_update_local_var->nsag_supported =
		nsag_supported;

	return slice_info_for_ue_configuration_update_local_var;
}

void OpenAPI_slice_info_for_ue_configuration_update_free(
	OpenAPI_slice_info_for_ue_configuration_update_t *
	...
	if(slice_info_for_ue_configuration_update->allowed_nssai_current_access)
	{
		...
		slice_info_for_ue_configuration_update->
		allowed_nssai_current_access = NULL;
	}
	if(slice_info_for_ue_configuration_update->allowed_nssai_other_access) {
		...
		slice_info_for_ue_configuration_update->
		allowed_nssai_other_access = NULL;
	}
...
cJSON *OpenAPI_slice_info_for_ue_configuration_update_convertToJSON(
	...
	if(slice_info_for_ue_configuration_update == NULL) {
		ogs_error(
			"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [SliceInfoForUEConfigurationUpdate]");
		return NULL;
	}
	...
	if(slice_info_for_ue_configuration_update->subscribed_nssai) {
		...
		if(subscribed_nssaiList == NULL) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [subscribed_nssai]");
			goto end;
		}
		OpenAPI_list_for_each(
			slice_info_for_ue_configuration_update->subscribed_nssai,
	...
	if(slice_info_for_ue_configuration_update->allowed_nssai_current_access)
	{
		...
		if(allowed_nssai_current_access_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [allowed_nssai_current_access]");
			goto end;
		}
	...
	if(slice_info_for_ue_configuration_update->allowed_nssai_other_access) {
		...
		if(allowed_nssai_other_access_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [allowed_nssai_other_access]");
			goto end;
		}
	...
	if(slice_info_for_ue_configuration_update->
	   is_default_configured_snssai_ind)
	{
		...
		{
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [default_configured_snssai_ind]");
			goto end;
		}
	}
	...
	if(slice_info_for_ue_configuration_update->requested_nssai) {
		...
		if(requested_nssaiList == NULL) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [requested_nssai]");
			goto end;
		}
		OpenAPI_list_for_each(
			slice_info_for_ue_configuration_update->requested_nssai,
	...
	if(slice_info_for_ue_configuration_update->mapping_of_nssai) {
		...
		if(mapping_of_nssaiList == NULL) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [mapping_of_nssai]");
			goto end;
		}
		OpenAPI_list_for_each(
			slice_info_for_ue_configuration_update->mapping_of_nssai,
	...
	if(slice_info_for_ue_configuration_update->is_ue_sup_nssrg_ind) {
		...
		{
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [ue_sup_nssrg_ind]");
			goto end;
		}
	}
	...
	if(slice_info_for_ue_configuration_update->is_suppress_nssrg_ind) {
		...
		{
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [suppress_nssrg_ind]");
			goto end;
		}
	}

	if(slice_info_for_ue_configuration_update->rejected_nssai_ra) {
		cJSON *rejected_nssai_raList = cJSON_AddArrayToObject(item,
		                                                      "rejectedNssaiRa");
		if(rejected_nssai_raList == NULL) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [rejected_nssai_ra]");
			goto end;
		}
		OpenAPI_list_for_each(
			slice_info_for_ue_configuration_update->
	...
	if(slice_info_for_ue_configuration_update->is_nsag_supported) {
		...
		{
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed [nsag_supported]");
			goto end;
		}
	}
...
OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON(
	cJSON *slice_info_for_ue_configuration_updateJSON) {
	OpenAPI_slice_info_for_ue_configuration_update_t *
	        slice_info_for_ue_configuration_update_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	subscribed_nssai =
		cJSON_GetObjectItemCaseSensitive(
			slice_info_for_ue_configuration_updateJSON,
			"subscribedNssai");
	if(subscribed_nssai) {
		cJSON *subscribed_nssai_local = NULL;
		if(!cJSON_IsArray(subscribed_nssai)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [subscribed_nssai]");
			goto end;
		}
	...
	if(default_configured_snssai_ind) {
		if(!cJSON_IsBool(default_configured_snssai_ind)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [default_configured_snssai_ind]");
			goto end;
		}
	}
	...
	if(requested_nssai) {
		...
		if(!cJSON_IsArray(requested_nssai)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [requested_nssai]");
			goto end;
		}
	...
	if(mapping_of_nssai) {
		...
		if(!cJSON_IsArray(mapping_of_nssai)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [mapping_of_nssai]");
			goto end;
		}
	...
	if(ue_sup_nssrg_ind) {
		if(!cJSON_IsBool(ue_sup_nssrg_ind)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [ue_sup_nssrg_ind]");
			goto end;
		}
	}
	...
	if(suppress_nssrg_ind) {
		if(!cJSON_IsBool(suppress_nssrg_ind)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [suppress_nssrg_ind]");
			goto end;
		}
	}
	...
	if(rejected_nssai_ra) {
		...
		if(!cJSON_IsArray(rejected_nssai_ra)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [rejected_nssai_ra]");
			goto end;
		}
		...
		cJSON_ArrayForEach(rejected_nssai_ra_local, rejected_nssai_ra) {
			...
			OpenAPI_snssai_t *rejected_nssai_raItem =
				OpenAPI_snssai_parseFromJSON(
					rejected_nssai_ra_local);
			if(!rejected_nssai_raItem) {
				ogs_error("No rejected_nssai_raItem");
				goto end;
			}
			OpenAPI_list_add(rejected_nssai_raList,
			                 rejected_nssai_raItem);
		}
	}
	...
	if(nsag_supported) {
		if(!cJSON_IsBool(nsag_supported)) {
			ogs_error(
				"OpenAPI_slice_info_for_ue_configuration_update_parseFromJSON() failed [nsag_supported]");
			goto end;
		}
	}
...
OpenAPI_slice_info_for_ue_configuration_update_copy(
	OpenAPI_slice_info_for_ue_configuration_update_t	*dst,
	OpenAPI_slice_info_for_ue_configuration_update_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_slice_info_for_ue_configuration_update_convertToJSON() failed");
		return NULL;
	}
