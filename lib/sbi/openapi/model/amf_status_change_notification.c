...
OpenAPI_amf_status_change_notification_create(
	...
	OpenAPI_amf_status_change_notification_t *
		...
		ogs_malloc(sizeof(OpenAPI_amf_status_change_notification_t));
...
void OpenAPI_amf_status_change_notification_free(
	OpenAPI_amf_status_change_notification_t *amf_status_change_notification)
{
...
cJSON *OpenAPI_amf_status_change_notification_convertToJSON(
	OpenAPI_amf_status_change_notification_t *amf_status_change_notification)
{
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(amf_status_change_notification == NULL) {
		ogs_error(
			"OpenAPI_amf_status_change_notification_convertToJSON() failed [AmfStatusChangeNotification]");
		return NULL;
	}
	...
	if(!amf_status_change_notification->amf_status_info_list) {
		ogs_error(
			"OpenAPI_amf_status_change_notification_convertToJSON() failed [amf_status_info_list]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(
		amf_status_change_notification->amf_status_info_list, node) {
		cJSON *itemLocal =
			OpenAPI_amf_status_info_convertToJSON(node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_amf_status_change_notification_convertToJSON() failed [amf_status_info_list]");
			goto end;
...
OpenAPI_amf_status_change_notification_parseFromJSON(
	...
	amf_status_info_list =
		cJSON_GetObjectItemCaseSensitive(
			amf_status_change_notificationJSON,
			"amfStatusInfoList");
	if(!amf_status_info_list) {
		ogs_error(
			"OpenAPI_amf_status_change_notification_parseFromJSON() failed [amf_status_info_list]");
		goto end;
	}
	...
	cJSON_ArrayForEach(amf_status_info_list_local, amf_status_info_list) {
		...
		OpenAPI_amf_status_info_t *amf_status_info_listItem =
			OpenAPI_amf_status_info_parseFromJSON(
				amf_status_info_list_local);
...
OpenAPI_amf_status_change_notification_copy(
	...
	OpenAPI_amf_status_change_notification_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_amf_status_change_notification_convertToJSON() failed");
		return NULL;
	}
