...
OpenAPI_session_management_subscription_data_1_create(
	OpenAPI_snssai_t *single_nssai, OpenAPI_list_t *dnn_configurations,
	...
	char *_3gpp_charging_characteristics, char *supported_features) {
	OpenAPI_session_management_subscription_data_1_t *
	        session_management_subscription_data_1_local_var =
		ogs_malloc(
			sizeof(OpenAPI_session_management_subscription_data_1_t));
	ogs_assert(session_management_subscription_data_1_local_var);

	session_management_subscription_data_1_local_var->single_nssai =
		single_nssai;
	session_management_subscription_data_1_local_var->dnn_configurations =
		dnn_configurations;
	session_management_subscription_data_1_local_var->internal_group_ids =
		internal_group_ids;
	session_management_subscription_data_1_local_var->
	shared_vn_group_data_ids = shared_vn_group_data_ids;
	session_management_subscription_data_1_local_var->
	shared_dnn_configurations_id = shared_dnn_configurations_id;
	session_management_subscription_data_1_local_var->odb_packet_services =
		odb_packet_services;
	session_management_subscription_data_1_local_var->is_trace_data_null =
		is_trace_data_null;
	session_management_subscription_data_1_local_var->trace_data =
		trace_data;
	session_management_subscription_data_1_local_var->shared_trace_data_id =
		shared_trace_data_id;
	session_management_subscription_data_1_local_var->
	expected_ue_behaviours_list = expected_ue_behaviours_list;
	session_management_subscription_data_1_local_var->
...
void OpenAPI_session_management_subscription_data_1_free(
	OpenAPI_session_management_subscription_data_1_t *
	...
	if(session_management_subscription_data_1->dnn_configurations) {
		...
		OpenAPI_list_free(
			session_management_subscription_data_1->
			dnn_configurations);
		session_management_subscription_data_1->dnn_configurations =
			NULL;
	}
	if(session_management_subscription_data_1->internal_group_ids) {
		...
		OpenAPI_list_free(
			session_management_subscription_data_1->
			internal_group_ids);
		session_management_subscription_data_1->internal_group_ids =
			NULL;
	}
	...
	if(session_management_subscription_data_1->shared_dnn_configurations_id)
	{
		...
		session_management_subscription_data_1->
		shared_dnn_configurations_id = NULL;
	}
	if(session_management_subscription_data_1->trace_data) {
		OpenAPI_trace_data_free(
			session_management_subscription_data_1->trace_data);
	...
	if(session_management_subscription_data_1->shared_trace_data_id) {
		ogs_free(
			session_management_subscription_data_1->
			shared_trace_data_id);
		session_management_subscription_data_1->shared_trace_data_id =
			NULL;
	}
	if(session_management_subscription_data_1->expected_ue_behaviours_list)
	{
		OpenAPI_list_for_each(
			session_management_subscription_data_1->
			expected_ue_behaviours_list, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
		...
		session_management_subscription_data_1->
		expected_ue_behaviours_list = NULL;
	}
	if(session_management_subscription_data_1->suggested_packet_num_dl_list)
	{
		OpenAPI_list_for_each(
			session_management_subscription_data_1->
			suggested_packet_num_dl_list, node) {
			OpenAPI_map_t *localKeyValue =
				(OpenAPI_map_t *) node->data;
			ogs_free(localKeyValue->key);
			OpenAPI_suggested_packet_num_dl_1_free(
				localKeyValue->value);
			OpenAPI_map_free(localKeyValue);
		}
		OpenAPI_list_free(
		...
		session_management_subscription_data_1->
		suggested_packet_num_dl_list = NULL;
	}
	if(session_management_subscription_data_1->
	   _3gpp_charging_characteristics)
	{
		ogs_free(
			...
			_3gpp_charging_characteristics);
		session_management_subscription_data_1->
		_3gpp_charging_characteristics = NULL;
	}
	if(session_management_subscription_data_1->supported_features) {
		ogs_free(
			session_management_subscription_data_1->
			supported_features);
		session_management_subscription_data_1->supported_features =
			NULL;
	}
	ogs_free(session_management_subscription_data_1);
}

cJSON *OpenAPI_session_management_subscription_data_1_convertToJSON(
	OpenAPI_session_management_subscription_data_1_t *
	session_management_subscription_data_1) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(session_management_subscription_data_1 == NULL) {
		ogs_error(
			"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [SessionManagementSubscriptionData_1]");
		return NULL;
	}
	...
	if(!session_management_subscription_data_1->single_nssai) {
		ogs_error(
			"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [single_nssai]");
		return NULL;
	}
	...
	if(session_management_subscription_data_1->dnn_configurations) {
		cJSON *dnn_configurations = cJSON_AddObjectToObject(item,
		                                                    "dnnConfigurations");
		if(dnn_configurations == NULL) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [dnn_configurations]");
			goto end;
		}
		...
		if(session_management_subscription_data_1->dnn_configurations) {
			OpenAPI_list_for_each(
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_dnn_configuration_1_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
					ogs_error(
						"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [inner]");
					goto end;
				}
	...
	if(session_management_subscription_data_1->internal_group_ids) {
		...
		if(internal_group_idsList == NULL) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [internal_group_ids]");
			goto end;
		}
		OpenAPI_list_for_each(
			session_management_subscription_data_1->
	...
	if(session_management_subscription_data_1->shared_vn_group_data_ids) {
		...
		if(shared_vn_group_data_ids == NULL) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [shared_vn_group_data_ids]");
			goto end;
		}
	...
	if(session_management_subscription_data_1->shared_dnn_configurations_id)
	{
		if(cJSON_AddStringToObject(item, "sharedDnnConfigurationsId",
		                           session_management_subscription_data_1
		                           ->shared_dnn_configurations_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [shared_dnn_configurations_id]");
			goto end;
		}
	}
	   ...
	   OpenAPI_odb_packet_services_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [odb_packet_services]");
			goto end;
		}
	}
	...
	if(session_management_subscription_data_1->trace_data) {
		...
		if(trace_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [trace_data]");
			goto end;
		}
	...
	if(session_management_subscription_data_1->shared_trace_data_id) {
		if(cJSON_AddStringToObject(item, "sharedTraceDataId",
		                           session_management_subscription_data_1
		                           ->shared_trace_data_id) == NULL)
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [shared_trace_data_id]");
			goto end;
		}
	}
	...
	if(session_management_subscription_data_1->expected_ue_behaviours_list)
	{
		cJSON *expected_ue_behaviours_list =
			cJSON_AddObjectToObject(item,
			                        "expectedUeBehavioursList");
		if(expected_ue_behaviours_list == NULL) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [expected_ue_behaviours_list]");
			goto end;
		}
	...
	if(session_management_subscription_data_1->suggested_packet_num_dl_list)
	{
		cJSON *suggested_packet_num_dl_list =
			cJSON_AddObjectToObject(item,
			                        "suggestedPacketNumDlList");
		if(suggested_packet_num_dl_list == NULL) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [suggested_packet_num_dl_list]");
			goto end;
		}
		   ...
		   suggested_packet_num_dl_list)
		{
			OpenAPI_list_for_each(
				...
				cJSON *itemLocal = localKeyValue->value ?
				                   OpenAPI_suggested_packet_num_dl_1_convertToJSON
				                           (localKeyValue->value)
				:
				                   cJSON_CreateNull();
				if(itemLocal == NULL) {
	   ...
	   _3gpp_charging_characteristics)
	{
		...
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [_3gpp_charging_characteristics]");
			goto end;
		}
	}
	...
	if(session_management_subscription_data_1->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_session_management_subscription_data_1_parseFromJSON(
	cJSON *session_management_subscription_data_1JSON) {
	OpenAPI_session_management_subscription_data_1_t *
	        session_management_subscription_data_1_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	single_nssai =
		cJSON_GetObjectItemCaseSensitive(
			session_management_subscription_data_1JSON,
			"singleNssai");
	if(!single_nssai) {
		ogs_error(
			"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [single_nssai]");
		goto end;
	}
	...
	if(dnn_configurations) {
		...
		if(!cJSON_IsObject(dnn_configurations) &&
		   !cJSON_IsNull(dnn_configurations))
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [dnn_configurations]");
			goto end;
		}
		if(cJSON_IsObject(dnn_configurations)) {
			dnn_configurationsList = OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(dnn_configurations_local_map,
			                   dnn_configurations) {
				cJSON *localMapObject =
					dnn_configurations_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_dnn_configuration_1_parseFromJSON
						        (localMapObject));
					...
					ogs_error(
						"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [inner]");
					goto end;
				}
				OpenAPI_list_add(dnn_configurationsList,
				                 localMapKeyPair);
			}
		}
	}
	...
	if(internal_group_ids) {
		...
		if(!cJSON_IsArray(internal_group_ids)) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [internal_group_ids]");
			goto end;
		}
	...
	if(shared_vn_group_data_ids) {
		...
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [shared_vn_group_data_ids]");
			goto end;
		}
		if(cJSON_IsObject(shared_vn_group_data_ids)) {
	...
	if(shared_dnn_configurations_id) {
		if(!cJSON_IsString(shared_dnn_configurations_id) &&
		   !cJSON_IsNull(shared_dnn_configurations_id))
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [shared_dnn_configurations_id]");
			goto end;
		}
	}
	...
	if(odb_packet_services) {
		if(!cJSON_IsString(odb_packet_services)) {
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [odb_packet_services]");
			goto end;
		}
	...
	if(shared_trace_data_id) {
		if(!cJSON_IsString(shared_trace_data_id) &&
		   !cJSON_IsNull(shared_trace_data_id))
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [shared_trace_data_id]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviours_list) {
		...
		if(!cJSON_IsObject(expected_ue_behaviours_list) &&
		   !cJSON_IsNull(expected_ue_behaviours_list))
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [expected_ue_behaviours_list]");
			goto end;
		}
		if(cJSON_IsObject(expected_ue_behaviours_list)) {
			...
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(
				expected_ue_behaviours_list_local_map,
				expected_ue_behaviours_list) {
				cJSON *localMapObject =
					expected_ue_behaviours_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
				...
				OpenAPI_list_add(
					expected_ue_behaviours_listList,
					localMapKeyPair);
			}
		}
	}
	...
	if(suggested_packet_num_dl_list) {
		...
		if(!cJSON_IsObject(suggested_packet_num_dl_list) &&
		   !cJSON_IsNull(suggested_packet_num_dl_list))
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [suggested_packet_num_dl_list]");
			goto end;
		}
		if(cJSON_IsObject(suggested_packet_num_dl_list)) {
			suggested_packet_num_dl_listList =
				OpenAPI_list_create();
			OpenAPI_map_t *localMapKeyPair = NULL;
			cJSON_ArrayForEach(
				suggested_packet_num_dl_list_local_map,
				suggested_packet_num_dl_list) {
				cJSON *localMapObject =
					suggested_packet_num_dl_list_local_map;
				if(cJSON_IsObject(localMapObject)) {
					localMapKeyPair = OpenAPI_map_create(
						ogs_strdup(
							localMapObject->string),
						OpenAPI_suggested_packet_num_dl_1_parseFromJSON
						        (localMapObject));
				} else if(cJSON_IsNull(localMapObject)) {
					localMapKeyPair =
						OpenAPI_map_create(ogs_strdup(
	...
	if(_3gpp_charging_characteristics) {
		...
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [_3gpp_charging_characteristics]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_session_management_subscription_data_1_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	session_management_subscription_data_1_local_var =
		OpenAPI_session_management_subscription_data_1_create(
			...
			shared_dnn_configurations_id &&
			!cJSON_IsNull(shared_dnn_configurations_id) ?
			ogs_strdup(shared_dnn_configurations_id->valuestring) :
			NULL,
			...
			!cJSON_IsNull(_3gpp_charging_characteristics) ?
			ogs_strdup(
				_3gpp_charging_characteristics->valuestring) :
			NULL,
			supported_features &&
			!cJSON_IsNull(supported_features) ?
...
OpenAPI_session_management_subscription_data_1_t *
OpenAPI_session_management_subscription_data_1_copy(
	OpenAPI_session_management_subscription_data_1_t	*dst,
	OpenAPI_session_management_subscription_data_1_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_session_management_subscription_data_1_convertToJSON(
			src);
	if(!item) {
		ogs_error(
			"OpenAPI_session_management_subscription_data_1_convertToJSON() failed");
		return NULL;
	}
