...
OpenAPI_assign_ebi_error_t *OpenAPI_assign_ebi_error_create(
	...
	OpenAPI_assign_ebi_error_t *assign_ebi_error_local_var =
		ogs_malloc(sizeof(OpenAPI_assign_ebi_error_t));
...
void OpenAPI_assign_ebi_error_free(
	OpenAPI_assign_ebi_error_t *assign_ebi_error) {
...
cJSON *OpenAPI_assign_ebi_error_convertToJSON(
	OpenAPI_assign_ebi_error_t *assign_ebi_error) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(assign_ebi_error == NULL) {
		ogs_error(
			"OpenAPI_assign_ebi_error_convertToJSON() failed [AssignEbiError]");
		return NULL;
	}
	...
	if(!assign_ebi_error->error) {
		ogs_error(
			"OpenAPI_assign_ebi_error_convertToJSON() failed [error]");
		return NULL;
	}
	cJSON *error_local_JSON =
		OpenAPI_problem_details_convertToJSON(assign_ebi_error->error);
	...
	if(!assign_ebi_error->failure_details) {
		ogs_error(
			"OpenAPI_assign_ebi_error_convertToJSON() failed [failure_details]");
		return NULL;
	}
	cJSON *failure_details_local_JSON =
		OpenAPI_assign_ebi_failed_convertToJSON(
			assign_ebi_error->failure_details);
...
OpenAPI_assign_ebi_error_t *OpenAPI_assign_ebi_error_parseFromJSON(
	cJSON *assign_ebi_errorJSON) {
	...
	if(!error) {
		ogs_error(
			"OpenAPI_assign_ebi_error_parseFromJSON() failed [error]");
		goto end;
	}
	...
	if(!failure_details) {
		ogs_error(
			"OpenAPI_assign_ebi_error_parseFromJSON() failed [failure_details]");
		goto end;
	}
	failure_details_local_nonprim =
		OpenAPI_assign_ebi_failed_parseFromJSON(failure_details);
	if(!failure_details_local_nonprim) {
		ogs_error(
			"OpenAPI_assign_ebi_failed_parseFromJSON failed [failure_details]");
		goto end;
	}
...
OpenAPI_assign_ebi_error_t *OpenAPI_assign_ebi_error_copy(
	OpenAPI_assign_ebi_error_t *dst, OpenAPI_assign_ebi_error_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
