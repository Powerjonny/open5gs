...
OpenAPI_point_uncertainty_circle_all_of_create(
	...
	OpenAPI_point_uncertainty_circle_all_of_t *
		...
		ogs_malloc(sizeof(OpenAPI_point_uncertainty_circle_all_of_t));
...
cJSON *OpenAPI_point_uncertainty_circle_all_of_convertToJSON(
	...
	if(point_uncertainty_circle_all_of == NULL) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_all_of_convertToJSON() failed [PointUncertaintyCircle_allOf]");
		return NULL;
	}
	...
	if(!point_uncertainty_circle_all_of->point) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_all_of_convertToJSON() failed [point]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_uncertainty_circle_all_of_convertToJSON() failed [uncertainty]");
		goto end;
	}
...
OpenAPI_point_uncertainty_circle_all_of_t *
OpenAPI_point_uncertainty_circle_all_of_parseFromJSON(
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	if(!uncertainty) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_all_of_parseFromJSON() failed [uncertainty]");
		goto end;
	}
...
OpenAPI_point_uncertainty_circle_all_of_t *
OpenAPI_point_uncertainty_circle_all_of_copy(
	OpenAPI_point_uncertainty_circle_all_of_t	*dst,
	OpenAPI_point_uncertainty_circle_all_of_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_uncertainty_circle_all_of_convertToJSON() failed");
		return NULL;
	}
