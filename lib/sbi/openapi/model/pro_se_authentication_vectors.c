...
OpenAPI_pro_se_authentication_vectors_create() {
	OpenAPI_pro_se_authentication_vectors_t *
		...
		ogs_malloc(sizeof(OpenAPI_pro_se_authentication_vectors_t));
	...
	OpenAPI_pro_se_authentication_vectors_t *pro_se_authentication_vectors)
{
	...
	if(pro_se_authentication_vectors == NULL) {
		ogs_error(
			"OpenAPI_pro_se_authentication_vectors_convertToJSON() failed [ProSeAuthenticationVectors]");
		return NULL;
	}
...
OpenAPI_pro_se_authentication_vectors_parseFromJSON(
	...
	OpenAPI_pro_se_authentication_vectors_t *
	        pro_se_authentication_vectors_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	pro_se_authentication_vectors_local_var =
		OpenAPI_pro_se_authentication_vectors_create(
			);
...
OpenAPI_pro_se_authentication_vectors_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pro_se_authentication_vectors_convertToJSON() failed");
		return NULL;
	}
