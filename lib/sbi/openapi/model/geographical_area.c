...
OpenAPI_geographical_area_t *OpenAPI_geographical_area_create(
	...
	OpenAPI_geographical_area_t *geographical_area_local_var =
		ogs_malloc(sizeof(OpenAPI_geographical_area_t));
...
void OpenAPI_geographical_area_free(
...
cJSON *OpenAPI_geographical_area_convertToJSON(
	OpenAPI_geographical_area_t *geographical_area) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(geographical_area == NULL) {
		ogs_error(
			"OpenAPI_geographical_area_convertToJSON() failed [GeographicalArea]");
		return NULL;
	}
	...
	if(geographical_area->civic_address) {
		...
		if(civic_address_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_geographical_area_convertToJSON() failed [civic_address]");
			goto end;
		}
...
OpenAPI_geographical_area_t *OpenAPI_geographical_area_parseFromJSON(
	...
	shapes = cJSON_GetObjectItemCaseSensitive(geographical_areaJSON,
	                                          "shapes");
	if(shapes) {
		shapes_local_nonprim =
			OpenAPI_geographic_area_parseFromJSON(shapes);
		if(!shapes_local_nonprim) {
			ogs_error(
				"OpenAPI_geographic_area_parseFromJSON failed [shapes]");
			goto end;
		}
	}
...
OpenAPI_geographical_area_t *OpenAPI_geographical_area_copy(
	OpenAPI_geographical_area_t *dst, OpenAPI_geographical_area_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
