...
OpenAPI_av5g_aka_t *OpenAPI_av5g_aka_create(char *rand, char *hxres_star,
                                            char *autn) {
	OpenAPI_av5g_aka_t *av5g_aka_local_var =
		ogs_malloc(sizeof(OpenAPI_av5g_aka_t));
...
cJSON *OpenAPI_av5g_aka_convertToJSON(OpenAPI_av5g_aka_t *av5g_aka) {
	...
	if(!av5g_aka->hxres_star) {
		ogs_error(
			"OpenAPI_av5g_aka_convertToJSON() failed [hxres_star]");
		return NULL;
	}
...
OpenAPI_av5g_aka_t *OpenAPI_av5g_aka_parseFromJSON(cJSON *av5g_akaJSON) {
	...
	hxres_star = cJSON_GetObjectItemCaseSensitive(av5g_akaJSON,
	                                              "hxresStar");
	if(!hxres_star) {
		ogs_error(
			"OpenAPI_av5g_aka_parseFromJSON() failed [hxres_star]");
		goto end;
	}
...
OpenAPI_av5g_aka_t *OpenAPI_av5g_aka_copy(OpenAPI_av5g_aka_t	*dst,
                                          OpenAPI_av5g_aka_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
