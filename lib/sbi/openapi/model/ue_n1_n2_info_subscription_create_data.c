...
OpenAPI_ue_n1_n2_info_subscription_create_data_create(
	...
	OpenAPI_ue_n1_n2_info_subscription_create_data_t *
		...
		ogs_malloc(
			sizeof(OpenAPI_ue_n1_n2_info_subscription_create_data_t));
...
void OpenAPI_ue_n1_n2_info_subscription_create_data_free(
	OpenAPI_ue_n1_n2_info_subscription_create_data_t *
...
cJSON *OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON(
	OpenAPI_ue_n1_n2_info_subscription_create_data_t *
	ue_n1_n2_info_subscription_create_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ue_n1_n2_info_subscription_create_data == NULL) {
		ogs_error(
			"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [UeN1N2InfoSubscriptionCreateData]");
		return NULL;
	}
	   ...
	   OpenAPI_n2_information_class_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [n2_information_class]");
			goto end;
		}
	}
	...
	if(ue_n1_n2_info_subscription_create_data->n2_notify_callback_uri) {
		if(cJSON_AddStringToObject(item, "n2NotifyCallbackUri",
		                           ue_n1_n2_info_subscription_create_data
		                           ->n2_notify_callback_uri) == NULL)
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [n2_notify_callback_uri]");
			goto end;
		}
	}
	   ...
	   OpenAPI_n1_message_class_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [n1_message_class]");
			goto end;
		}
	}
	...
	if(ue_n1_n2_info_subscription_create_data->n1_notify_callback_uri) {
		if(cJSON_AddStringToObject(item, "n1NotifyCallbackUri",
		                           ue_n1_n2_info_subscription_create_data
		                           ->n1_notify_callback_uri) == NULL)
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [n1_notify_callback_uri]");
			goto end;
		}
	}
	...
	if(ue_n1_n2_info_subscription_create_data->nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [nf_id]");
			goto end;
		}
	}
	...
	if(ue_n1_n2_info_subscription_create_data->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(ue_n1_n2_info_subscription_create_data->old_guami) {
		...
		if(old_guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed [old_guami]");
			goto end;
		}
...
OpenAPI_ue_n1_n2_info_subscription_create_data_t *
OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON(
	...
	if(n2_information_class) {
		if(!cJSON_IsString(n2_information_class)) {
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON() failed [n2_information_class]");
			goto end;
		}
	...
	if(n2_notify_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON() failed [n2_notify_callback_uri]");
			goto end;
		}
	}
	...
	if(n1_message_class) {
		if(!cJSON_IsString(n1_message_class)) {
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON() failed [n1_message_class]");
			goto end;
		}
	...
	if(n1_notify_callback_uri) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON() failed [n1_notify_callback_uri]");
			goto end;
		}
	}
	...
	if(nf_id) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON() failed [nf_id]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_ue_n1_n2_info_subscription_create_data_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	ue_n1_n2_info_subscription_create_data_local_var =
		OpenAPI_ue_n1_n2_info_subscription_create_data_create(
			...
			n2_notify_callback_uri &&
			!cJSON_IsNull(n2_notify_callback_uri) ?
			ogs_strdup(n2_notify_callback_uri->valuestring) : NULL,
			n1_message_class ? n1_message_classVariable : 0,
			n1_notify_callback_uri &&
			!cJSON_IsNull(n1_notify_callback_uri) ?
			ogs_strdup(n1_notify_callback_uri->valuestring) : NULL,
			nf_id &&
...
OpenAPI_ue_n1_n2_info_subscription_create_data_copy(
	OpenAPI_ue_n1_n2_info_subscription_create_data_t	*dst,
	OpenAPI_ue_n1_n2_info_subscription_create_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;

	ogs_assert(src);
	item =
		OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON(
			src);
	if(!item) {
		ogs_error(
			"OpenAPI_ue_n1_n2_info_subscription_create_data_convertToJSON() failed");
		return NULL;
	}
