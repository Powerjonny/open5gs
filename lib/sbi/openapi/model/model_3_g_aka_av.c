...
OpenAPI_model_3_g_aka_av_t *OpenAPI_model_3_g_aka_av_create(char	*rand,
                                                            char	*xres,
                                                            char	*autn,
                                                            char	*ck,
                                                            char	*ik) {
	OpenAPI_model_3_g_aka_av_t *model_3_g_aka_av_local_var =
		ogs_malloc(sizeof(OpenAPI_model_3_g_aka_av_t));
...
void OpenAPI_model_3_g_aka_av_free(
	OpenAPI_model_3_g_aka_av_t *model_3_g_aka_av) {
...
cJSON *OpenAPI_model_3_g_aka_av_convertToJSON(
	OpenAPI_model_3_g_aka_av_t *model_3_g_aka_av) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(model_3_g_aka_av == NULL) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_convertToJSON() failed [3GAkaAv]");
		return NULL;
	}
	...
	if(!model_3_g_aka_av->rand) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_convertToJSON() failed [rand]");
		return NULL;
	}
	...
	if(!model_3_g_aka_av->xres) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_convertToJSON() failed [xres]");
		return NULL;
	}
	...
	if(!model_3_g_aka_av->autn) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_convertToJSON() failed [autn]");
		return NULL;
	}
	...
	if(!model_3_g_aka_av->ck) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_convertToJSON() failed [ck]");
		return NULL;
	}
	...
	if(!model_3_g_aka_av->ik) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_convertToJSON() failed [ik]");
		return NULL;
	}
...
OpenAPI_model_3_g_aka_av_t *OpenAPI_model_3_g_aka_av_parseFromJSON(
	cJSON *model_3_g_aka_avJSON) {
	...
	if(!rand) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_parseFromJSON() failed [rand]");
		goto end;
	}
	...
	if(!xres) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_parseFromJSON() failed [xres]");
		goto end;
	}
	...
	if(!autn) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_parseFromJSON() failed [autn]");
		goto end;
	}
	...
	if(!ck) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_parseFromJSON() failed [ck]");
		goto end;
	}
	...
	if(!ik) {
		ogs_error(
			"OpenAPI_model_3_g_aka_av_parseFromJSON() failed [ik]");
		goto end;
	}
...
OpenAPI_model_3_g_aka_av_t *OpenAPI_model_3_g_aka_av_copy(
	OpenAPI_model_3_g_aka_av_t *dst, OpenAPI_model_3_g_aka_av_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
