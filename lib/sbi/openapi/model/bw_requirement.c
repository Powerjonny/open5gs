...
OpenAPI_bw_requirement_t *OpenAPI_bw_requirement_create(char	*app_id,
                                                        ...
                                                        char	*mir_bw_dl,
                                                        char	*mir_bw_ul) {
	OpenAPI_bw_requirement_t *bw_requirement_local_var =
		ogs_malloc(sizeof(OpenAPI_bw_requirement_t));
...
cJSON *OpenAPI_bw_requirement_convertToJSON(
	...
	if(bw_requirement == NULL) {
		ogs_error(
			"OpenAPI_bw_requirement_convertToJSON() failed [BwRequirement]");
		return NULL;
	}
	...
	if(!bw_requirement->app_id) {
		ogs_error(
			"OpenAPI_bw_requirement_convertToJSON() failed [app_id]");
		return NULL;
	}
	...
	if(bw_requirement->mar_bw_dl) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_convertToJSON() failed [mar_bw_dl]");
			goto end;
		}
	}
	...
	if(bw_requirement->mar_bw_ul) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_convertToJSON() failed [mar_bw_ul]");
			goto end;
		}
	}
	...
	if(bw_requirement->mir_bw_dl) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_convertToJSON() failed [mir_bw_dl]");
			goto end;
		}
	}
	...
	if(bw_requirement->mir_bw_ul) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_convertToJSON() failed [mir_bw_ul]");
			goto end;
		}
	}
...
OpenAPI_bw_requirement_t *OpenAPI_bw_requirement_parseFromJSON(
	...
	if(!app_id) {
		ogs_error(
			"OpenAPI_bw_requirement_parseFromJSON() failed [app_id]");
		goto end;
	}
	...
	if(mar_bw_dl) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_parseFromJSON() failed [mar_bw_dl]");
			goto end;
		}
	}
	...
	if(mar_bw_ul) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_parseFromJSON() failed [mar_bw_ul]");
			goto end;
		}
	}
	...
	if(mir_bw_dl) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_parseFromJSON() failed [mir_bw_dl]");
			goto end;
		}
	}
	...
	if(mir_bw_ul) {
		...
		{
			ogs_error(
				"OpenAPI_bw_requirement_parseFromJSON() failed [mir_bw_ul]");
			goto end;
		}
	}
