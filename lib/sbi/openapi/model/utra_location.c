...
OpenAPI_utra_location_t *OpenAPI_utra_location_create(
	OpenAPI_cell_global_id_t *cgi, OpenAPI_service_area_id_t *sai,
	OpenAPI_location_area_id_t *lai, OpenAPI_routing_area_id_t *rai,
	bool is_age_of_location_information, int age_of_location_information,
	char *ue_location_timestamp, char *geographical_information,
	char *geodetic_information) {
	OpenAPI_utra_location_t *utra_location_local_var =
		ogs_malloc(sizeof(OpenAPI_utra_location_t));
...
cJSON *OpenAPI_utra_location_convertToJSON(
	...
	if(utra_location == NULL) {
		ogs_error(
			"OpenAPI_utra_location_convertToJSON() failed [UtraLocation]");
		return NULL;
	}
	...
	if(utra_location->cgi) {
		...
		if(cgi_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [cgi]");
			goto end;
		}
	...
	if(utra_location->sai) {
		...
		if(sai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [sai]");
			goto end;
		}
	...
	if(utra_location->lai) {
		...
		if(lai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [lai]");
			goto end;
		}
	...
	if(utra_location->rai) {
		...
		if(rai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [rai]");
			goto end;
		}
	...
	if(utra_location->is_age_of_location_information) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [age_of_location_information]");
			goto end;
		}
	}
	...
	if(utra_location->ue_location_timestamp) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [ue_location_timestamp]");
			goto end;
		}
	}
	...
	if(utra_location->geographical_information) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [geographical_information]");
			goto end;
		}
	}
	...
	if(utra_location->geodetic_information) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_convertToJSON() failed [geodetic_information]");
			goto end;
		}
	}
...
OpenAPI_utra_location_t *OpenAPI_utra_location_parseFromJSON(
	cJSON *utra_locationJSON) {
	...
	age_of_location_information =
		cJSON_GetObjectItemCaseSensitive(utra_locationJSON,
		                                 "ageOfLocationInformation");
	if(age_of_location_information) {
		if(!cJSON_IsNumber(age_of_location_information)) {
			ogs_error(
				"OpenAPI_utra_location_parseFromJSON() failed [age_of_location_information]");
			goto end;
		}
	}
	...
	if(ue_location_timestamp) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_parseFromJSON() failed [ue_location_timestamp]");
			goto end;
		}
	}
	...
	if(geographical_information) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_parseFromJSON() failed [geographical_information]");
			goto end;
		}
	}
	...
	if(geodetic_information) {
		...
		{
			ogs_error(
				"OpenAPI_utra_location_parseFromJSON() failed [geodetic_information]");
			goto end;
		}
	}
...
OpenAPI_utra_location_t *OpenAPI_utra_location_copy(
	OpenAPI_utra_location_t *dst, OpenAPI_utra_location_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
