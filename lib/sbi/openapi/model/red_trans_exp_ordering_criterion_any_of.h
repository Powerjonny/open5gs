...
typedef enum { OpenAPI_red_trans_exp_ordering_criterion_any_of_NULL = 0,
	       OpenAPI_red_trans_exp_ordering_criterion_any_of_TIME_SLOT_START,
	       OpenAPI_red_trans_exp_ordering_criterion_any_of_RED_TRANS_EXP }
OpenAPI_red_trans_exp_ordering_criterion_any_of_e;

char * OpenAPI_red_trans_exp_ordering_criterion_any_of_ToString(
	OpenAPI_red_trans_exp_ordering_criterion_any_of_e
