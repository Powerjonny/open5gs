...
OpenAPI_n2_info_notify_request_t *OpenAPI_n2_info_notify_request_create(
	...
	OpenAPI_n2_info_notify_request_t *n2_info_notify_request_local_var =
...
void OpenAPI_n2_info_notify_request_free(
	OpenAPI_n2_info_notify_request_t *n2_info_notify_request) {
...
cJSON *OpenAPI_n2_info_notify_request_convertToJSON(
	...
	if(n2_info_notify_request == NULL) {
		ogs_error(
			"OpenAPI_n2_info_notify_request_convertToJSON() failed [N2InfoNotify_request]");
		return NULL;
	}
	...
	if(n2_info_notify_request->json_data) {
		cJSON *json_data_local_JSON =
			OpenAPI_n2_information_notification_convertToJSON(
				n2_info_notify_request->json_data);
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_info_notify_request_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(n2_info_notify_request->binary_data_n1_message) {
		char *encoded_str_binary_data_n1_message =
			OpenAPI_base64encode(
				n2_info_notify_request->binary_data_n1_message->
				data,
				n2_info_notify_request->binary_data_n1_message->
				len);
		...
		{
			ogs_error(
				"OpenAPI_n2_info_notify_request_convertToJSON() failed [binary_data_n1_message]");
			goto end;
		}
	...
	if(n2_info_notify_request->binary_data_n2_information) {
		...
		{
			ogs_error(
				"OpenAPI_n2_info_notify_request_convertToJSON() failed [binary_data_n2_information]");
			goto end;
		}
...
OpenAPI_n2_info_notify_request_t *OpenAPI_n2_info_notify_request_parseFromJSON(
	...
	if(json_data) {
		...
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON failed [json_data]");
			goto end;
		}
	}
	...
	if(binary_data_n1_message) {
		decoded_str_binary_data_n1_message =
			ogs_malloc(sizeof(OpenAPI_binary_t));
		ogs_assert(decoded_str_binary_data_n1_message);
		if(!cJSON_IsString(binary_data_n1_message)) {
			ogs_error(
				"OpenAPI_n2_info_notify_request_parseFromJSON() failed [binary_data_n1_message]");
			goto end;
		}
		decoded_str_binary_data_n1_message->data =
			OpenAPI_base64decode(
				binary_data_n1_message->valuestring,
				strlen(binary_data_n1_message->valuestring),
	...
	if(binary_data_n2_information) {
		...
		if(!cJSON_IsString(binary_data_n2_information)) {
			ogs_error(
				"OpenAPI_n2_info_notify_request_parseFromJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	n2_info_notify_request_local_var =
		OpenAPI_n2_info_notify_request_create(
...
OpenAPI_n2_info_notify_request_t *OpenAPI_n2_info_notify_request_copy(
	OpenAPI_n2_info_notify_request_t	*dst,
	OpenAPI_n2_info_notify_request_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n2_info_notify_request_convertToJSON() failed");
		return NULL;
	}
