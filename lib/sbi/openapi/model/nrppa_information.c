...
OpenAPI_nrppa_information_t *OpenAPI_nrppa_information_create(char *nf_id,
                                                              ...
                                                              *
                                                              ...
                                                              service_instance_id)
{
	OpenAPI_nrppa_information_t *nrppa_information_local_var =
		ogs_malloc(sizeof(OpenAPI_nrppa_information_t));
...
void OpenAPI_nrppa_information_free(
	OpenAPI_nrppa_information_t *nrppa_information) {
...
cJSON *OpenAPI_nrppa_information_convertToJSON(
	...
	if(nrppa_information == NULL) {
		ogs_error(
			"OpenAPI_nrppa_information_convertToJSON() failed [NrppaInformation]");
		return NULL;
	}
	...
	if(!nrppa_information->nf_id) {
		ogs_error(
			"OpenAPI_nrppa_information_convertToJSON() failed [nf_id]");
		return NULL;
	}
	...
	if(!nrppa_information->nrppa_pdu) {
		ogs_error(
			"OpenAPI_nrppa_information_convertToJSON() failed [nrppa_pdu]");
		return NULL;
	}
	cJSON *nrppa_pdu_local_JSON =
	...
	if(nrppa_information->service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nrppa_information_convertToJSON() failed [service_instance_id]");
			goto end;
		}
	}
...
OpenAPI_nrppa_information_t *OpenAPI_nrppa_information_parseFromJSON(
	...
	if(!nf_id) {
		ogs_error(
			"OpenAPI_nrppa_information_parseFromJSON() failed [nf_id]");
		goto end;
	}
	...
	if(!nrppa_pdu) {
		ogs_error(
			"OpenAPI_nrppa_information_parseFromJSON() failed [nrppa_pdu]");
		goto end;
	}
	nrppa_pdu_local_nonprim =
		OpenAPI_n2_info_content_parseFromJSON(nrppa_pdu);
	if(!nrppa_pdu_local_nonprim) {
		ogs_error(
			"OpenAPI_n2_info_content_parseFromJSON failed [nrppa_pdu]");
		goto end;
	}

	service_instance_id =
		cJSON_GetObjectItemCaseSensitive(nrppa_informationJSON,
		                                 "serviceInstanceId");
	if(service_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nrppa_information_parseFromJSON() failed [service_instance_id]");
			goto end;
		}
	}
...
OpenAPI_nrppa_information_t *OpenAPI_nrppa_information_copy(
	OpenAPI_nrppa_information_t *dst, OpenAPI_nrppa_information_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
