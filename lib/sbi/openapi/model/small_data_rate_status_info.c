...
OpenAPI_small_data_rate_status_info_create(OpenAPI_snssai_t *snssai, char *dnn,
                                           OpenAPI_small_data_rate_status_t *
                                           small_data_rate_status) {
	OpenAPI_small_data_rate_status_info_t *
	        small_data_rate_status_info_local_var =
		ogs_malloc(sizeof(OpenAPI_small_data_rate_status_info_t));
...
void OpenAPI_small_data_rate_status_info_free(
	OpenAPI_small_data_rate_status_info_t *small_data_rate_status_info) {
...
cJSON *OpenAPI_small_data_rate_status_info_convertToJSON(
	OpenAPI_small_data_rate_status_info_t *small_data_rate_status_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(small_data_rate_status_info == NULL) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_convertToJSON() failed [SmallDataRateStatusInfo]");
		return NULL;
	}
	...
	if(!small_data_rate_status_info->snssai) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_convertToJSON() failed [snssai]");
		return NULL;
	}
	...
	if(!small_data_rate_status_info->dnn) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_convertToJSON() failed [dnn]");
		return NULL;
	}
	...
	if(!small_data_rate_status_info->small_data_rate_status) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_convertToJSON() failed [small_data_rate_status]");
		return NULL;
	}
...
OpenAPI_small_data_rate_status_info_parseFromJSON(
	...
	OpenAPI_small_data_rate_status_info_t *
	        small_data_rate_status_info_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *snssai = NULL;
	...
	if(!snssai) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_parseFromJSON() failed [snssai]");
		goto end;
	}
	...
	if(!dnn) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	if(!small_data_rate_status) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_parseFromJSON() failed [small_data_rate_status]");
		goto end;
	}
...
OpenAPI_small_data_rate_status_info_t *OpenAPI_small_data_rate_status_info_copy(
	OpenAPI_small_data_rate_status_info_t	*dst,
	OpenAPI_small_data_rate_status_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_small_data_rate_status_info_convertToJSON() failed");
		return NULL;
	}
