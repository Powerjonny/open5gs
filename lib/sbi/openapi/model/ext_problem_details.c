...
OpenAPI_ext_problem_details_t *OpenAPI_ext_problem_details_create(char	*type,
                                                                  char	*title,
                                                                  bool
                                                                  is_status,
                                                                  int	status,
                                                                  ...
                                                                  *
                                                                  ...
                                                                  remote_error)
{
	OpenAPI_ext_problem_details_t *ext_problem_details_local_var =
		ogs_malloc(sizeof(OpenAPI_ext_problem_details_t));
	...
	ext_problem_details_local_var->access_token_request =
		access_token_request;
...
void OpenAPI_ext_problem_details_free(
	OpenAPI_ext_problem_details_t *ext_problem_details) {
	...
	if(ext_problem_details->invalid_params) {
		OpenAPI_list_for_each(ext_problem_details->invalid_params,
		                      node) {
...
cJSON *OpenAPI_ext_problem_details_convertToJSON(
	OpenAPI_ext_problem_details_t *ext_problem_details) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ext_problem_details == NULL) {
		ogs_error(
			"OpenAPI_ext_problem_details_convertToJSON() failed [ExtProblemDetails]");
		return NULL;
	}
	...
	if(ext_problem_details->type) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [type]");
			goto end;
		}
	}
	...
	if(ext_problem_details->title) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [title]");
			goto end;
		}
	}
	...
	if(ext_problem_details->is_status) {
		if(cJSON_AddNumberToObject(item, "status",
		                           ext_problem_details->status) == NULL)
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [status]");
			goto end;
		}
	}
	...
	if(ext_problem_details->detail) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [detail]");
			goto end;
		}
	}
	...
	if(ext_problem_details->instance) {
		if(cJSON_AddStringToObject(item, "instance",
		                           ext_problem_details->instance) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [instance]");
			goto end;
		}
	}
	...
	if(ext_problem_details->cause) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(ext_problem_details->invalid_params) {
		...
		if(invalid_paramsList == NULL) {
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [invalid_params]");
			goto end;
		}
		OpenAPI_list_for_each(ext_problem_details->invalid_params,
		                      node) {
	...
	if(ext_problem_details->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(ext_problem_details->access_token_error) {
		...
		if(access_token_error_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [access_token_error]");
			goto end;
		}
	...
	if(ext_problem_details->access_token_request) {
		...
		if(access_token_request_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [access_token_request]");
			goto end;
		}
	...
	if(ext_problem_details->nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [nrf_id]");
			goto end;
		}
	}
	...
	if(ext_problem_details->is_remote_error) {
		if(cJSON_AddBoolToObject(item, "remoteError",
		                         ext_problem_details->remote_error) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_ext_problem_details_convertToJSON() failed [remote_error]");
			goto end;
		}
	}
...
OpenAPI_ext_problem_details_t *OpenAPI_ext_problem_details_parseFromJSON(
	cJSON *ext_problem_detailsJSON) {
	...
	type = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                        "type");
	if(type) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [type]");
			goto end;
		}
	}

	title = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                         "title");
	if(title) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [title]");
			goto end;
		}
	}

	status = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                          "status");
	if(status) {
		if(!cJSON_IsNumber(status)) {
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [status]");
			goto end;
		}
	}

	detail = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                          "detail");
	if(detail) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [detail]");
			goto end;
		}
	}

	instance = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                            "instance");
	if(instance) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [instance]");
			goto end;
		}
	}

	cause = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                         "cause");
	if(cause) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [cause]");
			goto end;
		}
	}

	invalid_params =
		cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
		                                 "invalidParams");
	if(invalid_params) {
		cJSON *invalid_params_local = NULL;
		if(!cJSON_IsArray(invalid_params)) {
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [invalid_params]");
			goto end;
		}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	nrf_id = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                          "nrfId");
	if(nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [nrf_id]");
			goto end;
		}
	}

	remote_error = cJSON_GetObjectItemCaseSensitive(ext_problem_detailsJSON,
	                                                "remoteError");
	if(remote_error) {
		if(!cJSON_IsBool(remote_error)) {
			ogs_error(
				"OpenAPI_ext_problem_details_parseFromJSON() failed [remote_error]");
			goto end;
		}
	}
	...
	ext_problem_details_local_var = OpenAPI_ext_problem_details_create(
		type &&
		!cJSON_IsNull(type) ? ogs_strdup(type->valuestring) : NULL,
		title &&
		!cJSON_IsNull(title) ? ogs_strdup(title->valuestring) : NULL,
		status ? true : false,
		status ? status->valuedouble : 0,
		detail &&
		!cJSON_IsNull(detail) ? ogs_strdup(detail->valuestring) : NULL,
		instance &&
		!cJSON_IsNull(instance) ? ogs_strdup(instance->valuestring) :
		NULL,
		cause &&
		!cJSON_IsNull(cause) ? ogs_strdup(cause->valuestring) : NULL,
		...
		access_token_request ? access_token_request_local_nonprim :
		NULL,
		nrf_id &&
		!cJSON_IsNull(nrf_id) ? ogs_strdup(nrf_id->valuestring) : NULL,
...
OpenAPI_ext_problem_details_t *OpenAPI_ext_problem_details_copy(
	OpenAPI_ext_problem_details_t	*dst,
	OpenAPI_ext_problem_details_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
