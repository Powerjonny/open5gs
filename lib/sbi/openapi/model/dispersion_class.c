...
OpenAPI_dispersion_class_t *OpenAPI_dispersion_class_create() {
	OpenAPI_dispersion_class_t *dispersion_class_local_var =
		ogs_malloc(sizeof(OpenAPI_dispersion_class_t));
...
void OpenAPI_dispersion_class_free(
	OpenAPI_dispersion_class_t *dispersion_class) {
...
cJSON *OpenAPI_dispersion_class_convertToJSON(
	OpenAPI_dispersion_class_t *dispersion_class) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(dispersion_class == NULL) {
		ogs_error(
			"OpenAPI_dispersion_class_convertToJSON() failed [DispersionClass]");
		return NULL;
	}
...
OpenAPI_dispersion_class_t *OpenAPI_dispersion_class_parseFromJSON(
	cJSON *dispersion_classJSON) {
...
OpenAPI_dispersion_class_t *OpenAPI_dispersion_class_copy(
	OpenAPI_dispersion_class_t *dst, OpenAPI_dispersion_class_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
