...
OpenAPI_expected_ue_behaviour_data_1_create(
	...
	OpenAPI_battery_indication_t *battery_indication, char *validity_time) {
	OpenAPI_expected_ue_behaviour_data_1_t *
	        expected_ue_behaviour_data_1_local_var =
		ogs_malloc(sizeof(OpenAPI_expected_ue_behaviour_data_1_t));
	ogs_assert(expected_ue_behaviour_data_1_local_var);

	expected_ue_behaviour_data_1_local_var->stationary_indication =
		stationary_indication;
	expected_ue_behaviour_data_1_local_var->is_communication_duration_time =
		is_communication_duration_time;
	expected_ue_behaviour_data_1_local_var->communication_duration_time =
		communication_duration_time;
	expected_ue_behaviour_data_1_local_var->is_periodic_time =
		is_periodic_time;
	expected_ue_behaviour_data_1_local_var->periodic_time = periodic_time;
	expected_ue_behaviour_data_1_local_var->scheduled_communication_time =
		scheduled_communication_time;
	expected_ue_behaviour_data_1_local_var->scheduled_communication_type =
		scheduled_communication_type;
	expected_ue_behaviour_data_1_local_var->expected_umts = expected_umts;
	expected_ue_behaviour_data_1_local_var->traffic_profile =
		traffic_profile;
	expected_ue_behaviour_data_1_local_var->battery_indication =
		battery_indication;
...
void OpenAPI_expected_ue_behaviour_data_1_free(
	OpenAPI_expected_ue_behaviour_data_1_t *expected_ue_behaviour_data_1) {
	...
	if(expected_ue_behaviour_data_1->scheduled_communication_time) {
		OpenAPI_scheduled_communication_time_1_free(
			expected_ue_behaviour_data_1->
			scheduled_communication_time);
		expected_ue_behaviour_data_1->scheduled_communication_time =
			NULL;
	}
	if(expected_ue_behaviour_data_1->expected_umts) {
		OpenAPI_list_for_each(
			expected_ue_behaviour_data_1->expected_umts, node) {
	...
	if(expected_ue_behaviour_data_1->battery_indication) {
		OpenAPI_battery_indication_free(
			expected_ue_behaviour_data_1->battery_indication);
...
cJSON *OpenAPI_expected_ue_behaviour_data_1_convertToJSON(
	OpenAPI_expected_ue_behaviour_data_1_t *expected_ue_behaviour_data_1) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(expected_ue_behaviour_data_1 == NULL) {
		ogs_error(
			"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [ExpectedUeBehaviourData_1]");
		return NULL;
	}
	...
	{
		if(cJSON_AddStringToObject(item, "stationaryIndication",
		                           OpenAPI_stationary_indication_ToString
		                                   (expected_ue_behaviour_data_1
		                                   ->stationary_indication)) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [stationary_indication]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data_1->is_communication_duration_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [communication_duration_time]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data_1->is_periodic_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [periodic_time]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data_1->scheduled_communication_time) {
		cJSON *scheduled_communication_time_local_JSON =
			OpenAPI_scheduled_communication_time_1_convertToJSON(
				expected_ue_behaviour_data_1->
				scheduled_communication_time);
		if(scheduled_communication_time_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [scheduled_communication_time]");
			goto end;
		}
	...
	if(expected_ue_behaviour_data_1->scheduled_communication_type !=
	   OpenAPI_scheduled_communication_type_NULL)
	{
		if(cJSON_AddStringToObject(item, "scheduledCommunicationType",
		                           OpenAPI_scheduled_communication_type_ToString
		                                   (expected_ue_behaviour_data_1
		                                   ->
		                                   scheduled_communication_type))
		   ==
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [scheduled_communication_type]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data_1->expected_umts) {
		...
		if(expected_umtsList == NULL) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [expected_umts]");
			goto end;
		}
		OpenAPI_list_for_each(
			expected_ue_behaviour_data_1->expected_umts, node) {
			cJSON *itemLocal =
				OpenAPI_location_area_1_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [expected_umts]");
	...
	if(expected_ue_behaviour_data_1->traffic_profile !=
	   OpenAPI_traffic_profile_NULL)
	{
		if(cJSON_AddStringToObject(item, "trafficProfile",
		                           OpenAPI_traffic_profile_ToString(
						   expected_ue_behaviour_data_1
						   ->traffic_profile)) == NULL)
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [traffic_profile]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data_1->battery_indication) {
		cJSON *battery_indication_local_JSON =
			OpenAPI_battery_indication_convertToJSON(
				expected_ue_behaviour_data_1->battery_indication);
		if(battery_indication_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [battery_indication]");
			goto end;
		}
	...
	if(expected_ue_behaviour_data_1->validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_expected_ue_behaviour_data_1_parseFromJSON(
	cJSON *expected_ue_behaviour_data_1JSON) {
	OpenAPI_expected_ue_behaviour_data_1_t *
	        expected_ue_behaviour_data_1_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	OpenAPI_scheduled_communication_type_e
	        scheduled_communication_typeVariable = 0;
	...
	stationary_indication =
		cJSON_GetObjectItemCaseSensitive(
			expected_ue_behaviour_data_1JSON,
			"stationaryIndication");
	if(stationary_indication) {
		if(!cJSON_IsString(stationary_indication)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [stationary_indication]");
			goto end;
		}
		stationary_indicationVariable =
			OpenAPI_stationary_indication_FromString(
				stationary_indication->valuestring);
	}
	...
	if(communication_duration_time) {
		if(!cJSON_IsNumber(communication_duration_time)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [communication_duration_time]");
			goto end;
		}
	}
	...
	periodic_time =
		cJSON_GetObjectItemCaseSensitive(
			expected_ue_behaviour_data_1JSON, "periodicTime");
	if(periodic_time) {
		if(!cJSON_IsNumber(periodic_time)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [periodic_time]");
			goto end;
		}
	}
	...
	if(scheduled_communication_time) {
		...
		if(!scheduled_communication_time_local_nonprim) {
			ogs_error(
				"OpenAPI_scheduled_communication_time_1_parseFromJSON failed [scheduled_communication_time]");
			goto end;
		}
	}
	...
	if(scheduled_communication_type) {
		if(!cJSON_IsString(scheduled_communication_type)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [scheduled_communication_type]");
			goto end;
		}
		scheduled_communication_typeVariable =
			OpenAPI_scheduled_communication_type_FromString(
				scheduled_communication_type->valuestring);
	}

	expected_umts =
		cJSON_GetObjectItemCaseSensitive(
			expected_ue_behaviour_data_1JSON, "expectedUmts");
	if(expected_umts) {
		cJSON *expected_umts_local = NULL;
		if(!cJSON_IsArray(expected_umts)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [expected_umts]");
			goto end;
		}
		...
		cJSON_ArrayForEach(expected_umts_local, expected_umts) {
			...
			OpenAPI_location_area_1_t *expected_umtsItem =
				OpenAPI_location_area_1_parseFromJSON(
					expected_umts_local);
	...
	traffic_profile =
		cJSON_GetObjectItemCaseSensitive(
			expected_ue_behaviour_data_1JSON, "trafficProfile");
	if(traffic_profile) {
		if(!cJSON_IsString(traffic_profile)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [traffic_profile]");
			goto end;
		}
		traffic_profileVariable =
			OpenAPI_traffic_profile_FromString(
				traffic_profile->valuestring);
	}

	battery_indication =
		cJSON_GetObjectItemCaseSensitive(
			expected_ue_behaviour_data_1JSON, "batteryIndication");
	if(battery_indication) {
		...
		if(!battery_indication_local_nonprim) {
			ogs_error(
				"OpenAPI_battery_indication_parseFromJSON failed [battery_indication]");
			goto end;
		}
	}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_1_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	expected_ue_behaviour_data_1_local_var =
		OpenAPI_expected_ue_behaviour_data_1_create(
			...
			battery_indication ? battery_indication_local_nonprim :
			NULL,
			validity_time &&
			!cJSON_IsNull(validity_time) ?
...
OpenAPI_expected_ue_behaviour_data_1_t *
OpenAPI_expected_ue_behaviour_data_1_copy(
	OpenAPI_expected_ue_behaviour_data_1_t	*dst,
	OpenAPI_expected_ue_behaviour_data_1_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_expected_ue_behaviour_data_1_convertToJSON() failed");
		return NULL;
	}
