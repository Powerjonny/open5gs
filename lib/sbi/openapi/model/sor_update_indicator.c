...
char * OpenAPI_sor_update_indicator_ToString(
	...
	const char *sor_update_indicatorArray[] = { "NULL",
		                                    "INITIAL_REGISTRATION",
		                                    "EMERGENCY_REGISTRATION" };
	size_t sizeofArray = sizeof(sor_update_indicatorArray) /
	                     sizeof(sor_update_indicatorArray[0]);
...
OpenAPI_sor_update_indicator_e OpenAPI_sor_update_indicator_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(sor_update_indicator,
		          sor_update_indicatorArray[stringToReturn]) == 0) {
