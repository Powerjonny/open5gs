...
typedef enum { OpenAPI_lcs_qos_class_NULL = 0,
	       OpenAPI_lcs_qos_class_BEST_EFFORT, OpenAPI_lcs_qos_class_ASSURED,
	       OpenAPI_lcs_qos_class_MULTIPLE_QOS } OpenAPI_lcs_qos_class_e;
