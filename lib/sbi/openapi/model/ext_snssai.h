...
typedef enum { OpenAPI_ext_snssai_WILDCARDSD_NULL = 0,
	       OpenAPI_ext_snssai_WILDCARDSD__true }
OpenAPI_ext_snssai_wildcard_sd_e;

char * OpenAPI_ext_snssai_wildcard_sd_ToString(
	OpenAPI_ext_snssai_wildcard_sd_e wildcard_sd);

OpenAPI_ext_snssai_wildcard_sd_e OpenAPI_ext_snssai_wildcard_sd_FromString(
	char *wildcard_sd);
