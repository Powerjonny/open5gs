...
OpenAPI_pcf_selection_assistance_info_create(char		*dnn,
                                             OpenAPI_snssai_t	*single_nssai) {
	OpenAPI_pcf_selection_assistance_info_t *
	        pcf_selection_assistance_info_local_var =
		ogs_malloc(sizeof(OpenAPI_pcf_selection_assistance_info_t));
...
void OpenAPI_pcf_selection_assistance_info_free(
	OpenAPI_pcf_selection_assistance_info_t *pcf_selection_assistance_info)
{
...
cJSON *OpenAPI_pcf_selection_assistance_info_convertToJSON(
	OpenAPI_pcf_selection_assistance_info_t *pcf_selection_assistance_info)
{
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(pcf_selection_assistance_info == NULL) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_convertToJSON() failed [PcfSelectionAssistanceInfo]");
		return NULL;
	}
	...
	if(!pcf_selection_assistance_info->dnn) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_convertToJSON() failed [dnn]");
		return NULL;
	}
	...
	if(!pcf_selection_assistance_info->single_nssai) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_convertToJSON() failed [single_nssai]");
		return NULL;
	}
...
OpenAPI_pcf_selection_assistance_info_parseFromJSON(
	cJSON *pcf_selection_assistance_infoJSON) {
	OpenAPI_pcf_selection_assistance_info_t *
	...
	dnn =
		cJSON_GetObjectItemCaseSensitive(
			pcf_selection_assistance_infoJSON, "dnn");
	if(!dnn) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_parseFromJSON() failed [dnn]");
		goto end;
	}
	...
	single_nssai =
		cJSON_GetObjectItemCaseSensitive(
			pcf_selection_assistance_infoJSON, "singleNssai");
	if(!single_nssai) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_parseFromJSON() failed [single_nssai]");
		goto end;
	}
...
OpenAPI_pcf_selection_assistance_info_copy(
	OpenAPI_pcf_selection_assistance_info_t *dst,
	OpenAPI_pcf_selection_assistance_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pcf_selection_assistance_info_convertToJSON() failed");
		return NULL;
	}
