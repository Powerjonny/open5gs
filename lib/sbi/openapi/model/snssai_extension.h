...
typedef enum { OpenAPI_snssai_extension_WILDCARDSD_NULL = 0,
	       OpenAPI_snssai_extension_WILDCARDSD__true }
...
OpenAPI_snssai_extension_wildcard_sd_e
OpenAPI_snssai_extension_wildcard_sd_FromString(char *wildcard_sd);
