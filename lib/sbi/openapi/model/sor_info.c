...
OpenAPI_sor_info_t *OpenAPI_sor_info_create(
	...
	OpenAPI_sor_info_t *sor_info_local_var =
		ogs_malloc(sizeof(OpenAPI_sor_info_t));
	...
	sor_info_local_var->sor_transparent_container =
	...
	sor_info_local_var->is_usim_support_of_sor_cmci =
...
cJSON *OpenAPI_sor_info_convertToJSON(OpenAPI_sor_info_t *sor_info) {
	...
	if(sor_info->steering_container) {
		cJSON *steering_container_local_JSON =
			OpenAPI_steering_container_convertToJSON(
				sor_info->steering_container);
		if(steering_container_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [steering_container]");
			goto end;
		}
	...
	if(sor_info->sor_mac_iausf) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [sor_mac_iausf]");
			goto end;
		}
	}
	...
	if(sor_info->countersor) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [countersor]");
			goto end;
		}
	}
	...
	if(!sor_info->provisioning_time) {
		ogs_error(
			"OpenAPI_sor_info_convertToJSON() failed [provisioning_time]");
		return NULL;
	}
	...
	if(sor_info->sor_transparent_container) {
		if(cJSON_AddStringToObject(item, "sorTransparentContainer",
		                           sor_info->sor_transparent_container)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [sor_transparent_container]");
			goto end;
		}
	}
	...
	if(sor_info->sor_cmci) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [sor_cmci]");
			goto end;
		}
	}
	...
	if(sor_info->is_store_sor_cmci_in_me) {
		if(cJSON_AddBoolToObject(item, "storeSorCmciInMe",
		                         sor_info->store_sor_cmci_in_me) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [store_sor_cmci_in_me]");
			goto end;
		}
	}
	...
	if(sor_info->is_usim_support_of_sor_cmci) {
		if(cJSON_AddBoolToObject(item, "usimSupportOfSorCmci",
		                         sor_info->usim_support_of_sor_cmci) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_sor_info_convertToJSON() failed [usim_support_of_sor_cmci]");
			goto end;
		}
	}
...
OpenAPI_sor_info_t *OpenAPI_sor_info_parseFromJSON(cJSON *sor_infoJSON) {
	...
	steering_container = cJSON_GetObjectItemCaseSensitive(sor_infoJSON,
	                                                      "steeringContainer");
	...
	sor_mac_iausf = cJSON_GetObjectItemCaseSensitive(sor_infoJSON,
	                                                 "sorMacIausf");
	if(sor_mac_iausf) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_parseFromJSON() failed [sor_mac_iausf]");
			goto end;
		}
	}

	countersor = cJSON_GetObjectItemCaseSensitive(sor_infoJSON,
	                                              "countersor");
	if(countersor) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_parseFromJSON() failed [countersor]");
			goto end;
		}
	}

	provisioning_time = cJSON_GetObjectItemCaseSensitive(sor_infoJSON,
	                                                     "provisioningTime");
	if(!provisioning_time) {
		ogs_error(
			"OpenAPI_sor_info_parseFromJSON() failed [provisioning_time]");
		goto end;
	}
	...
	sor_transparent_container =
		cJSON_GetObjectItemCaseSensitive(sor_infoJSON,
	...
	if(sor_transparent_container) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_parseFromJSON() failed [sor_transparent_container]");
			goto end;
		}
	}
	...
	if(sor_cmci) {
		...
		{
			ogs_error(
				"OpenAPI_sor_info_parseFromJSON() failed [sor_cmci]");
			goto end;
		}
	}

	store_sor_cmci_in_me = cJSON_GetObjectItemCaseSensitive(sor_infoJSON,
	                                                        "storeSorCmciInMe");
	if(store_sor_cmci_in_me) {
		if(!cJSON_IsBool(store_sor_cmci_in_me)) {
			ogs_error(
				"OpenAPI_sor_info_parseFromJSON() failed [store_sor_cmci_in_me]");
			goto end;
		}
	}
	...
	if(usim_support_of_sor_cmci) {
		if(!cJSON_IsBool(usim_support_of_sor_cmci)) {
			ogs_error(
				"OpenAPI_sor_info_parseFromJSON() failed [usim_support_of_sor_cmci]");
			goto end;
		}
	}
...
OpenAPI_sor_info_t *OpenAPI_sor_info_copy(OpenAPI_sor_info_t	*dst,
                                          OpenAPI_sor_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
