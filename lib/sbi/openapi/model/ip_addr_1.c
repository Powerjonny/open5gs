...
OpenAPI_ip_addr_1_t *OpenAPI_ip_addr_1_create(char *ipv4_addr, char *ipv6_addr,
                                              char *ipv6_prefix) {
	OpenAPI_ip_addr_1_t *ip_addr_1_local_var =
		ogs_malloc(sizeof(OpenAPI_ip_addr_1_t));
...
cJSON *OpenAPI_ip_addr_1_convertToJSON(OpenAPI_ip_addr_1_t *ip_addr_1) {
	...
	if(ip_addr_1 == NULL) {
		ogs_error(
			"OpenAPI_ip_addr_1_convertToJSON() failed [IpAddr_1]");
		return NULL;
	}
	...
	if(ip_addr_1->ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_ip_addr_1_convertToJSON() failed [ipv4_addr]");
			goto end;
		}
	}
	...
	if(ip_addr_1->ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_ip_addr_1_convertToJSON() failed [ipv6_addr]");
			goto end;
		}
	}
	...
	if(ip_addr_1->ipv6_prefix) {
		...
		{
			ogs_error(
				"OpenAPI_ip_addr_1_convertToJSON() failed [ipv6_prefix]");
			goto end;
		}
	}
...
OpenAPI_ip_addr_1_t *OpenAPI_ip_addr_1_parseFromJSON(cJSON *ip_addr_1JSON) {
	...
	if(ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_ip_addr_1_parseFromJSON() failed [ipv4_addr]");
			goto end;
		}
	}
	...
	if(ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_ip_addr_1_parseFromJSON() failed [ipv6_addr]");
			goto end;
		}
	}

	ipv6_prefix = cJSON_GetObjectItemCaseSensitive(ip_addr_1JSON,
	                                               "ipv6Prefix");
	if(ipv6_prefix) {
		...
		{
			ogs_error(
				"OpenAPI_ip_addr_1_parseFromJSON() failed [ipv6_prefix]");
			goto end;
		}
	}
...
OpenAPI_ip_addr_1_t *OpenAPI_ip_addr_1_copy(OpenAPI_ip_addr_1_t *dst,
                                            OpenAPI_ip_addr_1_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
