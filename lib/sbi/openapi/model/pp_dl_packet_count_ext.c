...
OpenAPI_pp_dl_packet_count_ext_t *OpenAPI_pp_dl_packet_count_ext_create(
	...
	OpenAPI_pp_dl_packet_count_ext_t *pp_dl_packet_count_ext_local_var =
		ogs_malloc(sizeof(OpenAPI_pp_dl_packet_count_ext_t));
	...
	pp_dl_packet_count_ext_local_var->mtc_provider_information =
...
cJSON *OpenAPI_pp_dl_packet_count_ext_convertToJSON(
	...
	if(pp_dl_packet_count_ext == NULL) {
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [PpDlPacketCountExt]");
		return NULL;
	}
	...
	if(!pp_dl_packet_count_ext->af_instance_id) {
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [af_instance_id]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "afInstanceId",
	                           pp_dl_packet_count_ext->af_instance_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [af_instance_id]");
	...
	if(cJSON_AddNumberToObject(item, "referenceId",
	                           pp_dl_packet_count_ext->reference_id) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [reference_id]");
		goto end;
	}
	...
	if(pp_dl_packet_count_ext->dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(pp_dl_packet_count_ext->single_nssai) {
		cJSON *single_nssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				pp_dl_packet_count_ext->single_nssai);
		if(single_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [single_nssai]");
			goto end;
		}
	...
	if(pp_dl_packet_count_ext->validity_time) {
		if(cJSON_AddStringToObject(item, "validityTime",
		                           pp_dl_packet_count_ext->validity_time)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(pp_dl_packet_count_ext->mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed [mtc_provider_information]");
			goto end;
		}
	}
...
OpenAPI_pp_dl_packet_count_ext_t *OpenAPI_pp_dl_packet_count_ext_parseFromJSON(
	...
	af_instance_id =
		cJSON_GetObjectItemCaseSensitive(pp_dl_packet_count_extJSON,
		                                 "afInstanceId");
	if(!af_instance_id) {
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_parseFromJSON() failed [af_instance_id]");
		goto end;
	}
	...
	if(!reference_id) {
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_parseFromJSON() failed [reference_id]");
		goto end;
	}
	...
	dnn = cJSON_GetObjectItemCaseSensitive(pp_dl_packet_count_extJSON,
	                                       "dnn");
	if(dnn) {
		...
		{
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_parseFromJSON() failed [dnn]");
			goto end;
		}
	}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
	...
	if(mtc_provider_information) {
		...
		{
			ogs_error(
				"OpenAPI_pp_dl_packet_count_ext_parseFromJSON() failed [mtc_provider_information]");
			goto end;
		}
	}

	pp_dl_packet_count_ext_local_var =
		OpenAPI_pp_dl_packet_count_ext_create(
...
OpenAPI_pp_dl_packet_count_ext_t *OpenAPI_pp_dl_packet_count_ext_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_pp_dl_packet_count_ext_convertToJSON() failed");
		return NULL;
	}
