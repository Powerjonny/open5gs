...
char * OpenAPI_redirect_address_type_ToString(
	...
	const char *redirect_address_typeArray[] = { "NULL", "IPV4_ADDR",
		                                     "IPV6_ADDR", "URL",
		                                     "SIP_URI" };
	size_t sizeofArray = sizeof(redirect_address_typeArray) /
	                     sizeof(redirect_address_typeArray[0]);
...
OpenAPI_redirect_address_type_e OpenAPI_redirect_address_type_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(redirect_address_type,
		          redirect_address_typeArray[stringToReturn]) == 0) {
