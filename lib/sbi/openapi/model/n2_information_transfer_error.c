...
OpenAPI_n2_information_transfer_error_create(OpenAPI_problem_details_t *error,
                                             OpenAPI_pws_error_data_t	*
                                             pws_error_info) {
	OpenAPI_n2_information_transfer_error_t *
	        n2_information_transfer_error_local_var =
		ogs_malloc(sizeof(OpenAPI_n2_information_transfer_error_t));
...
void OpenAPI_n2_information_transfer_error_free(
	OpenAPI_n2_information_transfer_error_t *n2_information_transfer_error)
{
	...
	OpenAPI_n2_information_transfer_error_t *n2_information_transfer_error)
{
	...
	if(n2_information_transfer_error == NULL) {
		ogs_error(
			"OpenAPI_n2_information_transfer_error_convertToJSON() failed [N2InformationTransferError]");
		return NULL;
	}
	...
	if(!n2_information_transfer_error->error) {
		ogs_error(
			"OpenAPI_n2_information_transfer_error_convertToJSON() failed [error]");
		return NULL;
	}
	...
	if(n2_information_transfer_error->pws_error_info) {
		cJSON *pws_error_info_local_JSON =
			OpenAPI_pws_error_data_convertToJSON(
				n2_information_transfer_error->pws_error_info);
		if(pws_error_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_information_transfer_error_convertToJSON() failed [pws_error_info]");
			goto end;
		}
...
OpenAPI_n2_information_transfer_error_t *
OpenAPI_n2_information_transfer_error_parseFromJSON(
	cJSON *n2_information_transfer_errorJSON) {
	OpenAPI_n2_information_transfer_error_t *
	        n2_information_transfer_error_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *error = NULL;
	...
	if(!error) {
		ogs_error(
			"OpenAPI_n2_information_transfer_error_parseFromJSON() failed [error]");
		goto end;
	}
	...
	if(pws_error_info) {
		pws_error_info_local_nonprim =
			OpenAPI_pws_error_data_parseFromJSON(pws_error_info);
		if(!pws_error_info_local_nonprim) {
			ogs_error(
				"OpenAPI_pws_error_data_parseFromJSON failed [pws_error_info]");
			goto end;
		}
	}

	n2_information_transfer_error_local_var =
		OpenAPI_n2_information_transfer_error_create(
			error_local_nonprim,
...
OpenAPI_n2_information_transfer_error_copy(
	OpenAPI_n2_information_transfer_error_t *dst,
	OpenAPI_n2_information_transfer_error_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n2_information_transfer_error_convertToJSON() failed");
		return NULL;
	}
