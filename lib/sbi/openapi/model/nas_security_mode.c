...
OpenAPI_nas_security_mode_t *OpenAPI_nas_security_mode_create(
	...
	OpenAPI_nas_security_mode_t *nas_security_mode_local_var =
		ogs_malloc(sizeof(OpenAPI_nas_security_mode_t));
...
cJSON *OpenAPI_nas_security_mode_convertToJSON(
	...
	if(nas_security_mode == NULL) {
		ogs_error(
			"OpenAPI_nas_security_mode_convertToJSON() failed [NasSecurityMode]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(nas_security_mode->integrity_algorithm ==
	   OpenAPI_integrity_algorithm_NULL)
	{
		ogs_error(
			"OpenAPI_nas_security_mode_convertToJSON() failed [integrity_algorithm]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "integrityAlgorithm",
	                           OpenAPI_integrity_algorithm_ToString(
					   nas_security_mode->
	...
	if(nas_security_mode->ciphering_algorithm ==
	   OpenAPI_ciphering_algorithm_NULL)
	{
		ogs_error(
			"OpenAPI_nas_security_mode_convertToJSON() failed [ciphering_algorithm]");
		return NULL;
	}
...
OpenAPI_nas_security_mode_t *OpenAPI_nas_security_mode_parseFromJSON(
	...
	integrity_algorithm =
		cJSON_GetObjectItemCaseSensitive(nas_security_modeJSON,
		                                 "integrityAlgorithm");
	if(!integrity_algorithm) {
		ogs_error(
			"OpenAPI_nas_security_mode_parseFromJSON() failed [integrity_algorithm]");
		goto end;
	}
	...
	integrity_algorithmVariable =
		OpenAPI_integrity_algorithm_FromString(
	...
	if(!ciphering_algorithm) {
		ogs_error(
			"OpenAPI_nas_security_mode_parseFromJSON() failed [ciphering_algorithm]");
		goto end;
	}
	...
	ciphering_algorithmVariable =
		OpenAPI_ciphering_algorithm_FromString(
