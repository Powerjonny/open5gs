...
OpenAPI_nrf_info_served_bsf_info_value_create(OpenAPI_list_t	*dnn_list,
	...
	OpenAPI_nrf_info_served_bsf_info_value_t *
		...
		ogs_malloc(sizeof(OpenAPI_nrf_info_served_bsf_info_value_t));
	ogs_assert(nrf_info_served_bsf_info_value_local_var);

	nrf_info_served_bsf_info_value_local_var->dnn_list = dnn_list;
	nrf_info_served_bsf_info_value_local_var->ip_domain_list =
		ip_domain_list;
	nrf_info_served_bsf_info_value_local_var->ipv4_address_ranges =
		ipv4_address_ranges;
	nrf_info_served_bsf_info_value_local_var->ipv6_prefix_ranges =
		ipv6_prefix_ranges;
	...
	OpenAPI_nrf_info_served_bsf_info_value_t *nrf_info_served_bsf_info_value)
{
	...
	if(nrf_info_served_bsf_info_value->dnn_list) {
		OpenAPI_list_for_each(nrf_info_served_bsf_info_value->dnn_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(nrf_info_served_bsf_info_value->ip_domain_list) {
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->ip_domain_list, node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
			nrf_info_served_bsf_info_value->ip_domain_list);
		nrf_info_served_bsf_info_value->ip_domain_list = NULL;
	}
	if(nrf_info_served_bsf_info_value->ipv4_address_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->ipv4_address_ranges,
			node) {
	...
	if(nrf_info_served_bsf_info_value->ipv6_prefix_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->ipv6_prefix_ranges,
			node) {
	...
	if(nrf_info_served_bsf_info_value->supi_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->supi_ranges, node) {
	...
	if(nrf_info_served_bsf_info_value->gpsi_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->gpsi_ranges, node) {
	...
	OpenAPI_nrf_info_served_bsf_info_value_t *nrf_info_served_bsf_info_value)
{
	...
	if(nrf_info_served_bsf_info_value == NULL) {
		ogs_error(
			"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [NrfInfo_servedBsfInfo_value]");
		return NULL;
	}
	...
	if(nrf_info_served_bsf_info_value->dnn_list) {
		...
		if(dnn_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [dnn_list]");
			goto end;
		}
		OpenAPI_list_for_each(nrf_info_served_bsf_info_value->dnn_list,
		                      node) {
	...
	if(nrf_info_served_bsf_info_value->ip_domain_list) {
		cJSON *ip_domain_listList = cJSON_AddArrayToObject(item,
		                                                   "ipDomainList");
		if(ip_domain_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [ip_domain_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->ip_domain_list, node) {
			if(cJSON_AddStringToObject(ip_domain_listList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [ip_domain_list]");
	...
	if(nrf_info_served_bsf_info_value->ipv4_address_ranges) {
		cJSON *ipv4_address_rangesList = cJSON_AddArrayToObject(item,
		                                                        "ipv4AddressRanges");
		if(ipv4_address_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [ipv4_address_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->ipv4_address_ranges,
			...
			cJSON_AddItemToArray(ipv4_address_rangesList,
			                     itemLocal);
		}
	}
	...
	if(nrf_info_served_bsf_info_value->ipv6_prefix_ranges) {
		...
		if(ipv6_prefix_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [ipv6_prefix_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->ipv6_prefix_ranges,
	...
	if(nrf_info_served_bsf_info_value->rx_diam_host) {
		...
		{
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [rx_diam_host]");
			goto end;
		}
	}
	...
	if(nrf_info_served_bsf_info_value->rx_diam_realm) {
		...
		{
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [rx_diam_realm]");
			goto end;
		}
	}
	...
	if(nrf_info_served_bsf_info_value->group_id) {
		...
		{
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [group_id]");
			goto end;
		}
	}
	...
	if(nrf_info_served_bsf_info_value->supi_ranges) {
		...
		if(supi_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [supi_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->supi_ranges, node) {
	...
	if(nrf_info_served_bsf_info_value->gpsi_ranges) {
		...
		if(gpsi_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed [gpsi_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_bsf_info_value->gpsi_ranges, node) {
...
OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON(
	...
	OpenAPI_nrf_info_served_bsf_info_value_t *
	        nrf_info_served_bsf_info_value_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *dnn_list = NULL;
	...
	dnn_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "dnnList");
	if(dnn_list) {
		cJSON *dnn_list_local = NULL;
		if(!cJSON_IsArray(dnn_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [dnn_list]");
			goto end;
		}
	...
	ip_domain_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "ipDomainList");
	if(ip_domain_list) {
		cJSON *ip_domain_list_local = NULL;
		if(!cJSON_IsArray(ip_domain_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [ip_domain_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(ip_domain_list_local, ip_domain_list) {
			...
			OpenAPI_list_add(ip_domain_listList,
			                 ogs_strdup(
						 ip_domain_list_local->
						 valuestring));
		}
	}
	...
	ipv4_address_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON,
			"ipv4AddressRanges");
	if(ipv4_address_ranges) {
		cJSON *ipv4_address_ranges_local = NULL;
		if(!cJSON_IsArray(ipv4_address_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [ipv4_address_ranges]");
			goto end;
		}

		ipv4_address_rangesList = OpenAPI_list_create();

		cJSON_ArrayForEach(ipv4_address_ranges_local,
		                   ipv4_address_ranges) {
			...
			OpenAPI_ipv4_address_range_t *ipv4_address_rangesItem =
				OpenAPI_ipv4_address_range_parseFromJSON(
					ipv4_address_ranges_local);
			if(!ipv4_address_rangesItem) {
				ogs_error("No ipv4_address_rangesItem");
				goto end;
			}
			OpenAPI_list_add(ipv4_address_rangesList,
			                 ipv4_address_rangesItem);
		}
	}

	ipv6_prefix_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "ipv6PrefixRanges");
	if(ipv6_prefix_ranges) {
		cJSON *ipv6_prefix_ranges_local = NULL;
		if(!cJSON_IsArray(ipv6_prefix_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [ipv6_prefix_ranges]");
			goto end;
		}
	...
	rx_diam_host =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "rxDiamHost");
	if(rx_diam_host) {
		if(!cJSON_IsString(rx_diam_host) &&
		   !cJSON_IsNull(rx_diam_host))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [rx_diam_host]");
			goto end;
		}
	}
	...
	rx_diam_realm =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "rxDiamRealm");
	if(rx_diam_realm) {
		if(!cJSON_IsString(rx_diam_realm) &&
		   !cJSON_IsNull(rx_diam_realm))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [rx_diam_realm]");
			goto end;
		}
	}
	...
	group_id =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "groupId");
	if(group_id) {
		if(!cJSON_IsString(group_id) &&
		   !cJSON_IsNull(group_id))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [group_id]");
			goto end;
		}
	}
	...
	supi_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "supiRanges");
	if(supi_ranges) {
		cJSON *supi_ranges_local = NULL;
		if(!cJSON_IsArray(supi_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [supi_ranges]");
			goto end;
		}
	...
	gpsi_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_bsf_info_valueJSON, "gpsiRanges");
	if(gpsi_ranges) {
		cJSON *gpsi_ranges_local = NULL;
		if(!cJSON_IsArray(gpsi_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_bsf_info_value_parseFromJSON() failed [gpsi_ranges]");
			goto end;
		}
...
OpenAPI_nrf_info_served_bsf_info_value_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nrf_info_served_bsf_info_value_convertToJSON() failed");
		return NULL;
	}
