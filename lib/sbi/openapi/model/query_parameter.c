...
OpenAPI_query_parameter_t *OpenAPI_query_parameter_create(char	*name,
                                                          char	*value) {
	OpenAPI_query_parameter_t *query_parameter_local_var =
		ogs_malloc(sizeof(OpenAPI_query_parameter_t));
...
cJSON *OpenAPI_query_parameter_convertToJSON(
	OpenAPI_query_parameter_t *query_parameter) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(query_parameter == NULL) {
		ogs_error(
			"OpenAPI_query_parameter_convertToJSON() failed [QueryParameter]");
		return NULL;
	}
	...
	if(!query_parameter->name) {
		ogs_error(
			"OpenAPI_query_parameter_convertToJSON() failed [name]");
		return NULL;
	}
	...
	if(!query_parameter->value) {
		ogs_error(
			"OpenAPI_query_parameter_convertToJSON() failed [value]");
		return NULL;
	}
...
OpenAPI_query_parameter_t *OpenAPI_query_parameter_parseFromJSON(
	cJSON *query_parameterJSON) {
	...
	if(!name) {
		ogs_error(
			"OpenAPI_query_parameter_parseFromJSON() failed [name]");
		goto end;
	}
	...
	if(!value) {
		ogs_error(
			"OpenAPI_query_parameter_parseFromJSON() failed [value]");
		goto end;
	}
...
OpenAPI_query_parameter_t *OpenAPI_query_parameter_copy(
	OpenAPI_query_parameter_t *dst, OpenAPI_query_parameter_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
