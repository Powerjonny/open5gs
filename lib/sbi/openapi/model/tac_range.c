...
OpenAPI_tac_range_t *OpenAPI_tac_range_create(char *start, char *end,
                                              char *pattern) {
	OpenAPI_tac_range_t *tac_range_local_var =
		ogs_malloc(sizeof(OpenAPI_tac_range_t));
...
cJSON *OpenAPI_tac_range_convertToJSON(OpenAPI_tac_range_t *tac_range) {
	...
	if(tac_range == NULL) {
		ogs_error(
			"OpenAPI_tac_range_convertToJSON() failed [TacRange]");
		return NULL;
	}
	...
	if(tac_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_tac_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(tac_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_tac_range_convertToJSON() failed [end]");
			goto end;
		}
	}
	...
	if(tac_range->pattern) {
		...
		{
			ogs_error(
				"OpenAPI_tac_range_convertToJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_tac_range_t *OpenAPI_tac_range_parseFromJSON(cJSON *tac_rangeJSON) {
	...
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_tac_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_tac_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
	...
	if(pattern) {
		...
		{
			ogs_error(
				"OpenAPI_tac_range_parseFromJSON() failed [pattern]");
			goto end;
		}
	}
