...
OpenAPI_n2_information_notification_create(char *n2_notify_subscription_id,
                                           ...
                                           ran_node_id, char *initial_amf_name,
	...
	OpenAPI_n2_information_notification_t *
		...
		ogs_malloc(sizeof(OpenAPI_n2_information_notification_t));
...
void OpenAPI_n2_information_notification_free(
	OpenAPI_n2_information_notification_t *n2_information_notification) {
	...
	if(n2_information_notification->n2_notify_subscription_id) {
		ogs_free(
			n2_information_notification->n2_notify_subscription_id);
	...
	if(n2_information_notification->smf_change_info_list) {
		OpenAPI_list_for_each(
			n2_information_notification->smf_change_info_list,
			node) {
...
cJSON *OpenAPI_n2_information_notification_convertToJSON(
	...
	if(n2_information_notification == NULL) {
		ogs_error(
			"OpenAPI_n2_information_notification_convertToJSON() failed [N2InformationNotification]");
		return NULL;
	}
	...
	if(!n2_information_notification->n2_notify_subscription_id) {
		ogs_error(
			"OpenAPI_n2_information_notification_convertToJSON() failed [n2_notify_subscription_id]");
		return NULL;
	}
	...
	if(n2_information_notification->n2_info_container) {
		...
		if(n2_info_container_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [n2_info_container]");
			goto end;
		}
	...
	if(n2_information_notification->to_release_session_list) {
		cJSON *to_release_session_listList =
			cJSON_AddArrayToObject(item, "toReleaseSessionList");
		if(to_release_session_listList == NULL) {
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [to_release_session_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			n2_information_notification->to_release_session_list,
	...
	if(n2_information_notification->lcs_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [lcs_correlation_id]");
			goto end;
		}
	}

	if(n2_information_notification->notify_reason !=
	   OpenAPI_n2_info_notify_reason_NULL)
	{
		if(cJSON_AddStringToObject(item, "notifyReason",
		                           OpenAPI_n2_info_notify_reason_ToString
		                                   (n2_information_notification
		                                   ->notify_reason)) == NULL)
		{
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [notify_reason]");
			goto end;
		}
	}
	...
	if(n2_information_notification->smf_change_info_list) {
		...
		if(smf_change_info_listList == NULL) {
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [smf_change_info_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			n2_information_notification->smf_change_info_list,
			node) {
			cJSON *itemLocal =
				OpenAPI_smf_change_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_n2_information_notification_convertToJSON() failed [smf_change_info_list]");
	...
	if(n2_information_notification->ran_node_id) {
		...
		if(ran_node_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [ran_node_id]");
			goto end;
		}
	...
	if(n2_information_notification->initial_amf_name) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [initial_amf_name]");
			goto end;
		}
	}
	...
	if(n2_information_notification->an_n2_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [an_n2_ipv4_addr]");
			goto end;
		}
	}
	...
	if(n2_information_notification->an_n2_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [an_n2_ipv6_addr]");
			goto end;
		}
	}
	...
	if(n2_information_notification->guami) {
		...
		if(guami_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [guami]");
			goto end;
		}
	...
	if(n2_information_notification->is_notify_source_ng_ran) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_convertToJSON() failed [notify_source_ng_ran]");
			goto end;
		}
	}
...
OpenAPI_n2_information_notification_t *
OpenAPI_n2_information_notification_parseFromJSON(
	cJSON *n2_information_notificationJSON) {
	OpenAPI_n2_information_notification_t *
	        n2_information_notification_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	n2_notify_subscription_id =
		cJSON_GetObjectItemCaseSensitive(
			n2_information_notificationJSON,
			"n2NotifySubscriptionId");
	if(!n2_notify_subscription_id) {
		ogs_error(
			"OpenAPI_n2_information_notification_parseFromJSON() failed [n2_notify_subscription_id]");
		goto end;
	}
	...
	if(to_release_session_list) {
		...
		if(!cJSON_IsArray(to_release_session_list)) {
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [to_release_session_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(to_release_session_list_local,
			...
			*localDouble =
			...
			OpenAPI_list_add(to_release_session_listList,
			                 localDouble);
		}
	}
	...
	if(lcs_correlation_id) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [lcs_correlation_id]");
			goto end;
		}
	}
	...
	if(notify_reason) {
		if(!cJSON_IsString(notify_reason)) {
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [notify_reason]");
			goto end;
		}
		notify_reasonVariable =
			OpenAPI_n2_info_notify_reason_FromString(
	...
	if(smf_change_info_list) {
		...
		if(!cJSON_IsArray(smf_change_info_list)) {
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [smf_change_info_list]");
			goto end;
		}
	...
	if(initial_amf_name) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [initial_amf_name]");
			goto end;
		}
	}
	...
	if(an_n2_ipv4_addr) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [an_n2_ipv4_addr]");
			goto end;
		}
	}
	...
	if(an_n2_ipv6_addr) {
		...
		{
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [an_n2_ipv6_addr]");
			goto end;
		}
	}
	...
	if(notify_source_ng_ran) {
		if(!cJSON_IsBool(notify_source_ng_ran)) {
			ogs_error(
				"OpenAPI_n2_information_notification_parseFromJSON() failed [notify_source_ng_ran]");
			goto end;
		}
	}
	...
	n2_information_notification_local_var =
		OpenAPI_n2_information_notification_create(
			...
			NULL,
			to_release_session_list ? to_release_session_listList :
			NULL,
			lcs_correlation_id &&
			!cJSON_IsNull(lcs_correlation_id) ?
			...
			initial_amf_name &&
			!cJSON_IsNull(initial_amf_name) ?
			ogs_strdup(initial_amf_name->valuestring) : NULL,
			an_n2_ipv4_addr &&
			!cJSON_IsNull(an_n2_ipv4_addr) ?
			...
			notify_source_ng_ran ? notify_source_ng_ran->valueint :
			0
			);
...
OpenAPI_n2_information_notification_t *OpenAPI_n2_information_notification_copy(
	OpenAPI_n2_information_notification_t	*dst,
	OpenAPI_n2_information_notification_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n2_information_notification_convertToJSON() failed");
		return NULL;
	}
