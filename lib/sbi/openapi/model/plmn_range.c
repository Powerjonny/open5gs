...
OpenAPI_plmn_range_t *OpenAPI_plmn_range_create(char *start, char *end,
                                                char *pattern) {
	OpenAPI_plmn_range_t *plmn_range_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_range_t));
...
cJSON *OpenAPI_plmn_range_convertToJSON(OpenAPI_plmn_range_t *plmn_range) {
	...
	if(plmn_range == NULL) {
		ogs_error(
			"OpenAPI_plmn_range_convertToJSON() failed [PlmnRange]");
		return NULL;
	}
	...
	if(plmn_range->start) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_range_convertToJSON() failed [start]");
			goto end;
		}
	}
	...
	if(plmn_range->end) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_range_convertToJSON() failed [end]");
			goto end;
		}
	}
	...
	if(plmn_range->pattern) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_range_convertToJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_plmn_range_t *OpenAPI_plmn_range_parseFromJSON(cJSON *plmn_rangeJSON) {
	...
	if(start) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_range_parseFromJSON() failed [start]");
			goto end;
		}
	}
	...
	if(end) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_range_parseFromJSON() failed [end]");
			goto end;
		}
	}
	...
	if(pattern) {
		...
		{
			ogs_error(
				"OpenAPI_plmn_range_parseFromJSON() failed [pattern]");
			goto end;
		}
	}
...
OpenAPI_plmn_range_t *OpenAPI_plmn_range_copy(OpenAPI_plmn_range_t	*dst,
                                              OpenAPI_plmn_range_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
