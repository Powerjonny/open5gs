...
OpenAPI_n2_ran_information_t *OpenAPI_n2_ran_information_create(
	...
	OpenAPI_n2_ran_information_t *n2_ran_information_local_var =
		ogs_malloc(sizeof(OpenAPI_n2_ran_information_t));
...
cJSON *OpenAPI_n2_ran_information_convertToJSON(
	...
	if(n2_ran_information == NULL) {
		ogs_error(
			"OpenAPI_n2_ran_information_convertToJSON() failed [N2RanInformation]");
		return NULL;
	}
	...
	if(!n2_ran_information->n2_info_content) {
		ogs_error(
			"OpenAPI_n2_ran_information_convertToJSON() failed [n2_info_content]");
		return NULL;
	}
...
OpenAPI_n2_ran_information_t *OpenAPI_n2_ran_information_parseFromJSON(
	...
	n2_info_content =
		cJSON_GetObjectItemCaseSensitive(n2_ran_informationJSON,
		                                 "n2InfoContent");
	if(!n2_info_content) {
		ogs_error(
			"OpenAPI_n2_ran_information_parseFromJSON() failed [n2_info_content]");
		goto end;
	}
