...
OpenAPI_n1_n2_msg_txfr_err_detail_t *OpenAPI_n1_n2_msg_txfr_err_detail_create(
	bool is_retry_after, int retry_after, OpenAPI_arp_t *highest_prio_arp,
	bool is_max_waiting_time, int max_waiting_time) {
	OpenAPI_n1_n2_msg_txfr_err_detail_t *n1_n2_msg_txfr_err_detail_local_var
	        = ogs_malloc(sizeof(OpenAPI_n1_n2_msg_txfr_err_detail_t));
...
void OpenAPI_n1_n2_msg_txfr_err_detail_free(
	OpenAPI_n1_n2_msg_txfr_err_detail_t *n1_n2_msg_txfr_err_detail) {
...
cJSON *OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON(
	OpenAPI_n1_n2_msg_txfr_err_detail_t *n1_n2_msg_txfr_err_detail) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n1_n2_msg_txfr_err_detail == NULL) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON() failed [N1N2MsgTxfrErrDetail]");
		return NULL;
	}
	...
	if(n1_n2_msg_txfr_err_detail->is_retry_after) {
		...
		{
			ogs_error(
				"OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON() failed [retry_after]");
			goto end;
		}
	}

	if(n1_n2_msg_txfr_err_detail->highest_prio_arp) {
		cJSON *highest_prio_arp_local_JSON =
			OpenAPI_arp_convertToJSON(
				n1_n2_msg_txfr_err_detail->highest_prio_arp);
		if(highest_prio_arp_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON() failed [highest_prio_arp]");
			goto end;
		}
	...
	if(n1_n2_msg_txfr_err_detail->is_max_waiting_time) {
		...
		{
			ogs_error(
				"OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON() failed [max_waiting_time]");
			goto end;
		}
	}
...
OpenAPI_n1_n2_msg_txfr_err_detail_parseFromJSON(
	...
	retry_after =
		cJSON_GetObjectItemCaseSensitive(n1_n2_msg_txfr_err_detailJSON,
		                                 "retryAfter");
	if(retry_after) {
		if(!cJSON_IsNumber(retry_after)) {
			ogs_error(
				"OpenAPI_n1_n2_msg_txfr_err_detail_parseFromJSON() failed [retry_after]");
			goto end;
		}
	}
	...
	highest_prio_arp =
		cJSON_GetObjectItemCaseSensitive(n1_n2_msg_txfr_err_detailJSON,
		                                 "highestPrioArp");
	if(highest_prio_arp) {
		highest_prio_arp_local_nonprim =
			OpenAPI_arp_parseFromJSON(highest_prio_arp);
		if(!highest_prio_arp_local_nonprim) {
			ogs_error(
				"OpenAPI_arp_parseFromJSON failed [highest_prio_arp]");
			goto end;
		}
	}
	...
	if(max_waiting_time) {
		if(!cJSON_IsNumber(max_waiting_time)) {
			ogs_error(
				"OpenAPI_n1_n2_msg_txfr_err_detail_parseFromJSON() failed [max_waiting_time]");
			goto end;
		}
	}

	n1_n2_msg_txfr_err_detail_local_var =
		OpenAPI_n1_n2_msg_txfr_err_detail_create(
			retry_after ? true : false,
			retry_after ? retry_after->valuedouble : 0,
			highest_prio_arp ? highest_prio_arp_local_nonprim :
			NULL,
...
OpenAPI_n1_n2_msg_txfr_err_detail_t *OpenAPI_n1_n2_msg_txfr_err_detail_copy(
	OpenAPI_n1_n2_msg_txfr_err_detail_t	*dst,
	OpenAPI_n1_n2_msg_txfr_err_detail_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_n1_n2_msg_txfr_err_detail_convertToJSON() failed");
		return NULL;
	}
