...
OpenAPI_up_security_info_t *OpenAPI_up_security_info_create(
	...
	OpenAPI_up_security_info_t *up_security_info_local_var =
		ogs_malloc(sizeof(OpenAPI_up_security_info_t));
	ogs_assert(up_security_info_local_var);

	up_security_info_local_var->up_security = up_security;
	up_security_info_local_var->max_integrity_protected_data_rate_ul =
		max_integrity_protected_data_rate_ul;
	up_security_info_local_var->max_integrity_protected_data_rate_dl =
		max_integrity_protected_data_rate_dl;
...
void OpenAPI_up_security_info_free(
...
cJSON *OpenAPI_up_security_info_convertToJSON(
	OpenAPI_up_security_info_t *up_security_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(up_security_info == NULL) {
		ogs_error(
			"OpenAPI_up_security_info_convertToJSON() failed [UpSecurityInfo]");
		return NULL;
	}
	...
	if(!up_security_info->up_security) {
		ogs_error(
			"OpenAPI_up_security_info_convertToJSON() failed [up_security]");
		return NULL;
	}
	cJSON *up_security_local_JSON =
		OpenAPI_up_security_convertToJSON(
			up_security_info->up_security);
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_up_security_info_convertToJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	}
	   ...
	   OpenAPI_max_integrity_protected_data_rate_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_up_security_info_convertToJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	}
	...
	if(up_security_info->security_result) {
		cJSON *security_result_local_JSON =
			OpenAPI_security_result_convertToJSON(
				up_security_info->security_result);
		if(security_result_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_up_security_info_convertToJSON() failed [security_result]");
			goto end;
		}
...
OpenAPI_up_security_info_t *OpenAPI_up_security_info_parseFromJSON(
	cJSON *up_security_infoJSON) {
	...
	up_security = cJSON_GetObjectItemCaseSensitive(up_security_infoJSON,
	                                               "upSecurity");
	if(!up_security) {
		ogs_error(
			"OpenAPI_up_security_info_parseFromJSON() failed [up_security]");
		goto end;
	}
	...
	max_integrity_protected_data_rate_ul =
		cJSON_GetObjectItemCaseSensitive(up_security_infoJSON,
		                                 "maxIntegrityProtectedDataRateUl");
	if(max_integrity_protected_data_rate_ul) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_ul)) {
			ogs_error(
				"OpenAPI_up_security_info_parseFromJSON() failed [max_integrity_protected_data_rate_ul]");
			goto end;
		}
	...
	if(max_integrity_protected_data_rate_dl) {
		if(!cJSON_IsString(max_integrity_protected_data_rate_dl)) {
			ogs_error(
				"OpenAPI_up_security_info_parseFromJSON() failed [max_integrity_protected_data_rate_dl]");
			goto end;
		}
	...
	security_result = cJSON_GetObjectItemCaseSensitive(up_security_infoJSON,
	                                                   "securityResult");
	if(security_result) {
...
OpenAPI_up_security_info_t *OpenAPI_up_security_info_copy(
	OpenAPI_up_security_info_t *dst, OpenAPI_up_security_info_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
