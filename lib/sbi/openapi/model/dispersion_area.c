...
OpenAPI_dispersion_area_t *OpenAPI_dispersion_area_create(
	OpenAPI_list_t *tai_list, OpenAPI_list_t *ncgi_list,
	OpenAPI_list_t *ecgi_list, bool is_n3ga_ind, int n3ga_ind) {
	OpenAPI_dispersion_area_t *dispersion_area_local_var =
		ogs_malloc(sizeof(OpenAPI_dispersion_area_t));
...
cJSON *OpenAPI_dispersion_area_convertToJSON(
	...
	if(dispersion_area == NULL) {
		ogs_error(
			"OpenAPI_dispersion_area_convertToJSON() failed [DispersionArea]");
		return NULL;
	}
	...
	if(dispersion_area->tai_list) {
		...
		if(tai_listList == NULL) {
			ogs_error(
				"OpenAPI_dispersion_area_convertToJSON() failed [tai_list]");
			goto end;
		}
		OpenAPI_list_for_each(dispersion_area->tai_list, node) {
			cJSON *itemLocal =
	...
	if(dispersion_area->ncgi_list) {
		...
		if(ncgi_listList == NULL) {
			ogs_error(
				"OpenAPI_dispersion_area_convertToJSON() failed [ncgi_list]");
			goto end;
		}
		OpenAPI_list_for_each(dispersion_area->ncgi_list, node) {
			cJSON *itemLocal =
	...
	if(dispersion_area->ecgi_list) {
		...
		if(ecgi_listList == NULL) {
			ogs_error(
				"OpenAPI_dispersion_area_convertToJSON() failed [ecgi_list]");
			goto end;
		}
		OpenAPI_list_for_each(dispersion_area->ecgi_list, node) {
			cJSON *itemLocal =
	...
	if(dispersion_area->is_n3ga_ind) {
		...
		{
			ogs_error(
				"OpenAPI_dispersion_area_convertToJSON() failed [n3ga_ind]");
			goto end;
		}
	}
...
OpenAPI_dispersion_area_t *OpenAPI_dispersion_area_parseFromJSON(
	cJSON *dispersion_areaJSON) {
	...
	if(tai_list) {
		...
		if(!cJSON_IsArray(tai_list)) {
			ogs_error(
				"OpenAPI_dispersion_area_parseFromJSON() failed [tai_list]");
			goto end;
		}
	...
	if(ncgi_list) {
		...
		if(!cJSON_IsArray(ncgi_list)) {
			ogs_error(
				"OpenAPI_dispersion_area_parseFromJSON() failed [ncgi_list]");
			goto end;
		}
	...
	if(ecgi_list) {
		...
		if(!cJSON_IsArray(ecgi_list)) {
			ogs_error(
				"OpenAPI_dispersion_area_parseFromJSON() failed [ecgi_list]");
			goto end;
		}
	...
	if(n3ga_ind) {
		if(!cJSON_IsBool(n3ga_ind)) {
			ogs_error(
				"OpenAPI_dispersion_area_parseFromJSON() failed [n3ga_ind]");
			goto end;
		}
	}
...
OpenAPI_dispersion_area_t *OpenAPI_dispersion_area_copy(
	OpenAPI_dispersion_area_t *dst, OpenAPI_dispersion_area_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
