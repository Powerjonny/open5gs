...
OpenAPI_problem_details_t *OpenAPI_problem_details_create(char	*type,
                                                          char	*title,
                                                          bool	is_status,
                                                          int	status,
                                                          char	*detail,
...
cJSON *OpenAPI_problem_details_convertToJSON(
	...
	if(problem_details == NULL) {
		ogs_error(
			"OpenAPI_problem_details_convertToJSON() failed [ProblemDetails]");
		return NULL;
	}
	...
	if(problem_details->type) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [type]");
			goto end;
		}
	}
	...
	if(problem_details->title) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [title]");
			goto end;
		}
	}
	...
	if(problem_details->is_status) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [status]");
			goto end;
		}
	}
	...
	if(problem_details->detail) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [detail]");
			goto end;
		}
	}
	...
	if(problem_details->instance) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [instance]");
			goto end;
		}
	}
	...
	if(problem_details->cause) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(problem_details->invalid_params) {
		...
		if(invalid_paramsList == NULL) {
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [invalid_params]");
			goto end;
		}
		OpenAPI_list_for_each(problem_details->invalid_params, node) {
			cJSON *itemLocal =
	...
	if(problem_details->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(problem_details->access_token_error) {
		...
		if(access_token_error_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [access_token_error]");
			goto end;
		}
	...
	if(problem_details->access_token_request) {
		...
		if(access_token_request_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [access_token_request]");
			goto end;
		}
	...
	if(problem_details->nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_convertToJSON() failed [nrf_id]");
			goto end;
		}
	}
...
OpenAPI_problem_details_t *OpenAPI_problem_details_parseFromJSON(
	cJSON *problem_detailsJSON) {
	...
	if(type) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [type]");
			goto end;
		}
	}
	...
	if(title) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [title]");
			goto end;
		}
	}

	status = cJSON_GetObjectItemCaseSensitive(problem_detailsJSON,
	                                          "status");
	if(status) {
		if(!cJSON_IsNumber(status)) {
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [status]");
			goto end;
		}
	}

	detail = cJSON_GetObjectItemCaseSensitive(problem_detailsJSON,
	                                          "detail");
	if(detail) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [detail]");
			goto end;
		}
	}
	...
	if(instance) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [instance]");
			goto end;
		}
	}
	...
	if(cause) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [cause]");
			goto end;
		}
	}
	...
	if(invalid_params) {
		...
		if(!cJSON_IsArray(invalid_params)) {
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [invalid_params]");
			goto end;
		}
	...
	supported_features =
		cJSON_GetObjectItemCaseSensitive(problem_detailsJSON,
		                                 "supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
	...
	if(nrf_id) {
		...
		{
			ogs_error(
				"OpenAPI_problem_details_parseFromJSON() failed [nrf_id]");
			goto end;
		}
	}
...
OpenAPI_problem_details_t *OpenAPI_problem_details_copy(
	OpenAPI_problem_details_t *dst, OpenAPI_problem_details_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
