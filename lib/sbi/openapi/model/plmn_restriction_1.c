...
OpenAPI_plmn_restriction_1_t *OpenAPI_plmn_restriction_1_create(
	...
	OpenAPI_plmn_restriction_1_t *plmn_restriction_1_local_var =
		ogs_malloc(sizeof(OpenAPI_plmn_restriction_1_t));
	...
	plmn_restriction_1_local_var->service_area_restriction =
		service_area_restriction;
	plmn_restriction_1_local_var->core_network_type_restrictions =
		core_network_type_restrictions;
	plmn_restriction_1_local_var->primary_rat_restrictions =
		primary_rat_restrictions;
	plmn_restriction_1_local_var->secondary_rat_restrictions =
...
void OpenAPI_plmn_restriction_1_free(
	...
	if(plmn_restriction_1->forbidden_areas) {
		OpenAPI_list_for_each(plmn_restriction_1->forbidden_areas,
		                      node) {
...
cJSON *OpenAPI_plmn_restriction_1_convertToJSON(
	...
	if(plmn_restriction_1 == NULL) {
		ogs_error(
			"OpenAPI_plmn_restriction_1_convertToJSON() failed [PlmnRestriction_1]");
		return NULL;
	}
	...
	if(plmn_restriction_1->rat_restrictions != OpenAPI_rat_type_NULL) {
		...
		if(rat_restrictionsList == NULL) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_convertToJSON() failed [rat_restrictions]");
			goto end;
		}
		OpenAPI_list_for_each(plmn_restriction_1->rat_restrictions,
		                      node) {
	...
	if(plmn_restriction_1->forbidden_areas) {
		...
		if(forbidden_areasList == NULL) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_convertToJSON() failed [forbidden_areas]");
			goto end;
		}
		OpenAPI_list_for_each(plmn_restriction_1->forbidden_areas,
		                      node) {
	...
	if(plmn_restriction_1->service_area_restriction) {
		...
		if(service_area_restriction_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_convertToJSON() failed [service_area_restriction]");
			goto end;
		}
	   ...
	   OpenAPI_core_network_type_NULL)
	{
		...
		if(core_network_type_restrictionsList == NULL) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_convertToJSON() failed [core_network_type_restrictions]");
			goto end;
		}
	   ...
	   OpenAPI_rat_type_NULL)
	{
		...
		if(primary_rat_restrictionsList == NULL) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_convertToJSON() failed [primary_rat_restrictions]");
			goto end;
		}
		OpenAPI_list_for_each(
			plmn_restriction_1->primary_rat_restrictions, node) {
	   ...
	   OpenAPI_rat_type_NULL)
	{
		...
		if(secondary_rat_restrictionsList == NULL) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_convertToJSON() failed [secondary_rat_restrictions]");
			goto end;
		}
		OpenAPI_list_for_each(
			plmn_restriction_1->secondary_rat_restrictions, node) {
			if(cJSON_AddStringToObject(
...
OpenAPI_plmn_restriction_1_t *OpenAPI_plmn_restriction_1_parseFromJSON(
	...
	rat_restrictions =
		cJSON_GetObjectItemCaseSensitive(plmn_restriction_1JSON,
		                                 "ratRestrictions");
	if(rat_restrictions) {
		cJSON *rat_restrictions_local = NULL;
		if(!cJSON_IsArray(rat_restrictions)) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed [rat_restrictions]");
			goto end;
		}
		...
		if(rat_restrictionsList->count == 0) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed: Expected rat_restrictionsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(forbidden_areas) {
		...
		if(!cJSON_IsArray(forbidden_areas)) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed [forbidden_areas]");
			goto end;
		}
	...
	if(core_network_type_restrictions) {
		...
		if(!cJSON_IsArray(core_network_type_restrictions)) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed [core_network_type_restrictions]");
			goto end;
		}
		...
		if(core_network_type_restrictionsList->count == 0) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed: Expected core_network_type_restrictionsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(primary_rat_restrictions) {
		...
		if(!cJSON_IsArray(primary_rat_restrictions)) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed [primary_rat_restrictions]");
			goto end;
		}
		...
		if(primary_rat_restrictionsList->count == 0) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed: Expected primary_rat_restrictionsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
	...
	if(secondary_rat_restrictions) {
		...
		if(!cJSON_IsArray(secondary_rat_restrictions)) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed [secondary_rat_restrictions]");
			goto end;
		}
		...
		if(secondary_rat_restrictionsList->count == 0) {
			ogs_error(
				"OpenAPI_plmn_restriction_1_parseFromJSON() failed: Expected secondary_rat_restrictionsList to not be empty (after ignoring unsupported enum values).");
			goto end;
		}
	}
