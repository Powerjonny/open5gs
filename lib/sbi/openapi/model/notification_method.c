...
OpenAPI_notification_method_t *OpenAPI_notification_method_create() {
	OpenAPI_notification_method_t *notification_method_local_var =
		ogs_malloc(sizeof(OpenAPI_notification_method_t));
...
cJSON *OpenAPI_notification_method_convertToJSON(
	...
	if(notification_method == NULL) {
		ogs_error(
			"OpenAPI_notification_method_convertToJSON() failed [NotificationMethod]");
		return NULL;
	}
...
OpenAPI_notification_method_t *OpenAPI_notification_method_parseFromJSON(
...
OpenAPI_notification_method_t *OpenAPI_notification_method_copy(
	OpenAPI_notification_method_t	*dst,
	OpenAPI_notification_method_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
