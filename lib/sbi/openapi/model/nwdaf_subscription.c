...
OpenAPI_nwdaf_subscription_t *OpenAPI_nwdaf_subscription_create(
	...
	OpenAPI_nwdaf_subscription_t *nwdaf_subscription_local_var =
		ogs_malloc(sizeof(OpenAPI_nwdaf_subscription_t));
...
void OpenAPI_nwdaf_subscription_free(
	OpenAPI_nwdaf_subscription_t *nwdaf_subscription) {
	...
	if(nwdaf_subscription->nwdaf_events_subscription) {
		OpenAPI_nnwdaf_events_subscription_free(
...
cJSON *OpenAPI_nwdaf_subscription_convertToJSON(
	OpenAPI_nwdaf_subscription_t *nwdaf_subscription) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nwdaf_subscription == NULL) {
		ogs_error(
			"OpenAPI_nwdaf_subscription_convertToJSON() failed [NwdafSubscription]");
		return NULL;
	}
	...
	if(!nwdaf_subscription->nwdaf_evt_subs_service_uri) {
		ogs_error(
			"OpenAPI_nwdaf_subscription_convertToJSON() failed [nwdaf_evt_subs_service_uri]");
		return NULL;
	}
	...
	if(!nwdaf_subscription->nwdaf_events_subscription) {
		ogs_error(
			"OpenAPI_nwdaf_subscription_convertToJSON() failed [nwdaf_events_subscription]");
		return NULL;
	}
	cJSON *nwdaf_events_subscription_local_JSON =
		OpenAPI_nnwdaf_events_subscription_convertToJSON(
			nwdaf_subscription->nwdaf_events_subscription);
...
OpenAPI_nwdaf_subscription_t *OpenAPI_nwdaf_subscription_parseFromJSON(
	...
	nwdaf_evt_subs_service_uri =
		cJSON_GetObjectItemCaseSensitive(nwdaf_subscriptionJSON,
		                                 "nwdafEvtSubsServiceUri");
	if(!nwdaf_evt_subs_service_uri) {
		ogs_error(
			"OpenAPI_nwdaf_subscription_parseFromJSON() failed [nwdaf_evt_subs_service_uri]");
		goto end;
	}
	...
	if(!nwdaf_events_subscription) {
		ogs_error(
			"OpenAPI_nwdaf_subscription_parseFromJSON() failed [nwdaf_events_subscription]");
		goto end;
	}
...
OpenAPI_nwdaf_subscription_t *OpenAPI_nwdaf_subscription_copy(
	OpenAPI_nwdaf_subscription_t *dst, OpenAPI_nwdaf_subscription_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
