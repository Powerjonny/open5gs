...
OpenAPI_nf_load_level_information_t *OpenAPI_nf_load_level_information_create(
	OpenAPI_nf_type_e nf_type, char *nf_instance_id, char *nf_set_id,
	OpenAPI_nnwdaf_nf_status_t *nf_status, bool is_nf_cpu_usage,
	int nf_cpu_usage, bool is_nf_memory_usage, int nf_memory_usage,
	bool is_nf_storage_usage, int nf_storage_usage,
	bool is_nf_load_level_average, int nf_load_level_average,
	bool is_nf_load_levelpeak, int nf_load_levelpeak,
	bool is_nf_load_avg_in_aoi, int nf_load_avg_in_aoi,
	OpenAPI_snssai_t *snssai, bool is_confidence, int confidence) {
	OpenAPI_nf_load_level_information_t *nf_load_level_information_local_var
	        = ogs_malloc(sizeof(OpenAPI_nf_load_level_information_t));
...
void OpenAPI_nf_load_level_information_free(
	OpenAPI_nf_load_level_information_t *nf_load_level_information) {
...
cJSON *OpenAPI_nf_load_level_information_convertToJSON(
	OpenAPI_nf_load_level_information_t *nf_load_level_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(nf_load_level_information == NULL) {
		ogs_error(
			"OpenAPI_nf_load_level_information_convertToJSON() failed [NfLoadLevelInformation]");
		return NULL;
	}
	...
	if(nf_load_level_information->nf_type != OpenAPI_nf_type_NULL) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_type]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_instance_id]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_set_id]");
			goto end;
		}
	}

	if(nf_load_level_information->nf_status) {
		cJSON *nf_status_local_JSON =
			OpenAPI_nnwdaf_nf_status_convertToJSON(
				nf_load_level_information->nf_status);
		if(nf_status_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_status]");
			goto end;
		}
	...
	if(nf_load_level_information->is_nf_cpu_usage) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_cpu_usage]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->is_nf_memory_usage) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_memory_usage]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->is_nf_storage_usage) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_storage_usage]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->is_nf_load_level_average) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_load_level_average]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->is_nf_load_levelpeak) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_load_levelpeak]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->is_nf_load_avg_in_aoi) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [nf_load_avg_in_aoi]");
			goto end;
		}
	}
	...
	if(nf_load_level_information->snssai) {
		...
		if(snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [snssai]");
			goto end;
		}
	...
	if(nf_load_level_information->is_confidence) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_convertToJSON() failed [confidence]");
			goto end;
		}
	}
...
OpenAPI_nf_load_level_information_parseFromJSON(
	...
	nf_type =
		cJSON_GetObjectItemCaseSensitive(nf_load_level_informationJSON,
		                                 "nfType");
	if(nf_type) {
		if(!cJSON_IsString(nf_type)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_type]");
			goto end;
		}
		nf_typeVariable =
	...
	if(nf_instance_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_instance_id]");
			goto end;
		}
	}
	...
	if(nf_set_id) {
		...
		{
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_set_id]");
			goto end;
		}
	}
	...
	if(nf_status) {
		nf_status_local_nonprim =
			OpenAPI_nnwdaf_nf_status_parseFromJSON(nf_status);
		if(!nf_status_local_nonprim) {
			ogs_error(
				"OpenAPI_nnwdaf_nf_status_parseFromJSON failed [nf_status]");
			goto end;
		}
	}
	...
	if(nf_cpu_usage) {
		if(!cJSON_IsNumber(nf_cpu_usage)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_cpu_usage]");
			goto end;
		}
	}
	...
	if(nf_memory_usage) {
		if(!cJSON_IsNumber(nf_memory_usage)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_memory_usage]");
			goto end;
		}
	}
	...
	if(nf_storage_usage) {
		if(!cJSON_IsNumber(nf_storage_usage)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_storage_usage]");
			goto end;
		}
	}
	...
	if(nf_load_level_average) {
		if(!cJSON_IsNumber(nf_load_level_average)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_load_level_average]");
			goto end;
		}
	}
	...
	if(nf_load_levelpeak) {
		if(!cJSON_IsNumber(nf_load_levelpeak)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_load_levelpeak]");
			goto end;
		}
	}
	...
	if(nf_load_avg_in_aoi) {
		if(!cJSON_IsNumber(nf_load_avg_in_aoi)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [nf_load_avg_in_aoi]");
			goto end;
		}
	}
	...
	if(confidence) {
		if(!cJSON_IsNumber(confidence)) {
			ogs_error(
				"OpenAPI_nf_load_level_information_parseFromJSON() failed [confidence]");
			goto end;
		}
	}

	nf_load_level_information_local_var =
		OpenAPI_nf_load_level_information_create(
...
OpenAPI_nf_load_level_information_t *OpenAPI_nf_load_level_information_copy(
	OpenAPI_nf_load_level_information_t	*dst,
	OpenAPI_nf_load_level_information_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nf_load_level_information_convertToJSON() failed");
		return NULL;
	}
