...
OpenAPI_namf_subscription_data_t *OpenAPI_namf_subscription_data_create(
	char *amf_status_uri, OpenAPI_list_t *guami_list) {
	OpenAPI_namf_subscription_data_t *namf_subscription_data_local_var =
		ogs_malloc(sizeof(OpenAPI_namf_subscription_data_t));
...
void OpenAPI_namf_subscription_data_free(
	OpenAPI_namf_subscription_data_t *namf_subscription_data) {
	...
	if(namf_subscription_data->guami_list) {
		OpenAPI_list_for_each(namf_subscription_data->guami_list,
		                      node) {
...
cJSON *OpenAPI_namf_subscription_data_convertToJSON(
	OpenAPI_namf_subscription_data_t *namf_subscription_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(namf_subscription_data == NULL) {
		ogs_error(
			"OpenAPI_namf_subscription_data_convertToJSON() failed [NamfSubscriptionData]");
		return NULL;
	}
	...
	if(!namf_subscription_data->amf_status_uri) {
		ogs_error(
			"OpenAPI_namf_subscription_data_convertToJSON() failed [amf_status_uri]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "amfStatusUri",
	                           namf_subscription_data->amf_status_uri) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_namf_subscription_data_convertToJSON() failed [amf_status_uri]");
	...
	if(namf_subscription_data->guami_list) {
		...
		if(guami_listList == NULL) {
			ogs_error(
				"OpenAPI_namf_subscription_data_convertToJSON() failed [guami_list]");
			goto end;
		}
		OpenAPI_list_for_each(namf_subscription_data->guami_list,
		                      node) {
...
OpenAPI_namf_subscription_data_t *OpenAPI_namf_subscription_data_parseFromJSON(
	cJSON *namf_subscription_dataJSON) {
	OpenAPI_namf_subscription_data_t *namf_subscription_data_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	amf_status_uri =
		cJSON_GetObjectItemCaseSensitive(namf_subscription_dataJSON,
		                                 "amfStatusUri");
	if(!amf_status_uri) {
		ogs_error(
			"OpenAPI_namf_subscription_data_parseFromJSON() failed [amf_status_uri]");
		goto end;
	}
	...
	if(guami_list) {
		...
		if(!cJSON_IsArray(guami_list)) {
			ogs_error(
				"OpenAPI_namf_subscription_data_parseFromJSON() failed [guami_list]");
			goto end;
		}
	...
	namf_subscription_data_local_var =
		OpenAPI_namf_subscription_data_create(
...
OpenAPI_namf_subscription_data_t *OpenAPI_namf_subscription_data_copy(
	OpenAPI_namf_subscription_data_t	*dst,
	OpenAPI_namf_subscription_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_namf_subscription_data_convertToJSON() failed");
		return NULL;
	}
