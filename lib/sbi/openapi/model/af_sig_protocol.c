...
char * OpenAPI_af_sig_protocol_ToString(
	...
	const char *af_sig_protocolArray[] = { "NULL", "NO_INFORMATION",
		                               "SIP" };
	size_t sizeofArray = sizeof(af_sig_protocolArray) /
	                     sizeof(af_sig_protocolArray[0]);
...
OpenAPI_af_sig_protocol_e OpenAPI_af_sig_protocol_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(af_sig_protocol,
		          af_sig_protocolArray[stringToReturn]) == 0)
		{
