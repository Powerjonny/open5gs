...
void OpenAPI_point_uncertainty_ellipse_all_of_free(
	OpenAPI_point_uncertainty_ellipse_all_of_t *
...
cJSON *OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON(
	...
	if(point_uncertainty_ellipse_all_of == NULL) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [PointUncertaintyEllipse_allOf]");
		return NULL;
	}
	...
	if(!point_uncertainty_ellipse_all_of->point) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [point]");
		return NULL;
	}
	...
	if(!point_uncertainty_ellipse_all_of->uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [uncertainty_ellipse]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_point_uncertainty_ellipse_all_of_t *
OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON(
	...
	if(!point) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON() failed [point]");
		goto end;
	}
	point_local_nonprim =
	...
	uncertainty_ellipse =
		cJSON_GetObjectItemCaseSensitive(
			point_uncertainty_ellipse_all_ofJSON,
			"uncertaintyEllipse");
	if(!uncertainty_ellipse) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON() failed [uncertainty_ellipse]");
		goto end;
	}
	...
	if(!confidence) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_parseFromJSON() failed [confidence]");
		goto end;
	}
...
OpenAPI_point_uncertainty_ellipse_all_of_t *
OpenAPI_point_uncertainty_ellipse_all_of_copy(
	OpenAPI_point_uncertainty_ellipse_all_of_t	*dst,
	OpenAPI_point_uncertainty_ellipse_all_of_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_point_uncertainty_ellipse_all_of_convertToJSON() failed");
		return NULL;
	}
