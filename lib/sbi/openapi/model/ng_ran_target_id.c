...
OpenAPI_ng_ran_target_id_t *OpenAPI_ng_ran_target_id_create(
	OpenAPI_global_ran_node_id_t *ran_node_id, OpenAPI_tai_t *tai) {
	OpenAPI_ng_ran_target_id_t *ng_ran_target_id_local_var =
		ogs_malloc(sizeof(OpenAPI_ng_ran_target_id_t));
...
void OpenAPI_ng_ran_target_id_free(
	OpenAPI_ng_ran_target_id_t *ng_ran_target_id) {
...
cJSON *OpenAPI_ng_ran_target_id_convertToJSON(
	OpenAPI_ng_ran_target_id_t *ng_ran_target_id) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(ng_ran_target_id == NULL) {
		ogs_error(
			"OpenAPI_ng_ran_target_id_convertToJSON() failed [NgRanTargetId]");
		return NULL;
	}
	...
	if(!ng_ran_target_id->ran_node_id) {
		ogs_error(
			"OpenAPI_ng_ran_target_id_convertToJSON() failed [ran_node_id]");
		return NULL;
	}
	...
	if(!ng_ran_target_id->tai) {
		ogs_error(
			"OpenAPI_ng_ran_target_id_convertToJSON() failed [tai]");
		return NULL;
	}
	cJSON *tai_local_JSON =
		OpenAPI_tai_convertToJSON(ng_ran_target_id->tai);
...
OpenAPI_ng_ran_target_id_t *OpenAPI_ng_ran_target_id_parseFromJSON(
	cJSON *ng_ran_target_idJSON) {
	...
	if(!ran_node_id) {
		ogs_error(
			"OpenAPI_ng_ran_target_id_parseFromJSON() failed [ran_node_id]");
		goto end;
	}
	...
	if(!tai) {
		ogs_error(
			"OpenAPI_ng_ran_target_id_parseFromJSON() failed [tai]");
		goto end;
	}
...
OpenAPI_ng_ran_target_id_t *OpenAPI_ng_ran_target_id_copy(
	OpenAPI_ng_ran_target_id_t *dst, OpenAPI_ng_ran_target_id_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
