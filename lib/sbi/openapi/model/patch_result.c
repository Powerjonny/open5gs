...
OpenAPI_patch_result_t *OpenAPI_patch_result_create(OpenAPI_list_t *report) {
	OpenAPI_patch_result_t *patch_result_local_var =
...
cJSON *OpenAPI_patch_result_convertToJSON(
	OpenAPI_patch_result_t *patch_result) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;

	if(patch_result == NULL) {
		ogs_error(
			"OpenAPI_patch_result_convertToJSON() failed [PatchResult]");
		return NULL;
	}
	...
	if(!patch_result->report) {
		ogs_error(
			"OpenAPI_patch_result_convertToJSON() failed [report]");
		return NULL;
	}
...
OpenAPI_patch_result_t *OpenAPI_patch_result_parseFromJSON(
	cJSON *patch_resultJSON) {
	...
	if(!report) {
		ogs_error(
			"OpenAPI_patch_result_parseFromJSON() failed [report]");
		goto end;
	}
...
OpenAPI_patch_result_t *OpenAPI_patch_result_copy(
	OpenAPI_patch_result_t	*dst,
