...
OpenAPI_scheduled_communication_time_create(OpenAPI_list_t *days_of_week,
                                            char		*
                                            time_of_day_start,
                                            char *time_of_day_end)
{
	OpenAPI_scheduled_communication_time_t *
		...
		ogs_malloc(sizeof(OpenAPI_scheduled_communication_time_t));
...
void OpenAPI_scheduled_communication_time_free(
	...
	if(scheduled_communication_time->days_of_week) {
		OpenAPI_list_for_each(
			scheduled_communication_time->days_of_week, node) {
			ogs_free(node->data);
		}
...
cJSON *OpenAPI_scheduled_communication_time_convertToJSON(
	OpenAPI_scheduled_communication_time_t *scheduled_communication_time) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(scheduled_communication_time == NULL) {
		ogs_error(
			"OpenAPI_scheduled_communication_time_convertToJSON() failed [ScheduledCommunicationTime]");
		return NULL;
	}
	...
	if(scheduled_communication_time->days_of_week) {
		...
		if(days_of_weekList == NULL) {
			ogs_error(
				"OpenAPI_scheduled_communication_time_convertToJSON() failed [days_of_week]");
			goto end;
		}
		OpenAPI_list_for_each(
			scheduled_communication_time->days_of_week, node) {
	...
	if(scheduled_communication_time->time_of_day_start) {
		...
		{
			ogs_error(
				"OpenAPI_scheduled_communication_time_convertToJSON() failed [time_of_day_start]");
			goto end;
		}
	}
	...
	if(scheduled_communication_time->time_of_day_end) {
		...
		{
			ogs_error(
				"OpenAPI_scheduled_communication_time_convertToJSON() failed [time_of_day_end]");
			goto end;
		}
	}
...
OpenAPI_scheduled_communication_time_parseFromJSON(
	...
	OpenAPI_scheduled_communication_time_t *
	        scheduled_communication_time_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(days_of_week) {
		...
		if(!cJSON_IsArray(days_of_week)) {
			ogs_error(
				"OpenAPI_scheduled_communication_time_parseFromJSON() failed [days_of_week]");
			goto end;
		}
	...
	if(time_of_day_start) {
		...
		{
			ogs_error(
				"OpenAPI_scheduled_communication_time_parseFromJSON() failed [time_of_day_start]");
			goto end;
		}
	}
	...
	if(time_of_day_end) {
		...
		{
			ogs_error(
				"OpenAPI_scheduled_communication_time_parseFromJSON() failed [time_of_day_end]");
			goto end;
		}
	}

	scheduled_communication_time_local_var =
		OpenAPI_scheduled_communication_time_create(
...
OpenAPI_scheduled_communication_time_t *
OpenAPI_scheduled_communication_time_copy(
	OpenAPI_scheduled_communication_time_t	*dst,
	OpenAPI_scheduled_communication_time_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_scheduled_communication_time_convertToJSON() failed");
		return NULL;
	}
