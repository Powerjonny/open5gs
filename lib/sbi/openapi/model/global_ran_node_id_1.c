...
OpenAPI_global_ran_node_id_1_t *OpenAPI_global_ran_node_id_1_create(
	...
	OpenAPI_global_ran_node_id_1_t *global_ran_node_id_1_local_var =
		ogs_malloc(sizeof(OpenAPI_global_ran_node_id_1_t));
...
cJSON *OpenAPI_global_ran_node_id_1_convertToJSON(
	...
	if(global_ran_node_id_1 == NULL) {
		ogs_error(
			"OpenAPI_global_ran_node_id_1_convertToJSON() failed [GlobalRanNodeId_1]");
		return NULL;
	}
	...
	if(!global_ran_node_id_1->plmn_id) {
		ogs_error(
			"OpenAPI_global_ran_node_id_1_convertToJSON() failed [plmn_id]");
		return NULL;
	}
	cJSON *plmn_id_local_JSON =
		OpenAPI_plmn_id_1_convertToJSON(global_ran_node_id_1->plmn_id);
	...
	if(global_ran_node_id_1->n3_iwf_id) {
		if(cJSON_AddStringToObject(item, "n3IwfId",
		                           global_ran_node_id_1->n3_iwf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [n3_iwf_id]");
			goto end;
		}
	}

	if(global_ran_node_id_1->g_nb_id) {
		cJSON *g_nb_id_local_JSON =
			OpenAPI_gnb_id_convertToJSON(
				global_ran_node_id_1->g_nb_id);
		if(g_nb_id_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [g_nb_id]");
			goto end;
		}
	...
	if(global_ran_node_id_1->nge_nb_id) {
		if(cJSON_AddStringToObject(item, "ngeNbId",
		                           global_ran_node_id_1->nge_nb_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [nge_nb_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id_1->wagf_id) {
		if(cJSON_AddStringToObject(item, "wagfId",
		                           global_ran_node_id_1->wagf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [wagf_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id_1->tngf_id) {
		if(cJSON_AddStringToObject(item, "tngfId",
		                           global_ran_node_id_1->tngf_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [tngf_id]");
			goto end;
		}
	}
	...
	if(global_ran_node_id_1->nid) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [nid]");
			goto end;
		}
	}
	...
	if(global_ran_node_id_1->e_nb_id) {
		if(cJSON_AddStringToObject(item, "eNbId",
		                           global_ran_node_id_1->e_nb_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_convertToJSON() failed [e_nb_id]");
			goto end;
		}
	}
...
OpenAPI_global_ran_node_id_1_t *OpenAPI_global_ran_node_id_1_parseFromJSON(
	...
	cJSON *nid = NULL;
	cJSON *e_nb_id = NULL;
	plmn_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                           "plmnId");
	if(!plmn_id) {
		ogs_error(
			"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [plmn_id]");
		goto end;
	}
	...
	n3_iwf_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                             "n3IwfId");
	if(n3_iwf_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [n3_iwf_id]");
			goto end;
		}
	}

	g_nb_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                           "gNbId");
	if(g_nb_id) {
		g_nb_id_local_nonprim = OpenAPI_gnb_id_parseFromJSON(g_nb_id);
		if(!g_nb_id_local_nonprim) {
			ogs_error(
				"OpenAPI_gnb_id_parseFromJSON failed [g_nb_id]");
			goto end;
		}
	}

	nge_nb_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                             "ngeNbId");
	if(nge_nb_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [nge_nb_id]");
			goto end;
		}
	}

	wagf_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                           "wagfId");
	if(wagf_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [wagf_id]");
			goto end;
		}
	}

	tngf_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                           "tngfId");
	if(tngf_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [tngf_id]");
			goto end;
		}
	}
	...
	if(nid) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [nid]");
			goto end;
		}
	}

	e_nb_id = cJSON_GetObjectItemCaseSensitive(global_ran_node_id_1JSON,
	                                           "eNbId");
	if(e_nb_id) {
		...
		{
			ogs_error(
				"OpenAPI_global_ran_node_id_1_parseFromJSON() failed [e_nb_id]");
			goto end;
		}
	}
	...
	global_ran_node_id_1_local_var = OpenAPI_global_ran_node_id_1_create(
		...
		nge_nb_id &&
		!cJSON_IsNull(nge_nb_id) ? ogs_strdup(nge_nb_id->valuestring) :
		NULL,
		wagf_id &&
		!cJSON_IsNull(wagf_id) ? ogs_strdup(wagf_id->valuestring) :
		NULL,
		tngf_id &&
		!cJSON_IsNull(tngf_id) ? ogs_strdup(tngf_id->valuestring) :
		NULL,
		nid &&
		!cJSON_IsNull(nid) ? ogs_strdup(nid->valuestring) : NULL,
		e_nb_id &&
		!cJSON_IsNull(e_nb_id) ? ogs_strdup(e_nb_id->valuestring) : NULL
		);
...
OpenAPI_global_ran_node_id_1_t *OpenAPI_global_ran_node_id_1_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_global_ran_node_id_1_convertToJSON() failed");
		return NULL;
	}
