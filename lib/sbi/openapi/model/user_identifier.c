...
OpenAPI_user_identifier_t *OpenAPI_user_identifier_create(char	*supi,
                                                          char	*gpsi,
                                                          char	*validity_time)
{
	OpenAPI_user_identifier_t *user_identifier_local_var =
		ogs_malloc(sizeof(OpenAPI_user_identifier_t));
...
cJSON *OpenAPI_user_identifier_convertToJSON(
	...
	if(user_identifier == NULL) {
		ogs_error(
			"OpenAPI_user_identifier_convertToJSON() failed [UserIdentifier]");
		return NULL;
	}
	...
	if(!user_identifier->supi) {
		ogs_error(
			"OpenAPI_user_identifier_convertToJSON() failed [supi]");
		return NULL;
	}
	...
	if(user_identifier->gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_user_identifier_convertToJSON() failed [gpsi]");
			goto end;
		}
	}
	...
	if(user_identifier->validity_time) {
		if(cJSON_AddStringToObject(item, "validityTime",
		                           user_identifier->validity_time) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_user_identifier_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_user_identifier_t *OpenAPI_user_identifier_parseFromJSON(
	cJSON *user_identifierJSON) {
	...
	if(!supi) {
		ogs_error(
			"OpenAPI_user_identifier_parseFromJSON() failed [supi]");
		goto end;
	}
	...
	if(gpsi) {
		...
		{
			ogs_error(
				"OpenAPI_user_identifier_parseFromJSON() failed [gpsi]");
			goto end;
		}
	}

	validity_time = cJSON_GetObjectItemCaseSensitive(user_identifierJSON,
	                                                 "validityTime");
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_user_identifier_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_user_identifier_t *OpenAPI_user_identifier_copy(
	OpenAPI_user_identifier_t *dst, OpenAPI_user_identifier_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
