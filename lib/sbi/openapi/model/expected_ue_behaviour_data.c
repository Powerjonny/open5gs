...
OpenAPI_expected_ue_behaviour_data_t *OpenAPI_expected_ue_behaviour_data_create(
	...
	OpenAPI_expected_ue_behaviour_data_t *
		...
		ogs_malloc(sizeof(OpenAPI_expected_ue_behaviour_data_t));
...
void OpenAPI_expected_ue_behaviour_data_free(
	OpenAPI_expected_ue_behaviour_data_t *expected_ue_behaviour_data) {
	...
	if(expected_ue_behaviour_data->scheduled_communication_time) {
		OpenAPI_scheduled_communication_time_free(
	...
	if(expected_ue_behaviour_data->expected_umts) {
		OpenAPI_list_for_each(expected_ue_behaviour_data->expected_umts,
		                      node) {
...
cJSON *OpenAPI_expected_ue_behaviour_data_convertToJSON(
	OpenAPI_expected_ue_behaviour_data_t *expected_ue_behaviour_data) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(expected_ue_behaviour_data == NULL) {
		ogs_error(
			"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [ExpectedUeBehaviourData]");
		return NULL;
	}
	   ...
	   OpenAPI_stationary_indication_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [stationary_indication]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data->is_communication_duration_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [communication_duration_time]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data->is_periodic_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [periodic_time]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data->scheduled_communication_time) {
		cJSON *scheduled_communication_time_local_JSON =
			OpenAPI_scheduled_communication_time_convertToJSON(
				expected_ue_behaviour_data->
				scheduled_communication_time);
		if(scheduled_communication_time_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [scheduled_communication_time]");
			goto end;
		}
	   ...
	   OpenAPI_scheduled_communication_type_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [scheduled_communication_type]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data->expected_umts) {
		...
		if(expected_umtsList == NULL) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [expected_umts]");
			goto end;
		}
		OpenAPI_list_for_each(expected_ue_behaviour_data->expected_umts,
		                      node) {
	   ...
	   OpenAPI_traffic_profile_NULL)
	{
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [traffic_profile]");
			goto end;
		}
	}
	...
	if(expected_ue_behaviour_data->battery_indication) {
		...
		if(battery_indication_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [battery_indication]");
			goto end;
		}
	...
	if(expected_ue_behaviour_data->validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_expected_ue_behaviour_data_parseFromJSON(
	...
	OpenAPI_expected_ue_behaviour_data_t *
	        expected_ue_behaviour_data_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(stationary_indication) {
		if(!cJSON_IsString(stationary_indication)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [stationary_indication]");
			goto end;
		}
	...
	if(communication_duration_time) {
		if(!cJSON_IsNumber(communication_duration_time)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [communication_duration_time]");
			goto end;
		}
	}
	...
	if(periodic_time) {
		if(!cJSON_IsNumber(periodic_time)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [periodic_time]");
			goto end;
		}
	}
	...
	if(scheduled_communication_time) {
		scheduled_communication_time_local_nonprim =
			OpenAPI_scheduled_communication_time_parseFromJSON(
				scheduled_communication_time);
		if(!scheduled_communication_time_local_nonprim) {
			ogs_error(
				"OpenAPI_scheduled_communication_time_parseFromJSON failed [scheduled_communication_time]");
			goto end;
		}
	}
	...
	if(scheduled_communication_type) {
		if(!cJSON_IsString(scheduled_communication_type)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [scheduled_communication_type]");
			goto end;
		}
	...
	if(expected_umts) {
		...
		if(!cJSON_IsArray(expected_umts)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [expected_umts]");
			goto end;
		}
	...
	if(traffic_profile) {
		if(!cJSON_IsString(traffic_profile)) {
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [traffic_profile]");
			goto end;
		}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_expected_ue_behaviour_data_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}

	expected_ue_behaviour_data_local_var =
		OpenAPI_expected_ue_behaviour_data_create(
...
OpenAPI_expected_ue_behaviour_data_t *OpenAPI_expected_ue_behaviour_data_copy(
	OpenAPI_expected_ue_behaviour_data_t	*dst,
	OpenAPI_expected_ue_behaviour_data_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_expected_ue_behaviour_data_convertToJSON() failed");
		return NULL;
	}
