...
OpenAPI_n2_sm_information_t *OpenAPI_n2_sm_information_create(
	int pdu_session_id, OpenAPI_n2_info_content_t *n2_info_content,
	OpenAPI_snssai_t *s_nssai, OpenAPI_snssai_t *home_plmn_snssai,
	OpenAPI_snssai_t *iwk_snssai, bool is_subject_to_ho,
	int subject_to_ho) {
	OpenAPI_n2_sm_information_t *n2_sm_information_local_var =
		ogs_malloc(sizeof(OpenAPI_n2_sm_information_t));
...
void OpenAPI_n2_sm_information_free(
	OpenAPI_n2_sm_information_t *n2_sm_information) {
...
cJSON *OpenAPI_n2_sm_information_convertToJSON(
	OpenAPI_n2_sm_information_t *n2_sm_information) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(n2_sm_information == NULL) {
		ogs_error(
			"OpenAPI_n2_sm_information_convertToJSON() failed [N2SmInformation]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_n2_sm_information_convertToJSON() failed [pdu_session_id]");
		goto end;
	}
	...
	if(n2_sm_information->n2_info_content) {
		...
		if(n2_info_content_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_sm_information_convertToJSON() failed [n2_info_content]");
			goto end;
		}
	...
	if(n2_sm_information->s_nssai) {
		...
		if(s_nssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_sm_information_convertToJSON() failed [s_nssai]");
			goto end;
		}
	...
	if(n2_sm_information->home_plmn_snssai) {
		cJSON *home_plmn_snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				n2_sm_information->home_plmn_snssai);
		if(home_plmn_snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_sm_information_convertToJSON() failed [home_plmn_snssai]");
			goto end;
		}
	...
	if(n2_sm_information->iwk_snssai) {
		cJSON *iwk_snssai_local_JSON =
			OpenAPI_snssai_convertToJSON(
				n2_sm_information->iwk_snssai);
		if(iwk_snssai_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_n2_sm_information_convertToJSON() failed [iwk_snssai]");
			goto end;
		}
	...
	if(n2_sm_information->is_subject_to_ho) {
		...
		{
			ogs_error(
				"OpenAPI_n2_sm_information_convertToJSON() failed [subject_to_ho]");
			goto end;
		}
	}
...
OpenAPI_n2_sm_information_t *OpenAPI_n2_sm_information_parseFromJSON(
	...
	if(!pdu_session_id) {
		ogs_error(
			"OpenAPI_n2_sm_information_parseFromJSON() failed [pdu_session_id]");
		goto end;
	}
	...
	n2_info_content =
		cJSON_GetObjectItemCaseSensitive(n2_sm_informationJSON,
		                                 "n2InfoContent");
	if(n2_info_content) {
		n2_info_content_local_nonprim =
			OpenAPI_n2_info_content_parseFromJSON(n2_info_content);
		if(!n2_info_content_local_nonprim) {
			ogs_error(
				"OpenAPI_n2_info_content_parseFromJSON failed [n2_info_content]");
			goto end;
		}
	}
	...
	if(home_plmn_snssai) {
		...
		if(!home_plmn_snssai_local_nonprim) {
			ogs_error(
				"OpenAPI_snssai_parseFromJSON failed [home_plmn_snssai]");
			goto end;
		}
	}
	...
	iwk_snssai = cJSON_GetObjectItemCaseSensitive(n2_sm_informationJSON,
	                                              "iwkSnssai");
	if(iwk_snssai) {
		iwk_snssai_local_nonprim =
			OpenAPI_snssai_parseFromJSON(iwk_snssai);
		if(!iwk_snssai_local_nonprim) {
			ogs_error(
				"OpenAPI_snssai_parseFromJSON failed [iwk_snssai]");
			goto end;
		}
	}
	...
	if(subject_to_ho) {
		if(!cJSON_IsBool(subject_to_ho)) {
			ogs_error(
				"OpenAPI_n2_sm_information_parseFromJSON() failed [subject_to_ho]");
			goto end;
		}
	}
...
OpenAPI_n2_sm_information_t *OpenAPI_n2_sm_information_copy(
	OpenAPI_n2_sm_information_t *dst, OpenAPI_n2_sm_information_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
