...
OpenAPI_stationary_indication_rm_t *OpenAPI_stationary_indication_rm_create() {
	OpenAPI_stationary_indication_rm_t *stationary_indication_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_stationary_indication_rm_t));
...
cJSON *OpenAPI_stationary_indication_rm_convertToJSON(
	...
	if(stationary_indication_rm == NULL) {
		ogs_error(
			"OpenAPI_stationary_indication_rm_convertToJSON() failed [StationaryIndicationRm]");
		return NULL;
	}
...
OpenAPI_stationary_indication_rm_parseFromJSON(
	...
	OpenAPI_stationary_indication_rm_t *stationary_indication_rm_local_var =
		NULL;
	OpenAPI_lnode_t *node = NULL;
	stationary_indication_rm_local_var =
		OpenAPI_stationary_indication_rm_create(
			);
...
OpenAPI_stationary_indication_rm_t *OpenAPI_stationary_indication_rm_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_stationary_indication_rm_convertToJSON() failed");
		return NULL;
	}
