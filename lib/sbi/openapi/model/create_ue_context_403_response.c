...
OpenAPI_create_ue_context_403_response_create(
	...
	OpenAPI_create_ue_context_403_response_t *
		...
		ogs_malloc(sizeof(OpenAPI_create_ue_context_403_response_t));
	...
	OpenAPI_create_ue_context_403_response_t *create_ue_context_403_response)
{
	...
	if(create_ue_context_403_response->json_data) {
		OpenAPI_ue_context_create_error_free(
	...
	OpenAPI_create_ue_context_403_response_t *create_ue_context_403_response)
{
	...
	if(create_ue_context_403_response == NULL) {
		ogs_error(
			"OpenAPI_create_ue_context_403_response_convertToJSON() failed [CreateUEContext_403_response]");
		return NULL;
	}
	...
	if(create_ue_context_403_response->json_data) {
		...
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_create_ue_context_403_response_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(create_ue_context_403_response->binary_data_n2_information) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_403_response_convertToJSON() failed [binary_data_n2_information]");
			goto end;
		}
...
OpenAPI_create_ue_context_403_response_parseFromJSON(
	...
	if(json_data) {
		json_data_local_nonprim =
			OpenAPI_ue_context_create_error_parseFromJSON(
				json_data);
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_ue_context_create_error_parseFromJSON failed [json_data]");
			goto end;
		}
	}
	...
	binary_data_n2_information =
		cJSON_GetObjectItemCaseSensitive(
			create_ue_context_403_responseJSON,
	...
	if(binary_data_n2_information) {
		...
		if(!cJSON_IsString(binary_data_n2_information)) {
			ogs_error(
				"OpenAPI_create_ue_context_403_response_parseFromJSON() failed [binary_data_n2_information]");
			goto end;
		}
...
OpenAPI_create_ue_context_403_response_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_create_ue_context_403_response_convertToJSON() failed");
		return NULL;
	}
