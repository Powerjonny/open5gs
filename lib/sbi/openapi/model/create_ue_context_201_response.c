...
OpenAPI_create_ue_context_201_response_create(
	...
	OpenAPI_create_ue_context_201_response_t *
		...
		ogs_malloc(sizeof(OpenAPI_create_ue_context_201_response_t));
...
void OpenAPI_create_ue_context_201_response_free(
	OpenAPI_create_ue_context_201_response_t *create_ue_context_201_response)
{
	...
	if(create_ue_context_201_response->json_data) {
		OpenAPI_ue_context_created_data_free(
...
cJSON *OpenAPI_create_ue_context_201_response_convertToJSON(
	OpenAPI_create_ue_context_201_response_t *create_ue_context_201_response)
{
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(create_ue_context_201_response == NULL) {
		ogs_error(
			"OpenAPI_create_ue_context_201_response_convertToJSON() failed [CreateUEContext_201_response]");
		return NULL;
	}
	...
	if(create_ue_context_201_response->json_data) {
		cJSON *json_data_local_JSON =
			OpenAPI_ue_context_created_data_convertToJSON(
				create_ue_context_201_response->json_data);
		if(json_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [json_data]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext1) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext1]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext2) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext2]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext3) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext3]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext4) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext4]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext5) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext5]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext6) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext6]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext7) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext7]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext8) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext8]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext9) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext9]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext10) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext10]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext11) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext11]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext12) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext12]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext13) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext13]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext14) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext14]");
			goto end;
		}
	...
	if(create_ue_context_201_response->binary_data_n2_information_ext15) {
		...
		{
			ogs_error(
				"OpenAPI_create_ue_context_201_response_convertToJSON() failed [binary_data_n2_information_ext15]");
			goto end;
		}
...
OpenAPI_create_ue_context_201_response_t *
OpenAPI_create_ue_context_201_response_parseFromJSON(
	...
	if(json_data) {
		json_data_local_nonprim =
			OpenAPI_ue_context_created_data_parseFromJSON(
				json_data);
		if(!json_data_local_nonprim) {
			ogs_error(
				"OpenAPI_ue_context_created_data_parseFromJSON failed [json_data]");
			goto end;
		}
	}
	...
	if(binary_data_n2_information) {
		...
		if(!cJSON_IsString(binary_data_n2_information)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext1) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext1)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext1]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext2) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext2)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext2]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext3) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext3)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext3]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext4) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext4)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext4]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext5) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext5)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext5]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext6) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext6)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext6]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext7) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext7)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext7]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext8) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext8)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext8]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext9) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext9)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext9]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext10) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext10)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext10]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext11) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext11)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext11]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext12) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext12)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext12]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext13) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext13)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext13]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext14) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext14)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext14]");
			goto end;
		}
	...
	if(binary_data_n2_information_ext15) {
		...
		if(!cJSON_IsString(binary_data_n2_information_ext15)) {
			ogs_error(
				"OpenAPI_create_ue_context_201_response_parseFromJSON() failed [binary_data_n2_information_ext15]");
			goto end;
		}
...
OpenAPI_create_ue_context_201_response_t *
OpenAPI_create_ue_context_201_response_copy(
	OpenAPI_create_ue_context_201_response_t	*dst,
	OpenAPI_create_ue_context_201_response_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_create_ue_context_201_response_convertToJSON() failed");
		return NULL;
	}
