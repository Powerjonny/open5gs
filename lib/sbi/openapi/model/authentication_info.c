...
OpenAPI_authentication_info_t *OpenAPI_authentication_info_create(
	char *supi_or_suci, char *serving_network_name,
	OpenAPI_resynchronization_info_t *resynchronization_info, char *pei,
	bool is_trace_data_null, OpenAPI_trace_data_t *trace_data,
	char *udm_group_id, char *routing_indicator,
	OpenAPI_list_t *cell_cag_info, bool is_n5gc_ind, int n5gc_ind,
	char *supported_features, bool is_nswo_ind, int nswo_ind,
	bool is_disaster_roaming_ind, int disaster_roaming_ind,
	bool is_onboarding_ind, int onboarding_ind) {
	OpenAPI_authentication_info_t *authentication_info_local_var =
		ogs_malloc(sizeof(OpenAPI_authentication_info_t));
	ogs_assert(authentication_info_local_var);

	authentication_info_local_var->supi_or_suci = supi_or_suci;
	authentication_info_local_var->serving_network_name =
		serving_network_name;
	authentication_info_local_var->resynchronization_info =
	...
	authentication_info_local_var->is_disaster_roaming_ind =
		is_disaster_roaming_ind;
	authentication_info_local_var->disaster_roaming_ind =
...
void OpenAPI_authentication_info_free(
	OpenAPI_authentication_info_t *authentication_info) {
	...
	if(authentication_info->resynchronization_info) {
		OpenAPI_resynchronization_info_free(
			authentication_info->resynchronization_info);
	...
	if(authentication_info->cell_cag_info) {
		OpenAPI_list_for_each(authentication_info->cell_cag_info,
		                      node) {
			ogs_free(node->data);
		}
...
cJSON *OpenAPI_authentication_info_convertToJSON(
	OpenAPI_authentication_info_t *authentication_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(authentication_info == NULL) {
		ogs_error(
			"OpenAPI_authentication_info_convertToJSON() failed [AuthenticationInfo]");
		return NULL;
	}
	...
	if(!authentication_info->supi_or_suci) {
		ogs_error(
			"OpenAPI_authentication_info_convertToJSON() failed [supi_or_suci]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "supiOrSuci",
	                           authentication_info->supi_or_suci) == NULL)
	{
		ogs_error(
			"OpenAPI_authentication_info_convertToJSON() failed [supi_or_suci]");
	...
	if(!authentication_info->serving_network_name) {
		ogs_error(
			"OpenAPI_authentication_info_convertToJSON() failed [serving_network_name]");
		return NULL;
	}
	if(cJSON_AddStringToObject(item, "servingNetworkName",
	                           authentication_info->serving_network_name) ==
	   NULL)
	{
		ogs_error(
			"OpenAPI_authentication_info_convertToJSON() failed [serving_network_name]");
	...
	if(authentication_info->resynchronization_info) {
		cJSON *resynchronization_info_local_JSON =
			OpenAPI_resynchronization_info_convertToJSON(
				authentication_info->resynchronization_info);
		if(resynchronization_info_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [resynchronization_info]");
			goto end;
		}
		cJSON_AddItemToObject(item, "resynchronizationInfo",
		                      resynchronization_info_local_JSON);
		if(item->child == NULL) {
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [resynchronization_info]");
			goto end;
	...
	if(authentication_info->pei) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [pei]");
			goto end;
		}
	}
	...
	if(authentication_info->trace_data) {
		cJSON *trace_data_local_JSON =
			OpenAPI_trace_data_convertToJSON(
				authentication_info->trace_data);
		if(trace_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [trace_data]");
			goto end;
		}
	...
	if(authentication_info->udm_group_id) {
		if(cJSON_AddStringToObject(item, "udmGroupId",
		                           authentication_info->udm_group_id) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [udm_group_id]");
			goto end;
		}
	}
	...
	if(authentication_info->routing_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [routing_indicator]");
			goto end;
		}
	}
	...
	if(authentication_info->cell_cag_info) {
		...
		if(cell_cag_infoList == NULL) {
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [cell_cag_info]");
			goto end;
		}
		OpenAPI_list_for_each(authentication_info->cell_cag_info,
		                      node) {
	...
	if(authentication_info->is_n5gc_ind) {
		if(cJSON_AddBoolToObject(item, "n5gcInd",
		                         authentication_info->n5gc_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [n5gc_ind]");
			goto end;
		}
	}
	...
	if(authentication_info->supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [supported_features]");
			goto end;
		}
	}

	if(authentication_info->is_nswo_ind) {
		if(cJSON_AddBoolToObject(item, "nswoInd",
		                         authentication_info->nswo_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [nswo_ind]");
			goto end;
		}
	}
	...
	if(authentication_info->is_disaster_roaming_ind) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [disaster_roaming_ind]");
			goto end;
		}
	}
	...
	if(authentication_info->is_onboarding_ind) {
		if(cJSON_AddBoolToObject(item, "onboardingInd",
		                         authentication_info->onboarding_ind) ==
		   NULL)
		{
			ogs_error(
				"OpenAPI_authentication_info_convertToJSON() failed [onboarding_ind]");
			goto end;
		}
	}
...
OpenAPI_authentication_info_t *OpenAPI_authentication_info_parseFromJSON(
	cJSON *authentication_infoJSON) {
	...
	OpenAPI_resynchronization_info_t *resynchronization_info_local_nonprim =
		NULL;
	cJSON *pei = NULL;
	...
	supi_or_suci = cJSON_GetObjectItemCaseSensitive(authentication_infoJSON,
	                                                "supiOrSuci");
	if(!supi_or_suci) {
		ogs_error(
			"OpenAPI_authentication_info_parseFromJSON() failed [supi_or_suci]");
		goto end;
	}
	...
	serving_network_name =
		cJSON_GetObjectItemCaseSensitive(authentication_infoJSON,
		                                 "servingNetworkName");
	if(!serving_network_name) {
		ogs_error(
			"OpenAPI_authentication_info_parseFromJSON() failed [serving_network_name]");
		goto end;
	}
	...
	if(resynchronization_info) {
		...
		if(!resynchronization_info_local_nonprim) {
			ogs_error(
				"OpenAPI_resynchronization_info_parseFromJSON failed [resynchronization_info]");
			goto end;
		}
	}
	...
	if(pei) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [pei]");
			goto end;
		}
	}

	trace_data = cJSON_GetObjectItemCaseSensitive(authentication_infoJSON,
	                                              "traceData");
	if(trace_data) {
	...
	udm_group_id = cJSON_GetObjectItemCaseSensitive(authentication_infoJSON,
	                                                "udmGroupId");
	if(udm_group_id) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [udm_group_id]");
			goto end;
		}
	}
	...
	if(routing_indicator) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [routing_indicator]");
			goto end;
		}
	}
	...
	if(cell_cag_info) {
		...
		if(!cJSON_IsArray(cell_cag_info)) {
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [cell_cag_info]");
			goto end;
		}
		...
		cJSON_ArrayForEach(cell_cag_info_local, cell_cag_info) {
			...
			OpenAPI_list_add(cell_cag_infoList,
			                 ogs_strdup(
						 cell_cag_info_local->
						 valuestring));
		}
	...
	n5gc_ind = cJSON_GetObjectItemCaseSensitive(authentication_infoJSON,
	                                            "n5gcInd");
	if(n5gc_ind) {
		if(!cJSON_IsBool(n5gc_ind)) {
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [n5gc_ind]");
			goto end;
		}
	}
	...
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}

	nswo_ind = cJSON_GetObjectItemCaseSensitive(authentication_infoJSON,
	                                            "nswoInd");
	if(nswo_ind) {
		if(!cJSON_IsBool(nswo_ind)) {
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [nswo_ind]");
			goto end;
		}
	}
	...
	if(disaster_roaming_ind) {
		if(!cJSON_IsBool(disaster_roaming_ind)) {
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [disaster_roaming_ind]");
			goto end;
		}
	}
	...
	if(onboarding_ind) {
		if(!cJSON_IsBool(onboarding_ind)) {
			ogs_error(
				"OpenAPI_authentication_info_parseFromJSON() failed [onboarding_ind]");
			goto end;
		}
	}
	...
	authentication_info_local_var = OpenAPI_authentication_info_create(
		...
		resynchronization_info ? resynchronization_info_local_nonprim :
		NULL,
		pei &&
...
OpenAPI_authentication_info_t *OpenAPI_authentication_info_copy(
	OpenAPI_authentication_info_t	*dst,
	OpenAPI_authentication_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
