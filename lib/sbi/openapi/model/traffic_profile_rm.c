...
OpenAPI_traffic_profile_rm_t *OpenAPI_traffic_profile_rm_create() {
	OpenAPI_traffic_profile_rm_t *traffic_profile_rm_local_var =
		ogs_malloc(sizeof(OpenAPI_traffic_profile_rm_t));
...
cJSON *OpenAPI_traffic_profile_rm_convertToJSON(
	...
	if(traffic_profile_rm == NULL) {
		ogs_error(
			"OpenAPI_traffic_profile_rm_convertToJSON() failed [TrafficProfileRm]");
		return NULL;
	}
