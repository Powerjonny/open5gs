...
OpenAPI_options_response_t *OpenAPI_options_response_create(
	...
	OpenAPI_options_response_t *options_response_local_var =
		ogs_malloc(sizeof(OpenAPI_options_response_t));
...
void OpenAPI_options_response_free(
	OpenAPI_options_response_t *options_response) {
...
cJSON *OpenAPI_options_response_convertToJSON(
	...
	if(options_response == NULL) {
		ogs_error(
			"OpenAPI_options_response_convertToJSON() failed [OptionsResponse]");
		return NULL;
	}
	...
	if(options_response->supported_features) {
		if(cJSON_AddStringToObject(item, "supportedFeatures",
		                           options_response->supported_features)
		   == NULL)
		{
			ogs_error(
				"OpenAPI_options_response_convertToJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_options_response_t *OpenAPI_options_response_parseFromJSON(
	cJSON *options_responseJSON) {
	OpenAPI_options_response_t *options_response_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *supported_features = NULL;
	supported_features =
		cJSON_GetObjectItemCaseSensitive(options_responseJSON,
		                                 "supportedFeatures");
	if(supported_features) {
		...
		{
			ogs_error(
				"OpenAPI_options_response_parseFromJSON() failed [supported_features]");
			goto end;
		}
	}
...
OpenAPI_options_response_t *OpenAPI_options_response_copy(
	OpenAPI_options_response_t *dst, OpenAPI_options_response_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
