...
OpenAPI_nrf_info_served_nef_info_value_create(char *nef_id,
                                              ...
                                              OpenAPI_list_t *
                                              un_trust_af_info_list,
                                              bool
                                                        is_uas_nf_functionality_ind,
                                              int	uas_nf_functionality_ind)
{
	OpenAPI_nrf_info_served_nef_info_value_t *
	        nrf_info_served_nef_info_value_local_var =
		ogs_malloc(sizeof(OpenAPI_nrf_info_served_nef_info_value_t));
	...
	nrf_info_served_nef_info_value_local_var->
	external_group_identifiers_ranges = external_group_identifiers_ranges;
	nrf_info_served_nef_info_value_local_var->served_fqdn_list =
		served_fqdn_list;
	nrf_info_served_nef_info_value_local_var->tai_list = tai_list;
	nrf_info_served_nef_info_value_local_var->tai_range_list =
		tai_range_list;
	nrf_info_served_nef_info_value_local_var->dnai_list = dnai_list;
	nrf_info_served_nef_info_value_local_var->un_trust_af_info_list =
		un_trust_af_info_list;
	nrf_info_served_nef_info_value_local_var->is_uas_nf_functionality_ind =
		is_uas_nf_functionality_ind;
	nrf_info_served_nef_info_value_local_var->uas_nf_functionality_ind =
		uas_nf_functionality_ind;

	return nrf_info_served_nef_info_value_local_var;
}

void OpenAPI_nrf_info_served_nef_info_value_free(
	OpenAPI_nrf_info_served_nef_info_value_t *nrf_info_served_nef_info_value)
{
	...
	if(nrf_info_served_nef_info_value->af_ee_data) {
		OpenAPI_af_event_exposure_data_free(
			nrf_info_served_nef_info_value->af_ee_data);
		nrf_info_served_nef_info_value->af_ee_data = NULL;
	}
	if(nrf_info_served_nef_info_value->gpsi_ranges) {
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->gpsi_ranges, node) {
	...
	if(nrf_info_served_nef_info_value->external_group_identifiers_ranges) {
		OpenAPI_list_for_each(
			...
			external_group_identifiers_ranges, node) {
			OpenAPI_identity_range_free(node->data);
		}
		OpenAPI_list_free(
			nrf_info_served_nef_info_value->
			external_group_identifiers_ranges);
		nrf_info_served_nef_info_value->
		external_group_identifiers_ranges = NULL;
	}
	if(nrf_info_served_nef_info_value->served_fqdn_list) {
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->served_fqdn_list,
			node) {
			ogs_free(node->data);
		}
		OpenAPI_list_free(
	...
	if(nrf_info_served_nef_info_value->tai_list) {
		OpenAPI_list_for_each(nrf_info_served_nef_info_value->tai_list,
		                      node) {
	...
	if(nrf_info_served_nef_info_value->tai_range_list) {
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->tai_range_list, node) {
			OpenAPI_tai_range_free(node->data);
		}
		OpenAPI_list_free(
			nrf_info_served_nef_info_value->tai_range_list);
		nrf_info_served_nef_info_value->tai_range_list = NULL;
	}
	if(nrf_info_served_nef_info_value->dnai_list) {
		OpenAPI_list_for_each(nrf_info_served_nef_info_value->dnai_list,
		                      node) {
			ogs_free(node->data);
		}
	...
	if(nrf_info_served_nef_info_value->un_trust_af_info_list) {
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->un_trust_af_info_list,
			node) {
	...
	OpenAPI_nrf_info_served_nef_info_value_t *nrf_info_served_nef_info_value)
{
	...
	if(nrf_info_served_nef_info_value == NULL) {
		ogs_error(
			"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [NrfInfo_servedNefInfo_value]");
		return NULL;
	}

	item = cJSON_CreateObject();
	if(nrf_info_served_nef_info_value->nef_id) {
		if(cJSON_AddStringToObject(item, "nefId",
		                           nrf_info_served_nef_info_value->
		                           nef_id) == NULL)
		{
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [nef_id]");
			goto end;
		}
	}

	if(nrf_info_served_nef_info_value->pfd_data) {
		cJSON *pfd_data_local_JSON =
			OpenAPI_pfd_data_convertToJSON(
				nrf_info_served_nef_info_value->pfd_data);
		if(pfd_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [pfd_data]");
			goto end;
		}
	...
	if(nrf_info_served_nef_info_value->af_ee_data) {
		cJSON *af_ee_data_local_JSON =
			OpenAPI_af_event_exposure_data_convertToJSON(
				nrf_info_served_nef_info_value->af_ee_data);
		if(af_ee_data_local_JSON == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [af_ee_data]");
			goto end;
		}
	...
	if(nrf_info_served_nef_info_value->gpsi_ranges) {
		cJSON *gpsi_rangesList = cJSON_AddArrayToObject(item,
		                                                "gpsiRanges");
		if(gpsi_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [gpsi_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->gpsi_ranges, node) {
			cJSON *itemLocal =
				OpenAPI_identity_range_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [gpsi_ranges]");
	...
	if(nrf_info_served_nef_info_value->external_group_identifiers_ranges) {
		cJSON *external_group_identifiers_rangesList =
			cJSON_AddArrayToObject(item,
			                       "externalGroupIdentifiersRanges");
		if(external_group_identifiers_rangesList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [external_group_identifiers_ranges]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->
	...
	if(nrf_info_served_nef_info_value->served_fqdn_list) {
		cJSON *served_fqdn_listList = cJSON_AddArrayToObject(item,
		                                                     "servedFqdnList");
		if(served_fqdn_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [served_fqdn_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->served_fqdn_list,
			node) {
			if(cJSON_AddStringToObject(served_fqdn_listList, "",
			                           (char *) node->data) == NULL)
			{
				ogs_error(
					"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [served_fqdn_list]");
	...
	if(nrf_info_served_nef_info_value->tai_list) {
		...
		if(tai_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [tai_list]");
			goto end;
		}
		OpenAPI_list_for_each(nrf_info_served_nef_info_value->tai_list,
		                      node) {
	...
	if(nrf_info_served_nef_info_value->tai_range_list) {
		...
		if(tai_range_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [tai_range_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->tai_range_list, node) {
	...
	if(nrf_info_served_nef_info_value->dnai_list) {
		...
		if(dnai_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [dnai_list]");
			goto end;
		}
		OpenAPI_list_for_each(nrf_info_served_nef_info_value->dnai_list,
		                      node) {
	...
	if(nrf_info_served_nef_info_value->un_trust_af_info_list) {
		cJSON *un_trust_af_info_listList = cJSON_AddArrayToObject(item,
		                                                          "unTrustAfInfoList");
		if(un_trust_af_info_listList == NULL) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [un_trust_af_info_list]");
			goto end;
		}
		OpenAPI_list_for_each(
			nrf_info_served_nef_info_value->un_trust_af_info_list,
			node) {
			cJSON *itemLocal =
				OpenAPI_un_trust_af_info_convertToJSON(
					node->data);
			if(itemLocal == NULL) {
				ogs_error(
					"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [un_trust_af_info_list]");
			...
			cJSON_AddItemToArray(un_trust_af_info_listList,
			                     itemLocal);
		}
	}

	if(nrf_info_served_nef_info_value->is_uas_nf_functionality_ind) {
		if(cJSON_AddBoolToObject(item, "uasNfFunctionalityInd",
		                         nrf_info_served_nef_info_value->
		                         uas_nf_functionality_ind) == NULL)
		{
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed [uas_nf_functionality_ind]");
			goto end;
		}
	}
...
OpenAPI_nrf_info_served_nef_info_value_parseFromJSON(
	cJSON *nrf_info_served_nef_info_valueJSON) {
	OpenAPI_nrf_info_served_nef_info_value_t *
	        nrf_info_served_nef_info_value_local_var = NULL;
	OpenAPI_lnode_t *node = NULL;
	cJSON *nef_id = NULL;
	cJSON *pfd_data = NULL;
	...
	nef_id =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "nefId");
	if(nef_id) {
		if(!cJSON_IsString(nef_id) &&
		   !cJSON_IsNull(nef_id))
		{
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [nef_id]");
			goto end;
		}
	}
	...
	pfd_data =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "pfdData");
	if(pfd_data) {
		pfd_data_local_nonprim =
			OpenAPI_pfd_data_parseFromJSON(pfd_data);
		if(!pfd_data_local_nonprim) {
			ogs_error(
				"OpenAPI_pfd_data_parseFromJSON failed [pfd_data]");
			goto end;
		}
	}
	...
	af_ee_data =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "afEeData");
	if(af_ee_data) {
		af_ee_data_local_nonprim =
			OpenAPI_af_event_exposure_data_parseFromJSON(
				af_ee_data);
		if(!af_ee_data_local_nonprim) {
			ogs_error(
				"OpenAPI_af_event_exposure_data_parseFromJSON failed [af_ee_data]");
			goto end;
		}
	}
	...
	gpsi_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "gpsiRanges");
	if(gpsi_ranges) {
		cJSON *gpsi_ranges_local = NULL;
		if(!cJSON_IsArray(gpsi_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [gpsi_ranges]");
			goto end;
		}
		...
		cJSON_ArrayForEach(gpsi_ranges_local, gpsi_ranges) {
			...
			OpenAPI_identity_range_t *gpsi_rangesItem =
				OpenAPI_identity_range_parseFromJSON(
					gpsi_ranges_local);
			if(!gpsi_rangesItem) {
	...
	external_group_identifiers_ranges =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON,
			"externalGroupIdentifiersRanges");
	if(external_group_identifiers_ranges) {
		...
		if(!cJSON_IsArray(external_group_identifiers_ranges)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [external_group_identifiers_ranges]");
			goto end;
		}

		external_group_identifiers_rangesList = OpenAPI_list_create();

		cJSON_ArrayForEach(external_group_identifiers_ranges_local,
		                   external_group_identifiers_ranges) {
			if(!cJSON_IsObject(
				   external_group_identifiers_ranges_local))
			{
				ogs_error(
					"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [external_group_identifiers_ranges]");
				goto end;
			...
			OpenAPI_identity_range_t *
			        external_group_identifiers_rangesItem =
				OpenAPI_identity_range_parseFromJSON(
					external_group_identifiers_ranges_local);
			if(!external_group_identifiers_rangesItem) {
				ogs_error(
					"No external_group_identifiers_rangesItem");
				goto end;
			}
			OpenAPI_list_add(external_group_identifiers_rangesList,
			                 external_group_identifiers_rangesItem);
		}
	}
	...
	served_fqdn_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "servedFqdnList");
	if(served_fqdn_list) {
		cJSON *served_fqdn_list_local = NULL;
		if(!cJSON_IsArray(served_fqdn_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [served_fqdn_list]");
			goto end;
		}
		...
		cJSON_ArrayForEach(served_fqdn_list_local, served_fqdn_list) {
			...
			OpenAPI_list_add(served_fqdn_listList,
			                 ogs_strdup(
						 served_fqdn_list_local->
						 valuestring));
		}
	}
	...
	tai_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "taiList");
	if(tai_list) {
		cJSON *tai_list_local = NULL;
		if(!cJSON_IsArray(tai_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [tai_list]");
			goto end;
		}
	...
	tai_range_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "taiRangeList");
	if(tai_range_list) {
		cJSON *tai_range_list_local = NULL;
		if(!cJSON_IsArray(tai_range_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [tai_range_list]");
			goto end;
		}
	...
	dnai_list =
		cJSON_GetObjectItemCaseSensitive(
			nrf_info_served_nef_info_valueJSON, "dnaiList");
	if(dnai_list) {
		cJSON *dnai_list_local = NULL;
		if(!cJSON_IsArray(dnai_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [dnai_list]");
			goto end;
		}
	...
	if(un_trust_af_info_list) {
		...
		if(!cJSON_IsArray(un_trust_af_info_list)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [un_trust_af_info_list]");
			goto end;
		}

		un_trust_af_info_listList = OpenAPI_list_create();

		cJSON_ArrayForEach(un_trust_af_info_list_local,
		                   un_trust_af_info_list) {
			...
			OpenAPI_un_trust_af_info_t *un_trust_af_info_listItem =
				OpenAPI_un_trust_af_info_parseFromJSON(
					un_trust_af_info_list_local);
			if(!un_trust_af_info_listItem) {
				ogs_error("No un_trust_af_info_listItem");
				goto end;
			}
			OpenAPI_list_add(un_trust_af_info_listList,
	...
	if(uas_nf_functionality_ind) {
		if(!cJSON_IsBool(uas_nf_functionality_ind)) {
			ogs_error(
				"OpenAPI_nrf_info_served_nef_info_value_parseFromJSON() failed [uas_nf_functionality_ind]");
			goto end;
		}
	}

	nrf_info_served_nef_info_value_local_var =
		OpenAPI_nrf_info_served_nef_info_value_create(
			nef_id &&
			!cJSON_IsNull(nef_id) ?
			ogs_strdup(nef_id->valuestring) : NULL,
			...
			un_trust_af_info_list ? un_trust_af_info_listList :
			NULL,
			uas_nf_functionality_ind ? true : false,
			uas_nf_functionality_ind ?
			uas_nf_functionality_ind->valueint :
			0
			);
	...
	if(external_group_identifiers_rangesList) {
		OpenAPI_list_for_each(external_group_identifiers_rangesList,
		                      node) {
			OpenAPI_identity_range_free(node->data);
		}
...
OpenAPI_nrf_info_served_nef_info_value_copy(
	OpenAPI_nrf_info_served_nef_info_value_t	*dst,
	OpenAPI_nrf_info_served_nef_info_value_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_nrf_info_served_nef_info_value_convertToJSON() failed");
		return NULL;
	}
