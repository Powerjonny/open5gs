...
OpenAPI_wlan_per_ss_id_performance_info_create(char *ss_id,
                                               OpenAPI_list_t	*
                                               wlan_per_ts_infos) {
	OpenAPI_wlan_per_ss_id_performance_info_t *
	        wlan_per_ss_id_performance_info_local_var =
		ogs_malloc(sizeof(OpenAPI_wlan_per_ss_id_performance_info_t));
...
void OpenAPI_wlan_per_ss_id_performance_info_free(
	OpenAPI_wlan_per_ss_id_performance_info_t *
...
cJSON *OpenAPI_wlan_per_ss_id_performance_info_convertToJSON(
	OpenAPI_wlan_per_ss_id_performance_info_t *
	wlan_per_ss_id_performance_info) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(wlan_per_ss_id_performance_info == NULL) {
		ogs_error(
			"OpenAPI_wlan_per_ss_id_performance_info_convertToJSON() failed [WlanPerSsIdPerformanceInfo]");
		return NULL;
	}
	...
	if(!wlan_per_ss_id_performance_info->ss_id) {
		ogs_error(
			"OpenAPI_wlan_per_ss_id_performance_info_convertToJSON() failed [ss_id]");
		return NULL;
	}
	...
	if(!wlan_per_ss_id_performance_info->wlan_per_ts_infos) {
		ogs_error(
			"OpenAPI_wlan_per_ss_id_performance_info_convertToJSON() failed [wlan_per_ts_infos]");
		return NULL;
	}
	...
	OpenAPI_list_for_each(
		wlan_per_ss_id_performance_info->wlan_per_ts_infos, node) {
		cJSON *itemLocal =
			OpenAPI_wlan_per_ts_performance_info_convertToJSON(
				node->data);
		if(itemLocal == NULL) {
			ogs_error(
				"OpenAPI_wlan_per_ss_id_performance_info_convertToJSON() failed [wlan_per_ts_infos]");
...
OpenAPI_wlan_per_ss_id_performance_info_parseFromJSON(
	...
	if(!ss_id) {
		ogs_error(
			"OpenAPI_wlan_per_ss_id_performance_info_parseFromJSON() failed [ss_id]");
		goto end;
	}
	...
	if(!wlan_per_ts_infos) {
		ogs_error(
			"OpenAPI_wlan_per_ss_id_performance_info_parseFromJSON() failed [wlan_per_ts_infos]");
		goto end;
	}
	...
	wlan_per_ss_id_performance_info_local_var =
		OpenAPI_wlan_per_ss_id_performance_info_create(
...
OpenAPI_wlan_per_ss_id_performance_info_t *
OpenAPI_wlan_per_ss_id_performance_info_copy(
	OpenAPI_wlan_per_ss_id_performance_info_t	*dst,
	OpenAPI_wlan_per_ss_id_performance_info_t	*src) {
	cJSON *item = NULL;
	char *content = NULL;
	...
	if(!item) {
		ogs_error(
			"OpenAPI_wlan_per_ss_id_performance_info_convertToJSON() failed");
		return NULL;
	}
