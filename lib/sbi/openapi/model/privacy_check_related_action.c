...
char * OpenAPI_privacy_check_related_action_ToString(
	...
	const char *privacy_check_related_actionArray[] = { "NULL",
	...
	size_t sizeofArray = sizeof(privacy_check_related_actionArray) /
	                     sizeof(privacy_check_related_actionArray[0]);
	if(privacy_check_related_action < sizeofArray) {
		return (char *) privacy_check_related_actionArray[
...
OpenAPI_privacy_check_related_action_FromString(
	char *privacy_check_related_action) {
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(privacy_check_related_action,
		          privacy_check_related_actionArray[stringToReturn]) ==
		   0) {
