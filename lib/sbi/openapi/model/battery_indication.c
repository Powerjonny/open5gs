...
OpenAPI_battery_indication_t *OpenAPI_battery_indication_create(
	...
	OpenAPI_battery_indication_t *battery_indication_local_var =
		ogs_malloc(sizeof(OpenAPI_battery_indication_t));
...
void OpenAPI_battery_indication_free(
...
cJSON *OpenAPI_battery_indication_convertToJSON(
	OpenAPI_battery_indication_t *battery_indication) {
	cJSON *item = NULL;
	OpenAPI_lnode_t *node = NULL;
	...
	if(battery_indication == NULL) {
		ogs_error(
			"OpenAPI_battery_indication_convertToJSON() failed [BatteryIndication]");
		return NULL;
	}
	...
	if(battery_indication->is_battery_ind) {
		...
		{
			ogs_error(
				"OpenAPI_battery_indication_convertToJSON() failed [battery_ind]");
			goto end;
		}
	}
	...
	if(battery_indication->is_replaceable_ind) {
		...
		{
			ogs_error(
				"OpenAPI_battery_indication_convertToJSON() failed [replaceable_ind]");
			goto end;
		}
	}
	...
	if(battery_indication->is_rechargeable_ind) {
		...
		{
			ogs_error(
				"OpenAPI_battery_indication_convertToJSON() failed [rechargeable_ind]");
			goto end;
		}
	}
...
OpenAPI_battery_indication_t *OpenAPI_battery_indication_parseFromJSON(
	...
	replaceable_ind =
		cJSON_GetObjectItemCaseSensitive(battery_indicationJSON,
		                                 "replaceableInd");
	if(replaceable_ind) {
		if(!cJSON_IsBool(replaceable_ind)) {
			ogs_error(
				"OpenAPI_battery_indication_parseFromJSON() failed [replaceable_ind]");
			goto end;
		}
	}
	...
	if(rechargeable_ind) {
		if(!cJSON_IsBool(rechargeable_ind)) {
			ogs_error(
				"OpenAPI_battery_indication_parseFromJSON() failed [rechargeable_ind]");
			goto end;
		}
	}
...
OpenAPI_battery_indication_t *OpenAPI_battery_indication_copy(
	OpenAPI_battery_indication_t *dst, OpenAPI_battery_indication_t *src) {
	cJSON *item = NULL;
	char *content = NULL;
