...
OpenAPI_suggested_packet_num_dl_t *OpenAPI_suggested_packet_num_dl_create(
	...
	OpenAPI_suggested_packet_num_dl_t *suggested_packet_num_dl_local_var =
		ogs_malloc(sizeof(OpenAPI_suggested_packet_num_dl_t));
...
cJSON *OpenAPI_suggested_packet_num_dl_convertToJSON(
	...
	if(suggested_packet_num_dl == NULL) {
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_convertToJSON() failed [SuggestedPacketNumDl]");
		return NULL;
	}
	...
	{
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_convertToJSON() failed [suggested_packet_num_dl]");
		goto end;
	}
	...
	if(suggested_packet_num_dl->validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_suggested_packet_num_dl_convertToJSON() failed [validity_time]");
			goto end;
		}
	}
...
OpenAPI_suggested_packet_num_dl_t *OpenAPI_suggested_packet_num_dl_parseFromJSON
	...
	suggested_packet_num_dl =
		cJSON_GetObjectItemCaseSensitive(suggested_packet_num_dlJSON,
		                                 "suggestedPacketNumDl");
	if(!suggested_packet_num_dl) {
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_parseFromJSON() failed [suggested_packet_num_dl]");
		goto end;
	}
	...
	if(validity_time) {
		...
		{
			ogs_error(
				"OpenAPI_suggested_packet_num_dl_parseFromJSON() failed [validity_time]");
			goto end;
		}
	}

	suggested_packet_num_dl_local_var =
...
OpenAPI_suggested_packet_num_dl_t *OpenAPI_suggested_packet_num_dl_copy(
	...
	if(!item) {
		ogs_error(
			"OpenAPI_suggested_packet_num_dl_convertToJSON() failed");
		return NULL;
	}
