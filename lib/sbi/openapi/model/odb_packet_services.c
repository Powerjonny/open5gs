...
char * OpenAPI_odb_packet_services_ToString(
	...
	const char *odb_packet_servicesArray[] = { "NULL",
		                                   "ALL_PACKET_SERVICES",
		                                   "ROAMER_ACCESS_HPLMN_AP",
		                                   "ROAMER_ACCESS_VPLMN_AP" };
	size_t sizeofArray = sizeof(odb_packet_servicesArray) /
	                     sizeof(odb_packet_servicesArray[0]);
...
OpenAPI_odb_packet_services_e OpenAPI_odb_packet_services_FromString(
	...
	while(stringToReturn < sizeofArray) {
		if(strcmp(odb_packet_services,
		          odb_packet_servicesArray[stringToReturn]) == 0) {
