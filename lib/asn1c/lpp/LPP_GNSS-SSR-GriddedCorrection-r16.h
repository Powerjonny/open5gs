...
struct LPP_SSR_GriddedCorrectionIntegrityParameters_r17;
...
typedef struct LPP_GNSS_SSR_GriddedCorrection_r16 {
	 ...
	 */
	struct LPP_GNSS_SSR_GriddedCorrection_r16__ext1 {
		struct LPP_SSR_GriddedCorrectionIntegrityParameters_r17	*ssr_GriddedCorrectionIntegrityParameters_r17;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_LPP_GNSS_SSR_GriddedCorrection_r16_1[7];
