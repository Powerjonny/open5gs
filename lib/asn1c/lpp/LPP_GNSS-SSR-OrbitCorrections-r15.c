...
static asn_TYPE_member_t asn_MBR_LPP_ext1_11[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_GNSS_SSR_OrbitCorrections_r15__ext1, orbit_IntegrityParameters_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LPP_ORBIT_IntegrityParameters_r17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_11 = {
	sizeof(struct LPP_GNSS_SSR_OrbitCorrections_r15__ext1),
	offsetof(struct LPP_GNSS_SSR_OrbitCorrections_r15__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_GNSS_SSR_OrbitCorrections_r15_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_GNSS_SSR_OrbitCorrections_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_LPP_ext1_11,
		0,
...
static const int asn_MAP_LPP_GNSS_SSR_OrbitCorrections_r15_oms_1[] = { 5 };
...
asn_SEQUENCE_specifics_t asn_SPC_LPP_GNSS_SSR_OrbitCorrections_r15_specs_1 = {
	...
	asn_MAP_LPP_GNSS_SSR_OrbitCorrections_r15_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
