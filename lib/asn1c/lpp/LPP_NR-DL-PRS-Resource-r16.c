...
static int
memb_LPP_dl_PRS_ResourceSymbolOffset_v1800_constraint_16(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_LPP_dl_PRS_ResourceSymbolOffset_v1800_constr_17 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_LPP_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_PRS_Resource_r16__ext1, dl_PRS_ResourcePrioritySubset_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LPP_DL_PRS_ResourcePrioritySubset_r17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_14 = {
	sizeof(struct LPP_NR_DL_PRS_Resource_r16__ext1),
	offsetof(struct LPP_NR_DL_PRS_Resource_r16__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_LPP_ext2_16[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_PRS_Resource_r16__ext2, dl_PRS_ResourceSymbolOffset_v1800),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_LPP_dl_PRS_ResourceSymbolOffset_v1800_constr_17,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_LPP_dl_PRS_ResourceSymbolOffset_v1800_constraint_16
		},
		0, 0, /* No default value */
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext2_specs_16 = {
	sizeof(struct LPP_NR_DL_PRS_Resource_r16__ext2),
	offsetof(struct LPP_NR_DL_PRS_Resource_r16__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_NR_DL_PRS_Resource_r16_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct LPP_NR_DL_PRS_Resource_r16, dl_PRS_QCL_Info_r16),
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_NR_DL_PRS_Resource_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_LPP_ext1_14,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_PRS_Resource_r16, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_LPP_ext2_16,
		0,
...
static const int asn_MAP_LPP_NR_DL_PRS_Resource_r16_oms_1[] = { 5, 6, 7 };
