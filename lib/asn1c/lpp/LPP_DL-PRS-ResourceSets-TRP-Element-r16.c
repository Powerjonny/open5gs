...
static asn_TYPE_member_t asn_MBR_LPP_ext1_6[] = {
	{ ATF_POINTER, 2, offsetof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16__ext1, dl_PRS_ResourceSetARP_Cartesian_r18),
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16__ext1, nr_IntegrityDL_PRS_ResourceSetARP_LocationBounds_r18),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_6 = {
	sizeof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16__ext1),
	offsetof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_DL_PRS_ResourceSets_TRP_Element_r16_1[] = {
	{ ATF_POINTER, 3, offsetof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16, dl_PRS_ResourceSetARP_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16, dl_PRS_Resource_ARP_List_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_DL_PRS_ResourceSets_TRP_Element_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_LPP_ext1_6,
		0,
...
static const int asn_MAP_LPP_DL_PRS_ResourceSets_TRP_Element_r16_oms_1[] = { 0, 1, 2 };
