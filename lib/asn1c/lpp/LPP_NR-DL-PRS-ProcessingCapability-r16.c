...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_LPP_dummy_constr_9 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_LPP_dummy_value2enum_9[] = {
	{ 0,	2,	"m1" },
	{ 1,	2,	"m2" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_LPP_dummy_enum2value_9[] = {
	0,	/* m1(0) */
	1	/* m2(1) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_LPP_dummy_specs_9 = {
	asn_MAP_LPP_dummy_value2enum_9,	/* "tag" => N; sorted by tag */
	asn_MAP_LPP_dummy_enum2value_9,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_LPP_dummy_tags_9[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LPP_dummy_9 = {
	"dummy",
	"dummy",
	&asn_OP_NativeEnumerated,
	asn_DEF_LPP_dummy_tags_9,
	sizeof(asn_DEF_LPP_dummy_tags_9)
		/sizeof(asn_DEF_LPP_dummy_tags_9[0]) - 1, /* 1 */
	asn_DEF_LPP_dummy_tags_9,	/* Same as above */
	sizeof(asn_DEF_LPP_dummy_tags_9)
		/sizeof(asn_DEF_LPP_dummy_tags_9[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_LPP_dummy_constr_9,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_LPP_dummy_specs_9	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_LPP_ext1_8[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_PRS_ProcessingCapability_r16__ext1, dummy),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_8 = {
	sizeof(struct LPP_NR_DL_PRS_ProcessingCapability_r16__ext1),
	offsetof(struct LPP_NR_DL_PRS_ProcessingCapability_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_NR_DL_PRS_ProcessingCapability_r16_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_NR_DL_PRS_ProcessingCapability_r16, simulLTE_NR_PRS_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_PRS_ProcessingCapability_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_LPP_ext1_8,
		0,
...
static const int asn_MAP_LPP_NR_DL_PRS_ProcessingCapability_r16_oms_1[] = { 2, 3 };
