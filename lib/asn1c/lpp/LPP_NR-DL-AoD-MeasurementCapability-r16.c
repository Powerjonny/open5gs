...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_constr_8 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_constr_11 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_value2enum_8[] = {
	{ 0,	3,	"n16" },
	{ 1,	3,	"n24" }
};
static const unsigned int asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_enum2value_8[] = {
	0,	/* n16(0) */
	1	/* n24(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_specs_8 = {
	asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_value2enum_8,	/* "tag" => N; sorted by tag */
	asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_enum2value_8,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_8 = {
	"maxDL-PRS-RSRP-MeasurementFR1-v1730",
	"maxDL-PRS-RSRP-MeasurementFR1-v1730",
	&asn_OP_NativeEnumerated,
	asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8,
	sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8)
		/sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8[0]) - 1, /* 1 */
	asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8,	/* Same as above */
	sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8)
		/sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_tags_8[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_specs_8	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_value2enum_11[] = {
	{ 0,	3,	"n16" },
	{ 1,	3,	"n24" }
};
static const unsigned int asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_enum2value_11[] = {
	0,	/* n16(0) */
	1	/* n24(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_specs_11 = {
	asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_value2enum_11,	/* "tag" => N; sorted by tag */
	asn_MAP_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_enum2value_11,	/* N => "tag"; sorted by N */
	2,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_11 = {
	"maxDL-PRS-RSRP-MeasurementFR2-v1730",
	"maxDL-PRS-RSRP-MeasurementFR2-v1730",
	&asn_OP_NativeEnumerated,
	asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11,
	sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11)
		/sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11[0]) - 1, /* 1 */
	asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11,	/* Same as above */
	sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11)
		/sizeof(asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_tags_11[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_specs_11	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_LPP_ext1_7[] = {
	{ ATF_POINTER, 2, offsetof(struct LPP_NR_DL_AoD_MeasurementCapability_r16__ext1, maxDL_PRS_RSRP_MeasurementFR1_v1730),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR1_v1730_8,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_AoD_MeasurementCapability_r16__ext1, maxDL_PRS_RSRP_MeasurementFR2_v1730),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LPP_maxDL_PRS_RSRP_MeasurementFR2_v1730_11,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_7 = {
	sizeof(struct LPP_NR_DL_AoD_MeasurementCapability_r16__ext1),
	offsetof(struct LPP_NR_DL_AoD_MeasurementCapability_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_NR_DL_AoD_MeasurementCapability_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_DL_AoD_MeasurementCapability_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_LPP_ext1_7,
		0,
...
static const int asn_MAP_LPP_NR_DL_AoD_MeasurementCapability_r16_oms_1[] = { 3 };
...
asn_SEQUENCE_specifics_t asn_SPC_LPP_NR_DL_AoD_MeasurementCapability_r16_specs_1 = {
	...
	asn_MAP_LPP_NR_DL_AoD_MeasurementCapability_r16_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
