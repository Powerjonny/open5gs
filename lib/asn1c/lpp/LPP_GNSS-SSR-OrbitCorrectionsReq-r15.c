...
static int
memb_LPP_orbit_IntegrityReq_r17_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_LPP_orbit_IntegrityReq_r17_constr_5 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_LPP_ext1_4[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_GNSS_SSR_OrbitCorrectionsReq_r15__ext1, orbit_IntegrityReq_r17),
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_LPP_orbit_IntegrityReq_r17_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_LPP_orbit_IntegrityReq_r17_constraint_4
		},
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_4 = {
	sizeof(struct LPP_GNSS_SSR_OrbitCorrectionsReq_r15__ext1),
	offsetof(struct LPP_GNSS_SSR_OrbitCorrectionsReq_r15__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_GNSS_SSR_OrbitCorrectionsReq_r15_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LPP_GNSS_SSR_OrbitCorrectionsReq_r15, storedNavList_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_GNSS_SSR_OrbitCorrectionsReq_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_LPP_ext1_4,
		0,
...
static const int asn_MAP_LPP_GNSS_SSR_OrbitCorrectionsReq_r15_oms_1[] = { 0, 1 };
