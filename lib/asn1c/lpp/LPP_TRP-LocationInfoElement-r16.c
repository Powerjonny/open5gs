...
static asn_TYPE_member_t asn_MBR_LPP_ext1_11[] = {
	{ ATF_POINTER, 2, offsetof(struct LPP_TRP_LocationInfoElement_r16__ext1, trp_LocationCartesian_r18),
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_TRP_LocationInfoElement_r16__ext1, nr_IntegrityTRP_LocationBounds_r18),
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_11 = {
	sizeof(struct LPP_TRP_LocationInfoElement_r16__ext1),
	offsetof(struct LPP_TRP_LocationInfoElement_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_TRP_LocationInfoElement_r16_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct LPP_TRP_LocationInfoElement_r16, nr_PhysCellID_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct LPP_TRP_LocationInfoElement_r16, nr_CellGlobalID_r16),
	...
	{ ATF_POINTER, 5, offsetof(struct LPP_TRP_LocationInfoElement_r16, nr_ARFCN_r16),
	...
	{ ATF_POINTER, 4, offsetof(struct LPP_TRP_LocationInfoElement_r16, associated_DL_PRS_ID_r16),
	...
	{ ATF_POINTER, 3, offsetof(struct LPP_TRP_LocationInfoElement_r16, trp_Location_r16),
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_TRP_LocationInfoElement_r16, trp_DL_PRS_ResourceSets_r16),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_TRP_LocationInfoElement_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_LPP_ext1_11,
		0,
...
static const int asn_MAP_LPP_TRP_LocationInfoElement_r16_oms_1[] = { 1, 2, 3, 4, 5, 6, 7 };
