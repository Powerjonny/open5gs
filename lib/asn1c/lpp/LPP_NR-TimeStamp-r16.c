...
static int
memb_LPP_nr_Symbol_r18_constraint_13(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_LPP_nr_Symbol_r18_constr_14 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_LPP_ext1_13[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_TimeStamp_r16__ext1, nr_Symbol_r18),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_LPP_nr_Symbol_r18_constr_14,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_LPP_nr_Symbol_r18_constraint_13
		},
		0, 0, /* No default value */
		"nr-Symbol-r18"
		},
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_13 = {
	sizeof(struct LPP_NR_TimeStamp_r16__ext1),
	offsetof(struct LPP_NR_TimeStamp_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_NR_TimeStamp_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_NR_TimeStamp_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_LPP_ext1_13,
		0,
...
static const int asn_MAP_LPP_NR_TimeStamp_r16_oms_1[] = { 1, 2, 3, 6 };
