...
static asn_TYPE_member_t asn_MBR_LPP_ext1_11[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15__ext1, ssr_IntegrityOrbitBounds_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LPP_SSR_IntegrityOrbitBounds_r17,
		0,
		{
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext1_specs_11 = {
	sizeof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15__ext1),
	offsetof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LPP_SSR_OrbitCorrectionSatelliteElement_r15_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15, dot_delta_radial_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15, dot_delta_AlongTrack_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15, dot_delta_CrossTrack_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_SSR_OrbitCorrectionSatelliteElement_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_LPP_ext1_11,
		0,
...
static const int asn_MAP_LPP_SSR_OrbitCorrectionSatelliteElement_r15_oms_1[] = { 5, 6, 7, 8 };
