...
struct LPP_Multi_RTT_MeasCapabilityPerBand_r17;
...
typedef struct LPP_NR_Multi_RTT_MeasurementCapability_r16 {
	 ...
	 */
	struct LPP_NR_Multi_RTT_MeasurementCapability_r16__ext1 {
		struct LPP_NR_UE_TEG_Capability_r17	*nr_UE_TEG_Capability_r17;	/* OPTIONAL */
		struct LPP_NR_Multi_RTT_MeasurementCapability_r16__ext1__multi_RTT_MeasCapabilityBandList_r17 {
			A_SEQUENCE_OF(struct LPP_Multi_RTT_MeasCapabilityPerBand_r17) list;
...
extern asn_TYPE_member_t asn_MBR_LPP_NR_Multi_RTT_MeasurementCapability_r16_1[7];
