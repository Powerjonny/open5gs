...
static asn_TYPE_member_t asn_MBR_LPP_ext3_15[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_A_GNSS_ProvideCapabilities__ext3, scheduledLocationRequestSupported_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext3_specs_15 = {
	sizeof(struct LPP_A_GNSS_ProvideCapabilities__ext3),
	offsetof(struct LPP_A_GNSS_ProvideCapabilities__ext3, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_LPP_ext4_17[] = {
	{ ATF_POINTER, 1, offsetof(struct LPP_A_GNSS_ProvideCapabilities__ext4, periodicReportingIntervalMsSupport_r18),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_LPP_ext4_oms_17[] = { 0 };
static const ber_tlv_tag_t asn_DEF_LPP_ext4_tags_17[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LPP_ext4_tag2el_17[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* periodicReportingIntervalMsSupport-r18 */
};
static asn_SEQUENCE_specifics_t asn_SPC_LPP_ext4_specs_17 = {
	sizeof(struct LPP_A_GNSS_ProvideCapabilities__ext4),
	offsetof(struct LPP_A_GNSS_ProvideCapabilities__ext4, _asn_ctx),
	asn_MAP_LPP_ext4_tag2el_17,
	1,	/* Count of tags in the map */
	asn_MAP_LPP_ext4_oms_17,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LPP_ext4_17 = {
	"ext4",
	"ext4",
	&asn_OP_SEQUENCE,
	asn_DEF_LPP_ext4_tags_17,
	sizeof(asn_DEF_LPP_ext4_tags_17)
		/sizeof(asn_DEF_LPP_ext4_tags_17[0]) - 1, /* 1 */
	asn_DEF_LPP_ext4_tags_17,	/* Same as above */
	sizeof(asn_DEF_LPP_ext4_tags_17)
		/sizeof(asn_DEF_LPP_ext4_tags_17[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_LPP_ext4_17,
	1,	/* Elements count */
	&asn_SPC_LPP_ext4_specs_17	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_LPP_A_GNSS_ProvideCapabilities_1[] = {
	{ ATF_POINTER, 8, offsetof(struct LPP_A_GNSS_ProvideCapabilities, gnss_SupportList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct LPP_A_GNSS_ProvideCapabilities, assistanceDataSupportList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct LPP_A_GNSS_ProvideCapabilities, locationCoordinateTypes),
	...
	{ ATF_POINTER, 5, offsetof(struct LPP_A_GNSS_ProvideCapabilities, velocityTypes),
	...
	{ ATF_POINTER, 4, offsetof(struct LPP_A_GNSS_ProvideCapabilities, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_LPP_ext1_7,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct LPP_A_GNSS_ProvideCapabilities, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_LPP_ext2_11,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_A_GNSS_ProvideCapabilities, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_LPP_ext3_15,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_A_GNSS_ProvideCapabilities, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_LPP_ext4_17,
		0,
...
static const int asn_MAP_LPP_A_GNSS_ProvideCapabilities_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
