...
static const long asn_VAL_24_NRPPA_id_positioningDataCollectionReport = 23;
...
static const asn_ioc_cell_t asn_IOS_NRPPA_NRPPA_ELEMENTARY_PROCEDURES_1_rows[] = {
	...
	{ "&InitiatingMessage", aioc__type, &asn_DEF_NRPPA_PositioningDataCollectionReport },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_NRPPA_ProcedureCode, &asn_VAL_24_NRPPA_id_positioningDataCollectionReport },
...
static const asn_ioc_set_t asn_IOS_NRPPA_NRPPA_ELEMENTARY_PROCEDURES_1[] = {
	{ 24, 5, asn_IOS_NRPPA_NRPPA_ELEMENTARY_PROCEDURES_1_rows }
};
static int
...
static asn_TYPE_member_t asn_MBR_NRPPA_value_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPA_InitiatingMessage__value, choice.PositioningDataCollectionReport),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_NRPPA_PositioningDataCollectionReport,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
