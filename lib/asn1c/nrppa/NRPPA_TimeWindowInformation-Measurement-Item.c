...
asn_TYPE_member_t asn_MBR_NRPPA_TimeWindowInformation_Measurement_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NRPPA_TimeWindowInformation_Measurement_Item, timeWindowPeriodicityMeasurement),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPA_TimeWindowInformation_Measurement_Item, timeWindowStart),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRPPA_TimeWindowStart,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct NRPPA_TimeWindowInformation_Measurement_Item, iE_Extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRPPA_ProtocolExtensionContainer_4731P147,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_NRPPA_TimeWindowInformation_Measurement_Item_oms_1[] = { 2, 4 };
